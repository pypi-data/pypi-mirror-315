...
class TestAsr:
    ...
    def test_raw_response_create(self, client: Czlai) -> None:
        response = client.users.asr.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Czlai) -> None:
        with client.users.asr.with_streaming_response.create() as response:
...
class TestAsyncAsr:
    ...
    async def test_method_create(self, async_client: AsyncCzlai) -> None:
        asr = await async_client.users.asr.create()
        assert asr is None
    ...
    async def test_raw_response_create(self, async_client: AsyncCzlai) -> None:
        response = await async_client.users.asr.with_raw_response.create()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        asr = await response.parse()
        assert asr is None

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncCzlai) -> None:
        async with async_client.users.asr.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
