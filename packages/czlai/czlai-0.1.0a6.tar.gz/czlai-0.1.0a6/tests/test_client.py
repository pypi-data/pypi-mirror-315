...
from czlai import Czlai, AsyncCzlai, APIResponseValidationError
from czlai._types import Omit
from czlai._models import BaseModel, FinalRequestOptions
from czlai._constants import RAW_RESPONSE_HEADER
from czlai._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from czlai._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
...
def _get_open_connections(client: Czlai | AsyncCzlai) -> int:
...
class TestCzlai:
    ...
    def test_multipart_repeating_array(self, client: Czlai) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(CZLAI_BASE_URL="http://localhost:5000/from/env"):
            client = Czlai(
                bearer_token=bearer_token, username=username, password=password, _strict_response_validation=True
            )
    ...
    def test_base_url_trailing_slash(self, client: Czlai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Czlai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Czlai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch("czlai._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/ai-checkup/session-start").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/ai-checkup/session-start").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/ai-checkup/session-start").mock(side_effect=retry_handler)
    ...
    @mock.patch("czlai._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Czlai, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.ai_checkup.with_raw_response.session_start(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        self, client: Czlai, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.ai_checkup.with_raw_response.session_start(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncCzlai:
    client = AsyncCzlai(
        base_url=base_url,
        bearer_token=bearer_token,
        username=username,
    ...
    def test_multipart_repeating_array(self, async_client: AsyncCzlai) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncCzlai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncCzlai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncCzlai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        ...
        response = await client.ai_checkup.with_raw_response.session_start()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncCzlai, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from czlai._utils import asyncify
        from czlai._base_client import get_platform 
