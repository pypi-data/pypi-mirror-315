...
class ValidateArnoldTiledTextures(Validator):
    def run(self, _):
        ...
        msg = "You must generate Arnold Tiled Textures (TX files) locally as they can't be generated efficiently on the render nodes and your renders may come out black without them.\n"
