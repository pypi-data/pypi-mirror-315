...
def def process_audio_files(folder_path, image_path, ruta_videos, aspect_ratio, prompt, seed_input, seed, continue_fragment, process_multiple):
    import os
    import time
    ...
    for file_name in file_list:
        ...
        try:
            ...
            raise RuntimeError(f"Error al actualizar la barra de progreso: {e}")
