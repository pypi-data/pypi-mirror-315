    ...
    with gr.Tabs():
        ...
        with gr.Tab("Image+Audio to Video Avatar"):
            ...
            create_button.click(
                ...
                inputs=[subject, aspect_ratio_dropdown, seed_input, Seed_text, continue_fragment, process_multiple],
                outputs=[video_outputs, output_textbox]
            )
...
try:
    ...
    print("Gradio detenido manualmente. Cerrando...")  # Mensaje personalizado