...
class GoArena:
    ...
    def run_tournament(self) -> List[dict]:
        ...
        bot_stats = {bot: {'wins': 0, 'losses': 0, 'disqualified': 0, 'total_score': 0.0, 'matches': 0} for bot in bot_names}
        ...
        for bot, stats in bot_stats.items():
            ...
            logging.info(f"Bot {bot}: Wins: {stats['wins']}, Losses: {stats['losses']}, Disqualified: {stats['disqualified']}, Average Score: {avg_score}")
