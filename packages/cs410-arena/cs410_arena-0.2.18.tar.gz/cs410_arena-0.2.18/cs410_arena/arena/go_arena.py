...
class GoArena:
    ...
    def run_match(self, black_bot_url: str, white_bot_url: str) -> dict:
        ...
        move_counts = {black_bot_url: 0, white_bot_url: 0}
    ...
    def run_tournament(self) -> List[dict]:
        ...
        bot_stats = {bot: {'wins': 0, 'losses': 0, 'disqualified': 0, 'total_score': 0.0, 'matches': 0, 'total_moves': 0} for bot in bot_names}
        ...
        for black_bot, white_bot in matchups:
            ...
            if 'disqualified' in result:
                ...
                for bot in [black_bot, white_bot]:
                    bot_stats[bot]['total_moves'] += result['move_counts'].get(self.bot_urls[bot], 0)
        ...
        for bot, stats in bot_stats.items():
            ...
            logging.info(f"Bot {bot}: Wins: {stats['wins']}, Losses: {stats['losses']}, Disqualified: {stats['disqualified']}, Average Score: {avg_score}, Average Moves per Game: {avg_moves}")
