...
class DtoResponsesMoreLikeThisResponseSearchResponse(pydantic.BaseModel):
    """
    The response model for a successful `Search similar` request.
    ...
    articles: typing.List[DtoResponsesMoreLikeThisResponseArticleResult] = pydantic.Field(
