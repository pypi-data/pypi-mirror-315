...
class DtoResponsesSearchResponseSearchResponse(pydantic.BaseModel):
    """
    The response model for the `Search` and `Search by link` requests,
    including search results and metadata.
