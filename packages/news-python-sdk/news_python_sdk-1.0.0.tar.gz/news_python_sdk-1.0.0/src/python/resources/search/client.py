...
from .types.search_get_request_clustering_variable import \
    SearchGetRequestClusteringVariable
from .types.search_get_request_news_domain_type import \
    SearchGetRequestNewsDomainType
from .types.search_get_request_published_date_precision import \
...
class SearchClient:
    ...
    def get(self, *, q: str, search_in: typing.Optional[str] = None, predefined_sources: typing.Optional[str] = None, source_name: typing.Optional[str] = None, sources: typing.Optional[str] = None, not_sources: typing.Optional[str] = None, lang: typing.Optional[str] = None, not_lang: typing.Optional[str] = None, countries: typing.Optional[str] = None, not_countries: typing.Optional[str] = None, not_author_name: typing.Optional[str] = None, from_: typing.Optional[str] = None, to: typing.Optional[str] = None, published_date_precision: typing.Optional[SearchGetRequestPublishedDatePrecision] = None, by_parse_date: typing.Optional[bool] = None, sort_by: typing.Optional[SearchGetRequestSortBy] = None, ranked_only: typing.Optional[bool] = None, from_rank: typing.Optional[int] = None, to_rank: typing.Optional[int] = None, is_headline: typing.Optional[bool] = None, is_opinion: typing.Optional[bool] = None, is_paid_content: typing.Optional[bool] = None, parent_url: typing.Optional[str] = None, all_links: typing.Optional[str] = None, all_domain_links: typing.Optional[str] = None, additional_domain_info: typing.Optional[bool] = None, is_news_domain: typing.Optional[bool] = None, news_domain_type: typing.Optional[SearchGetRequestNewsDomainType] = None, news_type: typing.Optional[str] = None, word_count_min: typing.Optional[int] = None, word_count_max: typing.Optional[int] = None, page: typing.Optional[int] = None, page_size: typing.Optional[int] = None, clustering_enabled: typing.Optional[bool] = None, clustering_variable: typing.Optional[SearchGetRequestClusteringVariable] = None, clustering_threshold: typing.Optional[float] = None, include_nlp_data: typing.Optional[bool] = None, has_nlp: typing.Optional[bool] = None, theme: typing.Optional[str] = None, not_theme: typing.Optional[str] = None, org_entity_name: typing.Optional[str] = None, per_entity_name: typing.Optional[str] = None, loc_entity_name: typing.Optional[str] = None, misc_entity_name: typing.Optional[str] = None, title_sentiment_min: typing.Optional[float] = None, title_sentiment_max: typing.Optional[float] = None, content_sentiment_min: typing.Optional[float] = None, content_sentiment_max: typing.Optional[float] = None, iptc_tags: typing.Optional[str] = None, not_iptc_tags: typing.Optional[str] = None, iab_tags: typing.Optional[str] = None, not_iab_tags: typing.Optional[str] = None, custom_tags: typing.Optional[str] = None, exclude_duplicates: typing.Optional[bool] = None) -> SearchGetResponse:
        """
        Searches for articles based on specified criteria such as keyword, language, country, source, and more.
        
        Parameters:
            - q: str. The keyword(s) to search for in articles. 
            ...
            - search_in: typing.Optional[str]. The article fields to search in.
            ...
            - published_date_precision: typing.Optional[SearchGetRequestPublishedDatePrecision]. The precision of the published date. There are three types:
            ...
            - sort_by: typing.Optional[SearchGetRequestSortBy]. The sorting order of the results. Possible values are:
            ...
            - all_domain_links: typing.Optional[str]. The domain(s) mentioned in the article.
                                                      ...
                                                      For more details, see [Search by URL](/docs/v3/documentation/how-to/search-by-url).
            - additional_domain_info: typing.Optional[bool]. If true, includes additional domain information in the response for each article:
            ...
            - news_domain_type: typing.Optional[SearchGetRequestNewsDomainType]. Filters results based on the news domain type.
                                                                                 Possible values are:
            ...
            - page_size: typing.Optional[int]. The number of articles to return per page. 
                                               Range: `1` to `1000`.
            - clustering_enabled: typing.Optional[bool]. Determines whether to group similar articles into clusters.
            ...
            - clustering_variable: typing.Optional[SearchGetRequestClusteringVariable]. Specifies which part of the article to use for determining similarity when clustering.
                                                                                        ...
                                                                                        To learn more, see [Clustering news articles](/docs/v3/documentation/guides-and-concepts/clustering-news-articles).
            - clustering_threshold: typing.Optional[float]. Sets the similarity threshold for grouping articles into clusters.
            ...
            - not_theme: typing.Optional[str]. Inverse of the `theme` parameter. Excludes articles based on their general topic, as determined by NLP analysis. 
                                               ...
                                               **Note**: The `not_theme` parameter is only available if NLP is included in your subscription plan.
                                               ...
                                               To learn more, see [NLP features](/docs/v3/documentation/guides-and-concepts/nlp-features).
            - org_entity_name: typing.Optional[str]. Filters articles that mention specific organization names, as identified by NLP analysis.
            ...
            - per_entity_name: typing.Optional[str]. Filters articles that mention specific person names, as identified by NLP analysis.
                                                     ...
                                                     **Note**: The `PER_entity_name` parameter is only available if NLP is included in your subscription plan.
                                                     ...
                                                     To learn more, see [Search by entity](/docs/v3/documentation/how-to/search-by-entity).
            - loc_entity_name: typing.Optional[str]. Filters articles that mention specific location names, as identified by NLP analysis.
                                                     ...
                                                     **Note**: The `LOC_entity_name` parameter is only available if NLP is included in your subscription plan.
                                                     ...
                                                     To learn more, see [Search by entity](/docs/v3/documentation/how-to/search-by-entity).
            - misc_entity_name: typing.Optional[str]. Filters articles that mention other named entities not falling under person, organization, 
            ...
            - exclude_duplicates: typing.Optional[bool]. If true, excludes duplicate and highly similar articles from the search results. 
        ...
        """
        _response = self._client_wrapper.httpx_client.request("GET", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/search"), 
            params=remove_none_from_dict({"q": q, "search_in": search_in, "predefined_sources": predefined_sources, "source_name": source_name, "sources": sources, "not_sources": not_sources, "lang": lang, "not_lang": not_lang, "countries": countries, "not_countries": not_countries, "not_author_name": not_author_name, "from_": from_, "to_": to, "published_date_precision": published_date_precision, "by_parse_date": by_parse_date, "sort_by": sort_by, "ranked_only": ranked_only, "from_rank": from_rank, "to_rank": to_rank, "is_headline": is_headline, "is_opinion": is_opinion, "is_paid_content": is_paid_content, "parent_url": parent_url, "all_links": all_links, "all_domain_links": all_domain_links, "additional_domain_info": additional_domain_info, "is_news_domain": is_news_domain, "news_domain_type": news_domain_type, "news_type": news_type, "word_count_min": word_count_min, "word_count_max": word_count_max, "page": page, "page_size": page_size, "clustering_enabled": clustering_enabled, "clustering_variable": clustering_variable, "clustering_threshold": clustering_threshold, "include_nlp_data": include_nlp_data, "has_nlp": has_nlp, "theme": theme, "not_theme": not_theme, "ORG_entity_name": org_entity_name, "PER_entity_name": per_entity_name, "LOC_entity_name": loc_entity_name, "MISC_entity_name": misc_entity_name, "title_sentiment_min": title_sentiment_min, "title_sentiment_max": title_sentiment_max, "content_sentiment_min": content_sentiment_min, "content_sentiment_max": content_sentiment_max, "iptc_tags": iptc_tags, "not_iptc_tags": not_iptc_tags, "iab_tags": iab_tags, "not_iab_tags": not_iab_tags, "custom_tags": custom_tags, "exclude_duplicates": exclude_duplicates, },
            ),
            headers=self._client_wrapper.get_headers(),
            timeout=60)
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(SearchGetResponse, _response.json())# type: ignore
    ...
    def post(self, *, q: Q, search_in: typing.Optional[SearchIn] = OMIT, predefined_sources: typing.Optional[PredefinedSources] = OMIT, source_name: typing.Optional[SourceName] = OMIT, sources: typing.Optional[Sources] = OMIT, not_sources: typing.Optional[NotSources] = OMIT, lang: typing.Optional[Lang] = OMIT, not_lang: typing.Optional[NotLang] = OMIT, countries: typing.Optional[Countries] = OMIT, not_countries: typing.Optional[NotCountries] = OMIT, not_author_name: typing.Optional[NotAuthorName] = OMIT, from: typing.Optional[From] = OMIT, to: typing.Optional[To] = OMIT, published_date_precision: typing.Optional[PublishedDatePrecision] = OMIT, by_parse_date: typing.Optional[ByParseDate] = OMIT, sort_by: typing.Optional[SortBy] = OMIT, ranked_only: typing.Optional[RankedOnly] = OMIT, from_rank: typing.Optional[FromRank] = OMIT, to_rank: typing.Optional[ToRank] = OMIT, is_headline: typing.Optional[IsHeadline] = OMIT, is_opinion: typing.Optional[IsOpinion] = OMIT, is_paid_content: typing.Optional[IsPaidContent] = OMIT, parent_url: typing.Optional[ParentUrl] = OMIT, all_links: typing.Optional[AllLinks] = OMIT, all_domain_links: typing.Optional[AllDomainLinks] = OMIT, additional_domain_info: typing.Optional[AdditionalDomainInfo] = OMIT, is_news_domain: typing.Optional[IsNewsDomain] = OMIT, news_domain_type: typing.Optional[NewsDomainType] = OMIT, news_type: typing.Optional[NewsType] = OMIT, word_count_min: typing.Optional[WordCountMin] = OMIT, word_count_max: typing.Optional[WordCountMax] = OMIT, page: typing.Optional[Page] = OMIT, page_size: typing.Optional[PageSize] = OMIT, clustering_enabled: typing.Optional[ClusteringEnabled] = OMIT, clustering_variable: typing.Optional[ClusteringVariable] = OMIT, clustering_threshold: typing.Optional[ClusteringThreshold] = OMIT, include_nlp_data: typing.Optional[IncludeNlpData] = OMIT, has_nlp: typing.Optional[HasNlp] = OMIT, theme: typing.Optional[Theme] = OMIT, not_theme: typing.Optional[NotTheme] = OMIT, org_entity_name: typing.Optional[OrgEntityName] = OMIT, per_entity_name: typing.Optional[PerEntityName] = OMIT, loc_entity_name: typing.Optional[LocEntityName] = OMIT, misc_entity_name: typing.Optional[MiscEntityName] = OMIT, title_sentiment_min: typing.Optional[TitleSentimentMin] = OMIT, title_sentiment_max: typing.Optional[TitleSentimentMax] = OMIT, content_sentiment_min: typing.Optional[ContentSentimentMin] = OMIT, content_sentient_max: typing.Optional[ContentSentimentMax] = OMIT, iptc_tags: typing.Optional[IptcTags] = OMIT, not_iptc_tags: typing.Optional[NotIptcTags] = OMIT, iab_tags: typing.Optional[IabTags] = OMIT, not_iab_tags: typing.Optional[NotIabTags] = OMIT, custom_tags: typing.Optional[CustomTags] = OMIT, exclude_duplicates: typing.Optional[ExcludeDuplicates] = OMIT) -> SearchPostResponse:
        """
        Searches for articles based on specified criteria such as keyword, language, country, source, and more.
        ...
        if search_in is not OMIT:
            _request["search_in"] = search_in
        ...
        if additional_domain_info is not OMIT:
            _request["additional_domain_info"] = additional_domain_info
        ...
        if clustering_enabled is not OMIT:
            _request["clustering_enabled"] = clustering_enabled
        if clustering_variable is not OMIT:
            _request["clustering_variable"] = clustering_variable.value
        if clustering_threshold is not OMIT:
            _request["clustering_threshold"] = clustering_threshold
        ...
        if org_entity_name is not OMIT:
            _request["ORG_entity_name"] = org_entity_name
        if per_entity_name is not OMIT:
            _request["PER_entity_name"] = per_entity_name
        if loc_entity_name is not OMIT:
            _request["LOC_entity_name"] = loc_entity_name
        if misc_entity_name is not OMIT:
            _request["MISC_entity_name"] = misc_entity_name
        ...
        if content_sentient_max is not OMIT:
            _request["content_sentient_max"] = content_sentient_max
        ...
        if exclude_duplicates is not OMIT:
            _request["exclude_duplicates"] = exclude_duplicates
        _response = self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/search"), 
            json=jsonable_encoder(_request),
            headers=self._client_wrapper.get_headers(),
            timeout=60)
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(SearchPostResponse, _response.json())# type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(Error, _response.json())# type: ignore
            )
        if _response.status_code == 401:
    ...
    async def get(self, *, q: str, search_in: typing.Optional[str] = None, predefined_sources: typing.Optional[str] = None, source_name: typing.Optional[str] = None, sources: typing.Optional[str] = None, not_sources: typing.Optional[str] = None, lang: typing.Optional[str] = None, not_lang: typing.Optional[str] = None, countries: typing.Optional[str] = None, not_countries: typing.Optional[str] = None, not_author_name: typing.Optional[str] = None, from_: typing.Optional[str] = None, to: typing.Optional[str] = None, published_date_precision: typing.Optional[SearchGetRequestPublishedDatePrecision] = None, by_parse_date: typing.Optional[bool] = None, sort_by: typing.Optional[SearchGetRequestSortBy] = None, ranked_only: typing.Optional[bool] = None, from_rank: typing.Optional[int] = None, to_rank: typing.Optional[int] = None, is_headline: typing.Optional[bool] = None, is_opinion: typing.Optional[bool] = None, is_paid_content: typing.Optional[bool] = None, parent_url: typing.Optional[str] = None, all_links: typing.Optional[str] = None, all_domain_links: typing.Optional[str] = None, additional_domain_info: typing.Optional[bool] = None, is_news_domain: typing.Optional[bool] = None, news_domain_type: typing.Optional[SearchGetRequestNewsDomainType] = None, news_type: typing.Optional[str] = None, word_count_min: typing.Optional[int] = None, word_count_max: typing.Optional[int] = None, page: typing.Optional[int] = None, page_size: typing.Optional[int] = None, clustering_enabled: typing.Optional[bool] = None, clustering_variable: typing.Optional[SearchGetRequestClusteringVariable] = None, clustering_threshold: typing.Optional[float] = None, include_nlp_data: typing.Optional[bool] = None, has_nlp: typing.Optional[bool] = None, theme: typing.Optional[str] = None, not_theme: typing.Optional[str] = None, org_entity_name: typing.Optional[str] = None, per_entity_name: typing.Optional[str] = None, loc_entity_name: typing.Optional[str] = None, misc_entity_name: typing.Optional[str] = None, title_sentiment_min: typing.Optional[float] = None, title_sentiment_max: typing.Optional[float] = None, content_sentiment_min: typing.Optional[float] = None, content_sentiment_max: typing.Optional[float] = None, iptc_tags: typing.Optional[str] = None, not_iptc_tags: typing.Optional[str] = None, iab_tags: typing.Optional[str] = None, not_iab_tags: typing.Optional[str] = None, custom_tags: typing.Optional[str] = None, exclude_duplicates: typing.Optional[bool] = None) -> SearchGetResponse:
        ...
        Parameters:
            ...
            - exclude_duplicates: typing.Optional[bool]. If true, excludes duplicate and highly similar articles from the search results. 
                                                         ...
                                                         To learn more, see [Articles deduplication](/docs/v3/documentation/guides-and-concepts/articles-deduplication).
        """
        _response = await self._client_wrapper.httpx_client.request("GET", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/search"), 
            params=remove_none_from_dict({"q": q, "search_in": search_in, "predefined_sources": predefined_sources, "source_name": source_name, "sources": sources, "not_sources": not_sources, "lang": lang, "not_lang": not_lang, "countries": countries, "not_countries": not_countries, "not_author_name": not_author_name, "from_": from_, "to_": to, "published_date_precision": published_date_precision, "by_parse_date": by_parse_date, "sort_by": sort_by, "ranked_only": ranked_only, "from_rank": from_rank, "to_rank": to_rank, "is_headline": is_headline, "is_opinion": is_opinion, "is_paid_content": is_paid_content, "parent_url": parent_url, "all_links": all_links, "all_domain_links": all_domain_links, "additional_domain_info": additional_domain_info, "is_news_domain": is_news_domain, "news_domain_type": news_domain_type, "news_type": news_type, "word_count_min": word_count_min, "word_count_max": word_count_max, "page": page, "page_size": page_size, "clustering_enabled": clustering_enabled, "clustering_variable": clustering_variable, "clustering_threshold": clustering_threshold, "include_nlp_data": include_nlp_data, "has_nlp": has_nlp, "theme": theme, "not_theme": not_theme, "ORG_entity_name": org_entity_name, "PER_entity_name": per_entity_name, "LOC_entity_name": loc_entity_name, "MISC_entity_name": misc_entity_name, "title_sentiment_min": title_sentiment_min, "title_sentiment_max": title_sentiment_max, "content_sentiment_min": content_sentiment_min, "content_sentiment_max": content_sentiment_max, "iptc_tags": iptc_tags, "not_iptc_tags": not_iptc_tags, "iab_tags": iab_tags, "not_iab_tags": not_iab_tags, "custom_tags": custom_tags, "exclude_duplicates": exclude_duplicates, },
            ),
            headers=self._client_wrapper.get_headers(),
            timeout=60)
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    async def post(self, *, q: Q, search_in: typing.Optional[SearchIn] = OMIT, predefined_sources: typing.Optional[PredefinedSources] = OMIT, source_name: typing.Optional[SourceName] = OMIT, sources: typing.Optional[Sources] = OMIT, not_sources: typing.Optional[NotSources] = OMIT, lang: typing.Optional[Lang] = OMIT, not_lang: typing.Optional[NotLang] = OMIT, countries: typing.Optional[Countries] = OMIT, not_countries: typing.Optional[NotCountries] = OMIT, not_author_name: typing.Optional[NotAuthorName] = OMIT, from: typing.Optional[From] = OMIT, to: typing.Optional[To] = OMIT, published_date_precision: typing.Optional[PublishedDatePrecision] = OMIT, by_parse_date: typing.Optional[ByParseDate] = OMIT, sort_by: typing.Optional[SortBy] = OMIT, ranked_only: typing.Optional[RankedOnly] = OMIT, from_rank: typing.Optional[FromRank] = OMIT, to_rank: typing.Optional[ToRank] = OMIT, is_headline: typing.Optional[IsHeadline] = OMIT, is_opinion: typing.Optional[IsOpinion] = OMIT, is_paid_content: typing.Optional[IsPaidContent] = OMIT, parent_url: typing.Optional[ParentUrl] = OMIT, all_links: typing.Optional[AllLinks] = OMIT, all_domain_links: typing.Optional[AllDomainLinks] = OMIT, additional_domain_info: typing.Optional[AdditionalDomainInfo] = OMIT, is_news_domain: typing.Optional[IsNewsDomain] = OMIT, news_domain_type: typing.Optional[NewsDomainType] = OMIT, news_type: typing.Optional[NewsType] = OMIT, word_count_min: typing.Optional[WordCountMin] = OMIT, word_count_max: typing.Optional[WordCountMax] = OMIT, page: typing.Optional[Page] = OMIT, page_size: typing.Optional[PageSize] = OMIT, clustering_enabled: typing.Optional[ClusteringEnabled] = OMIT, clustering_variable: typing.Optional[ClusteringVariable] = OMIT, clustering_threshold: typing.Optional[ClusteringThreshold] = OMIT, include_nlp_data: typing.Optional[IncludeNlpData] = OMIT, has_nlp: typing.Optional[HasNlp] = OMIT, theme: typing.Optional[Theme] = OMIT, not_theme: typing.Optional[NotTheme] = OMIT, org_entity_name: typing.Optional[OrgEntityName] = OMIT, per_entity_name: typing.Optional[PerEntityName] = OMIT, loc_entity_name: typing.Optional[LocEntityName] = OMIT, misc_entity_name: typing.Optional[MiscEntityName] = OMIT, title_sentiment_min: typing.Optional[TitleSentimentMin] = OMIT, title_sentiment_max: typing.Optional[TitleSentimentMax] = OMIT, content_sentiment_min: typing.Optional[ContentSentimentMin] = OMIT, content_sentient_max: typing.Optional[ContentSentimentMax] = OMIT, iptc_tags: typing.Optional[IptcTags] = OMIT, not_iptc_tags: typing.Optional[NotIptcTags] = OMIT, iab_tags: typing.Optional[IabTags] = OMIT, not_iab_tags: typing.Optional[NotIabTags] = OMIT, custom_tags: typing.Optional[CustomTags] = OMIT, exclude_duplicates: typing.Optional[ExcludeDuplicates] = OMIT) -> SearchPostResponse:
        """
        Searches for articles based on specified criteria such as keyword, language, country, source, and more.
        ...
        if exclude_duplicates is not OMIT:
            _request["exclude_duplicates"] = exclude_duplicates
        _response = await self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/search"), 
            json=jsonable_encoder(_request),
            headers=self._client_wrapper.get_headers(),
            timeout=60)
        if 200 <= _response.status_code < 300:
