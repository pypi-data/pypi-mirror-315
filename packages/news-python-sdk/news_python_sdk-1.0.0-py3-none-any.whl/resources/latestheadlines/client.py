...
class LatestheadlinesClient:
    ...
    def get(
        ...
        *,
        ...
        Parameters:
            - when: typing.Optional[str]. The time period for which you want to get the latest headlines.
                                          Format examples:
                                          - `7d`: Last seven days
                                          - `30d`: Last 30 days
                                          - `1h`: Last hour
            ...
            - clustering_variable: typing.Optional[LatestHeadlinesGetRequestClusteringVariable]. Specifies which part of the article to use for determining similarity when clustering.
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/latest_headlines"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(LatestHeadlinesGetResponse, _response.json())  # type: ignore
    ...
    def post(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(LatestHeadlinesPostResponse, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(Error, _response.json()))  # type: ignore
        if _response.status_code == 401:
            raise UnauthorizedError(pydantic.parse_obj_as(Error, _response.json()))  # type: ignore
