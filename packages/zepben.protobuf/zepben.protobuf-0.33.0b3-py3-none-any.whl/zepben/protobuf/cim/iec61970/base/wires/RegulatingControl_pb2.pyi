...
class RegulatingControl(_message.Message):
    __slots__ = ["psr", "discreteNull", "discreteSet", "mode", "monitoredPhase", "targetDeadband", "targetValue", "enabledNull", "enabledSet", "maxAllowedTargetValue", "minAllowedTargetValue", "terminalMRID", "regulatingCondEqMRIDs", "ratedCurrent"]
