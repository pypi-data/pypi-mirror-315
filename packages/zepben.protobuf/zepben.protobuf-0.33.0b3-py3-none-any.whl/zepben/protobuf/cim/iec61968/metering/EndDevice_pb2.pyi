...
class EndDevice(_message.Message):
    __slots__ = ["ac", "usagePointMRIDs", "customerMRID", "serviceLocationMRID"]
    ...
    def __init__(self, ac: _Optional[_Union[_AssetContainer_pb2.AssetContainer, _Mapping]] = ..., usagePointMRIDs: _Optional[_Iterable[str]] = ..., customerMRID: _Optional[str] = ..., serviceLocationMRID: _Optional[str] = ...) -> None: ...
