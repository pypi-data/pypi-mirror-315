...
class tagtuple(tuple):
    ...
    def __add__(self, other):
        return type(self)(*super(tagtuple, self).__add__(other))

    def __mul__(self, other):
        return type(self)(*super(tagtuple, self).__mul__(other))

    def __rmul__(self, other):
        return type(self)(*super(tagtuple, self).__rmul__(other))
