...
import sys
import os
import ivy_tracer # import SequenceOn, SequenceOff
...
def module_to_cpp_class(classname,basename):
    ...
    # for attr in dir(im.module):
    #     print (attr, getattr(im.module,attr))
...
template <>
void __randomize<int128_t>( gen &g, const  z3::expr &v) {
    g.randomize(v);
}
...
""")
    ...
    return ivy_cpp.context.globals.get_file(), ivy_cpp.context.impls.get_file(), json_config
...
#                        ifc.check_fragment(True)
                    with im.module.theory_context():
                        ...
                        with ivy_cpp.CppContext():
                            header,impl, json_config = module_to_cpp_class(classname,basename)
            #        print header
            #        print impl
