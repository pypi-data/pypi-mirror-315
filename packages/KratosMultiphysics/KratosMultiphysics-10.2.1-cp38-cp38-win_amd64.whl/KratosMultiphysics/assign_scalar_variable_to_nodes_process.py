...
def Factory(settings, Model):
    ...
    return AssignScalarVariableToNodesProcess(Model, settings["Parameters"])

from KratosMultiphysics import assign_scalar_variable_to_entities_process

## All the processes python should be derived from "Process"
class AssignScalarVariableToNodesProcess(assign_scalar_variable_to_entities_process.AssignScalarVariableToEntitiesProcess):
