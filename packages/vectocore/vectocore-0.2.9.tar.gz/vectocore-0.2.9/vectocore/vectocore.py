...
class Vectocore:
    ...
    def extream_search(self, question: str, index_name="", max_count=10, mode="VECTOR"):
        params = {"command": "extream_search", "question": question, "index_name": index_name, "max_count": max_count, "mode": mode}
        result = self.__request_post(params)
        return result
...
class Lens:
    def __init__(self, tenant_key="", role=None, rule=None, output_format=None, mode=None, max_his_count=None, session_key=None):
        # 변수 은닉화
        self.__VECTOR_URL = "https://api.vectocore.com"
    ...
    def chat(self, question, stream=False):
        params = {"command": "lensChat", "question": question}
