...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-route53domains)](https://pypistats.org/packages/mypy-boto3-route53domains)
...
`mypy-boto3-route53domains` dependency in production. However, there is an
