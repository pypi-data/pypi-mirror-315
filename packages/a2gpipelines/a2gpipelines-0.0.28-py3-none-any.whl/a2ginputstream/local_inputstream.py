...
import requests
from a2ginputstream.inputstream import INSERTION_MODE, Inputstream, InputstreamStatus
...
class A2GHttpClient():
    ...
    def find(self, ikey:str, query:dict, inputstream:Inputstream,delete_id:bool=True) -> dict:
        try:
            ...
            elif inputstream.InputstreamType !=1:
            ...
            while downloaded_docs < total_query: 
                ...
                page += 1
                logger. info(f"downloaded_docs: {downloaded_docs}, total_query: {total_query}")
