...
class TestFiltering(unittest.TestCase):
    ...
    def testkalmanfiltermultid(self):
        ...
        state_observable = kf.create_observable(kalman.LinearGaussianObsModel.create(1.0, np.eye(2)), process1, process2)
        coord0_observable = kf.create_observable(kalman.LinearGaussianObsModel.create(1.), process1)
        coord1_observable = kf.create_observable(kalman.LinearGaussianObsModel.create(npu.row(1., 0.)), process2)
        coord2_observable = kf.create_observable(kalman.LinearGaussianObsModel.create(npu.row(0., 1.)), process2)
        sum_observable = kf.create_observable(kalman.LinearGaussianObsModel.create(npu.row(1., 1., 1.)), process1, process2)
        lin_comb_observable = kf.create_observable(kalman.LinearGaussianObsModel.create(npu.row(2., 0., -3.)), process1, process2)
