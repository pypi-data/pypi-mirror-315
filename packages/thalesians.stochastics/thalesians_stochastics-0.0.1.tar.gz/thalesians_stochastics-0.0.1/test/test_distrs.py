...
class TestDistrs(unittest.TestCase):
    ...
    def test_empirical_distr(self):
        ...
        npt.assert_almost_equal(trivial_empirical_1d.normalized_weights, np.array([[1.]]))
        npt.assert_almost_equal(trivial_empirical_1d.normalized_weight(0), 1.)
        ...
        npt.assert_almost_equal(trivial_empirical_1d.var_n_minus_1, 0.)
        self.assertEqual(trivial_empirical_1d.var, 0.)
        self.assertEqual(trivial_empirical_1d.cov_n, 0.)
        npt.assert_almost_equal(trivial_empirical_1d.cov_n_minus_1, 0.)
        ...
        npt.assert_almost_equal(simple_empirical_1d.normalized_weights, np.array([[.5], [.5]]))
        npt.assert_almost_equal(simple_empirical_1d.normalized_weight(0), .5)
        ...
        npt.assert_almost_equal(simple_empirical_1d.var_n_minus_1, 0.)
        self.assertEqual(simple_empirical_1d.cov_n, 1.)
        # "n minus 1" (unbiased) stats don't make sense as we are not using "repeat"-type weights, meaning that each
        # weight represents the number of occurrences of one observation:
        npt.assert_almost_equal(simple_empirical_1d.cov_n_minus_1, 0.)
        self.assertEqual(simple_empirical_1d.cov, 1.)
        self.assertEqual(simple_empirical_1d.vol_n, 1.)
        # "n minus 1" (unbiased) stats don't make sense as we are not using "repeat"-type weights, meaning that each
        # weight represents the number of occurrences of one observation:
        self.assertEqual(simple_empirical_1d.vol_n_minus_1, 0.)
        ...
        npt.assert_almost_equal(repeat_empirical_1d.normalized_weights, np.array([[ 0.6666667], [ 0.3333333]]))
        npt.assert_almost_equal(repeat_empirical_1d.normalized_weight(0), 0.6666667)
        ...
        npt.assert_almost_equal(repeat_empirical_2d.normalized_weights, np.array([[ 0.5 ], [ 0.25], [ 0.25]]))
        npt.assert_almost_equal(repeat_empirical_2d.normalized_weight(0), .5)
        ...
        npt.assert_almost_equal(approx_normal_empirical_2d.normalized_weights, npu.col(*np.ones((100,))) / 100.)
        npt.assert_almost_equal(approx_normal_empirical_2d.normalized_weight(0), .01)
        ...
        npt.assert_almost_equal(approx_normal_empirical_2d.weight(0), 1.)
        npt.assert_almost_equal(approx_normal_empirical_2d.normalized_weights, npu.col(*np.ones((100000,))) / 100000.)
        npt.assert_almost_equal(approx_normal_empirical_2d.normalized_weight(0), .00001)
    ...
    def test_multinomial_resample(self):
        ...
        npt.assert_almost_equal(resampled_approx_normal_empirical_2d.normalized_weights, npu.col(*np.ones((100000,))) / 100000.)
        npt.assert_almost_equal(resampled_approx_normal_empirical_2d.normalized_weight(0), .00001)
        ...
        npt.assert_almost_equal(subsampled_approx_normal_empirical_2d.normalized_weights, npu.col(*np.ones((40000,))) / 40000.)
        npt.assert_almost_equal(subsampled_approx_normal_empirical_2d.normalized_weight(0), .000025)
        ...
        npt.assert_almost_equal(supersampled_approx_normal_empirical_2d.normalized_weights, npu.col(*np.ones((300000,))) / 300000.)
        npt.assert_almost_equal(supersampled_approx_normal_empirical_2d.normalized_weight(0), 3.3333333333333333e-06)
