...
class TestSimulation(unittest.TestCase):
    def test_xtimes(self):
        self.assertIsInstance(sim.xtimes(-5, 5, step=2), collections.abc.Iterator)
        self.assertTrue(issubclass(collections.abc.Iterator, collections.abc.Iterable))
        self.assertIsInstance(sim.xtimes(-5, 5, step=2), collections.abc.Iterable)
