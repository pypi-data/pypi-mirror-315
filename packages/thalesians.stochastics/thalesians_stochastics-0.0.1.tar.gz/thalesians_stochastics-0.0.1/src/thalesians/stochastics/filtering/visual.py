...
import thalesians.adiutor.visual
...
class FilteringPlot(thalesians.adiutor.visual.LivePlot):
...
class InnovationQQPlot(thalesians.adiutor.visual.LivePlot):
    def __init__(self, fig=None, ax=None):
        super().__init__(fig, ax)
        
class EffectiveSampleSizePlot(thalesians.adiutor.visual.LivePlot):
    def __init__(self, fig=None, ax=None):
        super().__init__(fig, ax)
