...
def propagate_nbp(central_body: str, tspan: numpy.ndarray, x0: numpy.ndarray, sources_dict: dict, dat_dict: dict, units_dict: dict, stm: bool, variables: str, atol: float = 1e-10, rtol: float = 1e-10, hmax: float = 0.0, control_function: Callable = None) -> tuple[numpy.ndarray, numpy.ndarray]:
    """
    ...
    if control_function is None:
        ...
        with _package_folder_contex():
            T, Y = FKIAMToolbox.propagationmodule.propagate_nbp_control(central_body, tspan, x0, variables, neq, atol, rtol, hmax, control)
...
def _set_nbp_parameters(stm_req: bool, sources: dict, data: dict, units_data: dict) -> None:
    ...
    if sources['atm'] == False:
        ...
        FKIAMToolbox.odetoolbox.seed = data['seed']
