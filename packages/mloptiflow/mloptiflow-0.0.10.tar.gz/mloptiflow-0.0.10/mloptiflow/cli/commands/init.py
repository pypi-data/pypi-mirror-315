...
def init(project_name: str, paradigm: str, path: str):
    """Initialize a new ML project with the specified paradigm."""
    project_path = Path(path) / project_name
    try:
        project_path.mkdir(parents=True, exist_ok=False)
        copy_template_files(project_path, paradigm)
        ...
        click.echo("2. pip install -r requirements.txt or poetry install")
