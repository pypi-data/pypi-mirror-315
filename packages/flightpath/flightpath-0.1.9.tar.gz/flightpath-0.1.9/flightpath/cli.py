...
if __name__ == "__main__":
    ...
    # poetry run flightpath --verbose trace -u admin -p admin --baseurl http://localhost:8080 --end-task-id end --end-dag-id diamond2 --dag-run-id scheduled__2024-11-16T19:30:00+00:00 --output ~/Downloads/flightpath.db
