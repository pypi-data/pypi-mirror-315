...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_glue/type_defs/)
...
class DescribeEntityRequestDescribeEntityPaginateTypeDef(TypedDict):
    ConnectionName: str
    EntityName: str
    CatalogId: NotRequired[str]
    DataStoreApiVersion: NotRequired[str]
...
class ListConnectionTypesRequestListConnectionTypesPaginateTypeDef(TypedDict):
    PaginationConfig: NotRequired[PaginatorConfigTypeDef]
