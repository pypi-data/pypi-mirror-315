...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dataexchange/literals/)
...
Usage::
    ...
    data: AcceptanceStateFilterValueType = "ACCEPTED"
    ```
...
AcceptanceStateFilterValueType = Literal["ACCEPTED", "PENDING_RECEIVER_ACCEPTANCE"]
...
DataGrantAcceptanceStateType = Literal["ACCEPTED", "PENDING_RECEIVER_ACCEPTANCE"]
DatabaseLFTagPolicyPermissionType = Literal["DESCRIBE"]
GrantDistributionScopeType = Literal["AWS_ORGANIZATION", "NONE"]
...
ListDataGrantsPaginatorName = Literal["list_data_grants"]
...
ListReceivedDataGrantsPaginatorName = Literal["list_received_data_grants"]
