"""
Type annotations for dsql service literal definitions.

[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dsql/literals/)
...
Usage::
    ...
    data: ClusterActiveWaiterName = "cluster_active"
    ```
