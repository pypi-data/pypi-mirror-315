...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_chatbot/literals/)
...
Usage::
    ...
    data: CustomActionAttachmentCriteriaOperatorType = "EQUALS"
    ```
...
CustomActionAttachmentCriteriaOperatorType = Literal["EQUALS", "HAS_VALUE"]
DescribeChimeWebhookConfigurationsPaginatorName = Literal["describe_chime_webhook_configurations"]
DescribeSlackChannelConfigurationsPaginatorName = Literal["describe_slack_channel_configurations"]
DescribeSlackUserIdentitiesPaginatorName = Literal["describe_slack_user_identities"]
DescribeSlackWorkspacesPaginatorName = Literal["describe_slack_workspaces"]
ListAssociationsPaginatorName = Literal["list_associations"]
ListCustomActionsPaginatorName = Literal["list_custom_actions"]
ListMicrosoftTeamsChannelConfigurationsPaginatorName = Literal[
    "list_microsoft_teams_channel_configurations"
]
ListMicrosoftTeamsConfiguredTeamsPaginatorName = Literal["list_microsoft_teams_configured_teams"]
ListMicrosoftTeamsUserIdentitiesPaginatorName = Literal["list_microsoft_teams_user_identities"]
