...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_networkmanager/literals/)
...
Usage::
    ...
    data: AttachmentErrorCodeType = "DIRECT_CONNECT_GATEWAY_EXISTING_ATTACHMENTS"
    ```
