...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_opensearch/literals/)
...
Usage::
    ...
    data: AWSServicePrincipalType = "application.opensearchservice.amazonaws.com"
    ```
...
AppConfigTypeType = Literal[
    "opensearchDashboards.dashboardAdmin.groups", "opensearchDashboards.dashboardAdmin.users"
]
