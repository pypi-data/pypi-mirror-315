...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_license_manager_user_subscriptions/literals/)
...
Usage::
    ...
    data: ActiveDirectoryTypeType = "AWS_MANAGED"
    ```
...
__all__ = (
    ...
    "ListLicenseServerEndpointsPaginatorName",
...
ActiveDirectoryTypeType = Literal["AWS_MANAGED", "SELF_MANAGED"]
LicenseServerEndpointProvisioningStatusType = Literal[
    "DELETED", "DELETING", "DELETION_FAILED", "PROVISIONED", "PROVISIONING", "PROVISIONING_FAILED"
]
LicenseServerHealthStatusType = Literal["HEALTHY", "NOT_APPLICABLE", "UNHEALTHY"]
ListIdentityProvidersPaginatorName = Literal["list_identity_providers"]
ListInstancesPaginatorName = Literal["list_instances"]
ListLicenseServerEndpointsPaginatorName = Literal["list_license_server_endpoints"]
...
ServerTypeType = Literal["RDS_SAL"]
