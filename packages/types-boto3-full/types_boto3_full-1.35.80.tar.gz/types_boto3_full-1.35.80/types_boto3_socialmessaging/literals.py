"""
Type annotations for socialmessaging service literal definitions.

[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_socialmessaging/literals/)
...
Usage::
    ...
    data: ListLinkedWhatsAppBusinessAccountsPaginatorName = "list_linked_whatsapp_business_accounts"
    ```
