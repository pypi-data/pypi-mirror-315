...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_resource_groups/literals/)
...
GroupingStatusType = Literal["FAILED", "IN_PROGRESS", "SKIPPED", "SUCCESS"]
GroupingTypeType = Literal["GROUP", "UNGROUP"]
ListGroupResourcesPaginatorName = Literal["list_group_resources"]
ListGroupingStatusesFilterNameType = Literal["resource-arn", "status"]
ListGroupingStatusesPaginatorName = Literal["list_grouping_statuses"]
ListGroupsPaginatorName = Literal["list_groups"]
ListTagSyncTasksPaginatorName = Literal["list_tag_sync_tasks"]
...
TagSyncTaskStatusType = Literal["ACTIVE", "ERROR"]
