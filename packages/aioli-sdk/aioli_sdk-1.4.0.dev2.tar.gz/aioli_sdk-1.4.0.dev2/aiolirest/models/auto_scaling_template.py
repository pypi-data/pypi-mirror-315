...
class AutoScalingTemplate(BaseModel):
    ...
    modified_at: Optional[StrictStr] = Field(default=None, description="Date-time of last modification of the template. This is a read-only field and is automatically updated.", alias="modifiedAt")
    ...
    __properties: ClassVar[List[str]] = ["autoScaling", "description", "modifiedAt", "name"]
