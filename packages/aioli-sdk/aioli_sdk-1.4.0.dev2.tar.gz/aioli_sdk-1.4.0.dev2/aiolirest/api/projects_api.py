...
"""
    ...
    The version of the OpenAPI document: 1.4.0-dev2
...
class ProjectsApi:
    ...
    def projects_get(
        ...
        Return the properties of all configured projects. Results are sorted by modifiedAt descending.
    ...
    def projects_id_get(
        ...
        Return the properties of the project by ID.
    ...
    def projects_id_put(
        self,
        id: Annotated[StrictStr, Field(description="Project ID")],
        project: Annotated[ProjectRequest, Field(description="Project Data")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Update a project by providing an updated Project object.  This is normally obtained by a prior get operation, and then selectively modifying properties of the returned Project.

        :param id: Project ID (required)
        :type id: str
        :param project: Project Data (required)
        :type project: ProjectRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def projects_post(
        ...
        Provide the details of the project to be created.
