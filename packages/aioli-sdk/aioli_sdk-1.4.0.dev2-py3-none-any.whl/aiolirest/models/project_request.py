...
class ProjectRequest(BaseModel):
    ...
    owner: Optional[StrictStr] = Field(default=None, description="Project owner name or ID. If not specified, created for current user.")
    __properties: ClassVar[List[str]] = ["description", "name", "owner"]
