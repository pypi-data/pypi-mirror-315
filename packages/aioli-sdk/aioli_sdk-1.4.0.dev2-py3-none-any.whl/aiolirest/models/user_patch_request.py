...
class UserPatchRequest(BaseModel):
    ...
    default_project: Optional[StrictStr] = Field(default=None, alias="defaultProject")
    display_name: Optional[StrictStr] = None
    is_hashed: Optional[StrictBool] = Field(default=None, alias="isHashed")
    password: Optional[StrictStr] = None
    username: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["active", "defaultProject", "display_name", "isHashed", "password", "username"]
