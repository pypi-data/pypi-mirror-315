...
def _get_open_connections(client: Identety | AsyncIdentety) -> int:
...
class TestIdentety:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "identety/_legacy_response.py",
                        "identety/_response.py",
    ...
    def test_base_url_trailing_slash(self, client: Identety) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Identety) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Identety) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_omit_retry_count_header(
        self, client: Identety, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
