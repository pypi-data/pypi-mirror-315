...
But the invariant will complain if that isn't true.
    ...
    Traceback (most recent call last):
      ...
    zope.interface.exceptions.Invalid: InvalidAuthorEntry doesn't provide its
    ICookbookEntry schema.
...
'home page' for the web service.
    ...
    >>> representation = json.loads(response.decode())
...
a JSON hash containing a list of entries.
    ...
    >>> response = operation()
    >>> pprint_collection(json.loads(response))
    start: ...
    total_size: 2
    ---
    ...
...
'author_link' field to point to another author.
    ...
    ...         body=json.dumps(representation).encode(),
...
Now you don't.
    ...
    Traceback (most recent call last):
    ...
    zope.publisher.interfaces.NotFound: ... name: ...'recipes/Foies de
    voilaille en aspic'
