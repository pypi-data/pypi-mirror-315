...
Here's the service root resource.
    ...
    >>> body = json.loads(resource().decode())
...
object's URL.
    ...
    >>> body = json.loads(resource().decode(), object_pairs_hook=OrderedDict)
    >>> list(body)
...
service will fail.
    ...
    Object: <PostBetaServiceRootResource...>, name: ...'contact_list'
...
to traverse to its 'beta' name ('fax') will fail.
    ...
    ...
    zope.publisher.interfaces.NotFound:
    Object: <Contact object...>, name: ...'fax'
...
version.
    ...
    ...
    zope.publisher.interfaces.NotFound:
    Object: <Contact object...>, name: ...'fax_number'
