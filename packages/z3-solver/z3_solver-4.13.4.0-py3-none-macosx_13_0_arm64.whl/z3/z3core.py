...
_lib.Z3_mk_datatype_sort.argtypes = [ContextObj, Symbol]
...
_lib.Z3_solver_solve_for.restype = Ast
_lib.Z3_solver_solve_for.argtypes = [ContextObj, SolverObj, Ast]
...
def Z3_mk_datatype_sort(a0, a1, _elems=Elementaries(_lib.Z3_mk_datatype_sort)):
  r = _elems.f(a0, a1)
  _elems.Check(a0)
  return r
...
def Z3_solver_solve_for(a0, a1, a2, _elems=Elementaries(_lib.Z3_solver_solve_for)):
  r = _elems.f(a0, a1, a2)
  _elems.Check(a0)
  return r
