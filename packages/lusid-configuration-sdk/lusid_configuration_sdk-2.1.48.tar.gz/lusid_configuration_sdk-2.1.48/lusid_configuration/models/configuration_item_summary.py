...
class ConfigurationItemSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigurationItemSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigurationItemSummary:
        """Create an instance of ConfigurationItemSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigurationItemSummary.parse_obj(obj)

        _obj = ConfigurationItemSummary.parse_obj({
            "key": obj.get("key"),
            "value": obj.get("value"),
