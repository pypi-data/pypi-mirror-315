...
class ResourceListOfConfigurationItem(BaseModel):
    ...
    """
    values: conlist(ConfigurationItem) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfConfigurationItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfConfigurationItem:
        """Create an instance of ResourceListOfConfigurationItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfConfigurationItem.parse_obj(obj)

        _obj = ResourceListOfConfigurationItem.parse_obj({
            "values": [ConfigurationItem.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
