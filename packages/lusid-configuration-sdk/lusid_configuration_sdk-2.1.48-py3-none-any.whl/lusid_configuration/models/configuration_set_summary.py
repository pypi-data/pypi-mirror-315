...
class ConfigurationSetSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigurationSetSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigurationSetSummary:
        """Create an instance of ConfigurationSetSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigurationSetSummary.parse_obj(obj)

        _obj = ConfigurationSetSummary.parse_obj({
