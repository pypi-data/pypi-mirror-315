...
class ResourceListOfConfigurationSet(BaseModel):
    ...
    """
    values: conlist(ConfigurationSet) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfConfigurationSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfConfigurationSet:
        """Create an instance of ResourceListOfConfigurationSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfConfigurationSet.parse_obj(obj)

        _obj = ResourceListOfConfigurationSet.parse_obj({
            "values": [ConfigurationSet.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
