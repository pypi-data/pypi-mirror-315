...
from vincam._libs.d3d11 import *
from vincam._libs.dxgi import *
from vincam.core.device import Device
from vincam.core.output import Output
    ...
    def update_frame(self):
            ...
            try:
                ...
                if ctypes.c_int32(DXGI_ERROR_ACCESS_LOST).value == ce.args[0]:
                    return False
                elif ctypes.c_int32(DXGI_ERROR_WAIT_TIMEOUT).value == ce.args[0]:
                    self.updated = False
                    return True
                else:
                    pass
