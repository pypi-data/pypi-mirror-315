...
import { h as BlockTitle, C as Clear, w as Send, x as Square, B as Block, S as Static } from "./2.Day3wOGA.js";
import { F as File } from "./File.DqOJDDoa.js";
import { M as Music } from "./Music.BKn1BNLT.js";
import { V as Video } from "./Video.CzEOFOtQ.js";
import { U as Upload } from "./Upload.CZByIdhD.js";
/* empty css                                                    */
import { I as Image } from "./Image.eJ_qOnkr.js";
/* empty css                                                    */
import { default as default2 } from "./Example.o6E9Zspz.js";
...
function create_if_block_5(ctx) {
  ...
  return {
    ...
    h() {
      attr(div, "class", "thumbnails scroll-hide svelte-cgv3eu");
...
function create_each_block(ctx) {
  ...
  const if_block_creators = [create_if_block_7, create_if_block_8, create_if_block_9, create_else_block_2];
  const if_blocks = [];
  function select_block_type(ctx2, dirty) {
    ...
    if (show_if == null)
      show_if = !!/*file*/
      (ctx2[60].mime_type && /*file*/
      ctx2[60].mime_type.includes("image"));
    if (show_if)
      return 0;
    if (show_if_1 == null)
      show_if_1 = !!/*file*/
      (ctx2[60].mime_type && /*file*/
      ctx2[60].mime_type.includes("audio"));
    if (show_if_1)
      return 1;
    if (show_if_2 == null)
      show_if_2 = !!/*file*/
      (ctx2[60].mime_type && /*file*/
      ctx2[60].mime_type.includes("video"));
    if (show_if_2)
      return 2;
    return 3;
  }
  ...
  return {
    ...
    h() {
      attr(button0, "class", "delete-button svelte-cgv3eu");
      toggle_class(
        button0,
        "disabled",
        /*disabled*/
      ...
      attr(button1, "class", "thumbnail-item thumbnail-small svelte-cgv3eu");
...
function create_if_block_6(ctx) {
  ...
  return {
    ...
    h() {
      attr(div, "class", "loader svelte-cgv3eu");
...
function create_if_block_4(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(button, "class", "upload-button svelte-cgv3eu");
    },
    m(target, anchor) {
...
function create_if_block_2(ctx) {
  ...
  return {
    ...
    h() {
      attr(button, "class", "submit-button svelte-cgv3eu");
      toggle_class(
        button,
        "padded-button",
        /*submit_btn*/
...
function create_if_block$1(ctx) {
  ...
  return {
    ...
    h() {
      attr(button, "class", "stop-button svelte-cgv3eu");
      toggle_class(
        button,
        "padded-button",
        /*stop_btn*/
...
function create_fragment$1(ctx) {
  ...
  let if_block0 = (
    /*value*/
    (ctx[0].files.length > 0 || /*uploading*/
    ctx[24]) && create_if_block_5(ctx)
  );
  let if_block1 = !/*disabled*/
  ctx[4] && !/*file_count*/
  (ctx[20] === "single" && /*value*/
  ctx[0].files.length > 0) && create_if_block_4(ctx);
  let if_block2 = (
    /*submit_btn*/
  ...
  return {
    ...
    h() {
      ...
      attr(textarea, "class", "scroll-hide svelte-cgv3eu");
      ...
      ctx[7]);
      attr(div0, "class", "input-container svelte-cgv3eu");
      toggle_class(
        label_1,
        "container",
        /*container*/
      ...
      attr(div1, "class", "full-container svelte-cgv3eu");
    ...
    p(ctx2, dirty) {
      ...
      if (!/*disabled*/
      ctx2[4] && !/*file_count*/
      (ctx2[20] === "single" && /*value*/
      ctx2[0].files.length > 0)) {
        if (if_block1) {
          if_block1.p(ctx2, dirty);
          if (dirty[0] & /*disabled, file_count, value*/
          1048593) {
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("max_plain_text_length" in $$props2)
      $$invalidate(40, max_plain_text_length = $$props2.max_plain_text_length);
  ...
  $$self.$$.update = () => {
    ...
    1024) {
      if (oldValue !== value.text) {
        dispatch("change", value);
        $$invalidate(41, oldValue = value.text);
      }
    }
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      134217728)
        ...
        ctx2[27] ? "focus" : "base";
      if (dirty[0] & /*file_types, root, label, info, show_label, lines, rtl, text_align, max_lines, placeholder, submit_btn, stop_btn, autofocus, container, autoscroll, file_count, gradio, interactive, max_plain_text_length, value, value_is_output, dragging, loading_status*/
      268386247 | dirty[1] & /*$$scope*/
      2048) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("max_plain_text_length" in $$props2)
      $$invalidate(26, max_plain_text_length = $$props2.max_plain_text_length);
  };
  return [
    value,
    value_is_output,
