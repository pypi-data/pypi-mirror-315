import { B as Block, S as Static, W as BlockTitle, g as Empty, ao as LineChart, a6 as globals } from './2-BHQ5_Fzx.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-CieW47Db.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index23-wUp-GTiU.js.map
