...
import { B as Block, S as Static, J as MarkdownCode } from './2-BHQ5_Fzx.js';
import { d as dequal } from './index6-sfNUnwRZ.js';
import { U as Upload } from './ModifyUpload-GcZjrOvZ.js';
...
const Table = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = ` <div class="${["svelte-1pch949", label && label.length !== 0 ? "label" : ""].join(" ").trim()}">${label && label.length !== 0 && show_label ? `<p class="svelte-1pch949">${escape(label)}</p>` : ``} <div class="${[
      "table-wrap svelte-1pch949",
      (dragging ? "dragging" : "") + " " + (!wrap ? "no-wrap" : "")
    ].join(" ").trim()}" style="${"height:" + escape(table_height, true) + "px"}" role="grid" tabindex="0"${add_attribute("this", parent, 0)}><table class="${["svelte-1pch949", column_widths.length != 0 ? "fixed-layout" : ""].join(" ").trim()}"${add_attribute("this", table, 0)}>${label && label.length !== 0 ? `<caption class="sr-only">${escape(label)}</caption>` : ``} <thead class="svelte-1pch949"><tr class="svelte-1pch949">${each(_headers, ({ value, id }, i) => {
      return `<th${add_attribute("aria-sort", get_sort_status(), 0)} class="${["svelte-1pch949", header_edit === i ? "editing" : ""].join(" ").trim()}"${add_styles({
        "width": column_widths.length ? column_widths[i] : void 0
      })}><div class="cell-wrap svelte-1pch949">${validate_component(EditableCell, "EditableCell").$$render(
        $$result,
        {
          value,
          latex_delimiters,
        ...
        "sort-button " + escape(sort_direction, true) + " svelte-1pch949",
        (sort_by === i ? "sorted" : "") + " " + (sort_by === i && sort_direction === "des" ? "des" : "")
      ].join(" ").trim()}"><svg width="1em" height="1em" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-1pch949"><path d="M4.49999 0L8.3971 6.75H0.602875L4.49999 0Z"></path></svg> </div></div> </th>`;
    })}</tr></thead> <tbody><tr class="svelte-1pch949">${each(max, ({ value, id }, j) => {
      return `<td tabindex="-1" class="svelte-1pch949"${add_attribute("this", cells[j], 0)}><div class="cell-wrap svelte-1pch949">${validate_component(EditableCell, "EditableCell").$$render(
        $$result,
        {
          value,
          latex_delimiters,
      ...
      },
      {
        default: () => {
          return `${validate_component(VirtualTable, "VirtualTable").$$render(
            ...
            {
              tbody: ({ index, item }) => {
                return `<tr slot="tbody" class="${["svelte-1pch949", index % 2 === 0 ? "row_odd" : ""].join(" ").trim()}">${each(item, ({ value, id }, j) => {
                  return `<td tabindex="0"${add_styles(merge_ssr_styles(escape(styling?.[index]?.[j] || "", true), { "width": `var(--cell-width-${j})` }))} class="${[
                  ...
                  ].join(" ").trim()}"><div class="cell-wrap svelte-1pch949">${validate_component(EditableCell, "EditableCell").$$render(
                    $$result,
                    {
                      display_value: display_value?.[index]?.[j],
                      latex_delimiters,
                    ...
                    {}
                  )} ${editable ? `<button class="cell-menu-button svelte-1pch949" data-svelte-h="svelte-b4o3eq">⋮
									</button>` : ``}</div> </td>`;
                })}</tr>`;
              },
              thead: () => {
                return `<tr slot="thead" class="svelte-1pch949">${each(_headers, ({ value, id }, i) => {
                  return `<th${add_attribute("aria-sort", get_sort_status(), 0)} style="${"width: var(--cell-width-" + escape(i, true) + ");"}" class="${[
                  ...
                  ].join(" ").trim()}"><div class="cell-wrap svelte-1pch949"><div class="header-content svelte-1pch949">${validate_component(EditableCell, "EditableCell").$$render(
                    $$result,
                    {
                      latex_delimiters,
                      line_breaks,
                    ...
                    "sort-button " + escape(sort_direction, true) + " svelte-1pch949",
                    (sort_by === i ? "sorted" : "") + " " + (sort_by === i && sort_direction === "des" ? "des" : "")
                  ].join(" ").trim()}"><svg width="1em" height="1em" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-1pch949"><path d="M4.49999 0L8.3971 6.75H0.602875L4.49999 0Z"></path></svg> </div></div> ${editable ? `<button class="cell-menu-button svelte-1pch949" data-svelte-h="svelte-1e92k9i">⋮
									</button>` : ``}</div> </th>`;
                })}</tr>`;
              },
              default: () => {
...
//# sourceMappingURL=Index53-CfGKrgnC.js.map
