...
from clusterondemand.configuration import DEFAULT_DISK_SETUP, DEFAULT_DISK_SETUP_10_AND_ABOVE
...
def _get_node_disk_setup(bright_version: str) -> str:
    if config["node_disk_setup_path"]:
        ...
        elif bright_version and BcmVersion(bright_version) >= BcmVersion("10.0"):
