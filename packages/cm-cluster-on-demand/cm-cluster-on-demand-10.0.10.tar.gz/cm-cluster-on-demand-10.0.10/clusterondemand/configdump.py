...
from clusterondemandconfig.command_context import CommandContext
...
def run_command() -> None:
    ...
    print(full_ini_config_dump(config_to_dump, show_secrets=config["show_secrets"]))  # type: ignore
