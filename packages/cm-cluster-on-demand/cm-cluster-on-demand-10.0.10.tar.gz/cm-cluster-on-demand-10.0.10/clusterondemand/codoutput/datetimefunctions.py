...
def format_datetime(date_time: datetime, format: str = DATE_TIME_FORMAT, tzinfo: tzinfo | None = None) -> str:
...
def get_datetime_ago(then_datetime: datetime, now_datetime: datetime | None = None) -> str:
    """
