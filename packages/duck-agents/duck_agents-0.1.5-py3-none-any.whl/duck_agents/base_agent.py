...
class BaseAgent:
    def __init__(
        ...
        input_schema_json = json.dumps(self.input_schema.model_json_schema())
        self.prompt_template = ChatPromptTemplate.from_messages(
            [("system", _system_prompt_template.format(task_description=task_description,
    ...
    def prompt(self, data: BaseModel) -> BaseModel:
        return self.chain.invoke({"data": data.model_dump_json()})