...
class DataTfeOutputs(
    ...
    def __init__(
        ...
        *,
        ...
        :param workspace: The workspace to fetch the remote state from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/data-sources/outputs#workspace DataTfeOutputs#workspace}
        :param organization: The organization to fetch the remote state from. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/data-sources/outputs#organization DataTfeOutputs#organization}
        :param values: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/data-sources/outputs#values DataTfeOutputs#values}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataTfeOutputs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/data-sources/outputs#import import section} in the documentation of this resource for the id to use
