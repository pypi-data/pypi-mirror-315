...
class Stack(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Name of the Stack. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#name Stack#name}
        :param project_id: ID of the project that the Stack belongs to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#project_id Stack#project_id}
        :param description: Description of the Stack. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#description Stack#description}
        :param vcs_repo: vcs_repo block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#vcs_repo Stack#vcs_repo}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Stack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#import import section} in the documentation of this resource for the id to use
    ...
    def put_vcs_repo(
        ...
        *,
        ...
        '''
        :param identifier: Identifier of the VCS repository. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#identifier Stack#identifier}
        :param branch: The repository branch that Terraform should use. This defaults to the respository's default branch (e.g. main). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#branch Stack#branch}
        :param github_app_installation_id: The installation ID of the GitHub App. This conflicts with ``oauth_token_id`` and can only be used if ``oauth_token_id`` is not used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#github_app_installation_id Stack#github_app_installation_id}
        :param oauth_token_id: The VCS Connection to use. This ID can be obtained from a ``tfe_oauth_client`` resource. This conflicts with ``github_app_installation_id`` and can only be used if ``github_app_installation_id`` is not used. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/stack#oauth_token_id Stack#oauth_token_id}
        '''
        value = StackVcsRepo(
