...
class WorkspaceRunTask(
    ...
    def __init__(
        ...
        *,
        ...
        :param enforcement_level: The enforcement level of the task. Valid values are ``advisory`` and ``mandatory``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/workspace_run_task#enforcement_level WorkspaceRunTask#enforcement_level}
        :param task_id: The id of the Run task to associate to the Workspace. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/workspace_run_task#task_id WorkspaceRunTask#task_id}
        :param workspace_id: The id of the workspace to associate the Run task to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/workspace_run_task#workspace_id WorkspaceRunTask#workspace_id}
        :param stage: The stage to run the task in. Valid values are ``pre_plan``, ``post_plan``, ``pre_apply`` and ``post_apply``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/workspace_run_task#stage WorkspaceRunTask#stage}
        :param stages: The stages to run the task in. Valid values are ``pre_plan``, ``post_plan``, ``pre_apply`` and ``post_apply``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/workspace_run_task#stages WorkspaceRunTask#stages}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing WorkspaceRunTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/workspace_run_task#import import section} in the documentation of this resource for the id to use
