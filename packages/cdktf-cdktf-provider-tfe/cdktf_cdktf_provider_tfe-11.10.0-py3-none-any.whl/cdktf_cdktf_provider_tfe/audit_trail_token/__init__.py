...
class AuditTrailToken(
    ...
    def __init__(
        ...
        *,
        ...
        :param expired_at: The time when the audit trail token will expire. This must be a valid ISO8601 timestamp. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/audit_trail_token#expired_at AuditTrailToken#expired_at}
        :param force_regenerate: When set to true will force the audit trail token to be recreated. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/audit_trail_token#force_regenerate AuditTrailToken#force_regenerate}
        :param organization: Name of the organization. If omitted, organization must be defined in the provider config. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/audit_trail_token#organization AuditTrailToken#organization}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AuditTrailToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tfe/0.61.0/docs/resources/audit_trail_token#import import section} in the documentation of this resource for the id to use
