...
class SearchResultItem(BaseModel):
    ...
    oneof_schema_41_validator: Optional[InVitroSystem] = None
    # data type: MultiplexedSample
    oneof_schema_42_validator: Optional[MultiplexedSample] = None
    # data type: PrimaryCell
    oneof_schema_43_validator: Optional[PrimaryCell] = None
    # data type: TechnicalSample
    oneof_schema_44_validator: Optional[TechnicalSample] = None
    # data type: Tissue
    oneof_schema_45_validator: Optional[Tissue] = None
    # data type: WholeOrganism
    oneof_schema_46_validator: Optional[WholeOrganism] = None
    # data type: Software
    oneof_schema_47_validator: Optional[Software] = None
    # data type: SoftwareVersion
    oneof_schema_48_validator: Optional[SoftwareVersion] = None
    # data type: Source
    oneof_schema_49_validator: Optional[Source] = None
    # data type: Treatment
    oneof_schema_50_validator: Optional[Treatment] = None
    # data type: User
    oneof_schema_51_validator: Optional[User] = None
    # data type: Workflow
    oneof_schema_52_validator: Optional[Workflow] = None
