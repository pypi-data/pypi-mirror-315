...
class ConstructLibrarySet(BaseModel):
    ...
    def selection_criteria_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['accessible genome regions', 'candidate cis-regulatory elements', 'controls', 'chromatin states', 'phenotype-associated variants', 'DNase hypersensitive sites', 'genes', 'histone modifications', 'protein interactors', 'sequence variants', 'synthetic elements', 'transcription start sites', 'TF binding sites']):
