...
class Atlaz:
    ...
    def create_completion(self, source_text: str, customization: str = None):
        ...
        if not self.auth_token:
            print("You must authenticate before calling the API.")
            self.authenticate()
            if not self.auth_token:
                    ...
                    if line:
                        try:
                            ...
                            if status == "completed":
                                ...
                                logging.warning(f"Received unexpected status: {status}")
