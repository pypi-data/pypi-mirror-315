...
class ArtifactApi:
    ...
    async def artifact_create(
        ...
        create_artifactt_request: Annotated[CreateArtifacttRequest, Field(description="创建博客文章")],
        ...
        :type tenant: str
        :param create_artifactt_request: 创建博客文章 (required)
        :type create_artifactt_request: CreateArtifacttRequest
        ...
        _param = self._artifact_create_serialize(
            tenant=tenant,
            create_artifactt_request=create_artifactt_request,
    ...
    @validate_call
    async def artifact_create_with_http_info(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        create_artifactt_request: Annotated[CreateArtifacttRequest, Field(description="创建博客文章")],
        _request_timeout: Union[
    ...
    @validate_call
    async def artifact_create_without_preload_content(
        self,
        tenant: Annotated[str, Field(min_length=36, strict=True, max_length=36, description="The tenant id")],
        create_artifactt_request: Annotated[CreateArtifacttRequest, Field(description="创建博客文章")],
        _request_timeout: Union[
    ...
    def _artifact_create_serialize(
        self,
        tenant,
        create_artifactt_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_artifactt_request is not None:
            _body_params = create_artifactt_request
