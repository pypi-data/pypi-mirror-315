...
class AgentNode(BaseModel):
    ...
    name: StrictStr = Field(description="agent 节点名称, 或者作为工具名称")
    ...
    next_id: Optional[StrictStr] = Field(default=None, description="(暂时没起作用)下一个节点ID", alias="nextId")
    prev_id: Optional[StrictStr] = Field(default=None, description="(暂时没起作用)上一个节点ID", alias="prevId")
    output: Optional[AgentNodeOutput] = None
    input: Optional[AgentNodeInput] = None
    __properties: ClassVar[List[str]] = ["metadata", "name", "description", "steps", "finish", "nextId", "prevId", "output", "input"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "output": AgentNodeOutput.from_dict(obj["output"]) if obj.get("output") is not None else None,
            "input": AgentNodeInput.from_dict(obj["input"]) if obj.get("input") is not None else None
        })
        return _obj
