...
__all__ = ["CODE_GENERATION_PROMPT","CODE_EXPLANATION_CLAUDE_PROMPT","TECHNICAL_EXPLANATIONS","PYTHON_CODER_PROMPT","PREVIEW_SYS_PROMPT","CLAUDE_SYS_PROMPT","PREDICTIVE_QUESTION_REASONING_PROMPT","BRAINSTROM_BUDDY_PROMPT","AI_TECH_LEAD_PROMPT"]
