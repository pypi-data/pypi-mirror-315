...
class JsArray(JsObject.JsObject):
    ...
    def length(self):
        ...
        `w3schools <https://www.w3schools.com/JS/js_arrays.asp>`_
    ...
    def some_(self, js_funcs: Union[list, str]):
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_some.asp>`_
    ...
    def every_(
            self, js_funcs: Union[list, str], js_value: Optional[str] = None, profile: Union[dict, bool] = False
    ) -> JsFncs.JsFunction:
        """The every() method checks if all elements in an array pass a test (provided as a function).
        Data Structure used in this method is like obj(val, index, array)
        `w3schools <https://www.w3schools.com/jsref/jsref_every.asp>`_
    ...
    def filter_(
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_filter.asp>`_
    ...
    def find(self, js_funcs: Union[list, str]) -> str:
        """The find() method returns the value of the first element in an array that pass a test (provided as a function)
        `w3schools <https://www.w3schools.com/jsref/jsref_find.asp>`_
    ...
    def findIndex(self, js_funcs: Union[list, str], profile: Union[dict, bool] = False) -> JsFncs.JsFunction:
        """The find() method returns the value of the first element in an array that pass a test (provided as a function).
    `w3schools <https://www.w3schools.com/jsref/jsref_findindex.asp>`_
    ...
    def forEach(
            self, js_funcs: Union[list, str], value: str = "value", profile: Union[dict, bool] = False
    ) -> JsFncs.JsFunction:
        """The forEach() method calls a provided function once for each element in an array, in order.
        `w3schools <https://www.w3schools.com/jsref/jsref_foreach.asp>`_
    ...
    def map(self, js_funcs: Union[list, str], profile: Union[dict, bool] = False):
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_map.asp>`_
    ...
    def sort(self, js_funcs: Union[list, str], profile: Union[dict, bool] = False):
        ...
        `w3schools <https://www.w3schools.com/js/js_array_sort.asp>`_
    ...
    def reduce(self, js_funcs: Union[list, str], profile: Union[dict, bool] = False):
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_reduce.asp>`_
    ...
    def shift(self) -> JsObject.JsObject:
        """The shift() method removes the first item of an array.
        `w3schools <https://www.w3schools.com/jsref/jsref_shift.asp>`_
    ...
    def slice(self, start: Union[primitives.JsDataModel, int], end: Union[primitives.JsDataModel, int]):
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_slice_array.asp>`_
    ...
    def pop(self):
        ...
        `w3schools <https://www.w3schools.com/js/js_array_methods.asp>`_
    ...
    def delete(self, value: Union[float, primitives.JsDataModel]) -> JsFncs.JsFunction:
    ...
    def join(self, sep: Union[primitives.JsDataModel, str]):
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_join.asp>`_
    ...
    def copyWithin(self, start: Union[primitives.JsDataModel, int] = 0,
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_copywithin.asp>`_
    ...
    def fill(self, data: primitives.JsDataModel, start: Union[primitives.JsDataModel, int] = 0,
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_fill.asp>`_
    ...
    def concat(self, *args):
        ...
        arrays.
        `w3schools <https://www.w3schools.com/jsref/jsref_concat_array.asp>`_
    ...
    def append(self, js_obj, val: Union[primitives.JsDataModel, str]):
        ...
        `w3schools Array <https://www.w3schools.com/js/js_array_methods.asp>`_
        `w3schools Append <https://www.w3schools.com/python/ref_list_append.asp>`_
    ...
    def flat(self, depth: Union[primitives.JsDataModel, int] = 1):
        ...
        specified depth.
        `Mozilla <https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/flat>`_
    ...
    def flatMap(self, js_funcs: Union[list, str], profile: Union[dict, bool] = False):
        ...
        `Mozilla <https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/flatMap>`_
    ...
    def includes(self, element: Union[primitives.JsDataModel, str], start: int = 0):
        ...
        `w3schools <https://www.w3schools.com/jsref/jsref_includes_array.asp>`_
    ...
    def unique(self, js_obj):
        ...
        """
        js_obj.extendProto(self, "unique", '''var arrayResult = [];this.forEach(function(item){
if(arrayResult.indexOf(item) < 0){arrayResult.push(item)}}); return arrayResult''')
    ...
    def contains(self, js_obj, data: primitives.JsDataModel):
        """Prototype Extension. Alternative to the includes function and compatible with all the browsers
...
var i = this.length; while (i--){if (this[i] === obj){return true}}; return false''', pmts=["data"])
        return JsBoolean.JsBoolean("%s.contains(%s)" % (self.varId, JsUtils.jsConvertData(data, None)),
                                   is_py_data=False)
    ...
    def sample(self, n: Union[int, primitives.JsDataModel] = None, page: Optional[primitives.PageModel] = None):
        ...
        `underscorejs <https://underscorejs.org/#arrays>`_
    ...
    def chunk(self, n: Union[int, primitives.JsDataModel] = None, page: Optional[primitives.PageModel] = None):
        ...
        `underscorejs <https://underscorejs.org/#chunk>`_
    ...
    def initial(self, n: Union[int, primitives.JsDataModel] = None, page: Optional[primitives.PageModel] = None):
        ...
        `underscorejs <https://underscorejs.org/#initial>`_
    ...
    def where(self, values: Union[list, primitives.JsDataModel] = None, page: Optional[primitives.PageModel] = None):
        ...
        `underscorejs <https://underscorejs.org/#where>`_
    ...
    def intersection(self, arrays: Union[primitives.JsDataModel, list] = None,
        ...
        """Computes the union of the passed-in arrays: the list of unique items, in order, that are present in one or more
        of the arrays.
        `underscorejs <https://underscorejs.org/#intersection>`_
    ...
    def every(self):
        ...
        Short-circuits and stops traversing the list if a false element is found. predicate is transformed through
    ...
    def some(self):
        ...
        Short-circuits and stops traversing the list if a true element is found. predicate is transformed through
        iteratee to facilitate shorthand syntaxes.
        """
    ...
    def object(self, keys: list, page: Optional[primitives.PageModel] = None):
        ...
        of values. Passing by pairs is the reverse of pairs. If duplicate keys exist, the last value wins.
        `underscorejs <https://underscorejs.org/#arrays>`_
...
class JsRecordSet(JsArray):
    ...
    def distinct(self, col_name: Union[primitives.JsDataModel, str]):
        ...
        return JsArray.get(
            "(function(data){var result = {}; data.forEach(function(rec){result[rec[%s]] = true}); return Object.keys(result).sort() })(%s)" % (
            col_name, self.toStr()))
    ...
    def to_dict(self, col_name: Union[primitives.JsDataModel, str], value_name: Union[primitives.JsDataModel, str]):
        ...
        return JsArray.get(
            "(function(data){var result = {}; data.forEach(function(rec){if (!(rec[%(col)s] in result)){result[rec[%(col)s]] = 0}; result[rec[%(col)s]] += parseFloat(rec[%(val)s])}); return result })(%(record)s)" % {
                "col": col_name, "val": value_name, "record": self.toStr()})
