...
class MomentDate(JsPackage):
    ...
    def week(self, number: float = None):
        ...
        `momentjs <https://momentjs.com/docs/#/get-set/week/>`_
    ...
    def weekYear(self, number: float = None):
        ...
        `momentjs <https://momentjs.com/docs/#/get-set/week-year/>`_
    ...
    def get(self, text: str):
        """Getter.
        `momentjs <https://momentjs.com/docs/#/get-set/iso-weeks-in-year/>`_
    ...
    def isoWeekYear(self, number: float = None):
        ...
        `momentjs <https://momentjs.com/docs/#/get-set/iso-week-year/>`_
    ...
    def weeksInYear(self) -> JsObjects.JsNumber.JsNumber:
        ...
        `momentjs <https://momentjs.com/docs/#/get-set/weeks-in-year/>`_
        """
    ...
    def minutes(self, number=None):
        """Gets or sets the minutes. Accepts numbers from 0 to 59. If the range is exceeded, it will bubble up to the
        hour.
    ...
    def millisecond(self, number=None):
        """Gets or sets the milliseconds. Accepts numbers from 0 to 999. If the range is exceeded, it will bubble up
        to the seconds.
    ...
    def milliseconds(self, number=None):
        """Gets or sets the milliseconds. Accepts numbers from 0 to 999. If the range is exceeded, it will bubble up to
        the seconds.
...
class Moment(JsPackage):
    ...
    def time(self, hour: int, minute: int, second: int, js_code: str = None) -> MomentDate:
        ...
        if js_code is not None:
            return MomentDate(
                selector="moment().hour(%s).minute(%s).second(%s)" % (hour, minute, second), js_code=js_code,
                set_var=True)
    ...
    def parseZone(self, date=None, format=None, js_code=None) -> MomentDate:
        ...
        if js_code is not None:
            return MomentDate(selector="%s.parseZone(%s, %s)" % (self.varId, date, format), js_code=js_code,
                              set_var=True)
