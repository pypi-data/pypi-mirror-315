...
class OptionZaxisTitleStyle(Options):
...
class OptionZaxisPlotlinesLabels(Options):
...
class OptionZaxisPlotlinesLabel(Options):
...
class OptionZaxisPlotlinesEvents(Options):
...
class OptionZaxisPlotlines(Options):
    ...
    @property
    def events(self) -> 'OptionZaxisPlotlinesEvents':
        """An object defining mouse events for the plot line. """
        return self._config_sub_data("events", OptionZaxisPlotlinesEvents)
    ...
    @property
    def label(self) -> 'OptionZaxisPlotlinesLabel':
        """Text labels for the plot bands. """
        return self._config_sub_data("label", OptionZaxisPlotlinesLabel)

    @property
    def labels(self) -> 'OptionZaxisPlotlinesLabels':
        """. """
        return self._config_sub_data("labels", OptionZaxisPlotlinesLabels)
...
class OptionZaxisPlotbandsEvents(Options):
...
class OptionZaxisPlotbands(Options):
    ...
    @property
    def events(self) -> 'OptionZaxisPlotbandsEvents':
        """An object defining mouse events for the plot band. """
        return self._config_sub_data("events", OptionZaxisPlotbandsEvents)
    ...
    @property
    def label(self) -> 'OptionZaxisPlotbandsLabel':
        """Text labels for the plot bands. """
        return self._config_sub_data("label", OptionZaxisPlotbandsLabel)
...
class OptionZaxisLabelsStyle(Options):
...
class OptionZaxisLabels(Options):
    ...
    @property
    def style(self) -> 'OptionZaxisLabelsStyle':
        """CSS styles for the label. """
        return self._config_sub_data("style", OptionZaxisLabelsStyle)
...
class OptionZaxisDatetimelabelformatsDay(Options):
...
class OptionZaxisDatetimelabelformatsHour(Options):
...
class OptionZaxisAccessibility(Options):
...
class OptionZaxisEvents(Options):
...
class OptionZaxis(Options):

    @property
    def accessibility(self) -> 'OptionZaxisAccessibility':
        """Accessibility options for an axis. """
        return self._config_sub_data("accessibility", OptionZaxisAccessibility)
    ...
    @property
    def dateTimeLabelFormats(self) -> 'OptionZaxisDatetimelabelformats':
        """For a datetime axis, the scale will automatically adjust to the appropriate unit. """
        return self._config_sub_data("dateTimeLabelFormats", OptionZaxisDatetimelabelformats)
    ...
    @property
    def events(self) -> 'OptionZaxisEvents':
        """Event handlers for the axis. """
        return self._config_sub_data("events", OptionZaxisEvents)
    ...
    @property
    def labels(self) -> 'OptionZaxisLabels':
        """The axis labels show the number or category for each tick. """
        return self._config_sub_data("labels", OptionZaxisLabels)
    ...
    @property
    def plotBands(self) -> 'OptionZaxisPlotbands':
        """An array of colored bands stretching across the plot area marking an interval on the axis. """
        return self._config_sub_data("plotBands", OptionZaxisPlotbands)

    @property
    def plotLines(self) -> 'OptionZaxisPlotlines':
        """An array of lines stretching across the plot area, marking a specific value on one of the axes. """
        return self._config_sub_data("plotLines", OptionZaxisPlotlines)
    ...
    @property
    def title(self) -> 'OptionZaxisTitle':
        """The axis title, showing next to the axis line. """
        return self._config_sub_data("title", OptionZaxisTitle)
...
class OptionZaxisDatetimelabelformatsYear(Options):
...
class OptionZaxisDatetimelabelformatsWeek(Options):
...
class OptionZaxisDatetimelabelformatsSecond(Options):
...
class OptionZaxisDatetimelabelformatsMonth(Options):
...
class OptionZaxisDatetimelabelformatsMinute(Options):
...
class OptionZaxisDatetimelabelformatsMillisecond(Options):
...
class OptionZaxisDatetimelabelformats(Options):

    @property
    def day(self) -> 'OptionZaxisDatetimelabelformatsDay':
        """. """
        return self._config_sub_data("day", OptionZaxisDatetimelabelformatsDay)

    @property
    def hour(self) -> 'OptionZaxisDatetimelabelformatsHour':
        """. """
        return self._config_sub_data("hour", OptionZaxisDatetimelabelformatsHour)

    @property
    def millisecond(self) -> 'OptionZaxisDatetimelabelformatsMillisecond':
        """. """
        return self._config_sub_data("millisecond", OptionZaxisDatetimelabelformatsMillisecond)

    @property
    def minute(self) -> 'OptionZaxisDatetimelabelformatsMinute':
        """. """
        return self._config_sub_data("minute", OptionZaxisDatetimelabelformatsMinute)

    @property
    def month(self) -> 'OptionZaxisDatetimelabelformatsMonth':
        """. """
        return self._config_sub_data("month", OptionZaxisDatetimelabelformatsMonth)

    @property
    def second(self) -> 'OptionZaxisDatetimelabelformatsSecond':
        """. """
        return self._config_sub_data("second", OptionZaxisDatetimelabelformatsSecond)

    @property
    def week(self) -> 'OptionZaxisDatetimelabelformatsWeek':
        """. """
        return self._config_sub_data("week", OptionZaxisDatetimelabelformatsWeek)

    @property
    def year(self) -> 'OptionZaxisDatetimelabelformatsYear':
        """. """
        return self._config_sub_data("year", OptionZaxisDatetimelabelformatsYear)
