...
class Lists:
    ...
    def select(self, records=None, html_code: str = None, selected: Union[str, List[str]] = None,
        ...
        `bootstrap-select <https://silviomoreto.github.io/bootstrap-select/examples/>`_
        `bootstrap-select-v4 <https://www.npmjs.com/package/bootstrap-select-v4>`_
        `jqueryscript <https://www.jqueryscript.net/form/Bootstrap-4-Dropdown-Select-Plugin-jQuery.html>`_
            ...
            if selected is not None:
                for rec in records:
                    if rec["value"] in selected:
                        rec["selected"] = True
            if "iconBase" not in options:
                options["iconBase"] = "iconBase"
            if "tickIcon" not in options:
                icon_details = self.page.icons.get("check")
                options["tickIcon"] = icon_details["icon"]
            html_select = html.HtmlSelect.Select(self.page, records, html_code, width, height, profile, multiple,
                                                 options)
    ...
    def item(self, text: str = None, tag: str = None, options: dict = None) -> html.HtmlList.Li:
        ...
        `w3schools <https://www.w3schools.com/bootstrap/bootstrap_list_groups.asp>`_
        `font-awesome <http://astronautweb.co/snippet/font-awesome/>`_
    ...
    def list(self, data=None, color: str = None, width: types.SIZE_TYPE = ('auto', ""),
             ...
             profile: types.PROFILE_TYPE = None) -> html.HtmlList.List:
        ...
        `w3schools <https://www.w3schools.com/bootstrap/bootstrap_list_groups.asp>`_
        `font-awesome <http://astronautweb.co/snippet/font-awesome/>`_
        `template List <https://github.com/epykure/epyk-templates/blob/master/locals/components/list_dragdrop.py/>`_

        :param data: Optional. The list items
    ...
    def items(self, records: list = None, width: types.SIZE_TYPE = (None, "%"), height: types.SIZE_TYPE = ("auto", ""),
        ...
        `Template List <https://github.com/epykure/epyk-templates/blob/master/locals/components/list.py>`_
        `Template List Custom <https://github.com/epykure/epyk-templates/blob/master/locals/components/list_custom.py>`_
        `Template List filte <https://github.com/epykure/epyk-templates/blob/master/locals/components/list_filter.py>`_
        ...
        width = Arguments.size(width, unit="%")
        height = Arguments.size(height, unit="px")
        dft_options = {"items_type": 'text', "li_height": Defaults_css.Font.header_size}
        if options is not None:
            dft_options.update(options)
        html_item = html.HtmlList.Items(self.page, records or [], width, height, dft_options, html_code, profile,
                                        helper)
    ...
    def box(self, records: list = None, width: types.SIZE_TYPE = (100, "%"), height: types.SIZE_TYPE = (None, "%"),
        ...
        `Template List Box <https://github.com/epykure/epyk-templates/blob/master/locals/components/list_box.py>`_
    ...
    def numbers(self, data=None, width: types.SIZE_TYPE = ('auto', ""), height: types.SIZE_TYPE = (None, 'px'),
        ...
        `w3schools <https://www.w3schools.com/html/html_lists.asp>`_
        `w3 <https://www.w3.org/wiki/CSS/Properties/list-style-type>`_
    ...
    def disc(self, data=None, width: types.SIZE_TYPE = ('auto', ""), height: types.SIZE_TYPE = (None, 'px'),
        ...
        `w3schools <https://www.w3schools.com/cssref/pr_list-style-type.asp>`_
        `Template paragraph <https://github.com/epykure/epyk-templates/blob/master/locals/components/paragraph.py>`_
    ...
    def groups(self, data=None, categories=None, color: str = None, width: types.SIZE_TYPE = ('auto', ""),
               ...
               options: dict = None, profile: types.PROFILE_TYPE = None) -> html.HtmlList.Groups:
        """
    ...
    def checks(self, data=None, width: types.SIZE_TYPE = ('auto', ""), height: types.SIZE_TYPE = (None, 'px'),
        ...
        `Templates checkbox<https://github.com/epykure/epyk-templates/blob/master/locals/components/checkbox.py>`_
    ...
    def radios(self, data=None, group_name: str = 'group', width: types.SIZE_TYPE = ('auto', ""),
               ...
               helper: str = None, options: dict = None, profile: types.PROFILE_TYPE = None) -> html.HtmlList.Items:
        """
    ...
    def brackets(self, records=None, width: types.SIZE_TYPE = (100, "%"), height: types.SIZE_TYPE = (550, 'px'),
                 options: dict = None, profile: types.PROFILE_TYPE = None) -> html.HtmlList.ListTournaments:
        """
    ...
    def chips(self, items=None, category: str = 'group', placeholder: str = "", width: types.SIZE_TYPE = (100, "%"),
              ...
              profile: types.PROFILE_TYPE = None) -> html.HtmlEvent.Filters:
    ...
    def menu(self, component, title: Union[str, dict] = None, add: bool = False, height=(18, 'px'), save_funcs=None,
        ...
        if save_funcs is not None:
            ...
            menu_items.append(r)
        if not editable:
            container = self.page.ui.menu(component, update_funcs=update_funcs, title=title, menu_items=menu_items,
