...
class Vignets:
    ...
    def bubble(self, records=None, width: Union[tuple, int] = (70, "px"), height: Union[tuple, int] = ("auto", ''),
        ...
        `w3schools <https://www.w3schools.com/jsref/event_bubbles.asp>`_
    ...
    def number(self, number: float, label: str = "", title: str = None, align: str = "center",
        ...
        `w3schools <https://www.w3schools.com/tags/att_input_type_number.asp>`_

        :param number: The value
        :param label: Optional. The label text
        ...
        :param components: Optional. The HTML components
        :param width: Optional. A tuple with the integer for the component width and its unit
        :param height: Optional. A tuple with the integer for the component height and its unit
        :param profile: Optional. A flag to set the component performance storage
        :param html_code:
    ...
    def block(self, records=None, color: str = None, border: str = 'auto', width: Union[tuple, int] = (300, 'px'),
        ...
        `w3schools <https://www.w3schools.com/htmL/html_blocks.asp>`_
    ...
    def vignet(self, title: str, content: Union[str, list] = "", icon: str = None, render: str = "col",
               align: str = "center",
        ...
        :param title: Optional. A panel title. This will be attached to the title property
        :param content: Optional. The value to be displayed to the component
        ...
        if render == "col":
            ...
            if icon is not None:
                if not hasattr(icon, 'options'):
                    container.add(
                        self.page.ui.icons.awesome(icon, width=(30, "px"), height=(30, "px"), profile=profile))
                else:
                    container.add(icon)
            container.add(title)
            container.add(content)
    ...
    def price(self, value, title: str, items: List[html.Html.Html] = None, components: List[html.Html.Html] = None,
        ...
        :param width: Optional. A tuple with the integer for the component width and its unit
        :param height: Optional. A tuple with the integer for the component height and its unit
        :param currency: Optional. The currency value
        :param options: Optional. Specific Python options available for this component
        :param profile: Optional. A flag to set the component performance storage
        :param helper: Optional. The value to be displayed to the helper icon
        :param html_code: Optional.
    ...
    def slides(self, start: int = 0, width: Union[tuple, int] = (100, '%'), height: Union[tuple, int] = (100, "%"),
               ...
               profile: Union[dict, bool] = None) -> html.HtmlOthers.Slides:
        """
