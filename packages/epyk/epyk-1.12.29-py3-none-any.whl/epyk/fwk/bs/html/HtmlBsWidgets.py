...
'''
    dyn_repr = '''<div class="carousel-item {active}">
...
class BsNav(Component):
    ...
    def add_item(self, component: primitives.HtmlModel, url: str = "#", active: bool = False,
                 disabled: bool = False, css_cls: str = "nav-link"):
        """Add an item to the Nav list.

        `getbootstrap <https://getbootstrap.com/docs/5.1/components/navs-tabs/>`_

        :param component: The item to be added to the Nav
        :param url: Optional. The url path for the link
        :param active: Optional. The status of the option item
        :param disabled: Optional.
        :param css_cls: Optional.
        """
        link = self.page.web.std.link(component, url=url)
        link.add_style([css_cls], clear_first=True)
        link.options.managed = False
        if active:
            link.attr["class"].add("active")
    ...
    def add_dropdown(self, component: primitives.HtmlModel, url: str = "#", active: bool = False,
                     disabled: bool = False):
        pass
...
class BsCard(Component):
    ...
    def add_header(self, value, css_cls: str = "card-header"):
        title = self.page.web.std.div(value)
        title.attr["class"].initialise([css_cls])
        title.options.managed = False
        self.items.insert(0, title)
        return title

    def add_footer(self, value, css_cls: str = "card-footer"):
        title = self.page.web.std.div(value)
        title.attr["class"].initialise([css_cls])
        title.options.managed = False
        self.items.insert(0, title)
    ...
    def add_title(self, value, css_cls: str = "card-title", **kwargs):
    ...
    def add_subtitle(self, value, css_cls: str = "card-subtitle"):
    ...
    def add_link(self, value, url: str = "#", css_cls: str = "card-link", **kwargs):
        """
        ...
        link.attr["class"].initialise([css_cls])
        link.options.managed = False
        self.items.append(link)
        return link
