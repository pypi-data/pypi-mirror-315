...
class Buttons:
    ...
    def __set_color(self, component: html.Html.Html, color: Union[str, bool]):
        """Set the background color for the button. By default, it will use the theme's color.

        :param component: The component to be aligned in the page
        :param color: The color to set
        """
        if color is True:
            component.style.css.background = self.page.theme.notch(
                -5) if self.page.theme.dark else self.page.theme.notch(4)
            ...
            component.style.css.color = self.page.theme.colors[-1] if self.page.theme.dark else self.page.theme.colors[
                0]
        else:
    ...
    def button(self, text: str = "", icon: str = None, width: types.SIZE_TYPE = (None, "%"),
        ...
        `w3schools <https://www.w3schools.com/tags/tag_button.asp>`_
        `bootstrap <http://www.kodingmadesimple.com/2015/04/custom-twitter-bootstrap-buttons-icons-images.html>`_
        `Temp Button <https://github.com/epykure/epyk-templates/blob/master/locals/components/button.py>`_
        `Temp Alert <https://github.com/epykure/epyk-templates/blob/master/locals/components/alerts.py>`_
        `Temp Link <https://github.com/epykure/epyk-templates/blob/master/locals/components/button_link.py>`_
        `Temp Checkbox <https://github.com/epykure/epyk-templates/blob/master/locals/components/checkbox.py>`_
        ...
        component = html.HtmlButton.Button(
            self.page, text, icon, width, height, html_code=html_code, tooltip=tooltip, profile=profile,
            options=options)
    ...
    def colored(self, text: str = "", icon: str = None, color: str = None,
                ...
                html_code: str = None, tooltip: str = None, profile: types.PROFILE_TYPE = None, badge: str = None,
                options: types.OPTION_TYPE = None) -> html.HtmlButton.Button:
        ...
        component = self.button(text, icon, width, height, align, html_code, tooltip, profile, badge, dft_options)
    ...
    def clear(self, text: str = "", icon: str = "fas fa-eraser", color: str = None,
              ...
              align: str = "left", html_code: str = None, tooltip: str = None, badge: str = None,
        ...
        :param options: Optional. Specific Python options available for this component
        """
        component = self.button(text, icon, width, height, align, html_code, tooltip, profile, badge, options)
    ...
    def absolute(self, text: str, size_notch=None, icon: str = "", top: types.SIZE_TYPE = (50, "%"),
                 ...
                 height: types.SIZE_TYPE = (None, "px"), html_code: str = None, badge: str = None,
                 options: types.OPTION_TYPE = None, profile: types.PROFILE_TYPE = None) -> html.HtmlButton.Button:
        """Display a button on the page regardless the current layout of components. By default, the button will be
        center on the page.
    ...
    def important(self, text: str = "", icon: str = None, width: Union[tuple, int] = (None, "%"),
                  ...
                  tooltip: Optional[str] = None, profile: Union[dict, bool] = None, badge: str = None,
    ...
    def validate(self, text: str = "", width: Union[tuple, int] = (None, "%"), height: Union[tuple, int] = (None, "px"),
                 html_code: Optional[str] = None, align: str = "left", tooltip: Optional[str] = None, badge: str = None,
    ...
    def run(self, text: str = "", width: Union[tuple, int] = (None, "%"), height: Union[tuple, int] = (None, "px"),
            align: str = "left", html_code: Optional[str] = None, tooltip: Optional[str] = None, badge: str = None,
            profile: Union[dict, bool] = None, options: Optional[dict] = None) -> html.HtmlButton.Button:
    ...
    def remove(self, text: str = "", width: Union[tuple, int] = (None, "%"), height: Union[tuple, int] = (None, "px"),
        ...
        `w3schools <https://www.w3schools.com/tags/tag_button.asp>`_
        `bootstrap <http://www.kodingmadesimple.com/2015/04/custom-twitter-bootstrap-buttons-icons-images.html>`_
        `Template <https://github.com/epykure/epyk-templates/blob/master/locals/components/button.py>`_
    ...
    def mail(self, text: str = "", width: Union[tuple, int] = (None, "%"), height: Union[tuple, int] = (None, "px"),
             html_code: Optional[str] = None, align: str = "left", tooltip=None, badge: str = None,
             profile: Union[dict, bool] = None, options: Optional[dict] = None) -> html.HtmlButton.Button:
    ...
    def radio(self, record: List[dict] = None, html_code: Optional[str] = None, group_name: Optional[str] = None,
              ...
              checked: str = None, options: Optional[dict] = None,
              profile: Union[dict, bool] = None) -> html.HtmlRadio.Radio:
        ...
        `w3schools <https://www.w3schools.com/bootstrap/bootstrap_forms_inputs.asp>`_
        `Temp Button <https://github.com/epykure/epyk-templates/blob/master/locals/components/button.py>`_
    ...
    def toggle(self, record: dict = None, label: str = None, color: str = None,
        ...
        `Temp Button <https://github.com/epykure/epyk-templates/blob/master/locals/components/button.py>`_
        `Temp Switch <https://github.com/epykure/epyk-templates/blob/master/locals/components/switch.py>`_
        ...
        if label is not None:
            label = self.page.ui.texts.label(label, align=align, options=options,
                                             html_code="%s_label" % html_toggle.htmlCode)
    ...
    def checkboxes(self, record=None, color: str = None, width: types.SIZE_TYPE = (100, "%"),
        ...
        `w3schools <https://www.w3schools.com/howto/howto_css_custom_checkbox.asp>`_
        `Temp Checkbox <https://github.com/epykure/epyk-templates/blob/master/locals/components/button_checkboxes.py>`_
    ...
    def menu(self, record: list = None, text: str = "", icon: Optional[Union[str, bool]] = None,
        ...
        `w3schools <https://www.w3schools.com/howto/tryit.asp?filename=tryhow_css_js_dropdown_hover>`_
        `Temp Link <https://github.com/epykure/epyk-templates/blob/master/locals/components/button_link.py>`_
        `Temp Tree <https://github.com/epykure/epyk-templates/blob/master/locals/components/tree.py>`_
    ...
    def store(self, image, url, width: types.SIZE_TYPE = (7.375, "rem"), height: types.SIZE_TYPE = (2.375, "rem"),
        ...
        """Button for a badge which point to the various application stores (Google and Apple).The badge must be issued
        ...
        `Badges <https://play.google.com/intl/en_us/badges/y>`_
        `Temp Button <https://github.com/epykure/epyk-templates/blob/master/locals/components/button.py>`_
    ...
    def live(self, time: int, js_funcs: types.JS_FUNCS_TYPES, icon: Optional[Union[str, bool]] = "fas fa-circle",
             ...
             html_code: str = None, profile: types.PROFILE_TYPE = None, options: types.OPTION_TYPE = None):
        """Live component which will trigger event every x second. This will then allow other components to be refreshed
        in the page.
        ...
        `Temp Button <https://github.com/epykure/epyk-templates/blob/master/locals/components/button_icon.py>`_
        ...
        if dflt_options["started"]:
            ...
            self.page.body.onReady([
                self.page.js.window.setInterval(js_funcs, "%s_timer" % component.htmlCode, time * 1000)],
                profile=profile)
        else:
    ...
    def thumbs_down(self, width: Union[tuple, int] = ("auto", ""), height: Union[tuple, int] = (None, "px"),
                    align: str = "left", html_code: Optional[str] = None, tooltip: Optional[str] = None,
                    badge: str = None, profile: Union[dict, bool] = None, options: Optional[dict] = None):
        ...
        :param options: Optional. Specific Python options available for this component
        """
        component = self.button(icon="far fa-thumbs-down", width=width, height=height, html_code=html_code,
                                tooltip=tooltip,
                                profile=profile, options=options, align=align, badge=badge)
        component.options.templateError = Defaults_html.TEMPLATE_ERROR_ICON
        component.options.templateLoading = Defaults_html.TEMPLATE_LOADING_ICON
    ...
    def more(self, items, text: str = "More", width: types.SIZE_TYPE = ("auto", ""),
        ...
        component = html.HtmlButton.ButtonMore(
            self.page, items, text, width, height, html_code=html_code, tooltip=tooltip, profile=profile,
            options=options)
        component.style.css.line_height = self.page.body.style.globals.line_height
        html.Html.set_component_skin(component)
        return component
    ...
    def refresh(self, text: str = "Refresh", icon: Optional[Union[str, bool]] = "fas fa-sync-alt",
                ...
                html_code: Optional[str] = None, tooltip: Optional[str] = None, profile: Union[dict, bool] = None,
                badge: str = None, options: Optional[dict] = None):
    ...
    def data(self, filename: str = None, text: str = "", icon: Optional[Union[str, bool]] = None,
             width: Union[tuple, int] = (None, "%"), height: Union[tuple, int] = (None, "px"), align: str = "left",
             html_code: Optional[str] = None, tooltip: Optional[str] = None, profile: Union[dict, bool] = None,
             options: Optional[dict] = None) -> html.HtmlButton.ButtonData:
        """Standard refresh button with a font-awesome icon.
        ...
        if icon is None:
            if filename:
                mapped_file = {
                    "excel": 'far fa-file-excel', 'pdf': 'far fa-file-pdf', 'code': 'far fa-file-code',
                    'csv': 'fas fa-file-csv', "xls": 'far fa-file-excel', "xlsx": 'far fa-file-excel',
                    'word': 'fa-file-word'}
