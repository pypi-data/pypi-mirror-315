...
class CompRoughViz:
    ...
    def plot(self, record: list = None, y: List[str] = None, x: str = None, kind: str = "line",
             profile=None, width=(100, "%"), height=(330, "px"),
             options=None, html_code: str = None):
        """Create a roughViz chart component.

        `RoughViz <https://github.com/jwilber/roughViz>`_
    ...
    def line(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
             options=None, html_code=None) -> graph.GraphRoughViz.RoughViz:
    ...
    def scatter(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
                options=None, html_code=None) -> graph.GraphRoughViz.RoughVizScatter:
    ...
    def bar(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
            options=None, html_code=None) -> graph.GraphRoughViz.RoughVizBar:
    ...
    def pie(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
            options=None, html_code=None) -> graph.GraphRoughViz.RoughVizPie:
    ...
    def donut(self, record=None, y_columns=None, x_axis=None, profile=None, width=(100, "%"), height=(330, "px"),
              options=None, html_code=None) -> graph.GraphRoughViz.RoughVizDonut:
