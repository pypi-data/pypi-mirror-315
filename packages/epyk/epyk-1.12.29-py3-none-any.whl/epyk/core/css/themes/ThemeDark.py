...
class Grey(Theme.Theme):
    ...
    _charts = [
        '#009999', '#336699', '#ffdcb9', '#cc99ff', '#b3d9ff', '#ffff99', '#000066', '#b2dfdb', '#80cbc4',
        '#ffebee', '#ffcdd2', '#ef9a9a', '#f3e5f5', '#e1bee7', '#ce93d8', '#ede7f6', '#d1c4e9', '#b39ddb',
        '#e8eaf6', '#c5cae9', '#9fa8da', '#fffde7', '#fff9c4', '#fff59d', '#fff3e0', '#ffe0b2', '#ffcc80', '#efebe9',
        '#d7ccc8', '#bcaaa4']
