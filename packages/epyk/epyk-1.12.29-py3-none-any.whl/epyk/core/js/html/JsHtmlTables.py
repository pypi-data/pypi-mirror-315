...
class JsHtmlTabulatorCell(JsHtml.JsHtml):
    ...
    def getElement(self):
        ...
        `tabulator <https://tabulator.info/docs/5.4/components#component-row>`_
        """
    ...
    def getColumnField(self):
        ...
        `tabulator <https://tabulator.info/docs/5.4/components>`_
        """
    ...
    def getValue(self):
        ...
        `tabulator <https://tabulator.info/docs/5.4/components#component-cell>`_
        """
    ...
    def getRow(self):
        ...
        `tabulator <https://tabulator.info/docs/5.4/components#component-group>`_
        """
    ...
    def getData(self):
        ...
        `tabulator <https://tabulator.info/docs/5.4/components#component-calc>`_
        """
...
class JsHtmlTabulator(JsHtml.JsHtml):
    ...
    def headers(self):
        ...
        `tabulator <https://tabulator.info/docs/5.4/columns#get-definition>`_
        """
    ...
    def empty(self):
        ...
        `tabulator <https://tabulator.info/docs/5.4/update#alter-empty>`_
        """
...
class JsHtmlDatatable(JsHtml.JsHtml):
    ...
    (function(containerId, tag, htmlCode, jsCode, ctx, attrs){
        ...
        Object.keys(attrs).forEach(function(key) {newDiv.setAttribute(key, attrs[key]);}); newDiv.id = htmlCode; 
        if(!containerId){ document.body.appendChild(newDiv)} else {document.getElementById(containerId).appendChild(newDiv)};
        window[jsCode] = $(htmlCode).DataTable(ctx); return newDiv
    })(%(container)s, "%(tag)s", %(html_code)s, %(js_code)s, %(ctx)s, %(attrs)s)
            ''' % {
            "js_code": js_code,
            "attrs": self.component.get_attrs(css_class_names=self.component.style.get_classes(), to_str=False),
