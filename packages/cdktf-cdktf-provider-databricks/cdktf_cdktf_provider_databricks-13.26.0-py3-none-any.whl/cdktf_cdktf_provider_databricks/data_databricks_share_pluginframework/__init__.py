...
Refer to the Terraform Registry for docs: [`data_databricks_share_pluginframework`](https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework).
'''
...
class DataDatabricksSharePluginframework(
    ...
    def __init__(
        ...
        *,
        ...
        :param comment: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#comment DataDatabricksSharePluginframework#comment}.
        :param created_at: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#created_at DataDatabricksSharePluginframework#created_at}.
        :param created_by: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#created_by DataDatabricksSharePluginframework#created_by}.
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#name DataDatabricksSharePluginframework#name}.
        :param object: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#object DataDatabricksSharePluginframework#object}.
        :param owner: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#owner DataDatabricksSharePluginframework#owner}.
        :param storage_location: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#storage_location DataDatabricksSharePluginframework#storage_location}.
        :param storage_root: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#storage_root DataDatabricksSharePluginframework#storage_root}.
        :param updated_at: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#updated_at DataDatabricksSharePluginframework#updated_at}.
        :param updated_by: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#updated_by DataDatabricksSharePluginframework#updated_by}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataDatabricksSharePluginframework that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#import import section} in the documentation of this resource for the id to use
    ...
    def created_at(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b4d06d17c179e8fca4f4711e45fdd01d28481422f4df0156cccc727011728f29)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def created_by(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__7da369dd6def6d17db97d6fee640db7c35d4a48513dfe5117220dd2acb8ebfb5)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def storage_location(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__adee1c2f2d2f5ba052f5f26d4635fbf18820d145276271d1adf5d648c00a0949)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def updated_at(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__10cc2122c30dab1a39fafb3e9144fb0c88fd474d7b21d7a75bc0392cb6e70fa9)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def updated_by(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3e5f2a2ad58bc273e539f9e620507c3bf06636c978fd209c7d584dcf9d436b5a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDatabricksSharePluginframeworkConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def comment(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#comment DataDatabricksSharePluginframework#comment}.'''
        result = self._values.get("comment")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def created_at(self) -> typing.Optional[jsii.Number]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#created_at DataDatabricksSharePluginframework#created_at}.'''
        result = self._values.get("created_at")
        return typing.cast(typing.Optional[jsii.Number], result)

    @builtins.property
    def created_by(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#created_by DataDatabricksSharePluginframework#created_by}.'''
        result = self._values.get("created_by")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def name(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#name DataDatabricksSharePluginframework#name}.'''
    ...
    def object(
        ...
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#object DataDatabricksSharePluginframework#object}.'''
    ...
    def owner(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#owner DataDatabricksSharePluginframework#owner}.'''
        result = self._values.get("owner")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def storage_location(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#storage_location DataDatabricksSharePluginframework#storage_location}.'''
        result = self._values.get("storage_location")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def storage_root(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#storage_root DataDatabricksSharePluginframework#storage_root}.'''
        result = self._values.get("storage_root")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def updated_at(self) -> typing.Optional[jsii.Number]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#updated_at DataDatabricksSharePluginframework#updated_at}.'''
        result = self._values.get("updated_at")
        return typing.cast(typing.Optional[jsii.Number], result)

    @builtins.property
    def updated_by(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#updated_by DataDatabricksSharePluginframework#updated_by}.'''
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "effective_cdf_enabled": "effectiveCdfEnabled",
        "effective_history_data_sharing_status": "effectiveHistoryDataSharingStatus",
        "effective_shared_as": "effectiveSharedAs",
        "effective_start_version": "effectiveStartVersion",
...
class DataDatabricksSharePluginframeworkObject:
    def __init__(
        ...
        *,
        ...
        effective_cdf_enabled: typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]] = None,
        effective_history_data_sharing_status: typing.Optional[builtins.str] = None,
        effective_shared_as: typing.Optional[builtins.str] = None,
        effective_start_version: typing.Optional[jsii.Number] = None,
        ...
        '''
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#name DataDatabricksSharePluginframework#name}.
        :param added_at: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#added_at DataDatabricksSharePluginframework#added_at}.
        :param added_by: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#added_by DataDatabricksSharePluginframework#added_by}.
        :param cdf_enabled: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#cdf_enabled DataDatabricksSharePluginframework#cdf_enabled}.
        :param comment: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#comment DataDatabricksSharePluginframework#comment}.
        :param content: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#content DataDatabricksSharePluginframework#content}.
        :param data_object_type: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#data_object_type DataDatabricksSharePluginframework#data_object_type}.
        :param effective_cdf_enabled: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#effective_cdf_enabled DataDatabricksSharePluginframework#effective_cdf_enabled}.
        :param effective_history_data_sharing_status: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#effective_history_data_sharing_status DataDatabricksSharePluginframework#effective_history_data_sharing_status}.
        :param effective_shared_as: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#effective_shared_as DataDatabricksSharePluginframework#effective_shared_as}.
        :param effective_start_version: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#effective_start_version DataDatabricksSharePluginframework#effective_start_version}.
        :param history_data_sharing_status: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#history_data_sharing_status DataDatabricksSharePluginframework#history_data_sharing_status}.
        :param partition: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#partition DataDatabricksSharePluginframework#partition}.
        :param shared_as: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#shared_as DataDatabricksSharePluginframework#shared_as}.
        :param start_version: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#start_version DataDatabricksSharePluginframework#start_version}.
        :param status: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#status DataDatabricksSharePluginframework#status}.
        :param string_shared_as: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#string_shared_as DataDatabricksSharePluginframework#string_shared_as}.
        '''
        if __debug__:
            ...
            check_type(argname="argument effective_cdf_enabled", value=effective_cdf_enabled, expected_type=type_hints["effective_cdf_enabled"])
            check_type(argname="argument effective_history_data_sharing_status", value=effective_history_data_sharing_status, expected_type=type_hints["effective_history_data_sharing_status"])
            check_type(argname="argument effective_shared_as", value=effective_shared_as, expected_type=type_hints["effective_shared_as"])
            check_type(argname="argument effective_start_version", value=effective_start_version, expected_type=type_hints["effective_start_version"])
        ...
        if effective_cdf_enabled is not None:
            self._values["effective_cdf_enabled"] = effective_cdf_enabled
        if effective_history_data_sharing_status is not None:
            self._values["effective_history_data_sharing_status"] = effective_history_data_sharing_status
        if effective_shared_as is not None:
            self._values["effective_shared_as"] = effective_shared_as
        if effective_start_version is not None:
            self._values["effective_start_version"] = effective_start_version
    ...
    def added_at(self) -> typing.Optional[jsii.Number]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#added_at DataDatabricksSharePluginframework#added_at}.'''
        result = self._values.get("added_at")
        return typing.cast(typing.Optional[jsii.Number], result)

    @builtins.property
    def added_by(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#added_by DataDatabricksSharePluginframework#added_by}.'''
    ...
    def cdf_enabled(
        ...
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#cdf_enabled DataDatabricksSharePluginframework#cdf_enabled}.'''
    ...
    def content(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#content DataDatabricksSharePluginframework#content}.'''
        result = self._values.get("content")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def data_object_type(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#data_object_type DataDatabricksSharePluginframework#data_object_type}.'''
        result = self._values.get("data_object_type")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def effective_cdf_enabled(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#effective_cdf_enabled DataDatabricksSharePluginframework#effective_cdf_enabled}.'''
        result = self._values.get("effective_cdf_enabled")
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]], result)

    @builtins.property
    def effective_history_data_sharing_status(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#effective_history_data_sharing_status DataDatabricksSharePluginframework#effective_history_data_sharing_status}.'''
        result = self._values.get("effective_history_data_sharing_status")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def effective_shared_as(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#effective_shared_as DataDatabricksSharePluginframework#effective_shared_as}.'''
        result = self._values.get("effective_shared_as")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def effective_start_version(self) -> typing.Optional[jsii.Number]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#effective_start_version DataDatabricksSharePluginframework#effective_start_version}.'''
        result = self._values.get("effective_start_version")
        return typing.cast(typing.Optional[jsii.Number], result)

    @builtins.property
    def history_data_sharing_status(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#history_data_sharing_status DataDatabricksSharePluginframework#history_data_sharing_status}.'''
    ...
    def partition(
        ...
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#partition DataDatabricksSharePluginframework#partition}.'''
    ...
    def shared_as(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#shared_as DataDatabricksSharePluginframework#shared_as}.'''
        result = self._values.get("shared_as")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def start_version(self) -> typing.Optional[jsii.Number]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#start_version DataDatabricksSharePluginframework#start_version}.'''
        result = self._values.get("start_version")
        return typing.cast(typing.Optional[jsii.Number], result)

    @builtins.property
    def status(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#status DataDatabricksSharePluginframework#status}.'''
        result = self._values.get("status")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def string_shared_as(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#string_shared_as DataDatabricksSharePluginframework#string_shared_as}.'''
...
class DataDatabricksSharePluginframeworkObjectOutputReference(
    ...
    @jsii.member(jsii_name="resetEffectiveCdfEnabled")
    def reset_effective_cdf_enabled(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetEffectiveCdfEnabled", []))

    @jsii.member(jsii_name="resetEffectiveHistoryDataSharingStatus")
    def reset_effective_history_data_sharing_status(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetEffectiveHistoryDataSharingStatus", []))

    @jsii.member(jsii_name="resetEffectiveSharedAs")
    def reset_effective_shared_as(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetEffectiveSharedAs", []))

    @jsii.member(jsii_name="resetEffectiveStartVersion")
    def reset_effective_start_version(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetEffectiveStartVersion", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="effectiveCdfEnabledInput")
    def effective_cdf_enabled_input(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "effectiveCdfEnabledInput"))

    @builtins.property
    @jsii.member(jsii_name="effectiveHistoryDataSharingStatusInput")
    def effective_history_data_sharing_status_input(
        self,
    ) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "effectiveHistoryDataSharingStatusInput"))

    @builtins.property
    @jsii.member(jsii_name="effectiveSharedAsInput")
    def effective_shared_as_input(self) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "effectiveSharedAsInput"))

    @builtins.property
    @jsii.member(jsii_name="effectiveStartVersionInput")
    def effective_start_version_input(self) -> typing.Optional[jsii.Number]:
        return typing.cast(typing.Optional[jsii.Number], jsii.get(self, "effectiveStartVersionInput"))
    ...
    def added_at(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a1ab40291eca409cda5a83b92c85f88b312701d185f45745087b331b4d10ff2e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def added_by(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__aa736c86cfe0470f90500d24fb4f0d2265c15caacf972d57cbdc6973dc388ec7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def effective_cdf_enabled(
        ...
        return typing.cast(typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable], jsii.get(self, "effectiveCdfEnabled"))
    ...
    def effective_cdf_enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__851b0722688aa10c92600e7d03896fe0860df987a13931b66f4562cef14af269)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "effectiveCdfEnabled", value) # pyright: ignore[reportArgumentType]
    ...
    def effective_history_data_sharing_status(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__fac3bb74d75c4240e6bfc73d890b76de322073a7617b5e935e6151e8b57ca609)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "effectiveHistoryDataSharingStatus", value) # pyright: ignore[reportArgumentType]
    ...
    def effective_shared_as(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__be09996a1c75b9e1a448fcabf2dba1bb3a1b08f30ca0f5a84a2f94785d10c2d1)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "effectiveSharedAs", value) # pyright: ignore[reportArgumentType]
    ...
    def effective_start_version(self, value: jsii.Number) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__55635f64dcce69a4d7317e3b572254e9046d282af90b28206241cb3daa0ce96b)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "effectiveStartVersion", value) # pyright: ignore[reportArgumentType]
    ...
    def status(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__72671c7f7fc4be369450eb51fbef4440a766a8f75f2d11de6c680e99debf0b38)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DataDatabricksSharePluginframeworkObjectPartition:
    def __init__(
        ...
        *,
        ...
        '''
        :param value: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#value DataDatabricksSharePluginframework#value}.
        '''
        if __debug__:
...
class DataDatabricksSharePluginframeworkObjectPartitionValue:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#name DataDatabricksSharePluginframework#name}.
        :param op: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#op DataDatabricksSharePluginframework#op}.
        :param recipient_property_key: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#recipient_property_key DataDatabricksSharePluginframework#recipient_property_key}.
        :param value: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#value DataDatabricksSharePluginframework#value}.
        '''
        if __debug__:
    ...
    def op(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#op DataDatabricksSharePluginframework#op}.'''
        result = self._values.get("op")
        return typing.cast(typing.Optional[builtins.str], result)

    @builtins.property
    def recipient_property_key(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs/data-sources/share_pluginframework#recipient_property_key DataDatabricksSharePluginframework#recipient_property_key}.'''
...
def _typecheckingstub__b4d06d17c179e8fca4f4711e45fdd01d28481422f4df0156cccc727011728f29(
    value: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__7da369dd6def6d17db97d6fee640db7c35d4a48513dfe5117220dd2acb8ebfb5(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__adee1c2f2d2f5ba052f5f26d4635fbf18820d145276271d1adf5d648c00a0949(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__10cc2122c30dab1a39fafb3e9144fb0c88fd474d7b21d7a75bc0392cb6e70fa9(
    value: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3e5f2a2ad58bc273e539f9e620507c3bf06636c978fd209c7d584dcf9d436b5a(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__a1ab40291eca409cda5a83b92c85f88b312701d185f45745087b331b4d10ff2e(
    value: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__aa736c86cfe0470f90500d24fb4f0d2265c15caacf972d57cbdc6973dc388ec7(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__851b0722688aa10c92600e7d03896fe0860df987a13931b66f4562cef14af269(
    value: typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__fac3bb74d75c4240e6bfc73d890b76de322073a7617b5e935e6151e8b57ca609(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__be09996a1c75b9e1a448fcabf2dba1bb3a1b08f30ca0f5a84a2f94785d10c2d1(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__55635f64dcce69a4d7317e3b572254e9046d282af90b28206241cb3daa0ce96b(
    value: jsii.Number,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__72671c7f7fc4be369450eb51fbef4440a766a8f75f2d11de6c680e99debf0b38(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
