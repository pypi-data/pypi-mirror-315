r'''
# CDKTF prebuilt bindings for databricks/databricks provider version 1.61.0

This repo builds and publishes the [Terraform databricks provider](https://registry.terraform.io/providers/databricks/databricks/1.61.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform databricks provider](https://registry.terraform.io/providers/databricks/databricks/1.61.0)
