...
def shrink(model, min_elements=DEFAULT_MIN_ELEMENTS, float_quantization=False, float_levels=256):
    ...
    for input_glob in args.globs:
        ...
        for input_filename in input_filenames:
            ...
            if args.method == "float_weights" or args.method == "integer_weights":
                ...
                new_model = shrink(original_model, float_quantization=float_quantization, float_levels=args.float_levels)
