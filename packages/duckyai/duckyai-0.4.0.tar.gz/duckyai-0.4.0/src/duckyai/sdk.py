...
from duckyai._hooks import SDKHooks
from duckyai.documents import Documents
from duckyai.indexes import Indexes
from duckyai.types import OptionalNullable, UNSET
import httpx
from typing import Any, Callable, Dict, Optional, Union


class DuckyAI(BaseSDK):
    r"""Ducky API: API for managing and retrieving data from Ducky."""
