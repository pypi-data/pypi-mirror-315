...
with DuckyAI(
    ...
    res = ducky_ai.documents.retrieve(index_name="index_name", query="query", top_k=1, alpha=0.6027456183070403, rerank=True, metadata_filter={
        "key": "",
    })
...
async def main():
    async with DuckyAI(
        ...
        res = await ducky_ai.documents.retrieve_async(index_name="index_name", query="query", top_k=1, alpha=0.6027456183070403, rerank=True, metadata_filter={
            "key": "",
        })
...
* [index](docs/sdks/documents/README.md#index) - Index a document from text content
* [delete](docs/sdks/documents/README.md#delete) - Delete a document
* [get](docs/sdks/documents/README.md#get) - Get a document by ID with pagination
* [retrieve](docs/sdks/documents/README.md#retrieve) - Retrieve documents from an index


### [indexes](docs/sdks/indexes/README.md)

* [list](docs/sdks/indexes/README.md#list) - List indexes within a project
