...
async def main():
    async with DuckyAI(
        ...
        res = await ducky_ai.ducky.list_indexes_async()
...
* [index_text](docs/sdks/ducky/README.md#index_text) - Index a document from text content
...
* [retrieve_documents](docs/sdks/ducky/README.md#retrieve_documents) - Retrieve documents from an index
...
When custom error responses are specified for an operation, the SDK may also raise their associated exceptions. You can refer to respective *Errors* tables in SDK docs for more details on possible exception types for each operation. For example, the `list_indexes_async` method may raise the following exceptions:
