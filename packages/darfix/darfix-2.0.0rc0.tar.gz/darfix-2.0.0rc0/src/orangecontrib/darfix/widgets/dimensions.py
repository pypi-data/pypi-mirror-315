...
from darfix.gui.dimensionsWidget import DimensionWidget, _DimensionItem
from darfix.tasks.dimensiondefinition import DimensionDefinition
from .darfixwidget import (
    OWDarfixWidgetOneThread,
    unpackDataset,
)


class DimensionWidgetOW(OWDarfixWidgetOneThread, ewokstaskclass=DimensionDefinition):
    """
    ...
    def task_output_changed(self) -> None:
        ...
        if dataset in (MISSING_DATA, None):
            ...
            dataset = unpackDataset(dataset=dataset)
