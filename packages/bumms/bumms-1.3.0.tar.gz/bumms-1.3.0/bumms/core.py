...
def play_video_in_ascii():
    # Verwenden von subprocess, um video-to-ascii aufzurufen
...
def bumms_hd():
    # HD Version ausführen
    play_video_in_ascii()

if __name__ == "__main__":
    # Beispiel für den Standardlauf
    main()
    
    # Beispiel für bumms-hd
    # bumms_hd()  # Wenn bumms-hd ausgeführt werden soll, entkommentiere diese Zeile
