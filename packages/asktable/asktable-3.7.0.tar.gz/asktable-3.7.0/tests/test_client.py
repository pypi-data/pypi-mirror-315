...
class TestAsktable:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "asktable/_legacy_response.py",
                        "asktable/_response.py",
    ...
    def test_multipart_repeating_array(self, client: Asktable) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Asktable(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.parametrize(
        "client",
        [
            Asktable(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Asktable(
    ...
    def test_base_url_trailing_slash(self, client: Asktable) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Asktable) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Asktable) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Asktable(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Asktable(base_url=base_url, api_key=api_key, _strict_response_validation=True)
...
class TestAsyncAsktable:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncAsktable) -> None:
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncAsktable(base_url=base_url, api_key=api_key, _strict_response_validation=True)
