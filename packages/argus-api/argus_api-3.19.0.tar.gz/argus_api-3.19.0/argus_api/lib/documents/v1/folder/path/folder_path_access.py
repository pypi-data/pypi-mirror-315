...
list_document_watchers_2 = deprecated_alias("list_document_watchers_2")(get_folder_watchers_by_path)
#: **DEPRECATED** : ``list_document_watchers_by_path_1`` is an alias for ``get_folder_watchers_by_path``. Exists
#: only for backward compatibility - **do not use** - use ``get_folder_watchers_by_path`` instead.
list_document_watchers_by_path_1 = deprecated_alias("list_document_watchers_by_path_1")(get_folder_watchers_by_path)
...
list_folder_watchers_by_path = deprecated_alias("list_folder_watchers_by_path")(get_folder_watchers_by_id)
...
set_current_user_folder_watch_status = deprecated_alias("set_current_user_folder_watch_status")(set_current_user_folder_watch_status_by_id)
...
set_current_user_folder_watch_status_1 = deprecated_alias("set_current_user_folder_watch_status_1")(set_current_user_folder_watch_status_by_path)
...
update_document_access_settings_1 = deprecated_alias("update_document_access_settings_1")(update_folder_access_settings)
...
update_document_access_settings_by_path_1 = deprecated_alias("update_document_access_settings_by_path_1")(update_folder_access_settings_by_path)