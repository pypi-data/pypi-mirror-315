...
disable_monitoring = deprecated_alias("disable_monitoring")(disable_host_monitoring)
...
duplicate_1 = deprecated_alias("duplicate_1")(duplicate_host)
...
duplicate_2 = deprecated_alias("duplicate_2")(setup_default_configuration)
...
enable_monitoring = deprecated_alias("enable_monitoring")(enable_host_monitoring)
#: **DEPRECATED** : ``list_2`` is an alias for ``list_hosts``. Exists
#: only for backward compatibility - **do not use** - use ``list_hosts`` instead.
list_2 = deprecated_alias("list_2")(list_hosts)
...
schedule_monitoring = deprecated_alias("schedule_monitoring")(schedule_host_monitoring)
