...
list_users = deprecated_alias("list_users")(list_users_v1)
...
update_profile_picture_for_user_j_s_o_n = deprecated_alias("update_profile_picture_for_user_j_s_o_n")(update_profile_picture_for_user_json)