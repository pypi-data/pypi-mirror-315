...
initialize = deprecated_alias("initialize")(initialize_totp_generator)
...
legacy_t_o_t_p_authentication = deprecated_alias("legacy_t_o_t_p_authentication")(legacy_totp_authentication)
...
revoke = deprecated_alias("revoke")(revoke_totp_generator)
#: **DEPRECATED** : ``revoke_5`` is an alias for ``revoke_totp_generator``. Exists
#: only for backward compatibility - **do not use** - use ``revoke_totp_generator`` instead.
revoke_5 = deprecated_alias("revoke_5")(revoke_totp_generator)
...
verify = deprecated_alias("verify")(verify_totp_generator)