...
#: **DEPRECATED** : ``list_document_watchers_2`` is an alias for ``get_folder_watchers_by_path``. Exists
#: only for backward compatibility - **do not use** - use ``get_folder_watchers_by_path`` instead.
list_document_watchers_2 = register_command(
    extending=("documents", "v1", "folder", "path", "access"),
    module=argus_cli_module,
    alias="list_document_watchers_2"
)(deprecated_alias("list_document_watchers_2")(get_folder_watchers_by_path))
#: **DEPRECATED** : ``list_document_watchers_by_path_1`` is an alias for ``get_folder_watchers_by_path``. Exists
#: only for backward compatibility - **do not use** - use ``get_folder_watchers_by_path`` instead.
list_document_watchers_by_path_1 = register_command(
    extending=("documents", "v1", "folder", "path", "access"),
    module=argus_cli_module,
    alias="list_document_watchers_by_path_1"
)(deprecated_alias("list_document_watchers_by_path_1")(get_folder_watchers_by_path))
#: **DEPRECATED** : ``list_folder_watchers_by_path`` is an alias for ``get_folder_watchers_by_id``. Exists
#: only for backward compatibility - **do not use** - use ``get_folder_watchers_by_id`` instead.
list_folder_watchers_by_path = register_command(
    extending=("documents", "v1", "folder", "path", "access"),
    module=argus_cli_module,
    alias="list_folder_watchers_by_path"
)(deprecated_alias("list_folder_watchers_by_path")(get_folder_watchers_by_id))
#: **DEPRECATED** : ``set_current_user_folder_watch_status`` is an alias for ``set_current_user_folder_watch_status_by_id``. Exists
#: only for backward compatibility - **do not use** - use ``set_current_user_folder_watch_status_by_id`` instead.
set_current_user_folder_watch_status = register_command(
    extending=("documents", "v1", "folder", "path", "access"),
    module=argus_cli_module,
    alias="set_current_user_folder_watch_status"
)(deprecated_alias("set_current_user_folder_watch_status")(set_current_user_folder_watch_status_by_id))
#: **DEPRECATED** : ``set_current_user_folder_watch_status_1`` is an alias for ``set_current_user_folder_watch_status_by_path``. Exists
#: only for backward compatibility - **do not use** - use ``set_current_user_folder_watch_status_by_path`` instead.
set_current_user_folder_watch_status_1 = register_command(
    extending=("documents", "v1", "folder", "path", "access"),
    module=argus_cli_module,
    alias="set_current_user_folder_watch_status_1"
)(deprecated_alias("set_current_user_folder_watch_status_1")(set_current_user_folder_watch_status_by_path))
#: **DEPRECATED** : ``update_document_access_settings_1`` is an alias for ``update_folder_access_settings``. Exists
#: only for backward compatibility - **do not use** - use ``update_folder_access_settings`` instead.
update_document_access_settings_1 = register_command(
    extending=("documents", "v1", "folder", "path", "access"),
    module=argus_cli_module,
    alias="update_document_access_settings_1"
)(deprecated_alias("update_document_access_settings_1")(update_folder_access_settings))
#: **DEPRECATED** : ``update_document_access_settings_by_path_1`` is an alias for ``update_folder_access_settings_by_path``. Exists
#: only for backward compatibility - **do not use** - use ``update_folder_access_settings_by_path`` instead.
update_document_access_settings_by_path_1 = register_command(
    extending=("documents", "v1", "folder", "path", "access"),
    module=argus_cli_module,
    alias="update_document_access_settings_by_path_1"
)(deprecated_alias("update_document_access_settings_by_path_1")(update_folder_access_settings_by_path))