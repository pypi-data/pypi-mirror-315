...
def add_sensor_type(
    ...
    :param str shortName: Short name of Sensor Type\, needs to be unique \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
...
def update_sensor_type(
    ...
    :param str idOrShortName: Sensor type ID or short name
    :param str shortName: New unique short name of the Sensor Type. \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param str name: New name of the Sensor Type \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param str url: New URL of the Sensor Type \=\> \(\(https\?\|ftp\|gopher\|telnet\|file\)\:\(\(\/\)\|\(\\\\\)\)\+\[\\w\\d\:\\\#\@\%\/\;\$\(\)\~\_\?\\\\\+\-\=\\\\\\.\&\]\*\)
