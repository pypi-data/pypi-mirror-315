...
@register_command(
    extending=("notifications", "v1", "notification"),
...
prepare_notification_1 = register_command(
    extending=("notifications", "v1", "notification"),
    module=argus_cli_module,
    alias="prepare_notification_1"
)(deprecated_alias("prepare_notification_1")(send_notification))