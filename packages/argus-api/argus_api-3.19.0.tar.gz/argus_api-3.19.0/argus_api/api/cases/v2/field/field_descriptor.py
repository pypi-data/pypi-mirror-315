...
def add_field_to_policy(
    ...
    :param str displayName: Display name for field. Default is field name. \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    ...
    # Only send displayName if the argument was provided, don't send null values
...
def create_field_descriptor(
    ...
    :param str shortName: Shortname of field to add. If not specified\, it will be set to a lowercase\, concatenated shortname based on the name. \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    ...
    :param dict localizedDescriptions: Localized descriptions. If not set\, localizedDescription will return null. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    ...
    :param bool hidden: Mark this field as hidden. Hidden fields will not be displayed in the UI. \(default false\)
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
    ...
    if customer is not None:
        body.update({"customer": customer})
    # Only send valueType if the argument was provided, don't send null values
    if valueType is not None:
        body.update({"valueType": valueType})
    # Only send multiValue if the argument was provided, don't send null values
    ...
    # Only send validator if the argument was provided, don't send null values
    if validator is not None:
        body.update({"validator": validator})
    # Only send valueSource if the argument was provided, don't send null values
    if valueSource is not None:
        body.update({"valueSource": valueSource})
    # Only send rendererOptions if the argument was provided, don't send null values
...
def list_field_descriptors(
    ...
    :param list sortBy: Sort order \(see \/cases\/v2\/field\/descriptor\/search documentation for details\)
    ...
    # Only send policy if the argument was provided, don't send null values
...
def list_field_policies(
    ...
    :param list keywords: Limit result to fields matching one of these keywords
    :param list sortBy: Sort order \(see \/cases\/v2\/field\/policy\/search documentation for details\)
    :param int limit: Maximum number of returned results
    :param int offset: Skip a number of results
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
...
def search_field_descriptors(
    ...
    :param list service: Restrict search to fields which are in use in one of the specified services \(service ID or shortname\).
    :param list policy: Restrict search to fields which are in use in one of the specified policies \(by policy ID or name\)
    :param int availableForCaseID: Restrict search to fields which are available for specified case \(by ID\)
    ...
    # Only send availableForCaseID if the argument was provided, don't send null values
    if availableForCaseID is not None:
        body.update({"availableForCaseID": availableForCaseID})
    # Only send valueType if the argument was provided, don't send null values
    if valueType is not None:
        body.update({"valueType": valueType})
...
def update_field_descriptor(
    ...
    :param str shortName: If set\, change the shortname of the field. \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param dict localizedNames: If set\, update the localized names. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param dict localizedDescriptions: If set\, update the localized descriptions. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    ...
    :param bool hidden: If set\, change the hidden parameter of this field.
    ...
    :param str readRole: If set\, update the required service role to read this field.
    :param str writeRole: If set\, update the required service role to write this field.
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
