...
def list_instances_by_agent_user(
    ...
    """List configuration instances by agent user (fetching instances bound to the host associated with the agent) (INTERNAL)
    ...
    route = "/configurationadmin/v1/agent/{user}/instances".format(limit=limit,
        user=user,
        offset=offset,
