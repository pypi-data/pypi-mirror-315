...
@register_command(
    extending=("authentication", "v1", "password"),
...
def change_current_user_password(
    ...
    """Change current users Argus password. Note that this will only change the password used for SMS, PASSWORD and TOTP, not external authentications like LDAP or SSO via OpenID.The operation must be verified using an authorization code, or the existing password (legacy). (PUBLIC)
...
def test_user_password(
    ...
    """Test a new password before changing it, to verify its strength (PUBLIC)
