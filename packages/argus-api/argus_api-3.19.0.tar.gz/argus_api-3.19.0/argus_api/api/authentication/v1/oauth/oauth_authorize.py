...
def create_oauth2_client(
    ...
    :param str shortName: A shortname describing this resource. This name will show up when listing external resources. \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param str name: A name describing this resource. This name will show up when listing external resources. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param str description: A description of this resource. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    ...
    :param str mainURI: The main landing page for this resource. This will be used to link to the application from Argus. \=\> Sanitize by regex https\:\/\/.\*
    :param list redirectURIs: The redirect URIs to allow when redirecting from the OAuth authorization endpoint. \=\> Sanitize by regex http\(s\)\?\:\/\/.\*
    ...
    :param list permittedScopes: A list of scopes the client will be permitted to ask for. If not set\, all scopes are assumed permitted for the client
    ...
    :param str maxSecurityLevel: Max security level for this client \(default external\)
    :param bool hidden: If true\, this client is by default excluded in the oauth external client list
    :param str redirectURI: DEPRECATED\: This field is DEPRECATED. Use redirectURIs instead.
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def update_oauth2_client(
    ...
    :param str shortName: If set\, update the shortname describing this resource. This name will show up when listing external resources. \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param str name: If set\, update the name describing this resource. This name will show up when listing external resources. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param str description: If set\, update the description of this resource. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param str mainURI: If set\, update the main landing page for this resource. This will be used to link to the application from Argus. \=\> Sanitize by regex https\:\/\/.\*
    :param list redirectURIs: If set\, update the redirect URIs to allow when redirecting from the OAuth authorization endpoint. \=\> Sanitize by regex http\(s\)\?\:\/\/.\*
...
create_o_auth2_client = register_command(
    extending=("authentication", "v1", "oauth", "authorize"),
    module=argus_cli_module,
    alias="create_o_auth2_client"
)(deprecated_alias("create_o_auth2_client")(create_oauth2_client))
...
update_o_auth2_client = register_command(
    extending=("authentication", "v1", "oauth", "authorize"),
    module=argus_cli_module,
    alias="update_o_auth2_client"
)(deprecated_alias("update_o_auth2_client")(update_oauth2_client))