...
legacy_l_d_a_p_authentication = register_command(
    extending=("authentication", "v1", "ldap", "authenticate"),
    module=argus_cli_module,
    alias="legacy_l_d_a_p_authentication"
)(deprecated_alias("legacy_l_d_a_p_authentication")(legacy_ldap_authentication))