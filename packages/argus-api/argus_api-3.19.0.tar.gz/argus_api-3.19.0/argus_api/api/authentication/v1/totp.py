...
#: **DEPRECATED** : ``initialize`` is an alias for ``initialize_totp_generator``. Exists
#: only for backward compatibility - **do not use** - use ``initialize_totp_generator`` instead.
initialize = register_command(
    extending=("authentication", "v1", "totp"),
    module=argus_cli_module,
    alias="initialize"
)(deprecated_alias("initialize")(initialize_totp_generator))
#: **DEPRECATED** : ``legacy_t_o_t_p_authentication`` is an alias for ``legacy_totp_authentication``. Exists
#: only for backward compatibility - **do not use** - use ``legacy_totp_authentication`` instead.
legacy_t_o_t_p_authentication = register_command(
    extending=("authentication", "v1", "totp"),
    module=argus_cli_module,
    alias="legacy_t_o_t_p_authentication"
)(deprecated_alias("legacy_t_o_t_p_authentication")(legacy_totp_authentication))
#: **DEPRECATED** : ``revoke`` is an alias for ``revoke_totp_generator``. Exists
#: only for backward compatibility - **do not use** - use ``revoke_totp_generator`` instead.
revoke = register_command(
    extending=("authentication", "v1", "totp"),
    module=argus_cli_module,
    alias="revoke"
)(deprecated_alias("revoke")(revoke_totp_generator))
#: **DEPRECATED** : ``revoke_5`` is an alias for ``revoke_totp_generator``. Exists
#: only for backward compatibility - **do not use** - use ``revoke_totp_generator`` instead.
revoke_5 = register_command(
    extending=("authentication", "v1", "totp"),
    module=argus_cli_module,
    alias="revoke_5"
)(deprecated_alias("revoke_5")(revoke_totp_generator))
#: **DEPRECATED** : ``verify`` is an alias for ``verify_totp_generator``. Exists
#: only for backward compatibility - **do not use** - use ``verify_totp_generator`` instead.
verify = register_command(
    extending=("authentication", "v1", "totp"),
    module=argus_cli_module,
    alias="verify"
)(deprecated_alias("verify")(verify_totp_generator))