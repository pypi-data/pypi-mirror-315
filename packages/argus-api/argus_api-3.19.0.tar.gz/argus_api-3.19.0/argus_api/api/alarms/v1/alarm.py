...
def add_alarm(
    ...
    :param str shortName: Short name of the alarm \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param str description: Alarm description \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param str info: Alarm verbose information \=\> format\:html
    :param list references: Alarm vulnerability references \(CVE\-numbers\, BID\-numbers\, URLs etc\) \=\> Sanitize by regex \^\(\(\?\!\(https\?\|ftp\|gopher\|telnet\|file\|javascript\|mailto\)\:\)\)\(\[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\)\*\|\(\(https\?\|ftp\|gopher\|telnet\|file\)\:\(\(\/\)\|\(\\\\\)\)\+\[\\w\\d\:\\\#\@\%\/\;\$\(\)\~\_\?\\\\\+\-\=\\\\\\.\&\]\*\)
    ...
    :param list signatures: List of signatures to map to this alarm \=\> Sanitize by regex \[a\-zA\-Z0\-9\_\/\:\@\~\!\\\+\\\-\\.\\\?\]\*
...
def delete_alarm_mitre_relationship(
    ...
    route = "/alarms/v1/alarm/{idOrShortName}/mitre/{idOrExtId}".format(idOrShortName=idOrShortName,
        idOrExtId=idOrExtId,
...
def map_to_alarm(
    ...
    :param int id: ID of the alarm
    :param list signatures: Signatures \(exist\/new\) to be mapped to the alarm \=\> Sanitize by regex \[a\-zA\-Z0\-9\_\/\:\@\~\!\\\+\\\-\\.\\\?\]\*
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def search_alarm_mitre_relationships(
    ...
    :param list sortBy: Fields to sort results by \(without sign is ascending\, with \'\-\' sign is descending\) \(default mitreCategoryShortName\, \-createdTimestamp\)
...
def update_alarm(
    ...
    :param int id: ID of the alarm
    :param str shortName: If set\, update short name of the alarm \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param str description: If set\, update description of alarm \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    ...
    :param list addReferences: Vulnerability references to be added to the alarm \(CVE\-numbers\, BID\-numbers\, URLs etc\) \=\> Sanitize by regex \^\(\(\?\!\(https\?\|ftp\|gopher\|telnet\|file\|javascript\|mailto\)\:\)\)\(\[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\)\*\|\(\(https\?\|ftp\|gopher\|telnet\|file\)\:\(\(\/\)\|\(\\\\\)\)\+\[\\w\\d\:\\\#\@\%\/\;\$\(\)\~\_\?\\\\\+\-\=\\\\\\.\&\]\*\)
    :param list deleteReferences: Vulnerability references to be removed from the alarm
    :param list addLinks: External links to be added to the alarm \=\> \(\(https\?\|ftp\|gopher\|telnet\|file\)\:\(\(\/\)\|\(\\\\\)\)\+\[\\w\\d\:\\\#\@\%\/\;\$\(\)\~\_\?\\\\\+\-\=\\\\\\.\&\]\*\)
    :param list deleteLinks: External links to be removed from the alarm
    :param list addLabels: Labels to be added to the alarm \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param list deleteLabels: Labels to be removed from the alarm \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param str internalReference: If set\, update link to an internal reference for the alarm \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
