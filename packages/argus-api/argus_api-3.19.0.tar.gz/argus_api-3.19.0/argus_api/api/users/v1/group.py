...
def find_groups(
    ...
    """DEPRECATED: Use POST useradmin/v2/group/search. Search group profiles (PUBLIC)
...
def get_group_by_id(
    ...
    """DEPRECATED: Use GET users/v2/group/{idOrShortname}. Get group profile by ID (PUBLIC)
...
def get_group_by_name(
    ...
    """DEPRECATED: Use GET users/v2/group/{idOrShortname}. Get group profile by name (PUBLIC)
...
def list_groups(
    ...
    """DEPRECATED: Use GET users/v2/group. Get group information (PUBLIC)
