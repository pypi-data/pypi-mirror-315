...
def get_basic_subject(
    ...
    route = "/users/v2/subject/{shortNameOrID}".format(shortNameOrID=shortNameOrID,
        domain=domain)
    headers = {}
...
def get_subject_group_memberships(
    subject: int,
    sortBy: str = None,
    ...
    """Returns the basic groups of the subject (PUBLIC)
    
    :param int subject: ID of the subject
    :param list sortBy: Field to sort by
    :param bool includeInherited: Include inherited groups
    :param int limit: Maximum number of returned group memberships
    :param int offset: Skip a number of group memberships
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
    ...
    route = "/users/v2/subject/{subject}/groups".format(includeInherited=includeInherited,
        limit=limit,
        subject=subject,
        sortBy=sortBy,
        offset=offset)
...
def list_basic_subjects(
    ...
    route = "/users/v2/subject".format(limit=limit,
...
def search_basic_subjects(
    ...
    route = "/users/v2/subject/search".format()
    headers = {}
