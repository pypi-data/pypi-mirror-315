...
def add_business_process(
    ...
    route = "/assets/v1/businessprocess".format()
    headers = {}
...
def attach_services_to_business_process(
    ...
    route = "/assets/v1/businessprocess/{id}/attachservices".format(id=id)
    headers = {}

    body = body or {}
    # Only send serviceAssetIDs if the argument was provided, don't send null values
...
def delete_business_process(
    ...
    route = "/assets/v1/businessprocess/{id}".format(id=id)
    headers = {}
...
def detach_services_from_business_process(
    ...
    route = "/assets/v1/businessprocess/{id}/detachservices".format(id=id)
    headers = {}
...
def search_business_process_statistics(
    ...
    """Fetch business process statistics base on criteria (PUBLIC)
    ...
    route = "/assets/v1/businessprocess/statistics".format()
    headers = {}
...
def search_business_processes(
    ...
    route = "/assets/v1/businessprocess/search".format()
    headers = {}
...
def search_business_processes_simplified(
    ...
    route = "/assets/v1/businessprocess".format(limit=limit,
