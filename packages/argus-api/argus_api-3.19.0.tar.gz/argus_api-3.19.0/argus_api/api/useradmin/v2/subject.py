...
def add_subject_group_memberships(
    ...
    """Adds this subject to one or multiple groups (PUBLIC)
    ...
    route = "/useradmin/v2/subject/{shortNameOrID}/groups".format(shortNameOrID=shortNameOrID,
        domain=domain)
    headers = {}
...
#: **DEPRECATED** : ``get_subject_1`` is an alias for ``get_subject``. Exists
#: only for backward compatibility - **do not use** - use ``get_subject`` instead.
get_subject_1 = register_command(
    extending=("useradmin", "v2", "subject"),
    module=argus_cli_module,
    alias="get_subject_1"
)(deprecated_alias("get_subject_1")(get_subject))
#: **DEPRECATED** : ``list_subjects_1`` is an alias for ``list_subjects``. Exists
#: only for backward compatibility - **do not use** - use ``list_subjects`` instead.
list_subjects_1 = register_command(
    extending=("useradmin", "v2", "subject"),
    module=argus_cli_module,
    alias="list_subjects_1"
)(deprecated_alias("list_subjects_1")(list_subjects))