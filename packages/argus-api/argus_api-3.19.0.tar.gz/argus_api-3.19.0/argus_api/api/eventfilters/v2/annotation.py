...
def delete_annotation_filter(
    ...
    route = "/eventfilters/v2/annotation/{idOrShortName}".format(idOrShortName=idOrShortName)
    headers = {}
...
def search_annotation_filter_status(
    ...
    """Search for annotation filters instance statuses for filters that match the criteria (INTERNAL)
