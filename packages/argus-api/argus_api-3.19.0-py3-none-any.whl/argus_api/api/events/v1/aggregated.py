...
def find_aggregated_event_stats(
    ...
    :param str timeFrameStrategy: Configures the aggregation search to use start\/end timestamp or just event timestamp for the timeframe of the search. \(default startEndTimestamp\)
