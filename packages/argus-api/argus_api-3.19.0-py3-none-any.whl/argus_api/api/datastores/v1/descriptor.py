...
def add_data_store_descriptor(
    ...
    :param str name: Name for the new datastore\, must be unique. \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param str description: A textual description of the datastore. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    ...
    :param str behaviourType: The behaviour of the datastore. CENTRAL datastores are only updated centrally\, but may be used in distributed processing. LOCAL and DISTRIBUTED datastores are not stored centrally\, but updated in the distributed system. DISTRIBUTED may be shared between processing nodes. \(default CENTRAL\)
    :param str dataType: The type of data stored in the datastore \(MAP or LIST\). Maps have keys with values\, lists only have keys. \(default MAP\)
    :param bool useLowerCaseKeys: Boolean flag that determines whether to use lower case keys. \(default false\)
...
def update_data_store_descriptor(
    ...
    :param str dataStore: Store name
    :param str name: If set\, change the name of this datastore. All entries will be updated \(may take long time for large stores\). \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param str description: If set\, change the textual description of this datastore. \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
