...
@register_command(
    extending=("datacollector", "v1", "ingest"),
...
def ingest_bulk_data(
    ...
    :param bool ignoreOnFailed: Whether or not to ignore any errors in the records \(default false\)
