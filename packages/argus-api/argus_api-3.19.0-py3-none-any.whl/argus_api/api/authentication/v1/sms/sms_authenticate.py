...
#: **DEPRECATED** : ``legacy_s_m_s_authentication`` is an alias for ``legacy_sms_authentication``. Exists
#: only for backward compatibility - **do not use** - use ``legacy_sms_authentication`` instead.
legacy_s_m_s_authentication = register_command(
    extending=("authentication", "v1", "sms", "authenticate"),
    module=argus_cli_module,
    alias="legacy_s_m_s_authentication"
)(deprecated_alias("legacy_s_m_s_authentication")(legacy_sms_authentication))
#: **DEPRECATED** : ``send_s_m_s_validation_code`` is an alias for ``send_sms_validation_code``. Exists
#: only for backward compatibility - **do not use** - use ``send_sms_validation_code`` instead.
send_s_m_s_validation_code = register_command(
    extending=("authentication", "v1", "sms", "authenticate"),
    module=argus_cli_module,
    alias="send_s_m_s_validation_code"
)(deprecated_alias("send_s_m_s_validation_code")(send_sms_validation_code))