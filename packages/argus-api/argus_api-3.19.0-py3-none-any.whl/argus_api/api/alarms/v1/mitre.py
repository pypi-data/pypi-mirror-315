...
def add_mitre_category_relationship(
    ...
    route = "/alarms/v1/mitre/{idOrExtId}/relations".format(idOrExtId=idOrExtId,
        sourceCategoryModel=sourceCategoryModel)
    headers = {}
...
def add_or_update_mitre_model_version(
    ...
    route = "/alarms/v1/mitre/model/{model}/versions/{version}".format(model=model,
        version=version)
    headers = {}
...
def list_mitre_categories(
    ...
    route = "/alarms/v1/mitre".format(type=type,
        model=model,
        version=version,
...
def search_mitre_categories(
    ...
    :param bool includeRelationships: Whether to include MITRE category relationships in search results or not \(default false\)
