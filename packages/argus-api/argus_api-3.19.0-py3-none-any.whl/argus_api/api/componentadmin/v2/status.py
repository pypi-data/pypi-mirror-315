...
def list_template_status(
    ...
    route = "/componentadmin/v2/status/template".format(limit=limit,
        offset=offset)
    headers = {}
...
get_instance_status_1 = register_command(
    extending=("componentadmin", "v2", "status"),
    module=argus_cli_module,
    alias="get_instance_status_1"
)(deprecated_alias("get_instance_status_1")(get_instance_status))