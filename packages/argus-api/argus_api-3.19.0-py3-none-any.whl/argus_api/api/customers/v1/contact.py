...
def add_contact(
    ...
    # Only send workPhone if the argument was provided, don't send null values
    if workPhone is not None:
        body.update({"workPhone": workPhone})
    # Only send mobilePhone if the argument was provided, don't send null values
    ...
    # Only send mailSettings if the argument was provided, don't send null values
    if mailSettings is not None:
        body.update({"mailSettings": mailSettings})
    # Only send smsSettings if the argument was provided, don't send null values
