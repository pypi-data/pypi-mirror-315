...
def add_customer(
    ...
    :param str shortName: shortName to set for new customer \(must be unique\). \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    ...
    # Only send logoURL if the argument was provided, don't send null values
    ...
    # Only send accountManagerID if the argument was provided, don't send null values
    ...
    # Only send features if the argument was provided, don't send null values
...
def get_customer(
    ...
    :param str idOrShortname: Customer ID
    ...
    route = "/customers/v1/customer/{idOrShortname}".format(idOrShortname=idOrShortname,
        domain=domain,
    ...
    # Only send skipServices if the argument was provided, don't send null values
...
def get_user_roles(
    ...
    route = "/customers/v1/customer/{idOrShortname}/userroles".format(idOrShortname=idOrShortname,
        domain=domain)
    headers = {}
...
def update_customer(
    ...
    if accountManagerID is not None:
        body.update({"accountManagerID": accountManagerID})
    # Only send addFeatures if the argument was provided, don't send null values
    if addFeatures is not None:
        body.update({"addFeatures": addFeatures})
    # Only send deleteFeatures if the argument was provided, don't send null values
...
#: **DEPRECATED** : ``get_customer_by_shortname`` is an alias for ``get_customer``. Exists
#: only for backward compatibility - **do not use** - use ``get_customer`` instead.
get_customer_by_shortname = register_command(
    extending=("customers", "v1", "customer"),
    module=argus_cli_module,
    alias="get_customer_by_shortname"
)(deprecated_alias("get_customer_by_shortname")(get_customer))
#: **DEPRECATED** : ``get_customer_by_id`` is an alias for ``get_customer``. Exists
#: only for backward compatibility - **do not use** - use ``get_customer`` instead.
get_customer_by_id = register_command(
    extending=("customers", "v1", "customer"),
    module=argus_cli_module,
    alias="get_customer_by_id"
)(deprecated_alias("get_customer_by_id")(get_customer))