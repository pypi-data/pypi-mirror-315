...
def add_attachment(
    ...
    :param bool prepared: If set the attachment will be uploaded in a \"prepared\" state\, in which they are not visible to other users until the connected comment is published. \(default false\)
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def answer_enquiry(
    ...
    """Answer a case enquiry (INTERNAL)
    ...
    route = "/cases/v2/case/{caseID}/enquiries/{enquiryID}/answer".format(caseID=caseID,
        enquiryID=enquiryID)
    headers = {}
...
def create_enquiry(
    ...
    """Create a new case enquiry (INTERNAL)
    
    :param int caseID: Case ID
    :param dict uischema: 
    :param str title: Human readable title of the case enquiry \=\> \[\\s\\w\\\{\\\}\\\$\\\-\\\(\\\)\\.\\\[\\\]\"\\\'\_\/\\\\\,\\\*\\\+\\\#\:\@\!\?\;\=\]\*
    :param str flowName: Machine readable shortname to identify the case enquiry \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    :param str readRole: Required role for read access to the case enquiry \(default tech\)
    :param str writeRole: Required role for write access to the case enquiry \(default tech\)
    :param dict querySchema: 
    :param list queryLayout: DEPRECATED\: List of layout elements\/widgets used in this case enquiry. Deprecated\, use uiSchema\-field instead.
    :param bool mandatory: Boolean flag that indicates whether the case enquiry is mandatory or not \(default false\)
    :param json: return the response's body as a ``dict`` parsed from json. ``True`` by
      default. If set to false, the raw ``requests.Response`` object will be returned.
    :param verify: path to a certificate bundle or boolean indicating whether SSL
      verification should be performed.
...
def delete_enquiry(
    ...
    """Delete a case enquiry (INTERNAL)
    ...
    route = "/cases/v2/case/{caseID}/enquiries/{enquiryID}".format(caseID=caseID,
        enquiryID=enquiryID)
    headers = {}
...
def get_enquiry(
    ...
    """Fetches a case enquiry (INTERNAL)
...
def get_enquiry_client_validation_code(
    ...
    """Fetches a case enquiry client validation code (in JavaScript) (INTERNAL)
    ...
    route = "/cases/v2/case/enquiries/clientValidationCode".format(caseID=caseID,
        enquiryID=enquiryID)
    headers = {}
    headers['content'] = None
...
def list_enquiries(
    ...
    """Fetches case enquiries (INTERNAL)
    ...
    route = "/cases/v2/case/{caseID}/enquiries".format(limit=limit,
        caseID=caseID,
        state=state,
...
def reject_enquiry(
    ...
    """Reject a case enquiry (INTERNAL)
    ...
    route = "/cases/v2/case/{caseID}/enquiries/{enquiryID}/reject".format(caseID=caseID,
        enquiryID=enquiryID)
    headers = {}
