...
@register_command(
    extending=("cases", "v2", "servicetask"),
...
def abort_task(
    ...
    route = "/cases/v2/servicetask/{taskID}".format(taskID=taskID)
    headers = {}
...
def list_tasks(
    ...
    route = "/cases/v2/servicetask".format(limit=limit,
        state=state,
        operation=operation,
        user=user,
...
def search_tasks(
    ...
    route = "/cases/v2/servicetask/search".format()
    headers = {}
