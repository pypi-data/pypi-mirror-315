...
def add_host_application(
    ...
    # Only send roleID if the argument was provided, don't send null values
    ...
    if cpe is not None:
        body.update({"cpe": cpe})
    # Only send sockets if the argument was provided, don't send null values
...
def update_host_application(
    ...
    if cpe is not None:
        body.update({"cpe": cpe})
    # Only send addSockets if the argument was provided, don't send null values
    if addSockets is not None:
        body.update({"addSockets": addSockets})
    # Only send deleteSockets if the argument was provided, don't send null values
