...
#: **DEPRECATED** : ``list_document_watchers`` is an alias for ``list_document_watchers_by_id``. Exists
#: only for backward compatibility - **do not use** - use ``list_document_watchers_by_id`` instead.
list_document_watchers = register_command(
    extending=("documents", "v1", "document"),
    module=argus_cli_module,
    alias="list_document_watchers"
)(deprecated_alias("list_document_watchers")(list_document_watchers_by_id))