...
@register_command(
    extending=("logging", "v1", "distributed"),
    module=argus_cli_module
)
def submit_distributed_log_events_bulk(
    ...
    """Submit distributed log events in a bulk operation (INTERNAL)
    ...
    route = "/logging/v1/distributed".format()
    headers = {}
