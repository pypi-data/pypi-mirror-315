...
def aggregate_metrics(
    ...
    :param list keyIntervals: List of key intervals\, to filter the aggregation on. \(default null\)
    ...
    :param str startTimestamp: Restrict result set to records submitted after this time.Allows the use of unix timestamp \(milliseconds\)\, ISO timestamp\, or relative time.
    :param str endTimestamp: Restrict result set to records submitted before this time. Allows the use of unix timestamp \(milliseconds\)\, ISO timestamp\, or relative time. \(default now\)
    :param str timeZone: Settable Timezone. For more information please refer to official java documentation
...
If not set the data will be localized according to user\'s timezone. \(default null\)
    ...
    :param bool skipKeyTranslation: Whether to skip key translation and return the raw value. \(default false\)
    :param bool groupByCustomer: DEPRECATED\: States whether Metric records will be aggregated by customers. Deprecated\, use the groupBy field. \(default false\)
