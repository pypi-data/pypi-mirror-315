...
detach_artifact_by_g_a = deprecated_alias("detach_artifact_by_g_a")(detach_artifact_by_gav)
...
attach = deprecated_alias("attach")(attach_artifact)
...
attach_by_name = deprecated_alias("attach_by_name")(attach_artifact_by_name)
...
attach_detach = deprecated_alias("attach_detach")(attach_detach_artifacts)
...
create_1 = deprecated_alias("create_1")(create_code_profile)
...
delete = deprecated_alias("delete")(delete_code_profile)
...
detach = deprecated_alias("detach")(detach_artifact)
#: **DEPRECATED** : ``detach_by_artifact_by_g_a`` is an alias for ``detach_artifact_by_gav``. Exists
#: only for backward compatibility - **do not use** - use ``detach_artifact_by_gav`` instead.
detach_by_artifact_by_g_a = deprecated_alias("detach_by_artifact_by_g_a")(detach_artifact_by_gav)
...
detach_by_name = deprecated_alias("detach_by_name")(detach_artifact_by_name)
...
duplicate = deprecated_alias("duplicate")(duplicate_code_profile)
...
get_by_id_1 = deprecated_alias("get_by_id_1")(get_code_profile_by_id)
...
get_by_name = deprecated_alias("get_by_name")(get_code_profile_by_name)
...
list_1 = deprecated_alias("list_1")(list_code_profiles)
...
search_1 = deprecated_alias("search_1")(search_code_profiles)
...
update = deprecated_alias("update")(update_code_profile)