...
legacy_s_m_s_authentication = deprecated_alias("legacy_s_m_s_authentication")(legacy_sms_authentication)
...
send_s_m_s_validation_code = deprecated_alias("send_s_m_s_validation_code")(send_sms_validation_code)