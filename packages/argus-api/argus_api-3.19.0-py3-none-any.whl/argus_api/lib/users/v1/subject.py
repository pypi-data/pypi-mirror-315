...
def find_subjects(
    ...
    route = "/users/v1/subject/search".format()
...
def get_subject_by_id(
    ...
    route = "/users/v1/subject/{subjectID}".format(subjectID=subjectID)
...
def get_subject_by_name(
    ...
    route = "/users/v1/subject/{subjectName}".format(subjectName=subjectName)
...
def list_subjects_v1(
    ...
    route = "/users/v1/subject".format(limit=limit,
        subjectID=subjectID,
        offset=offset)
...
#: **DEPRECATED** : ``list_subjects`` is an alias for ``list_subjects_v1``. Exists
#: only for backward compatibility - **do not use** - use ``list_subjects_v1`` instead.
list_subjects = deprecated_alias("list_subjects")(list_subjects_v1)