...
def get_default_namespace():
    ...
    """
    return KubeflowPlugin().get_default_namespace()
...
def create_service(name: str):
    ...
    """
    return KubeflowPlugin().create_service(name=name)
...
def delete_service(name: str):
    ...
    """
    return KubeflowPlugin().delete_service(name=name)
...
def create_fl_component_from_func(
    ...
    """
    return KubeflowPlugin().create_fl_component_from_func(func=func,
                                                          output_component_file=output_component_file,
                                                          base_image=base_image,
                                                          packages_to_install=packages_to_install,
                                                          annotations=annotations,
                                                          container_port=container_port,
                                                          pod_label_name=pod_label_name,
...
def flservercomponent(
    ...
    def decorator(func):
        return create_fl_component_from_func(func=func,
                                             output_component_file=output_component_file,
                                             base_image=base_image,
                                             packages_to_install=packages_to_install,
                                             annotations=annotations,
