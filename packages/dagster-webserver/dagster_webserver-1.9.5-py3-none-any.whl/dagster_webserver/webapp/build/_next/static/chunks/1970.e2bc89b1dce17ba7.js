...
`;var rW=r(99417);let rZ=e=>{let{repoAddress:t,schedule:r}=e,{permissions:{canStartSchedule:i,canStopRunningSchedule:s}}=(0,tj.xz)(t.location),{name:o}=r,l={...(0,ej.$)(t),scheduleName:o},[a,{loading:d}]=(0,h.Db)(rW.E1,{onCompleted:rW.JH}),c=i&&s,p=c?`In code, a default status for "${o}" has been set to "${r.defaultStatus}". Click here to reset the schedule status to track the status set in code.`:tj.Qr;return(0,n.jsx)(T.u,{content:(0,n.jsx)("div",{style:{maxWidth:"500px",wordBreak:"break-word"},children:p}),display:"flex",children:(0,n.jsx)(K.zx,{disabled:d||!c,onClick:()=>{a({variables:{scheduleSelector:l}})},children:"Reset schedule status"})})};var rY=r(89516),rX=r(24427),r0=r(55010),r1=r(60603),r2=r(49035),r4=r(76562),r8=r(8068),r6=r(68903),r3=r(24608),r9=r(57234),r5=r(58252);let r7=navigator.language,ne=e=>(0,n.jsx)(tF.Vq,{...e,style:{width:"70vw",display:"flex"},title:(0,n.jsxs)(i.x,{flex:{direction:"row",gap:8,alignItems:"center"},children:[(0,n.jsx)(en.JO,{name:"preview_tick"}),(0,n.jsxs)("span",{children:["Preview tick result for ",e.name]})]}),children:(0,n.jsx)(nt,{...e})}),nt=e=>{let{repoAddress:t,name:r,onClose:o,jobName:l}=e,[d,c]=(0,a.useState)(),p=(0,a.useMemo)(()=>({repositoryLocationName:t.location,repositoryName:t.name,scheduleName:r}),[t,r]),{data:u}=(0,h.aM)(nr,{variables:{scheduleSelector:p}}),[x,{loading:m}]=(0,h.Db)(ni),j=(0,r9.W)(),{timezone:[g]}=(0,a.useContext)(r6.JB),[f,y]=(0,a.useState)(!1),b=(0,a.useRef)(null),{viewport:S,containerProps:v}=(0,t2.S)(),[$,N]=(0,a.useState)(!1),[w,C]=(0,a.useState)(null),[E,k]=(0,a.useState)(null),A=(0,a.useMemo)(()=>u&&!m,[u,m]),P=(0,a.useCallback)(async()=>{if(!A)return;let e=(0,ej.$)(t),n=await x({variables:{selectorData:{...e,scheduleName:r},timestamp:b.current.ts}}),i=n.data?.scheduleDryRun;i?i?.__typename==="DryRunInstigationTick"?i.evaluationResult?.error?C(i.evaluationResult.error):k(i):i?.__typename==="ScheduleNotFoundError"?(0,r8._K)({title:"Schedule not found",body:`Could not find a schedule named: ${r}`}):C(i):(0,eg.UT)("scheduleDryRun Mutation returned no data??")},[A,x,t,r]),O=(0,a.useMemo)(()=>E&&p?(0,r5.G)(E,p):[],[p,E]),R=(0,a.useMemo)(()=>null!=O&&O.length>0,[O]),_=(0,a.useCallback)(async()=>{if(R){N(!0);try{O&&await j({executionParamsList:O},"toast")}catch(e){console.error(e)}N(!1),o()}},[R,O,j,o]),F=(0,a.useMemo)(()=>{if($)return(0,n.jsxs)(i.x,{flex:{direction:"row",gap:8,justifyContent:"center",alignItems:"center"},children:[(0,n.jsx)(t9.$,{purpose:"body-text"}),(0,n.jsx)("div",{children:"Launching runs"})]});if(!u)return(0,n.jsx)(i.x,{padding:{vertical:48},flex:{alignItems:"center",justifyContent:"center"},children:(0,n.jsx)(t9.$,{purpose:"page"})});if("PythonError"===u.scheduleOrError.__typename)return(0,n.jsx)(eC.T9,{error:u.scheduleOrError});if("ScheduleNotFoundError"===u.scheduleOrError.__typename)return(0,n.jsx)(s.t,{icon:"error",title:"Schedule not found",description:`Could not find a schedule named: ${r}`});if(E||w)return(0,n.jsx)(nn,{repoAddress:t,name:r,timestamp:b.current.ts,jobName:l,scheduleExecutionData:E,scheduleExecutionError:w});if(m)return(0,n.jsxs)(i.x,{flex:{direction:"row",gap:8,justifyContent:"center",alignItems:"center"},children:[(0,n.jsx)(t9.$,{purpose:"body-text"}),(0,n.jsx)("div",{children:"Evaluating schedule"})]});{let e=u.scheduleOrError.potentialTickTimestamps.map(e=>({ts:e,label:(0,r3.j)({timestamp:{unix:e},locale:r7,timezone:g,timeFormat:{showTimezone:!0}})}));return b.current=d||e[0]||null,(0,n.jsxs)(i.x,{flex:{direction:"column",gap:8},children:[(0,n.jsx)(no,{children:"Select an evaluation time to simulate"}),(0,n.jsx)(r0.J,{isOpen:f,position:"bottom-left",fill:!0,content:(0,n.jsx)(r1.v2,{style:{maxHeight:"400px",overflow:"scroll",width:`${S.width}px`},children:e.map(e=>(0,n.jsx)(r1.sN,{text:(0,n.jsx)("div",{"data-testid":(0,rr.N)(`tick-${e.ts}`),children:e.label}),onClick:()=>{c(e),y(!1)}},e.ts))}),children:(0,n.jsx)("div",{...v,children:(0,n.jsx)(K.zx,{style:{flex:1,width:"100%"},rightIcon:(0,n.jsx)(en.JO,{name:"arrow_drop_down"}),onClick:()=>y(e=>!e),"data-testid":(0,rr.N)("tick-selection"),children:b.current?.label})})}),(0,n.jsxs)("div",{children:["Each evaluation of a schedule is called a tick, which is an opportunity for one or more runs to be launched. Ticks kick off runs, which either materialize a selection of assets or execute a ",(0,n.jsx)("a",{href:"https://docs.dagster.io/concepts/ops-jobs-graphs/jobs",children:"job"}),". You can preview the result for a given tick in the next step."]}),(0,n.jsxs)("div",{children:[(0,n.jsx)("a",{href:"https://docs.dagster.io/concepts/automation/schedules",children:"Learn more"})," about schedules"]})]})}},[$,u,E,w,m,t,r,l,d,f,S.width,v,g]),I=(0,a.useMemo)(()=>$?null:E||w?(0,n.jsx)(K.zx,{icon:(0,n.jsx)(en.JO,{name:"settings_backup_restore"}),"data-testid":(0,rr.N)("try-again"),onClick:()=>{k(null),C(null)},children:"Try again"}):null,[$,E,w]),U=(0,a.useMemo)(()=>{if($)return(0,n.jsx)(i.x,{flex:{direction:"row",gap:8}});if(E||w){let e=E?.evaluationResult?.runRequests,t=e?.length||0,r=!w&&0===t;return w||r?(0,n.jsx)(i.x,{flex:{direction:"row",gap:8},children:(0,n.jsx)(K.zx,{onClick:o,children:"Close"})}):(0,n.jsxs)(i.x,{flex:{direction:"row",gap:8},children:[(0,n.jsx)(K.zx,{onClick:o,children:"Close"}),(0,n.jsx)(T.u,{canShow:!R||$,content:"Launches all runs and commits tick result",placement:"top-end",children:(0,n.jsx)(K.zx,{icon:(0,n.jsx)(en.JO,{name:"check_filled"}),intent:"primary",disabled:!R||$,onClick:_,"data-testid":(0,rr.N)("launch-all"),children:(0,n.jsx)("div",{children:"Launch all & commit tick result"})})})]})}return m?(0,n.jsx)(i.x,{flex:{direction:"row",gap:8},children:(0,n.jsx)(K.zx,{onClick:o,children:"Close"})}):(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(K.zx,{onClick:o,children:"Close"}),(0,n.jsx)(K.zx,{"data-testid":(0,rr.N)("continue"),intent:"primary",disabled:!A,onClick:()=>{P()},children:"Continue"})]})},[R,A,$,o,_,E,w,P,m]);return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(tF.a7,{children:(0,n.jsx)("div",{style:{minHeight:"300px"},children:F})}),(0,n.jsx)(tF.cN,{topBorder:!0,left:I,children:U})]})},nr=(0,h.Ps)`
  query getSchedule(
