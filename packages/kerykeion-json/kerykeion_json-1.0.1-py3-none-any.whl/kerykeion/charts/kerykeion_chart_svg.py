...
class KerykeionChartSVG:
    ...
    def getSVGString(self, minify: bool = False) -> str:
        """HTTP istekleri için SVG içeriğini string olarak döndürür"""
        
        if not hasattr(self, "template"):
            self.template = self.makeTemplate(minify)
        
        # HTTP yanıtı için SVG MIME type'ı ile birlikte döndür
