...
class AsyncClient(AsyncBaseClient):
    ...
    async def detach_customer_payment_method(
    ...
    async def report_event(
        self, input: UsageEventsReportInput, **kwargs: Any
    ) -> ReportEvent:
        query = gql(
            """
    ...
    async def delegate_subscription_to_customer(
    ...
    async def transfer_subscription_to_resource(
    ...
    async def get_mock_paywall(
        self, input: GetPaywallInput, **kwargs: Any
    ) -> GetMockPaywall:
        query = gql(
            """
