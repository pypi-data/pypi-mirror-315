...
def get_library_path():
    ...
    if system == 'Linux':
        return os.path.join(lib_dir, 'libmachbaseAPI.so')
    elif system == 'Windows':
        return os.path.join(lib_dir, 'libmachbaseAPI.dll')
    elif system == 'Darwin':
        return os.path.join(lib_dir, 'libmachbaseAPI.dylib')
    else:
