    ...
    try:
        ...
        while True:
            ...
            if user_prompt_json.startswith('/rollback'):
                ...
                continue
            user_prompt, name_subdomain, tier, file_attachments, focused_files, domain, snow_mode, auto_mode = parse_initial_payload(user_prompt_json, project_path)
            ...
            if user_prompt == "deploy_to_server":
                ...
                await coding_controller.get_started(user_prompt, tier, file_attachments, focused_files, snow_mode, auto_mode)
                logger.info("#### `All done!` Keep chatting with us for more help. Thanks for using!")
...
def parse_initial_payload(user_prompt_json, project_path):
    try:
        ...
        return user_prompt, name_subdomain, tier, file_path, tracked_file, domain, snow_mode, True
    except:
        return user_prompt_json, "", "", [], [], "", False, True
