...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"OS: {platform.system()} - All paths and structures must match this OS format.\n\n"
            "#### Core Requirements\n"
            "1. For landing pages and simple multi-page sites:\n"
            "   - MUST use pure HTML/CSS unless specifically requested otherwise\n" 
            "   - NO React, TypeScript or complex frameworks unless:\n"
            "     * Explicitly required by user\n"
            "     * Advanced functionality needed\n\n"
            "2. File Organization:\n"
            "   - Every UI file MUST have dedicated style file\n"
            "   - Proper directory structure based on tech stack\n"
            "   - Clear file naming and organization\n"
            "   - No duplicate or conflicting paths\n\n"
            "3. Technology Guidelines:\n"
            "   - Maps: Use real integrations (Google Maps, Mapbox, etc)\n"
            "   - Calendars: Use proper libraries with full functionality\n"
            "   - Components: Build with actual code, not placeholders\n\n"
            ...
            "   - Sizes (rem):\n"
            "     * h1: 2rem desktop / 1.75rem mobile\n"
            "     * h2: 1.75rem desktop / 1.5rem mobile\n"
            "     * h3: 1.5rem desktop / 1.25rem mobile\n"
            "     * h4: 1.25rem desktop / 1.125rem mobile\n"
            "     * Body: 1rem\n"
            "     * Small: 0.875rem\n"
            "     * Micro: 0.75rem\n"
            "   - Line heights:\n"
            ...
            "     * Body: 1.5-1.6\n"
            "     * Small: 1.4\n"
            "   - Character spacing: -0.02em headings, normal body\n\n"
            "2. Image Guidelines:\n"
            "   - SVG for:\n"
            ...
            "     * Screenshots, badges\n"
            "   - JPG for:\n"
            "     * Photos, backgrounds, banners\n"
            "   - Sizes:\n"
            "     * Icons: 24x24px, 128x128px, 512x512px\n"
            "     * Illustrations: 400x400px, 800x600px, 1024x1024px\n"
            "     * Products: 400x400px, 1200x1200px, 2048x2048px\n\n"
            ...
            "   │   └── main.css\n"
            "   ├── css/\n"
            "   │   └── [page].css     # One per HTML file\n"
            "   └── [page].html        # Must link to its CSS\n\n"
            "2. Component Framework Projects:\n"
            "   src/\n"
            "   ├── styles/\n"
            "   │   ├── globals.css\n"
            "   │   └── variables.css\n"
            ...
            "   - Build requirements\n\n"
            "#### Directory Structure Output Rules\n"
            "- Show ONLY:\n"
            "  * New files being added\n"
            "  * Files being moved\n"
            "  * New/moved image files\n"
            "- Use single unified tree\n"
            "- Include full paths\n"
            "- No duplicates\n"
            "- Clear file purposes\n\n"
            ...
            "End with:\n"
            "#### DONE: *** - D*** I** (if dependencies AND eligible images needed)\n"
            "#### DONE: *** - D*** (if only dependencies needed)\n"
            "#### DONE: *** - I** (if only eligible images needed)\n"
            "No ending if neither needed\n\n"
            "CRITICAL: This is planning phase ONLY - NO implementation code or details"
        )
