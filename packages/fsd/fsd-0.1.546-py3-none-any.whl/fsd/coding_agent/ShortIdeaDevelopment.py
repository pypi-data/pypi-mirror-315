...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "End with #### DONE: *** - D*** I** if both dependencies and eligible images (.png, .jpg, .jpeg, .ico) needed to be newly generated and mentioned in plan\n"
            "End with #### DONE: *** - D*** if only dependencies needed\n"
            "End with #### DONE: *** - I** if only eligible images (.png, .jpg, .jpeg, .ico) needed to be newly generated and mentioned in plan\n"
