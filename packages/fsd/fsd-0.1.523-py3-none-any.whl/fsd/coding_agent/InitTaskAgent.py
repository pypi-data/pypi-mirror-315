        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "5. Determine if using a React + TypeScript + Vite template would be appropriate\n\n"
                    "Return result as:\n"
                    ...
                    "  - Project is a simple landing page (use HTML/CSS instead)\n"
                    "- 1: Use React + TypeScript + Vite template only if:\n"
                    "  - Project is empty/new\n"
                    "  - User prompt involves complex web/frontend development beyond a landing page\n"
                    "  - User prompt aligns with React/TypeScript capabilities\n"
                    "  - No conflicting tech requirements\n"
                    "  - No existing project structure\n"
                    "  - Project requires interactive components/state management\n\n"
            ...
            {
                "role": "user",
                "content": f"Project structure:\n{self.repo.print_tree()}\n\nUser prompt:\n{prompt}\n\nAnalyze if this is an empty/new project without existing structure and if the prompt allows using React + TypeScript + Vite template. For landing pages, prefer simple HTML/CSS implementation."
            }
        ]
