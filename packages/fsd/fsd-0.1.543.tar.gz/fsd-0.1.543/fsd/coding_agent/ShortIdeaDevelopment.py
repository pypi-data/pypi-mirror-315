...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "8. Asset Guidelines:\n"
            "   SVG Usage (PREFERRED for all icons/logos):\n"
            ...
            f"```\n"
            f"PLANNING PHASE ONLY - NO CODE IMPLEMENTATION\n"
            f"Response Language: {original_prompt_language}\n"
            f"Use markdown for links: [text](url)\n"
            "Include only relevant sections. End with #### DONE: *** - D*** I** if both dependencies and eligible images (PNG/JPG/JPEG/ico) needed. Use #### DONE: *** - D*** for dependencies only, or #### DONE: *** - I** for images only."
        )
