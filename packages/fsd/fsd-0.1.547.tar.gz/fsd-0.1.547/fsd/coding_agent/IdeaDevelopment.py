...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            "REQUIRED: Response MUST end with one of these markers:\n\n"
            "#### DONE: *** - D*** I**\n"
            "    - Use ONLY when BOTH new dependencies AND new images (.png/.jpg/.jpeg/.ico) are specified in plan\n"
            "    - This marker is MANDATORY if plan includes both\n\n"
            "#### DONE: *** - D***\n" 
            "    - Use ONLY when ONLY new dependencies are specified in plan\n"
            "    - This marker is MANDATORY if plan includes only dependencies\n\n"
            "#### DONE: *** - I**\n"
            "    - Use ONLY when ONLY new images (.png/.jpg/.jpeg/.ico) are specified in plan\n"
            "    - This marker is MANDATORY if plan includes only images\n\n"
            "NO marker should be included if neither dependencies nor images are specified\n"
            "FAILURE TO USE CORRECT MARKER WILL RESULT IN PLAN REJECTION\n"
        )
