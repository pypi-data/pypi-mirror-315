    ...
    async def get_coding_request(self, file, techStack, codingModel):
        ...
        if is_svg:
            ...
            specialized_prompt = (
                ...
                "\nFor Imports & Dependencies:\n"
                "- NEVER import non-existent modules or components\n"
                "- ALWAYS verify imports exist in project before using\n"
                "- Use correct import paths based on project structure\n"
                "- Follow tech stack's import conventions:\n"
                "  • React: Use proper import paths for components/hooks\n"
                "  • Vue: Use correct import syntax for components/composables\n"
                "  • Angular: Follow NgModule import patterns\n"
                "  • Node: Use require/import based on module system\n"
                "- Maintain consistent import style across codebase\n"
                "- Group imports logically (core/vendor/local)\n"
                "- Remove unused imports\n"
                "- Use proper version ranges in package.json\n"
                "- Document required peer dependencies\n"
                "- Handle circular dependencies\n"
                "- Use proper path aliases if configured\n"
                "- Verify CSS/asset imports work with bundler\n"
            )
