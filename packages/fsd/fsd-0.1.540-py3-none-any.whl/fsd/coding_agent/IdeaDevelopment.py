...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"IMPORTANT: For landing pages and simple multi-page websites, ALWAYS use pure HTML/CSS unless specifically requested otherwise.\n"
            f"DO NOT use React, TypeScript, or other complex frameworks for basic landing pages and brochure sites.\n"
            f"Only use complex frameworks if explicitly required by user or if advanced functionality is needed.\n\n"
            f"Ultimate Goal\n"
