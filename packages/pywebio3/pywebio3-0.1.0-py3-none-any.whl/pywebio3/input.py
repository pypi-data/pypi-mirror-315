...
.. list-table::
   ...
   * - `input <pywebio3.input.input>`
     - Text input

   * - `textarea <pywebio3.input.textarea>`
     - Multi-line text input

   * - `select <pywebio3.input.select>`
     - Drop-down selection

   * - `checkbox <pywebio3.input.checkbox>`
     - Checkbox

   * - `radio <pywebio3.input.radio>`
     - Radio

   * - `slider <pywebio3.input.slider>`
     - Slider

   * - `actions <pywebio3.input.actions>`
     - Actions selection

   * - `file_upload <pywebio3.input.file_upload>`
     - File uploading

   * - `input_group <pywebio3.input.input_group>`
     - Input group

   * - `input_update <pywebio3.input.input_update>`
     - Update input item
