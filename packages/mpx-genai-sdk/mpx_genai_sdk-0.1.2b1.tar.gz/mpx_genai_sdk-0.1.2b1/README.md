# Masterpiecex Python API library

[![PyPI version](https://img.shields.io/pypi/v/mpx_genai_sdk.svg)](https://pypi.org/project/mpx_genai_sdk/)
...
create_response_object = client.assets.create(
    description="my description of the asset",
    name="asset1.glb",
    type="model/gltf-binary",
)
print(create_response_object.asset_url)
```
...
async def main() -> None:
    create_response_object = await client.assets.create(
        description="my description of the asset",
        name="asset1.glb",
        type="model/gltf-binary",
    )
...
client.with_options(max_retries=5).assets.create(
    description="my description of the asset",
    name="asset1.glb",
    type="model/gltf-binary",
)
...
client.with_options(timeout=5.0).assets.create(
    description="my description of the asset",
    name="asset1.glb",
    type="model/gltf-binary",
)
...
asset = response.parse()  # get the object that `assets.create()` would have returned
