...
from mpx_genai_sdk import Masterpiecex, AsyncMasterpiecex, APIResponseValidationError
from mpx_genai_sdk._types import Omit
from mpx_genai_sdk._models import BaseModel, FinalRequestOptions
from mpx_genai_sdk._constants import RAW_RESPONSE_HEADER
from mpx_genai_sdk._exceptions import APIStatusError, APITimeoutError, MasterpiecexError, APIResponseValidationError
from mpx_genai_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Masterpiecex | AsyncMasterpiecex) -> int:
...
class TestMasterpiecex:
    client = Masterpiecex(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "mpx_genai_sdk/_legacy_response.py",
                        "mpx_genai_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "mpx_genai_sdk/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MasterpiecexError):
            with update_env(**{"MPX_SDK_BEARER_TOKEN": Omit()}):
                client2 = Masterpiecex(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Masterpiecex) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MASTERPIECEX_BASE_URL="http://localhost:5000/from/env"):
            client = Masterpiecex(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Masterpiecex) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Masterpiecex) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Masterpiecex) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Masterpiecex(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Masterpiecex(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("mpx_genai_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/assets/create").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/assets/create",
                body=cast(
                    object, dict(description="my description of the asset", name="asset1.glb", type="model/gltf-binary")
                ),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/assets/create").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/assets/create").mock(side_effect=retry_handler)

        response = client.assets.with_raw_response.create(
            description="my description of the asset", name="asset1.glb", type="model/gltf-binary"
        )
    ...
    def test_omit_retry_count_header(
        self, client: Masterpiecex, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMasterpiecex:
    client = AsyncMasterpiecex(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MasterpiecexError):
            with update_env(**{"MPX_SDK_BEARER_TOKEN": Omit()}):
                client2 = AsyncMasterpiecex(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMasterpiecex) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MASTERPIECEX_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMasterpiecex(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMasterpiecex) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMasterpiecex) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMasterpiecex) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMasterpiecex(
        ...
        client = AsyncMasterpiecex(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncMasterpiecex,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.assets.with_raw_response.create(
            description="my description of the asset", name="asset1.glb", type="model/gltf-binary"
        )
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMasterpiecex, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from mpx_genai_sdk._utils import asyncify
        from mpx_genai_sdk._base_client import get_platform 
