 ...
 *
 * Copyright (c) 2009-2014, 2021, 2023,
...
#define OTF2_VERSION_SUFFIX "rc5"
/** @brief The OTF2 version as string. */
#define OTF2_VERSION        "3.1-rc5"
/** @} */
...
enum OTF2_Paradigm_enum
{
    ...
    /** @brief OpenMP target functions and kernels.
     *
     *  @pclass{OTF2_PARADIGM_CLASS_ACCELERATOR}
     *  @pproperty{OTF2_PARADIGM_PROPERTY_RMA_ONLY,@eref{OTF2_TRUE}}
     *
     *  @since Version 3.1.
     */
    OTF2_PARADIGM_OPENMP_TARGET      = 25
};
...
enum OTF2_ThumbnailType_enum
{
    ...
    /** @brief The referenced definitions are of type @eref{Comm}.
     *
     *  @since Version 3.1.
     */
    OTF2_THUMBNAIL_TYPE_COMM       = 3,

    /** @brief The referenced definitions are of type @eref{RmaWin}.
     *
     *  @since Version 3.1.
     */
    OTF2_THUMBNAIL_TYPE_RMA_WIN    = 4,

    /** @brief The referenced definitions are of type @eref{IoHandle}.
     *
     *  @since Version 3.1.
     */
    OTF2_THUMBNAIL_TYPE_IO_HANDLE  = 5
};
