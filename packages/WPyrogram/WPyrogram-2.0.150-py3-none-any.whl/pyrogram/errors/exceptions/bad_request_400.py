...
class ExtendedMediaAmountInvalid(BadRequest):
    """The maximum amount of `star_count` should be less than the `stars_paid_post_amount_max` [client configuration parameters](/api/config)."""
