r'''
# CDKTF prebuilt bindings for vancluever/acme provider version 2.28.2

This repo builds and publishes the [Terraform acme provider](https://registry.terraform.io/providers/vancluever/acme/2.28.2/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform acme provider](https://registry.terraform.io/providers/vancluever/acme/2.28.2)
