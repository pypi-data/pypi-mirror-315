...
```
venv/bin/pip install crux_odin-1.5.11-py3-none-any.whl cruxctl-2.2.0-py3-none-any.whl
```
- Verify install
```
cruxctl version
...
- Install private upstreams and cruxctl (Replace with the versions in the zipped distribution)
```
pip install crux_odin-1.5.11-py3-none-any.whl cruxctl-2.2.0-py3-none-any.whl
```
- Verify install
```
cruxctl version
