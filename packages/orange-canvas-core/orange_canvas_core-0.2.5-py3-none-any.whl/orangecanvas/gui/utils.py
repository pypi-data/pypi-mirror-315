...
def message_critical(text, title=None, informative_text=None, details=None,
    ...
    """
    if not text:
        text = _tr.m[425, "An unexpected error occurred."]

    if title is None:
        title = _tr.m[426, "Error"]
...
def message_warning(text, title=None, informative_text=None, details=None,
    ...
    if not text:
        import random
        text_candidates = [_tr.m[427, "Death could come at any moment."],
                           _tr.m[428, "Murphy lurks about. Remember to save frequently."]
                           ]
        text = random.choice(text_candidates)

    if title is not None:
        title = _tr.m[429, "Warning"]
...
def message_information(text, title=None, informative_text=None, details=None,
    ...
    """
    if title is None:
        title = _tr.m[430, "Information"]
    if not text:
        text = _tr.m[431, "I am not a number."]
...
def message(icon, text, title=None, informative_text=None, details=None,
    ...
    """
    if title is None:
        title = _tr.m[432, "Message"]
    if not text:
        text = _tr.m[433, "I am neither a postman nor a doctor."]
