...
class CanvasMainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.dock_help.setDefaultText(
            (_tr.m[47, "Select a widget to show its description."] + ("<br/><br/>" + (_tr.m[48, "See <a href='action:examples-action'>workflow examples</a>, "] + (_tr.m[49, "<a href='action:screencasts-action'>YouTube tutorials</a>, "] + _tr.m[50, "or open the <a href='action:welcome-action'>welcome screen</a>."]))))
        )
        self.dock_help_action = canvas_tool_dock.toggleQuickHelpAction()
        self.dock_help_action.setText(self.tr(_tr.m[51, "Show Help"]))
        ...
        self.output_dock = DockWidget(
            self.tr(_tr.m[52, "Log"]), self, objectName="output-dock",
        ...
        self.help_dock = DockWidget(
            self.tr(_tr.m[53, "Help"]), self, objectName="help-dock",
    ...
    def setup_actions(self):
        ...
        self.new_action = QAction(
            self.tr(_tr.m[54, "New"]), self,
            objectName="action-new",
            toolTip=self.tr(_tr.m[55, "Open a new workflow."]),
            triggered=self.new_workflow_window,
            shortcut=QKeySequence.New,
            icon=load_styled_svg_icon("New.svg")
        )
        self.open_action = QAction(
            self.tr(_tr.m[56, "Open"]), self,
            objectName="action-open",
            toolTip=self.tr(_tr.m[57, "Open a workflow."]),
            triggered=self.open_scheme,
            shortcut=QKeySequence.Open,
            icon=load_styled_svg_icon("Open.svg")
        )
        self.open_and_freeze_action = QAction(
            self.tr(_tr.m[58, "Open and Freeze"]), self,
            objectName="action-open-and-freeze",
            toolTip=self.tr((_tr.m[59, "Open a new workflow and freeze signal "] + _tr.m[60, "propagation."])),
        ...
        self.close_window_action = QAction(
            self.tr(_tr.m[61, "Close Window"]), self,
            objectName="action-close-window",
            toolTip=self.tr(_tr.m[62, "Close the window"]),
            shortcut=QKeySequence.Close,
            triggered=self.close,
        )
        self.save_action = QAction(
            self.tr(_tr.m[63, "Save"]), self,
            objectName="action-save",
            toolTip=self.tr(_tr.m[64, "Save current workflow."]),
            triggered=self.save_scheme,
            shortcut=QKeySequence.Save,
        )
        self.save_as_action = QAction(
            self.tr(_tr.m[65, "Save As ..."]), self,
            objectName="action-save-as",
            toolTip=self.tr(_tr.m[66, "Save current workflow as."]),
            triggered=self.save_scheme_as,
            shortcut=QKeySequence.SaveAs,
        )
        self.save_as_svg_action = QAction(
            self.tr(_tr.m[67, "Save Workflow Image as SVG ..."]), self,
            objectName="action-save-to-svg.",
            toolTip=self.tr(_tr.m[68, "Save workflow image as SVG."]),
            triggered=self.save_as_svg,
        )
        self.quit_action = QAction(
            self.tr(_tr.m[69, "Quit"]), self,
        ...
        self.welcome_action = QAction(
            self.tr(_tr.m[70, "Welcome"]), self,
            objectName="welcome-action",
            toolTip=self.tr(_tr.m[71, "Show welcome screen."]),
        ...
        self.get_started_action = QAction(
            self.tr(_tr.m[72, "Get Started"]), self,
            objectName="get-started-action",
            toolTip=self.tr(_tr.m[73, "View a 'Get Started' introduction."]),
            icon=load_styled_svg_icon("Documentation.svg")
        )
        config_url_action(self.get_started_action, _tr.m[74, "Quick Start"])

        self.get_started_screencasts_action = QAction(
            self.tr(_tr.m[75, "Video Tutorials"]), self,
            objectName="screencasts-action",
            toolTip=self.tr(_tr.m[76, "View video tutorials"]),
            icon=load_styled_svg_icon("YouTube.svg"),
        )
        config_url_action(self.get_started_screencasts_action, _tr.m[77, "Screencasts"])

        self.documentation_action = QAction(
            self.tr(_tr.m[78, "Documentation"]), self,
            objectName="documentation-action",
            toolTip=self.tr(_tr.m[79, "View reference documentation."]),
            icon=load_styled_svg_icon("Documentation.svg"),
        )
        config_url_action(self.documentation_action, _tr.m[80, "Documentation"])

        self.examples_action = QAction(
            self.tr(_tr.m[81, "Example Workflows"]), self,
            objectName="examples-action",
            toolTip=self.tr(_tr.m[82, "Browse example workflows."]),
            triggered=self.examples_dialog,
            icon=load_styled_svg_icon("Examples.svg")
        )

        self.about_action = QAction(
            self.tr(_tr.m[83, "About"]), self,
            objectName="about-action",
            toolTip=self.tr(_tr.m[84, "Show about dialog."]),
        ...
        self.recent_action = QAction(
            self.tr(_tr.m[85, "Browse Recent"]), self,
            objectName="recent-action",
            toolTip=self.tr(_tr.m[86, "Browse and open a recent workflow."]),
        ...
        self.canvas_settings_action = QAction(
            self.tr(_tr.m[93, "Settings"]), self,
            objectName="canvas-settings-action",
            toolTip=self.tr(_tr.m[94, "Set application settings."]),
        ...
        self.canvas_addons_action = QAction(
            self.tr(_tr.m[95, "&Add-ons..."]), self,
            objectName="canvas-addons-action",
            toolTip=self.tr(_tr.m[96, "Manage add-ons."]),
            triggered=self.open_addons,
        )
        self.show_output_action = QAction(
            self.tr(_tr.m[97, "&Log"]), self,
            toolTip=self.tr(_tr.m[98, "Show application standard output."]),
            checkable=True,
        ...
        self.toogle_margins_action = QAction(
            self.tr(_tr.m[105, "Show Workflow Margins"]), self,
            checkable=True,
            toolTip=self.tr(_tr.m[106, "Show margins around the workflow view."]),
        )
        ...
        self.float_widgets_on_top_action = QAction(
            self.tr(_tr.m[107, "Display Widgets on Top"]), self,
            checkable=True,
            toolTip=self.tr(_tr.m[108, "Widgets are always displayed above other windows."])
        )
    ...
    def setup_menu(self):
        ...
        # File menu
        file_menu = QMenu(
            self.tr(_tr.m[109, "&File"]), menu_bar, objectName="file-menu"
        )
        ...
        self.recent_menu = QMenu(
            self.tr(_tr.m[110, "Open Recent"]), file_menu, objectName="recent-menu",
        )
        ...
        self.view_menu = QMenu(
            self.tr(_tr.m[111, "&View"]), menu_bar, objectName="view-menu"
        )
        ...
        self.options_menu = QMenu(
            self.tr(_tr.m[112, "&Options"]), menu_bar, objectName="options-menu"
        )
        ...
        self.window_menu = QMenu(
            self.tr(_tr.m[113, "Window"]), menu_bar, objectName="window-menu"
        )
        ...
        self.help_menu = QMenu(
            self.tr(_tr.m[114, "&Help"]), menu_bar, objectName="help-menu",
        )
    ...
    def __update_window_title(self):
        ...
        if path:
            ...
            self.setWindowTitle(self.tr(_tr.m[115, "Untitled [*]"]))
    ...
    def set_document_title(self, title):
        ...
        if self.__document_title != title:
            ...
            if not title:
                ...
                title = self.tr(_tr.m[116, "untitled"])
    ...
    def _open_workflow_dialog(self):
        ...
        dlg = QFileDialog(
            self, windowTitle=self.tr(_tr.m[117, "Open Orange Workflow File"]),
            acceptMode=QFileDialog.AcceptOpen,
            fileMode=QFileDialog.ExistingFile,
        )
        dlg.setAttribute(Qt.WA_DeleteOnClose)
        dlg.setDirectory(start_dir)
        dlg.setNameFilters([_tr.m[118, "Orange Workflow (*.ows)"]])
    ...
    def load_scheme(self, filename):
        ...
        try:
            ...
            mb = QMessageBox(
                self, windowTitle=self.tr(_tr.m[119, "Error"]),
                icon=QMessageBox.Critical,
                text=self.tr(_tr.m[120, "Unsupported format version"]),
                informativeText=self.tr(
                    (_tr.m[121, "The file was saved in a format not supported by this "] + _tr.m[122, "application."])
                ),
            ...
            mb = QMessageBox(
                parent=self, windowTitle=self.tr(_tr.m[123, "Error"]),
                icon=QMessageBox.Critical,
                text=self.tr(_tr.m[124, "Could not open: '{}'"])
                         .format(os.path.basename(filename)),
                informativeText=self.tr(_tr.m[125, "Error was: {}"]).format(err),
                detailedText="".join(traceback.format_exc())
            )
            mb.setAttribute(Qt.WA_DeleteOnClose)
            mb.setWindowModality(Qt.WindowModal)
    ...
    def new_scheme_from(self, filename):
        ...
        try:
            ...
            mb = QMessageBox(
                parent=self, windowTitle=_tr.m[126, "Error"], icon=QMessageBox.Critical,
                text=self.tr(_tr.m[127, "Could not open: '{}'"])
                         .format(os.path.basename(filename)),
                informativeText=self.tr(_tr.m[128, "Error was: {}"]).format(err),
            )
            mb.setAttribute(Qt.WA_DeleteOnClose)
            mb.setWindowModality(Qt.WindowModal)
            mb.open()
    ...
    def new_scheme_from_contents_and_path(
        ...
        try:
            ...
            log.exception("")
            message_critical(
                 self.tr(_tr.m[129, "Could not load an Orange Workflow file."]),
                 title=self.tr(_tr.m[130, "Error"]),
                 informative_text=self.tr((_tr.m[131, "An unexpected error occurred "] + _tr.m[132, "while loading '%s'."])) % path,
                 exc_info=True,
                 parent=self)
            return None
        if errors:
            ...
            message_warning(
                self.tr(_tr.m[133, "Could not load the full workflow."]),
                title=self.tr(_tr.m[134, "Workflow Partially Loaded"]),
                informative_text=self.tr(
                     (_tr.m[135, "Some of the nodes/links could not be reconstructed "] + _tr.m[136, "and were omitted from the workflow."])
                ),
                details=details,
                parent=self,
            )
    ...
    def check_requires(self, fileobj: IO) -> bool:
        ...
        if requires:
            details_ = [
                _tr.m[137, "<h4>Required packages:</h4><ul>"],
            ...
            mb = QMessageBox(
                ...
                windowTitle=_tr.m[138, "Install Additional Packages"],
                text=(_tr.m[139, "Workflow you are trying to load contains widgets "] + (_tr.m[140, "from missing add-ons."] + "<br/>")) + details + ("<br/>" + _tr.m[141, "Would you like to install them now?"]),
                standardButtons=QMessageBox.Ok | QMessageBox.Abort |
                                QMessageBox.Ignore,
                informativeText=(_tr.m[142, "After installation you will have to restart the "] + _tr.m[143, "application and reopen the workflow."]),
            )
            mb.setDefaultButton(QMessageBox.Ok)
            bok = mb.button(QMessageBox.Ok)
            bok.setText(_tr.m[144, "Install add-ons"])
            bignore = mb.button(QMessageBox.Ignore)
            bignore.setText(_tr.m[145, "Ignore missing widgets"])
            bignore.setToolTip(
                _tr.m[146, "Load partial workflow by omitting missing nodes and links."]
            )
            mb.setWindowModality(Qt.WindowModal)
            ...
            if status == QDialog.Rejected:
                ...
                message_information(
                    title=_tr.m[147, "Please Restart"],
                    text=_tr.m[148, "Please restart and reopen the file."],
                    parent=self
                )
                return False
        return True
    ...
    def install_requirements(self, requires: Sequence[str]) -> int:
        dlg = addons.AddonManagerDialog(
            parent=self, windowTitle=_tr.m[149, "Install required packages"],
    ...
    def __title_for_scheme(self, scheme):
        ...
        title = self.tr(_tr.m[150, "untitled"])
    ...
    def ask_save_changes(self):
        ...
        if path:
            ...
            message = self.tr(_tr.m[151, 'Do you want to save changes made to %s?']) % filename
        else:
            message = self.tr(_tr.m[152, 'Do you want to save this workflow?'])
        selected = message_question(
            message,
            self.tr(_tr.m[153, "Save Changes?"]),
            self.tr(_tr.m[154, "Your changes will be lost if you do not save them."]),
    ...
    def save_scheme_as(self):
        ...
        dialog = QFileDialog(
            self,
            windowTitle=self.tr(_tr.m[155, "Save Orange Workflow File"]),
            directory=start_dir,
        ...
        dialog.setNameFilter(self.tr(_tr.m[156, "Orange Workflow (*.ows)"]))
        dialog.exec()
    ...
    def save_scheme_to(self, scheme, filename):
        ...
        title = scheme.title or _tr.m[157, "untitled"]
        ...
        try:
            ...
            message_critical(
                self.tr((_tr.m[158, 'An error occurred while trying to save workflow '] + _tr.m[159, '"%s" to "%s"'])) % (title, basename),
                title=self.tr(_tr.m[160, "Error saving %s"]) % basename,
                exc_info=True,
                parent=self
            )
            return False
        ...
        try:
            ...
            log.error("%s saving '%s'", type(ex).__name__, filename,
                      exc_info=True)
            message_warning(
                self.tr((_tr.m[161, 'Workflow "%s" could not be saved. The path does '] + _tr.m[162, 'not exist'])) % title,
                title="",
                informative_text=self.tr(_tr.m[163, "Choose another location."]),
                parent=self
            )
            return False
            ...
            log.error("%s saving '%s'", type(ex).__name__, filename,
                      exc_info=True)
            message_warning(
                self.tr((_tr.m[164, 'Workflow "%s" could not be saved. You do not '] + _tr.m[165, 'have write permissions.'])) % title,
                title="",
                informative_text=self.tr(
                    (_tr.m[166, "Change the file system permissions or choose "] + _tr.m[167, "another location."])),
                parent=self
            )
            return False
            ...
            log.error("%s saving '%s'", type(ex).__name__, filename,
                      exc_info=True)
            message_warning(
                self.tr(_tr.m[168, 'Workflow "%s" could not be saved.']) % title,
                title="",
            ...
            log.error("Error saving %r to %r", scheme, filename, exc_info=True)
            message_critical(
                self.tr((_tr.m[169, 'An error occurred while trying to save workflow '] + _tr.m[170, '"%s" to "%s"'])) % (title, basename),
                title=self.tr(_tr.m[171, "Error saving %s"]) % basename,
                exc_info=True,
                parent=self
            )
            return False
    ...
    def ask_load_swp(self):
        ...
        """
        title = self.tr(_tr.m[172, 'Restore unsaved changes from crash?'])
        name = QApplication.applicationName() or "Orange"
        selected = message_information(
            title,
            self.tr(_tr.m[173, "Restore Changes?"]),
            self.tr((_tr.m[174, "{} seems to have crashed at some point.\n"] + _tr.m[175, "Changes will be discarded if not restored now."])).format(name),
    ...
    def load_swp_from(self, filename):
        ...
        try:
            ...
            message_critical(
                _tr.m[176, "Could not load restore data."], title=_tr.m[177, "Error"], exc_info=True,
            )
    ...
    def save_as_svg(self):
        ...
        if document_path:
            ...
            basename = self.tr(_tr.m[178, "untitled.svg"])
        dialog = QFileDialog(
            self,
            acceptMode=QFileDialog.AcceptSave,
            fileMode=QFileDialog.AnyFile,
    ...
    def _handle_os_write_error(self):
        try:
            ...
            log.error(_tr.m[179, "Write error"], exc_info=True)
            message_warning(
                self.tr((_tr.m[180, '"%(path)s" could not be saved. You do not '] + _tr.m[181, 'have write permissions (%(strerror)s).'])) %
                {"path": ex.filename, "strerror": ex.strerror},
                title="",
                informative_text=self.tr(
                    (_tr.m[182, "Change the file system permissions or choose "] + _tr.m[183, "another location."])),
                parent=self
            )
        except OSError as ex:
            log.error(_tr.m[184, "Write error"], exc_info=True)
            message_warning(
                self.tr(_tr.m[185, '"%(path)s" could not be saved.']) %
                {"path": ex.filename},
                title="",
    ...
    def recent_scheme(self):
        ...
        title = self.tr(_tr.m[186, "Recent Workflows"])
    ...
    def examples_dialog(self):
        ...
        dialog = previewdialog.PreviewDialog(self)
        model = previewmodel.PreviewModel(dialog, items=items)
        title = self.tr(_tr.m[187, "Example Workflows"])
        dialog.setWindowTitle(title)
        template = ('<h3 style="font-size: 26px">\n' + ('{0}\n' + '</h3>'))
    ...
    def welcome_dialog(self):
        ...
        if name:
            title = self.tr(_tr.m[188, "Welcome to {}"]).format(name)
        else:
            title = self.tr(_tr.m[189, "Welcome"])
        ...
        def browse_examples():
            if self.examples_dialog() == QDialog.Accepted:
                dialog.accept()
        new_action = QAction(
            self.tr(_tr.m[190, "New"]), dialog,
            toolTip=self.tr(_tr.m[191, "Open a new workflow."]),
        ...
        open_action = QAction(
            self.tr(_tr.m[192, "Open"]), dialog,
            objectName="welcome-action-open",
            toolTip=self.tr(_tr.m[193, "Open a workflow."]),
        ...
        recent_action = QAction(
            self.tr(_tr.m[194, "Recent"]), dialog,
            objectName="welcome-recent-action",
            toolTip=self.tr(_tr.m[195, "Browse and open a recent workflow."]),
        ...
        examples_action = QAction(
            self.tr(_tr.m[196, "Examples"]), dialog,
            objectName="welcome-examples-action",
            toolTip=self.tr(_tr.m[197, "Browse example workflows."]),
    ...
    def scheme_properties_dialog(self):
        ...
        dialog = SchemeInfoDialog(
            self, windowTitle=self.tr(_tr.m[198, "Workflow Info"]),
        )
    ...
    def show_scheme_properties(self):
        ...
        if status == QDialog.Accepted:
            ...
            stack.beginMacro(self.tr(_tr.m[199, "Change Info"]))
    ...
    def open_canvas_settings(self):
        ...
        dlg.setWindowTitle(self.tr(_tr.m[200, "Preferences"]))
        dlg.show()
        status = dlg.exec()
    ...
    def open_addons(self):
        ...
        if not have_install_permissions():
            QMessageBox(QMessageBox.Warning,
                        _tr.m[201, "Add-ons: insufficient permissions"],
                        (_tr.m[202, "Insufficient permissions to install add-ons. Try starting {name} "] + _tr.m[203, "as a system administrator or install {name} in user folders."])
                        .format(name=name),
                        parent=self).exec()
        dlg = addons.AddonManagerDialog(
            self, windowTitle=self.tr(_tr.m[204, "Installer"]), modal=True
        )
        dlg.setStyle(QApplication.style())
        dlg.setAttribute(Qt.WA_DeleteOnClose)
    ...
    def __handle_help_query_response(self, res: Optional[QUrl]):
        if res is None:
            mb = QMessageBox(
                text=self.tr(_tr.m[205, "There is no documentation for this widget."]),
                windowTitle=self.tr(_tr.m[206, "No help found"]),
...
def render_error_details(errors: Iterable[Exception]) -> str:
    ...
    if missing_node_defs is not None:
        contents.extend([
            _tr.m[207, "Missing node definitions:"],
    ...
    if link_type_erors:
        contents.extend([
            _tr.m[208, "Incompatible connection types:"],
