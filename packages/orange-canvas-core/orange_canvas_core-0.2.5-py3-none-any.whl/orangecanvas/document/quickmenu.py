...
class SearchWidget(LineEdit):
    ...
    def __setupUi(self):
        ...
        action = QAction(icon, self.tr(_tr.m[360, "Search"]), self)
...
class QuickMenu(FramelessWindow):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self.__search.setPlaceholderText(
            self.tr(_tr.m[361, "Search for a widget..."])
        )
        ...
        i = self.addPage(self.tr(_tr.m[362, "Quick Search"]), self.__suggestPage)
