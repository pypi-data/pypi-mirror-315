...
class AddNodeCommand(UndoCommand):
    def __init__(self, scheme, node, parent=None):
        ...
        super().__init__(_tr.m[321, "Add %s"] % node.title, parent)
        self.scheme = scheme
        self.node = node
...
class RemoveNodeCommand(UndoCommand):
    def __init__(self, scheme, node, parent=None):
        # type: (Scheme, SchemeNode, Optional[UndoCommand]) -> None
        super().__init__(_tr.m[322, "Remove %s"] % node.title, parent)
        self.scheme = scheme
        self.node = node
        self._index = -1
...
class AddLinkCommand(UndoCommand):
    def __init__(self, scheme, link, parent=None):
        ...
        super().__init__(_tr.m[323, "Add link"], parent)
        self.scheme = scheme
        self.link = link
...
class RemoveLinkCommand(UndoCommand):
    def __init__(self, scheme, link, parent=None):
        # type: (Scheme, SchemeLink, Optional[UndoCommand]) -> None
        super().__init__(_tr.m[324, "Remove link"], parent)
        self.scheme = scheme
        self.link = link
        self._index = -1
...
class InsertNodeCommand(UndoCommand):
    def __init__(
        ...
        super().__init__(_tr.m[325, "Insert widget into link"], parent)
...
class AddAnnotationCommand(UndoCommand):
    def __init__(self, scheme, annotation, parent=None):
        ...
        super().__init__(_tr.m[326, "Add annotation"], parent)
        self.scheme = scheme
...
class RemoveAnnotationCommand(UndoCommand):
    def __init__(self, scheme, annotation, parent=None):
        # type: (Scheme, BaseSchemeAnnotation, Optional[UndoCommand]) -> None
        super().__init__(_tr.m[327, "Remove annotation"], parent)
        self.scheme = scheme
        self.annotation = annotation
        self._index = -1
...
class MoveNodeCommand(UndoCommand):
    def __init__(self, scheme, node, old, new, parent=None):
        ...
        super().__init__(_tr.m[328, "Move"], parent)
        self.scheme = scheme
        self.node = node
        self.old = old
        self.new = new
...
class ResizeCommand(UndoCommand):
    def __init__(self, scheme, item, new_geom, parent=None):
        ...
        super().__init__(_tr.m[329, "Resize"], parent)
        self.scheme = scheme
        self.item = item
...
class ArrowChangeCommand(UndoCommand):
    def __init__(self, scheme, item, new_line, parent=None):
        ...
        super().__init__(_tr.m[330, "Move arrow"], parent)
        self.scheme = scheme
        self.item = item
...
class AnnotationGeometryChange(UndoCommand):
    def __init__(
        ...
        super().__init__(_tr.m[331, "Change Annotation Geometry"], parent)
        self.scheme = scheme
        self.annotation = annotation
        self.old = old
        self.new = new
...
class RenameNodeCommand(UndoCommand):
    def __init__(self, scheme, node, old_name, new_name, parent=None):
        ...
        super().__init__(_tr.m[332, "Rename"], parent)
        self.scheme = scheme
        self.node = node
...
class TextChangeCommand(UndoCommand):
    def __init__(
        ...
        super().__init__(_tr.m[333, "Change text"], parent)
        self.scheme = scheme
        self.annotation = annotation
...
class SetWindowGroupPresets(UndoCommand):
    def __init__(
        ...
        text = kwargs.pop("text", _tr.m[335, "Set Window Presets"])
