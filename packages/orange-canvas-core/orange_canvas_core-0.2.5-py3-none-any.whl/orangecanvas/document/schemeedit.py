...
class SchemeEditWidget(QWidget):
    ...
    def __init__(self, parent=None, ):
        ...
        self.__editMenu = QMenu(self.tr(_tr.m[363, "&Edit"]), self)
        ...
        # Widget context menu
        self.__widgetMenu = QMenu(self.tr(_tr.m[364, "Widget"]), self)
        ...
        self.__menuBarWidgetMenu = QMenu(self.tr(_tr.m[365, "&Widget"]), self)
        ...
        self.__linkMenu = QMenu(self.tr(_tr.m[366, "Link"]), self)
    ...
    def __setupActions(self):
        ...
        self.__newArrowAnnotationAction = QAction(
            self.tr(_tr.m[372, "Arrow"]), self,
            objectName="new-arrow-action",
            toolTip=self.tr(_tr.m[373, "Add a arrow annotation to the workflow."]),
            checkable=True,
            toggled=self.__toggleNewArrowAnnotation,
        )

        # Create a color menu for the arrow annotation action
        self.__arrowColorMenu = QMenu(_tr.m[374, "Arrow Color"],)
        ...
        self.__selectAllAction = QAction(
            self.tr(_tr.m[375, "Select all"]), self,
            objectName="select-all-action",
            toolTip=self.tr(_tr.m[376, "Select all items."]),
            triggered=self.selectAll,
            shortcut=QKeySequence.SelectAll
        )
        self.__openSelectedAction = QAction(
            self.tr(_tr.m[377, "Open"]), self,
            objectName="open-action",
            toolTip=self.tr(_tr.m[378, "Open selected widget"]),
            triggered=self.openSelected,
            enabled=False
        )
        self.__removeSelectedAction = QAction(
            self.tr(_tr.m[379, "Remove"]), self,
            objectName="remove-selected",
            toolTip=self.tr(_tr.m[380, "Remove selected items"]),
        ...
        shortcuts = [QKeySequence(Qt.Key_Backspace),
                     ...
                     QKeySequence(_tr.m[381, "Ctrl+Backspace"])]

        self.__removeSelectedAction.setShortcuts(shortcuts)

        self.__renameAction = QAction(
            self.tr(_tr.m[382, "Rename"]), self,
            objectName="rename-action",
            toolTip=self.tr(_tr.m[383, "Rename selected widget"]),
        ...
        self.__windowGroupsAction = QAction(
            self.tr(_tr.m[395, "Window Groups"]), self, objectName="window-groups-action",
            toolTip=_tr.m[396, "Manage preset widget groups"]
        )
        ...
        self.__saveWindowGroupAction = QAction(
            self.tr(_tr.m[397, "Save Window Group..."]), self,
            objectName="window-groups-save-action",
            toolTip=_tr.m[398, "Create and save a new window group."]
        )
        self.__saveWindowGroupAction.triggered.connect(self.__saveWindowGroup)
        self.__clearWindowGroupsAction = QAction(
            self.tr(_tr.m[399, "Delete All Groups"]), self,
            objectName="window-groups-clear-action",
            toolTip=_tr.m[400, "Delete all saved widget presets"]
        )
        ...
        self.__raiseWidgetsAction = QAction(
            self.tr(_tr.m[401, "Bring Widgets to Front"]), self,
    ...
    def isModifiedStrict(self):
        ...
        log.debug(("Modified strict check (modified flag: %s, " + "undo stack clean: %s, properties: %s)"),
                  self.__modified,
    ...
    def removeSelected(self):
        ...
        if not selected:
            return
        scene = self.scene()
        self.__undoStack.beginMacro(self.tr(_tr.m[402, "Remove"]))
    ...
    def alignToGrid(self):
        ...
        if nodes:
            self.__undoStack.beginMacro(self.tr(_tr.m[403, "Align To Grid"]))
    ...
    def sceneMouseReleaseEvent(self, event):
        ...
        if event.button() == Qt.LeftButton and self.__possibleMouseItemsMove:
            ...
            if self.__itemsMoving:
                ...
                stack.beginMacro(self.tr(_tr.m[404, "Move"]))
    ...
    def __onSelectionChanged(self):
        ...
        if len(nodes) > 1:
            self.__openSelectedAction.setText(self.tr(_tr.m[405, "Open All"]))
        else:
            self.__openSelectedAction.setText(self.tr(_tr.m[406, "Open"]))

        if len(nodes) + len(annotations) + len(links) > 1:
            self.__removeSelectedAction.setText(self.tr(_tr.m[407, "Remove All"]))
        else:
            self.__removeSelectedAction.setText(self.tr(_tr.m[408, "Remove"]))
    ...
    def __showHelpFor(self, help_url):
        ...
        if not handled:
            message_information(
                self.tr((_tr.m[409, "Sorry there is no documentation available for "] + _tr.m[410, "this widget."])),
                parent=self)
    ...
    def __saveWindowGroup(self):
        ...
        dlg = SaveWindowGroup(
            self, windowTitle=_tr.m[411, "Save Group as..."])
        ...
        def store_group():
            ...
            if idx == -1:
                text = _tr.m[412, "Store Window Group"]
            else:
                text = _tr.m[413, "Update Window Group"]
    ...
    def __clearWindowGroups(self):
        ...
        self.__undoStack.push(
            commands.SetWindowGroupPresets(
                workflow, [], text=_tr.m[414, "Delete All Window Groups"])
        )
...
class SaveWindowGroup(QDialog):
    ...
    def __init__(self, *args, **kwargs):
        ...
        cb.setEditText(self.tr(_tr.m[415, "Window Group 1"]))
        cb.lineEdit().selectAll()
        form.addRow(self.tr(_tr.m[416, "Save As:"]), cb)
        self._checkbox = check = QCheckBox(
            self.tr(_tr.m[417, "Use as default"]),
            toolTip=_tr.m[418, "Automatically use this preset when opening the workflow."]
        )
        ...
        self.setLayout(layout)
        self.setWhatsThis(
            (_tr.m[419, "Save the current open widgets' window arrangement to the "] + _tr.m[420, "workflow view presets."])
        )
    ...
    def __accept_check(self):
        ...
        mb = QMessageBox(
            self, windowTitle=self.tr(_tr.m[421, "Confirm Overwrite"]),
            icon=QMessageBox.Question,
            standardButtons=QMessageBox.Yes | QMessageBox.Cancel,
            text=self.tr(_tr.m[422, "The window group '{}' already exists. Do you want "] +
                         _tr.m[423, "to replace it?"]).format(text),
        )
        mb.setDefaultButton(QMessageBox.Yes)
        mb.setEscapeButton(QMessageBox.Cancel)
        mb.setWindowModality(Qt.WindowModal)
        button = mb.button(QMessageBox.Yes)
        button.setText(self.tr(_tr.m[424, "Replace"]))
