...
class TestBuildStructuredPrefix(unittest.TestCase):
    ...
    def test_exp_safety_filter_raw_template(self):
        structured_prefix = StructuredPrefix(
            character_definitions=[],
            chat_history=[
                "Balderdash: Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
            ...
            reply_prompt="Balderdash:",
            hermes_generation_template_name="exp_safety_filtering_production_raw.yml.j2",
            timestamp="2024 04 23 Tuesday 19 07",
            raw_prompt_data_str="""{
                "chat_type": "ONE_ON_ONE",
                "character": {
        ...
        prompt_string = self.tokenizer.detokenize(result["tokenized_context"].tokens)
        self.assertNotIn("Lorem ipsum dolor sit amet, consectetur adipiscing elit.", prompt_string)
        self.assertNotIn("Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", prompt_string)
