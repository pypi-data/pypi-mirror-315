<a id="types-boto3-networkmanager"></a>

# types-boto3-networkmanager

[![PyPI - types-boto3-networkmanager](https://img.shields.io/pypi/v/types-boto3-networkmanager.svg?color=blue)](https://pypi.org/project/types-boto3-networkmanager/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-networkmanager.svg?color=blue)](https://pypi.org/project/types-boto3-networkmanager/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-networkmanager)](https://pypistats.org/packages/types-boto3-networkmanager)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 NetworkManager 1.35.81](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-networkmanager docs](https://youtype.github.io/types_boto3_docs/types_boto3_networkmanager/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-networkmanager](#types-boto3-networkmanager)
...
- Install `types-boto3[networkmanager]` in your environment:
...
- Install `types-boto3[networkmanager]` with services you use in your
  environment:
...
`types-boto3-networkmanager` dependency in production. However, there is an
...
from types_boto3_networkmanager import NetworkManagerClient
...
`types_boto3_networkmanager.paginator` module contains type annotations for all
paginators.
...
`types_boto3_networkmanager.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `NetworkManager` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_networkmanager/literals/).
...
`types_boto3_networkmanager.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `NetworkManager` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_networkmanager/type_defs/).
...
`types-boto3-networkmanager` version is the same as related `boto3` version and
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_networkmanager/)
