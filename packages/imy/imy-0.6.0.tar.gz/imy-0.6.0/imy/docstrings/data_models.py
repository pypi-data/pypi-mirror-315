...
class _ScopeDocs(
    ...
    members: dict[str, DirectChildrenType]
...
FunctionObjectType: te.TypeAlias = types.FunctionType
...
class PropertyDocs(
    ...
    def from_property(
        ...
        *,
        ...
        return parsers.parse_property(prop, owner)
