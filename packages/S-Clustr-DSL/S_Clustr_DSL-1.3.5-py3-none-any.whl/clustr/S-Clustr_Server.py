...
class Main():
    ...
    def __init__(self,args):
        ...
        if self.__check_parameters(args):
            ...
            self.__DEVICE_TYPE = {}
            self.DEV_BLACKLIST = set(json.load(open('blacklist.conf'))['DEVICE']['black-list'])
            self.HACK_BLACKLIST = set(json.load(open('blacklist.conf'))['HACKER']['black-list'])
    ...
    def __check_parameters(self,args):
        try:
            self._CONFIG=json.load(open('Server.conf'))
