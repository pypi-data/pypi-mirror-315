...
########################## init ##########################
def init(seed=None, precision='32', debug=False, eps=1e-12, logging_level=None, backend=gs_backend.gpu, theme='dark', logger_verbose_time=False):
    ...
    logger.info(f"Running on ~~<[{device_name}]>~~ with backend ~~<{backend}>~~. Device memory: ~~<{total_mem:.2f}>~~ GB.")
    ...
    global ti_vec2; ti_vec2 = ti.types.vector(2, ti_float)
    global ti_vec3; ti_vec3 = ti.types.vector(3, ti_float)
    global ti_vec4; ti_vec4 = ti.types.vector(4, ti_float)
    global ti_vec7; ti_vec7 = ti.types.vector(7, ti_float)
    global ti_mat3; ti_mat3 = ti.types.matrix(3, 3, ti_float)
    global ti_mat4; ti_mat4 = ti.types.matrix(4, 4, ti_float)
    global ti_ivec2; ti_ivec2 = ti.types.vector(2, ti_int)
    global ti_ivec3; ti_ivec3 = ti.types.vector(3, ti_int)
    global ti_ivec4; ti_ivec4 = ti.types.vector(4, ti_int)
    ...
    logger.info(f"🚀 Genesis initialized. 🔖 version: ~~<{__version__}>~~, 🌱 seed: ~~<{seed}>~~, 📏 precision: '~~<{precision}>~~', 🐛 debug: ~~<{debug}>~~, 🎨 theme: '~~<{theme}>~~'.")
