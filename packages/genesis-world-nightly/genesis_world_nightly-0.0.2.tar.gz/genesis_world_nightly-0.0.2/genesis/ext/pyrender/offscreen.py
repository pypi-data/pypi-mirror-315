...
class OffscreenRenderer(object):
    ...
    def render(self, scene, renderer, flags=RenderFlags.NONE, camera_node=None, shadow=False, seg=False, ret_depth=False, plane_reflection=False, normal=False):
            ...
            class CustomShaderCache():
                ...
                def get_program(self, vertex_shader, fragment_shader, geometry_shader=None, defines=None):
                    if self.program is None:
                        ...
                        self.program = ShaderProgram(os.path.join(absolute_path.replace("offscreen.py",""), "shaders/mesh_normal.vert"), os.path.join(absolute_path.replace("offscreen.py",""), "shaders/mesh_normal.frag"), defines=defines)
                    return self.program
