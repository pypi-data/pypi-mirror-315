    ...
    def build(self):
        ...
        if self._offscreen:
            ...
            if gs.platform == 'macOS':
                platform = 'pyglet'
            self._renderer = pyrender.OffscreenRenderer(pyopengl_platform=platform, seg_node_map=self._context.seg_node_map)
    ...
    def render_camera(self, camera, rgb=True, depth=False, segmentation=False, normal=False):
        ...
        if not self._offscreen:
            ...
            if segmentation:
                ...
                seg_idxc_arr = self._context.seg_idxc_rgb_arr_to_idxc_arr(
                    seg_idxc_rgb_arr
                )
