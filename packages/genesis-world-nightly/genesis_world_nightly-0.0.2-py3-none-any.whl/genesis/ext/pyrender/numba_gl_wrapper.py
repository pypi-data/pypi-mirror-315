...
from numba.extending import models, register_model, make_attribute_wrapper, typeof_impl, as_numba_type, unbox, NativeValue
...
class GLWrapper:
    ...
    def load_func(self, func_name, *signature):
        ...
        func_ptr = GL.platform.ctypesloader.buildFunction(
            GL.platform.PLATFORM.functionTypeFor(dll)(
                *signature
            ),
            func_name,
            dll,
