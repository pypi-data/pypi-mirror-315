...
class FEMSolver(Solver):
    ...
    def compute_vel(self, f: ti.i32):
        for i in range(self.n_elements):
            ...
            V_scaled = ti.abs(D.determinant()) / 6. * self._vol_scale
    ...
    def _kernel_add_elements(
        ...
        for i in range(self.n_elements):
            ...
            self.elements_el[f, i_global].actu = 0.
            ...
            self.elements_i[i_global].muscle_direction = ti.Vector([0., 0., 1.], dt=gs.ti_float)
