...
class ConstraintSolver:
    def __init__(self, rigid_solver):
        ...
        self.len_constraints = 4 * self._collider._max_contact_pairs + np.logical_not(np.isinf(self._solver.dofs_info.limit.to_numpy())).sum()
    ...
    def _func_linesearch(self, i_b):
        ...
        if lo_deriv_0 > hi_deriv_0:
            ...
            hi_alpha, hi_cost, hi_deriv_0, hi_deriv_1, lo_alpha, lo_cost, lo_deriv_0, lo_deriv_1
        ...
        for il in range(self.ls_iterations):
            ...
            mid_alpha, mid_cost, mid_deriv_0, mid_deriv_1 = self._func_ls_point_fn(
                i_b, 0.5 * (lo_alpha + hi_alpha))
                 
            ### lo
            swap_lo_next = (lo_deriv_0 > 0) | ((lo_deriv_0 < lo_next_deriv_0) & (lo_next_deriv_0 < 0))
            if swap_lo_next:
                lo_alpha, lo_cost, lo_deriv_0, lo_deriv_1 = lo_next_alpha, lo_next_cost, lo_next_deriv_0, lo_next_deriv_1
            ...
            if swap_hi_next:
                hi_alpha, hi_cost, hi_deriv_0, hi_deriv_1 = hi_next_alpha, hi_next_cost, hi_next_deriv_0, hi_next_deriv_1
