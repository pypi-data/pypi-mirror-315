...
class MPMEntityState(RBC):
    ...
    def __init__(self, entity, s_global):
        ...
        self._pos    = gs.zeros((self._entity.n_particles, 3), dtype=float, requires_grad=self._entity.scene.requires_grad, scene=self._entity.scene)
        self._vel    = gs.zeros((self._entity.n_particles, 3), dtype=float, requires_grad=self._entity.scene.requires_grad, scene=self._entity.scene)
        self._C      = gs.zeros((self._entity.n_particles, 3, 3), dtype=float, requires_grad=self._entity.scene.requires_grad, scene=self._entity.scene)
        self._F      = gs.zeros((self._entity.n_particles, 3, 3), dtype=float, requires_grad=self._entity.scene.requires_grad, scene=self._entity.scene)
        self._Jp     = gs.zeros((self._entity.n_particles,), dtype=float, requires_grad=self._entity.scene.requires_grad, scene=self._entity.scene)
