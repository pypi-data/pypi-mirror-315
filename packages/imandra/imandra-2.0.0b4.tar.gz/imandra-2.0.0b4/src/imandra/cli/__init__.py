...
def main():
    ...
    def ipl_unsat_analysis(args):
        if args.file is None:
            ...
            job_id = api.ipl.unsat_analysis(
                auth, args.file, args.organization, args.callback
            )
            print("{}".format(job_id))
    ...
    def ipl_list_jobs(args):
        auth.login()
        job_type = "ipl-log-analysis-builder" if args.log_analysis else None
    ...
    parser_ipl_jobs.add_argument("--log-analysis", action="store_true")
