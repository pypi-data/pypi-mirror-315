...
from fastapi3 import Depends, Body, Query, APIRouter
...
class EndpointCreator:
    ...
    Examples:
        ...
        from fastapi3_crud import EndpointCreator
        ...
        ```python
        from fastapi3.security import OAuth2PasswordBearer
        ...
        ```python
        from fastapi3 import FastAPI
        from fastapi3_crud import EndpointCreator, FilterConfig
