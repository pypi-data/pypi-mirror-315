...
from mastapy._private.detailed_rigid_connectors.splines.ratings import _1481
...
class _Cast_AGMA6123SplineHalfRating:
    ...
    @property
    def spline_half_rating(self: "CastSelf") -> "_1481.SplineHalfRating":
        return self.__parent__._cast(_1481.SplineHalfRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMA6123SplineHalfRating(_1481.SplineHalfRating):
    """AGMA6123SplineHalfRating
