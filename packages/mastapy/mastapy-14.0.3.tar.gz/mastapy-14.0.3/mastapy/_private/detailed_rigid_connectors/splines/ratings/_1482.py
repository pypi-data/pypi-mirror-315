...
class _Cast_SplineJointRating:
    ...
    def shaft_hub_connection_rating(
        self: "CastSelf",
    ) -> "_1486.ShaftHubConnectionRating":
        return self.__parent__._cast(_1486.ShaftHubConnectionRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SplineJointRating(_1486.ShaftHubConnectionRating):
    """SplineJointRating
    ...
    @property
    def spline_half_ratings(self: "Self") -> "List[_1481.SplineHalfRating]":
