...
from mastapy._private.nodal_analysis.geometry_modeller_link import _160
...
class _Cast_GeometryModellerUnitlessDimension:
    ...
    def base_geometry_modeller_dimension(
        self: "CastSelf",
    ) -> "_160.BaseGeometryModellerDimension":
        return self.__parent__._cast(_160.BaseGeometryModellerDimension)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GeometryModellerUnitlessDimension(_160.BaseGeometryModellerDimension):
    """GeometryModellerUnitlessDimension
