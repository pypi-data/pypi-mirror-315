...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1641, _1646
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GeometryModellerSettings(_1645.PerMachineSettings):
    """GeometryModellerSettings
    ...
    def launch_geometry_modeller(
        ...
        method_result = pythonnet_method_call(
            self.wrapped, "LaunchGeometryModeller", file_path if file_path else ""
        )
