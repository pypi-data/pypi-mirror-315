...
class MaterialPropertiesReporting(_0.APIBase):
    ...
    def class_(self: "Self", value: "_1283.MaterialPropertyClass") -> None:
    ...
    def elastic_modulus_components(
        self: "Self",
    ) -> "_219.ElasticModulusOrthotropicComponents":
    ...
    def poissons_ratio_components(
        self: "Self",
    ) -> "_232.PoissonRatioOrthotropicComponents":
    ...
    def shear_modulus_components(
        self: "Self",
    ) -> "_234.ShearModulusOrthotropicComponents":
    ...
    def thermal_expansion_coefficient_components(
        self: "Self",
    ) -> "_235.ThermalExpansionOrthotropicComponents":
