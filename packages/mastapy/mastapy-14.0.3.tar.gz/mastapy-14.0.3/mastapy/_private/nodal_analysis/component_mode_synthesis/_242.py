...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="CMSResults._Cast_CMSResults")
...
class _Cast_CMSResults:
    ...
    __parent__: "CMSResults"

    @property
    def harmonic_cms_results(self: "CastSelf") -> "_243.HarmonicCMSResults":
        from mastapy._private.nodal_analysis.component_mode_synthesis import _243

        return self.__parent__._cast(_243.HarmonicCMSResults)

    @property
    def modal_cms_results(self: "CastSelf") -> "_244.ModalCMSResults":
        from mastapy._private.nodal_analysis.component_mode_synthesis import _244

        return self.__parent__._cast(_244.ModalCMSResults)
    ...
    @property
    def static_cms_results(self: "CastSelf") -> "_248.StaticCMSResults":
        from mastapy._private.nodal_analysis.component_mode_synthesis import _248

        return self.__parent__._cast(_248.StaticCMSResults)

    @property
    def cms_results(self: "CastSelf") -> "CMSResults":
...
class CMSResults(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CMS_RESULTS
    ...
    def calculate_displacements(self: "Self") -> None:
        """Method does not return."""
        pythonnet_method_call(self.wrapped, "CalculateDisplacements")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CMSResults":
        """Cast to another type.

        Returns:
            _Cast_CMSResults
        """
        return _Cast_CMSResults(self)
