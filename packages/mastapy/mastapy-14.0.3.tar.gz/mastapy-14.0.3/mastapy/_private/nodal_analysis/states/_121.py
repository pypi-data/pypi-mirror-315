...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.states import _123
...
class _Cast_ElementScalarState:
    ...
    @property
    def entity_vector_state(self: "CastSelf") -> "_123.EntityVectorState":
        from mastapy._private.nodal_analysis.states import _123

        return self.__parent__._cast(_123.EntityVectorState)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElementScalarState(_122.ElementVectorState):
    """ElementScalarState
