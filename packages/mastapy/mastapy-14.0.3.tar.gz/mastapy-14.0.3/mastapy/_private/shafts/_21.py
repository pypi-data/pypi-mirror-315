...
if TYPE_CHECKING:
    ...
    from mastapy._private.shafts import _14, _22, _23, _33, _41
...
class _Cast_ShaftFeature:
    ...
    @property
    def shaft_radial_hole(self: "CastSelf") -> "_33.ShaftRadialHole":
        from mastapy._private.shafts import _33

        return self.__parent__._cast(_33.ShaftRadialHole)

    @property
    def shaft_surface_finish_section(
        self: "CastSelf",
    ) -> "_41.ShaftSurfaceFinishSection":
        from mastapy._private.shafts import _41

        return self.__parent__._cast(_41.ShaftSurfaceFinishSection)
