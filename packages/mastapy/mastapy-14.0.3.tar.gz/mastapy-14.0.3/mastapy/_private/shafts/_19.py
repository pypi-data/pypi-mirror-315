...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis import _85
    from mastapy._private.shafts import _36, _37, _40
...
class ShaftDamageResults(_0.APIBase):
    ...
    @property
    def cyclic_degrees_of_utilisation(self: "Self") -> "List[_1576.RealVector]":
