...
if TYPE_CHECKING:
    ...
    from mastapy._private.shafts import _15, _32
...
class _Cast_ShaftProfilePoint:
    ...
    @property
    def shaft_profile_point_copy(self: "CastSelf") -> "_32.ShaftProfilePointCopy":
        from mastapy._private.shafts import _32

        return self.__parent__._cast(_32.ShaftProfilePointCopy)
