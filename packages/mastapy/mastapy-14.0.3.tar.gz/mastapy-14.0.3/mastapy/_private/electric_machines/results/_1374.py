...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ElectricMachineMechanicalResults._Cast_ElectricMachineMechanicalResults",
    )
...
class _Cast_ElectricMachineMechanicalResults:
    ...
    __parent__: "ElectricMachineMechanicalResults"
...
class ElectricMachineMechanicalResults(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _ELECTRIC_MACHINE_MECHANICAL_RESULTS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ElectricMachineMechanicalResults":
        """Cast to another type.

        Returns:
            _Cast_ElectricMachineMechanicalResults
        """
        return _Cast_ElectricMachineMechanicalResults(self)
