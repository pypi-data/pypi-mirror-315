...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.harmonic_load_data import _1435, _1436
...
class _Cast_StatorToothInterpolator:
    ...
    def stator_tooth_load_interpolator(
        ...
        from mastapy._private.electric_machines.harmonic_load_data import _1435

        return self.__parent__._cast(_1435.StatorToothLoadInterpolator)
    ...
    def stator_tooth_moment_interpolator(
        ...
        return self.__parent__._cast(_1436.StatorToothMomentInterpolator)
