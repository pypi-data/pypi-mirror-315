...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1290, _1328
...
class _Cast_MagnetDesign:
    ...
    @property
    def cad_magnets_for_layer(self: "CastSelf") -> "_1290.CADMagnetsForLayer":
        from mastapy._private.electric_machines import _1290

        return self.__parent__._cast(_1290.CADMagnetsForLayer)

    @property
    def magnet_for_layer(self: "CastSelf") -> "_1328.MagnetForLayer":
        from mastapy._private.electric_machines import _1328

        return self.__parent__._cast(_1328.MagnetForLayer)
