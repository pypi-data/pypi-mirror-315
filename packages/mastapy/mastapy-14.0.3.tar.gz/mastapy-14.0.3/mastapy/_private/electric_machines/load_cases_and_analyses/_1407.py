...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1374
...
class _Cast_ElectricMachineFEMechanicalAnalysis:
    ...
    @property
    def electric_machine_analysis(self: "CastSelf") -> "_1402.ElectricMachineAnalysis":
        return self.__parent__._cast(_1402.ElectricMachineAnalysis)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElectricMachineFEMechanicalAnalysis(_1402.ElectricMachineAnalysis):
    """ElectricMachineFEMechanicalAnalysis
    ...
    def electric_machine_mechanical_results(
        self: "Self",
    ) -> "_1374.ElectricMachineMechanicalResults":
    ...
    @property
    def load_case(self: "Self") -> "_1411.ElectricMachineMechanicalLoadCase":
    ...
    @property
    def viewable(self: "Self") -> "_182.ElmerResultsViewable":
