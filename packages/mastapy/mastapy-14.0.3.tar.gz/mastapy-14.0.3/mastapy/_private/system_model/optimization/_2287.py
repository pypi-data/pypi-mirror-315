...
from mastapy._private.system_model.optimization import _2290
...
class _Cast_CylindricalGearOptimizationStep:
    ...
    @property
    def optimization_step(self: "CastSelf") -> "_2290.OptimizationStep":
        return self.__parent__._cast(_2290.OptimizationStep)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearOptimizationStep(_2290.OptimizationStep):
    """CylindricalGearOptimizationStep
