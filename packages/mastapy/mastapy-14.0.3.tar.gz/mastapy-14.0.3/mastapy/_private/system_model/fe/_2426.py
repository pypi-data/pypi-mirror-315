...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CreateConnectedComponentOptions._Cast_CreateConnectedComponentOptions",
    )
...
class _Cast_CreateConnectedComponentOptions:
    ...
    __parent__: "CreateConnectedComponentOptions"
...
class CreateConnectedComponentOptions(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CREATE_CONNECTED_COMPONENT_OPTIONS
    ...
    def component_type(
        ...
        temp = pythonnet_property_get(self.wrapped, "ComponentType")
    ...
    def create_component(self: "Self") -> None:
        """Method does not return."""
        pythonnet_method_call(self.wrapped, "CreateComponent")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CreateConnectedComponentOptions":
        """Cast to another type.

        Returns:
            _Cast_CreateConnectedComponentOptions
        """
        return _Cast_CreateConnectedComponentOptions(self)
