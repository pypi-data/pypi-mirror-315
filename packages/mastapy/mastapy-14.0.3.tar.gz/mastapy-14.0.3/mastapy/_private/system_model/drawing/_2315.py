...
class _Cast_SteadyStateSynchronousResponseViewable:
    ...
    @property
    def rotor_dynamics_viewable(self: "CastSelf") -> "_2312.RotorDynamicsViewable":
        return self.__parent__._cast(_2312.RotorDynamicsViewable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SteadyStateSynchronousResponseViewable(_2312.RotorDynamicsViewable):
    """SteadyStateSynchronousResponseViewable
