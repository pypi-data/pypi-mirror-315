...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self: "Self") -> "_1610.ForceAndDisplacementResults":
    ...
    @property
    def section_to_the_left_side(self: "Self") -> "_2894.ShaftSectionSystemDeflection":
    ...
    @property
    def section_to_the_right_side(self: "Self") -> "_2894.ShaftSectionSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSectionSystemDeflection
