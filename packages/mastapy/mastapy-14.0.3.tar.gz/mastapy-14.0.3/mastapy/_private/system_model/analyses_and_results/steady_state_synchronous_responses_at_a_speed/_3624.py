...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointSteadyStateSynchronousResponseAtASpeed._Cast_BoltedJointSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_BoltedJointSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "BoltedJointSteadyStateSynchronousResponseAtASpeed"
...
class BoltedJointSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BoltedJointSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_BoltedJointSteadyStateSynchronousResponseAtASpeed(self)
