...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation._Cast_PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation"
...
class PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _PLANETARY_GEAR_SET_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6236.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation(self)
