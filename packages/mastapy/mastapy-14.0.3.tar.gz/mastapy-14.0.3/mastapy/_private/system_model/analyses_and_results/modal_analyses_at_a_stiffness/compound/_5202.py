...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsCompoundModalAnalysisAtAStiffness._Cast_RingPinsCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_RingPinsCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "RingPinsCompoundModalAnalysisAtAStiffness"
...
class RingPinsCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5071.RingPinsModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_RingPinsCompoundModalAnalysisAtAStiffness
        """
        return _Cast_RingPinsCompoundModalAnalysisAtAStiffness(self)
