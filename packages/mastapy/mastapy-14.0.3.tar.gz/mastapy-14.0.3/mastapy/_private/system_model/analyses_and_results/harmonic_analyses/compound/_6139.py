...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterTurbineCompoundHarmonicAnalysis._Cast_TorqueConverterTurbineCompoundHarmonicAnalysis",
    )
...
class _Cast_TorqueConverterTurbineCompoundHarmonicAnalysis:
    ...
    __parent__: "TorqueConverterTurbineCompoundHarmonicAnalysis"
...
class TorqueConverterTurbineCompoundHarmonicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_TURBINE_COMPOUND_HARMONIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5972.TorqueConverterTurbineHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterTurbineCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterTurbineCompoundHarmonicAnalysis
        """
        return _Cast_TorqueConverterTurbineCompoundHarmonicAnalysis(self)
