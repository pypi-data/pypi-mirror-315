...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshCompoundAdvancedSystemDeflection._Cast_FaceGearMeshCompoundAdvancedSystemDeflection",
    )
...
class _Cast_FaceGearMeshCompoundAdvancedSystemDeflection:
    ...
    __parent__: "FaceGearMeshCompoundAdvancedSystemDeflection"
...
class FaceGearMeshCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_MESH_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7487.FaceGearMeshAdvancedSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearMeshCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshCompoundAdvancedSystemDeflection
        """
        return _Cast_FaceGearMeshCompoundAdvancedSystemDeflection(self)
