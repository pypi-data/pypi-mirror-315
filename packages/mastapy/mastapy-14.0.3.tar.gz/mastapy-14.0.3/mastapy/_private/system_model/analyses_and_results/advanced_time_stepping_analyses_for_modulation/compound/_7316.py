...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="BoltCompoundAdvancedTimeSteppingAnalysisForModulation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_BoltCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_BoltCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "BoltCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class BoltCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _BOLT_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BoltCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_BoltCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_BoltCompoundAdvancedTimeSteppingAnalysisForModulation(self)
