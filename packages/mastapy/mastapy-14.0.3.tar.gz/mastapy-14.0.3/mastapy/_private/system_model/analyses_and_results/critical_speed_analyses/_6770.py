...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentCriticalSpeedAnalysis._Cast_MeasurementComponentCriticalSpeedAnalysis",
    )
...
class _Cast_MeasurementComponentCriticalSpeedAnalysis:
    ...
    __parent__: "MeasurementComponentCriticalSpeedAnalysis"
...
class MeasurementComponentCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MeasurementComponentCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentCriticalSpeedAnalysis
        """
        return _Cast_MeasurementComponentCriticalSpeedAnalysis(self)
