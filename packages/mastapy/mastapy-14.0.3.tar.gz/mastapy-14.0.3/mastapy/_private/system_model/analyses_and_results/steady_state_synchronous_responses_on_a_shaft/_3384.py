...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CVTSteadyStateSynchronousResponseOnAShaft._Cast_CVTSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_CVTSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "CVTSteadyStateSynchronousResponseOnAShaft"
...
class CVTSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _CVT_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CVTSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_CVTSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_CVTSteadyStateSynchronousResponseOnAShaft(self)
