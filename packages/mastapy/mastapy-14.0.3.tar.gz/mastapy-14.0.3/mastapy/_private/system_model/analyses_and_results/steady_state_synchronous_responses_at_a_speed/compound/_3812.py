...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="MassDiscCompoundSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="MassDiscCompoundSteadyStateSynchronousResponseAtASpeed._Cast_MassDiscCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_MassDiscCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "MassDiscCompoundSteadyStateSynchronousResponseAtASpeed"
...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _MASS_DISC_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3680.MassDiscSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_MassDiscCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(self)
