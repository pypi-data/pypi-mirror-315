...
_ZEROL_BEVEL_GEAR_MESH_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation._Cast_ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation:
    """Special nested class for casting ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation to subclasses."""

    __parent__: "ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation"
...
class ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _ZEROL_BEVEL_GEAR_MESH_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6279.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation(self)
