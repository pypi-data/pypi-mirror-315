...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterConnectionCompoundModalAnalysisAtAStiffness._Cast_TorqueConverterConnectionCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_TorqueConverterConnectionCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "TorqueConverterConnectionCompoundModalAnalysisAtAStiffness"
...
class TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_CONNECTION_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5099.TorqueConverterConnectionModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterConnectionCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterConnectionCompoundModalAnalysisAtAStiffness
        """
        return _Cast_TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(self)
