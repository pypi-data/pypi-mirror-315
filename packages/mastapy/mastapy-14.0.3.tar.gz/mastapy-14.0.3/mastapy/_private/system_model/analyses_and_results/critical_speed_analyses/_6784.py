...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PulleyCriticalSpeedAnalysis._Cast_PulleyCriticalSpeedAnalysis",
    )
...
class _Cast_PulleyCriticalSpeedAnalysis:
    ...
    __parent__: "PulleyCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PulleyCriticalSpeedAnalysis(_6730.CouplingHalfCriticalSpeedAnalysis):
    """PulleyCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _PULLEY_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PulleyCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PulleyCriticalSpeedAnalysis
        """
        return _Cast_PulleyCriticalSpeedAnalysis(self)
