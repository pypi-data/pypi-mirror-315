...
class DynamicExternalInterfaceOptions(_0.APIBase):
    ...
    @property
    def input_signal_filter_level(self: "Self") -> "_5577.InputSignalFilterLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5577",
    ...
    def input_signal_filter_level(
        self: "Self", value: "_5577.InputSignalFilterLevel"
    ) -> None:
