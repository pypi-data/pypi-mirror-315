...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltConnectionCompoundCriticalSpeedAnalysis._Cast_BeltConnectionCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_BeltConnectionCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "BeltConnectionCompoundCriticalSpeedAnalysis"
...
class BeltConnectionCompoundCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _BELT_CONNECTION_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6700.BeltConnectionCriticalSpeedAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltConnectionCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BeltConnectionCompoundCriticalSpeedAnalysis
        """
        return _Cast_BeltConnectionCompoundCriticalSpeedAnalysis(self)
