...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpCompoundPowerFlow._Cast_TorqueConverterPumpCompoundPowerFlow",
    )
...
class _Cast_TorqueConverterPumpCompoundPowerFlow:
    ...
    __parent__: "TorqueConverterPumpCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterPumpCompoundPowerFlow(_4317.CouplingHalfCompoundPowerFlow):
    """TorqueConverterPumpCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_PUMP_COMPOUND_POWER_FLOW
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4268.TorqueConverterPumpPowerFlow]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterPumpCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpCompoundPowerFlow
        """
        return _Cast_TorqueConverterPumpCompoundPowerFlow(self)
