...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHarmonicAnalysisOfSingleExcitation._Cast_ClutchHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ClutchHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ClutchHarmonicAnalysisOfSingleExcitation"
...
class ClutchHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ClutchHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ClutchHarmonicAnalysisOfSingleExcitation(self)
