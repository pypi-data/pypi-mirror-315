...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="OilSealCompoundModalAnalysisAtAStiffness._Cast_OilSealCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_OilSealCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "OilSealCompoundModalAnalysisAtAStiffness"
...
class OilSealCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _OIL_SEAL_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5060.OilSealModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_OilSealCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_OilSealCompoundModalAnalysisAtAStiffness
        """
        return _Cast_OilSealCompoundModalAnalysisAtAStiffness(self)
