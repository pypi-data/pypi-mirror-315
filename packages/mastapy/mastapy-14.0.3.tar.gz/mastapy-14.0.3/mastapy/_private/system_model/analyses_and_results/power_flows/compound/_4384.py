...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfCompoundPowerFlow._Cast_SpringDamperHalfCompoundPowerFlow",
    )
...
class _Cast_SpringDamperHalfCompoundPowerFlow:
    ...
    __parent__: "SpringDamperHalfCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperHalfCompoundPowerFlow(_4317.CouplingHalfCompoundPowerFlow):
    """SpringDamperHalfCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_COMPOUND_POWER_FLOW
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4251.SpringDamperHalfPowerFlow]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHalfCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfCompoundPowerFlow
        """
        return _Cast_SpringDamperHalfCompoundPowerFlow(self)
