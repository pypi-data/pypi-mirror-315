...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingConnectionLoadCase._Cast_RollingRingConnectionLoadCase",
    )
...
class _Cast_RollingRingConnectionLoadCase:
    ...
    __parent__: "RollingRingConnectionLoadCase"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingConnectionLoadCase(_7064.InterMountableComponentConnectionLoadCase):
    """RollingRingConnectionLoadCase

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ROLLING_RING_CONNECTION_LOAD_CASE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingConnectionLoadCase":
        """Cast to another type.

        Returns:
            _Cast_RollingRingConnectionLoadCase
        """
        return _Cast_RollingRingConnectionLoadCase(self)
