...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="DatumCompoundHarmonicAnalysis._Cast_DatumCompoundHarmonicAnalysis",
    )
...
class _Cast_DatumCompoundHarmonicAnalysis:
    ...
    __parent__: "DatumCompoundHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundHarmonicAnalysis(_6042.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _DATUM_COMPOUND_HARMONIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5867.DatumHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_5867.DatumHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.DatumHarmonicAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_DatumCompoundHarmonicAnalysis
        """
        return _Cast_DatumCompoundHarmonicAnalysis(self)
