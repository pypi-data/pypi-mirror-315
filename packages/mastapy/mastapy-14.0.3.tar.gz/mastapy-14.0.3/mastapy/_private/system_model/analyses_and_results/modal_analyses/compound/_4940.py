...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingAssemblyCompoundModalAnalysis._Cast_RollingRingAssemblyCompoundModalAnalysis",
    )
...
class _Cast_RollingRingAssemblyCompoundModalAnalysis:
    ...
    __parent__: "RollingRingAssemblyCompoundModalAnalysis"
...
class RollingRingAssemblyCompoundModalAnalysis(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_ASSEMBLY_COMPOUND_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingAssemblyCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_RollingRingAssemblyCompoundModalAnalysis
        """
        return _Cast_RollingRingAssemblyCompoundModalAnalysis(self)
