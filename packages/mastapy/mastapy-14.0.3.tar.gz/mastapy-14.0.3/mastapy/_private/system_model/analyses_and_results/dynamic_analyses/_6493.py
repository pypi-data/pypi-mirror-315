...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6490
...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis",
    )
...
class _Cast_KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis:
    ...
    __parent__: "KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis"
...
class KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = (
        _KLINGELNBERG_CYCLO_PALLOID_HYPOID_GEAR_MESH_DYNAMIC_ANALYSIS
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis
        """
        return _Cast_KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis(self)
