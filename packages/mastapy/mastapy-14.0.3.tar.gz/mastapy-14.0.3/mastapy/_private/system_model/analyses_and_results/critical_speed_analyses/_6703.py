...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearMeshCriticalSpeedAnalysis._Cast_BevelDifferentialGearMeshCriticalSpeedAnalysis",
    )
...
class _Cast_BevelDifferentialGearMeshCriticalSpeedAnalysis:
    ...
    __parent__: "BevelDifferentialGearMeshCriticalSpeedAnalysis"
...
class BevelDifferentialGearMeshCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _BEVEL_DIFFERENTIAL_GEAR_MESH_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BevelDifferentialGearMeshCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialGearMeshCriticalSpeedAnalysis
        """
        return _Cast_BevelDifferentialGearMeshCriticalSpeedAnalysis(self)
