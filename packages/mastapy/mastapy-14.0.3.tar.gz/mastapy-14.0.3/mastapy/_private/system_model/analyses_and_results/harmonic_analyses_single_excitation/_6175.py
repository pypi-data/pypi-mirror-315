...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation._Cast_ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation"
...
class ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_HALF_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation(self)
