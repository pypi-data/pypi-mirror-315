...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassHarmonicAnalysis._Cast_UnbalancedMassHarmonicAnalysis",
    )
...
class _Cast_UnbalancedMassHarmonicAnalysis:
    ...
    __parent__: "UnbalancedMassHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UnbalancedMassHarmonicAnalysis(_5975.VirtualComponentHarmonicAnalysis):
    """UnbalancedMassHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_HARMONIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_UnbalancedMassHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassHarmonicAnalysis
        """
        return _Cast_UnbalancedMassHarmonicAnalysis(self)
