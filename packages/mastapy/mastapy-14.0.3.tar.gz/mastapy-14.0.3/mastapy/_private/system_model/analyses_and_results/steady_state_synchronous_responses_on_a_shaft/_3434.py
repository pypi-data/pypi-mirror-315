...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsToDiscConnectionSteadyStateSynchronousResponseOnAShaft._Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "RingPinsToDiscConnectionSteadyStateSynchronousResponseOnAShaft"
...
class RingPinsToDiscConnectionSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _RING_PINS_TO_DISC_CONNECTION_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponseOnAShaft(
            self
        )
