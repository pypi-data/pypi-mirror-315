...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FlexiblePinAssemblySystemDeflection(_2897.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def flexible_pin_shaft_details(self: "Self") -> "_2895.ShaftSystemDeflection":
    ...
    @property
    def pin_analysis(self: "Self") -> "_2895.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4201.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    def spindle_analyses(self: "Self") -> "_2895.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def bearing_static_analyses(self: "Self") -> "List[_2787.BearingSystemDeflection]":
    ...
    def observed_pin_stiffness_reporters(
        self: "Self",
    ) -> "List[_2874.ObservedPinStiffnessReporter]":
