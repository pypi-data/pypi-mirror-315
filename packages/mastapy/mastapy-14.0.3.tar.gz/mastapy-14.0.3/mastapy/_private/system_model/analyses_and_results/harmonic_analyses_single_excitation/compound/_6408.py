...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="WormGearSetCompoundHarmonicAnalysisOfSingleExcitation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearSetCompoundHarmonicAnalysisOfSingleExcitation._Cast_WormGearSetCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_WormGearSetCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "WormGearSetCompoundHarmonicAnalysisOfSingleExcitation"
...
class WormGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _WORM_GEAR_SET_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6277.WormGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def worm_gears_compound_harmonic_analysis_of_single_excitation(
        self: "Self",
    ) -> "List[_6406.WormGearCompoundHarmonicAnalysisOfSingleExcitation]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "WormGearsCompoundHarmonicAnalysisOfSingleExcitation"
        )
    ...
    def worm_meshes_compound_harmonic_analysis_of_single_excitation(
        self: "Self",
    ) -> "List[_6407.WormGearMeshCompoundHarmonicAnalysisOfSingleExcitation]":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "WormMeshesCompoundHarmonicAnalysisOfSingleExcitation"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_WormGearSetCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_WormGearSetCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_WormGearSetCompoundHarmonicAnalysisOfSingleExcitation(self)
