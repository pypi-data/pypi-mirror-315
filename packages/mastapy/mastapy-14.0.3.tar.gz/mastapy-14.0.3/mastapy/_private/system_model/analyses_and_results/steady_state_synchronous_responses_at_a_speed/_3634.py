...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ConceptGearMeshSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_ConceptGearMeshSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ConceptGearMeshSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ConceptGearMeshSteadyStateSynchronousResponseAtASpeed"
...
class ConceptGearMeshSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptGearMeshSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearMeshSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ConceptGearMeshSteadyStateSynchronousResponseAtASpeed(self)
