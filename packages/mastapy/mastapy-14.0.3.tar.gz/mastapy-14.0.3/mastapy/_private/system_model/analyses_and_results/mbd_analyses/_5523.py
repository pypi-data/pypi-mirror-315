...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialSunGearMultibodyDynamicsAnalysis._Cast_BevelDifferentialSunGearMultibodyDynamicsAnalysis",
    )
...
class _Cast_BevelDifferentialSunGearMultibodyDynamicsAnalysis:
    ...
    __parent__: "BevelDifferentialSunGearMultibodyDynamicsAnalysis"
...
class BevelDifferentialSunGearMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _BEVEL_DIFFERENTIAL_SUN_GEAR_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialSunGearMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialSunGearMultibodyDynamicsAnalysis
        """
        return _Cast_BevelDifferentialSunGearMultibodyDynamicsAnalysis(self)
