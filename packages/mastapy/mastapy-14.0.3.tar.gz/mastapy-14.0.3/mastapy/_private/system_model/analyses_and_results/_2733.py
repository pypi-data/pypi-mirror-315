...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SteadyStateSynchronousResponseAtASpeedAnalysis._Cast_SteadyStateSynchronousResponseAtASpeedAnalysis",
    )
...
class _Cast_SteadyStateSynchronousResponseAtASpeedAnalysis:
    ...
    __parent__: "SteadyStateSynchronousResponseAtASpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SteadyStateSynchronousResponseAtASpeedAnalysis(_2709.SingleAnalysis):
    """SteadyStateSynchronousResponseAtASpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SteadyStateSynchronousResponseAtASpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SteadyStateSynchronousResponseAtASpeedAnalysis
        """
        return _Cast_SteadyStateSynchronousResponseAtASpeedAnalysis(self)
