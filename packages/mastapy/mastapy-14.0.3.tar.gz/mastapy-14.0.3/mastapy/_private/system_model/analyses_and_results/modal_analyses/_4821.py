...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterModalAnalysis._Cast_TorqueConverterModalAnalysis",
    )
...
class _Cast_TorqueConverterModalAnalysis:
    ...
    __parent__: "TorqueConverterModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterModalAnalysis(_4729.CouplingModalAnalysis):
    """TorqueConverterModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterModalAnalysis
        """
        return _Cast_TorqueConverterModalAnalysis(self)
