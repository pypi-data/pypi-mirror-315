...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfSteadyStateSynchronousResponseAtASpeed._Cast_ClutchHalfSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ClutchHalfSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ClutchHalfSteadyStateSynchronousResponseAtASpeed"
...
class ClutchHalfSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_HALF_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchHalfSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ClutchHalfSteadyStateSynchronousResponseAtASpeed(self)
