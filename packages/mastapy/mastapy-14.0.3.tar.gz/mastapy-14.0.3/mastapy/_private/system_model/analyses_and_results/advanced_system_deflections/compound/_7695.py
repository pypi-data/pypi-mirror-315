...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMeshCompoundAdvancedSystemDeflection._Cast_ZerolBevelGearMeshCompoundAdvancedSystemDeflection",
    )
...
class _Cast_ZerolBevelGearMeshCompoundAdvancedSystemDeflection:
    ...
    __parent__: "ZerolBevelGearMeshCompoundAdvancedSystemDeflection"
...
class ZerolBevelGearMeshCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_MESH_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7564.ZerolBevelGearMeshAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearMeshCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMeshCompoundAdvancedSystemDeflection
        """
        return _Cast_ZerolBevelGearMeshCompoundAdvancedSystemDeflection(self)
