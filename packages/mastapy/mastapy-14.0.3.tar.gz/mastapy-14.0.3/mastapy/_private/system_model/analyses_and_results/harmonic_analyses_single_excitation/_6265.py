...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserHalfHarmonicAnalysisOfSingleExcitation._Cast_SynchroniserHalfHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_SynchroniserHalfHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "SynchroniserHalfHarmonicAnalysisOfSingleExcitation"
...
class SynchroniserHalfHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_HALF_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SynchroniserHalfHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserHalfHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_SynchroniserHalfHarmonicAnalysisOfSingleExcitation(self)
