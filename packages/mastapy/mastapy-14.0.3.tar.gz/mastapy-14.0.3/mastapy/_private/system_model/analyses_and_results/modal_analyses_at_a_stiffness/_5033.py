...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearModalAnalysisAtAStiffness._Cast_FaceGearModalAnalysisAtAStiffness",
    )
...
class _Cast_FaceGearModalAnalysisAtAStiffness:
    ...
    __parent__: "FaceGearModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearModalAnalysisAtAStiffness(_5038.GearModalAnalysisAtAStiffness):
    """FaceGearModalAnalysisAtAStiffness

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FACE_GEAR_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_FaceGearModalAnalysisAtAStiffness
        """
        return _Cast_FaceGearModalAnalysisAtAStiffness(self)
