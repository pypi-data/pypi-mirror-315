...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearCompoundModalAnalysisAtAStiffness._Cast_HypoidGearCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_HypoidGearCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "HypoidGearCompoundModalAnalysisAtAStiffness"
...
class HypoidGearCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _HYPOID_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5042.HypoidGearModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearCompoundModalAnalysisAtAStiffness
        """
        return _Cast_HypoidGearCompoundModalAnalysisAtAStiffness(self)
