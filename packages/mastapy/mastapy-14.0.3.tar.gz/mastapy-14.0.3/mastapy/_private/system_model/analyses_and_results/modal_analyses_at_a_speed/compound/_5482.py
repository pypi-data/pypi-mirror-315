...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed._Cast_StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed"
...
class StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_DIFF_GEAR_MESH_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5350.StraightBevelDiffGearMeshModalAnalysisAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed
        """
        return _Cast_StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed(self)
