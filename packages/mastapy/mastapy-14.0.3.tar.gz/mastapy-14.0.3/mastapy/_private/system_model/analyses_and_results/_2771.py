...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CompoundTorsionalSystemDeflectionAnalysis._Cast_CompoundTorsionalSystemDeflectionAnalysis",
    )
...
class _Cast_CompoundTorsionalSystemDeflectionAnalysis:
    ...
    __parent__: "CompoundTorsionalSystemDeflectionAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CompoundTorsionalSystemDeflectionAnalysis(_2708.CompoundAnalysis):
    """CompoundTorsionalSystemDeflectionAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _COMPOUND_TORSIONAL_SYSTEM_DEFLECTION_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CompoundTorsionalSystemDeflectionAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CompoundTorsionalSystemDeflectionAnalysis
        """
        return _Cast_CompoundTorsionalSystemDeflectionAnalysis(self)
