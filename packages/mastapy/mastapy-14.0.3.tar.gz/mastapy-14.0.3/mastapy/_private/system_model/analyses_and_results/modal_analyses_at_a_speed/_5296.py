...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearModalAnalysisAtASpeed._Cast_FaceGearModalAnalysisAtASpeed",
    )
...
class _Cast_FaceGearModalAnalysisAtASpeed:
    ...
    __parent__: "FaceGearModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearModalAnalysisAtASpeed(_5301.GearModalAnalysisAtASpeed):
    """FaceGearModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FACE_GEAR_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_FaceGearModalAnalysisAtASpeed
        """
        return _Cast_FaceGearModalAnalysisAtASpeed(self)
