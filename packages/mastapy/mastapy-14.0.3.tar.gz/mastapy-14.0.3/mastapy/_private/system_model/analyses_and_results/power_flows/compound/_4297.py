...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="BoltCompoundPowerFlow._Cast_BoltCompoundPowerFlow"
    )
...
class _Cast_BoltCompoundPowerFlow:
    ...
    __parent__: "BoltCompoundPowerFlow"
    ...
    @property
    def bolt_compound_power_flow(self: "CastSelf") -> "BoltCompoundPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundPowerFlow(_4303.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLT_COMPOUND_POWER_FLOW
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4161.BoltPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4161.BoltPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltPowerFlow]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_BoltCompoundPowerFlow
        """
        return _Cast_BoltCompoundPowerFlow(self)
