...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyCompoundPowerFlow._Cast_CycloidalAssemblyCompoundPowerFlow",
    )
...
class _Cast_CycloidalAssemblyCompoundPowerFlow:
    ...
    __parent__: "CycloidalAssemblyCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalAssemblyCompoundPowerFlow(_4378.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_COMPOUND_POWER_FLOW
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4184.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyCompoundPowerFlow
        """
        return _Cast_CycloidalAssemblyCompoundPowerFlow(self)
