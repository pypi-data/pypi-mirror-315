...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingAssemblyCompoundSystemDeflection._Cast_RollingRingAssemblyCompoundSystemDeflection",
    )
...
class _Cast_RollingRingAssemblyCompoundSystemDeflection:
    ...
    __parent__: "RollingRingAssemblyCompoundSystemDeflection"
...
class RollingRingAssemblyCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_ASSEMBLY_COMPOUND_SYSTEM_DEFLECTION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingAssemblyCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_RollingRingAssemblyCompoundSystemDeflection
        """
        return _Cast_RollingRingAssemblyCompoundSystemDeflection(self)
