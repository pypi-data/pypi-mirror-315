...
T = TypeVar("T", bound="_6956.LoadCase")
...
class _Cast_AbstractAnalysisOptions:
    ...
    @property
    def system_deflection_options(self: "CastSelf") -> "_2918.SystemDeflectionOptions":
        from mastapy._private.system_model.analyses_and_results.system_deflections import (
            _2918,
        )

        return self.__parent__._cast(_2918.SystemDeflectionOptions)
    ...
    def frequency_response_analysis_options(
        ...
        return self.__parent__._cast(_4751.FrequencyResponseAnalysisOptions)

    @property
    def mbd_run_up_analysis_options(
        self: "CastSelf",
    ) -> "_5592.MBDRunUpAnalysisOptions":
        from mastapy._private.system_model.analyses_and_results.mbd_analyses import (
            _5592,
        )

        return self.__parent__._cast(_5592.MBDRunUpAnalysisOptions)
    ...
    def frequency_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5888.FrequencyOptionsForHarmonicAnalysisResults)
    ...
    def speed_options_for_harmonic_analysis_results(
        ...
        return self.__parent__._cast(_5949.SpeedOptionsForHarmonicAnalysisResults)

    @property
    def stiffness_options_for_harmonic_analysis(
        self: "CastSelf",
    ) -> "_5956.StiffnessOptionsForHarmonicAnalysis":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _5956,
        )

        return self.__parent__._cast(_5956.StiffnessOptionsForHarmonicAnalysis)
