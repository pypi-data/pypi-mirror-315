...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft._Cast_BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft"
...
class BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _BOLTED_JOINT_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3361.BoltedJointSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft(self)
