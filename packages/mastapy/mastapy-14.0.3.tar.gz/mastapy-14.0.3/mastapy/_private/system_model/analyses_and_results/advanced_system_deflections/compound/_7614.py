...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearMeshCompoundAdvancedSystemDeflection._Cast_CylindricalGearMeshCompoundAdvancedSystemDeflection",
    )
...
class _Cast_CylindricalGearMeshCompoundAdvancedSystemDeflection:
    ...
    __parent__: "CylindricalGearMeshCompoundAdvancedSystemDeflection"
...
class CylindricalGearMeshCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_MESH_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7480.CylindricalGearMeshAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CylindricalGearMeshCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearMeshCompoundAdvancedSystemDeflection
        """
        return _Cast_CylindricalGearMeshCompoundAdvancedSystemDeflection(self)
