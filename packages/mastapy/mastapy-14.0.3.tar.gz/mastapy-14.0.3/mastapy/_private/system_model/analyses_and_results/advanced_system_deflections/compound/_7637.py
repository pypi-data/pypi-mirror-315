...
class KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7504.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_advanced_system_deflection(
        ...
        "List[_7635.KlingelnbergCycloPalloidHypoidGearCompoundAdvancedSystemDeflection]"
    ):
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7636.KlingelnbergCycloPalloidHypoidGearMeshCompoundAdvancedSystemDeflection]":
