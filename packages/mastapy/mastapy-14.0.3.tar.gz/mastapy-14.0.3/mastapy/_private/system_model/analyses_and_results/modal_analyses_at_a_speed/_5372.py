...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearModalAnalysisAtASpeed._Cast_ZerolBevelGearModalAnalysisAtASpeed",
    )
...
class _Cast_ZerolBevelGearModalAnalysisAtASpeed:
    ...
    __parent__: "ZerolBevelGearModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearModalAnalysisAtASpeed(_5259.BevelGearModalAnalysisAtASpeed):
    """ZerolBevelGearModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ZerolBevelGearModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearModalAnalysisAtASpeed
        """
        return _Cast_ZerolBevelGearModalAnalysisAtASpeed(self)
