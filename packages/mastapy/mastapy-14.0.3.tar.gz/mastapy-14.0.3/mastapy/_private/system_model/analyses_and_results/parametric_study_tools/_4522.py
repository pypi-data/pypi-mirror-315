...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingParametricStudyTool._Cast_RollingRingParametricStudyTool",
    )
...
class _Cast_RollingRingParametricStudyTool:
    ...
    __parent__: "RollingRingParametricStudyTool"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingParametricStudyTool(_4447.CouplingHalfParametricStudyTool):
    """RollingRingParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ROLLING_RING_PARAMETRIC_STUDY_TOOL
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2890.RollingRingSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_RollingRingParametricStudyTool
        """
        return _Cast_RollingRingParametricStudyTool(self)
