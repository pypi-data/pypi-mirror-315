...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed._Cast_TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed"
...
class TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_PUMP_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed(self)
