...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FEPartCompoundModalAnalysis._Cast_FEPartCompoundModalAnalysis",
    )
...
class _Cast_FEPartCompoundModalAnalysis:
    ...
    __parent__: "FEPartCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEPartCompoundModalAnalysis(_4849.AbstractShaftOrHousingCompoundModalAnalysis):
    """FEPartCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FE_PART_COMPOUND_MODAL_ANALYSIS
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4749.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FEPartCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FEPartCompoundModalAnalysis
        """
        return _Cast_FEPartCompoundModalAnalysis(self)
