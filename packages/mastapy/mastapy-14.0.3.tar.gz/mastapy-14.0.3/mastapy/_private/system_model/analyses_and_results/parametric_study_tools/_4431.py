...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfParametricStudyTool._Cast_ClutchHalfParametricStudyTool",
    )
...
class _Cast_ClutchHalfParametricStudyTool:
    ...
    __parent__: "ClutchHalfParametricStudyTool"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfParametricStudyTool(_4447.CouplingHalfParametricStudyTool):
    """ClutchHalfParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_HALF_PARAMETRIC_STUDY_TOOL
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfParametricStudyTool
        """
        return _Cast_ClutchHalfParametricStudyTool(self)
