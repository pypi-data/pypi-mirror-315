...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearHarmonicAnalysisOfSingleExcitation._Cast_ZerolBevelGearHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ZerolBevelGearHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ZerolBevelGearHarmonicAnalysisOfSingleExcitation"
...
class ZerolBevelGearHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ZerolBevelGearHarmonicAnalysisOfSingleExcitation(self)
