...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed"
...
class ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_GEAR_SET_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    @property
    def component_design(self: "Self") -> "_2583.ConceptGearSet":
    ...
    @property
    def assembly_design(self: "Self") -> "_2583.ConceptGearSet":
        """mastapy.system_model.part_model.gears.ConceptGearSet
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3635.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gears_compound_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3766.ConceptGearCompoundSteadyStateSynchronousResponseAtASpeed]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "ConceptGearsCompoundSteadyStateSynchronousResponseAtASpeed"
        )
    ...
    def concept_meshes_compound_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3767.ConceptGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "ConceptMeshesCompoundSteadyStateSynchronousResponseAtASpeed"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed(self)
