...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierModalAnalysisAtASpeed._Cast_PlanetCarrierModalAnalysisAtASpeed",
    )
...
class _Cast_PlanetCarrierModalAnalysisAtASpeed:
    ...
    __parent__: "PlanetCarrierModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierModalAnalysisAtASpeed(_5322.MountableComponentModalAnalysisAtASpeed):
    """PlanetCarrierModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _PLANET_CARRIER_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PlanetCarrierModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierModalAnalysisAtASpeed
        """
        return _Cast_PlanetCarrierModalAnalysisAtASpeed(self)
