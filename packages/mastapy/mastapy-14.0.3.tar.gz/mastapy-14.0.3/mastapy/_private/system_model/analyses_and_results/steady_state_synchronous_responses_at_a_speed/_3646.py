...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CVTPulleySteadyStateSynchronousResponseAtASpeed._Cast_CVTPulleySteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_CVTPulleySteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "CVTPulleySteadyStateSynchronousResponseAtASpeed"
...
class CVTPulleySteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CVT_PULLEY_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CVTPulleySteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_CVTPulleySteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_CVTPulleySteadyStateSynchronousResponseAtASpeed(self)
