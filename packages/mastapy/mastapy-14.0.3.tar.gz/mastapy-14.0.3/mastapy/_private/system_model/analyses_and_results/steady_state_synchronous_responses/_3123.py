...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearMeshSteadyStateSynchronousResponse._Cast_CylindricalGearMeshSteadyStateSynchronousResponse",
    )
...
class _Cast_CylindricalGearMeshSteadyStateSynchronousResponse:
    ...
    __parent__: "CylindricalGearMeshSteadyStateSynchronousResponse"
...
class CylindricalGearMeshSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CylindricalGearMeshSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearMeshSteadyStateSynchronousResponse
        """
        return _Cast_CylindricalGearMeshSteadyStateSynchronousResponse(self)
