...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingCompoundModalAnalysisAtASpeed._Cast_ConceptCouplingCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_ConceptCouplingCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "ConceptCouplingCompoundModalAnalysisAtASpeed"
...
class ConceptCouplingCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5270.ConceptCouplingModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptCouplingCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingCompoundModalAnalysisAtASpeed
        """
        return _Cast_ConceptCouplingCompoundModalAnalysisAtASpeed(self)
