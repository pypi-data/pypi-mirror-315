...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCompoundCriticalSpeedAnalysis._Cast_BoltedJointCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_BoltedJointCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "BoltedJointCompoundCriticalSpeedAnalysis"
...
class BoltedJointCompoundCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6711.BoltedJointCriticalSpeedAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCompoundCriticalSpeedAnalysis
        """
        return _Cast_BoltedJointCompoundCriticalSpeedAnalysis(self)
