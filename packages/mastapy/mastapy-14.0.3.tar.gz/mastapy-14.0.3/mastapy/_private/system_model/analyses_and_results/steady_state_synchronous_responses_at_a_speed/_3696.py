...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsSteadyStateSynchronousResponseAtASpeed._Cast_RingPinsSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_RingPinsSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "RingPinsSteadyStateSynchronousResponseAtASpeed"
...
class RingPinsSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_RingPinsSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_RingPinsSteadyStateSynchronousResponseAtASpeed(self)
