...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearCompoundAdvancedSystemDeflection._Cast_StraightBevelGearCompoundAdvancedSystemDeflection",
    )
...
class _Cast_StraightBevelGearCompoundAdvancedSystemDeflection:
    ...
    __parent__: "StraightBevelGearCompoundAdvancedSystemDeflection"
...
class StraightBevelGearCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearCompoundAdvancedSystemDeflection
        """
        return _Cast_StraightBevelGearCompoundAdvancedSystemDeflection(self)
