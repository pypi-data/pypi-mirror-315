...
class ConceptGearSetCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5273.ConceptGearSetModalAnalysisAtASpeed]":
    ...
    def concept_gears_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5403.ConceptGearCompoundModalAnalysisAtASpeed]":
    ...
    def concept_meshes_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5404.ConceptGearMeshCompoundModalAnalysisAtASpeed]":
