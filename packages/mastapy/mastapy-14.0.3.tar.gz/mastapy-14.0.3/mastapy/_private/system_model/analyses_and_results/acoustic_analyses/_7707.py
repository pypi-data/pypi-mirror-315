...
from mastapy._private.system_model.analyses_and_results.acoustic_analyses import _7706
...
class _Cast_SingleHarmonicExcitationAnalysisDetail:
    ...
    @property
    def single_excitation_details(self: "CastSelf") -> "_7706.SingleExcitationDetails":
        return self.__parent__._cast(_7706.SingleExcitationDetails)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SingleHarmonicExcitationAnalysisDetail(_7706.SingleExcitationDetails):
    """SingleHarmonicExcitationAnalysisDetail
