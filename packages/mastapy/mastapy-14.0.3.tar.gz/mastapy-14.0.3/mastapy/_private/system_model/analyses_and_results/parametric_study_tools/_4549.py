...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterTurbineParametricStudyTool._Cast_TorqueConverterTurbineParametricStudyTool",
    )
...
class _Cast_TorqueConverterTurbineParametricStudyTool:
    ...
    __parent__: "TorqueConverterTurbineParametricStudyTool"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterTurbineParametricStudyTool(_4447.CouplingHalfParametricStudyTool):
    """TorqueConverterTurbineParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_TURBINE_PARAMETRIC_STUDY_TOOL
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2922.TorqueConverterTurbineSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterTurbineParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterTurbineParametricStudyTool
        """
        return _Cast_TorqueConverterTurbineParametricStudyTool(self)
