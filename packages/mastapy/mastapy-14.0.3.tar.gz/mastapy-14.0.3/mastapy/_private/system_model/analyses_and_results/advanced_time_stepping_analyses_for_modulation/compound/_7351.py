...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _FACE_GEAR_MESH_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    @property
    def component_design(self: "Self") -> "_2368.FaceGearMesh":
    ...
    @property
    def connection_design(self: "Self") -> "_2368.FaceGearMesh":
        """mastapy.system_model.connections_and_sockets.gears.FaceGearMesh
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7219.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_FaceGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(self)
