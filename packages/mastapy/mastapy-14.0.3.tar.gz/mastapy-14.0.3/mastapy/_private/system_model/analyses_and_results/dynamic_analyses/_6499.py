...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6547
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentDynamicAnalysis._Cast_MeasurementComponentDynamicAnalysis",
    )
...
class _Cast_MeasurementComponentDynamicAnalysis:
    ...
    __parent__: "MeasurementComponentDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeasurementComponentDynamicAnalysis(_6547.VirtualComponentDynamicAnalysis):
    """MeasurementComponentDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MeasurementComponentDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentDynamicAnalysis
        """
        return _Cast_MeasurementComponentDynamicAnalysis(self)
