...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCompoundHarmonicAnalysis._Cast_ClutchHalfCompoundHarmonicAnalysis",
    )
...
class _Cast_ClutchHalfCompoundHarmonicAnalysis:
    ...
    __parent__: "ClutchHalfCompoundHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfCompoundHarmonicAnalysis(_6056.CouplingHalfCompoundHarmonicAnalysis):
    """ClutchHalfCompoundHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_HALF_COMPOUND_HARMONIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5837.ClutchHalfHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCompoundHarmonicAnalysis
        """
        return _Cast_ClutchHalfCompoundHarmonicAnalysis(self)
