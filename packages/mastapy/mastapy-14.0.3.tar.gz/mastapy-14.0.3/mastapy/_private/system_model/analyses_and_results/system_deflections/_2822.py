...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2884
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleySystemDeflection(_2884.PulleySystemDeflection):
    """CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4183.CVTPulleyPowerFlow":
    ...
    @property
    def fixed_sheave_contact_results(self: "Self") -> "List[_1612.NodeResults]":
    ...
    @property
    def moving_sheave_contact_results(self: "Self") -> "List[_1612.NodeResults]":
        """List[mastapy.math_utility.measured_vectors.NodeResults]
