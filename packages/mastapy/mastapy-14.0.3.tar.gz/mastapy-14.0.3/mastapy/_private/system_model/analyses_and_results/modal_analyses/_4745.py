...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelModalAnalysis._Cast_ExternalCADModelModalAnalysis",
    )
...
class _Cast_ExternalCADModelModalAnalysis:
    ...
    __parent__: "ExternalCADModelModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExternalCADModelModalAnalysis(_4714.ComponentModalAnalysis):
    """ExternalCADModelModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _EXTERNAL_CAD_MODEL_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ExternalCADModelModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelModalAnalysis
        """
        return _Cast_ExternalCADModelModalAnalysis(self)
