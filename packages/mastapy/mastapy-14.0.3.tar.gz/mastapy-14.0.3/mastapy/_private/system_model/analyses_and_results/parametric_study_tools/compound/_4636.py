...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneCompoundParametricStudyTool(_4583.ComponentCompoundParametricStudyTool):
    """MicrophoneCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7078.MicrophoneLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4494.MicrophoneParametricStudyTool]":
