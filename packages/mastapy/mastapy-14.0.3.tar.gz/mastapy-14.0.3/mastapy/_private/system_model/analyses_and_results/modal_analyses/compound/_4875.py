...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfCompoundModalAnalysis._Cast_ConceptCouplingHalfCompoundModalAnalysis",
    )
...
class _Cast_ConceptCouplingHalfCompoundModalAnalysis:
    ...
    __parent__: "ConceptCouplingHalfCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingHalfCompoundModalAnalysis(_4886.CouplingHalfCompoundModalAnalysis):
    """ConceptCouplingHalfCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_HALF_COMPOUND_MODAL_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4716.ConceptCouplingHalfModalAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptCouplingHalfCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfCompoundModalAnalysis
        """
        return _Cast_ConceptCouplingHalfCompoundModalAnalysis(self)
