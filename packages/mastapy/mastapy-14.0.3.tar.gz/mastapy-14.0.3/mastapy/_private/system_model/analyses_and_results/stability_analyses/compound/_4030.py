...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingCompoundStabilityAnalysis._Cast_ConceptCouplingCompoundStabilityAnalysis",
    )
...
class _Cast_ConceptCouplingCompoundStabilityAnalysis:
    ...
    __parent__: "ConceptCouplingCompoundStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingCompoundStabilityAnalysis(_4041.CouplingCompoundStabilityAnalysis):
    """ConceptCouplingCompoundStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_COMPOUND_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptCouplingCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingCompoundStabilityAnalysis
        """
        return _Cast_ConceptCouplingCompoundStabilityAnalysis(self)
