...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingCompoundSteadyStateSynchronousResponseAtASpeed._Cast_RollingRingCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_RollingRingCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "RollingRingCompoundSteadyStateSynchronousResponseAtASpeed"
...
class RollingRingCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _ROLLING_RING_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3700.RollingRingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RollingRingCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_RollingRingCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_RollingRingCompoundSteadyStateSynchronousResponseAtASpeed(self)
