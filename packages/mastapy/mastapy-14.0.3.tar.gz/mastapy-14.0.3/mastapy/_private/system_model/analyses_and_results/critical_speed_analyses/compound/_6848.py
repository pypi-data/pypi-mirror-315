...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCompoundCriticalSpeedAnalysis._Cast_ClutchHalfCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_ClutchHalfCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "ClutchHalfCompoundCriticalSpeedAnalysis"
...
class ClutchHalfCompoundCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_HALF_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6714.ClutchHalfCriticalSpeedAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCompoundCriticalSpeedAnalysis
        """
        return _Cast_ClutchHalfCompoundCriticalSpeedAnalysis(self)
