...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="BoltCompoundModalAnalysis._Cast_BoltCompoundModalAnalysis"
    )
...
class _Cast_BoltCompoundModalAnalysis:
    ...
    __parent__: "BoltCompoundModalAnalysis"
    ...
    @property
    def bolt_compound_modal_analysis(self: "CastSelf") -> "BoltCompoundModalAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundModalAnalysis(_4872.ComponentCompoundModalAnalysis):
    """BoltCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLT_COMPOUND_MODAL_ANALYSIS
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4709.BoltModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4709.BoltModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltModalAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BoltCompoundModalAnalysis
        """
        return _Cast_BoltCompoundModalAnalysis(self)
