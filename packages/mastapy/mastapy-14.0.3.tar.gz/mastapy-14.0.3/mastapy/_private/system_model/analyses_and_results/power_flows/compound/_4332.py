...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshCompoundPowerFlow._Cast_FaceGearMeshCompoundPowerFlow",
    )
...
class _Cast_FaceGearMeshCompoundPowerFlow:
    ...
    __parent__: "FaceGearMeshCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMeshCompoundPowerFlow(_4337.GearMeshCompoundPowerFlow):
    """FaceGearMeshCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FACE_GEAR_MESH_COMPOUND_POWER_FLOW
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4195.FaceGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: "Self") -> "List[_4195.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearMeshCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshCompoundPowerFlow
        """
        return _Cast_FaceGearMeshCompoundPowerFlow(self)
