...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCompoundHarmonicAnalysis._Cast_BoltedJointCompoundHarmonicAnalysis",
    )
...
class _Cast_BoltedJointCompoundHarmonicAnalysis:
    ...
    __parent__: "BoltedJointCompoundHarmonicAnalysis"
...
class BoltedJointCompoundHarmonicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_COMPOUND_HARMONIC_ANALYSIS
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5834.BoltedJointHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCompoundHarmonicAnalysis
        """
        return _Cast_BoltedJointCompoundHarmonicAnalysis(self)
