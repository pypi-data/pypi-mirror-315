...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalDiscHarmonicAnalysisOfSingleExcitation._Cast_CycloidalDiscHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_CycloidalDiscHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "CycloidalDiscHarmonicAnalysisOfSingleExcitation"
...
class CycloidalDiscHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_DISC_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CycloidalDiscHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_CycloidalDiscHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_CycloidalDiscHarmonicAnalysisOfSingleExcitation(self)
