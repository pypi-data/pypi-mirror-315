...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfCompoundAdvancedSystemDeflection._Cast_ConceptCouplingHalfCompoundAdvancedSystemDeflection",
    )
...
class _Cast_ConceptCouplingHalfCompoundAdvancedSystemDeflection:
    ...
    __parent__: "ConceptCouplingHalfCompoundAdvancedSystemDeflection"
...
class ConceptCouplingHalfCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_HALF_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7459.ConceptCouplingHalfAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingHalfCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfCompoundAdvancedSystemDeflection
        """
        return _Cast_ConceptCouplingHalfCompoundAdvancedSystemDeflection(self)
