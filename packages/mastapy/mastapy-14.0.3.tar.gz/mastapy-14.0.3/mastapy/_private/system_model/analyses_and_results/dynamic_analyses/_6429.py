...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="BearingDynamicAnalysis._Cast_BearingDynamicAnalysis"
    )
...
class _Cast_BearingDynamicAnalysis:
    ...
    __parent__: "BearingDynamicAnalysis"
    ...
    @property
    def bearing_dynamic_analysis(self: "CastSelf") -> "BearingDynamicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BearingDynamicAnalysis(_6457.ConnectorDynamicAnalysis):
    """BearingDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BEARING_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BearingDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BearingDynamicAnalysis
        """
        return _Cast_BearingDynamicAnalysis(self)
