...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyModalAnalysisAtASpeed._Cast_FlexiblePinAssemblyModalAnalysisAtASpeed",
    )
...
class _Cast_FlexiblePinAssemblyModalAnalysisAtASpeed:
    ...
    __parent__: "FlexiblePinAssemblyModalAnalysisAtASpeed"
...
class FlexiblePinAssemblyModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _FLEXIBLE_PIN_ASSEMBLY_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FlexiblePinAssemblyModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyModalAnalysisAtASpeed
        """
        return _Cast_FlexiblePinAssemblyModalAnalysisAtASpeed(self)
