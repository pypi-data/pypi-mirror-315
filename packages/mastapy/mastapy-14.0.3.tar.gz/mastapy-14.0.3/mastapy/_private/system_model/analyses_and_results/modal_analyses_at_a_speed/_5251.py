...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltConnectionModalAnalysisAtASpeed._Cast_BeltConnectionModalAnalysisAtASpeed",
    )
...
class _Cast_BeltConnectionModalAnalysisAtASpeed:
    ...
    __parent__: "BeltConnectionModalAnalysisAtASpeed"
...
class BeltConnectionModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _BELT_CONNECTION_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltConnectionModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_BeltConnectionModalAnalysisAtASpeed
        """
        return _Cast_BeltConnectionModalAnalysisAtASpeed(self)
