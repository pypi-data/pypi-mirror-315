...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearCompoundCriticalSpeedAnalysis._Cast_ConceptGearCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_ConceptGearCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "ConceptGearCompoundCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearCompoundCriticalSpeedAnalysis(_6883.GearCompoundCriticalSpeedAnalysis):
    """ConceptGearCompoundCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6720.ConceptGearCriticalSpeedAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearCompoundCriticalSpeedAnalysis
        """
        return _Cast_ConceptGearCompoundCriticalSpeedAnalysis(self)
