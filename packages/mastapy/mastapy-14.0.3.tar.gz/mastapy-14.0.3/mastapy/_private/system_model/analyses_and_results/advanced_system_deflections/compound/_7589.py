...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCompoundAdvancedSystemDeflection._Cast_ClutchHalfCompoundAdvancedSystemDeflection",
    )
...
class _Cast_ClutchHalfCompoundAdvancedSystemDeflection:
    ...
    __parent__: "ClutchHalfCompoundAdvancedSystemDeflection"
...
class ClutchHalfCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_HALF_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7454.ClutchHalfAdvancedSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCompoundAdvancedSystemDeflection
        """
        return _Cast_ClutchHalfCompoundAdvancedSystemDeflection(self)
