...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierSteadyStateSynchronousResponseOnAShaft._Cast_PlanetCarrierSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_PlanetCarrierSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "PlanetCarrierSteadyStateSynchronousResponseOnAShaft"
...
class PlanetCarrierSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _PLANET_CARRIER_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PlanetCarrierSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_PlanetCarrierSteadyStateSynchronousResponseOnAShaft(self)
