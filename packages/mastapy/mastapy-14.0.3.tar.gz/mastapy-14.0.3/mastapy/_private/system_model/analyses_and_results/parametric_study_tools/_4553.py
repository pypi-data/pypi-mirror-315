...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearParametricStudyTool._Cast_WormGearParametricStudyTool",
    )
...
class _Cast_WormGearParametricStudyTool:
    ...
    __parent__: "WormGearParametricStudyTool"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearParametricStudyTool(_4475.GearParametricStudyTool):
    """WormGearParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _WORM_GEAR_PARAMETRIC_STUDY_TOOL
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_WormGearParametricStudyTool
        """
        return _Cast_WormGearParametricStudyTool(self)
