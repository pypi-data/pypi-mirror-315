...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchConnectionCompoundStabilityAnalysis._Cast_ClutchConnectionCompoundStabilityAnalysis",
    )
...
class _Cast_ClutchConnectionCompoundStabilityAnalysis:
    ...
    __parent__: "ClutchConnectionCompoundStabilityAnalysis"
...
class ClutchConnectionCompoundStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_CONNECTION_COMPOUND_STABILITY_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3889.ClutchConnectionStabilityAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchConnectionCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ClutchConnectionCompoundStabilityAnalysis
        """
        return _Cast_ClutchConnectionCompoundStabilityAnalysis(self)
