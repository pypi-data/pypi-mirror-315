...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionCompoundModalAnalysisAtAStiffness._Cast_ShaftHubConnectionCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_ShaftHubConnectionCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "ShaftHubConnectionCompoundModalAnalysisAtAStiffness"
...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _SHAFT_HUB_CONNECTION_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ShaftHubConnectionCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionCompoundModalAnalysisAtAStiffness
        """
        return _Cast_ShaftHubConnectionCompoundModalAnalysisAtAStiffness(self)
