...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadCompoundModalAnalysisAtASpeed._Cast_PowerLoadCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_PowerLoadCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "PowerLoadCompoundModalAnalysisAtASpeed"
...
class PowerLoadCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _POWER_LOAD_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5332.PowerLoadModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerLoadCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadCompoundModalAnalysisAtASpeed
        """
        return _Cast_PowerLoadCompoundModalAnalysisAtASpeed(self)
