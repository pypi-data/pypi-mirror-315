...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="DatumPowerFlow._Cast_DatumPowerFlow")
...
class _Cast_DatumPowerFlow:
    ...
    @property
    def datum_power_flow(self: "CastSelf") -> "DatumPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumPowerFlow(_4166.ComponentPowerFlow):
    """DatumPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _DATUM_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_DatumPowerFlow
        """
        return _Cast_DatumPowerFlow(self)
