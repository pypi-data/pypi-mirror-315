...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearCompoundModalAnalysis._Cast_WormGearCompoundModalAnalysis",
    )
...
class _Cast_WormGearCompoundModalAnalysis:
    ...
    __parent__: "WormGearCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearCompoundModalAnalysis(_4905.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _WORM_GEAR_COMPOUND_MODAL_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4830.WormGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4830.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_WormGearCompoundModalAnalysis
        """
        return _Cast_WormGearCompoundModalAnalysis(self)
