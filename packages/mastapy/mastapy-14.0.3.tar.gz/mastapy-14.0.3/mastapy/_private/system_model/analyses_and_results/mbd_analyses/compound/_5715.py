...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelCompoundMultibodyDynamicsAnalysis._Cast_ExternalCADModelCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_ExternalCADModelCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "ExternalCADModelCompoundMultibodyDynamicsAnalysis"
...
class ExternalCADModelCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _EXTERNAL_CAD_MODEL_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5561.ExternalCADModelMultibodyDynamicsAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ExternalCADModelCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_ExternalCADModelCompoundMultibodyDynamicsAnalysis(self)
