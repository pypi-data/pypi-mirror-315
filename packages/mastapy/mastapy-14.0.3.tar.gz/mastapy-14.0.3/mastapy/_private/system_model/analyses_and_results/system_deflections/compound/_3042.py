...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionCompoundSystemDeflection._Cast_ShaftHubConnectionCompoundSystemDeflection",
    )
...
class _Cast_ShaftHubConnectionCompoundSystemDeflection:
    ...
    __parent__: "ShaftHubConnectionCompoundSystemDeflection"
...
class ShaftHubConnectionCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _SHAFT_HUB_CONNECTION_COMPOUND_SYSTEM_DEFLECTION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ShaftHubConnectionCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionCompoundSystemDeflection
        """
        return _Cast_ShaftHubConnectionCompoundSystemDeflection(self)
