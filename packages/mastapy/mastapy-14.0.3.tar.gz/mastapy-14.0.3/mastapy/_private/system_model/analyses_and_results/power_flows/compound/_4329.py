...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundPowerFlow(_4303.ComponentCompoundPowerFlow):
    """DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4193.DatumPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4193.DatumPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.DatumPowerFlow]
