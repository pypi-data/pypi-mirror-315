...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearCompoundModalAnalysisAtAStiffness._Cast_FaceGearCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_FaceGearCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "FaceGearCompoundModalAnalysisAtAStiffness"
...
class FaceGearCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_FaceGearCompoundModalAnalysisAtAStiffness
        """
        return _Cast_FaceGearCompoundModalAnalysisAtAStiffness(self)
