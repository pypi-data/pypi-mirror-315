...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearHarmonicAnalysisOfSingleExcitation._Cast_HypoidGearHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_HypoidGearHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "HypoidGearHarmonicAnalysisOfSingleExcitation"
...
class HypoidGearHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _HYPOID_GEAR_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_HypoidGearHarmonicAnalysisOfSingleExcitation(self)
