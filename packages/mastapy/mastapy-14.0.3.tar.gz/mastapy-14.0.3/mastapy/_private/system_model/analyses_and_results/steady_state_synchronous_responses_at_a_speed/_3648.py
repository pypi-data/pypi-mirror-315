...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="CycloidalAssemblySteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblySteadyStateSynchronousResponseAtASpeed._Cast_CycloidalAssemblySteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_CycloidalAssemblySteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "CycloidalAssemblySteadyStateSynchronousResponseAtASpeed"
...
class CycloidalAssemblySteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CYCLOIDAL_ASSEMBLY_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CycloidalAssemblySteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblySteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_CycloidalAssemblySteadyStateSynchronousResponseAtASpeed(self)
