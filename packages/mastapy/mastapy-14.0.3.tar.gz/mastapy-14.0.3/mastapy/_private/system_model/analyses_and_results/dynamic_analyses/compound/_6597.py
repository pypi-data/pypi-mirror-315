...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyCompoundDynamicAnalysis._Cast_CycloidalAssemblyCompoundDynamicAnalysis",
    )
...
class _Cast_CycloidalAssemblyCompoundDynamicAnalysis:
    ...
    __parent__: "CycloidalAssemblyCompoundDynamicAnalysis"
...
class CycloidalAssemblyCompoundDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6464.CycloidalAssemblyDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyCompoundDynamicAnalysis
        """
        return _Cast_CycloidalAssemblyCompoundDynamicAnalysis(self)
