...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfModalAnalysisAtASpeed._Cast_SpringDamperHalfModalAnalysisAtASpeed",
    )
...
class _Cast_SpringDamperHalfModalAnalysisAtASpeed:
    ...
    __parent__: "SpringDamperHalfModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperHalfModalAnalysisAtASpeed(_5280.CouplingHalfModalAnalysisAtASpeed):
    """SpringDamperHalfModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHalfModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfModalAnalysisAtASpeed
        """
        return _Cast_SpringDamperHalfModalAnalysisAtASpeed(self)
