...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BearingCompoundSteadyStateSynchronousResponse._Cast_BearingCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_BearingCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "BearingCompoundSteadyStateSynchronousResponse"
...
class BearingCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _BEARING_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3084.BearingSteadyStateSynchronousResponse]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BearingCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_BearingCompoundSteadyStateSynchronousResponse
        """
        return _Cast_BearingCompoundSteadyStateSynchronousResponse(self)
