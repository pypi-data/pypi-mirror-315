...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed",
    )
...
class _Cast_KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed:
    ...
    __parent__: "KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed"
...
class KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed(
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed
        """
        return _Cast_KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed(self)
