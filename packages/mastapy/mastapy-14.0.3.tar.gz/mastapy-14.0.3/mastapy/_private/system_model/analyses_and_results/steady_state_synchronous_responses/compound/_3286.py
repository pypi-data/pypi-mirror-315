...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MassDiscCompoundSteadyStateSynchronousResponse._Cast_MassDiscCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_MassDiscCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "MassDiscCompoundSteadyStateSynchronousResponse"
...
class MassDiscCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _MASS_DISC_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MassDiscCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_MassDiscCompoundSteadyStateSynchronousResponse
        """
        return _Cast_MassDiscCompoundSteadyStateSynchronousResponse(self)
