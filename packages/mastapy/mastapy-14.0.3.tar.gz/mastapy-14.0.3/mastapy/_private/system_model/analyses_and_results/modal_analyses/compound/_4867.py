...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCompoundModalAnalysis._Cast_BoltedJointCompoundModalAnalysis",
    )
...
class _Cast_BoltedJointCompoundModalAnalysis:
    ...
    __parent__: "BoltedJointCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointCompoundModalAnalysis(_4947.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLTED_JOINT_COMPOUND_MODAL_ANALYSIS
    ...
    @property
    def component_design(self: "Self") -> "_2501.BoltedJoint":
    ...
    @property
    def assembly_design(self: "Self") -> "_2501.BoltedJoint":
        """mastapy.system_model.part_model.BoltedJoint
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4708.BoltedJointModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4708.BoltedJointModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltedJointModalAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCompoundModalAnalysis
        """
        return _Cast_BoltedJointCompoundModalAnalysis(self)
