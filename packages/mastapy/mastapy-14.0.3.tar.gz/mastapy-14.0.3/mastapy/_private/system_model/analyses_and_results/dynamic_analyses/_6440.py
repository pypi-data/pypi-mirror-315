...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="BoltDynamicAnalysis._Cast_BoltDynamicAnalysis"
    )
...
class _Cast_BoltDynamicAnalysis:
    ...
    __parent__: "BoltDynamicAnalysis"
    ...
    @property
    def bolt_dynamic_analysis(self: "CastSelf") -> "BoltDynamicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltDynamicAnalysis(_6446.ComponentDynamicAnalysis):
    """BoltDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLT_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BoltDynamicAnalysis
        """
        return _Cast_BoltDynamicAnalysis(self)
