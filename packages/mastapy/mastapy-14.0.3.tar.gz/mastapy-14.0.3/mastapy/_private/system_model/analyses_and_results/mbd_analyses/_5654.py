...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMultibodyDynamicsAnalysis._Cast_ZerolBevelGearMultibodyDynamicsAnalysis",
    )
...
class _Cast_ZerolBevelGearMultibodyDynamicsAnalysis:
    ...
    __parent__: "ZerolBevelGearMultibodyDynamicsAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearMultibodyDynamicsAnalysis(_5525.BevelGearMultibodyDynamicsAnalysis):
    """ZerolBevelGearMultibodyDynamicsAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ZerolBevelGearMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMultibodyDynamicsAnalysis
        """
        return _Cast_ZerolBevelGearMultibodyDynamicsAnalysis(self)
