...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="BevelDifferentialSunGearSteadyStateSynchronousResponse"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialSunGearSteadyStateSynchronousResponse._Cast_BevelDifferentialSunGearSteadyStateSynchronousResponse",
    )
...
class _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponse:
    ...
    __parent__: "BevelDifferentialSunGearSteadyStateSynchronousResponse"
...
class BevelDifferentialSunGearSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_SUN_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialSunGearSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponse
        """
        return _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponse(self)
