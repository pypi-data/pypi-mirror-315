...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshCompoundMultibodyDynamicsAnalysis._Cast_FaceGearMeshCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_FaceGearMeshCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "FaceGearMeshCompoundMultibodyDynamicsAnalysis"
...
class FaceGearMeshCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_MESH_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5562.FaceGearMeshMultibodyDynamicsAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearMeshCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_FaceGearMeshCompoundMultibodyDynamicsAnalysis(self)
