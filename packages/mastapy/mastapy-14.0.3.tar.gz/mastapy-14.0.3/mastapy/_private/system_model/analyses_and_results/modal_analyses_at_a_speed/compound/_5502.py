...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearCompoundModalAnalysisAtASpeed._Cast_ZerolBevelGearCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_ZerolBevelGearCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "ZerolBevelGearCompoundModalAnalysisAtASpeed"
...
class ZerolBevelGearCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ZerolBevelGearCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearCompoundModalAnalysisAtASpeed
        """
        return _Cast_ZerolBevelGearCompoundModalAnalysisAtASpeed(self)
