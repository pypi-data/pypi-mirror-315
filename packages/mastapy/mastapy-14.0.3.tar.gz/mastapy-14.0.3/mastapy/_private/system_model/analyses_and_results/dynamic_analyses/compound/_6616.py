...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearCompoundDynamicAnalysis._Cast_HypoidGearCompoundDynamicAnalysis",
    )
...
class _Cast_HypoidGearCompoundDynamicAnalysis:
    ...
    __parent__: "HypoidGearCompoundDynamicAnalysis"
...
class HypoidGearCompoundDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _HYPOID_GEAR_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6485.HypoidGearDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearCompoundDynamicAnalysis
        """
        return _Cast_HypoidGearCompoundDynamicAnalysis(self)
