...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltConnectionCompoundModalAnalysisAtASpeed._Cast_BeltConnectionCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_BeltConnectionCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "BeltConnectionCompoundModalAnalysisAtASpeed"
    ...
    def cvt_belt_connection_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5414.CVTBeltConnectionCompoundModalAnalysisAtASpeed":
        from mastapy._private.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
            _5414,
        )
...
class BeltConnectionCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _BELT_CONNECTION_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5251.BeltConnectionModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltConnectionCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_BeltConnectionCompoundModalAnalysisAtASpeed
        """
        return _Cast_BeltConnectionCompoundModalAnalysisAtASpeed(self)
