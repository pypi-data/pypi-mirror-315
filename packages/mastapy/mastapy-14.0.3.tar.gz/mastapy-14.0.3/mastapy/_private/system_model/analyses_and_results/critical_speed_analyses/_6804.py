...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearCriticalSpeedAnalysis._Cast_StraightBevelGearCriticalSpeedAnalysis",
    )
...
class _Cast_StraightBevelGearCriticalSpeedAnalysis:
    ...
    __parent__: "StraightBevelGearCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearCriticalSpeedAnalysis(_6707.BevelGearCriticalSpeedAnalysis):
    """StraightBevelGearCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelGearCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearCriticalSpeedAnalysis
        """
        return _Cast_StraightBevelGearCriticalSpeedAnalysis(self)
