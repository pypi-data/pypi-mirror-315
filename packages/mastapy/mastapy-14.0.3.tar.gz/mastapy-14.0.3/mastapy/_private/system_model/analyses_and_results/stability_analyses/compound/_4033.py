...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearCompoundStabilityAnalysis._Cast_ConceptGearCompoundStabilityAnalysis",
    )
...
class _Cast_ConceptGearCompoundStabilityAnalysis:
    ...
    __parent__: "ConceptGearCompoundStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearCompoundStabilityAnalysis(_4062.GearCompoundStabilityAnalysis):
    """ConceptGearCompoundStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_COMPOUND_STABILITY_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3899.ConceptGearStabilityAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearCompoundStabilityAnalysis
        """
        return _Cast_ConceptGearCompoundStabilityAnalysis(self)
