...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingAssemblyCompoundPowerFlow._Cast_RollingRingAssemblyCompoundPowerFlow",
    )
...
class _Cast_RollingRingAssemblyCompoundPowerFlow:
    ...
    __parent__: "RollingRingAssemblyCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingAssemblyCompoundPowerFlow(_4378.SpecialisedAssemblyCompoundPowerFlow):
    """RollingRingAssemblyCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ROLLING_RING_ASSEMBLY_COMPOUND_POWER_FLOW
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4239.RollingRingAssemblyPowerFlow]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingAssemblyCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_RollingRingAssemblyCompoundPowerFlow
        """
        return _Cast_RollingRingAssemblyCompoundPowerFlow(self)
