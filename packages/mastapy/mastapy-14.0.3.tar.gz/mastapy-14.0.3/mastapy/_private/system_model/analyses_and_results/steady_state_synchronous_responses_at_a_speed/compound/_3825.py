...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="PointLoadCompoundSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PointLoadCompoundSteadyStateSynchronousResponseAtASpeed._Cast_PointLoadCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_PointLoadCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "PointLoadCompoundSteadyStateSynchronousResponseAtASpeed"
...
class PointLoadCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _POINT_LOAD_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3693.PointLoadSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PointLoadCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PointLoadCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_PointLoadCompoundSteadyStateSynchronousResponseAtASpeed(self)
