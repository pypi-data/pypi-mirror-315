...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ClutchCompoundPowerFlow._Cast_ClutchCompoundPowerFlow"
    )
...
class _Cast_ClutchCompoundPowerFlow:
    ...
    __parent__: "ClutchCompoundPowerFlow"
    ...
    @property
    def clutch_compound_power_flow(self: "CastSelf") -> "ClutchCompoundPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchCompoundPowerFlow(_4315.CouplingCompoundPowerFlow):
    """ClutchCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_COMPOUND_POWER_FLOW
    ...
    @property
    def component_design(self: "Self") -> "_2640.Clutch":
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4164.ClutchPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4164.ClutchPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ClutchPowerFlow]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_ClutchCompoundPowerFlow
        """
        return _Cast_ClutchCompoundPowerFlow(self)
