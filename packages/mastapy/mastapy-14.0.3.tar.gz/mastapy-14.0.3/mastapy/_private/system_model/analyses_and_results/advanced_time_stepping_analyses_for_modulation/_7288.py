...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation._Cast_TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation"
...
class TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_TURBINE_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation(
            self
        )
