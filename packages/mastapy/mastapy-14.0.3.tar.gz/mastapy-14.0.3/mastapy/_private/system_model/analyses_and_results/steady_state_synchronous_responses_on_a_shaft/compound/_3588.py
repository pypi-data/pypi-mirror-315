...
_STRAIGHT_BEVEL_SUN_GEAR_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self",
        bound="StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft",
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft._Cast_StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft(
    _3581.StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft
):
    """StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_SUN_GEAR_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3457.StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft]":
        """List[mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft]
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_StraightBevelSunGearCompoundSteadyStateSynchronousResponseOnAShaft(
            self
        )
