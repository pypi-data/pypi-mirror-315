...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierCompoundHarmonicAnalysis._Cast_PlanetCarrierCompoundHarmonicAnalysis",
    )
...
class _Cast_PlanetCarrierCompoundHarmonicAnalysis:
    ...
    __parent__: "PlanetCarrierCompoundHarmonicAnalysis"
...
class PlanetCarrierCompoundHarmonicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _PLANET_CARRIER_COMPOUND_HARMONIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5933.PlanetCarrierHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PlanetCarrierCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierCompoundHarmonicAnalysis
        """
        return _Cast_PlanetCarrierCompoundHarmonicAnalysis(self)
