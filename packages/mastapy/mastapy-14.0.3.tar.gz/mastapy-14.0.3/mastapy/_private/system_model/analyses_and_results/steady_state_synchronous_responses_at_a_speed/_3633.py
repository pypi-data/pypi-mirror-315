...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ConceptCouplingSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingSteadyStateSynchronousResponseAtASpeed._Cast_ConceptCouplingSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ConceptCouplingSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ConceptCouplingSteadyStateSynchronousResponseAtASpeed"
...
class ConceptCouplingSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ConceptCouplingSteadyStateSynchronousResponseAtASpeed(self)
