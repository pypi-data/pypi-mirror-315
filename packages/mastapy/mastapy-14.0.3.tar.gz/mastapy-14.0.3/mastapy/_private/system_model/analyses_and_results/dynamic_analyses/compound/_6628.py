...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundDynamicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6497.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6626.KlingelnbergCycloPalloidSpiralBevelGearCompoundDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_dynamic_analysis(
        ...
        "List[_6627.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundDynamicAnalysis]"
    ):
