...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftSteadyStateSynchronousResponseAtASpeed._Cast_ShaftSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ShaftSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ShaftSteadyStateSynchronousResponseAtASpeed"
...
class ShaftSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _SHAFT_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def planetaries(
        self: "Self",
    ) -> "List[ShaftSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ShaftSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ShaftSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ShaftSteadyStateSynchronousResponseAtASpeed(self)
