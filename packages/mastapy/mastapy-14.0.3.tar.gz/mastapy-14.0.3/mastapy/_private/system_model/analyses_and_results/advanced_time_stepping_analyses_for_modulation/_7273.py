...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation._Cast_StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation"
...
class StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_DIFF_GEAR_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation(
            self
        )
