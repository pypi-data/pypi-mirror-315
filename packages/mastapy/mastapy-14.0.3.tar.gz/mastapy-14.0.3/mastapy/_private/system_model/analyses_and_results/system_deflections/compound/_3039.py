...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyCompoundSystemDeflection(_2949.AssemblyCompoundSystemDeflection):
    """RootAssemblyCompoundSystemDeflection
    ...
    def duty_cycle_efficiency_results(
        self: "Self",
    ) -> "_2994.DutyCycleEfficiencyResults":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2891.RootAssemblySystemDeflection]":
    ...
    def peak_to_peak_transmission_error_chart(
        self: "Self",
        mesh_duty_cycles: "List[_1133.CylindricalGearMeshMicroGeometryDutyCycle]",
        header: "str",
        x_axis_title: "str",
        y_axis_title: "str",
