...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearCompoundModalAnalysisAtASpeed._Cast_WormGearCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_WormGearCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "WormGearCompoundModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearCompoundModalAnalysisAtASpeed(_5432.GearCompoundModalAnalysisAtASpeed):
    """WormGearCompoundModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _WORM_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5369.WormGearModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_WormGearCompoundModalAnalysisAtASpeed
        """
        return _Cast_WormGearCompoundModalAnalysisAtASpeed(self)
