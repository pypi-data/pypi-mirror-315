...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperSteadyStateSynchronousResponseOnAShaft._Cast_SpringDamperSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_SpringDamperSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "SpringDamperSteadyStateSynchronousResponseOnAShaft"
...
class SpringDamperSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_SpringDamperSteadyStateSynchronousResponseOnAShaft(self)
