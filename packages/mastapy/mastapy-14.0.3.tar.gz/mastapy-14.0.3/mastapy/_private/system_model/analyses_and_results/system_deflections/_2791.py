...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSetSystemDeflection(_2796.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4154.BevelDifferentialGearSetPowerFlow":
