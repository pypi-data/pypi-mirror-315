...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelPlanetGearModalAnalysisAtASpeed._Cast_StraightBevelPlanetGearModalAnalysisAtASpeed",
    )
...
class _Cast_StraightBevelPlanetGearModalAnalysisAtASpeed:
    ...
    __parent__: "StraightBevelPlanetGearModalAnalysisAtASpeed"
...
class StraightBevelPlanetGearModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_PLANET_GEAR_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelPlanetGearModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelPlanetGearModalAnalysisAtASpeed
        """
        return _Cast_StraightBevelPlanetGearModalAnalysisAtASpeed(self)
