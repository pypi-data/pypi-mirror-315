...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingConnectionModalAnalysisAtASpeed._Cast_ConceptCouplingConnectionModalAnalysisAtASpeed",
    )
...
class _Cast_ConceptCouplingConnectionModalAnalysisAtASpeed:
    ...
    __parent__: "ConceptCouplingConnectionModalAnalysisAtASpeed"
...
class ConceptCouplingConnectionModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_CONNECTION_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptCouplingConnectionModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingConnectionModalAnalysisAtASpeed
        """
        return _Cast_ConceptCouplingConnectionModalAnalysisAtASpeed(self)
