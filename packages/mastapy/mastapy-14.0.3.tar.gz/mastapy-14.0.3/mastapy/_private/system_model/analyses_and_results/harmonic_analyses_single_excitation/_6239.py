...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadHarmonicAnalysisOfSingleExcitation._Cast_PowerLoadHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_PowerLoadHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "PowerLoadHarmonicAnalysisOfSingleExcitation"
...
class PowerLoadHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _POWER_LOAD_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerLoadHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_PowerLoadHarmonicAnalysisOfSingleExcitation(self)
