...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="DatumCriticalSpeedAnalysis._Cast_DatumCriticalSpeedAnalysis"
    )
...
class _Cast_DatumCriticalSpeedAnalysis:
    ...
    __parent__: "DatumCriticalSpeedAnalysis"
    ...
    @property
    def datum_critical_speed_analysis(self: "CastSelf") -> "DatumCriticalSpeedAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCriticalSpeedAnalysis(_6716.ComponentCriticalSpeedAnalysis):
    """DatumCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _DATUM_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_DatumCriticalSpeedAnalysis
        """
        return _Cast_DatumCriticalSpeedAnalysis(self)
