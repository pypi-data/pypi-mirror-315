...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis._Cast_BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis"
...
class BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_GEAR_MESH_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5519.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_BevelDifferentialGearMeshCompoundMultibodyDynamicsAnalysis(self)
