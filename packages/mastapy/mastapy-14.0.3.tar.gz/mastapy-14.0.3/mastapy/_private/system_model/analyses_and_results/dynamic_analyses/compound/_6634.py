...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealCompoundDynamicAnalysis(_6590.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6503.OilSealDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6503.OilSealDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.OilSealDynamicAnalysis]
