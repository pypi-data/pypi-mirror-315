...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2708, _2764
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TimeSeriesLoadCaseGroup(_5795.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: "Self") -> "List[_6958.TimeSeriesLoadCase]":
