...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation._Cast_SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation"
...
class SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _SPIRAL_BEVEL_GEAR_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation(self)
