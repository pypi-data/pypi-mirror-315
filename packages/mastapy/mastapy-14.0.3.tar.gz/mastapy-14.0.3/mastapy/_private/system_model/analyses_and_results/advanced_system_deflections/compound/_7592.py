...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingCompoundAdvancedSystemDeflection._Cast_ConceptCouplingCompoundAdvancedSystemDeflection",
    )
...
class _Cast_ConceptCouplingCompoundAdvancedSystemDeflection:
    ...
    __parent__: "ConceptCouplingCompoundAdvancedSystemDeflection"
...
class ConceptCouplingCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7457.ConceptCouplingAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingCompoundAdvancedSystemDeflection
        """
        return _Cast_ConceptCouplingCompoundAdvancedSystemDeflection(self)
