...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierCompoundStabilityAnalysis._Cast_PlanetCarrierCompoundStabilityAnalysis",
    )
...
class _Cast_PlanetCarrierCompoundStabilityAnalysis:
    ...
    __parent__: "PlanetCarrierCompoundStabilityAnalysis"
...
class PlanetCarrierCompoundStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = _PLANET_CARRIER_COMPOUND_STABILITY_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3957.PlanetCarrierStabilityAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PlanetCarrierCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierCompoundStabilityAnalysis
        """
        return _Cast_PlanetCarrierCompoundStabilityAnalysis(self)
