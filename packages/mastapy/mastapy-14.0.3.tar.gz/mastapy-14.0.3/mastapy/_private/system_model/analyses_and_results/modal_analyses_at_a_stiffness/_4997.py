...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointModalAnalysisAtAStiffness._Cast_BoltedJointModalAnalysisAtAStiffness",
    )
...
class _Cast_BoltedJointModalAnalysisAtAStiffness:
    ...
    __parent__: "BoltedJointModalAnalysisAtAStiffness"
...
class BoltedJointModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointModalAnalysisAtAStiffness
        """
        return _Cast_BoltedJointModalAnalysisAtAStiffness(self)
