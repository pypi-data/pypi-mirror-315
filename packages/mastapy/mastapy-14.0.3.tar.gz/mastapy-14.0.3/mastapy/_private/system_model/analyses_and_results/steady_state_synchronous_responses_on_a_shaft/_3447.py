...
_SPRING_DAMPER_HALF_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="SpringDamperHalfSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfSteadyStateSynchronousResponseOnAShaft._Cast_SpringDamperHalfSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_SpringDamperHalfSteadyStateSynchronousResponseOnAShaft:
    """Special nested class for casting SpringDamperHalfSteadyStateSynchronousResponseOnAShaft to subclasses."""

    __parent__: "SpringDamperHalfSteadyStateSynchronousResponseOnAShaft"
...
class SpringDamperHalfSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _SPRING_DAMPER_HALF_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperHalfSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_SpringDamperHalfSteadyStateSynchronousResponseOnAShaft(self)
