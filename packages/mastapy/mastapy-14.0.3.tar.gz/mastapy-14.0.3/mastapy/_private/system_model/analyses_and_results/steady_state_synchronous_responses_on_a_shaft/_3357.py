...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft._Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft"
...
class BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_SUN_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_BevelDifferentialSunGearSteadyStateSynchronousResponseOnAShaft(
            self
        )
