...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness._Cast_ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness"
...
class ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_CONNECTION_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    @property
    def component_design(self: "Self") -> "_2401.ConceptCouplingConnection":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5004.ConceptCouplingConnectionModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness
        """
        return _Cast_ConceptCouplingConnectionCompoundModalAnalysisAtAStiffness(self)
