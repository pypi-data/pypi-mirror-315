...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltConnectionSteadyStateSynchronousResponse._Cast_BeltConnectionSteadyStateSynchronousResponse",
    )
...
class _Cast_BeltConnectionSteadyStateSynchronousResponse:
    ...
    __parent__: "BeltConnectionSteadyStateSynchronousResponse"
...
class BeltConnectionSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _BELT_CONNECTION_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltConnectionSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_BeltConnectionSteadyStateSynchronousResponse
        """
        return _Cast_BeltConnectionSteadyStateSynchronousResponse(self)
