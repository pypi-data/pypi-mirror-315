...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="OilSealSteadyStateSynchronousResponseAtASpeed._Cast_OilSealSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_OilSealSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "OilSealSteadyStateSynchronousResponseAtASpeed"
...
class OilSealSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _OIL_SEAL_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_OilSealSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_OilSealSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_OilSealSteadyStateSynchronousResponseAtASpeed(self)
