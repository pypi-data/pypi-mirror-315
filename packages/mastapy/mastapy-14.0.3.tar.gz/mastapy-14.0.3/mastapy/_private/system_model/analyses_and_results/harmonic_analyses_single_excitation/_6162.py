...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation._Cast_BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation"
...
class BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation(
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_BevelDifferentialPlanetGearHarmonicAnalysisOfSingleExcitation(self)
