...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="HypoidGearHarmonicAnalysis._Cast_HypoidGearHarmonicAnalysis"
    )
...
class _Cast_HypoidGearHarmonicAnalysis:
    ...
    __parent__: "HypoidGearHarmonicAnalysis"
    ...
    @property
    def hypoid_gear_harmonic_analysis(self: "CastSelf") -> "HypoidGearHarmonicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearHarmonicAnalysis(_5819.AGMAGleasonConicalGearHarmonicAnalysis):
    """HypoidGearHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _HYPOID_GEAR_HARMONIC_ANALYSIS
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2854.HypoidGearSystemDeflection":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearHarmonicAnalysis
        """
        return _Cast_HypoidGearHarmonicAnalysis(self)
