...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltDriveModalAnalysisAtAStiffness._Cast_BeltDriveModalAnalysisAtAStiffness",
    )
...
class _Cast_BeltDriveModalAnalysisAtAStiffness:
    ...
    __parent__: "BeltDriveModalAnalysisAtAStiffness"
...
class BeltDriveModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _BELT_DRIVE_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltDriveModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_BeltDriveModalAnalysisAtAStiffness
        """
        return _Cast_BeltDriveModalAnalysisAtAStiffness(self)
