...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointCompoundPowerFlow(_4378.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4160.BoltedJointPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4160.BoltedJointPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltedJointPowerFlow]
