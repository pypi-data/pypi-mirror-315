...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperCompoundStabilityAnalysis._Cast_SpringDamperCompoundStabilityAnalysis",
    )
...
class _Cast_SpringDamperCompoundStabilityAnalysis:
    ...
    __parent__: "SpringDamperCompoundStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperCompoundStabilityAnalysis(_4041.CouplingCompoundStabilityAnalysis):
    """SpringDamperCompoundStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_COMPOUND_STABILITY_ANALYSIS
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3976.SpringDamperStabilityAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperCompoundStabilityAnalysis
        """
        return _Cast_SpringDamperCompoundStabilityAnalysis(self)
