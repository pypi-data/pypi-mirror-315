...
_PART_TO_PART_SHEAR_COUPLING_HALF_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self",
        bound="PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft",
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft._Cast_PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft(
    _3380.CouplingHalfSteadyStateSynchronousResponseOnAShaft
):
    """PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft
    ...
    TYPE: ClassVar["Type"] = (
        _PART_TO_PART_SHEAR_COUPLING_HALF_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft(
            self
        )
