...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft._Cast_FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft"
...
class FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _FLEXIBLE_PIN_ASSEMBLY_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft(self)
