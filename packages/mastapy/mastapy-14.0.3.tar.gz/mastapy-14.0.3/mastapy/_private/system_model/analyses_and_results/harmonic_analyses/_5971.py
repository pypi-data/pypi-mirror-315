...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpHarmonicAnalysis._Cast_TorqueConverterPumpHarmonicAnalysis",
    )
...
class _Cast_TorqueConverterPumpHarmonicAnalysis:
    ...
    __parent__: "TorqueConverterPumpHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterPumpHarmonicAnalysis(_5854.CouplingHalfHarmonicAnalysis):
    """TorqueConverterPumpHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_PUMP_HARMONIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterPumpHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpHarmonicAnalysis
        """
        return _Cast_TorqueConverterPumpHarmonicAnalysis(self)
