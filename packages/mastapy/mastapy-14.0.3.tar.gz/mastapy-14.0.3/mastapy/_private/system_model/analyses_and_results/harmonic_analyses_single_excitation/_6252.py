...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation._Cast_SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation"
...
class SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _SPIRAL_BEVEL_GEAR_MESH_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation(self)
