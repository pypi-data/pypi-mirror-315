...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft"
...
class ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _ZEROL_BEVEL_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft(self)
