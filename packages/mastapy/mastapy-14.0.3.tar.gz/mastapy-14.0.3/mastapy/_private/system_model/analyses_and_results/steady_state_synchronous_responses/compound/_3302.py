...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsCompoundSteadyStateSynchronousResponse._Cast_RingPinsCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_RingPinsCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "RingPinsCompoundSteadyStateSynchronousResponse"
...
class RingPinsCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3168.RingPinsSteadyStateSynchronousResponse]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_RingPinsCompoundSteadyStateSynchronousResponse
        """
        return _Cast_RingPinsCompoundSteadyStateSynchronousResponse(self)
