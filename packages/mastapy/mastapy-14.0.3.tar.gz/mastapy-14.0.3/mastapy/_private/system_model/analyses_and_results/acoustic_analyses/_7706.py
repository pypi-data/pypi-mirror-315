...
class _Cast_SingleExcitationDetails:
    ...
    def single_harmonic_excitation_analysis_detail(
        self: "CastSelf",
    ) -> "_7707.SingleHarmonicExcitationAnalysisDetail":
        from mastapy._private.system_model.analyses_and_results.acoustic_analyses import (
            _7707,
        )

        return self.__parent__._cast(_7707.SingleHarmonicExcitationAnalysisDetail)

    @property
    def unit_force_excitation_analysis_detail(
        self: "CastSelf",
    ) -> "_7708.UnitForceExcitationAnalysisDetail":
        from mastapy._private.system_model.analyses_and_results.acoustic_analyses import (
            _7708,
        )

        return self.__parent__._cast(_7708.UnitForceExcitationAnalysisDetail)
