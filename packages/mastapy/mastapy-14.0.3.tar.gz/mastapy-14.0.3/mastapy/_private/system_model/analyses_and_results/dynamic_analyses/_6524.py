...
_SPIRAL_BEVEL_GEAR_DYNAMIC_ANALYSIS = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="SpiralBevelGearDynamicAnalysis")
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearDynamicAnalysis._Cast_SpiralBevelGearDynamicAnalysis",
    )
...
class _Cast_SpiralBevelGearDynamicAnalysis:
    """Special nested class for casting SpiralBevelGearDynamicAnalysis to subclasses."""

    __parent__: "SpiralBevelGearDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearDynamicAnalysis(_6437.BevelGearDynamicAnalysis):
    """SpiralBevelGearDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_DYNAMIC_ANALYSIS
    ...
    @property
    def component_load_case(self: "Self") -> "_7108.SpiralBevelGearLoadCase":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpiralBevelGearDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearDynamicAnalysis
        """
        return _Cast_SpiralBevelGearDynamicAnalysis(self)
