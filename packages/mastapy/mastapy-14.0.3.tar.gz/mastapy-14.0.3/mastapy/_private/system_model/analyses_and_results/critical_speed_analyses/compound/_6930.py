...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperConnectionCompoundCriticalSpeedAnalysis._Cast_SpringDamperConnectionCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_SpringDamperConnectionCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "SpringDamperConnectionCompoundCriticalSpeedAnalysis"
...
class SpringDamperConnectionCompoundCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_CONNECTION_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6798.SpringDamperConnectionCriticalSpeedAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperConnectionCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperConnectionCompoundCriticalSpeedAnalysis
        """
        return _Cast_SpringDamperConnectionCompoundCriticalSpeedAnalysis(self)
