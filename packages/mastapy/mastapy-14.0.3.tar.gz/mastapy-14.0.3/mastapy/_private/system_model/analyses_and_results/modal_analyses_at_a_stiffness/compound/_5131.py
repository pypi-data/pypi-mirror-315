...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCompoundModalAnalysisAtAStiffness._Cast_BoltedJointCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_BoltedJointCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "BoltedJointCompoundModalAnalysisAtAStiffness"
...
class BoltedJointCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCompoundModalAnalysisAtAStiffness
        """
        return _Cast_BoltedJointCompoundModalAnalysisAtAStiffness(self)
