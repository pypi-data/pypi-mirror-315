...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelPlanetGearPowerFlow._Cast_StraightBevelPlanetGearPowerFlow",
    )
...
class _Cast_StraightBevelPlanetGearPowerFlow:
    ...
    __parent__: "StraightBevelPlanetGearPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelPlanetGearPowerFlow(_4254.StraightBevelDiffGearPowerFlow):
    """StraightBevelPlanetGearPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_PLANET_GEAR_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelPlanetGearPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelPlanetGearPowerFlow
        """
        return _Cast_StraightBevelPlanetGearPowerFlow(self)
