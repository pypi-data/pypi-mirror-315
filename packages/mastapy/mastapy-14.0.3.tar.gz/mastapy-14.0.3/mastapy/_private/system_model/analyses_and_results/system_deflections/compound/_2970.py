...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfCompoundSystemDeflection._Cast_ConceptCouplingHalfCompoundSystemDeflection",
    )
...
class _Cast_ConceptCouplingHalfCompoundSystemDeflection:
    ...
    __parent__: "ConceptCouplingHalfCompoundSystemDeflection"
...
class ConceptCouplingHalfCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_HALF_COMPOUND_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2807.ConceptCouplingHalfSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptCouplingHalfCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfCompoundSystemDeflection
        """
        return _Cast_ConceptCouplingHalfCompoundSystemDeflection(self)
