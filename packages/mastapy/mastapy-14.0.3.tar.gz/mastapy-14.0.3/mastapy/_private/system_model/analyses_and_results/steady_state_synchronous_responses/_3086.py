...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltDriveSteadyStateSynchronousResponse._Cast_BeltDriveSteadyStateSynchronousResponse",
    )
...
class _Cast_BeltDriveSteadyStateSynchronousResponse:
    ...
    __parent__: "BeltDriveSteadyStateSynchronousResponse"
...
class BeltDriveSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _BELT_DRIVE_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltDriveSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_BeltDriveSteadyStateSynchronousResponse
        """
        return _Cast_BeltDriveSteadyStateSynchronousResponse(self)
