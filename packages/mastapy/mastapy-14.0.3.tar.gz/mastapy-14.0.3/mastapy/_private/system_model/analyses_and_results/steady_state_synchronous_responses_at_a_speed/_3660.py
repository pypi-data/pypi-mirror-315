...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearSteadyStateSynchronousResponseAtASpeed._Cast_FaceGearSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_FaceGearSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "FaceGearSteadyStateSynchronousResponseAtASpeed"
...
class FaceGearSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_FaceGearSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_FaceGearSteadyStateSynchronousResponseAtASpeed(self)
