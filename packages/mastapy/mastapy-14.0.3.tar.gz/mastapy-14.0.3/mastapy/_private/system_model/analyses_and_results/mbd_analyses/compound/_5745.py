...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.mbd_analyses import _5602
    from mastapy._private.system_model.analyses_and_results.mbd_analyses.compound import (
        _5663,
        _5744,
        _5763,
    ...
    Self = TypeVar(
        "Self", bound="PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis._Cast_PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis"
...
class PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = (
        _PART_TO_PART_SHEAR_COUPLING_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis(self)
