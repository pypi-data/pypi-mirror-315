...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelSystemDeflection._Cast_ExternalCADModelSystemDeflection",
    )
...
class _Cast_ExternalCADModelSystemDeflection:
    ...
    __parent__: "ExternalCADModelSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExternalCADModelSystemDeflection(_2804.ComponentSystemDeflection):
    """ExternalCADModelSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _EXTERNAL_CAD_MODEL_SYSTEM_DEFLECTION
    ...
    @property
    def power_flow_results(self: "Self") -> "_4194.ExternalCADModelPowerFlow":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ExternalCADModelSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelSystemDeflection
        """
        return _Cast_ExternalCADModelSystemDeflection(self)
