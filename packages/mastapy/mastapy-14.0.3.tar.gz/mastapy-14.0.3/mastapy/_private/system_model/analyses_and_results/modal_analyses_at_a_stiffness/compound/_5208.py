...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftCompoundModalAnalysisAtAStiffness._Cast_ShaftCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_ShaftCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "ShaftCompoundModalAnalysisAtAStiffness"
...
class ShaftCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _SHAFT_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5078.ShaftModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ShaftCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_ShaftCompoundModalAnalysisAtAStiffness
        """
        return _Cast_ShaftCompoundModalAnalysisAtAStiffness(self)
