...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearAdvancedSystemDeflection._Cast_ConceptGearAdvancedSystemDeflection",
    )
...
class _Cast_ConceptGearAdvancedSystemDeflection:
    ...
    __parent__: "ConceptGearAdvancedSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearAdvancedSystemDeflection(_7491.GearAdvancedSystemDeflection):
    """ConceptGearAdvancedSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_ADVANCED_SYSTEM_DEFLECTION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearAdvancedSystemDeflection
        """
        return _Cast_ConceptGearAdvancedSystemDeflection(self)
