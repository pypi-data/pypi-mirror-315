...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearAdvancedTimeSteppingAnalysisForModulation._Cast_WormGearAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_WormGearAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "WormGearAdvancedTimeSteppingAnalysisForModulation"
...
class WormGearAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = _WORM_GEAR_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2929.WormGearSystemDeflection":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_WormGearAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_WormGearAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_WormGearAdvancedTimeSteppingAnalysisForModulation(self)
