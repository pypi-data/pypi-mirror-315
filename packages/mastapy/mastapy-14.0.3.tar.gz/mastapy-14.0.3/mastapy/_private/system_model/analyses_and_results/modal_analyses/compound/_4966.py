...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4821
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _4847,
        _4928,
        _4947,
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterCompoundModalAnalysis(_4884.CouplingCompoundModalAnalysis):
    """TorqueConverterCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4821.TorqueConverterModalAnalysis]":
