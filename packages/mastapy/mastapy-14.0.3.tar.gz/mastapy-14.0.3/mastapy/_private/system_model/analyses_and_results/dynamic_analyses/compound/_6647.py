...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingAssemblyCompoundDynamicAnalysis._Cast_RollingRingAssemblyCompoundDynamicAnalysis",
    )
...
class _Cast_RollingRingAssemblyCompoundDynamicAnalysis:
    ...
    __parent__: "RollingRingAssemblyCompoundDynamicAnalysis"
...
class RollingRingAssemblyCompoundDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_ASSEMBLY_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6516.RollingRingAssemblyDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingAssemblyCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_RollingRingAssemblyCompoundDynamicAnalysis
        """
        return _Cast_RollingRingAssemblyCompoundDynamicAnalysis(self)
