...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation._Cast_ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation"
...
class ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_HALF_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation(self)
