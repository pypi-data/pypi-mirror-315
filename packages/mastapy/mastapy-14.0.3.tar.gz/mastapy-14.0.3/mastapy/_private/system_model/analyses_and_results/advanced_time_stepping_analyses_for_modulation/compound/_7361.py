...
class HypoidGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def hypoid_gears_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7359.HypoidGearCompoundAdvancedTimeSteppingAnalysisForModulation]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "HypoidGearsCompoundAdvancedTimeSteppingAnalysisForModulation"
        )
    ...
    def hypoid_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7360.HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "HypoidMeshesCompoundAdvancedTimeSteppingAnalysisForModulation",
        )
