...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse._Cast_PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse:
    ...
    def coupling_connection_compound_steady_state_synchronous_response(
        self: "CastSelf",
    ) -> "_3249.CouplingConnectionCompoundSteadyStateSynchronousResponse":
...
class PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _PART_TO_PART_SHEAR_COUPLING_CONNECTION_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3159.PartToPartShearCouplingConnectionSteadyStateSynchronousResponse]":
    ...
    def cast_to(
        ...
        "_Cast_PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse"
    ):
        ...
        Returns:
            _Cast_PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse
        """
        return _Cast_PartToPartShearCouplingConnectionCompoundSteadyStateSynchronousResponse(
            self
        )
