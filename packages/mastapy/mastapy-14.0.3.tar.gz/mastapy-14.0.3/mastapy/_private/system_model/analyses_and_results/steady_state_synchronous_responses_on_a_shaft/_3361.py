...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointSteadyStateSynchronousResponseOnAShaft._Cast_BoltedJointSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_BoltedJointSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "BoltedJointSteadyStateSynchronousResponseOnAShaft"
...
class BoltedJointSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BoltedJointSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_BoltedJointSteadyStateSynchronousResponseOnAShaft(self)
