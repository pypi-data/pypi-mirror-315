...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialPlanetGearModalAnalysis._Cast_BevelDifferentialPlanetGearModalAnalysis",
    )
...
class _Cast_BevelDifferentialPlanetGearModalAnalysis:
    ...
    __parent__: "BevelDifferentialPlanetGearModalAnalysis"
...
class BevelDifferentialPlanetGearModalAnalysis(
    ...
    TYPE: ClassVar["Type"] = _BEVEL_DIFFERENTIAL_PLANET_GEAR_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BevelDifferentialPlanetGearModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialPlanetGearModalAnalysis
        """
        return _Cast_BevelDifferentialPlanetGearModalAnalysis(self)
