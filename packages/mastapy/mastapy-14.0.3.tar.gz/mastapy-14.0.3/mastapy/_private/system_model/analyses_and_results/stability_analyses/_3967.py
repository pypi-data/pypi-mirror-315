...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionStabilityAnalysis._Cast_ShaftHubConnectionStabilityAnalysis",
    )
...
class _Cast_ShaftHubConnectionStabilityAnalysis:
    ...
    __parent__: "ShaftHubConnectionStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftHubConnectionStabilityAnalysis(_3904.ConnectorStabilityAnalysis):
    """ShaftHubConnectionStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SHAFT_HUB_CONNECTION_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ShaftHubConnectionStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionStabilityAnalysis
        """
        return _Cast_ShaftHubConnectionStabilityAnalysis(self)
