...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetDynamicAnalysis(_6483.GearSetDynamicAnalysis):
    """FaceGearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6476.FaceGearDynamicAnalysis]":
    ...
    def face_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6476.FaceGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.FaceGearDynamicAnalysis]
