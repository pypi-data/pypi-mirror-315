...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PulleyMultibodyDynamicsAnalysis(_5547.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self: "Self") -> "List[_5659.DynamicTorqueResultAtTime]":
