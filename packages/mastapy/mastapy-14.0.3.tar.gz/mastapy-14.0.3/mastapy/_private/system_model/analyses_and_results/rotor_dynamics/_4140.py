...
from mastapy._private.system_model.analyses_and_results.rotor_dynamics import _4138
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftModalComplexShapeAtStiffness(_4138.ShaftModalComplexShape):
    """ShaftModalComplexShapeAtStiffness
