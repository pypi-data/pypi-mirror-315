...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="KlingelnbergCycloPalloidHypoidGearDynamicAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearDynamicAnalysis",
    )
...
class _Cast_KlingelnbergCycloPalloidHypoidGearDynamicAnalysis:
    ...
    __parent__: "KlingelnbergCycloPalloidHypoidGearDynamicAnalysis"
...
class KlingelnbergCycloPalloidHypoidGearDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _KLINGELNBERG_CYCLO_PALLOID_HYPOID_GEAR_DYNAMIC_ANALYSIS
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_KlingelnbergCycloPalloidHypoidGearDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_KlingelnbergCycloPalloidHypoidGearDynamicAnalysis
        """
        return _Cast_KlingelnbergCycloPalloidHypoidGearDynamicAnalysis(self)
