...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetPowerFlow(_4147.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    @property
    def rating(self: "Self") -> "_453.HypoidGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_453.HypoidGearSetRating":
        """mastapy.gears.rating.hypoid.HypoidGearSetRating
    ...
    @property
    def hypoid_gears_power_flow(self: "Self") -> "List[_4207.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    def agma_gleason_conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4206.HypoidGearMeshPowerFlow]":
    ...
    @property
    def hypoid_meshes_power_flow(self: "Self") -> "List[_4206.HypoidGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]
