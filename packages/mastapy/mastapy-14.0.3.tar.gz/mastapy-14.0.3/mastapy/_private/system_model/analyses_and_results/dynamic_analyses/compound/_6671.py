...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserPartCompoundDynamicAnalysis._Cast_SynchroniserPartCompoundDynamicAnalysis",
    )
...
class _Cast_SynchroniserPartCompoundDynamicAnalysis:
    ...
    __parent__: "SynchroniserPartCompoundDynamicAnalysis"
...
class SynchroniserPartCompoundDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_PART_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def component_analysis_cases(
        self: "Self",
    ) -> "List[_6540.SynchroniserPartDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserPartCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserPartCompoundDynamicAnalysis
        """
        return _Cast_SynchroniserPartCompoundDynamicAnalysis(self)
