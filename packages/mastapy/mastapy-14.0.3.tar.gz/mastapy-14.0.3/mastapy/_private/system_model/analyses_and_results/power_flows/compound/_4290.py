...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearMeshCompoundPowerFlow._Cast_BevelDifferentialGearMeshCompoundPowerFlow",
    )
...
class _Cast_BevelDifferentialGearMeshCompoundPowerFlow:
    ...
    __parent__: "BevelDifferentialGearMeshCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearMeshCompoundPowerFlow(_4295.BevelGearMeshCompoundPowerFlow):
    """BevelDifferentialGearMeshCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BEVEL_DIFFERENTIAL_GEAR_MESH_COMPOUND_POWER_FLOW
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4152.BevelDifferentialGearMeshPowerFlow]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BevelDifferentialGearMeshCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialGearMeshCompoundPowerFlow
        """
        return _Cast_BevelDifferentialGearMeshCompoundPowerFlow(self)
