...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMeshCriticalSpeedAnalysis._Cast_ZerolBevelGearMeshCriticalSpeedAnalysis",
    )
...
class _Cast_ZerolBevelGearMeshCriticalSpeedAnalysis:
    ...
    __parent__: "ZerolBevelGearMeshCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearMeshCriticalSpeedAnalysis(_6708.BevelGearMeshCriticalSpeedAnalysis):
    """ZerolBevelGearMeshCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_MESH_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ZerolBevelGearMeshCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMeshCriticalSpeedAnalysis
        """
        return _Cast_ZerolBevelGearMeshCriticalSpeedAnalysis(self)
