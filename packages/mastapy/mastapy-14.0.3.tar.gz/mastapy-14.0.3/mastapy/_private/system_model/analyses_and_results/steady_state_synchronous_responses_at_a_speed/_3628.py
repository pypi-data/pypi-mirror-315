...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchSteadyStateSynchronousResponseAtASpeed._Cast_ClutchSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ClutchSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ClutchSteadyStateSynchronousResponseAtASpeed"
...
class ClutchSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ClutchSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ClutchSteadyStateSynchronousResponseAtASpeed(self)
