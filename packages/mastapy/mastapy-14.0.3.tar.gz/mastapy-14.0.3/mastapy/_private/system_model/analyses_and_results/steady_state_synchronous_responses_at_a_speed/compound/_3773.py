...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ConnectorCompoundSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConnectorCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ConnectorCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ConnectorCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ConnectorCompoundSteadyStateSynchronousResponseAtASpeed"
...
class ConnectorCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CONNECTOR_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def component_analysis_cases(
        self: "Self",
    ) -> "List[_3641.ConnectorSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConnectorCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConnectorCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ConnectorCompoundSteadyStateSynchronousResponseAtASpeed(self)
