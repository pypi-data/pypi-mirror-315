...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="DatumCompoundModalAnalysisAtASpeed._Cast_DatumCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_DatumCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "DatumCompoundModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundModalAnalysisAtASpeed(_5399.ComponentCompoundModalAnalysisAtASpeed):
    """DatumCompoundModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _DATUM_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5293.DatumModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_DatumCompoundModalAnalysisAtASpeed
        """
        return _Cast_DatumCompoundModalAnalysisAtASpeed(self)
