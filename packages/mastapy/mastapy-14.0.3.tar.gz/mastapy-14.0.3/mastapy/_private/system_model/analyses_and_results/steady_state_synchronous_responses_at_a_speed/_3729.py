...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassSteadyStateSynchronousResponseAtASpeed._Cast_UnbalancedMassSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_UnbalancedMassSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "UnbalancedMassSteadyStateSynchronousResponseAtASpeed"
...
class UnbalancedMassSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _UNBALANCED_MASS_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_UnbalancedMassSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_UnbalancedMassSteadyStateSynchronousResponseAtASpeed(self)
