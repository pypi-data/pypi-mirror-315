...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PointLoadSteadyStateSynchronousResponseAtASpeed._Cast_PointLoadSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_PointLoadSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "PointLoadSteadyStateSynchronousResponseAtASpeed"
...
class PointLoadSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _POINT_LOAD_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PointLoadSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PointLoadSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_PointLoadSteadyStateSynchronousResponseAtASpeed(self)
