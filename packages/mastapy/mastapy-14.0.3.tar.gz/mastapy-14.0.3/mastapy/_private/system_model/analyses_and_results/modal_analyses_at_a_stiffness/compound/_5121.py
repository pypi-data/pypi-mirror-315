...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltDriveCompoundModalAnalysisAtAStiffness._Cast_BeltDriveCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_BeltDriveCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "BeltDriveCompoundModalAnalysisAtAStiffness"
...
class BeltDriveCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _BELT_DRIVE_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4988.BeltDriveModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltDriveCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_BeltDriveCompoundModalAnalysisAtAStiffness
        """
        return _Cast_BeltDriveCompoundModalAnalysisAtAStiffness(self)
