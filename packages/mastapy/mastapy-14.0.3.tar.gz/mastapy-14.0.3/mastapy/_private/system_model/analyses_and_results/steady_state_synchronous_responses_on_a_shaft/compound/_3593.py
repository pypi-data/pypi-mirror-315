...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft._Cast_TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft"
...
class TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3464.TorqueConverterSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft(self)
