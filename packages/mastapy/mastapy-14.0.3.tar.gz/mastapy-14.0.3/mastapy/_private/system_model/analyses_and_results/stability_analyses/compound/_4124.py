...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterConnectionCompoundStabilityAnalysis._Cast_TorqueConverterConnectionCompoundStabilityAnalysis",
    )
...
class _Cast_TorqueConverterConnectionCompoundStabilityAnalysis:
    ...
    __parent__: "TorqueConverterConnectionCompoundStabilityAnalysis"
...
class TorqueConverterConnectionCompoundStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_CONNECTION_COMPOUND_STABILITY_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3992.TorqueConverterConnectionStabilityAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterConnectionCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterConnectionCompoundStabilityAnalysis
        """
        return _Cast_TorqueConverterConnectionCompoundStabilityAnalysis(self)
