...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearCompoundPowerFlow(_4336.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self: "Self") -> "_385.WormGearDutyCycleRating":
    ...
    @property
    def worm_gear_duty_cycle_rating(self: "Self") -> "_385.WormGearDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearDutyCycleRating
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4273.WormGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4273.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
