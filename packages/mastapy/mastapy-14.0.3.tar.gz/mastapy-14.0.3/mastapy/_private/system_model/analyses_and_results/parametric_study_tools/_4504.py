...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.convergence import _1626
    from mastapy._private.system_model import _2260, _2265
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: "Self", value: "_6970.AnalysisType") -> None:
    ...
    @property
    def parametric_study_type(self: "Self") -> "_7082.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7082",
            "ParametricStudyType",
        )(value)

    @parametric_study_type.setter
    @enforce_parameter_types
    def parametric_study_type(self: "Self", value: "_7082.ParametricStudyType") -> None:
    ...
    @property
    def external_full_fe_loader(self: "Self") -> "_2265.ExternalFullFELoader":
    ...
    @property
    def step_results(self: "Self") -> "List[_4506.ParametricStudyToolStepResult]":
    ...
    @property
    def study_variables(self: "Self") -> "List[_4507.ParametricStudyVariable]":
    ...
    def parametric_study_logging_variables(
        self: "Self",
    ) -> "List[_2737.AnalysisCaseVariable]":
    ...
    def add_logging_variable(
        self: "Self", design_entity: "_2260.DesignEntity", path: "List[str]"
    ) -> "_2737.AnalysisCaseVariable":
    ...
    def move_study_variable_down(
        self: "Self", study_variable: "_4507.ParametricStudyVariable"
    ) -> None:
        """Method does not return.
    ...
    def remove_logging_variable(
        self: "Self", analysis_variable: "_2737.AnalysisCaseVariable"
    ) -> None:
        """Method does not return.
