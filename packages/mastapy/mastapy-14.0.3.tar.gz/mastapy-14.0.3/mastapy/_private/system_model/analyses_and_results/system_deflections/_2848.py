...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshSystemDeflection(_2856.InterMountableComponentConnectionSystemDeflection):
    """GearMeshSystemDeflection
    ...
    @property
    def gear_a(self: "Self") -> "_2850.GearSystemDeflection":
    ...
    @property
    def gear_b(self: "Self") -> "_2850.GearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.GearSystemDeflection
    ...
    @property
    def mesh_separations(self: "Self") -> "List[_2870.MeshSeparationsAtFaceWidth]":
    ...
    @property
    def gear_set(self: "Self") -> "_2849.GearSetSystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4202.GearMeshPowerFlow":
