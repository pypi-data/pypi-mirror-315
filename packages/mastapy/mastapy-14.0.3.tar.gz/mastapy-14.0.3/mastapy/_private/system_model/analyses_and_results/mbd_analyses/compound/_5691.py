...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis._Cast_ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis"
...
class ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_HALF_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5536.ConceptCouplingHalfMultibodyDynamicsAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_ConceptCouplingHalfCompoundMultibodyDynamicsAnalysis(self)
