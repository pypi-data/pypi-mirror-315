...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="RingPinsCompoundPowerFlow._Cast_RingPinsCompoundPowerFlow"
    )
...
class _Cast_RingPinsCompoundPowerFlow:
    ...
    __parent__: "RingPinsCompoundPowerFlow"
    ...
    @property
    def ring_pins_compound_power_flow(self: "CastSelf") -> "RingPinsCompoundPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPinsCompoundPowerFlow(_4357.MountableComponentCompoundPowerFlow):
    """RingPinsCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _RING_PINS_COMPOUND_POWER_FLOW
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4237.RingPinsPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4237.RingPinsPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RingPinsPowerFlow]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_RingPinsCompoundPowerFlow
        """
        return _Cast_RingPinsCompoundPowerFlow(self)
