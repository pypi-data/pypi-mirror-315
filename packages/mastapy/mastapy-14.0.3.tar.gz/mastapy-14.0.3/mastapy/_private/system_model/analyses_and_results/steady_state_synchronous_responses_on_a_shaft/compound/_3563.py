...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft._Cast_PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft"
...
class PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _POWER_LOAD_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3431.PowerLoadSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft(self)
