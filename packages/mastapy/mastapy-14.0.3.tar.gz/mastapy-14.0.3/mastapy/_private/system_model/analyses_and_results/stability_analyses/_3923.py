...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3928
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshStabilityAnalysis._Cast_FaceGearMeshStabilityAnalysis",
    )
...
class _Cast_FaceGearMeshStabilityAnalysis:
    ...
    __parent__: "FaceGearMeshStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMeshStabilityAnalysis(_3928.GearMeshStabilityAnalysis):
    """FaceGearMeshStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FACE_GEAR_MESH_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearMeshStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshStabilityAnalysis
        """
        return _Cast_FaceGearMeshStabilityAnalysis(self)
