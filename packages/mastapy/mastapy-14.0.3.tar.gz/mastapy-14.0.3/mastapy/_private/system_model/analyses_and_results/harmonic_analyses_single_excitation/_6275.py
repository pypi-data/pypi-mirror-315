...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearHarmonicAnalysisOfSingleExcitation._Cast_WormGearHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_WormGearHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "WormGearHarmonicAnalysisOfSingleExcitation"
...
class WormGearHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _WORM_GEAR_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_WormGearHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_WormGearHarmonicAnalysisOfSingleExcitation(self)
