...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyCriticalSpeedAnalysis._Cast_FlexiblePinAssemblyCriticalSpeedAnalysis",
    )
...
class _Cast_FlexiblePinAssemblyCriticalSpeedAnalysis:
    ...
    __parent__: "FlexiblePinAssemblyCriticalSpeedAnalysis"
...
class FlexiblePinAssemblyCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _FLEXIBLE_PIN_ASSEMBLY_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FlexiblePinAssemblyCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyCriticalSpeedAnalysis
        """
        return _Cast_FlexiblePinAssemblyCriticalSpeedAnalysis(self)
