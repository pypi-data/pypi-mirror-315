...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltCompoundSteadyStateSynchronousResponseAtASpeed._Cast_BoltCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_BoltCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "BoltCompoundSteadyStateSynchronousResponseAtASpeed"
...
class BoltCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _BOLT_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3625.BoltSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BoltCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_BoltCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_BoltCompoundSteadyStateSynchronousResponseAtASpeed(self)
