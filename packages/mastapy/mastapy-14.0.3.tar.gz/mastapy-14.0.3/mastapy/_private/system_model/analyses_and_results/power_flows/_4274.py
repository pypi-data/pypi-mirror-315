...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetPowerFlow(_4204.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4273.WormGearPowerFlow]":
    ...
    @property
    def worm_gears_power_flow(self: "Self") -> "List[_4273.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4272.WormGearMeshPowerFlow]":
    ...
    @property
    def worm_meshes_power_flow(self: "Self") -> "List[_4272.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
