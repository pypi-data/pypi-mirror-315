...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_ClutchHalfCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_ClutchHalfCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "ClutchHalfCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class ClutchHalfCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _CLUTCH_HALF_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7188.ClutchHalfAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchHalfCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_ClutchHalfCompoundAdvancedTimeSteppingAnalysisForModulation(self)
