...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft._Cast_PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft"
...
class PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _PLANET_CARRIER_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3429.PlanetCarrierSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft(self)
