...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="OilSealAdvancedTimeSteppingAnalysisForModulation._Cast_OilSealAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_OilSealAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "OilSealAdvancedTimeSteppingAnalysisForModulation"
...
class OilSealAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = _OIL_SEAL_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    ...
    @property
    def component_load_case(self: "Self") -> "_7081.OilSealLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2875.OilSealSystemDeflection":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_OilSealAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_OilSealAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_OilSealAdvancedTimeSteppingAnalysisForModulation(self)
