...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool._Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool",
    )
...
class _Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool:
    ...
    __parent__: "KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool"
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4488.KlingelnbergCycloPalloidSpiralBevelGearMeshParametricStudyTool]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool
        """
        return _Cast_KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool(
            self
        )
