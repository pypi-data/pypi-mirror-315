...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearCompoundModalAnalysis._Cast_CylindricalGearCompoundModalAnalysis",
    )
...
class _Cast_CylindricalGearCompoundModalAnalysis:
    ...
    __parent__: "CylindricalGearCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearCompoundModalAnalysis(_4905.GearCompoundModalAnalysis):
    """CylindricalGearCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_COMPOUND_MODAL_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4738.CylindricalGearModalAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearCompoundModalAnalysis
        """
        return _Cast_CylindricalGearCompoundModalAnalysis(self)
