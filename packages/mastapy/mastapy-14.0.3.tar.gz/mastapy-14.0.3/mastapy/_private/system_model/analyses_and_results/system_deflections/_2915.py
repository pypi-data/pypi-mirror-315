...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserSystemDeflection(_2897.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4263.SynchroniserPowerFlow":
    ...
    @property
    def cones(self: "Self") -> "List[_2912.SynchroniserHalfSystemDeflection]":
