...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMeshSteadyStateSynchronousResponse._Cast_ZerolBevelGearMeshSteadyStateSynchronousResponse",
    )
...
class _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponse:
    ...
    __parent__: "ZerolBevelGearMeshSteadyStateSynchronousResponse"
...
class ZerolBevelGearMeshSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearMeshSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponse
        """
        return _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponse(self)
