...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperModalAnalysisAtAStiffness._Cast_SpringDamperModalAnalysisAtAStiffness",
    )
...
class _Cast_SpringDamperModalAnalysisAtAStiffness:
    ...
    __parent__: "SpringDamperModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperModalAnalysisAtAStiffness(_5017.CouplingModalAnalysisAtAStiffness):
    """SpringDamperModalAnalysisAtAStiffness

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperModalAnalysisAtAStiffness
        """
        return _Cast_SpringDamperModalAnalysisAtAStiffness(self)
