...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCompoundParametricStudyTool._Cast_ClutchHalfCompoundParametricStudyTool",
    )
...
class _Cast_ClutchHalfCompoundParametricStudyTool:
    ...
    __parent__: "ClutchHalfCompoundParametricStudyTool"
...
class ClutchHalfCompoundParametricStudyTool(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_HALF_COMPOUND_PARAMETRIC_STUDY_TOOL
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_6986.ClutchHalfLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4431.ClutchHalfParametricStudyTool]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfCompoundParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCompoundParametricStudyTool
        """
        return _Cast_ClutchHalfCompoundParametricStudyTool(self)
