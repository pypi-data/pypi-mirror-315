...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed._Cast_PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed"
...
class PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _PLANETARY_GEAR_SET_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed(self)
