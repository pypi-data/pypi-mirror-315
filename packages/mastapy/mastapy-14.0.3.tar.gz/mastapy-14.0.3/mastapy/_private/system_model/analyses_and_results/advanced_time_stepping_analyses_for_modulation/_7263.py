...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftAdvancedTimeSteppingAnalysisForModulation._Cast_ShaftAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_ShaftAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "ShaftAdvancedTimeSteppingAnalysisForModulation"
...
class ShaftAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = _SHAFT_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    ...
    @property
    def component_load_case(self: "Self") -> "_7105.ShaftLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2895.ShaftSystemDeflection":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ShaftAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_ShaftAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_ShaftAdvancedTimeSteppingAnalysisForModulation(self)
