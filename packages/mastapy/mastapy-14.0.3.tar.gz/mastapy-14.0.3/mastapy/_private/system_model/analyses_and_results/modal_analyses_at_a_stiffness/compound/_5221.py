...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearCompoundModalAnalysisAtAStiffness._Cast_StraightBevelGearCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_StraightBevelGearCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "StraightBevelGearCompoundModalAnalysisAtAStiffness"
...
class StraightBevelGearCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5091.StraightBevelGearModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearCompoundModalAnalysisAtAStiffness
        """
        return _Cast_StraightBevelGearCompoundModalAnalysisAtAStiffness(self)
