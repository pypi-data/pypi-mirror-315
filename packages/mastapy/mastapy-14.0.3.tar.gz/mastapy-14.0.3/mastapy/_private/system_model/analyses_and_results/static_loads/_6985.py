...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchConnectionLoadCase(_7004.CouplingConnectionLoadCase):
    """ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self: "Self") -> "_1585.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def clutch_pressures(self: "Self", value: "_1585.Vector2DListAccessor") -> None:
