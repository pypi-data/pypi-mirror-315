...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsCompoundSystemDeflection._Cast_RingPinsCompoundSystemDeflection",
    )
...
class _Cast_RingPinsCompoundSystemDeflection:
    ...
    __parent__: "RingPinsCompoundSystemDeflection"
...
class RingPinsCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_COMPOUND_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2885.RingPinsSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_RingPinsCompoundSystemDeflection
        """
        return _Cast_RingPinsCompoundSystemDeflection(self)
