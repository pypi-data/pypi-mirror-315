...
_STRAIGHT_BEVEL_DIFF_GEAR_MESH_HARMONIC_ANALYSIS = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="StraightBevelDiffGearMeshHarmonicAnalysis")
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearMeshHarmonicAnalysis._Cast_StraightBevelDiffGearMeshHarmonicAnalysis",
    )
...
class _Cast_StraightBevelDiffGearMeshHarmonicAnalysis:
    """Special nested class for casting StraightBevelDiffGearMeshHarmonicAnalysis to subclasses."""

    __parent__: "StraightBevelDiffGearMeshHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearMeshHarmonicAnalysis(_5832.BevelGearMeshHarmonicAnalysis):
    """StraightBevelDiffGearMeshHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_DIFF_GEAR_MESH_HARMONIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelDiffGearMeshHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearMeshHarmonicAnalysis
        """
        return _Cast_StraightBevelDiffGearMeshHarmonicAnalysis(self)
