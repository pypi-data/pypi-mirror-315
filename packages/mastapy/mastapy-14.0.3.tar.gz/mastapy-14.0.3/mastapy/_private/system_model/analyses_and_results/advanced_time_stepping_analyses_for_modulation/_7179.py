...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self",
        bound="BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation",
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation._Cast_BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation"
...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation":
