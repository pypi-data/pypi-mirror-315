...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearCompoundSteadyStateSynchronousResponse._Cast_FaceGearCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_FaceGearCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "FaceGearCompoundSteadyStateSynchronousResponse"
...
class FaceGearCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3132.FaceGearSteadyStateSynchronousResponse]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_FaceGearCompoundSteadyStateSynchronousResponse
        """
        return _Cast_FaceGearCompoundSteadyStateSynchronousResponse(self)
