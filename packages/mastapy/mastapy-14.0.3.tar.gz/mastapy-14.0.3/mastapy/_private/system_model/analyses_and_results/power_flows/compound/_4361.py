...
_PART_TO_PART_SHEAR_COUPLING_CONNECTION_COMPOUND_POWER_FLOW = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="PartToPartShearCouplingConnectionCompoundPowerFlow")
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingConnectionCompoundPowerFlow._Cast_PartToPartShearCouplingConnectionCompoundPowerFlow",
    )
...
class _Cast_PartToPartShearCouplingConnectionCompoundPowerFlow:
    ...
    __parent__: "PartToPartShearCouplingConnectionCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartToPartShearCouplingConnectionCompoundPowerFlow(
    _4316.CouplingConnectionCompoundPowerFlow
):
    """PartToPartShearCouplingConnectionCompoundPowerFlow
    ...
    TYPE: ClassVar["Type"] = _PART_TO_PART_SHEAR_COUPLING_CONNECTION_COMPOUND_POWER_FLOW
    ...
    @property
    def component_design(self: "Self") -> "_2405.PartToPartShearCouplingConnection":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4226.PartToPartShearCouplingConnectionPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PartToPartShearCouplingConnectionPowerFlow]
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingConnectionCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingConnectionCompoundPowerFlow
        """
        return _Cast_PartToPartShearCouplingConnectionCompoundPowerFlow(self)
