...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft._Cast_SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft"
...
class SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _SPRING_DAMPER_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3448.SpringDamperSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft(self)
