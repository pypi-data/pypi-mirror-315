...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness._Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness",
    )
...
class _Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness:
    ...
    __parent__: "KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness"
...
class KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness(
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness
        """
        return _Cast_KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness(self)
