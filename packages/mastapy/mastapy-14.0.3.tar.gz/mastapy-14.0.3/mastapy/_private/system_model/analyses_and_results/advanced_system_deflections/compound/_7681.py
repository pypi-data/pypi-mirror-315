...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserCompoundAdvancedSystemDeflection._Cast_SynchroniserCompoundAdvancedSystemDeflection",
    )
...
class _Cast_SynchroniserCompoundAdvancedSystemDeflection:
    ...
    __parent__: "SynchroniserCompoundAdvancedSystemDeflection"
...
class SynchroniserCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7549.SynchroniserAdvancedSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserCompoundAdvancedSystemDeflection
        """
        return _Cast_SynchroniserCompoundAdvancedSystemDeflection(self)
