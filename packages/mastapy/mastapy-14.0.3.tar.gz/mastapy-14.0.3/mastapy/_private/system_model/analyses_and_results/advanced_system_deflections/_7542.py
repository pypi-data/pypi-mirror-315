...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearMeshAdvancedSystemDeflection._Cast_StraightBevelDiffGearMeshAdvancedSystemDeflection",
    )
...
class _Cast_StraightBevelDiffGearMeshAdvancedSystemDeflection:
    ...
    __parent__: "StraightBevelDiffGearMeshAdvancedSystemDeflection"
...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_DIFF_GEAR_MESH_ADVANCED_SYSTEM_DEFLECTION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelDiffGearMeshAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearMeshAdvancedSystemDeflection
        """
        return _Cast_StraightBevelDiffGearMeshAdvancedSystemDeflection(self)
