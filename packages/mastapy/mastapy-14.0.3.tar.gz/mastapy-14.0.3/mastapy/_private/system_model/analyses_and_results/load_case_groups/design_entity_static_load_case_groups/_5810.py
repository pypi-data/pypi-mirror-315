...
TConnection = TypeVar("TConnection", bound="_2329.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_7002.ConnectionLoadCase"
)
...
class ConnectionStaticLoadCaseGroup(
    _5811.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
