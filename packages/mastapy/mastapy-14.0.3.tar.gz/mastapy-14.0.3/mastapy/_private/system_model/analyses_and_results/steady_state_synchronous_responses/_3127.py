...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="DatumSteadyStateSynchronousResponse._Cast_DatumSteadyStateSynchronousResponse",
    )
...
class _Cast_DatumSteadyStateSynchronousResponse:
    ...
    __parent__: "DatumSteadyStateSynchronousResponse"
...
class DatumSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _DATUM_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_DatumSteadyStateSynchronousResponse
        """
        return _Cast_DatumSteadyStateSynchronousResponse(self)
