...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5801
...
class _Cast_ClutchEngagementStatus:
    ...
    def generic_clutch_engagement_status(
        self: "CastSelf",
    ) -> "_5801.GenericClutchEngagementStatus":
        return self.__parent__._cast(_5801.GenericClutchEngagementStatus)
...
class ClutchEngagementStatus(
    _5801.GenericClutchEngagementStatus[_2399.ClutchConnection]
):
    """ClutchEngagementStatus
