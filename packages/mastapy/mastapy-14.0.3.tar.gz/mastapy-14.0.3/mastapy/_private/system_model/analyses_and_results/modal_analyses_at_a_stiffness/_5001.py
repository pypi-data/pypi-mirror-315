...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchModalAnalysisAtAStiffness._Cast_ClutchModalAnalysisAtAStiffness",
    )
...
class _Cast_ClutchModalAnalysisAtAStiffness:
    ...
    __parent__: "ClutchModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchModalAnalysisAtAStiffness(_5017.CouplingModalAnalysisAtAStiffness):
    """ClutchModalAnalysisAtAStiffness

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_ClutchModalAnalysisAtAStiffness
        """
        return _Cast_ClutchModalAnalysisAtAStiffness(self)
