...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyCompoundModalAnalysisAtAStiffness._Cast_CycloidalAssemblyCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_CycloidalAssemblyCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "CycloidalAssemblyCompoundModalAnalysisAtAStiffness"
...
class CycloidalAssemblyCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CycloidalAssemblyCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyCompoundModalAnalysisAtAStiffness
        """
        return _Cast_CycloidalAssemblyCompoundModalAnalysisAtAStiffness(self)
