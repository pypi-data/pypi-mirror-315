...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperCompoundSystemDeflection._Cast_SpringDamperCompoundSystemDeflection",
    )
...
class _Cast_SpringDamperCompoundSystemDeflection:
    ...
    __parent__: "SpringDamperCompoundSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperCompoundSystemDeflection(_2979.CouplingCompoundSystemDeflection):
    """SpringDamperCompoundSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_COMPOUND_SYSTEM_DEFLECTION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2903.SpringDamperSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperCompoundSystemDeflection
        """
        return _Cast_SpringDamperCompoundSystemDeflection(self)
