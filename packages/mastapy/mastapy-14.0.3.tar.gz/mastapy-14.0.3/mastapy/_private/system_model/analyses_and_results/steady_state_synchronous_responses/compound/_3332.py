...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpCompoundSteadyStateSynchronousResponse._Cast_TorqueConverterPumpCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_TorqueConverterPumpCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "TorqueConverterPumpCompoundSteadyStateSynchronousResponse"
...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_PUMP_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3200.TorqueConverterPumpSteadyStateSynchronousResponse]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterPumpCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpCompoundSteadyStateSynchronousResponse
        """
        return _Cast_TorqueConverterPumpCompoundSteadyStateSynchronousResponse(self)
