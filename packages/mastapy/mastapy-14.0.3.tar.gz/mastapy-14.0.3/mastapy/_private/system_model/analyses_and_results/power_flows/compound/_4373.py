...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingConnectionCompoundPowerFlow._Cast_RollingRingConnectionCompoundPowerFlow",
    )
...
class _Cast_RollingRingConnectionCompoundPowerFlow:
    ...
    __parent__: "RollingRingConnectionCompoundPowerFlow"
...
class RollingRingConnectionCompoundPowerFlow(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_CONNECTION_COMPOUND_POWER_FLOW
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4240.RollingRingConnectionPowerFlow]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingConnectionCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_RollingRingConnectionCompoundPowerFlow
        """
        return _Cast_RollingRingConnectionCompoundPowerFlow(self)
