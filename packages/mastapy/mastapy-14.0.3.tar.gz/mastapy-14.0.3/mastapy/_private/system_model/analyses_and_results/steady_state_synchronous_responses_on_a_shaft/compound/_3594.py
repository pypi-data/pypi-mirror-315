...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft._Cast_TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_CONNECTION_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3462.TorqueConverterConnectionSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        ...
        "_Cast_TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft"
    ):
        ...
        Returns:
            _Cast_TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_TorqueConverterConnectionCompoundSteadyStateSynchronousResponseOnAShaft(
            self
        )
