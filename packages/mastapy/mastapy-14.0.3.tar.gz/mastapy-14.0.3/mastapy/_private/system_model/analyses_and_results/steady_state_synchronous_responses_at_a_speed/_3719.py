...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed._Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed"
...
class StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_PLANET_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_StraightBevelPlanetGearSteadyStateSynchronousResponseAtASpeed(self)
