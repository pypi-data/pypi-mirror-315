...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ResultLocationSelectionGroup._Cast_ResultLocationSelectionGroup",
    )
...
class _Cast_ResultLocationSelectionGroup:
    ...
    __parent__: "ResultLocationSelectionGroup"
...
class ResultLocationSelectionGroup(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _RESULT_LOCATION_SELECTION_GROUP
    ...
    @property
    def response_locations(self: "Self") -> "List[_5991.ResultNodeSelection]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.results.ResultNodeSelection]

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "ResponseLocations")
    ...
    def remove_nodes(self: "Self") -> None:
        """Method does not return."""
        pythonnet_method_call(self.wrapped, "RemoveNodes")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ResultLocationSelectionGroup":
        """Cast to another type.

        Returns:
            _Cast_ResultLocationSelectionGroup
        """
        return _Cast_ResultLocationSelectionGroup(self)
