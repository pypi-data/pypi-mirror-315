...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentHarmonicAnalysis(_5926.PartHarmonicAnalysis):
    """ComponentHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4714.ComponentModalAnalysis":
    ...
    @property
    def results(self: "Self") -> "_6003.HarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2804.ComponentSystemDeflection":
