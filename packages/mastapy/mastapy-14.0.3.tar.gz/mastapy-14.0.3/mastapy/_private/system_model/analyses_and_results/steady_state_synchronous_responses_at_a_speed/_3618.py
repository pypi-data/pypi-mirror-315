...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed._Cast_BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed"
...
class BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_BevelDifferentialGearSteadyStateSynchronousResponseAtASpeed(self)
