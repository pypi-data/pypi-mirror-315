...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetHarmonicAnalysis(_5894.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: "Self") -> "List[_5976.WormGearHarmonicAnalysis]":
    ...
    def worm_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_5976.WormGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.WormGearHarmonicAnalysis]
