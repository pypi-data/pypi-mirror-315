...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSetCompoundPowerFlow(_4296.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4154.BevelDifferentialGearSetPowerFlow]":
    ...
    def bevel_differential_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4289.BevelDifferentialGearCompoundPowerFlow]":
    ...
    def bevel_differential_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4290.BevelDifferentialGearMeshCompoundPowerFlow]":
