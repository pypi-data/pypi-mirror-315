...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearSteadyStateSynchronousResponseOnAShaft._Cast_FaceGearSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_FaceGearSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "FaceGearSteadyStateSynchronousResponseOnAShaft"
...
class FaceGearSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_FaceGearSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_FaceGearSteadyStateSynchronousResponseOnAShaft(self)
