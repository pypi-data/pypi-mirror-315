...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MassDiscCompoundStabilityAnalysis._Cast_MassDiscCompoundStabilityAnalysis",
    )
...
class _Cast_MassDiscCompoundStabilityAnalysis:
    ...
    __parent__: "MassDiscCompoundStabilityAnalysis"
...
class MassDiscCompoundStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = _MASS_DISC_COMPOUND_STABILITY_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3945.MassDiscStabilityAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MassDiscCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MassDiscCompoundStabilityAnalysis
        """
        return _Cast_MassDiscCompoundStabilityAnalysis(self)
