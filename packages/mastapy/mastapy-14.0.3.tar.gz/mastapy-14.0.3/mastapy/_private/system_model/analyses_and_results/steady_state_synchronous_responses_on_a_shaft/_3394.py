...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ExternalCADModelSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelSteadyStateSynchronousResponseOnAShaft._Cast_ExternalCADModelSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_ExternalCADModelSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "ExternalCADModelSteadyStateSynchronousResponseOnAShaft"
...
class ExternalCADModelSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _EXTERNAL_CAD_MODEL_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ExternalCADModelSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_ExternalCADModelSteadyStateSynchronousResponseOnAShaft(self)
