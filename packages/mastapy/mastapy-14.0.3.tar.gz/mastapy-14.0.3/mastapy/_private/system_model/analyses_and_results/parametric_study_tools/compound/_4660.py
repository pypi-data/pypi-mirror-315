...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearMeshCompoundParametricStudyTool._Cast_SpiralBevelGearMeshCompoundParametricStudyTool",
    )
...
class _Cast_SpiralBevelGearMeshCompoundParametricStudyTool:
    ...
    __parent__: "SpiralBevelGearMeshCompoundParametricStudyTool"
...
class SpiralBevelGearMeshCompoundParametricStudyTool(
    ...
    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_MESH_COMPOUND_PARAMETRIC_STUDY_TOOL
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4528.SpiralBevelGearMeshParametricStudyTool]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpiralBevelGearMeshCompoundParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearMeshCompoundParametricStudyTool
        """
        return _Cast_SpiralBevelGearMeshCompoundParametricStudyTool(self)
