...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="DatumCompoundModalAnalysisAtAStiffness._Cast_DatumCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_DatumCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "DatumCompoundModalAnalysisAtAStiffness"
...
class DatumCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _DATUM_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5029.DatumModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_DatumCompoundModalAnalysisAtAStiffness
        """
        return _Cast_DatumCompoundModalAnalysisAtAStiffness(self)
