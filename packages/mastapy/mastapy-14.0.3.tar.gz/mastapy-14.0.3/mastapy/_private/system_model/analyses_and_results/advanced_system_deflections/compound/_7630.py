...
class HypoidGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7497.HypoidGearSetAdvancedSystemDeflection]":
    ...
    def hypoid_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7628.HypoidGearCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7629.HypoidGearMeshCompoundAdvancedSystemDeflection]":
