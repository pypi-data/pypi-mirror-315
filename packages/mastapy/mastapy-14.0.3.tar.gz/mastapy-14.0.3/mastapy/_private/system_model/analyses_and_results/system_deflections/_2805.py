...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ConcentricPartGroupCombinationSystemDeflectionResults"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConcentricPartGroupCombinationSystemDeflectionResults._Cast_ConcentricPartGroupCombinationSystemDeflectionResults",
    )
...
class _Cast_ConcentricPartGroupCombinationSystemDeflectionResults:
    ...
    __parent__: "ConcentricPartGroupCombinationSystemDeflectionResults"
...
class ConcentricPartGroupCombinationSystemDeflectionResults(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = (
        _CONCENTRIC_PART_GROUP_COMBINATION_SYSTEM_DEFLECTION_RESULTS
    )
    ...
    def shaft_deflections_in_view_coordinate_system(
        self: "Self",
    ) -> "List[_2302.ConcentricPartGroupCombinationSystemDeflectionShaftResults]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "ShaftDeflectionsInViewCoordinateSystem"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConcentricPartGroupCombinationSystemDeflectionResults":
        """Cast to another type.

        Returns:
            _Cast_ConcentricPartGroupCombinationSystemDeflectionResults
        """
        return _Cast_ConcentricPartGroupCombinationSystemDeflectionResults(self)
