...
class _Cast_FlexiblePinAnalysisStopStartAnalysis:
    ...
    @property
    def flexible_pin_analysis(self: "CastSelf") -> "_6413.FlexiblePinAnalysis":
        return self.__parent__._cast(_6413.FlexiblePinAnalysis)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FlexiblePinAnalysisStopStartAnalysis(_6413.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self: "Self") -> "_2895.ShaftSystemDeflection":
    ...
    @property
    def shaft_nominal_load_case(self: "Self") -> "_2895.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
