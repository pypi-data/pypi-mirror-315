...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingSteadyStateSynchronousResponseOnAShaft._Cast_RollingRingSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_RollingRingSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "RollingRingSteadyStateSynchronousResponseOnAShaft"
...
class RollingRingSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RollingRingSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_RollingRingSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_RollingRingSteadyStateSynchronousResponseOnAShaft(self)
