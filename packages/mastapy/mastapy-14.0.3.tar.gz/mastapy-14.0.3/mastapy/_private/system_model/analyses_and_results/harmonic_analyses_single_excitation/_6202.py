...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshHarmonicAnalysisOfSingleExcitation._Cast_FaceGearMeshHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_FaceGearMeshHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "FaceGearMeshHarmonicAnalysisOfSingleExcitation"
...
class FaceGearMeshHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_MESH_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearMeshHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_FaceGearMeshHarmonicAnalysisOfSingleExcitation(self)
