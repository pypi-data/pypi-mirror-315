...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BearingCompoundAdvancedSystemDeflection._Cast_BearingCompoundAdvancedSystemDeflection",
    )
...
class _Cast_BearingCompoundAdvancedSystemDeflection:
    ...
    __parent__: "BearingCompoundAdvancedSystemDeflection"
...
class BearingCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _BEARING_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7439.BearingAdvancedSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BearingCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_BearingCompoundAdvancedSystemDeflection
        """
        return _Cast_BearingCompoundAdvancedSystemDeflection(self)
