...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelGearMeshHarmonicAnalysisOfSingleExcitation._Cast_BevelGearMeshHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_BevelGearMeshHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "BevelGearMeshHarmonicAnalysisOfSingleExcitation"
...
class BevelGearMeshHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _BEVEL_GEAR_MESH_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelGearMeshHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_BevelGearMeshHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_BevelGearMeshHarmonicAnalysisOfSingleExcitation(self)
