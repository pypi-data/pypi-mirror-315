...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_TURBINE_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7288.TorqueConverterTurbineAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        ...
        "_Cast_TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation"
    ):
        ...
        Returns:
            _Cast_TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_TorqueConverterTurbineCompoundAdvancedTimeSteppingAnalysisForModulation(
            self
        )
