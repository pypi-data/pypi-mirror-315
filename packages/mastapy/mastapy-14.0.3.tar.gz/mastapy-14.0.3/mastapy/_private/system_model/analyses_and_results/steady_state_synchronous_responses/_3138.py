...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="GuideDxfModelSteadyStateSynchronousResponse._Cast_GuideDxfModelSteadyStateSynchronousResponse",
    )
...
class _Cast_GuideDxfModelSteadyStateSynchronousResponse:
    ...
    __parent__: "GuideDxfModelSteadyStateSynchronousResponse"
...
class GuideDxfModelSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _GUIDE_DXF_MODEL_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_GuideDxfModelSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_GuideDxfModelSteadyStateSynchronousResponse
        """
        return _Cast_GuideDxfModelSteadyStateSynchronousResponse(self)
