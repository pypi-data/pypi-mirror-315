...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassSteadyStateSynchronousResponse._Cast_UnbalancedMassSteadyStateSynchronousResponse",
    )
...
class _Cast_UnbalancedMassSteadyStateSynchronousResponse:
    ...
    __parent__: "UnbalancedMassSteadyStateSynchronousResponse"
...
class UnbalancedMassSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_UnbalancedMassSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassSteadyStateSynchronousResponse
        """
        return _Cast_UnbalancedMassSteadyStateSynchronousResponse(self)
