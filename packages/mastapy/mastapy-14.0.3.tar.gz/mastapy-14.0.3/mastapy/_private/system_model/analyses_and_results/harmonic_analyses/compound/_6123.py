...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfCompoundHarmonicAnalysis._Cast_SpringDamperHalfCompoundHarmonicAnalysis",
    )
...
class _Cast_SpringDamperHalfCompoundHarmonicAnalysis:
    ...
    __parent__: "SpringDamperHalfCompoundHarmonicAnalysis"
...
class SpringDamperHalfCompoundHarmonicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_COMPOUND_HARMONIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5954.SpringDamperHalfHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHalfCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfCompoundHarmonicAnalysis
        """
        return _Cast_SpringDamperHalfCompoundHarmonicAnalysis(self)
