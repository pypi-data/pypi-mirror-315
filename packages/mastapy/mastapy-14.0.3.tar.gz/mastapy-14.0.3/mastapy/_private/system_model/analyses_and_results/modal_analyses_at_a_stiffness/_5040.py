...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="GuideDxfModelModalAnalysisAtAStiffness._Cast_GuideDxfModelModalAnalysisAtAStiffness",
    )
...
class _Cast_GuideDxfModelModalAnalysisAtAStiffness:
    ...
    __parent__: "GuideDxfModelModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GuideDxfModelModalAnalysisAtAStiffness(_5003.ComponentModalAnalysisAtAStiffness):
    """GuideDxfModelModalAnalysisAtAStiffness

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _GUIDE_DXF_MODEL_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_GuideDxfModelModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_GuideDxfModelModalAnalysisAtAStiffness
        """
        return _Cast_GuideDxfModelModalAnalysisAtAStiffness(self)
