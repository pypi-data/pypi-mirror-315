...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHarmonicAnalysis._Cast_SpringDamperHarmonicAnalysis",
    )
...
class _Cast_SpringDamperHarmonicAnalysis:
    ...
    __parent__: "SpringDamperHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperHarmonicAnalysis(_5855.CouplingHarmonicAnalysis):
    """SpringDamperHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HARMONIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHarmonicAnalysis
        """
        return _Cast_SpringDamperHarmonicAnalysis(self)
