...
class _Cast_DesignEntityModalAnalysisGroupResults:
    ...
    def single_excitation_results_modal_analysis(
        self: "CastSelf",
    ) -> "_4845.SingleExcitationResultsModalAnalysis":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.reporting import (
            _4845,
        )

        return self.__parent__._cast(_4845.SingleExcitationResultsModalAnalysis)

    @property
    def single_mode_results(self: "CastSelf") -> "_4846.SingleModeResults":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.reporting import (
            _4846,
        )

        return self.__parent__._cast(_4846.SingleModeResults)
