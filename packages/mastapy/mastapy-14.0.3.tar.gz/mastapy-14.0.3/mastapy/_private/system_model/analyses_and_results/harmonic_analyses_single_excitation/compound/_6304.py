...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation._Cast_ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation"
...
class ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _CLUTCH_HALF_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6170.ClutchHalfHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ClutchHalfCompoundHarmonicAnalysisOfSingleExcitation(self)
