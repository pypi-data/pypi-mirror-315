...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentCompoundSteadyStateSynchronousResponse._Cast_MeasurementComponentCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_MeasurementComponentCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "MeasurementComponentCompoundSteadyStateSynchronousResponse"
...
class MeasurementComponentCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _MEASUREMENT_COMPONENT_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_MeasurementComponentCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentCompoundSteadyStateSynchronousResponse
        """
        return _Cast_MeasurementComponentCompoundSteadyStateSynchronousResponse(self)
