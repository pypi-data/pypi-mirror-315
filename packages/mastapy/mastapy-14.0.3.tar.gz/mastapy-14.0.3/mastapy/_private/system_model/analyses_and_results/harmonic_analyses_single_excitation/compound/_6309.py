...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation._Cast_ConceptCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ConceptCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ConceptCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation"
...
class ConceptCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_HALF_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6175.ConceptCouplingHalfHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ConceptCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(self)
