...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: "Self") -> "_5512.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5512",
            "AnalysisTypes",
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: "Self", value: "_5512.AnalysisTypes") -> None:
    ...
    @enforce_parameter_types
    def include_shaft_and_housing_flexibilities(
        self: "Self", value: "_5616.ShaftAndHousingFlexibilityOption"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def method_to_define_period(
        self: "Self",
    ) -> "_5575.InertiaAdjustedLoadCasePeriodMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5575",
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: "Self", value: "_5575.InertiaAdjustedLoadCasePeriodMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(
        self: "Self", value: "_2532.PowerLoad"
    ) -> None:
        wrapper_type = (
    ...
    def static_load_cases_to_create(
        self: "Self",
    ) -> "_5576.InertiaAdjustedLoadCaseResultsToCreate":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5576",
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: "Self", value: "_5576.InertiaAdjustedLoadCaseResultsToCreate"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def external_interface_options(
        self: "Self",
    ) -> "_5662.DynamicExternalInterfaceOptions":
    ...
    def frequency_response_options(
        self: "Self",
    ) -> "_4751.FrequencyResponseAnalysisOptions":
    ...
    @property
    def run_up_analysis_options(self: "Self") -> "_5592.MBDRunUpAnalysisOptions":
    ...
    @property
    def spline_damping_options(self: "Self") -> "_5625.SplineDampingOptions":
