...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCompoundModalAnalysisAtASpeed._Cast_BoltedJointCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_BoltedJointCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "BoltedJointCompoundModalAnalysisAtASpeed"
...
class BoltedJointCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5261.BoltedJointModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCompoundModalAnalysisAtASpeed
        """
        return _Cast_BoltedJointCompoundModalAnalysisAtASpeed(self)
