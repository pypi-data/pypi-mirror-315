...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterTurbineCompoundSteadyStateSynchronousResponse._Cast_TorqueConverterTurbineCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_TorqueConverterTurbineCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "TorqueConverterTurbineCompoundSteadyStateSynchronousResponse"
...
class TorqueConverterTurbineCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_TURBINE_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3202.TorqueConverterTurbineSteadyStateSynchronousResponse]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterTurbineCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterTurbineCompoundSteadyStateSynchronousResponse
        """
        return _Cast_TorqueConverterTurbineCompoundSteadyStateSynchronousResponse(self)
