...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchCompoundAdvancedSystemDeflection._Cast_ClutchCompoundAdvancedSystemDeflection",
    )
...
class _Cast_ClutchCompoundAdvancedSystemDeflection:
    ...
    __parent__: "ClutchCompoundAdvancedSystemDeflection"
...
class ClutchCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7452.ClutchAdvancedSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ClutchCompoundAdvancedSystemDeflection
        """
        return _Cast_ClutchCompoundAdvancedSystemDeflection(self)
