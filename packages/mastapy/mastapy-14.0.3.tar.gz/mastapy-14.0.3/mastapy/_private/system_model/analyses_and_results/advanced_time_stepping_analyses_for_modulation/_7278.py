...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation._Cast_StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation"
...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_GEAR_SET_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7119.StraightBevelGearSetLoadCase":
    ...
    def straight_bevel_gears_advanced_time_stepping_analysis_for_modulation(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "StraightBevelGearsAdvancedTimeSteppingAnalysisForModulation"
        )
    ...
    def bevel_meshes_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7277.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_meshes_advanced_time_stepping_analysis_for_modulation(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "StraightBevelMeshesAdvancedTimeSteppingAnalysisForModulation"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(self)
