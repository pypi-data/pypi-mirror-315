...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperCompoundModalAnalysisAtASpeed._Cast_SpringDamperCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_SpringDamperCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "SpringDamperCompoundModalAnalysisAtASpeed"
...
class SpringDamperCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5349.SpringDamperModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperCompoundModalAnalysisAtASpeed
        """
        return _Cast_SpringDamperCompoundModalAnalysisAtASpeed(self)
