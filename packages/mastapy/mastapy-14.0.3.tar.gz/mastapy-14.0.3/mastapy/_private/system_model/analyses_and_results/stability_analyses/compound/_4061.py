...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyCompoundStabilityAnalysis._Cast_FlexiblePinAssemblyCompoundStabilityAnalysis",
    )
...
class _Cast_FlexiblePinAssemblyCompoundStabilityAnalysis:
    ...
    __parent__: "FlexiblePinAssemblyCompoundStabilityAnalysis"
...
class FlexiblePinAssemblyCompoundStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = _FLEXIBLE_PIN_ASSEMBLY_COMPOUND_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FlexiblePinAssemblyCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyCompoundStabilityAnalysis
        """
        return _Cast_FlexiblePinAssemblyCompoundStabilityAnalysis(self)
