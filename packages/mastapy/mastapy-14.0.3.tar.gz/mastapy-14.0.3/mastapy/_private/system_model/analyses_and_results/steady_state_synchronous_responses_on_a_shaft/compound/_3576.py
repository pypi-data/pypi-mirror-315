...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self",
        bound="SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft",
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft._Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft"
...
class SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _SPIRAL_BEVEL_GEAR_MESH_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    @property
    def component_design(self: "Self") -> "_2380.SpiralBevelGearMesh":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3443.SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(
            self
        )
