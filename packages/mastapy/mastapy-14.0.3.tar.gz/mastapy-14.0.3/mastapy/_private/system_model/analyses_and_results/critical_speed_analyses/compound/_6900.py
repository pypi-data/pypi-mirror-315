...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MassDiscCompoundCriticalSpeedAnalysis._Cast_MassDiscCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_MassDiscCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "MassDiscCompoundCriticalSpeedAnalysis"
...
class MassDiscCompoundCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _MASS_DISC_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6769.MassDiscCriticalSpeedAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MassDiscCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MassDiscCompoundCriticalSpeedAnalysis
        """
        return _Cast_MassDiscCompoundCriticalSpeedAnalysis(self)
