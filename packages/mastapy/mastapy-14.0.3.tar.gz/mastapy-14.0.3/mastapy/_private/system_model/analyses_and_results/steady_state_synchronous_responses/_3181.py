...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperConnectionSteadyStateSynchronousResponse._Cast_SpringDamperConnectionSteadyStateSynchronousResponse",
    )
...
class _Cast_SpringDamperConnectionSteadyStateSynchronousResponse:
    ...
    __parent__: "SpringDamperConnectionSteadyStateSynchronousResponse"
...
class SpringDamperConnectionSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_CONNECTION_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperConnectionSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperConnectionSteadyStateSynchronousResponse
        """
        return _Cast_SpringDamperConnectionSteadyStateSynchronousResponse(self)
