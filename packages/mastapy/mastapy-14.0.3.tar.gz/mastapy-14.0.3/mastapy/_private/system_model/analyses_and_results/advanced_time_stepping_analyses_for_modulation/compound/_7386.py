...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _POWER_LOAD_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_PowerLoadCompoundAdvancedTimeSteppingAnalysisForModulation(self)
