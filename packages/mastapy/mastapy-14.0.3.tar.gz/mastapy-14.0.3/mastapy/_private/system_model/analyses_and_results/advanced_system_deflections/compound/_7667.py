...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearCompoundAdvancedSystemDeflection._Cast_SpiralBevelGearCompoundAdvancedSystemDeflection",
    )
...
class _Cast_SpiralBevelGearCompoundAdvancedSystemDeflection:
    ...
    __parent__: "SpiralBevelGearCompoundAdvancedSystemDeflection"
...
class SpiralBevelGearCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7535.SpiralBevelGearAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearCompoundAdvancedSystemDeflection
        """
        return _Cast_SpiralBevelGearCompoundAdvancedSystemDeflection(self)
