...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsCompoundHarmonicAnalysisOfSingleExcitation._Cast_RingPinsCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_RingPinsCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "RingPinsCompoundHarmonicAnalysisOfSingleExcitation"
...
class RingPinsCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6241.RingPinsHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RingPinsCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_RingPinsCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_RingPinsCompoundHarmonicAnalysisOfSingleExcitation(self)
