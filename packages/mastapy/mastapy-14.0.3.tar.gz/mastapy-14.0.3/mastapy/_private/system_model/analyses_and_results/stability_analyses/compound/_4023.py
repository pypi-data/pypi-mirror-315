...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltCompoundStabilityAnalysis._Cast_BoltCompoundStabilityAnalysis",
    )
...
class _Cast_BoltCompoundStabilityAnalysis:
    ...
    __parent__: "BoltCompoundStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltCompoundStabilityAnalysis(_4029.ComponentCompoundStabilityAnalysis):
    """BoltCompoundStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLT_COMPOUND_STABILITY_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3888.BoltStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_3888.BoltStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.BoltStabilityAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BoltCompoundStabilityAnalysis
        """
        return _Cast_BoltCompoundStabilityAnalysis(self)
