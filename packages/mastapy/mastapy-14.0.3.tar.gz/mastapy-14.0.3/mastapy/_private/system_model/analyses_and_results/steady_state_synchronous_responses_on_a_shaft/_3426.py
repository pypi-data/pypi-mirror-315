...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft._Cast_PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft"
...
class PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _PART_TO_PART_SHEAR_COUPLING_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft(self)
