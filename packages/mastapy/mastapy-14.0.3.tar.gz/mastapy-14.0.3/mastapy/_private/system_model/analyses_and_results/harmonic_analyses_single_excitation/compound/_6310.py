...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ConceptGearCompoundHarmonicAnalysisOfSingleExcitation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearCompoundHarmonicAnalysisOfSingleExcitation._Cast_ConceptGearCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ConceptGearCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ConceptGearCompoundHarmonicAnalysisOfSingleExcitation"
...
class ConceptGearCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_GEAR_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6177.ConceptGearHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptGearCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ConceptGearCompoundHarmonicAnalysisOfSingleExcitation(self)
