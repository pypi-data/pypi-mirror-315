...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadAdvancedTimeSteppingAnalysisForModulation._Cast_PowerLoadAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_PowerLoadAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "PowerLoadAdvancedTimeSteppingAnalysisForModulation"
...
class PowerLoadAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = _POWER_LOAD_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PowerLoadAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_PowerLoadAdvancedTimeSteppingAnalysisForModulation(self)
