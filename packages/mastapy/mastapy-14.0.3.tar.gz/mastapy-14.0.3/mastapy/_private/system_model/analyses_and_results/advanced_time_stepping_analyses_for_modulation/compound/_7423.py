...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _WORM_GEAR_MESH_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    @property
    def component_design(self: "Self") -> "_2386.WormGearMesh":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_WormGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(self)
