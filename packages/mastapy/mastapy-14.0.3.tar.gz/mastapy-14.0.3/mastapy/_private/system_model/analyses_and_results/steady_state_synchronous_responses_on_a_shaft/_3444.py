...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft._Cast_SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft"
...
class SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _SPIRAL_BEVEL_GEAR_SET_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def bevel_gears_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3445.SpiralBevelGearSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spiral_bevel_gears_steady_state_synchronous_response_on_a_shaft(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "SpiralBevelGearsSteadyStateSynchronousResponseOnAShaft"
        )
    ...
    def spiral_bevel_meshes_steady_state_synchronous_response_on_a_shaft(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "SpiralBevelMeshesSteadyStateSynchronousResponseOnAShaft"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft(self)
