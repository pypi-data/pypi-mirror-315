...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassCompoundModalAnalysisAtAStiffness._Cast_UnbalancedMassCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_UnbalancedMassCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "UnbalancedMassCompoundModalAnalysisAtAStiffness"
...
class UnbalancedMassCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_UnbalancedMassCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassCompoundModalAnalysisAtAStiffness
        """
        return _Cast_UnbalancedMassCompoundModalAnalysisAtAStiffness(self)
