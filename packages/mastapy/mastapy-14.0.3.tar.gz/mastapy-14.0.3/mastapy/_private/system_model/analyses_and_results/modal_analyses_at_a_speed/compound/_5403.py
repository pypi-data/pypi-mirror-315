...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearCompoundModalAnalysisAtASpeed._Cast_ConceptGearCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_ConceptGearCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "ConceptGearCompoundModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearCompoundModalAnalysisAtASpeed(_5432.GearCompoundModalAnalysisAtASpeed):
    """ConceptGearCompoundModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5272.ConceptGearModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearCompoundModalAnalysisAtASpeed
        """
        return _Cast_ConceptGearCompoundModalAnalysisAtASpeed(self)
