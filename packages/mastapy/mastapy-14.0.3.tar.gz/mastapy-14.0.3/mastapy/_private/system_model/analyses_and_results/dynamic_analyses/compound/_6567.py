...
class BevelDifferentialGearSetCompoundDynamicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6434.BevelDifferentialGearSetDynamicAnalysis]":
    ...
    def bevel_differential_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6565.BevelDifferentialGearCompoundDynamicAnalysis]":
    ...
    def bevel_differential_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6566.BevelDifferentialGearMeshCompoundDynamicAnalysis]":
