...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpPowerFlow._Cast_TorqueConverterPumpPowerFlow",
    )
...
class _Cast_TorqueConverterPumpPowerFlow:
    ...
    __parent__: "TorqueConverterPumpPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterPumpPowerFlow(_4179.CouplingHalfPowerFlow):
    """TorqueConverterPumpPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_PUMP_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterPumpPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpPowerFlow
        """
        return _Cast_TorqueConverterPumpPowerFlow(self)
