...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation"
...
class StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_GEAR_MESH_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation(self)
