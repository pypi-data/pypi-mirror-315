...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearModalAnalysisAtAStiffness._Cast_StraightBevelGearModalAnalysisAtAStiffness",
    )
...
class _Cast_StraightBevelGearModalAnalysisAtAStiffness:
    ...
    __parent__: "StraightBevelGearModalAnalysisAtAStiffness"
...
class StraightBevelGearModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelGearModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearModalAnalysisAtAStiffness
        """
        return _Cast_StraightBevelGearModalAnalysisAtAStiffness(self)
