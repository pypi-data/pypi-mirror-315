...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PointLoadCompoundHarmonicAnalysis._Cast_PointLoadCompoundHarmonicAnalysis",
    )
...
class _Cast_PointLoadCompoundHarmonicAnalysis:
    ...
    __parent__: "PointLoadCompoundHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadCompoundHarmonicAnalysis(_6141.VirtualComponentCompoundHarmonicAnalysis):
    """PointLoadCompoundHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POINT_LOAD_COMPOUND_HARMONIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5934.PointLoadHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PointLoadCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PointLoadCompoundHarmonicAnalysis
        """
        return _Cast_PointLoadCompoundHarmonicAnalysis(self)
