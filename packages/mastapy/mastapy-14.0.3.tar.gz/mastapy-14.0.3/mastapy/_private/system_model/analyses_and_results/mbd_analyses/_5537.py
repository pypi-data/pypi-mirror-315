...
from mastapy._private.system_model.analyses_and_results.mbd_analyses import _5548
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingMultibodyDynamicsAnalysis._Cast_ConceptCouplingMultibodyDynamicsAnalysis",
    )
...
class _Cast_ConceptCouplingMultibodyDynamicsAnalysis:
    ...
    __parent__: "ConceptCouplingMultibodyDynamicsAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingMultibodyDynamicsAnalysis(_5548.CouplingMultibodyDynamicsAnalysis):
    """ConceptCouplingMultibodyDynamicsAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptCouplingMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingMultibodyDynamicsAnalysis
        """
        return _Cast_ConceptCouplingMultibodyDynamicsAnalysis(self)
