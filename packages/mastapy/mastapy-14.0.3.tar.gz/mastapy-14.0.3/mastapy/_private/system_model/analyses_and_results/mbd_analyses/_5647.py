...
from mastapy._private.system_model.analyses_and_results.mbd_analyses import _5648
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassMultibodyDynamicsAnalysis._Cast_UnbalancedMassMultibodyDynamicsAnalysis",
    )
...
class _Cast_UnbalancedMassMultibodyDynamicsAnalysis:
    ...
    __parent__: "UnbalancedMassMultibodyDynamicsAnalysis"
...
class UnbalancedMassMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_UnbalancedMassMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassMultibodyDynamicsAnalysis
        """
        return _Cast_UnbalancedMassMultibodyDynamicsAnalysis(self)
