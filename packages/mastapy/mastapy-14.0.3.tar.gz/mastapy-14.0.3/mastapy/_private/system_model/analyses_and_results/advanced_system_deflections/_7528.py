...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingAssemblyAdvancedSystemDeflection._Cast_RollingRingAssemblyAdvancedSystemDeflection",
    )
...
class _Cast_RollingRingAssemblyAdvancedSystemDeflection:
    ...
    __parent__: "RollingRingAssemblyAdvancedSystemDeflection"
...
class RollingRingAssemblyAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_ASSEMBLY_ADVANCED_SYSTEM_DEFLECTION
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_2888.RollingRingAssemblySystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingAssemblyAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_RollingRingAssemblyAdvancedSystemDeflection
        """
        return _Cast_RollingRingAssemblyAdvancedSystemDeflection(self)
