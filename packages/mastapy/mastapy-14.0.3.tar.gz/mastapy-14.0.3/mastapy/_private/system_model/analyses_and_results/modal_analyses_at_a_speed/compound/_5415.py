...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundModalAnalysisAtASpeed(_5384.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5283.CVTModalAnalysisAtASpeed]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_5283.CVTModalAnalysisAtASpeed]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.CVTModalAnalysisAtASpeed]
