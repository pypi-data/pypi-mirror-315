...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterCriticalSpeedAnalysis._Cast_TorqueConverterCriticalSpeedAnalysis",
    )
...
class _Cast_TorqueConverterCriticalSpeedAnalysis:
    ...
    __parent__: "TorqueConverterCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterCriticalSpeedAnalysis(_6729.CouplingCriticalSpeedAnalysis):
    """TorqueConverterCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterCriticalSpeedAnalysis
        """
        return _Cast_TorqueConverterCriticalSpeedAnalysis(self)
