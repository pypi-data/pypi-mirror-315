...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft._Cast_StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft"
...
class StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_SUN_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_StraightBevelSunGearSteadyStateSynchronousResponseOnAShaft(self)
