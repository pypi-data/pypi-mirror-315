...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCompoundModalAnalysisAtASpeed._Cast_ClutchHalfCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_ClutchHalfCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "ClutchHalfCompoundModalAnalysisAtASpeed"
...
class ClutchHalfCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_HALF_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5264.ClutchHalfModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCompoundModalAnalysisAtASpeed
        """
        return _Cast_ClutchHalfCompoundModalAnalysisAtASpeed(self)
