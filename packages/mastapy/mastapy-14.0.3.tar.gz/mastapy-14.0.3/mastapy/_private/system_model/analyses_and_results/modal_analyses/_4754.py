...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetModalAnalysis(_4801.SpecialisedAssemblyModalAnalysis):
    """GearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4753.GearModalAnalysis]":
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4752.GearMeshModalAnalysis]":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2849.GearSetSystemDeflection":
