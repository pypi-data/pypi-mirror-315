...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterTurbineMultibodyDynamicsAnalysis._Cast_TorqueConverterTurbineMultibodyDynamicsAnalysis",
    )
...
class _Cast_TorqueConverterTurbineMultibodyDynamicsAnalysis:
    ...
    __parent__: "TorqueConverterTurbineMultibodyDynamicsAnalysis"
...
class TorqueConverterTurbineMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_TURBINE_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterTurbineMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterTurbineMultibodyDynamicsAnalysis
        """
        return _Cast_TorqueConverterTurbineMultibodyDynamicsAnalysis(self)
