...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalPlanetGearModalAnalysisAtAStiffness._Cast_CylindricalPlanetGearModalAnalysisAtAStiffness",
    )
...
class _Cast_CylindricalPlanetGearModalAnalysisAtAStiffness:
    ...
    __parent__: "CylindricalPlanetGearModalAnalysisAtAStiffness"
...
class CylindricalPlanetGearModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_PLANET_GEAR_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalPlanetGearModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_CylindricalPlanetGearModalAnalysisAtAStiffness
        """
        return _Cast_CylindricalPlanetGearModalAnalysisAtAStiffness(self)
