...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetCompoundPowerFlow(_4378.SpecialisedAssemblyCompoundPowerFlow):
    """GearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4204.GearSetPowerFlow]":
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4204.GearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.GearSetPowerFlow]
