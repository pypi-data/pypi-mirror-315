...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5975
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentHarmonicAnalysis._Cast_MeasurementComponentHarmonicAnalysis",
    )
...
class _Cast_MeasurementComponentHarmonicAnalysis:
    ...
    __parent__: "MeasurementComponentHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeasurementComponentHarmonicAnalysis(_5975.VirtualComponentHarmonicAnalysis):
    """MeasurementComponentHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_HARMONIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MeasurementComponentHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentHarmonicAnalysis
        """
        return _Cast_MeasurementComponentHarmonicAnalysis(self)
