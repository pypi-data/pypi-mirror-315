...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyCompoundAdvancedSystemDeflection._Cast_CycloidalAssemblyCompoundAdvancedSystemDeflection",
    )
...
class _Cast_CycloidalAssemblyCompoundAdvancedSystemDeflection:
    ...
    __parent__: "CycloidalAssemblyCompoundAdvancedSystemDeflection"
...
class CycloidalAssemblyCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7475.CycloidalAssemblyAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CycloidalAssemblyCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyCompoundAdvancedSystemDeflection
        """
        return _Cast_CycloidalAssemblyCompoundAdvancedSystemDeflection(self)
