...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterAdvancedSystemDeflection._Cast_TorqueConverterAdvancedSystemDeflection",
    )
...
class _Cast_TorqueConverterAdvancedSystemDeflection:
    ...
    __parent__: "TorqueConverterAdvancedSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterAdvancedSystemDeflection(_7469.CouplingAdvancedSystemDeflection):
    """TorqueConverterAdvancedSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_ADVANCED_SYSTEM_DEFLECTION
    ...
    @property
    def assembly_design(self: "Self") -> "_2674.TorqueConverter":
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7128.TorqueConverterLoadCase":
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_2921.TorqueConverterSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterAdvancedSystemDeflection
        """
        return _Cast_TorqueConverterAdvancedSystemDeflection(self)
