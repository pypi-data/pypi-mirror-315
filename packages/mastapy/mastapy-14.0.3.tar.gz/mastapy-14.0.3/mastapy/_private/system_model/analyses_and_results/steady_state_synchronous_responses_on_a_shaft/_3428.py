...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft._Cast_PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft"
...
class PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _PLANETARY_GEAR_SET_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft(self)
