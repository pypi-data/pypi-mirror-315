...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionCompoundCriticalSpeedAnalysis._Cast_ShaftHubConnectionCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_ShaftHubConnectionCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "ShaftHubConnectionCompoundCriticalSpeedAnalysis"
...
class ShaftHubConnectionCompoundCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SHAFT_HUB_CONNECTION_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ShaftHubConnectionCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionCompoundCriticalSpeedAnalysis
        """
        return _Cast_ShaftHubConnectionCompoundCriticalSpeedAnalysis(self)
