...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft._Cast_SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft"
...
class SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _SPRING_DAMPER_CONNECTION_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_SpringDamperConnectionSteadyStateSynchronousResponseOnAShaft(self)
