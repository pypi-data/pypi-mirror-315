...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentPowerFlow._Cast_MeasurementComponentPowerFlow",
    )
...
class _Cast_MeasurementComponentPowerFlow:
    ...
    __parent__: "MeasurementComponentPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeasurementComponentPowerFlow(_4271.VirtualComponentPowerFlow):
    """MeasurementComponentPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MeasurementComponentPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentPowerFlow
        """
        return _Cast_MeasurementComponentPowerFlow(self)
