...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearMeshCompoundModalAnalysisAtASpeed._Cast_SpiralBevelGearMeshCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_SpiralBevelGearMeshCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "SpiralBevelGearMeshCompoundModalAnalysisAtASpeed"
...
class SpiralBevelGearMeshCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_MESH_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5344.SpiralBevelGearMeshModalAnalysisAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearMeshCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearMeshCompoundModalAnalysisAtASpeed
        """
        return _Cast_SpiralBevelGearMeshCompoundModalAnalysisAtASpeed(self)
