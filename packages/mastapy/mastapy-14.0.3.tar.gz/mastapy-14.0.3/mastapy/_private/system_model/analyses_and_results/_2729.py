...
_PARAMETRIC_STUDY_TOOL_ANALYSIS = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ParametricStudyToolAnalysis")
    CastSelf = TypeVar(
        "CastSelf",
        bound="ParametricStudyToolAnalysis._Cast_ParametricStudyToolAnalysis",
    )
...
class _Cast_ParametricStudyToolAnalysis:
    """Special nested class for casting ParametricStudyToolAnalysis to subclasses."""

    __parent__: "ParametricStudyToolAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParametricStudyToolAnalysis(_2709.SingleAnalysis):
    """ParametricStudyToolAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _PARAMETRIC_STUDY_TOOL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ParametricStudyToolAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ParametricStudyToolAnalysis
        """
        return _Cast_ParametricStudyToolAnalysis(self)
