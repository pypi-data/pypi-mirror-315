...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1554, _1563
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadHarmonicLoadData(_1433.SpeedDependentHarmonicLoadData):
    """PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self: "Self") -> "_1554.DegreeOfFreedom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1554", "DegreeOfFreedom"
        )(value)

    @degree_of_freedom.setter
    @enforce_parameter_types
    def degree_of_freedom(self: "Self", value: "_1554.DegreeOfFreedom") -> None:
