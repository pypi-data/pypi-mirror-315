...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyModalAnalysisAtASpeed._Cast_CycloidalAssemblyModalAnalysisAtASpeed",
    )
...
class _Cast_CycloidalAssemblyModalAnalysisAtASpeed:
    ...
    __parent__: "CycloidalAssemblyModalAnalysisAtASpeed"
...
class CycloidalAssemblyModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyModalAnalysisAtASpeed
        """
        return _Cast_CycloidalAssemblyModalAnalysisAtASpeed(self)
