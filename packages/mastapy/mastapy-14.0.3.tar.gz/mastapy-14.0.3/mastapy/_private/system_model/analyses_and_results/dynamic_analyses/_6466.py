...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalDiscDynamicAnalysis._Cast_CycloidalDiscDynamicAnalysis",
    )
...
class _Cast_CycloidalDiscDynamicAnalysis:
    ...
    __parent__: "CycloidalDiscDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalDiscDynamicAnalysis(_6422.AbstractShaftDynamicAnalysis):
    """CycloidalDiscDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYCLOIDAL_DISC_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalDiscDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CycloidalDiscDynamicAnalysis
        """
        return _Cast_CycloidalDiscDynamicAnalysis(self)
