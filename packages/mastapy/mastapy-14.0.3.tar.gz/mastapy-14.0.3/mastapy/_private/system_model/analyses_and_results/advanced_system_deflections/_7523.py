...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadAdvancedSystemDeflection._Cast_PowerLoadAdvancedSystemDeflection",
    )
...
class _Cast_PowerLoadAdvancedSystemDeflection:
    ...
    __parent__: "PowerLoadAdvancedSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadAdvancedSystemDeflection(_7559.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POWER_LOAD_ADVANCED_SYSTEM_DEFLECTION
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_7557.TransmissionErrorToOtherPowerLoad]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerLoadAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadAdvancedSystemDeflection
        """
        return _Cast_PowerLoadAdvancedSystemDeflection(self)
