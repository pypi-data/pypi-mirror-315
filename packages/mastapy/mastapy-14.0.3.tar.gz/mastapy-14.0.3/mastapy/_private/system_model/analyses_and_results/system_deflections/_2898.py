...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearMeshSystemDeflection(_2795.BevelGearMeshSystemDeflection):
    """SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def rating(self: "Self") -> "_415.SpiralBevelGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_415.SpiralBevelGearMeshRating":
        """mastapy.gears.rating.spiral_bevel.SpiralBevelGearMeshRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4247.SpiralBevelGearMeshPowerFlow":
