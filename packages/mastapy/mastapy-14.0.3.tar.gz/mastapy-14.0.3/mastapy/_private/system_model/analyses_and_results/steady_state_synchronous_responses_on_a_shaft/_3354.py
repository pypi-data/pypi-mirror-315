...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft._Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft"
...
class BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_GEAR_SET_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def bevel_gears_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3355.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bevel_differential_gears_steady_state_synchronous_response_on_a_shaft(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "BevelDifferentialGearsSteadyStateSynchronousResponseOnAShaft"
        )
    ...
    def bevel_differential_meshes_steady_state_synchronous_response_on_a_shaft(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "BevelDifferentialMeshesSteadyStateSynchronousResponseOnAShaft",
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft(
            self
        )
