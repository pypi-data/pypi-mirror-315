...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="StraightBevelSunGearHarmonicAnalysisOfSingleExcitation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelSunGearHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelSunGearHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_StraightBevelSunGearHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "StraightBevelSunGearHarmonicAnalysisOfSingleExcitation"
...
class StraightBevelSunGearHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_SUN_GEAR_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelSunGearHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelSunGearHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_StraightBevelSunGearHarmonicAnalysisOfSingleExcitation(self)
