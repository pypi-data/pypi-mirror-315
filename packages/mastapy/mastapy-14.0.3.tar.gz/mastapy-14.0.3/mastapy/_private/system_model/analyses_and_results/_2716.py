...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="DynamicModelAtAStiffnessAnalysis._Cast_DynamicModelAtAStiffnessAnalysis",
    )
...
class _Cast_DynamicModelAtAStiffnessAnalysis:
    ...
    __parent__: "DynamicModelAtAStiffnessAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DynamicModelAtAStiffnessAnalysis(_2709.SingleAnalysis):
    """DynamicModelAtAStiffnessAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _DYNAMIC_MODEL_AT_A_STIFFNESS_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DynamicModelAtAStiffnessAnalysis":
        """Cast to another type.

        Returns:
            _Cast_DynamicModelAtAStiffnessAnalysis
        """
        return _Cast_DynamicModelAtAStiffnessAnalysis(self)
