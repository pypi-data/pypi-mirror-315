...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperCompoundPowerFlow._Cast_SpringDamperCompoundPowerFlow",
    )
...
class _Cast_SpringDamperCompoundPowerFlow:
    ...
    __parent__: "SpringDamperCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperCompoundPowerFlow(_4315.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_COMPOUND_POWER_FLOW
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4252.SpringDamperPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4252.SpringDamperPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpringDamperPowerFlow]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperCompoundPowerFlow
        """
        return _Cast_SpringDamperCompoundPowerFlow(self)
