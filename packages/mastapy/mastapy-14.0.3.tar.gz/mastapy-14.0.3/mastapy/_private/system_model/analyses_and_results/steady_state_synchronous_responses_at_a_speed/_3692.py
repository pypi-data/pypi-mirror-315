...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierSteadyStateSynchronousResponseAtASpeed._Cast_PlanetCarrierSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_PlanetCarrierSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "PlanetCarrierSteadyStateSynchronousResponseAtASpeed"
...
class PlanetCarrierSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _PLANET_CARRIER_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PlanetCarrierSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_PlanetCarrierSteadyStateSynchronousResponseAtASpeed(self)
