...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearModalAnalysisAtAStiffness._Cast_ConceptGearModalAnalysisAtAStiffness",
    )
...
class _Cast_ConceptGearModalAnalysisAtAStiffness:
    ...
    __parent__: "ConceptGearModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearModalAnalysisAtAStiffness(_5038.GearModalAnalysisAtAStiffness):
    """ConceptGearModalAnalysisAtAStiffness

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearModalAnalysisAtAStiffness
        """
        return _Cast_ConceptGearModalAnalysisAtAStiffness(self)
