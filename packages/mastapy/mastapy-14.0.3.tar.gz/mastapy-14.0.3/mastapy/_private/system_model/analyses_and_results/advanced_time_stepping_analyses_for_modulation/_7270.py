...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="SpringDamperAdvancedTimeSteppingAnalysisForModulation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperAdvancedTimeSteppingAnalysisForModulation._Cast_SpringDamperAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_SpringDamperAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "SpringDamperAdvancedTimeSteppingAnalysisForModulation"
...
class SpringDamperAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _SPRING_DAMPER_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2903.SpringDamperSystemDeflection":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_SpringDamperAdvancedTimeSteppingAnalysisForModulation(self)
