...
class SpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6253.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gears_compound_harmonic_analysis_of_single_excitation(
        self: "Self",
    ) -> "List[_6382.SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "SpiralBevelGearsCompoundHarmonicAnalysisOfSingleExcitation"
        )
    ...
    def spiral_bevel_meshes_compound_harmonic_analysis_of_single_excitation(
        self: "Self",
    ) -> "List[_6383.SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation]":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "SpiralBevelMeshesCompoundHarmonicAnalysisOfSingleExcitation"
        )
