...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis._Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis",
    )
...
class _Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis:
    ...
    __parent__: "KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis"
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4073.KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "KlingelnbergCycloPalloidHypoidGearsCompoundStabilityAnalysis"
        )
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4074.KlingelnbergCycloPalloidHypoidGearMeshCompoundStabilityAnalysis]":
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "KlingelnbergCycloPalloidHypoidMeshesCompoundStabilityAnalysis",
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis
        """
        return _Cast_KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis(
            self
        )
