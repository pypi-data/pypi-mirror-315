...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft._Cast_TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft"
...
class TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_TURBINE_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_TorqueConverterTurbineSteadyStateSynchronousResponseOnAShaft(self)
