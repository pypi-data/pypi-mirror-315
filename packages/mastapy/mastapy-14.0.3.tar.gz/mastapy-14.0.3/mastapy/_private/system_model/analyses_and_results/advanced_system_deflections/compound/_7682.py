...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserHalfCompoundAdvancedSystemDeflection._Cast_SynchroniserHalfCompoundAdvancedSystemDeflection",
    )
...
class _Cast_SynchroniserHalfCompoundAdvancedSystemDeflection:
    ...
    __parent__: "SynchroniserHalfCompoundAdvancedSystemDeflection"
...
class SynchroniserHalfCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_HALF_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7550.SynchroniserHalfAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SynchroniserHalfCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserHalfCompoundAdvancedSystemDeflection
        """
        return _Cast_SynchroniserHalfCompoundAdvancedSystemDeflection(self)
