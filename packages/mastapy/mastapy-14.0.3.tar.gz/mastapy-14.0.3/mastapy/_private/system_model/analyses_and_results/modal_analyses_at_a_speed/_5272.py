...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearModalAnalysisAtASpeed._Cast_ConceptGearModalAnalysisAtASpeed",
    )
...
class _Cast_ConceptGearModalAnalysisAtASpeed:
    ...
    __parent__: "ConceptGearModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearModalAnalysisAtASpeed(_5301.GearModalAnalysisAtASpeed):
    """ConceptGearModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearModalAnalysisAtASpeed
        """
        return _Cast_ConceptGearModalAnalysisAtASpeed(self)
