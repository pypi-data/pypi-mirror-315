...
class _Cast_ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection:
    ...
    def abstract_shaft_to_mountable_component_connection_compound_advanced_system_deflection(
        self: "CastSelf",
    ) -> "_7569.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection":
...
class ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection(
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_7533.ShaftToMountableComponentConnectionAdvancedSystemDeflection]":
