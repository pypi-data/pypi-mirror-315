...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearCompoundDynamicAnalysis(_6633.MountableComponentCompoundDynamicAnalysis):
    """GearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6481.GearDynamicAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6481.GearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.GearDynamicAnalysis]
