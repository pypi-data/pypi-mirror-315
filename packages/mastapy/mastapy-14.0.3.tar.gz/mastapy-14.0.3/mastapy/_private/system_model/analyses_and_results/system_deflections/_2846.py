...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1610, _1614
    ...
    from mastapy._private.system_model.fe import _2468
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEPartSystemDeflection(_2775.AbstractShaftOrHousingSystemDeflection):
    """FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4200.FEPartPowerFlow":
    ...
    @property
    def export(self: "Self") -> "_2468.SystemDeflectionFEExportOptions":
