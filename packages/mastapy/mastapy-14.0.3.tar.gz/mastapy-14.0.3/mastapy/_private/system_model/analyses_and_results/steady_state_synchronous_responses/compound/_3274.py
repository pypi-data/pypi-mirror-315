...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearMeshCompoundSteadyStateSynchronousResponse._Cast_HypoidGearMeshCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_HypoidGearMeshCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "HypoidGearMeshCompoundSteadyStateSynchronousResponse"
...
class HypoidGearMeshCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _HYPOID_GEAR_MESH_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3139.HypoidGearMeshSteadyStateSynchronousResponse]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_HypoidGearMeshCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearMeshCompoundSteadyStateSynchronousResponse
        """
        return _Cast_HypoidGearMeshCompoundSteadyStateSynchronousResponse(self)
