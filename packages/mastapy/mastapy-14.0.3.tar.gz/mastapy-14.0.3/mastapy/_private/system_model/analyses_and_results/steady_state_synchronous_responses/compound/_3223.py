...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse._Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse"
...
class BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_GEAR_MESH_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3087.BevelDifferentialGearMeshSteadyStateSynchronousResponse]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse
        """
        return _Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse(
            self
        )
