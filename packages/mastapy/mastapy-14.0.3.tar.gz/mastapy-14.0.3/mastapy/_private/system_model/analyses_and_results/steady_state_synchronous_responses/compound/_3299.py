...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PointLoadCompoundSteadyStateSynchronousResponse._Cast_PointLoadCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_PointLoadCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "PointLoadCompoundSteadyStateSynchronousResponse"
...
class PointLoadCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _POINT_LOAD_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PointLoadCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_PointLoadCompoundSteadyStateSynchronousResponse
        """
        return _Cast_PointLoadCompoundSteadyStateSynchronousResponse(self)
