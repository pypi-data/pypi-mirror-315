...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="DatumSteadyStateSynchronousResponseAtASpeed._Cast_DatumSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_DatumSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "DatumSteadyStateSynchronousResponseAtASpeed"
...
class DatumSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _DATUM_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_DatumSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_DatumSteadyStateSynchronousResponseAtASpeed(self)
