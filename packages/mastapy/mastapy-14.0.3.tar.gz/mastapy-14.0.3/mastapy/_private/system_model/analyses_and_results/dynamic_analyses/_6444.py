...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ClutchHalfDynamicAnalysis._Cast_ClutchHalfDynamicAnalysis"
    )
...
class _Cast_ClutchHalfDynamicAnalysis:
    ...
    __parent__: "ClutchHalfDynamicAnalysis"
    ...
    @property
    def clutch_half_dynamic_analysis(self: "CastSelf") -> "ClutchHalfDynamicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfDynamicAnalysis(_6460.CouplingHalfDynamicAnalysis):
    """ClutchHalfDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_HALF_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfDynamicAnalysis
        """
        return _Cast_ClutchHalfDynamicAnalysis(self)
