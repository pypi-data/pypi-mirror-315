...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearAdvancedSystemDeflection._Cast_HypoidGearAdvancedSystemDeflection",
    )
...
class _Cast_HypoidGearAdvancedSystemDeflection:
    ...
    __parent__: "HypoidGearAdvancedSystemDeflection"
...
class HypoidGearAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _HYPOID_GEAR_ADVANCED_SYSTEM_DEFLECTION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearAdvancedSystemDeflection
        """
        return _Cast_HypoidGearAdvancedSystemDeflection(self)
