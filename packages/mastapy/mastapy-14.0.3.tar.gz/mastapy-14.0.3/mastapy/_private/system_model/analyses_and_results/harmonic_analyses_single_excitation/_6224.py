...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MassDiscHarmonicAnalysisOfSingleExcitation._Cast_MassDiscHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_MassDiscHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "MassDiscHarmonicAnalysisOfSingleExcitation"
...
class MassDiscHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _MASS_DISC_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MassDiscHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_MassDiscHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_MassDiscHarmonicAnalysisOfSingleExcitation(self)
