...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ClutchCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ClutchCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ClutchCompoundSteadyStateSynchronousResponseAtASpeed"
...
class ClutchCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CLUTCH_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3628.ClutchSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ClutchCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ClutchCompoundSteadyStateSynchronousResponseAtASpeed(self)
