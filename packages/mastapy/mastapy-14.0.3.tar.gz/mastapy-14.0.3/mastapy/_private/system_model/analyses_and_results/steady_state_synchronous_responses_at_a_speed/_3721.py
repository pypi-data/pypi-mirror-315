...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="SynchroniserHalfSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserHalfSteadyStateSynchronousResponseAtASpeed._Cast_SynchroniserHalfSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_SynchroniserHalfSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "SynchroniserHalfSteadyStateSynchronousResponseAtASpeed"
...
class SynchroniserHalfSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _SYNCHRONISER_HALF_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SynchroniserHalfSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserHalfSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_SynchroniserHalfSteadyStateSynchronousResponseAtASpeed(self)
