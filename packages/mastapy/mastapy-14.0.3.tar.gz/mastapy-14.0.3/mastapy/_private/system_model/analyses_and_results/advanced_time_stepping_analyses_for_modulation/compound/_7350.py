...
_FACE_GEAR_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation(
    _7355.GearCompoundAdvancedTimeSteppingAnalysisForModulation
):
    """FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    TYPE: ClassVar["Type"] = (
        _FACE_GEAR_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7218.FaceGearAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_FaceGearCompoundAdvancedTimeSteppingAnalysisForModulation(self)
