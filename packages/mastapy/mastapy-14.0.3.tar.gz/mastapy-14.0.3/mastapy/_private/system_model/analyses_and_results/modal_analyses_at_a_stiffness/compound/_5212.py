...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearCompoundModalAnalysisAtAStiffness._Cast_SpiralBevelGearCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_SpiralBevelGearCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "SpiralBevelGearCompoundModalAnalysisAtAStiffness"
...
class SpiralBevelGearCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5082.SpiralBevelGearModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearCompoundModalAnalysisAtAStiffness
        """
        return _Cast_SpiralBevelGearCompoundModalAnalysisAtAStiffness(self)
