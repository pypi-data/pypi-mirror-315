...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearDynamicAnalysis._Cast_StraightBevelGearDynamicAnalysis",
    )
...
class _Cast_StraightBevelGearDynamicAnalysis:
    ...
    __parent__: "StraightBevelGearDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearDynamicAnalysis(_6437.BevelGearDynamicAnalysis):
    """StraightBevelGearDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelGearDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearDynamicAnalysis
        """
        return _Cast_StraightBevelGearDynamicAnalysis(self)
