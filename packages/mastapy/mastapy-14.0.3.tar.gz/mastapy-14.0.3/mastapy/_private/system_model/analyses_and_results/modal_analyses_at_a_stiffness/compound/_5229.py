...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserSleeveCompoundModalAnalysisAtAStiffness._Cast_SynchroniserSleeveCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_SynchroniserSleeveCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "SynchroniserSleeveCompoundModalAnalysisAtAStiffness"
...
class SynchroniserSleeveCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_SLEEVE_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5098.SynchroniserSleeveModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SynchroniserSleeveCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserSleeveCompoundModalAnalysisAtAStiffness
        """
        return _Cast_SynchroniserSleeveCompoundModalAnalysisAtAStiffness(self)
