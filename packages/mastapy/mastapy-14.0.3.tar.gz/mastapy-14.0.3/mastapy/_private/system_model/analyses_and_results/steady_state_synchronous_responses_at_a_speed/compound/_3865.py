...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed"
...
class ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _ZEROL_BEVEL_GEAR_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3736.ZerolBevelGearSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ZerolBevelGearCompoundSteadyStateSynchronousResponseAtASpeed(self)
