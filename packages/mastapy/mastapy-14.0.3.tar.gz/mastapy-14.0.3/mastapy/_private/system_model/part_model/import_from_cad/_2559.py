...
from mastapy._private.system_model.part_model.gears import _2586, _2587
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFromCAD(_2565.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: "Self", value: "_2587.CylindricalGearSet") -> None:
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: "Self", value: "_2586.CylindricalGear") -> None:
        wrapper_type = (
