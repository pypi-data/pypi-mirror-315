...
from mastapy._private.system_model import _2276
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoad(_2540.VirtualComponent):
    """PowerLoad
    ...
    @enforce_parameter_types
    def electric_machine_detail_selector(
        self: "Self", value: "_1304.ElectricMachineDetail"
    ) -> None:
    ...
    def electric_machine_search_region_specification_method(
        self: "Self",
    ) -> "_2507.ElectricMachineSearchRegionSpecificationMethod":
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: "Self", value: "_2507.ElectricMachineSearchRegionSpecificationMethod"
    ) -> None:
    ...
    @property
    def engine_fuel_consumption_grid(self: "Self") -> "_1615.GriddedSurfaceAccessor":
    ...
    @property
    def engine_torque_grid(self: "Self") -> "_1615.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: "Self", value: "_1615.GriddedSurfaceAccessor") -> None:
    ...
    @enforce_parameter_types
    def power_load_type(self: "Self", value: "_2276.PowerLoadType") -> None:
    ...
    @property
    def oil_pump_detail(self: "Self") -> "_310.OilPumpDetail":
    ...
    @property
    def single_blade_details(self: "Self") -> "_2542.WindTurbineSingleBladeDetails":
