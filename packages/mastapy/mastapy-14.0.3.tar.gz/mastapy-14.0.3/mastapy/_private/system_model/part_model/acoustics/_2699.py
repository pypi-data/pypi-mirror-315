...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2696, _2697, _2698
...
class _Cast_MeshedResultSurfaceBase:
    ...
    @property
    def meshed_result_surface(self: "CastSelf") -> "_2698.MeshedResultSurface":
        from mastapy._private.system_model.part_model.acoustics import _2698

        return self.__parent__._cast(_2698.MeshedResultSurface)
