...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGear(_2580.BevelGear):
    """StraightBevelGear
    ...
    @property
    def bevel_gear_design(self: "Self") -> "_987.StraightBevelGearDesign":
    ...
    @property
    def straight_bevel_gear_design(self: "Self") -> "_987.StraightBevelGearDesign":
        """mastapy.gears.gear_designs.straight_bevel.StraightBevelGearDesign

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "StraightBevelGearDesign")
