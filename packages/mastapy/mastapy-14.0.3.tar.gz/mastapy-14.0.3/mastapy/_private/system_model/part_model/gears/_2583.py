...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSet(_2593.GearSet):
    """ConceptGearSet
    ...
    @property
    def active_gear_set_design(self: "Self") -> "_1218.ConceptGearSetDesign":
    ...
    @property
    def concept_gear_set_design(self: "Self") -> "_1218.ConceptGearSetDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearSetDesign
    ...
    @property
    def concept_gears(self: "Self") -> "List[_2582.ConceptGear]":
    ...
    @property
    def concept_meshes(self: "Self") -> "List[_2362.ConceptGearMesh]":
