...
from mastapy._private.system_model.part_model.acoustics import _2698, _2703
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeshedResultSphere(_2698.MeshedResultSurface[_2703.ResultSphereOptions]):
    """MeshedResultSphere
