...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierSettings(_1645.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        self: "Self",
    ) -> "_2272.PlanetPinManufacturingErrorsCoordinateSystem":
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        self: "Self", value: "_2272.PlanetPinManufacturingErrorsCoordinateSystem"
    ) -> None:
