...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2547, _2550, _2553
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParallelPartGroupSelection(_2551.ParallelPartGroup):
    """ParallelPartGroupSelection
    ...
    @property
    def design_measurements(self: "Self") -> "List[_2550.DesignMeasurements]":
