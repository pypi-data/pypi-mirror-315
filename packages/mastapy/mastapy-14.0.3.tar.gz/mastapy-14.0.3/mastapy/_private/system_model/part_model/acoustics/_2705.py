...
from mastapy._private.system_model import _2261
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2702.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2702

        return self.__parent__._cast(_2702.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2703.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2703

        return self.__parent__._cast(_2703.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2502.Component") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2261.DesignEntityId") -> None:
