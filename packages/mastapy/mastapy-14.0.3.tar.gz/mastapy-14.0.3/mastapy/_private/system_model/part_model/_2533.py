...
class _Cast_RadialInternalClearanceTolerance:
    ...
    def internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2517.InternalClearanceTolerance":
        return self.__parent__._cast(_2517.InternalClearanceTolerance)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RadialInternalClearanceTolerance(_2517.InternalClearanceTolerance):
    """RadialInternalClearanceTolerance
