...
class MicrophoneArrayDesign(_0.APIBase):
    ...
    @property
    def envelope_type(self: "Self") -> "_2690.AcousticEnvelopeType":
    ...
    @enforce_parameter_types
    def envelope_type(self: "Self", value: "_2690.AcousticEnvelopeType") -> None:
    ...
    def spherical_envelope_centre(
        self: "Self",
    ) -> "_2706.SphericalEnvelopeCentreDefinition":
    ...
    @enforce_parameter_types
    def spherical_envelope_centre(
        self: "Self", value: "_2706.SphericalEnvelopeCentreDefinition"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Acoustics.SphericalEnvelopeCentreDefinition",
    ...
    @property
    def spherical_envelope_type(self: "Self") -> "_2707.SphericalEnvelopeType":
    ...
    def spherical_envelope_type(
        self: "Self", value: "_2707.SphericalEnvelopeType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def selected_part(self: "Self") -> "List[_2701.PartSelectionForAcousticEnvelope]":
