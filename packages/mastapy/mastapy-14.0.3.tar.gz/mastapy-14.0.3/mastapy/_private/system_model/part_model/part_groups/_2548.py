...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2549, _2553
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConcentricPartGroup(_2547.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    def parallel_groups(
        self: "Self",
    ) -> "List[_2549.ConcentricPartGroupParallelToThis]":
