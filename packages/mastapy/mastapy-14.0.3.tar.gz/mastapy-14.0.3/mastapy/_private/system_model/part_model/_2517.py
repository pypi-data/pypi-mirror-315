...
from mastapy._private.bearings.tolerances import _1957, _1959
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2496, _2533
...
class _Cast_InternalClearanceTolerance:
    ...
    def axial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2496.AxialInternalClearanceTolerance)
    ...
    def radial_internal_clearance_tolerance(
        ...
        return self.__parent__._cast(_2533.RadialInternalClearanceTolerance)
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    def clearance_class(self: "Self", value: "_1957.InternalClearanceClass") -> None:
