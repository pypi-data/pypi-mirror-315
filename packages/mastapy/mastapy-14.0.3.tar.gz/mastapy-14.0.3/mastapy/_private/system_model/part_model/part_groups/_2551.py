...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2548, _2552, _2553
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParallelPartGroup(_2547.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self: "Self") -> "List[_2548.ConcentricPartGroup]":
