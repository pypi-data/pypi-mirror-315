...
class _Cast_ComponentConnection:
    ...
    @property
    def component_measurer(self: "CastSelf") -> "_2328.ComponentMeasurer":
        return self.__parent__._cast(_2328.ComponentMeasurer)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentConnection(_2328.ComponentMeasurer):
    """ComponentConnection
    ...
    @property
    def connected_component(self: "Self") -> "_2502.Component":
