...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearMesh(_2370.GearMesh):
    """ConceptGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1217.ConceptGearMeshDesign":
    ...
    @property
    def concept_gear_mesh_design(self: "Self") -> "_1217.ConceptGearMeshDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearMeshDesign
