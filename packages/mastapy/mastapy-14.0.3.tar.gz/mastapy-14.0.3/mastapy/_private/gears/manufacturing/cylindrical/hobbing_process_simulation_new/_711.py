...
T = TypeVar("T", bound="_710.ProcessSimulationInput")
...
class _Cast_ProcessSimulationNew:
    ...
    def hobbing_process_simulation_new(
        self: "CastSelf",
    ) -> "_698.HobbingProcessSimulationNew":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _698,
        )

        return self.__parent__._cast(_698.HobbingProcessSimulationNew)

    @property
    def worm_grinding_process_simulation_new(
        self: "CastSelf",
    ) -> "_725.WormGrindingProcessSimulationNew":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _725,
        )

        return self.__parent__._cast(_725.WormGrindingProcessSimulationNew)
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def gear_tooth_shape_calculation(self: "Self") -> "_706.ProcessGearShape":
    ...
    @property
    def lead_calculation(self: "Self") -> "_707.ProcessLeadCalculation":
    ...
    @property
    def pitch_calculation(self: "Self") -> "_708.ProcessPitchCalculation":
    ...
    @property
    def profile_calculation(self: "Self") -> "_709.ProcessProfileCalculation":
    ...
    def total_modification_calculation(
        self: "Self",
    ) -> "_713.ProcessTotalModificationCalculation":
