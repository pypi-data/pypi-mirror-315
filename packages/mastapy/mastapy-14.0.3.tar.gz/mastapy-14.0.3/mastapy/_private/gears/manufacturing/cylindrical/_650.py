...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _637, _647
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalSetManufacturingConfig(_1271.GearSetImplementationDetail):
    """CylindricalSetManufacturingConfig
    ...
    def cylindrical_mesh_manufacturing_configurations(
        self: "Self",
    ) -> "List[_647.CylindricalMeshManufacturingConfig]":
