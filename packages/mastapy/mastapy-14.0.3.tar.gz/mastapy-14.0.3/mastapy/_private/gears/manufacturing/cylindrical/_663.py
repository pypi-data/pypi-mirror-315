...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _766
    from mastapy._private.gears.manufacturing.cylindrical.cutters import _747

    Self = TypeVar("Self", bound="SuitableCutterSetup")
    CastSelf = TypeVar(
        "CastSelf", bound="SuitableCutterSetup._Cast_SuitableCutterSetup"
    )
...
class _Cast_SuitableCutterSetup:
    ...
    __parent__: "SuitableCutterSetup"

    @property
    def suitable_cutter_setup(self: "CastSelf") -> "SuitableCutterSetup":
...
class SuitableCutterSetup(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _SUITABLE_CUTTER_SETUP
    ...
    def rough_cutter_creation_settings(
        self: "Self",
    ) -> "_747.RoughCutterCreationSettings":
    ...
    @property
    def tool_clearances(self: "Self") -> "_766.ManufacturingOperationConstraints":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.ManufacturingOperationConstraints

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "ToolClearances")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SuitableCutterSetup":
        """Cast to another type.

        Returns:
            _Cast_SuitableCutterSetup
        """
        return _Cast_SuitableCutterSetup(self)
