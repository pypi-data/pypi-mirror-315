...
class _Cast_ShaverRedressing:
    ...
    @property
    def axial_shaver_redressing(self: "CastSelf") -> "_775.AxialShaverRedressing":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _775,
        )

        return self.__parent__._cast(_775.AxialShaverRedressing)

    @property
    def plunge_shaver_redressing(self: "CastSelf") -> "_782.PlungeShaverRedressing":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _782,
        )

        return self.__parent__._cast(_782.PlungeShaverRedressing)
