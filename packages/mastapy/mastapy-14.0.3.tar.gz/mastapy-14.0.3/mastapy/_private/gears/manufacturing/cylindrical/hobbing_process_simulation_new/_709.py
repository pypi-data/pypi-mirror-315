...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ProcessProfileCalculation._Cast_ProcessProfileCalculation"
    )
...
class _Cast_ProcessProfileCalculation:
    ...
    __parent__: "ProcessProfileCalculation"

    @property
    def process_profile_calculation(self: "CastSelf") -> "ProcessProfileCalculation":
...
class ProcessProfileCalculation(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _PROCESS_PROFILE_CALCULATION
    ...
    def left_flank_accuracy_calculation(
        self: "Self",
    ) -> "_687.CalculateProfileDeviationAccuracy":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ProcessProfileCalculation":
        """Cast to another type.

        Returns:
            _Cast_ProcessProfileCalculation
        """
        return _Cast_ProcessProfileCalculation(self)
