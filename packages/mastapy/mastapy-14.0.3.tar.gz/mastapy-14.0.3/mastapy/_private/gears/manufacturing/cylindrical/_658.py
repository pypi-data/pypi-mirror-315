...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _659, _660, _661
...
T = TypeVar("T", bound="_661.ModificationSegment")
...
class _Cast_MicroGeometryInputs:
    ...
    @property
    def micro_geometry_inputs_lead(self: "CastSelf") -> "_659.MicroGeometryInputsLead":
        from mastapy._private.gears.manufacturing.cylindrical import _659

        return self.__parent__._cast(_659.MicroGeometryInputsLead)

    @property
    def micro_geometry_inputs_profile(
        self: "CastSelf",
    ) -> "_660.MicroGeometryInputsProfile":
        from mastapy._private.gears.manufacturing.cylindrical import _660

        return self.__parent__._cast(_660.MicroGeometryInputsProfile)
