...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _854, _862
...
class _Cast_GearFilletNodeStressResultsColumn:
    ...
    def cylindrical_gear_fillet_node_stress_results_column(
        self: "CastSelf",
    ) -> "_854.CylindricalGearFilletNodeStressResultsColumn":
        from mastapy._private.gears.ltca import _854

        return self.__parent__._cast(_854.CylindricalGearFilletNodeStressResultsColumn)
