...
from mastapy._private.gears.ltca import _868
...
class _Cast_CylindricalGearMeshLoadedContactLine:
    ...
    def gear_mesh_loaded_contact_line(
        self: "CastSelf",
    ) -> "_868.GearMeshLoadedContactLine":
        return self.__parent__._cast(_868.GearMeshLoadedContactLine)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshLoadedContactLine(_868.GearMeshLoadedContactLine):
    """CylindricalGearMeshLoadedContactLine
    ...
    def loaded_contact_strip_end_points(
        self: "Self",
    ) -> "List[_884.CylindricalGearMeshLoadedContactPoint]":
