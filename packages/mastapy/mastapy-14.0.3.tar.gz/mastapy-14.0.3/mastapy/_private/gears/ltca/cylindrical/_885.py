...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca.cylindrical import _882, _887
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetLoadDistributionAnalysis(_871.GearSetLoadDistributionAnalysis):
    """CylindricalGearSetLoadDistributionAnalysis
    ...
    @property
    def tiff_analysis(self: "Self") -> "_921.CylindricalGearSetTIFFAnalysis":
