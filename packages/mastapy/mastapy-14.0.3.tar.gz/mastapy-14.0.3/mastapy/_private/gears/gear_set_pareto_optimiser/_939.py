...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="InputSliderForPareto._Cast_InputSliderForPareto"
    )
...
class _Cast_InputSliderForPareto:
    ...
    __parent__: "InputSliderForPareto"

    @property
    def input_slider_for_pareto(self: "CastSelf") -> "InputSliderForPareto":
...
class InputSliderForPareto(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    TYPE: ClassVar["Type"] = _INPUT_SLIDER_FOR_PARETO
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_InputSliderForPareto":
        """Cast to another type.

        Returns:
            _Cast_InputSliderForPareto
        """
        return _Cast_InputSliderForPareto(self)
