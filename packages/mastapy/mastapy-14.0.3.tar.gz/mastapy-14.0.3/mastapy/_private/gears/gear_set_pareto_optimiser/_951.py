...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ParetoCylindricalGearSetOptimisationStrategyDatabase._Cast_ParetoCylindricalGearSetOptimisationStrategyDatabase",
    )
...
class _Cast_ParetoCylindricalGearSetOptimisationStrategyDatabase:
    ...
    __parent__: "ParetoCylindricalGearSetOptimisationStrategyDatabase"
...
class ParetoCylindricalGearSetOptimisationStrategyDatabase(
    ...
    TYPE: ClassVar["Type"] = _PARETO_CYLINDRICAL_GEAR_SET_OPTIMISATION_STRATEGY_DATABASE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ParetoCylindricalGearSetOptimisationStrategyDatabase":
        """Cast to another type.

        Returns:
            _Cast_ParetoCylindricalGearSetOptimisationStrategyDatabase
        """
        return _Cast_ParetoCylindricalGearSetOptimisationStrategyDatabase(self)
