...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ParetoStraightBevelGearSetDutyCycleOptimisationStrategyDatabase._Cast_ParetoStraightBevelGearSetDutyCycleOptimisationStrategyDatabase",
    )
...
class _Cast_ParetoStraightBevelGearSetDutyCycleOptimisationStrategyDatabase:
    ...
    __parent__: "ParetoStraightBevelGearSetDutyCycleOptimisationStrategyDatabase"
...
class ParetoStraightBevelGearSetDutyCycleOptimisationStrategyDatabase(
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ParetoStraightBevelGearSetDutyCycleOptimisationStrategyDatabase":
        """Cast to another type.

        Returns:
            _Cast_ParetoStraightBevelGearSetDutyCycleOptimisationStrategyDatabase
        """
        return _Cast_ParetoStraightBevelGearSetDutyCycleOptimisationStrategyDatabase(
            self
        )
