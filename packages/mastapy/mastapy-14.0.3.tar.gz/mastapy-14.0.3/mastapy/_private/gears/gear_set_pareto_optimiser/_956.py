...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase._Cast_ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase",
    )
...
class _Cast_ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase:
    ...
    __parent__: "ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase"
...
class ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase(
    ...
    TYPE: ClassVar["Type"] = (
        _PARETO_HYPOID_GEAR_SET_DUTY_CYCLE_OPTIMISATION_STRATEGY_DATABASE
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase":
        """Cast to another type.

        Returns:
            _Cast_ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase
        """
        return _Cast_ParetoHypoidGearSetDutyCycleOptimisationStrategyDatabase(self)
