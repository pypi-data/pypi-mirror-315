...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _473, _476, _488
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearDutyCycleRating(_370.GearDutyCycleRating):
    """CylindricalGearDutyCycleRating
    ...
    def cylindrical_gear_mesh_ratings(
        self: "Self",
    ) -> "List[_488.MeshRatingForReports]":
