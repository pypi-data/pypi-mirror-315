...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.klingelnberg_conical.kn3030 import _431, _432
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergConicalMeshSingleFlankRating(_379.MeshSingleFlankRating):
    """KlingelnbergConicalMeshSingleFlankRating
    ...
    def lubrication_speed_ampersand_roughness_factor_product(self: "Self") -> "float":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "LubricationSpeedAmpersandRoughnessFactorProduct"
        )
