...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel_diff import _412, _414
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearMeshRating(_552.ConicalGearMeshRating):
    """StraightBevelDiffGearMeshRating
    ...
    @property
    def meshed_gears(self: "Self") -> "List[_414.StraightBevelDiffMeshedGearRating]":
    ...
    @property
    def gears_in_mesh(self: "Self") -> "List[_414.StraightBevelDiffMeshedGearRating]":
        """List[mastapy.gears.rating.straight_bevel_diff.StraightBevelDiffMeshedGearRating]
