...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetRating(_376.GearSetRating):
    """WormGearSetRating
    ...
    @property
    def worm_gear_set(self: "Self") -> "_985.WormGearSetDesign":
    ...
    @property
    def gear_mesh_ratings(self: "Self") -> "List[_386.WormGearMeshRating]":
    ...
    @property
    def worm_mesh_ratings(self: "Self") -> "List[_386.WormGearMeshRating]":
        """List[mastapy.gears.rating.worm.WormGearMeshRating]
