...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearToothMicroGeometry._Cast_CylindricalGearToothMicroGeometry",
    )
...
class _Cast_CylindricalGearToothMicroGeometry:
    ...
    __parent__: "CylindricalGearToothMicroGeometry"
...
class CylindricalGearToothMicroGeometry(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_TOOTH_MICRO_GEOMETRY
    ...
    def tooth_number(self: "Self") -> "int":
        ...
        """
        temp = pythonnet_property_get(self.wrapped, "ToothNumber")
    ...
    @property
    def left_flank(self: "Self") -> "_1129.CylindricalGearFlankMicroGeometry":
    ...
    @property
    def right_flank(self: "Self") -> "_1129.CylindricalGearFlankMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearFlankMicroGeometry
    ...
    @property
    def flanks(self: "Self") -> "List[_1129.CylindricalGearFlankMicroGeometry]":
    ...
    @property
    def both_flanks(self: "Self") -> "_1129.CylindricalGearFlankMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearFlankMicroGeometry
    ...
    @property
    def gear(self: "Self") -> "_1135.CylindricalGearMicroGeometryBase":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearToothMicroGeometry":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearToothMicroGeometry
        """
        return _Cast_CylindricalGearToothMicroGeometry(self)
