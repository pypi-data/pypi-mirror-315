...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.klingelnberg_hypoid import _1003, _1004
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(
    ...
    @property
    def gears(self: "Self") -> "List[_1003.KlingelnbergCycloPalloidHypoidGearDesign]":
    ...
    def klingelnberg_conical_meshes(
        self: "Self",
    ) -> "List[_1004.KlingelnbergCycloPalloidHypoidGearMeshDesign]":
