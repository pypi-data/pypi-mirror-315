...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.worm import _982, _983, _985, _986
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearMeshDesign(_975.GearMeshDesign):
    """WormGearMeshDesign
    ...
    @property
    def wheel(self: "Self") -> "_986.WormWheelDesign":
    ...
    @property
    def worm(self: "Self") -> "_982.WormDesign":
