...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMicroGeometry(_1261.GearImplementationDetail):
    """FaceGearMicroGeometry
    ...
    @property
    def face_gear(self: "Self") -> "_1015.FaceGearDesign":
    ...
    @property
    def micro_geometry(self: "Self") -> "_1135.CylindricalGearMicroGeometryBase":
