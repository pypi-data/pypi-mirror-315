...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.straight_bevel_diff import _991, _993, _994
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearMeshDesign(_1221.BevelGearMeshDesign):
    """StraightBevelDiffGearMeshDesign
    ...
    def straight_bevel_diff_meshed_gears(
        self: "Self",
    ) -> "List[_994.StraightBevelDiffMeshedGearDesign]":
