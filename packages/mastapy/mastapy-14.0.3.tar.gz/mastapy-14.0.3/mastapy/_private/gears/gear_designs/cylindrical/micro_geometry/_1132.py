...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1050, _1058
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshMicroGeometry(_1265.GearMeshImplementationDetail):
    """CylindricalGearMeshMicroGeometry
    ...
    @property
    def cylindrical_mesh(self: "Self") -> "_1050.CylindricalGearMeshDesign":
    ...
    def cylindrical_gear_micro_geometries_specified_per_tooth(
        self: "Self",
    ) -> "List[_1138.CylindricalGearMicroGeometryPerTooth]":
    ...
    @property
    def gear_a(self: "Self") -> "_1135.CylindricalGearMicroGeometryBase":
    ...
    @property
    def gear_b(self: "Self") -> "_1135.CylindricalGearMicroGeometryBase":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearMicroGeometryBase
