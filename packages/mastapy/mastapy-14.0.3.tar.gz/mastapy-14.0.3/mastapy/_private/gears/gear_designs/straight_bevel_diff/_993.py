...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.straight_bevel_diff import _991, _992
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSetDesign(_1222.BevelGearSetDesign):
    """StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self: "Self") -> "List[_991.StraightBevelDiffGearDesign]":
    ...
    def straight_bevel_diff_gears(
        self: "Self",
    ) -> "List[_991.StraightBevelDiffGearDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel_diff.StraightBevelDiffGearDesign]
    ...
    def straight_bevel_diff_meshes(
        self: "Self",
    ) -> "List[_992.StraightBevelDiffGearMeshDesign]":
