...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="CylindricalGearSetManufacturingConfigurationSelection"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearSetManufacturingConfigurationSelection._Cast_CylindricalGearSetManufacturingConfigurationSelection",
    )
...
class _Cast_CylindricalGearSetManufacturingConfigurationSelection:
    ...
    __parent__: "CylindricalGearSetManufacturingConfigurationSelection"
...
class CylindricalGearSetManufacturingConfigurationSelection(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_SET_MANUFACTURING_CONFIGURATION_SELECTION
    ...
    def manufacturing_configuration(
        ...
        pythonnet_property_set(self.wrapped, "ManufacturingConfiguration", value)
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CylindricalGearSetManufacturingConfigurationSelection":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearSetManufacturingConfigurationSelection
        """
        return _Cast_CylindricalGearSetManufacturingConfigurationSelection(self)
