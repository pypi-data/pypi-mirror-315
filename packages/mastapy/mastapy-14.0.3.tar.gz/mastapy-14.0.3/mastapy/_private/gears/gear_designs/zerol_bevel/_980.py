...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.zerol_bevel import _978, _979
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetDesign(_1222.BevelGearSetDesign):
    """ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self: "Self") -> "_364.ZerolBevelGleasonToothTaperOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._364", "ZerolBevelGleasonToothTaperOption"
        )(value)

    @tooth_taper_zerol.setter
    @enforce_parameter_types
    def tooth_taper_zerol(
        self: "Self", value: "_364.ZerolBevelGleasonToothTaperOption"
    ) -> None:
    ...
    @property
    def gears(self: "Self") -> "List[_978.ZerolBevelGearDesign]":
    ...
    @property
    def zerol_bevel_gears(self: "Self") -> "List[_978.ZerolBevelGearDesign]":
        """List[mastapy.gears.gear_designs.zerol_bevel.ZerolBevelGearDesign]
    ...
    @property
    def zerol_bevel_meshes(self: "Self") -> "List[_979.ZerolBevelGearMeshDesign]":
