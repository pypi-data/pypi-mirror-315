...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _251
...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self: "Self") -> "_251.AcousticRadiationEfficiencyInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._251", "AcousticRadiationEfficiencyInputType"
        )(value)

    @input_type.setter
    @enforce_parameter_types
    def input_type(
        self: "Self", value: "_251.AcousticRadiationEfficiencyInputType"
    ) -> None:
    ...
    @property
    def radiation_efficiency_curve(self: "Self") -> "_1585.Vector2DListAccessor":
