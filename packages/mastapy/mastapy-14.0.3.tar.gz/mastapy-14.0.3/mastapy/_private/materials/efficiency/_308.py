...
from mastapy._private.materials.efficiency import _315
...
class _Cast_IndependentResistiveTorque:
    ...
    @property
    def resistive_torque(self: "CastSelf") -> "_315.ResistiveTorque":
        return self.__parent__._cast(_315.ResistiveTorque)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class IndependentResistiveTorque(_315.ResistiveTorque):
    """IndependentResistiveTorque
