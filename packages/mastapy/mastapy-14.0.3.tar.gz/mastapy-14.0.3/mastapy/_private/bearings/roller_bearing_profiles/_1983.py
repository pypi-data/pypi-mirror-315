...
class ProfileSet(_0.APIBase):
    ...
    @property
    def active_profile_type(self: "Self") -> "_1946.RollerBearingProfileTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1946", "RollerBearingProfileTypes"
        )(value)

    @active_profile_type.setter
    @enforce_parameter_types
    def active_profile_type(
        self: "Self", value: "_1946.RollerBearingProfileTypes"
    ) -> None:
    ...
    @property
    def active_profile(self: "Self") -> "_1991.RollerBearingProfile":
