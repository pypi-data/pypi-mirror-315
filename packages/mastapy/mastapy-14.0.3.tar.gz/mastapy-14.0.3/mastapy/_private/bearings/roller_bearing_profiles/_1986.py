...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollerBearingCrownedProfile._Cast_RollerBearingCrownedProfile",
    )
...
class _Cast_RollerBearingCrownedProfile:
    ...
    __parent__: "RollerBearingCrownedProfile"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollerBearingCrownedProfile(_1991.RollerBearingProfile):
    """RollerBearingCrownedProfile

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ROLLER_BEARING_CROWNED_PROFILE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollerBearingCrownedProfile":
        """Cast to another type.

        Returns:
            _Cast_RollerBearingCrownedProfile
        """
        return _Cast_RollerBearingCrownedProfile(self)
