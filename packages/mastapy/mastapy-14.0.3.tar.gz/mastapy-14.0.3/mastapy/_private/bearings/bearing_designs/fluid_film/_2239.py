...
from mastapy._private.bearings.bearing_designs.fluid_film import _2238
...
class _Cast_AxialGrooveJournalBearing:
    ...
    @property
    def axial_feed_journal_bearing(self: "CastSelf") -> "_2238.AxialFeedJournalBearing":
        return self.__parent__._cast(_2238.AxialFeedJournalBearing)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AxialGrooveJournalBearing(_2238.AxialFeedJournalBearing):
    """AxialGrooveJournalBearing
