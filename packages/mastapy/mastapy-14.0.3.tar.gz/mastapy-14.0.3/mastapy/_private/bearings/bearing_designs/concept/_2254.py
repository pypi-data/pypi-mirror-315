...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.concept import _2253
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptAxialClearanceBearing(_2255.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self: "Self") -> "_2253.BearingNodePosition":
    ...
    @enforce_parameter_types
    def node_position(self: "Self", value: "_2253.BearingNodePosition") -> None:
