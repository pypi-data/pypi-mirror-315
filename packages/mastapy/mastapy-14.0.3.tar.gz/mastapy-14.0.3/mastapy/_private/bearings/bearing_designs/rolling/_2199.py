...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="BearingProtection._Cast_BearingProtection")
...
class _Cast_BearingProtection:
    ...
    __parent__: "BearingProtection"

    @property
    def bearing_protection(self: "CastSelf") -> "BearingProtection":
...
class BearingProtection(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _BEARING_PROTECTION
    ...
    def advanced_bearing_results_hidden(self: "Self") -> "str":
        ...
        """
        temp = pythonnet_property_get(self.wrapped, "AdvancedBearingResultsHidden")
    ...
    def bearing_is_protected(self: "Self") -> "bool":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "BearingIsProtected")
    ...
    def internal_geometry_hidden(self: "Self") -> "str":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "InternalGeometryHidden")
    ...
    @property
    def protection_level(self: "Self") -> "_2201.BearingProtectionLevel":
        """mastapy.bearings.bearing_designs.rolling.BearingProtectionLevel

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "ProtectionLevel")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BearingProtection":
        """Cast to another type.

        Returns:
            _Cast_BearingProtection
        """
        return _Cast_BearingProtection(self)
