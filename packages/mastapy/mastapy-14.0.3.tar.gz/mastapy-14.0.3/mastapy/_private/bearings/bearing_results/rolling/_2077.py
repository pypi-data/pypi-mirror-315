...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2080, _2085, _2089
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedNeedleRollerBearingResults(_2065.LoadedCylindricalRollerBearingResults):
    """LoadedNeedleRollerBearingResults
