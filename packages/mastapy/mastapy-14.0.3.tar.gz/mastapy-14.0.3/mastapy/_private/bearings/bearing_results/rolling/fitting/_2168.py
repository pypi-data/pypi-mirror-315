...
from mastapy._private.bearings.bearing_results.rolling.fitting import _2169
...
class _Cast_OuterRingFittingThermalResults:
    ...
    def ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2169.RingFittingThermalResults":
        return self.__parent__._cast(_2169.RingFittingThermalResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OuterRingFittingThermalResults(_2169.RingFittingThermalResults):
    """OuterRingFittingThermalResults
