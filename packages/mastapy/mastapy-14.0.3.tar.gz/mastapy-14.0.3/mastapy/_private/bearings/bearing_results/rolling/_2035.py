...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2034, _2036
...
class _Cast_ISOTR141792001Results:
    ...
    @property
    def isotr1417912001_results(self: "CastSelf") -> "_2034.ISOTR1417912001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2034

        return self.__parent__._cast(_2034.ISOTR1417912001Results)

    @property
    def isotr1417922001_results(self: "CastSelf") -> "_2036.ISOTR1417922001Results":
        from mastapy._private.bearings.bearing_results.rolling import _2036

        return self.__parent__._cast(_2036.ISOTR1417922001Results)
