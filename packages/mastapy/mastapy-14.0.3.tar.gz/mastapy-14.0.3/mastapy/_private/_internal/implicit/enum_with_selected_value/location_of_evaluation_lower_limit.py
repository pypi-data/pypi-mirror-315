...
from mastapy._private.gears.micro_geometry import _586
...
class EnumWithSelectedValue_LocationOfEvaluationLowerLimit(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfEvaluationLowerLimit]",
    ) -> "_586.LocationOfEvaluationLowerLimit":
        ...
        Returns:
            _586.LocationOfEvaluationLowerLimit
        """
        return _586.LocationOfEvaluationLowerLimit
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _586.LocationOfEvaluationLowerLimit.type_()

    @property
    def selected_value(self: "Self") -> "_586.LocationOfEvaluationLowerLimit":
    ...
    @property
    def available_values(self: "Self") -> "List[_586.LocationOfEvaluationLowerLimit]":
