...
from mastapy._private.system_model.fe import _2460
...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_2460.NodeSelectionDepthOption":
        ...
        Returns:
            _2460.NodeSelectionDepthOption
        """
        return _2460.NodeSelectionDepthOption
    ...
    def implicit_type(cls: "Type[Overridable_NodeSelectionDepthOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2460.NodeSelectionDepthOption.type_()

    @property
    def value(self: "Self") -> "_2460.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: "Self") -> "_2460.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: "Self") -> "_2460.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
