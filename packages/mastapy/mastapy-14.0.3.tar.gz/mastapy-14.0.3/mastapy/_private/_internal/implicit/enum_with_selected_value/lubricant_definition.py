...
class EnumWithSelectedValue_LubricantDefinition(
    ...
    def wrapped_type(
        ...
        Returns:
            _274.LubricantDefinition
        """
        return _274.LubricantDefinition
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LubricantDefinition]") -> "Any":
        ...
        Returns:
            Any
        """
        return _274.LubricantDefinition.type_()

    @property
    def selected_value(self: "Self") -> "_274.LubricantDefinition":
    ...
    @property
    def available_values(self: "Self") -> "List[_274.LubricantDefinition]":
