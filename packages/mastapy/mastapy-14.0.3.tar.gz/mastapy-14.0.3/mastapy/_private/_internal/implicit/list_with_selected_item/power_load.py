...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_PowerLoad")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_PowerLoad",)


class ListWithSelectedItem_PowerLoad(_2532.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_PowerLoad]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_PowerLoad]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2532.PowerLoad.TYPE

    @property
    def selected_value(self: "Self") -> "_2532.PowerLoad":
    ...
    @property
    def available_values(self: "Self") -> "List[_2532.PowerLoad]":
