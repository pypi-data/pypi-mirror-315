...
class EnumWithSelectedValue_ElmerResultType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ElmerResultType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _183.ElmerResultType.type_()

    @property
    def selected_value(self: "Self") -> "_183.ElmerResultType":
    ...
    @property
    def available_values(self: "Self") -> "List[_183.ElmerResultType]":
