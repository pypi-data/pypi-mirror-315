...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1462.SplineFitClassType
        """
        return _1462.SplineFitClassType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_SplineFitClassType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1462.SplineFitClassType.type_()

    @property
    def selected_value(self: "Self") -> "_1462.SplineFitClassType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1462.SplineFitClassType]":
