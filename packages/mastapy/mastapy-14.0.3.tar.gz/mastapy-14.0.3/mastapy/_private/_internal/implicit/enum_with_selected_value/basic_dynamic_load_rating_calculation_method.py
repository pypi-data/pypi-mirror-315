...
from mastapy._private.bearings import _1925
...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod]",
    ) -> "_1925.BasicDynamicLoadRatingCalculationMethod":
        ...
        Returns:
            _1925.BasicDynamicLoadRatingCalculationMethod
        """
        return _1925.BasicDynamicLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1925.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1925.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1925.BasicDynamicLoadRatingCalculationMethod]":
