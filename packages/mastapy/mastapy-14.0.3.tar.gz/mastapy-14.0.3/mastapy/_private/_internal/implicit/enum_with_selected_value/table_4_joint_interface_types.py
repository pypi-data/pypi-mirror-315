...
class EnumWithSelectedValue_Table4JointInterfaceTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_Table4JointInterfaceTypes]",
    ) -> "_1498.Table4JointInterfaceTypes":
        ...
        Returns:
            _1498.Table4JointInterfaceTypes
        """
        return _1498.Table4JointInterfaceTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1498.Table4JointInterfaceTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1498.Table4JointInterfaceTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1498.Table4JointInterfaceTypes]":
