...
class Overridable_ContactRatioRequirements(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _334.ContactRatioRequirements
        """
        return _334.ContactRatioRequirements
    ...
    def implicit_type(cls: "Type[Overridable_ContactRatioRequirements]") -> "Any":
        ...
        Returns:
            Any
        """
        return _334.ContactRatioRequirements.type_()

    @property
    def value(self: "Self") -> "_334.ContactRatioRequirements":
    ...
    @property
    def override_value(self: "Self") -> "_334.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
    ...
    @property
    def calculated_value(self: "Self") -> "_334.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
