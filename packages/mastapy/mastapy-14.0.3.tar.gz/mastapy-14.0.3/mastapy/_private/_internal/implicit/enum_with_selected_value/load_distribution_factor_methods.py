...
class EnumWithSelectedValue_LoadDistributionFactorMethods(
    ...
    def wrapped_type(
        ...
        Returns:
            _1209.LoadDistributionFactorMethods
        """
        return _1209.LoadDistributionFactorMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1209.LoadDistributionFactorMethods.type_()

    @property
    def selected_value(self: "Self") -> "_1209.LoadDistributionFactorMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_1209.LoadDistributionFactorMethods]":
