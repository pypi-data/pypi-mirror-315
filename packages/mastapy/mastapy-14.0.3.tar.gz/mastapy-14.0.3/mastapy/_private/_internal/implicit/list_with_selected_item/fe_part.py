...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_FEPart")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_FEPart",)


class ListWithSelectedItem_FEPart(_2511.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_FEPart]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_FEPart]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2511.FEPart.TYPE

    @property
    def selected_value(self: "Self") -> "_2511.FEPart":
    ...
    @property
    def available_values(self: "Self") -> "List[_2511.FEPart]":
