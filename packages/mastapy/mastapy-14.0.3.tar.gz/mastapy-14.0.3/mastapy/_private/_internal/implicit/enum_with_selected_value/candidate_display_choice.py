...
class EnumWithSelectedValue_CandidateDisplayChoice(
    ...
    def wrapped_type(
        ...
        Returns:
            _928.CandidateDisplayChoice
        """
        return _928.CandidateDisplayChoice
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _928.CandidateDisplayChoice.type_()

    @property
    def selected_value(self: "Self") -> "_928.CandidateDisplayChoice":
    ...
    @property
    def available_values(self: "Self") -> "List[_928.CandidateDisplayChoice]":
