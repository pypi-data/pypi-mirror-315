...
class Overridable_UnbalancedMassInclusionOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2539.UnbalancedMassInclusionOption
        """
        return _2539.UnbalancedMassInclusionOption
    ...
    def implicit_type(cls: "Type[Overridable_UnbalancedMassInclusionOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2539.UnbalancedMassInclusionOption.type_()

    @property
    def value(self: "Self") -> "_2539.UnbalancedMassInclusionOption":
    ...
    @property
    def override_value(self: "Self") -> "_2539.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
    ...
    @property
    def calculated_value(self: "Self") -> "_2539.UnbalancedMassInclusionOption":
        """mastapy.system_model.part_model.UnbalancedMassInclusionOption
