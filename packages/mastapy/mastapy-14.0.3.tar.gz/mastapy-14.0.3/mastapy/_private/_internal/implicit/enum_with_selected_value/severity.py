...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Severity]") -> "_1845.Severity":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Severity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1845.Severity.type_()

    @property
    def selected_value(self: "Self") -> "_1845.Severity":
    ...
    @property
    def available_values(self: "Self") -> "List[_1845.Severity]":
