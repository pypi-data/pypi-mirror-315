...
class EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification]",
    ) -> "_7093.PointLoadLoadCase.ForceSpecification":
        ...
        Returns:
            _7093.PointLoadLoadCase.ForceSpecification
        """
        return _7093.PointLoadLoadCase.ForceSpecification
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7093.PointLoadLoadCase.ForceSpecification.type_()

    @property
    def selected_value(self: "Self") -> "_7093.PointLoadLoadCase.ForceSpecification":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7093.PointLoadLoadCase.ForceSpecification]":
