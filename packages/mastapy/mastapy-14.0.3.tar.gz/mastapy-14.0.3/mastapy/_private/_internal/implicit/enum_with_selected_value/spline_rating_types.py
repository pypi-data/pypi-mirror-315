...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1467.SplineRatingTypes
        """
        return _1467.SplineRatingTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_SplineRatingTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1467.SplineRatingTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1467.SplineRatingTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1467.SplineRatingTypes]":
