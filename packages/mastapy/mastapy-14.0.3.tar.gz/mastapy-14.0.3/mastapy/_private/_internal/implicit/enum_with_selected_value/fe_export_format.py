...
class EnumWithSelectedValue_FEExportFormat(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FEExportFormat]") -> "Any":
        ...
        Returns:
            Any
        """
        return _174.FEExportFormat.type_()

    @property
    def selected_value(self: "Self") -> "_174.FEExportFormat":
    ...
    @property
    def available_values(self: "Self") -> "List[_174.FEExportFormat]":
