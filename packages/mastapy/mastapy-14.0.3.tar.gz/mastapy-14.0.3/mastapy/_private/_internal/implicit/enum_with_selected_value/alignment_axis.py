...
class EnumWithSelectedValue_AlignmentAxis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_AlignmentAxis]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1541.AlignmentAxis.type_()

    @property
    def selected_value(self: "Self") -> "_1541.AlignmentAxis":
    ...
    @property
    def available_values(self: "Self") -> "List[_1541.AlignmentAxis]":
