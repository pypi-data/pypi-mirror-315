...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_T")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_T",)
T = TypeVar("T")
...
class ListWithSelectedItem_T(Generic[T], mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_T]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_T]") -> "Any":
    ...
    @property
    def selected_value(self: "Self") -> "T":
        """T
    ...
    @property
    def available_values(self: "Self") -> "List[T]":
        """List[T]
