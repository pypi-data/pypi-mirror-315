...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ListWithSelectedItem_ActiveGearSetDesignSelectionGroup"
    )
...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2573.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(
        cls: "Type[ListWithSelectedItem_ActiveGearSetDesignSelectionGroup]",
    ) -> "Any":
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2573.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: "Self") -> "_2573.ActiveGearSetDesignSelectionGroup":
