...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollerBearingProfileTypes]",
    ) -> "_1946.RollerBearingProfileTypes":
        ...
        Returns:
            _1946.RollerBearingProfileTypes
        """
        return _1946.RollerBearingProfileTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1946.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1946.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1946.RollerBearingProfileTypes]":
