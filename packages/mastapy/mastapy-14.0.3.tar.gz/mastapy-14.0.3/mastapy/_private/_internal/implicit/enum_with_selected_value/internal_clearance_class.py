...
from mastapy._private.bearings.tolerances import _1957
...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1957.InternalClearanceClass
        """
        return _1957.InternalClearanceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1957.InternalClearanceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1957.InternalClearanceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1957.InternalClearanceClass]":
