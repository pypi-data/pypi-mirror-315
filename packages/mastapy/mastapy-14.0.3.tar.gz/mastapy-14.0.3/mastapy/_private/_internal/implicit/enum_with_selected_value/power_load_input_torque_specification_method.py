...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod]",
    ) -> "_2274.PowerLoadInputTorqueSpecificationMethod":
        ...
        Returns:
            _2274.PowerLoadInputTorqueSpecificationMethod
        """
        return _2274.PowerLoadInputTorqueSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2274.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2274.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2274.PowerLoadInputTorqueSpecificationMethod]":
