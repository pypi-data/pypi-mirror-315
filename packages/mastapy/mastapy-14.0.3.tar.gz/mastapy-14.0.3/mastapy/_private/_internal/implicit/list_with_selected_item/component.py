...
class ListWithSelectedItem_Component(_2502.Component, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_Component]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_Component]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2502.Component.TYPE

    @property
    def selected_value(self: "Self") -> "_2502.Component":
    ...
    @property
    def available_values(self: "Self") -> "List[_2502.Component]":
