...
class Overridable_DQAxisConvention(mixins.OverridableMixin, Enum):
    ...
    def implicit_type(cls: "Type[Overridable_DQAxisConvention]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1302.DQAxisConvention.type_()

    @property
    def value(self: "Self") -> "_1302.DQAxisConvention":
    ...
    @property
    def override_value(self: "Self") -> "_1302.DQAxisConvention":
        """mastapy.electric_machines.DQAxisConvention
    ...
    @property
    def calculated_value(self: "Self") -> "_1302.DQAxisConvention":
        """mastapy.electric_machines.DQAxisConvention
