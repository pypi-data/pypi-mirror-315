...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod]",
    ) -> "_1926.BasicStaticLoadRatingCalculationMethod":
        ...
        Returns:
            _1926.BasicStaticLoadRatingCalculationMethod
        """
        return _1926.BasicStaticLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1926.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1926.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1926.BasicStaticLoadRatingCalculationMethod]":
