...
from mastapy._private.detailed_rigid_connectors.splines import _1444
...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption]",
    ) -> "_1444.DudleyEffectiveLengthApproximationOption":
        ...
        Returns:
            _1444.DudleyEffectiveLengthApproximationOption
        """
        return _1444.DudleyEffectiveLengthApproximationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1444.DudleyEffectiveLengthApproximationOption.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1444.DudleyEffectiveLengthApproximationOption]":
