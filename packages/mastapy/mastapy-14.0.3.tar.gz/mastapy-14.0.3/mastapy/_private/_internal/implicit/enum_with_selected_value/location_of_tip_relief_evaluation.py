...
class EnumWithSelectedValue_LocationOfTipReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfTipReliefEvaluation]",
    ) -> "_589.LocationOfTipReliefEvaluation":
        ...
        Returns:
            _589.LocationOfTipReliefEvaluation
        """
        return _589.LocationOfTipReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _589.LocationOfTipReliefEvaluation.type_()

    @property
    def selected_value(self: "Self") -> "_589.LocationOfTipReliefEvaluation":
    ...
    @property
    def available_values(self: "Self") -> "List[_589.LocationOfTipReliefEvaluation]":
