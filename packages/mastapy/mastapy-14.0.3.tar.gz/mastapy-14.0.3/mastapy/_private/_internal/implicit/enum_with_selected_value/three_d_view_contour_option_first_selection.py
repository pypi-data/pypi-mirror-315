...
from mastapy._private.utility.enums import _1877
...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection]",
    ) -> "_1877.ThreeDViewContourOptionFirstSelection":
        ...
        Returns:
            _1877.ThreeDViewContourOptionFirstSelection
        """
        return _1877.ThreeDViewContourOptionFirstSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1877.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: "Self") -> "_1877.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1877.ThreeDViewContourOptionFirstSelection]":
