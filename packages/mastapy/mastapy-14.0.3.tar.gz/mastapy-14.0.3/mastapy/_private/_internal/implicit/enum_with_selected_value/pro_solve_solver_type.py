...
from mastapy._private.fe_tools.vfx_tools.vfx_enums import _1281
...
class EnumWithSelectedValue_ProSolveSolverType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1281.ProSolveSolverType
        """
        return _1281.ProSolveSolverType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ProSolveSolverType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1281.ProSolveSolverType.type_()

    @property
    def selected_value(self: "Self") -> "_1281.ProSolveSolverType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1281.ProSolveSolverType]":
