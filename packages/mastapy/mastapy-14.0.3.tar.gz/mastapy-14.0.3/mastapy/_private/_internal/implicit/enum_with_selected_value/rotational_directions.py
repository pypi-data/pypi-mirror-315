...
class EnumWithSelectedValue_RotationalDirections(
    ...
    def wrapped_type(
        ...
        Returns:
            _1952.RotationalDirections
        """
        return _1952.RotationalDirections
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RotationalDirections]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1952.RotationalDirections.type_()

    @property
    def selected_value(self: "Self") -> "_1952.RotationalDirections":
    ...
    @property
    def available_values(self: "Self") -> "List[_1952.RotationalDirections]":
