...
from mastapy._private.detailed_rigid_connectors.splines import _1468
...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_SplineToleranceClassTypes]",
    ) -> "_1468.SplineToleranceClassTypes":
        ...
        Returns:
            _1468.SplineToleranceClassTypes
        """
        return _1468.SplineToleranceClassTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1468.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1468.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1468.SplineToleranceClassTypes]":
