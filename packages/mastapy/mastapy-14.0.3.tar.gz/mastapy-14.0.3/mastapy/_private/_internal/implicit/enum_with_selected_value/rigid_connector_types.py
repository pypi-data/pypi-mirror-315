...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    def wrapped_type(
        ...
        Returns:
            _2659.RigidConnectorTypes
        """
        return _2659.RigidConnectorTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_RigidConnectorTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2659.RigidConnectorTypes.type_()

    @property
    def selected_value(self: "Self") -> "_2659.RigidConnectorTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_2659.RigidConnectorTypes]":
