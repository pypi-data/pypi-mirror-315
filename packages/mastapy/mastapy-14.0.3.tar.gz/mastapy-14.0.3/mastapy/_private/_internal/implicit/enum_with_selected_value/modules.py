...
class EnumWithSelectedValue_Modules(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Modules]") -> "_1453.Modules":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Modules]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1453.Modules.type_()

    @property
    def selected_value(self: "Self") -> "_1453.Modules":
    ...
    @property
    def available_values(self: "Self") -> "List[_1453.Modules]":
