...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2658.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2658.RigidConnectorToothSpacingType
        """
        return _2658.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2658.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: "Self") -> "_2658.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2658.RigidConnectorToothSpacingType]":
