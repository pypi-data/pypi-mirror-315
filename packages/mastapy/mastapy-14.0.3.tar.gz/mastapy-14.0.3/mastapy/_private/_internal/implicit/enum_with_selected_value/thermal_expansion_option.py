...
from mastapy._private.system_model.fe import _2469
...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _2469.ThermalExpansionOption
        """
        return _2469.ThermalExpansionOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2469.ThermalExpansionOption.type_()

    @property
    def selected_value(self: "Self") -> "_2469.ThermalExpansionOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2469.ThermalExpansionOption]":
