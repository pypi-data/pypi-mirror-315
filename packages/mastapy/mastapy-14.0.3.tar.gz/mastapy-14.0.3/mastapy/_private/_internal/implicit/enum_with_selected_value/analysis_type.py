...
class EnumWithSelectedValue_AnalysisType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_AnalysisType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6970.AnalysisType.type_()

    @property
    def selected_value(self: "Self") -> "_6970.AnalysisType":
    ...
    @property
    def available_values(self: "Self") -> "List[_6970.AnalysisType]":
