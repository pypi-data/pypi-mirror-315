...
class EnumWithSelectedValue_CoilPositionInSlot(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1296.CoilPositionInSlot
        """
        return _1296.CoilPositionInSlot
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CoilPositionInSlot]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1296.CoilPositionInSlot.type_()

    @property
    def selected_value(self: "Self") -> "_1296.CoilPositionInSlot":
    ...
    @property
    def available_values(self: "Self") -> "List[_1296.CoilPositionInSlot]":
