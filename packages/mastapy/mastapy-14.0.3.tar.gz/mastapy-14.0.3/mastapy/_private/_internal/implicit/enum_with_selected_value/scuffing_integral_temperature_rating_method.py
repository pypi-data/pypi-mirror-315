...
from mastapy._private.gears.rating.cylindrical import _495
...
class EnumWithSelectedValue_ScuffingIntegralTemperatureRatingMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _495.ScuffingIntegralTemperatureRatingMethod
        """
        return _495.ScuffingIntegralTemperatureRatingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _495.ScuffingIntegralTemperatureRatingMethod.type_()

    @property
    def selected_value(self: "Self") -> "_495.ScuffingIntegralTemperatureRatingMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_495.ScuffingIntegralTemperatureRatingMethod]":
