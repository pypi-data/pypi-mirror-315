...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_ElectricMachineDataSet")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_ElectricMachineDataSet",)


class ListWithSelectedItem_ElectricMachineDataSet(
    _2431.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_ElectricMachineDataSet]") -> "Any":
    ...
    @classmethod
    def implicit_type(
        cls: "Type[ListWithSelectedItem_ElectricMachineDataSet]",
    ) -> "Any":
        ...
        Returns:
            Any
        """
        return _2431.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2431.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2431.ElectricMachineDataSet]":
