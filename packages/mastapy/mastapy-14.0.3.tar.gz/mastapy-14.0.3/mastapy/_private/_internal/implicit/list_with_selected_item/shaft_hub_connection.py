...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_ShaftHubConnection")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_ShaftHubConnection",)


class ListWithSelectedItem_ShaftHubConnection(
    _2662.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2662.ShaftHubConnection.TYPE

    @property
    def selected_value(self: "Self") -> "_2662.ShaftHubConnection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2662.ShaftHubConnection]":
