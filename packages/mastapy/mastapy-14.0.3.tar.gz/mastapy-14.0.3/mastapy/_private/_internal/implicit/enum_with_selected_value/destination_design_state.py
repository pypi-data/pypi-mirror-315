...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7146.DestinationDesignState
        """
        return _7146.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7146.DestinationDesignState.type_()

    @property
    def selected_value(self: "Self") -> "_7146.DestinationDesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_7146.DestinationDesignState]":
