...
from mastapy._private.fe_tools.enums import _1283
...
class EnumWithSelectedValue_MaterialPropertyClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1283.MaterialPropertyClass
        """
        return _1283.MaterialPropertyClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1283.MaterialPropertyClass.type_()

    @property
    def selected_value(self: "Self") -> "_1283.MaterialPropertyClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1283.MaterialPropertyClass]":
