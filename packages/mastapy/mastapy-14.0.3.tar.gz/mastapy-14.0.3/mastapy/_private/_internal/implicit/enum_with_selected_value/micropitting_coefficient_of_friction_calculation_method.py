...
class EnumWithSelectedValue_MicropittingCoefficientOfFrictionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_MicropittingCoefficientOfFrictionCalculationMethod]",
    ) -> "_350.MicropittingCoefficientOfFrictionCalculationMethod":
        ...
        Returns:
            _350.MicropittingCoefficientOfFrictionCalculationMethod
        """
        return _350.MicropittingCoefficientOfFrictionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _350.MicropittingCoefficientOfFrictionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_350.MicropittingCoefficientOfFrictionCalculationMethod]":
