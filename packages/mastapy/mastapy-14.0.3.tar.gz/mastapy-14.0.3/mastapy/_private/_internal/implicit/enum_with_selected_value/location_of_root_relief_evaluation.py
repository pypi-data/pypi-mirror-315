...
class EnumWithSelectedValue_LocationOfRootReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfRootReliefEvaluation]",
    ) -> "_588.LocationOfRootReliefEvaluation":
        ...
        Returns:
            _588.LocationOfRootReliefEvaluation
        """
        return _588.LocationOfRootReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _588.LocationOfRootReliefEvaluation.type_()

    @property
    def selected_value(self: "Self") -> "_588.LocationOfRootReliefEvaluation":
    ...
    @property
    def available_values(self: "Self") -> "List[_588.LocationOfRootReliefEvaluation]":
