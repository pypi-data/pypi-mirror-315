...
from mastapy._private.fe_tools.vfx_tools.vfx_enums import _1280
...
class EnumWithSelectedValue_ProSolveMpcType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ProSolveMpcType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1280.ProSolveMpcType.type_()

    @property
    def selected_value(self: "Self") -> "_1280.ProSolveMpcType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1280.ProSolveMpcType]":
