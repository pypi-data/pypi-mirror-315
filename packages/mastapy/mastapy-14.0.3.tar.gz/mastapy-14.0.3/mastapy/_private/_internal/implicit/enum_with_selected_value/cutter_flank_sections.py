...
class EnumWithSelectedValue_CutterFlankSections(
    ...
    def wrapped_type(
        ...
        Returns:
            _634.CutterFlankSections
        """
        return _634.CutterFlankSections
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CutterFlankSections]") -> "Any":
        ...
        Returns:
            Any
        """
        return _634.CutterFlankSections.type_()

    @property
    def selected_value(self: "Self") -> "_634.CutterFlankSections":
    ...
    @property
    def available_values(self: "Self") -> "List[_634.CutterFlankSections]":
