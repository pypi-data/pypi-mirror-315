...
from mastapy._private.math_utility.optimisation import _1589
...
class _Cast_Optimisable:
    ...
    @property
    def abstract_optimisable(self: "CastSelf") -> "_1589.AbstractOptimisable":
        return self.__parent__._cast(_1589.AbstractOptimisable)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Optimisable(_1589.AbstractOptimisable):
    """Optimisable
