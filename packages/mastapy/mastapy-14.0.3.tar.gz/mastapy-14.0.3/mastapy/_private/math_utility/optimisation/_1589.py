...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1592
...
class _Cast_AbstractOptimisable:
    ...
    @property
    def optimisable(self: "CastSelf") -> "_1592.Optimisable":
        from mastapy._private.math_utility.optimisation import _1592

        return self.__parent__._cast(_1592.Optimisable)
