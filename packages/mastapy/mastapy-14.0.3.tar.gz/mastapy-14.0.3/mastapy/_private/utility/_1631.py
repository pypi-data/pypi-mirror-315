...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1630, _1644
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: "Self") -> "_1644.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: "Self") -> "List[_1630.DispatcherHelper]":
