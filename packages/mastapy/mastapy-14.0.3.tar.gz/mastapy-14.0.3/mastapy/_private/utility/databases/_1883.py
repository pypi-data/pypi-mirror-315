...
from mastapy._private.utility.databases import _1885, _1886
...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.databases import _1879, _1884

    Self = TypeVar("Self", bound="NamedDatabase")
    CastSelf = TypeVar("CastSelf", bound="NamedDatabase._Cast_NamedDatabase")

TValue = TypeVar("TValue", bound="_1884.NamedDatabaseItem")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class NamedDatabase(_1886.SQLDatabase[_1885.NamedKey, TValue]):
    """NamedDatabase
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_name: "str", item: "_1884.NamedDatabaseItem"
    ) -> "_1884.NamedDatabaseItem":
    ...
    @enforce_parameter_types
    def rename(
        self: "Self", item: "_1884.NamedDatabaseItem", new_name: "str"
    ) -> "bool":
        """bool
