...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CustomReportChartItem(_1826.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    @property
    def point_shape(self: "Self") -> "_1802.SMTChartPointShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1802", "SMTChartPointShape"
        )(value)

    @point_shape.setter
    @enforce_parameter_types
    def point_shape(self: "Self", value: "_1802.SMTChartPointShape") -> None:
