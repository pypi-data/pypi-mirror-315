...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @enforce_parameter_types
    def selected_version(self: "Self", value: "_1652.SystemDirectory") -> None:
        wrapper_type = (
    ...
    @property
    def current_version(self: "Self") -> "_1652.SystemDirectory":
    ...
    @property
    def version_to_copy(self: "Self") -> "_1652.SystemDirectory":
        """mastapy.utility.SystemDirectory
