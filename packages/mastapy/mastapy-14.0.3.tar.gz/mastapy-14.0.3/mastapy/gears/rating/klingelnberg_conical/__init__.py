...
if __tc:
    ...
    from mastapy._private.gears.rating.klingelnberg_conical._425 import (
        KlingelnbergCycloPalloidConicalGearRating,
    )
    from mastapy._private.gears.rating.klingelnberg_conical._426 import (
    ...
    __import_structure = {
        ...
        "_private.gears.rating.klingelnberg_conical._425": [
            "KlingelnbergCycloPalloidConicalGearRating"
        ],
        "_private.gears.rating.klingelnberg_conical._426": [
            "KlingelnbergCycloPalloidConicalGearSetRating"
        ],
    }
