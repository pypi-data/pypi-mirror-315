...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis.gears import _1853, _1862
...
class _Cast_OrderWithRadius:
    ...
    @property
    def order_for_te(self: "CastSelf") -> "_1857.OrderForTE":
        return self.__parent__._cast(_1857.OrderForTE)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OrderWithRadius(_1857.OrderForTE):
    """OrderWithRadius
