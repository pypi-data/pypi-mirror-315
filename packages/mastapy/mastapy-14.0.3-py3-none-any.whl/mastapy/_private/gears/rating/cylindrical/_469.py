...
class _Cast_CylindricalGearFlankDutyCycleRating:
    ...
    @property
    def gear_flank_rating(self: "CastSelf") -> "_371.GearFlankRating":
        return self.__parent__._cast(_371.GearFlankRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearFlankDutyCycleRating(_371.GearFlankRating):
    """CylindricalGearFlankDutyCycleRating
