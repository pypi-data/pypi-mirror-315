...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="VDI2736PlasticPlasticRateableMesh._Cast_VDI2736PlasticPlasticRateableMesh",
    )
...
class _Cast_VDI2736PlasticPlasticRateableMesh:
    ...
    __parent__: "VDI2736PlasticPlasticRateableMesh"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class VDI2736PlasticPlasticRateableMesh(_506.PlasticGearVDI2736AbstractRateableMesh):
    """VDI2736PlasticPlasticRateableMesh

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _VDI2736_PLASTIC_PLASTIC_RATEABLE_MESH
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_VDI2736PlasticPlasticRateableMesh":
        """Cast to another type.

        Returns:
            _Cast_VDI2736PlasticPlasticRateableMesh
        """
        return _Cast_VDI2736PlasticPlasticRateableMesh(self)
