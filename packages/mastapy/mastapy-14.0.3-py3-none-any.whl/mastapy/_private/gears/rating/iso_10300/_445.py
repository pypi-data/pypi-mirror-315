...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.conical import _556
...
class _Cast_ISO10300SingleFlankRatingMethodB1:
    ...
    def conical_gear_single_flank_rating(
        self: "CastSelf",
    ) -> "_556.ConicalGearSingleFlankRating":
        from mastapy._private.gears.rating.conical import _556

        return self.__parent__._cast(_556.ConicalGearSingleFlankRating)
...
class ISO10300SingleFlankRatingMethodB1(
    _442.ISO10300SingleFlankRating[_403.VirtualCylindricalGearISO10300MethodB1]
):
    """ISO10300SingleFlankRatingMethodB1
    ...
    def relative_surface_condition_factor_for_grey_cast_iron_nitrided_and_nitro_carburized_steels_1_mum_mean_roughness_40_mum(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "RelativeSurfaceConditionFactorForGreyCastIronNitridedAndNitroCarburizedSteels1MumMeanRoughness40Mum",
        )
    ...
    def relative_surface_condition_factor_for_grey_cast_iron_nitrided_and_nitro_carburized_steels_mean_roughness_1_mum(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "RelativeSurfaceConditionFactorForGreyCastIronNitridedAndNitroCarburizedSteelsMeanRoughness1Mum",
        )
    ...
    def relative_surface_condition_factor_for_non_hardened_steels_1_mum_mean_roughness_40_mum(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "RelativeSurfaceConditionFactorForNonHardenedSteels1MumMeanRoughness40Mum",
        )
    ...
    def relative_surface_condition_factor_for_non_hardened_steels_mean_roughness_1_mum(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "RelativeSurfaceConditionFactorForNonHardenedSteelsMeanRoughness1Mum",
        )
    ...
    def relative_surface_condition_factor_for_through_hardened_and_case_hardened_steels_1_mum_mean_roughness_40_mum(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "RelativeSurfaceConditionFactorForThroughHardenedAndCaseHardenedSteels1MumMeanRoughness40Mum",
        )
    ...
    def relative_surface_condition_factor_for_through_hardened_and_case_hardened_steels_mean_roughness_1_mum(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "RelativeSurfaceConditionFactorForThroughHardenedAndCaseHardenedSteelsMeanRoughness1Mum",
        )
