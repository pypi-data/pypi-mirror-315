...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.zerol_bevel import _382, _383
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetRating(_569.BevelGearSetRating):
    """ZerolBevelGearSetRating
    ...
    @property
    def zerol_bevel_mesh_ratings(self: "Self") -> "List[_382.ZerolBevelGearMeshRating]":
