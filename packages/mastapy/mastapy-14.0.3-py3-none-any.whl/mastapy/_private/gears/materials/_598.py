...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.materials import _600, _601
...
T = TypeVar("T", bound="_601.BevelGearMaterial")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelGearAbstractMaterialDatabase(_283.MaterialDatabase[T]):
    """BevelGearAbstractMaterialDatabase
