...
class _Cast_CylindricalGearRootFilletStressResults:
    ...
    def gear_root_fillet_stress_results(
        self: "CastSelf",
    ) -> "_870.GearRootFilletStressResults":
        return self.__parent__._cast(_870.GearRootFilletStressResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearRootFilletStressResults(_870.GearRootFilletStressResults):
    """CylindricalGearRootFilletStressResults
