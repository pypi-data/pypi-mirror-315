...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ParetoHypoidGearSetOptimisationStrategyDatabase._Cast_ParetoHypoidGearSetOptimisationStrategyDatabase",
    )
...
class _Cast_ParetoHypoidGearSetOptimisationStrategyDatabase:
    ...
    __parent__: "ParetoHypoidGearSetOptimisationStrategyDatabase"
...
class ParetoHypoidGearSetOptimisationStrategyDatabase(
    ...
    TYPE: ClassVar["Type"] = _PARETO_HYPOID_GEAR_SET_OPTIMISATION_STRATEGY_DATABASE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ParetoHypoidGearSetOptimisationStrategyDatabase":
        """Cast to another type.

        Returns:
            _Cast_ParetoHypoidGearSetOptimisationStrategyDatabase
        """
        return _Cast_ParetoHypoidGearSetOptimisationStrategyDatabase(self)
