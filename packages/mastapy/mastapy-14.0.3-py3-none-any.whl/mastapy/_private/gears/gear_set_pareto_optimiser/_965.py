...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetParetoOptimiser(_937.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: "Self") -> "_989.StraightBevelGearSetDesign":
    ...
    def all_candidate_gear_sets(
        self: "Self",
    ) -> "List[_989.StraightBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: "Self") -> "List[_989.StraightBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel.StraightBevelGearSetDesign]
