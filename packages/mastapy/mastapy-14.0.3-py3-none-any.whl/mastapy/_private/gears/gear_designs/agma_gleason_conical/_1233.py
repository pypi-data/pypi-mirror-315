...
from mastapy._private.gears.gear_designs.conical import _1194, _1197, _1198
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs import _973, _974
    from mastapy._private.gears.gear_designs.bevel import _1220
    from mastapy._private.gears.gear_designs.conical import _1193, _1204
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMAGleasonConicalGearDesign(_1194.ConicalGearDesign):
    """AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self: "Self") -> "_1204.FrontEndTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.conical._1204", "FrontEndTypes"
        )(value)

    @front_end_type.setter
    @enforce_parameter_types
    def front_end_type(self: "Self", value: "_1204.FrontEndTypes") -> None:
    ...
    @enforce_parameter_types
    def machine_setting_calculation_method(
        self: "Self", value: "_1197.ConicalMachineSettingCalculationMethods"
    ) -> None:
    ...
    @enforce_parameter_types
    def manufacture_method(
        self: "Self", value: "_1198.ConicalManufactureMethods"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def accuracy_grades(self: "Self") -> "_326.AccuracyGrades":
    ...
    @property
    def bevel_gear_material(self: "Self") -> "_610.GearMaterial":
    ...
    @property
    def cutter(self: "Self") -> "_1193.ConicalGearCutter":
