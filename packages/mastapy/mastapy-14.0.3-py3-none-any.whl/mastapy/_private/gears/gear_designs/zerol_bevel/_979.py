...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.zerol_bevel import _978, _980, _981
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearMeshDesign(_1221.BevelGearMeshDesign):
    """ZerolBevelGearMeshDesign
    ...
    @property
    def zerol_bevel_gear_set(self: "Self") -> "_980.ZerolBevelGearSetDesign":
    ...
    def zerol_bevel_meshed_gears(
        self: "Self",
    ) -> "List[_981.ZerolBevelMeshedGearDesign]":
