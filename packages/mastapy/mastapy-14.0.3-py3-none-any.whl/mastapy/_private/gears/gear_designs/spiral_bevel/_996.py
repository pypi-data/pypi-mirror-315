...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.spiral_bevel import _995, _997, _998
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearMeshDesign(_1221.BevelGearMeshDesign):
    """SpiralBevelGearMeshDesign
    ...
    def spiral_bevel_meshed_gears(
        self: "Self",
    ) -> "List[_998.SpiralBevelMeshedGearDesign]":
