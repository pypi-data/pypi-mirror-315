...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.straight_bevel import _987, _989, _990
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearMeshDesign(_1221.BevelGearMeshDesign):
    """StraightBevelGearMeshDesign
    ...
    @property
    def straight_bevel_gear_set(self: "Self") -> "_989.StraightBevelGearSetDesign":
    ...
    def straight_bevel_meshed_gears(
        self: "Self",
    ) -> "List[_990.StraightBevelMeshedGearDesign]":
