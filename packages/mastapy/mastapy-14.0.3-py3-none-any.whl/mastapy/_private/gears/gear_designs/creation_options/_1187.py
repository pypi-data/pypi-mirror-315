...
T = TypeVar("T", bound="_976.GearSetDesign")
...
class _Cast_GearSetCreationOptions:
    ...
    def cylindrical_gear_pair_creation_options(
        ...
        from mastapy._private.gears.gear_designs.creation_options import _1186

        return self.__parent__._cast(_1186.CylindricalGearPairCreationOptions)

    @property
    def hypoid_gear_set_creation_options(
        self: "CastSelf",
    ) -> "_1188.HypoidGearSetCreationOptions":
        from mastapy._private.gears.gear_designs.creation_options import _1188

        return self.__parent__._cast(_1188.HypoidGearSetCreationOptions)

    @property
    def spiral_bevel_gear_set_creation_options(
        self: "CastSelf",
    ) -> "_1189.SpiralBevelGearSetCreationOptions":
        from mastapy._private.gears.gear_designs.creation_options import _1189

        return self.__parent__._cast(_1189.SpiralBevelGearSetCreationOptions)
