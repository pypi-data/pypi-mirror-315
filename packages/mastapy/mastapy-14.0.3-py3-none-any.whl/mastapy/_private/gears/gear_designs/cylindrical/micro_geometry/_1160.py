...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ModificationForCustomer102CAD._Cast_ModificationForCustomer102CAD",
    )
...
class _Cast_ModificationForCustomer102CAD:
    ...
    __parent__: "ModificationForCustomer102CAD"

    @property
    def lead_modification_for_customer_102cad(
        self: "CastSelf",
    ) -> "_1149.LeadModificationForCustomer102CAD":
        from mastapy._private.gears.gear_designs.cylindrical.micro_geometry import _1149

        return self.__parent__._cast(_1149.LeadModificationForCustomer102CAD)

    @property
    def profile_modification_for_customer_102cad(
        self: "CastSelf",
    ) -> "_1163.ProfileModificationForCustomer102CAD":
        from mastapy._private.gears.gear_designs.cylindrical.micro_geometry import _1163

        return self.__parent__._cast(_1163.ProfileModificationForCustomer102CAD)
...
class ModificationForCustomer102CAD(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _MODIFICATION_FOR_CUSTOMER_102CAD
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ModificationForCustomer102CAD":
        """Cast to another type.

        Returns:
            _Cast_ModificationForCustomer102CAD
        """
        return _Cast_ModificationForCustomer102CAD(self)
