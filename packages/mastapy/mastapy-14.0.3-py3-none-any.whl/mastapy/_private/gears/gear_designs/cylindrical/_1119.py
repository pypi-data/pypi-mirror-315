...
class _Cast_ToothThicknessSpecification:
    ...
    def tooth_thickness_specification_base(
        self: "CastSelf",
    ) -> "_1120.ToothThicknessSpecificationBase":
        return self.__parent__._cast(_1120.ToothThicknessSpecificationBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ToothThicknessSpecification(_1120.ToothThicknessSpecificationBase):
    """ToothThicknessSpecification
