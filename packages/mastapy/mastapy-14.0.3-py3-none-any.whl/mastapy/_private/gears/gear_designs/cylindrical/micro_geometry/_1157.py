...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeshedCylindricalGearMicroGeometry._Cast_MeshedCylindricalGearMicroGeometry",
    )
...
class _Cast_MeshedCylindricalGearMicroGeometry:
    ...
    __parent__: "MeshedCylindricalGearMicroGeometry"
...
class MeshedCylindricalGearMicroGeometry(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _MESHED_CYLINDRICAL_GEAR_MICRO_GEOMETRY
    ...
    @property
    def flanks(self: "Self") -> "List[_1156.MeshedCylindricalGearFlankMicroGeometry]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MeshedCylindricalGearMicroGeometry":
        """Cast to another type.

        Returns:
            _Cast_MeshedCylindricalGearMicroGeometry
        """
        return _Cast_MeshedCylindricalGearMicroGeometry(self)
