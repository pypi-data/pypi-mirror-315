...
from mastapy._private.gears.cylindrical import _1253
...
class _Cast_CylindricalGearLTCAContactCharts:
    ...
    @property
    def gear_ltca_contact_charts(self: "CastSelf") -> "_1253.GearLTCAContactCharts":
        return self.__parent__._cast(_1253.GearLTCAContactCharts)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearLTCAContactCharts(_1253.GearLTCAContactCharts):
    """CylindricalGearLTCAContactCharts
