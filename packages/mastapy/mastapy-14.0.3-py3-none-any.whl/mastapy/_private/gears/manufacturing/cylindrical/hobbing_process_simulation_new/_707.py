...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ProcessLeadCalculation._Cast_ProcessLeadCalculation"
    )
...
class _Cast_ProcessLeadCalculation:
    ...
    __parent__: "ProcessLeadCalculation"

    @property
    def process_lead_calculation(self: "CastSelf") -> "ProcessLeadCalculation":
...
class ProcessLeadCalculation(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _PROCESS_LEAD_CALCULATION
    ...
    def left_flank_accuracy_calculation(
        self: "Self",
    ) -> "_685.CalculateLeadDeviationAccuracy":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ProcessLeadCalculation":
        """Cast to another type.

        Returns:
            _Cast_ProcessLeadCalculation
        """
        return _Cast_ProcessLeadCalculation(self)
