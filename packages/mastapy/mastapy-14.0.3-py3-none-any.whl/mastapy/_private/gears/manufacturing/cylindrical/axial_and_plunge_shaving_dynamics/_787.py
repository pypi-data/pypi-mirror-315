...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollAngleRangeRelativeToAccuracy._Cast_RollAngleRangeRelativeToAccuracy",
    )
...
class _Cast_RollAngleRangeRelativeToAccuracy:
    ...
    __parent__: "RollAngleRangeRelativeToAccuracy"
...
class RollAngleRangeRelativeToAccuracy(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _ROLL_ANGLE_RANGE_RELATIVE_TO_ACCURACY
    ...
    def accuracy(self: "Self") -> "str":
        ...
        """
        temp = pythonnet_property_get(self.wrapped, "Accuracy")
    ...
    @property
    def roll_angle_range(self: "Self") -> "List[_788.RollAngleReportObject]":
        """List[mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics.RollAngleReportObject]

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "RollAngleRange")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollAngleRangeRelativeToAccuracy":
        """Cast to another type.

        Returns:
            _Cast_RollAngleRangeRelativeToAccuracy
        """
        return _Cast_RollAngleRangeRelativeToAccuracy(self)
