...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HobbingProcessLeadCalculation._Cast_HobbingProcessLeadCalculation",
    )
...
class _Cast_HobbingProcessLeadCalculation:
    ...
    __parent__: "HobbingProcessLeadCalculation"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HobbingProcessLeadCalculation(_691.HobbingProcessCalculation):
    """HobbingProcessLeadCalculation

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _HOBBING_PROCESS_LEAD_CALCULATION
    ...
    @property
    def left_flank_lead_modification_chart(self: "Self") -> "_1922.TwoDChartDefinition":
    ...
    @property
    def left_flank(self: "Self") -> "_685.CalculateLeadDeviationAccuracy":
    ...
    @property
    def right_flank(self: "Self") -> "_685.CalculateLeadDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateLeadDeviationAccuracy
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HobbingProcessLeadCalculation":
        """Cast to another type.

        Returns:
            _Cast_HobbingProcessLeadCalculation
        """
        return _Cast_HobbingProcessLeadCalculation(self)
