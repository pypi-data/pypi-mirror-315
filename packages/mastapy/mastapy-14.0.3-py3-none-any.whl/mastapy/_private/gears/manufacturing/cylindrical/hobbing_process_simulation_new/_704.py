...
class _Cast_MountingError:
    ...
    @property
    def gear_mounting_error(self: "CastSelf") -> "_690.GearMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _690,
        )

        return self.__parent__._cast(_690.GearMountingError)

    @property
    def rack_mounting_error(self: "CastSelf") -> "_715.RackMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _715,
        )

        return self.__parent__._cast(_715.RackMountingError)
