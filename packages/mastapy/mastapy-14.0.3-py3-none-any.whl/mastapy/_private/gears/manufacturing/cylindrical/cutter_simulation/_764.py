...
class _Cast_GearCutterSimulation:
    ...
    @property
    def finish_cutter_simulation(self: "CastSelf") -> "_761.FinishCutterSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _761,
        )

        return self.__parent__._cast(_761.FinishCutterSimulation)

    @property
    def rough_cutter_simulation(self: "CastSelf") -> "_769.RoughCutterSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _769,
        )

        return self.__parent__._cast(_769.RoughCutterSimulation)
...
class GearCutterSimulation(_0.APIBase):
    ...
    @property
    def average_thickness(self: "Self") -> "_756.CutterSimulationCalc":
    ...
    @property
    def average_thickness_virtual(self: "Self") -> "_772.VirtualSimulationCalculator":
    ...
    @property
    def least_profile(self: "Self") -> "_756.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    def least_profile_virtual(self: "Self") -> "_772.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    def maximum_thickness(self: "Self") -> "_756.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    def maximum_thickness_virtual(self: "Self") -> "_772.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    def minimum_thickness(self: "Self") -> "_756.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    def minimum_thickness_virtual(self: "Self") -> "_772.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    def gear_mesh_cutter_simulations(
        self: "Self",
    ) -> "List[_759.CylindricalManufacturedRealGearInMesh]":
    ...
    def gear_mesh_cutter_simulations_virtual(
        self: "Self",
    ) -> "List[_760.CylindricalManufacturedVirtualGearInMesh]":
    ...
    @property
    def thickness_calculators(self: "Self") -> "List[_756.CutterSimulationCalc]":
    ...
    def virtual_thickness_calculators(
        self: "Self",
    ) -> "List[_772.VirtualSimulationCalculator]":
