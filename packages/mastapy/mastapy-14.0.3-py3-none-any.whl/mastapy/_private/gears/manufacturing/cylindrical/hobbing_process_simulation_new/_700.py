...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HobbingProcessTotalModificationCalculation(_691.HobbingProcessCalculation):
    """HobbingProcessTotalModificationCalculation
    ...
    @property
    def total_errors_chart_left_flank(self: "Self") -> "_1920.ThreeDChartDefinition":
    ...
    @property
    def total_errors_chart_right_flank(self: "Self") -> "_1920.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
