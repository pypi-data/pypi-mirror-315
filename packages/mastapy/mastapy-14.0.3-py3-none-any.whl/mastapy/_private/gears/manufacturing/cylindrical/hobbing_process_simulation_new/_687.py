...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CalculateProfileDeviationAccuracy._Cast_CalculateProfileDeviationAccuracy",
    )
...
class _Cast_CalculateProfileDeviationAccuracy:
    ...
    __parent__: "CalculateProfileDeviationAccuracy"
...
class CalculateProfileDeviationAccuracy(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CALCULATE_PROFILE_DEVIATION_ACCURACY
    ...
    def achieved_profile_agma20151a01_quality_grade(self: "Self") -> "float":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "AchievedProfileAGMA20151A01QualityGrade"
        )
    ...
    def achieved_profile_iso132811995e_quality_grade(self: "Self") -> "float":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "AchievedProfileISO132811995EQualityGrade"
        )
    ...
    def profile_deviation_agma20151a01_quality_grade_designed(self: "Self") -> "float":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "ProfileDeviationAGMA20151A01QualityGradeDesigned"
        )
    ...
    def profile_deviation_iso132811995e_quality_grade_designed(self: "Self") -> "float":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "ProfileDeviationISO132811995EQualityGradeDesigned"
        )
    ...
    def profile_form_deviation_agma20151a01_quality_grade_obtained(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "ProfileFormDeviationAGMA20151A01QualityGradeObtained"
        )
    ...
    def profile_form_deviation_iso132811995e_quality_grade_obtained(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "ProfileFormDeviationISO132811995EQualityGradeObtained"
        )
    ...
    def profile_slope_deviation_agma20151a01_quality_grade_obtained(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "ProfileSlopeDeviationAGMA20151A01QualityGradeObtained"
        )
    ...
    def profile_slope_deviation_iso132811995e_quality_grade_obtained(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "ProfileSlopeDeviationISO132811995EQualityGradeObtained"
        )
    ...
    def total_profile_deviation_agma20151a01_quality_grade_obtained(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "TotalProfileDeviationAGMA20151A01QualityGradeObtained"
        )
    ...
    def total_profile_deviation_iso132811995e_quality_grade_obtained(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "TotalProfileDeviationISO132811995EQualityGradeObtained"
        )
    ...
    def manufactured_agma20151a01_quality_grades(
        self: "Self",
    ) -> "List[_703.ManufacturedQualityGrade]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CalculateProfileDeviationAccuracy":
        """Cast to another type.

        Returns:
            _Cast_CalculateProfileDeviationAccuracy
        """
        return _Cast_CalculateProfileDeviationAccuracy(self)
