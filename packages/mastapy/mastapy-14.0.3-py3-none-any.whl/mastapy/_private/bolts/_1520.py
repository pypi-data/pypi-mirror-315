...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltMaterial(_1516.BoltedJointMaterial):
    """BoltMaterial
    ...
    @property
    def strength_grade(self: "Self") -> "_1535.StrengthGrades":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bolts._1535", "StrengthGrades"
        )(value)

    @strength_grade.setter
    @enforce_parameter_types
    def strength_grade(self: "Self", value: "_1535.StrengthGrades") -> None:
