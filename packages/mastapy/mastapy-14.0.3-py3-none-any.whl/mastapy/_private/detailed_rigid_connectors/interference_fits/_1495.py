...
from mastapy._private.detailed_rigid_connectors.interference_fits import _1498
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class InterferenceFitDesign(_1437.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    @property
    def assembly_method(self: "Self") -> "_1493.AssemblyMethods":
    ...
    def assembly_method(self: "Self", value: "_1493.AssemblyMethods") -> None:
    ...
    @property
    def calculation_method(self: "Self") -> "_1494.CalculationMethods":
    ...
    @enforce_parameter_types
    def calculation_method(self: "Self", value: "_1494.CalculationMethods") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods",
        )
    ...
    @enforce_parameter_types
    def joint_interface_type(
        self: "Self", value: "_1498.Table4JointInterfaceTypes"
    ) -> None:
