...
class _Cast_DataLoggerWithCharts:
    ...
    @property
    def data_logger(self: "CastSelf") -> "_1626.DataLogger":
        return self.__parent__._cast(_1626.DataLogger)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DataLoggerWithCharts(_1626.DataLogger):
    """DataLoggerWithCharts
    ...
    @property
    def logged_items(self: "Self") -> "List[_1904.DataLoggerItem]":
