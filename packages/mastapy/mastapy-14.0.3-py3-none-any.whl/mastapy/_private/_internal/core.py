...
if TYPE_CHECKING:
    ...
    Self_EnvironmentSummary = TypeVar("Self_EnvironmentSummary", "EnvironmentSummary")
...
from mastapy._private._internal.mastapy_version_exception import MastapyVersionException
...
from mastapy._private._internal.utility import StrEnum, qualname
...
class EnvironmentSummary:
    ...
    def is_valid_linux_configuration(self: "Self_EnvironmentSummary") -> bool:
        ...
        return (
            ...
            and self.dotnet_version is DotNetVersion.NET6
        )
    ...
    def __post_init__(self: "Self_EnvironmentSummary") -> None:
        ...
        dotnet_version = (
            DotNetVersion.NET6 if os.path.isfile(path_to_deps) else DotNetVersion.NET462
        )
...
class MastaPropertyMultiMethod(dict):
    ...
    def setter(self, func):
        ...
        if using_pythonnet3 and setter_value_type is int:
    ...
    def _masta_property_decorator(func):
        ...
        if parameter:
            ...
            if hasattr(returns, "__mro__") and Image.Image in returns.__mro__:
                from mastapy._private._internal.conversion import mp_to_pn_smt_bitmap
...
def _init_runtime_setup(environment_summary: EnvironmentSummary) -> DllPaths:
    ...
    if python_version in SpecifierSet(">=3.9"):
        ...
        elif environment_summary.dotnet_version is DotNetVersion.NET6:
            raise MastaInitException(
...
def _init_runtime(path_to_dll_folder: str, initialise_api_access: bool) -> None:
    ...
    if using_pythonnet3():
        ...
        if initialise_api_access:
            if environment_summary.dotnet_version is DotNetVersion.NET6:
...
def _init(path_to_dll_folder: str, initialise_api_access: bool = True) -> bool:
    ...
    _init_runtime(path_to_dll_folder, initialise_api_access)
...
def init(path_to_dll_folder: str) -> None:
