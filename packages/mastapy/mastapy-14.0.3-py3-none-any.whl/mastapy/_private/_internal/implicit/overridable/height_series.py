...
class Overridable_HeightSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_HeightSeries]") -> "_2214.HeightSeries":
    ...
    def implicit_type(cls: "Type[Overridable_HeightSeries]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2214.HeightSeries.type_()

    @property
    def value(self: "Self") -> "_2214.HeightSeries":
    ...
    @property
    def override_value(self: "Self") -> "_2214.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
    ...
    @property
    def calculated_value(self: "Self") -> "_2214.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
