...
class Overridable_MeshStiffnessSource(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _7076.MeshStiffnessSource
        """
        return _7076.MeshStiffnessSource
    ...
    def implicit_type(cls: "Type[Overridable_MeshStiffnessSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _7076.MeshStiffnessSource.type_()

    @property
    def value(self: "Self") -> "_7076.MeshStiffnessSource":
    ...
    @property
    def override_value(self: "Self") -> "_7076.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
    ...
    @property
    def calculated_value(self: "Self") -> "_7076.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
