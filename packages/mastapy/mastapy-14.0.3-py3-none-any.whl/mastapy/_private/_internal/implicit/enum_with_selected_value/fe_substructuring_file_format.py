...
from mastapy._private.nodal_analysis.fe_export_utility import _175
...
class EnumWithSelectedValue_FESubstructuringFileFormat(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FESubstructuringFileFormat]",
    ) -> "_175.FESubstructuringFileFormat":
        ...
        Returns:
            _175.FESubstructuringFileFormat
        """
        return _175.FESubstructuringFileFormat
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _175.FESubstructuringFileFormat.type_()

    @property
    def selected_value(self: "Self") -> "_175.FESubstructuringFileFormat":
    ...
    @property
    def available_values(self: "Self") -> "List[_175.FESubstructuringFileFormat]":
