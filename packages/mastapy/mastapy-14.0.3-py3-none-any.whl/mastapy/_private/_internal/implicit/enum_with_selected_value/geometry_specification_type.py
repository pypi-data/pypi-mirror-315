...
class EnumWithSelectedValue_GeometrySpecificationType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_GeometrySpecificationType]",
    ) -> "_1082.GeometrySpecificationType":
        ...
        Returns:
            _1082.GeometrySpecificationType
        """
        return _1082.GeometrySpecificationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1082.GeometrySpecificationType.type_()

    @property
    def selected_value(self: "Self") -> "_1082.GeometrySpecificationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1082.GeometrySpecificationType]":
