...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum]",
    ) -> "_2208.FatigueLoadLimitCalculationMethodEnum":
        ...
        Returns:
            _2208.FatigueLoadLimitCalculationMethodEnum
        """
        return _2208.FatigueLoadLimitCalculationMethodEnum
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2208.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: "Self") -> "_2208.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2208.FatigueLoadLimitCalculationMethodEnum]":
