...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    def wrapped_type(
        ...
        Returns:
            _1556.DynamicsResponseScaling
        """
        return _1556.DynamicsResponseScaling
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1556.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: "Self") -> "_1556.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: "Self") -> "List[_1556.DynamicsResponseScaling]":
