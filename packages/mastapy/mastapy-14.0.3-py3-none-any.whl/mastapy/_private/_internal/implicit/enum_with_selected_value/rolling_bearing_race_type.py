...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1950.RollingBearingRaceType
        """
        return _1950.RollingBearingRaceType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1950.RollingBearingRaceType.type_()

    @property
    def selected_value(self: "Self") -> "_1950.RollingBearingRaceType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1950.RollingBearingRaceType]":
