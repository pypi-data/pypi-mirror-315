...
class EnumWithSelectedValue_LubricationMethods(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapper_type(cls: "Type[EnumWithSelectedValue_LubricationMethods]") -> "Any":
    ...
    @classmethod
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LubricationMethods]",
    ) -> "_347.LubricationMethods":
        ...
        Returns:
            _347.LubricationMethods
        """
        return _347.LubricationMethods

    @classmethod
    def implicit_type(cls: "Type[EnumWithSelectedValue_LubricationMethods]") -> "Any":
        ...
        Returns:
            Any
        """
        return _347.LubricationMethods.type_()

    @property
    def selected_value(self: "Self") -> "_347.LubricationMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_347.LubricationMethods]":
