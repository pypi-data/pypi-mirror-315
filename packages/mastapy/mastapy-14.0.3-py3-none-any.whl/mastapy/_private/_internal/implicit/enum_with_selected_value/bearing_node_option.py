...
from mastapy._private.system_model.fe import _2420
...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2420.BearingNodeOption
        """
        return _2420.BearingNodeOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BearingNodeOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2420.BearingNodeOption.type_()

    @property
    def selected_value(self: "Self") -> "_2420.BearingNodeOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_2420.BearingNodeOption]":
