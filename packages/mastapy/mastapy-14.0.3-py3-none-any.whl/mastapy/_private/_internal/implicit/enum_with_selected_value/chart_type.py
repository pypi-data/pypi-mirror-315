...
class EnumWithSelectedValue_ChartType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_ChartType]") -> "_668.ChartType":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ChartType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _668.ChartType.type_()

    @property
    def selected_value(self: "Self") -> "_668.ChartType":
    ...
    @property
    def available_values(self: "Self") -> "List[_668.ChartType]":
