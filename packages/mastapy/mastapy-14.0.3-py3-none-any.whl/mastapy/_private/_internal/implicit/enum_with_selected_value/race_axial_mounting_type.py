...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2019.RaceAxialMountingType
        """
        return _2019.RaceAxialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2019.RaceAxialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2019.RaceAxialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2019.RaceAxialMountingType]":
