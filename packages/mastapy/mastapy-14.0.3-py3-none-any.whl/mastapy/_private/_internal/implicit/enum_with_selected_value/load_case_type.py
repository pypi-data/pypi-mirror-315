...
class EnumWithSelectedValue_LoadCaseType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LoadCaseType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1414.LoadCaseType.type_()

    @property
    def selected_value(self: "Self") -> "_1414.LoadCaseType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1414.LoadCaseType]":
