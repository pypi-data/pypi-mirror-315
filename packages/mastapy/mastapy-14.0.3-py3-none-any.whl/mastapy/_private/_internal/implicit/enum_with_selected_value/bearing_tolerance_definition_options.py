...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1959.BearingToleranceDefinitionOptions
        """
        return _1959.BearingToleranceDefinitionOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1959.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1959.BearingToleranceDefinitionOptions":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1959.BearingToleranceDefinitionOptions]":
