...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LoadedBallElementPropertyType]",
    ) -> "_2018.LoadedBallElementPropertyType":
        ...
        Returns:
            _2018.LoadedBallElementPropertyType
        """
        return _2018.LoadedBallElementPropertyType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2018.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: "Self") -> "_2018.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2018.LoadedBallElementPropertyType]":
