...
from mastapy._private.gears.micro_geometry import _587
...
class EnumWithSelectedValue_LocationOfEvaluationUpperLimit(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfEvaluationUpperLimit]",
    ) -> "_587.LocationOfEvaluationUpperLimit":
        ...
        Returns:
            _587.LocationOfEvaluationUpperLimit
        """
        return _587.LocationOfEvaluationUpperLimit
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _587.LocationOfEvaluationUpperLimit.type_()

    @property
    def selected_value(self: "Self") -> "_587.LocationOfEvaluationUpperLimit":
    ...
    @property
    def available_values(self: "Self") -> "List[_587.LocationOfEvaluationUpperLimit]":
