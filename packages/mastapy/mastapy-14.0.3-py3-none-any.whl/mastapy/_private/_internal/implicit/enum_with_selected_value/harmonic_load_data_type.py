...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1432.HarmonicLoadDataType
        """
        return _1432.HarmonicLoadDataType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_HarmonicLoadDataType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1432.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: "Self") -> "_1432.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1432.HarmonicLoadDataType]":
