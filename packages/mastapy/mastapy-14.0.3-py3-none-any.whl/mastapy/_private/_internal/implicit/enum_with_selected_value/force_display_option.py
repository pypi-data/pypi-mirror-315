...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1429.ForceDisplayOption
        """
        return _1429.ForceDisplayOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ForceDisplayOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1429.ForceDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1429.ForceDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1429.ForceDisplayOption]":
