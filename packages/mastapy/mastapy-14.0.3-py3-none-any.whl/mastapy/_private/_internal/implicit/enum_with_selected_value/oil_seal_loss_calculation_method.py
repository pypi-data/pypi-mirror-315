...
class EnumWithSelectedValue_OilSealLossCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_OilSealLossCalculationMethod]",
    ) -> "_312.OilSealLossCalculationMethod":
        ...
        Returns:
            _312.OilSealLossCalculationMethod
        """
        return _312.OilSealLossCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _312.OilSealLossCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_312.OilSealLossCalculationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_312.OilSealLossCalculationMethod]":
