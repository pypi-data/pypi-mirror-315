...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2020.RaceRadialMountingType
        """
        return _2020.RaceRadialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2020.RaceRadialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2020.RaceRadialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2020.RaceRadialMountingType]":
