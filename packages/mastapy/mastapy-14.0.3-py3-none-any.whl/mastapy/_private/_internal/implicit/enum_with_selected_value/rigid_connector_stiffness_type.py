...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorStiffnessType]",
    ) -> "_2655.RigidConnectorStiffnessType":
        ...
        Returns:
            _2655.RigidConnectorStiffnessType
        """
        return _2655.RigidConnectorStiffnessType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2655.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: "Self") -> "_2655.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2655.RigidConnectorStiffnessType]":
