...
from mastapy._private.math_utility import _1545
...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComplexPartDisplayOption]",
    ) -> "_1545.ComplexPartDisplayOption":
        ...
        Returns:
            _1545.ComplexPartDisplayOption
        """
        return _1545.ComplexPartDisplayOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1545.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1545.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1545.ComplexPartDisplayOption]":
