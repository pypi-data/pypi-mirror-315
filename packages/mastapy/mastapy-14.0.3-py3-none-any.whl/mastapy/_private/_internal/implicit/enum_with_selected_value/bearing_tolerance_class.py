...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1958.BearingToleranceClass
        """
        return _1958.BearingToleranceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1958.BearingToleranceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1958.BearingToleranceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1958.BearingToleranceClass]":
