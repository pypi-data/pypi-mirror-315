...
class EnumWithSelectedValue_DegreeOfFreedom(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DegreeOfFreedom]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1554.DegreeOfFreedom.type_()

    @property
    def selected_value(self: "Self") -> "_1554.DegreeOfFreedom":
    ...
    @property
    def available_values(self: "Self") -> "List[_1554.DegreeOfFreedom]":
