...
class EnumWithSelectedValue_ThicknessType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ThicknessType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1113.ThicknessType.type_()

    @property
    def selected_value(self: "Self") -> "_1113.ThicknessType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1113.ThicknessType]":
