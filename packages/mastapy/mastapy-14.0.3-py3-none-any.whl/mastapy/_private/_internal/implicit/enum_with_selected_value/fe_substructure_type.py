...
from mastapy._private.system_model.fe import _2446
...
class EnumWithSelectedValue_FESubstructureType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2446.FESubstructureType
        """
        return _2446.FESubstructureType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FESubstructureType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2446.FESubstructureType.type_()

    @property
    def selected_value(self: "Self") -> "_2446.FESubstructureType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2446.FESubstructureType]":
