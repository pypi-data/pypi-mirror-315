...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4462.DoeValueSpecificationOption":
        ...
        Returns:
            _4462.DoeValueSpecificationOption
        """
        return _4462.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4462.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4462.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4462.DoeValueSpecificationOption]":
