...
from mastapy._private.bearings.bearing_results.rolling import _2022
...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BallBearingAnalysisMethod]",
    ) -> "_2022.BallBearingAnalysisMethod":
        ...
        Returns:
            _2022.BallBearingAnalysisMethod
        """
        return _2022.BallBearingAnalysisMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2022.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2022.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2022.BallBearingAnalysisMethod]":
