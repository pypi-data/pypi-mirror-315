...
from mastapy._private.electric_machines.load_cases_and_analyses import _1422
...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    def wrapped_type(
        ...
        Returns:
            _1422.SpecifyTorqueOrCurrent
        """
        return _1422.SpecifyTorqueOrCurrent
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1422.SpecifyTorqueOrCurrent.type_()

    @property
    def selected_value(self: "Self") -> "_1422.SpecifyTorqueOrCurrent":
    ...
    @property
    def available_values(self: "Self") -> "List[_1422.SpecifyTorqueOrCurrent]":
