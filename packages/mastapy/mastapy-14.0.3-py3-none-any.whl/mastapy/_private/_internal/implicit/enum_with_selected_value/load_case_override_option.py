...
class EnumWithSelectedValue_LoadCaseOverrideOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1640.LoadCaseOverrideOption
        """
        return _1640.LoadCaseOverrideOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1640.LoadCaseOverrideOption.type_()

    @property
    def selected_value(self: "Self") -> "_1640.LoadCaseOverrideOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1640.LoadCaseOverrideOption]":
