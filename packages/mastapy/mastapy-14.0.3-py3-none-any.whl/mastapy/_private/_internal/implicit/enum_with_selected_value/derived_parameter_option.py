...
class EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption]",
    ) -> "_1186.CylindricalGearPairCreationOptions.DerivedParameterOption":
        ...
        Returns:
            _1186.CylindricalGearPairCreationOptions.DerivedParameterOption
        """
        return _1186.CylindricalGearPairCreationOptions.DerivedParameterOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1186.CylindricalGearPairCreationOptions.DerivedParameterOption.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1186.CylindricalGearPairCreationOptions.DerivedParameterOption]":
