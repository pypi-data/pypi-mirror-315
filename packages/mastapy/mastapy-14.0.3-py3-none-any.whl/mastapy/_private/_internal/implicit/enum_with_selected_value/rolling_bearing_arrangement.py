...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    @classmethod
    def wrapper_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "Any":
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "_1947.RollingBearingArrangement":
        ...
        Returns:
            _1947.RollingBearingArrangement
        """
        return _1947.RollingBearingArrangement
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1947.RollingBearingArrangement.type_()

    @property
    def selected_value(self: "Self") -> "_1947.RollingBearingArrangement":
    ...
    @property
    def available_values(self: "Self") -> "List[_1947.RollingBearingArrangement]":
