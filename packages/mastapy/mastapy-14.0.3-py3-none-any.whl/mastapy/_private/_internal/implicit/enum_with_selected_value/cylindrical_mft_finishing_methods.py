...
class EnumWithSelectedValue_CylindricalMftFinishingMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_CylindricalMftFinishingMethods]",
    ) -> "_648.CylindricalMftFinishingMethods":
        ...
        Returns:
            _648.CylindricalMftFinishingMethods
        """
        return _648.CylindricalMftFinishingMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _648.CylindricalMftFinishingMethods.type_()

    @property
    def selected_value(self: "Self") -> "_648.CylindricalMftFinishingMethods":
    ...
    @property
    def available_values(self: "Self") -> "List[_648.CylindricalMftFinishingMethods]":
