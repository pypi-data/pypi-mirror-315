...
class EnumWithSelectedValue_ResidualStressCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ResidualStressCalculationMethod]",
    ) -> "_1102.ResidualStressCalculationMethod":
        ...
        Returns:
            _1102.ResidualStressCalculationMethod
        """
        return _1102.ResidualStressCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1102.ResidualStressCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1102.ResidualStressCalculationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_1102.ResidualStressCalculationMethod]":
