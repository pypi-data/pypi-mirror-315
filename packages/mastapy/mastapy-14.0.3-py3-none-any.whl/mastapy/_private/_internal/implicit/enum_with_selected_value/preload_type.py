...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PreloadType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2017.PreloadType.type_()

    @property
    def selected_value(self: "Self") -> "_2017.PreloadType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2017.PreloadType]":
