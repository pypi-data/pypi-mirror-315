...
class EnumWithSelectedValue_PressureAngleTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1454.PressureAngleTypes
        """
        return _1454.PressureAngleTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PressureAngleTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1454.PressureAngleTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1454.PressureAngleTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1454.PressureAngleTypes]":
