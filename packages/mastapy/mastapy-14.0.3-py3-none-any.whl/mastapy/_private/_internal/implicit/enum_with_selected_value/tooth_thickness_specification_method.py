...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ToothThicknessSpecificationMethod]",
    ) -> "_1230.ToothThicknessSpecificationMethod":
        ...
        Returns:
            _1230.ToothThicknessSpecificationMethod
        """
        return _1230.ToothThicknessSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1230.ToothThicknessSpecificationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1230.ToothThicknessSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1230.ToothThicknessSpecificationMethod]":
