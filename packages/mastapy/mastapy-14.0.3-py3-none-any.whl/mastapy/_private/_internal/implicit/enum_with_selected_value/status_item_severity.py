...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1848.StatusItemSeverity
        """
        return _1848.StatusItemSeverity
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_StatusItemSeverity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1848.StatusItemSeverity.type_()

    @property
    def selected_value(self: "Self") -> "_1848.StatusItemSeverity":
    ...
    @property
    def available_values(self: "Self") -> "List[_1848.StatusItemSeverity]":
