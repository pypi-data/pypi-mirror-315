...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_DesignState")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_DesignState",)


class ListWithSelectedItem_DesignState(
    _5799.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5799.DesignState.TYPE

    @property
    def selected_value(self: "Self") -> "_5799.DesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_5799.DesignState]":
