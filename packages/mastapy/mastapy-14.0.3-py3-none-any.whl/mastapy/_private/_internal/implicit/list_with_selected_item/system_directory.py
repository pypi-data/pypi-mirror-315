...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_SystemDirectory")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_SystemDirectory",)


class ListWithSelectedItem_SystemDirectory(
    _1652.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_SystemDirectory]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_SystemDirectory]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1652.SystemDirectory.TYPE

    @property
    def selected_value(self: "Self") -> "_1652.SystemDirectory":
    ...
    @property
    def available_values(self: "Self") -> "List[_1652.SystemDirectory]":
        """List[mastapy.utility.SystemDirectory]
