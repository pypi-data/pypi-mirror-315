...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_RotorSkewSlice")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_RotorSkewSlice",)


class ListWithSelectedItem_RotorSkewSlice(
    _1342.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_RotorSkewSlice]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_RotorSkewSlice]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1342.RotorSkewSlice.TYPE

    @property
    def selected_value(self: "Self") -> "_1342.RotorSkewSlice":
        """mastapy.electric_machines.RotorSkewSlice
    ...
    @property
    def available_values(self: "Self") -> "List[_1342.RotorSkewSlice]":
