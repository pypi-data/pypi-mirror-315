...
class ListWithSelectedItem_StaticLoadCase(
    _6957.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_StaticLoadCase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _6957.StaticLoadCase.TYPE

    @property
    def selected_value(self: "Self") -> "_6957.StaticLoadCase":
    ...
    @property
    def available_values(self: "Self") -> "List[_6957.StaticLoadCase]":
