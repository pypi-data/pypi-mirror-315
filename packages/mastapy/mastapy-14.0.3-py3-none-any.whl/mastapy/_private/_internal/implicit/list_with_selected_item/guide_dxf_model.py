...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="ListWithSelectedItem_GuideDxfModel")


__docformat__ = "restructuredtext en"
__all__ = ("ListWithSelectedItem_GuideDxfModel",)


class ListWithSelectedItem_GuideDxfModel(
    _2513.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_GuideDxfModel]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_GuideDxfModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2513.GuideDxfModel.TYPE

    @property
    def selected_value(self: "Self") -> "_2513.GuideDxfModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_2513.GuideDxfModel]":
