...
class ListWithSelectedItem_FESubstructure(
    _2441.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_FESubstructure]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructure]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2441.FESubstructure.TYPE

    @property
    def selected_value(self: "Self") -> "_2441.FESubstructure":
    ...
    @property
    def available_values(self: "Self") -> "List[_2441.FESubstructure]":
