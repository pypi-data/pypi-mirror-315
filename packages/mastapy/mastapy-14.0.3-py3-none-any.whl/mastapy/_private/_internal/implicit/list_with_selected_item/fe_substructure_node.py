...
class ListWithSelectedItem_FESubstructureNode(
    _2443.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def wrapper_type(cls: "Type[ListWithSelectedItem_FESubstructureNode]") -> "Any":
    ...
    @classmethod
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructureNode]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2443.FESubstructureNode.TYPE

    @property
    def selected_value(self: "Self") -> "_2443.FESubstructureNode":
    ...
    @property
    def available_values(self: "Self") -> "List[_2443.FESubstructureNode]":
