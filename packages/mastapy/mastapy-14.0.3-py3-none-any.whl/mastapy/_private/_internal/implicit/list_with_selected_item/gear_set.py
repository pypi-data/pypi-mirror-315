...
class ListWithSelectedItem_GearSet(_2593.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2593.GearSet.TYPE

    @property
    def selected_value(self: "Self") -> "_2593.GearSet":
    ...
    @property
    def available_values(self: "Self") -> "List[_2593.GearSet]":
