...
class CycloidalDiscModificationsSpecification(_0.APIBase):
    ...
    def coefficient_for_logarithmic_crowning(self: "Self") -> "float":
        """float"""
        temp = pythonnet_property_get(self.wrapped, "CoefficientForLogarithmicCrowning")
    ...
    @enforce_parameter_types
    def coefficient_for_logarithmic_crowning(self: "Self", value: "float") -> None:
        pythonnet_property_set(
            self.wrapped,
    ...
    def crowning_specification_method(
        self: "Self",
    ) -> "_1502.CrowningSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.cycloidal._1502", "CrowningSpecificationMethod"
        )(value)

    @crowning_specification_method.setter
    @enforce_parameter_types
    def crowning_specification_method(
        self: "Self", value: "_1502.CrowningSpecificationMethod"
    ) -> None:
    ...
    def direction_of_measured_modifications(
        self: "Self",
    ) -> "_1509.DirectionOfMeasuredModifications":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.cycloidal._1509", "DirectionOfMeasuredModifications"
        )(value)

    @direction_of_measured_modifications.setter
    @enforce_parameter_types
    def direction_of_measured_modifications(
        self: "Self", value: "_1509.DirectionOfMeasuredModifications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def measured_profile_modification(self: "Self") -> "_1585.Vector2DListAccessor":
