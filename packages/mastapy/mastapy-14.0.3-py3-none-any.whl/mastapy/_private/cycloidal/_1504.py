...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1505, _1508
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: "Self") -> "_1922.TwoDChartDefinition":
    ...
    @property
    def exporter(self: "Self") -> "_1505.CycloidalDiscDesignExporter":
    ...
    def modifications_specification(
        self: "Self",
    ) -> "_1508.CycloidalDiscModificationsSpecification":
