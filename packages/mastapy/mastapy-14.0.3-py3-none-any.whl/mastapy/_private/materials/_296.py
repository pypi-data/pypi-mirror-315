...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self: "Self") -> "_297.SoundPressureEnclosureType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._297", "SoundPressureEnclosureType"
        )(value)

    @enclosure_type.setter
    @enforce_parameter_types
    def enclosure_type(self: "Self", value: "_297.SoundPressureEnclosureType") -> None:
