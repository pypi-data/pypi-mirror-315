...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _306, _308
...
class _Cast_ResistiveTorque:
    ...
    @property
    def combined_resistive_torque(self: "CastSelf") -> "_306.CombinedResistiveTorque":
        from mastapy._private.materials.efficiency import _306

        return self.__parent__._cast(_306.CombinedResistiveTorque)

    @property
    def independent_resistive_torque(
        self: "CastSelf",
    ) -> "_308.IndependentResistiveTorque":
        from mastapy._private.materials.efficiency import _308

        return self.__parent__._cast(_308.IndependentResistiveTorque)
