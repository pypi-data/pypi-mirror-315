...
from mastapy._private.nodal_analysis.dev_tools_analyses import _205
...
class _Cast_FEModelHarmonicAnalysisDrawStyle:
    ...
    @property
    def fe_model_tab_draw_style(self: "CastSelf") -> "_205.FEModelTabDrawStyle":
        return self.__parent__._cast(_205.FEModelTabDrawStyle)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEModelHarmonicAnalysisDrawStyle(_205.FEModelTabDrawStyle):
    """FEModelHarmonicAnalysisDrawStyle
