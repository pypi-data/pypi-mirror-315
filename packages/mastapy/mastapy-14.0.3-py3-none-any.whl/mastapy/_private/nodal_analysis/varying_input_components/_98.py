...
from mastapy._private.nodal_analysis.varying_input_components import _96
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ForceInputComponent._Cast_ForceInputComponent"
    )
...
class _Cast_ForceInputComponent:
    ...
    __parent__: "ForceInputComponent"

    @property
    def abstract_varying_input_component(
        self: "CastSelf",
    ) -> "_96.AbstractVaryingInputComponent":
        return self.__parent__._cast(_96.AbstractVaryingInputComponent)

    @property
    def force_input_component(self: "CastSelf") -> "ForceInputComponent":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ForceInputComponent(_96.AbstractVaryingInputComponent):
    """ForceInputComponent

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FORCE_INPUT_COMPONENT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ForceInputComponent":
        """Cast to another type.

        Returns:
            _Cast_ForceInputComponent
        """
        return _Cast_ForceInputComponent(self)
