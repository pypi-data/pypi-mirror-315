...
class _Cast_AbstractVaryingInputComponent:
    ...
    @property
    def angle_input_component(self: "CastSelf") -> "_97.AngleInputComponent":
        from mastapy._private.nodal_analysis.varying_input_components import _97

        return self.__parent__._cast(_97.AngleInputComponent)

    @property
    def force_input_component(self: "CastSelf") -> "_98.ForceInputComponent":
        from mastapy._private.nodal_analysis.varying_input_components import _98

        return self.__parent__._cast(_98.ForceInputComponent)

    @property
    def moment_input_component(self: "CastSelf") -> "_99.MomentInputComponent":
        from mastapy._private.nodal_analysis.varying_input_components import _99

        return self.__parent__._cast(_99.MomentInputComponent)
    ...
    def non_dimensional_input_component(
        ...
        return self.__parent__._cast(_100.NonDimensionalInputComponent)

    @property
    def velocity_input_component(self: "CastSelf") -> "_102.VelocityInputComponent":
        from mastapy._private.nodal_analysis.varying_input_components import _102

        return self.__parent__._cast(_102.VelocityInputComponent)
...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    @input_type.setter
    @enforce_parameter_types
    def input_type(self: "Self", value: "_94.ValueInputOption") -> None:
    ...
    @property
    def value_vs_angle(self: "Self") -> "_1585.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def value_vs_angle(self: "Self", value: "_1585.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ValueVsAngle", value.wrapped)

    @property
    def value_vs_angle_and_speed(self: "Self") -> "_1615.GriddedSurfaceAccessor":
    ...
    @property
    def value_vs_position(self: "Self") -> "_1585.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def value_vs_position(self: "Self", value: "_1585.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ValueVsPosition", value.wrapped)

    @property
    def value_vs_time(self: "Self") -> "_1585.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def value_vs_time(self: "Self", value: "_1585.Vector2DListAccessor") -> None:
