...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer import _180, _181
...
class _Cast_ElmerResults:
    ...
    def elmer_results_from_electromagnetic_analysis(
        self: "CastSelf",
    ) -> "_180.ElmerResultsFromElectromagneticAnalysis":
        from mastapy._private.nodal_analysis.elmer import _180

        return self.__parent__._cast(_180.ElmerResultsFromElectromagneticAnalysis)

    @property
    def elmer_results_from_mechanical_analysis(
        self: "CastSelf",
    ) -> "_181.ElmerResultsFromMechanicalAnalysis":
        from mastapy._private.nodal_analysis.elmer import _181

        return self.__parent__._cast(_181.ElmerResultsFromMechanicalAnalysis)
