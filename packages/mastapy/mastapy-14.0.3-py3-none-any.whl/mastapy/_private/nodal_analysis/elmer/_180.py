...
from mastapy._private.nodal_analysis.elmer import _179
...
class _Cast_ElmerResultsFromElectromagneticAnalysis:
    ...
    @property
    def elmer_results(self: "CastSelf") -> "_179.ElmerResults":
        return self.__parent__._cast(_179.ElmerResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElmerResultsFromElectromagneticAnalysis(_179.ElmerResults):
    """ElmerResultsFromElectromagneticAnalysis
