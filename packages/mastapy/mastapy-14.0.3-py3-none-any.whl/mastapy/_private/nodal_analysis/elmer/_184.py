...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MechanicalContactSpecification._Cast_MechanicalContactSpecification",
    )
...
class _Cast_MechanicalContactSpecification:
    ...
    __parent__: "MechanicalContactSpecification"
...
class MechanicalContactSpecification(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _MECHANICAL_CONTACT_SPECIFICATION
    ...
    @property
    def contact_type(self: "Self") -> "_176.ContactType":
        """mastapy.nodal_analysis.elmer.ContactType"""
        temp = pythonnet_property_get(self.wrapped, "ContactType")
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._176", "ContactType"
        )(value)

    @contact_type.setter
    @enforce_parameter_types
    def contact_type(self: "Self", value: "_176.ContactType") -> None:
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.NodalAnalysis.Elmer.ContactType"
        )
        pythonnet_property_set(self.wrapped, "ContactType", value)
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MechanicalContactSpecification":
        """Cast to another type.

        Returns:
            _Cast_MechanicalContactSpecification
        """
        return _Cast_MechanicalContactSpecification(self)
