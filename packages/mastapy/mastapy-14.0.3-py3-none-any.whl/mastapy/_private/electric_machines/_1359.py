...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1315, _1324, _1325, _1328
...
class _Cast_UShapedLayerSpecification:
    ...
    def rotor_internal_layer_specification(
        self: "CastSelf",
    ) -> "_1341.RotorInternalLayerSpecification":
        return self.__parent__._cast(_1341.RotorInternalLayerSpecification)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UShapedLayerSpecification(_1341.RotorInternalLayerSpecification):
    """UShapedLayerSpecification
    ...
    @property
    def flux_barrier_configuration(self: "Self") -> "_1315.FluxBarriers":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1315", "FluxBarriers"
        )(value)

    @flux_barrier_configuration.setter
    @enforce_parameter_types
    def flux_barrier_configuration(self: "Self", value: "_1315.FluxBarriers") -> None:
    ...
    @property
    def inner_magnet_clearance(self: "Self") -> "_1324.MagnetClearance":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1324", "MagnetClearance"
        )(value)

    @inner_magnet_clearance.setter
    @enforce_parameter_types
    def inner_magnet_clearance(self: "Self", value: "_1324.MagnetClearance") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def magnet_configuration(self: "Self") -> "_1325.MagnetConfiguration":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.electric_machines._1325", "MagnetConfiguration"
        )(value)

    @magnet_configuration.setter
    @enforce_parameter_types
    def magnet_configuration(self: "Self", value: "_1325.MagnetConfiguration") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def outer_magnet_lower_clearance(self: "Self") -> "_1324.MagnetClearance":
        """mastapy.electric_machines.MagnetClearance"""
    ...
    def outer_magnet_lower_clearance(
        self: "Self", value: "_1324.MagnetClearance"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.ElectricMachines.MagnetClearance"
        )
    ...
    @property
    def outer_magnets(self: "Self") -> "_1328.MagnetForLayer":
