...
from mastapy._private.electric_machines import _1308, _1356
...
class _Cast_TwoDimensionalFEModelForElectromagneticAnalysis:
    ...
    def two_dimensional_fe_model_for_analysis(
        self: "CastSelf",
    ) -> "_1356.TwoDimensionalFEModelForAnalysis":
        return self.__parent__._cast(_1356.TwoDimensionalFEModelForAnalysis)
...
class TwoDimensionalFEModelForElectromagneticAnalysis(
    _1356.TwoDimensionalFEModelForAnalysis[_1308.ElectricMachineMeshingOptions]
):
    """TwoDimensionalFEModelForElectromagneticAnalysis
