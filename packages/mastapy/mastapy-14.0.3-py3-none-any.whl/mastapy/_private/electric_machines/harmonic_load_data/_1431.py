...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1319

    Self = TypeVar("Self", bound="HarmonicLoadDataControlExcitationOptionBase")
    CastSelf = TypeVar(
        "CastSelf",
        bound="HarmonicLoadDataControlExcitationOptionBase._Cast_HarmonicLoadDataControlExcitationOptionBase",
    )
...
class _Cast_HarmonicLoadDataControlExcitationOptionBase:
    ...
    __parent__: "HarmonicLoadDataControlExcitationOptionBase"

    @property
    def harmonic_load_data_control_excitation_option_for_electric_machine_mode(
        self: "CastSelf",
    ) -> "_1319.HarmonicLoadDataControlExcitationOptionForElectricMachineMode":
        from mastapy._private.electric_machines import _1319
...
class HarmonicLoadDataControlExcitationOptionBase(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _HARMONIC_LOAD_DATA_CONTROL_EXCITATION_OPTION_BASE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HarmonicLoadDataControlExcitationOptionBase":
        """Cast to another type.

        Returns:
            _Cast_HarmonicLoadDataControlExcitationOptionBase
        """
        return _Cast_HarmonicLoadDataControlExcitationOptionBase(self)
