...
from mastapy._private.electric_machines.harmonic_load_data import _1434
...
class _Cast_StatorToothMomentInterpolator:
    ...
    @property
    def stator_tooth_interpolator(self: "CastSelf") -> "_1434.StatorToothInterpolator":
        return self.__parent__._cast(_1434.StatorToothInterpolator)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StatorToothMomentInterpolator(_1434.StatorToothInterpolator):
    """StatorToothMomentInterpolator
