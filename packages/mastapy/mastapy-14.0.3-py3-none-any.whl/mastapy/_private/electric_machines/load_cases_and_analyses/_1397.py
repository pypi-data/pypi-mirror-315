...
from mastapy._private.electric_machines.results import _1389
...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.load_cases_and_analyses import _1396, _1406
...
class DynamicForceAnalysis(
    _1402.ElectricMachineAnalysis, _1389.IHaveDynamicForceResults
):
    """DynamicForceAnalysis
    ...
    @property
    def load_case(self: "Self") -> "_1396.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: "Self") -> "_1371.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: "Self",
    ) -> "List[_1406.ElectricMachineFEAnalysis]":
