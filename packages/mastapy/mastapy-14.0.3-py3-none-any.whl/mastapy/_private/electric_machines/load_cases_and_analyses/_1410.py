...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: "Self") -> "List[_1398.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1396.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: "Self") -> "List[_1401.EfficiencyMapLoadCase]":
    ...
    def mechanical_load_cases(
        self: "Self",
    ) -> "List[_1411.ElectricMachineMechanicalLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1426.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: "Self",
    ) -> "List[_1408.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: "Self",
    ) -> "List[_1425.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: "Self", load_case_type: "_1414.LoadCaseType"
    ...
    def add_load_case_named(
        self: "Self", load_case_type: "_1414.LoadCaseType", name: "str"
    ) -> "_1409.ElectricMachineLoadCaseBase":
        """mastapy.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        self: "Self",
        setup: "_1310.ElectricMachineSetup",
        load_case_type: "_1414.LoadCaseType",
    ) -> "_1641.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1310.ElectricMachineSetup",
        load_case_type: "_1414.LoadCaseType",
        task_progress: "_7733.TaskProgress",
    ) -> "_1641.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: "Self", load_case: "_1409.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool
