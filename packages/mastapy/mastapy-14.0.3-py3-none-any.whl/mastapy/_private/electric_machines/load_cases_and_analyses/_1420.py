...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1380
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SingleOperatingPointAnalysis(_1402.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    def electric_machine_results(
        self: "Self",
    ) -> "_1380.ElectricMachineResultsForOpenCircuitAndOnLoad":
    ...
    @property
    def load_case(self: "Self") -> "_1408.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: "Self",
    ) -> "List[_1421.SlotDetailForAnalysis]":
