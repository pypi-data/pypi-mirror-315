...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1328, _1359, _1360
...
class _Cast_RotorInternalLayerSpecification:
    ...
    def u_shaped_layer_specification(
        self: "CastSelf",
    ) -> "_1359.UShapedLayerSpecification":
        from mastapy._private.electric_machines import _1359

        return self.__parent__._cast(_1359.UShapedLayerSpecification)

    @property
    def v_shaped_magnet_layer_specification(
        self: "CastSelf",
    ) -> "_1360.VShapedMagnetLayerSpecification":
        from mastapy._private.electric_machines import _1360

        return self.__parent__._cast(_1360.VShapedMagnetLayerSpecification)
...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    @property
    def magnets(self: "Self") -> "_1328.MagnetForLayer":
