...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1390, _1392
...
class _Cast_ElectricMachineDQModel:
    ...
    @property
    def linear_dq_model(self: "CastSelf") -> "_1390.LinearDQModel":
        from mastapy._private.electric_machines.results import _1390

        return self.__parent__._cast(_1390.LinearDQModel)

    @property
    def non_linear_dq_model(self: "CastSelf") -> "_1392.NonLinearDQModel":
        from mastapy._private.electric_machines.results import _1392

        return self.__parent__._cast(_1392.NonLinearDQModel)
