...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1382, _1383, _1384, _1386
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: "Self") -> "_1922.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: "Self") -> "_1922.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: "Self",
    ) -> "List[_1383.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: "Self",
    ) -> "List[_1386.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: "Self",
    ) -> "List[_1384.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: "Self",
    ) -> "List[_1382.ElectricMachineResultsForPhaseAtTimeStep]":
