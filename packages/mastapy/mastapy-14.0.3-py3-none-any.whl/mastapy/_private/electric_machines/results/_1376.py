...
class _Cast_ElectricMachineResults:
    ...
    def on_load_electric_machine_results(
        self: "CastSelf",
    ) -> "_1394.OnLoadElectricMachineResults":
        from mastapy._private.electric_machines.results import _1394

        return self.__parent__._cast(_1394.OnLoadElectricMachineResults)

    @property
    def open_circuit_electric_machine_results(
        self: "CastSelf",
    ) -> "_1395.OpenCircuitElectricMachineResults":
        from mastapy._private.electric_machines.results import _1395

        return self.__parent__._cast(_1395.OpenCircuitElectricMachineResults)
...
class ElectricMachineResults(_0.APIBase):
    ...
    @property
    def results_timesteps(self: "Self") -> "List[_1385.ElectricMachineResultsTimeStep]":
    ...
    def results_for_conductor_turns(
        self: "Self",
    ) -> "List[_1377.ElectricMachineResultsForConductorTurn]":
    ...
    def results_for_line_to_line(
        self: "Self",
    ) -> "List[_1379.ElectricMachineResultsForLineToLine]":
    ...
    def results_for_phases(
        self: "Self",
    ) -> "List[_1381.ElectricMachineResultsForPhase]":
