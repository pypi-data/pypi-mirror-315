...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.convergence import _1625
...
class _Cast_DataLogger:
    ...
    @property
    def convergence_logger(self: "CastSelf") -> "_1625.ConvergenceLogger":
        from mastapy._private.math_utility.convergence import _1625

        return self.__parent__._cast(_1625.ConvergenceLogger)

    @property
    def data_logger_with_charts(self: "CastSelf") -> "_1905.DataLoggerWithCharts":
        from mastapy._private.utility_gui import _1905

        return self.__parent__._cast(_1905.DataLoggerWithCharts)
