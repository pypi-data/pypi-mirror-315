...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_set_pareto_optimiser import _927

    Self = TypeVar("Self", bound="ParetoOptimisationStrategyBars")
    CastSelf = TypeVar(
        "CastSelf",
        bound="ParetoOptimisationStrategyBars._Cast_ParetoOptimisationStrategyBars",
    )
...
class _Cast_ParetoOptimisationStrategyBars:
    ...
    __parent__: "ParetoOptimisationStrategyBars"

    @property
    def bar_for_pareto(self: "CastSelf") -> "_927.BarForPareto":
        from mastapy._private.gears.gear_set_pareto_optimiser import _927

        return self.__parent__._cast(_927.BarForPareto)
...
class ParetoOptimisationStrategyBars(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _PARETO_OPTIMISATION_STRATEGY_BARS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ParetoOptimisationStrategyBars":
        """Cast to another type.

        Returns:
            _Cast_ParetoOptimisationStrategyBars
        """
        return _Cast_ParetoOptimisationStrategyBars(self)
