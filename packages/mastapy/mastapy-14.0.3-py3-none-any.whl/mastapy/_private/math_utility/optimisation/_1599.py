...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1597, _1598, _1601
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ParetoOptimisationStrategy(_1884.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    def charts(
        self: "Self",
    ) -> "List[_1601.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    def inputs(self: "Self") -> "List[_1597.ParetoOptimisationInput]":
    ...
    @property
    def outputs(self: "Self") -> "List[_1598.ParetoOptimisationOutput]":
