...
class TwodimensionalFunctionLookupTable(
    _1616.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1615.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: "Self", value: "_1615.GriddedSurfaceAccessor") -> None:
