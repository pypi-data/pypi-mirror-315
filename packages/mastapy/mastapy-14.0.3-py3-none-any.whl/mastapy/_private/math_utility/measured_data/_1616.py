...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_data import _1617, _1618
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LookupTableBase(_1637.IndependentReportablePropertiesBase[T]):
    """LookupTableBase
    ...
    def extrapolation_option(self: "Self", value: "_1560.ExtrapolationOptions") -> None:
