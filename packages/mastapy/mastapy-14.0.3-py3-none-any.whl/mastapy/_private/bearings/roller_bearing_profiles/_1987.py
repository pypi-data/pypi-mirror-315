...
from mastapy._private.math_utility import _1560
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollerBearingDinLundbergProfile(_1991.RollerBearingProfile):
    """RollerBearingDinLundbergProfile
    ...
    @enforce_parameter_types
    def extrapolation_method(self: "Self", value: "_1560.ExtrapolationOptions") -> None:
