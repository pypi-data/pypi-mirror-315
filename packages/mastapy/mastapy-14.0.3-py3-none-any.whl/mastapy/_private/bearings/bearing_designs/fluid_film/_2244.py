...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2251, _2252
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PadFluidFilmBearing(_2187.DetailedBearing):
    """PadFluidFilmBearing
    ...
    @enforce_parameter_types
    def rotational_direction(self: "Self", value: "_1952.RotationalDirections") -> None:
