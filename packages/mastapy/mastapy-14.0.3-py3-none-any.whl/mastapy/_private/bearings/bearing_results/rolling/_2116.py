...
class _Cast_MaximumStaticContactStress:
    ...
    def maximum_static_contact_stress_results_abstract(
        self: "CastSelf",
    ) -> "_2118.MaximumStaticContactStressResultsAbstract":
        return self.__parent__._cast(_2118.MaximumStaticContactStressResultsAbstract)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MaximumStaticContactStress(_2118.MaximumStaticContactStressResultsAbstract):
    """MaximumStaticContactStress
