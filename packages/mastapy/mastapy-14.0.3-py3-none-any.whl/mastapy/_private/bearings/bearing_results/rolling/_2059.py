...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedBallBearingRow(_2090.LoadedRollingBearingRow):
    """LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2058.LoadedBallBearingResults":
    ...
    @property
    def race_results(self: "Self") -> "List[_2057.LoadedBallBearingRaceResults]":
