...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2070, _2094, _2101
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedSphericalRollerBearingElement(_2084.LoadedRollerBearingElement):
    """LoadedSphericalRollerBearingElement
