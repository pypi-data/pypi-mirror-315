...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2057, _2072

    Self = TypeVar("Self", bound="LoadedRollingBearingRaceResults")
    CastSelf = TypeVar(
        "CastSelf",
        bound="LoadedRollingBearingRaceResults._Cast_LoadedRollingBearingRaceResults",
    )
...
class _Cast_LoadedRollingBearingRaceResults:
    ...
    __parent__: "LoadedRollingBearingRaceResults"

    @property
    def loaded_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2057.LoadedBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2057

        return self.__parent__._cast(_2057.LoadedBallBearingRaceResults)

    @property
    def loaded_four_point_contact_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2072.LoadedFourPointContactBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2072

        return self.__parent__._cast(_2072.LoadedFourPointContactBallBearingRaceResults)
...
class LoadedRollingBearingRaceResults(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _LOADED_ROLLING_BEARING_RACE_RESULTS
    ...
    def contact_radius_in_rolling_direction(self: "Self") -> "float":
        ...
        """
        temp = pythonnet_property_get(self.wrapped, "ContactRadiusInRollingDirection")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_LoadedRollingBearingRaceResults":
        """Cast to another type.

        Returns:
            _Cast_LoadedRollingBearingRaceResults
        """
        return _Cast_LoadedRollingBearingRaceResults(self)
