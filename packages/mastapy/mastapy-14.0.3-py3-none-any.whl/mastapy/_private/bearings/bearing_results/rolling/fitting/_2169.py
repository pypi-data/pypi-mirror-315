...
class _Cast_RingFittingThermalResults:
    ...
    def inner_ring_fitting_thermal_results(
        ...
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2166

        return self.__parent__._cast(_2166.InnerRingFittingThermalResults)

    @property
    def outer_ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2168.OuterRingFittingThermalResults":
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2168

        return self.__parent__._cast(_2168.OuterRingFittingThermalResults)
...
class RingFittingThermalResults(_0.APIBase):
    ...
    @property
    def interference_values(self: "Self") -> "List[_2167.InterferenceComponents]":
