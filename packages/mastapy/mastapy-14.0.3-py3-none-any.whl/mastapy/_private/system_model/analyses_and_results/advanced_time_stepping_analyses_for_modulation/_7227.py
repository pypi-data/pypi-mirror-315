...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5902
...
class _Cast_HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation:
    ...
    @property
    def harmonic_analysis_options(self: "CastSelf") -> "_5902.HarmonicAnalysisOptions":
        return self.__parent__._cast(_5902.HarmonicAnalysisOptions)
