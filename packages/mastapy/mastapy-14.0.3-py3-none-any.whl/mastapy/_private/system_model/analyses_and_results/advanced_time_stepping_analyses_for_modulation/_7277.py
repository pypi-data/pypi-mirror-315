...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation._Cast_StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation"
...
class StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_GEAR_MESH_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(
            self
        )
