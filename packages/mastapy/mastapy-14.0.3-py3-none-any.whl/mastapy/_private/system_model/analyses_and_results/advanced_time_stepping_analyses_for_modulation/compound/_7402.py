...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _SPRING_DAMPER_CONNECTION_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7271.SpringDamperConnectionAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        ...
        "_Cast_SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation"
    ):
        ...
        Returns:
            _Cast_SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_SpringDamperConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(
            self
        )
