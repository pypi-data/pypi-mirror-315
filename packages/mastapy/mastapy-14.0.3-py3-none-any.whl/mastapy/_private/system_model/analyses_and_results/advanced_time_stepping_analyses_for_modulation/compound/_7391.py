...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _ROLLING_RING_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7259.RollingRingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_RollingRingCompoundAdvancedTimeSteppingAnalysisForModulation(self)
