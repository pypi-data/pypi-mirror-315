...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation._Cast_ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation"
...
class ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _SHAFT_HUB_CONNECTION_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(self)
