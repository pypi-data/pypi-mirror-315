...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearSetAdvancedTimeSteppingAnalysisForModulation._Cast_FaceGearSetAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_FaceGearSetAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "FaceGearSetAdvancedTimeSteppingAnalysisForModulation"
...
class FaceGearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _FACE_GEAR_SET_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def face_gears_advanced_time_stepping_analysis_for_modulation(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "FaceGearsAdvancedTimeSteppingAnalysisForModulation"
        )
    ...
    def face_meshes_advanced_time_stepping_analysis_for_modulation(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "FaceMeshesAdvancedTimeSteppingAnalysisForModulation"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FaceGearSetAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_FaceGearSetAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_FaceGearSetAdvancedTimeSteppingAnalysisForModulation(self)
