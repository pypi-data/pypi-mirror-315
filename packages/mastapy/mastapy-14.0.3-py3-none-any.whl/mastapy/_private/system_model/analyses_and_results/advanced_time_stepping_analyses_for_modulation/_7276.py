...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearAdvancedTimeSteppingAnalysisForModulation._Cast_StraightBevelGearAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_StraightBevelGearAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "StraightBevelGearAdvancedTimeSteppingAnalysisForModulation"
...
class StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_GEAR_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(self)
