...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchAdvancedTimeSteppingAnalysisForModulation._Cast_ClutchAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_ClutchAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "ClutchAdvancedTimeSteppingAnalysisForModulation"
...
class ClutchAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2802.ClutchSystemDeflection":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_ClutchAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_ClutchAdvancedTimeSteppingAnalysisForModulation(self)
