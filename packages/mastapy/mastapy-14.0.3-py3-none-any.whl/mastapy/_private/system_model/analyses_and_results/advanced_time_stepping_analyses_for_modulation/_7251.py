...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation._Cast_PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation"
...
class PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _PLANETARY_CONNECTION_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_PlanetaryConnectionAdvancedTimeSteppingAnalysisForModulation(self)
