...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self",
        bound="BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation",
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation._Cast_BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation"
...
class BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_GEAR_SET_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def bevel_gears_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7176.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bevel_differential_gears_advanced_time_stepping_analysis_for_modulation(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "BevelDifferentialGearsAdvancedTimeSteppingAnalysisForModulation",
        )
    ...
    def bevel_meshes_advanced_time_stepping_analysis_for_modulation(
        ...
        "List[_7177.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def bevel_differential_meshes_advanced_time_stepping_analysis_for_modulation(
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "BevelDifferentialMeshesAdvancedTimeSteppingAnalysisForModulation",
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(
            self
        )
