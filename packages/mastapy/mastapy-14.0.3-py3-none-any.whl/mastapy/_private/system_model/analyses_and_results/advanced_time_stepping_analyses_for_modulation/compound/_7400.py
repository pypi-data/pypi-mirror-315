...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self",
        bound="SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    def spiral_bevel_gears_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7398.SpiralBevelGearCompoundAdvancedTimeSteppingAnalysisForModulation]":
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "SpiralBevelGearsCompoundAdvancedTimeSteppingAnalysisForModulation",
        )
    ...
    def spiral_bevel_meshes_compound_advanced_time_stepping_analysis_for_modulation(
        self: "Self",
    ) -> "List[_7399.SpiralBevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation]":
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "SpiralBevelMeshesCompoundAdvancedTimeSteppingAnalysisForModulation",
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearSetCompoundAdvancedTimeSteppingAnalysisForModulation":
