...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation._Cast_ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation"
...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _ZEROL_BEVEL_GEAR_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(self)
