...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _HYPOID_GEAR_MESH_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    @property
    def component_design(self: "Self") -> "_2372.HypoidGearMesh":
    ...
    @property
    def connection_design(self: "Self") -> "_2372.HypoidGearMesh":
        """mastapy.system_model.connections_and_sockets.gears.HypoidGearMesh
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7229.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_HypoidGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(
            self
        )
