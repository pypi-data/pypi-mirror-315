...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="TorqueConverterAdvancedTimeSteppingAnalysisForModulation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterAdvancedTimeSteppingAnalysisForModulation._Cast_TorqueConverterAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_TorqueConverterAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "TorqueConverterAdvancedTimeSteppingAnalysisForModulation"
...
class TorqueConverterAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_TorqueConverterAdvancedTimeSteppingAnalysisForModulation(self)
