...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="DatumCompoundAdvancedTimeSteppingAnalysisForModulation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="DatumCompoundAdvancedTimeSteppingAnalysisForModulation._Cast_DatumCompoundAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_DatumCompoundAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "DatumCompoundAdvancedTimeSteppingAnalysisForModulation"
...
class DatumCompoundAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _DATUM_COMPOUND_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7216.DatumAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_DatumCompoundAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_DatumCompoundAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_DatumCompoundAdvancedTimeSteppingAnalysisForModulation(self)
