...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation._Cast_ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation"
...
class ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _ZEROL_BEVEL_GEAR_MESH_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(self)
