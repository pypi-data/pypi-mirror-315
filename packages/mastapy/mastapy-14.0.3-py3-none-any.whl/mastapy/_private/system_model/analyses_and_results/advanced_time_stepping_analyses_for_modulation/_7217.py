...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelAdvancedTimeSteppingAnalysisForModulation._Cast_ExternalCADModelAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_ExternalCADModelAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "ExternalCADModelAdvancedTimeSteppingAnalysisForModulation"
...
class ExternalCADModelAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _EXTERNAL_CAD_MODEL_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ExternalCADModelAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_ExternalCADModelAdvancedTimeSteppingAnalysisForModulation(self)
