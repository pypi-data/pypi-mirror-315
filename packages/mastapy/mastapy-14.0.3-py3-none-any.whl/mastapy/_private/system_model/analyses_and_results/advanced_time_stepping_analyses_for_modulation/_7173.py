...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BearingAdvancedTimeSteppingAnalysisForModulation._Cast_BearingAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_BearingAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "BearingAdvancedTimeSteppingAnalysisForModulation"
...
class BearingAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = _BEARING_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2787.BearingSystemDeflection":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BearingAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_BearingAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_BearingAdvancedTimeSteppingAnalysisForModulation(self)
