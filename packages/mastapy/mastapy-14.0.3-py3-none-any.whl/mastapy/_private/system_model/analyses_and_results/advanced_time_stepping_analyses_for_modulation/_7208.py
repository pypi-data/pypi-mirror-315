...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation._Cast_CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation"
...
class CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _CYCLOIDAL_ASSEMBLY_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation(self)
