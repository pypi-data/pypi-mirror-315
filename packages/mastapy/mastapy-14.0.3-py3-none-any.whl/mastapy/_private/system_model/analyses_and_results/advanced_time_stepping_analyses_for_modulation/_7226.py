...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="GuideDxfModelAdvancedTimeSteppingAnalysisForModulation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="GuideDxfModelAdvancedTimeSteppingAnalysisForModulation._Cast_GuideDxfModelAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_GuideDxfModelAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "GuideDxfModelAdvancedTimeSteppingAnalysisForModulation"
...
class GuideDxfModelAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = (
        _GUIDE_DXF_MODEL_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_GuideDxfModelAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_GuideDxfModelAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_GuideDxfModelAdvancedTimeSteppingAnalysisForModulation(self)
