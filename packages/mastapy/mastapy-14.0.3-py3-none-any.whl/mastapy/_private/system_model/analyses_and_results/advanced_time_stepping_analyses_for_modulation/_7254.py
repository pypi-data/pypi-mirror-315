...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PointLoadAdvancedTimeSteppingAnalysisForModulation._Cast_PointLoadAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_PointLoadAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "PointLoadAdvancedTimeSteppingAnalysisForModulation"
...
class PointLoadAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = _POINT_LOAD_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2882.PointLoadSystemDeflection":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PointLoadAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_PointLoadAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_PointLoadAdvancedTimeSteppingAnalysisForModulation(self)
