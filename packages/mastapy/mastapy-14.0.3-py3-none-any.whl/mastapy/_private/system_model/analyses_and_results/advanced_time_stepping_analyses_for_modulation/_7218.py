...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearAdvancedTimeSteppingAnalysisForModulation._Cast_FaceGearAdvancedTimeSteppingAnalysisForModulation",
    )
...
class _Cast_FaceGearAdvancedTimeSteppingAnalysisForModulation:
    ...
    __parent__: "FaceGearAdvancedTimeSteppingAnalysisForModulation"
...
class FaceGearAdvancedTimeSteppingAnalysisForModulation(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_ADVANCED_TIME_STEPPING_ANALYSIS_FOR_MODULATION
    ...
    @property
    def component_load_case(self: "Self") -> "_7037.FaceGearLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2845.FaceGearSystemDeflection":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FaceGearAdvancedTimeSteppingAnalysisForModulation":
        """Cast to another type.

        Returns:
            _Cast_FaceGearAdvancedTimeSteppingAnalysisForModulation
        """
        return _Cast_FaceGearAdvancedTimeSteppingAnalysisForModulation(self)
