...
class HarmonicAcousticAnalysis(_0.APIBase):
    ...
    @property
    def analysis_run_type(self: "Self") -> "_7697.AcousticAnalysisRunType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.acoustic_analyses._7697",
            "AcousticAnalysisRunType",
        )(value)

    @analysis_run_type.setter
    @enforce_parameter_types
    def analysis_run_type(self: "Self", value: "_7697.AcousticAnalysisRunType") -> None:
    ...
    def excitation_details_to_run(
        self: "Self",
    ) -> "List[_7706.SingleExcitationDetails]":
    ...
    def calculate_surface_sound_pressure(self: "Self") -> None:
        """Method does not return."""
        pythonnet_method_call(self.wrapped, "CalculateSurfaceSoundPressure")
