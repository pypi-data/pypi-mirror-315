...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="GuideDxfModelLoadCase._Cast_GuideDxfModelLoadCase"
    )
...
class _Cast_GuideDxfModelLoadCase:
    ...
    __parent__: "GuideDxfModelLoadCase"
    ...
    @property
    def guide_dxf_model_load_case(self: "CastSelf") -> "GuideDxfModelLoadCase":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GuideDxfModelLoadCase(_6990.ComponentLoadCase):
    """GuideDxfModelLoadCase

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _GUIDE_DXF_MODEL_LOAD_CASE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_GuideDxfModelLoadCase":
        """Cast to another type.

        Returns:
            _Cast_GuideDxfModelLoadCase
        """
        return _Cast_GuideDxfModelLoadCase(self)
