...
from mastapy._private.system_model.analyses_and_results.static_loads import _7044
...
class _Cast_ConicalGearManufactureError:
    ...
    @property
    def gear_manufacture_error(self: "CastSelf") -> "_7044.GearManufactureError":
        return self.__parent__._cast(_7044.GearManufactureError)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearManufactureError(_7044.GearManufactureError):
    """ConicalGearManufactureError
    ...
    @property
    def pitch_errors_concave_flank(self: "Self") -> "_1585.Vector2DListAccessor":
    ...
    @property
    def pitch_errors_convex_flank(self: "Self") -> "_1585.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
