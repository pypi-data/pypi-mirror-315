...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.file_access_helpers import _1873
...
class _Cast_MultiTimeSeriesDataInputFileOptions:
    ...
    @property
    def data_input_file_options(self: "CastSelf") -> "_1903.DataInputFileOptions":
        return self.__parent__._cast(_1903.DataInputFileOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MultiTimeSeriesDataInputFileOptions(_1903.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self: "Self") -> "_1873.TextFileDelimiterOptions":
