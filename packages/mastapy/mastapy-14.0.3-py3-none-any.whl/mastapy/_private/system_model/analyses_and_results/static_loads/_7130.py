...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterTurbineLoadCase._Cast_TorqueConverterTurbineLoadCase",
    )
...
class _Cast_TorqueConverterTurbineLoadCase:
    ...
    __parent__: "TorqueConverterTurbineLoadCase"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterTurbineLoadCase(_7005.CouplingHalfLoadCase):
    """TorqueConverterTurbineLoadCase

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_TURBINE_LOAD_CASE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterTurbineLoadCase":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterTurbineLoadCase
        """
        return _Cast_TorqueConverterTurbineLoadCase(self)
