...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="ClutchHalfLoadCase._Cast_ClutchHalfLoadCase")
...
class _Cast_ClutchHalfLoadCase:
    ...
    @property
    def clutch_half_load_case(self: "CastSelf") -> "ClutchHalfLoadCase":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfLoadCase(_7005.CouplingHalfLoadCase):
    """ClutchHalfLoadCase

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_HALF_LOAD_CASE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfLoadCase":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfLoadCase
        """
        return _Cast_ClutchHalfLoadCase(self)
