...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ZerolBevelGearLoadCase._Cast_ZerolBevelGearLoadCase"
    )
...
class _Cast_ZerolBevelGearLoadCase:
    ...
    __parent__: "ZerolBevelGearLoadCase"
    ...
    @property
    def zerol_bevel_gear_load_case(self: "CastSelf") -> "ZerolBevelGearLoadCase":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearLoadCase(_6980.BevelGearLoadCase):
    """ZerolBevelGearLoadCase

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_LOAD_CASE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ZerolBevelGearLoadCase":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearLoadCase
        """
        return _Cast_ZerolBevelGearLoadCase(self)
