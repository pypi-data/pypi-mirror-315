...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetLoadCase(_6982.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: "Self") -> "List[_7117.StraightBevelGearLoadCase]":
    ...
    def straight_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7117.StraightBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.StraightBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7118.StraightBevelGearMeshLoadCase]":
