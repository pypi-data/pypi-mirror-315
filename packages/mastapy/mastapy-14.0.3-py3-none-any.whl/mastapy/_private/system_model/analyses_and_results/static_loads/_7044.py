...
class _Cast_GearManufactureError:
    ...
    def conical_gear_manufacture_error(
        self: "CastSelf",
    ) -> "_6998.ConicalGearManufactureError":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _6998,
        )

        return self.__parent__._cast(_6998.ConicalGearManufactureError)

    @property
    def cylindrical_gear_manufacture_error(
        self: "CastSelf",
    ) -> "_7015.CylindricalGearManufactureError":
        from mastapy._private.system_model.analyses_and_results.static_loads import (
            _7015,
        )

        return self.__parent__._cast(_7015.CylindricalGearManufactureError)
