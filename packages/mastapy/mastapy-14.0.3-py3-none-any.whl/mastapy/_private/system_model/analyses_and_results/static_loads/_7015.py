...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearManufactureError(_7044.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    @property
    def pitch_errors_left_flank(self: "Self") -> "_1585.Vector2DListAccessor":
    ...
    @property
    def pitch_errors_right_flank(self: "Self") -> "_1585.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
