...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalPlanetGearModalAnalysisAtASpeed._Cast_CylindricalPlanetGearModalAnalysisAtASpeed",
    )
...
class _Cast_CylindricalPlanetGearModalAnalysisAtASpeed:
    ...
    __parent__: "CylindricalPlanetGearModalAnalysisAtASpeed"
...
class CylindricalPlanetGearModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_PLANET_GEAR_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalPlanetGearModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_CylindricalPlanetGearModalAnalysisAtASpeed
        """
        return _Cast_CylindricalPlanetGearModalAnalysisAtASpeed(self)
