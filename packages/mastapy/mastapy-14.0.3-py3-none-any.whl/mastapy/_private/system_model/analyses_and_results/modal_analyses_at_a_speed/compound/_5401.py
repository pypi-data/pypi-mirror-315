...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ConceptCouplingConnectionCompoundModalAnalysisAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingConnectionCompoundModalAnalysisAtASpeed._Cast_ConceptCouplingConnectionCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_ConceptCouplingConnectionCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "ConceptCouplingConnectionCompoundModalAnalysisAtASpeed"

    @property
    def coupling_connection_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5412.CouplingConnectionCompoundModalAnalysisAtASpeed":
...
class ConceptCouplingConnectionCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_CONNECTION_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5268.ConceptCouplingConnectionModalAnalysisAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingConnectionCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingConnectionCompoundModalAnalysisAtASpeed
        """
        return _Cast_ConceptCouplingConnectionCompoundModalAnalysisAtASpeed(self)
