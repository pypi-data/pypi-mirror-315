...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelSunGearCompoundModalAnalysisAtASpeed._Cast_StraightBevelSunGearCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_StraightBevelSunGearCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "StraightBevelSunGearCompoundModalAnalysisAtASpeed"
...
class StraightBevelSunGearCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_SUN_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5357.StraightBevelSunGearModalAnalysisAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelSunGearCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelSunGearCompoundModalAnalysisAtASpeed
        """
        return _Cast_StraightBevelSunGearCompoundModalAnalysisAtASpeed(self)
