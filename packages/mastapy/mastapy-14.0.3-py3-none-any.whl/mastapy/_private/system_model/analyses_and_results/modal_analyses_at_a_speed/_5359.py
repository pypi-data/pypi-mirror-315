...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserModalAnalysisAtASpeed._Cast_SynchroniserModalAnalysisAtASpeed",
    )
...
class _Cast_SynchroniserModalAnalysisAtASpeed:
    ...
    __parent__: "SynchroniserModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserModalAnalysisAtASpeed(_5343.SpecialisedAssemblyModalAnalysisAtASpeed):
    """SynchroniserModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SYNCHRONISER_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserModalAnalysisAtASpeed
        """
        return _Cast_SynchroniserModalAnalysisAtASpeed(self)
