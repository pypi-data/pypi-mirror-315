...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self",
        bound="CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed",
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed._Cast_CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed"

    @property
    def abstract_shaft_to_mountable_component_connection_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> (
        "_5377.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed"
    ):
...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5288.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtASpeed":
