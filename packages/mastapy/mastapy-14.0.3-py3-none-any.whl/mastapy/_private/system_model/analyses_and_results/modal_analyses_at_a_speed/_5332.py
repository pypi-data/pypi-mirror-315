...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadModalAnalysisAtASpeed._Cast_PowerLoadModalAnalysisAtASpeed",
    )
...
class _Cast_PowerLoadModalAnalysisAtASpeed:
    ...
    __parent__: "PowerLoadModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadModalAnalysisAtASpeed(_5367.VirtualComponentModalAnalysisAtASpeed):
    """PowerLoadModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POWER_LOAD_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerLoadModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadModalAnalysisAtASpeed
        """
        return _Cast_PowerLoadModalAnalysisAtASpeed(self)
