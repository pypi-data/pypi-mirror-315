...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="OilSealModalAnalysisAtASpeed._Cast_OilSealModalAnalysisAtASpeed",
    )
...
class _Cast_OilSealModalAnalysisAtASpeed:
    ...
    __parent__: "OilSealModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealModalAnalysisAtASpeed(_5278.ConnectorModalAnalysisAtASpeed):
    """OilSealModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _OIL_SEAL_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_OilSealModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_OilSealModalAnalysisAtASpeed
        """
        return _Cast_OilSealModalAnalysisAtASpeed(self)
