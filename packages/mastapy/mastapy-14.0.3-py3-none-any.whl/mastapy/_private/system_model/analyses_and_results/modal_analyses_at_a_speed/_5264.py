...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfModalAnalysisAtASpeed._Cast_ClutchHalfModalAnalysisAtASpeed",
    )
...
class _Cast_ClutchHalfModalAnalysisAtASpeed:
    ...
    __parent__: "ClutchHalfModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfModalAnalysisAtASpeed(_5280.CouplingHalfModalAnalysisAtASpeed):
    """ClutchHalfModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_HALF_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfModalAnalysisAtASpeed
        """
        return _Cast_ClutchHalfModalAnalysisAtASpeed(self)
