...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingAssemblyModalAnalysisAtASpeed._Cast_RollingRingAssemblyModalAnalysisAtASpeed",
    )
...
class _Cast_RollingRingAssemblyModalAnalysisAtASpeed:
    ...
    __parent__: "RollingRingAssemblyModalAnalysisAtASpeed"
...
class RollingRingAssemblyModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_ASSEMBLY_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingAssemblyModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_RollingRingAssemblyModalAnalysisAtASpeed
        """
        return _Cast_RollingRingAssemblyModalAnalysisAtASpeed(self)
