...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchCompoundModalAnalysisAtASpeed._Cast_ClutchCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_ClutchCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "ClutchCompoundModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchCompoundModalAnalysisAtASpeed(_5411.CouplingCompoundModalAnalysisAtASpeed):
    """ClutchCompoundModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5265.ClutchModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ClutchCompoundModalAnalysisAtASpeed
        """
        return _Cast_ClutchCompoundModalAnalysisAtASpeed(self)
