...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="BoltModalAnalysisAtASpeed._Cast_BoltModalAnalysisAtASpeed"
    )
...
class _Cast_BoltModalAnalysisAtASpeed:
    ...
    __parent__: "BoltModalAnalysisAtASpeed"
    ...
    @property
    def bolt_modal_analysis_at_a_speed(self: "CastSelf") -> "BoltModalAnalysisAtASpeed":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltModalAnalysisAtASpeed(_5267.ComponentModalAnalysisAtASpeed):
    """BoltModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLT_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_BoltModalAnalysisAtASpeed
        """
        return _Cast_BoltModalAnalysisAtASpeed(self)
