...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfCompoundModalAnalysisAtASpeed._Cast_SpringDamperHalfCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_SpringDamperHalfCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "SpringDamperHalfCompoundModalAnalysisAtASpeed"
...
class SpringDamperHalfCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5348.SpringDamperHalfModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHalfCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfCompoundModalAnalysisAtASpeed
        """
        return _Cast_SpringDamperHalfCompoundModalAnalysisAtASpeed(self)
