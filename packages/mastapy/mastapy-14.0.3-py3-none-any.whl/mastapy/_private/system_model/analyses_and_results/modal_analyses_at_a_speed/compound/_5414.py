...
class _Cast_CVTBeltConnectionCompoundModalAnalysisAtASpeed:
    ...
    def belt_connection_compound_modal_analysis_at_a_speed(
        self: "CastSelf",
    ) -> "_5383.BeltConnectionCompoundModalAnalysisAtASpeed":
        return self.__parent__._cast(_5383.BeltConnectionCompoundModalAnalysisAtASpeed)
...
class CVTBeltConnectionCompoundModalAnalysisAtASpeed(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5282.CVTBeltConnectionModalAnalysisAtASpeed]":
