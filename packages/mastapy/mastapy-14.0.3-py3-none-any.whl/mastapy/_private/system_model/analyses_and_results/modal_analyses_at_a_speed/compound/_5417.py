...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyCompoundModalAnalysisAtASpeed._Cast_CycloidalAssemblyCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_CycloidalAssemblyCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "CycloidalAssemblyCompoundModalAnalysisAtASpeed"
...
class CycloidalAssemblyCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5285.CycloidalAssemblyModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyCompoundModalAnalysisAtASpeed
        """
        return _Cast_CycloidalAssemblyCompoundModalAnalysisAtASpeed(self)
