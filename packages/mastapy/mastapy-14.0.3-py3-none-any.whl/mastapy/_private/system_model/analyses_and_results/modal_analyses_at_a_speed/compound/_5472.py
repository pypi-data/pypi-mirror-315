...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionCompoundModalAnalysisAtASpeed._Cast_ShaftHubConnectionCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_ShaftHubConnectionCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "ShaftHubConnectionCompoundModalAnalysisAtASpeed"
...
class ShaftHubConnectionCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _SHAFT_HUB_CONNECTION_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5340.ShaftHubConnectionModalAnalysisAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ShaftHubConnectionCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionCompoundModalAnalysisAtASpeed
        """
        return _Cast_ShaftHubConnectionCompoundModalAnalysisAtASpeed(self)
