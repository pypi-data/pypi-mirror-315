...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearModalAnalysisAtASpeed._Cast_WormGearModalAnalysisAtASpeed",
    )
...
class _Cast_WormGearModalAnalysisAtASpeed:
    ...
    __parent__: "WormGearModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearModalAnalysisAtASpeed(_5301.GearModalAnalysisAtASpeed):
    """WormGearModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _WORM_GEAR_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_WormGearModalAnalysisAtASpeed
        """
        return _Cast_WormGearModalAnalysisAtASpeed(self)
