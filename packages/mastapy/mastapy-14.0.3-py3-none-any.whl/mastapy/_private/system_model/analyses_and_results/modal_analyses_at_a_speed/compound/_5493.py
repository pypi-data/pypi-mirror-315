...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterCompoundModalAnalysisAtASpeed._Cast_TorqueConverterCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_TorqueConverterCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "TorqueConverterCompoundModalAnalysisAtASpeed"
...
class TorqueConverterCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5363.TorqueConverterModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterCompoundModalAnalysisAtASpeed
        """
        return _Cast_TorqueConverterCompoundModalAnalysisAtASpeed(self)
