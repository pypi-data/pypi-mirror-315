...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearMeshModalAnalysisAtASpeed._Cast_StraightBevelDiffGearMeshModalAnalysisAtASpeed",
    )
...
class _Cast_StraightBevelDiffGearMeshModalAnalysisAtASpeed:
    ...
    __parent__: "StraightBevelDiffGearMeshModalAnalysisAtASpeed"
...
class StraightBevelDiffGearMeshModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_DIFF_GEAR_MESH_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelDiffGearMeshModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearMeshModalAnalysisAtASpeed
        """
        return _Cast_StraightBevelDiffGearMeshModalAnalysisAtASpeed(self)
