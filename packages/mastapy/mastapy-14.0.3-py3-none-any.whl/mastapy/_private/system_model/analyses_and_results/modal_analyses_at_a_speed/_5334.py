...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsModalAnalysisAtASpeed._Cast_RingPinsModalAnalysisAtASpeed",
    )
...
class _Cast_RingPinsModalAnalysisAtASpeed:
    ...
    __parent__: "RingPinsModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPinsModalAnalysisAtASpeed(_5322.MountableComponentModalAnalysisAtASpeed):
    """RingPinsModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _RING_PINS_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_RingPinsModalAnalysisAtASpeed
        """
        return _Cast_RingPinsModalAnalysisAtASpeed(self)
