...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FEPartModalAnalysisAtASpeed._Cast_FEPartModalAnalysisAtASpeed",
    )
...
class _Cast_FEPartModalAnalysisAtASpeed:
    ...
    __parent__: "FEPartModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FEPartModalAnalysisAtASpeed(_5244.AbstractShaftOrHousingModalAnalysisAtASpeed):
    """FEPartModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FE_PART_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FEPartModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_FEPartModalAnalysisAtASpeed
        """
        return _Cast_FEPartModalAnalysisAtASpeed(self)
