...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed._Cast_KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed",
    )
...
class _Cast_KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed:
    ...
    __parent__: "KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed"
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed(
    ...
    def klingelnberg_cyclo_palloid_conical_gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5312.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis_at_a_speed(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "KlingelnbergCycloPalloidHypoidGearsModalAnalysisAtASpeed"
        )
    ...
    def klingelnberg_cyclo_palloid_conical_meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5311.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis_at_a_speed(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "KlingelnbergCycloPalloidHypoidMeshesModalAnalysisAtASpeed"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed
        """
        return _Cast_KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed(self)
