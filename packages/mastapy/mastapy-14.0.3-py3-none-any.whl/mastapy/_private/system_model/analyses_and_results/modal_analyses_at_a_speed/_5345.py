...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearModalAnalysisAtASpeed._Cast_SpiralBevelGearModalAnalysisAtASpeed",
    )
...
class _Cast_SpiralBevelGearModalAnalysisAtASpeed:
    ...
    __parent__: "SpiralBevelGearModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearModalAnalysisAtASpeed(_5259.BevelGearModalAnalysisAtASpeed):
    """SpiralBevelGearModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpiralBevelGearModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearModalAnalysisAtASpeed
        """
        return _Cast_SpiralBevelGearModalAnalysisAtASpeed(self)
