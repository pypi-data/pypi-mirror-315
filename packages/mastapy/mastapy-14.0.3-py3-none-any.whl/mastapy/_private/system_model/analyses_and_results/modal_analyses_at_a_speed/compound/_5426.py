...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelCompoundModalAnalysisAtASpeed._Cast_ExternalCADModelCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_ExternalCADModelCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "ExternalCADModelCompoundModalAnalysisAtASpeed"
...
class ExternalCADModelCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _EXTERNAL_CAD_MODEL_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5294.ExternalCADModelModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ExternalCADModelCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelCompoundModalAnalysisAtASpeed
        """
        return _Cast_ExternalCADModelCompoundModalAnalysisAtASpeed(self)
