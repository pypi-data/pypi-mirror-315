...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierCompoundModalAnalysisAtASpeed._Cast_PlanetCarrierCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_PlanetCarrierCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "PlanetCarrierCompoundModalAnalysisAtASpeed"
...
class PlanetCarrierCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _PLANET_CARRIER_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5330.PlanetCarrierModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PlanetCarrierCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierCompoundModalAnalysisAtASpeed
        """
        return _Cast_PlanetCarrierCompoundModalAnalysisAtASpeed(self)
