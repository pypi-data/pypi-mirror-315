...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearMeshCompoundModalAnalysisAtASpeed._Cast_CylindricalGearMeshCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_CylindricalGearMeshCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "CylindricalGearMeshCompoundModalAnalysisAtASpeed"
...
class CylindricalGearMeshCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_MESH_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5289.CylindricalGearMeshModalAnalysisAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CylindricalGearMeshCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearMeshCompoundModalAnalysisAtASpeed
        """
        return _Cast_CylindricalGearMeshCompoundModalAnalysisAtASpeed(self)
