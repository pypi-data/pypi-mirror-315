...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyCompoundModalAnalysisAtASpeed._Cast_FlexiblePinAssemblyCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_FlexiblePinAssemblyCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "FlexiblePinAssemblyCompoundModalAnalysisAtASpeed"
...
class FlexiblePinAssemblyCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _FLEXIBLE_PIN_ASSEMBLY_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5299.FlexiblePinAssemblyModalAnalysisAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FlexiblePinAssemblyCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyCompoundModalAnalysisAtASpeed
        """
        return _Cast_FlexiblePinAssemblyCompoundModalAnalysisAtASpeed(self)
