...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsCompoundModalAnalysisAtASpeed._Cast_RingPinsCompoundModalAnalysisAtASpeed",
    )
...
class _Cast_RingPinsCompoundModalAnalysisAtASpeed:
    ...
    __parent__: "RingPinsCompoundModalAnalysisAtASpeed"
...
class RingPinsCompoundModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_COMPOUND_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5334.RingPinsModalAnalysisAtASpeed]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsCompoundModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_RingPinsCompoundModalAnalysisAtASpeed
        """
        return _Cast_RingPinsCompoundModalAnalysisAtASpeed(self)
