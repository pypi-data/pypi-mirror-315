...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearSetModalAnalysisAtASpeed._Cast_StraightBevelDiffGearSetModalAnalysisAtASpeed",
    )
...
class _Cast_StraightBevelDiffGearSetModalAnalysisAtASpeed:
    ...
    __parent__: "StraightBevelDiffGearSetModalAnalysisAtASpeed"
...
class StraightBevelDiffGearSetModalAnalysisAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_DIFF_GEAR_SET_MODAL_ANALYSIS_AT_A_SPEED
    ...
    def bevel_gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5351.StraightBevelDiffGearModalAnalysisAtASpeed]":
    ...
    def straight_bevel_diff_gears_modal_analysis_at_a_speed(
        ...
        temp = pythonnet_property_get(
            self.wrapped, "StraightBevelDiffGearsModalAnalysisAtASpeed"
        )
    ...
    def straight_bevel_diff_meshes_modal_analysis_at_a_speed(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "StraightBevelDiffMeshesModalAnalysisAtASpeed"
        )
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelDiffGearSetModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearSetModalAnalysisAtASpeed
        """
        return _Cast_StraightBevelDiffGearSetModalAnalysisAtASpeed(self)
