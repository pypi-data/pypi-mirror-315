...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="DatumModalAnalysisAtASpeed._Cast_DatumModalAnalysisAtASpeed"
    )
...
class _Cast_DatumModalAnalysisAtASpeed:
    ...
    __parent__: "DatumModalAnalysisAtASpeed"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumModalAnalysisAtASpeed(_5267.ComponentModalAnalysisAtASpeed):
    """DatumModalAnalysisAtASpeed

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _DATUM_MODAL_ANALYSIS_AT_A_SPEED
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumModalAnalysisAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_DatumModalAnalysisAtASpeed
        """
        return _Cast_DatumModalAnalysisAtASpeed(self)
