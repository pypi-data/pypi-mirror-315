...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyCompoundAdvancedSystemDeflection._Cast_FlexiblePinAssemblyCompoundAdvancedSystemDeflection",
    )
...
class _Cast_FlexiblePinAssemblyCompoundAdvancedSystemDeflection:
    ...
    __parent__: "FlexiblePinAssemblyCompoundAdvancedSystemDeflection"
...
class FlexiblePinAssemblyCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _FLEXIBLE_PIN_ASSEMBLY_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7490.FlexiblePinAssemblyAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FlexiblePinAssemblyCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyCompoundAdvancedSystemDeflection
        """
        return _Cast_FlexiblePinAssemblyCompoundAdvancedSystemDeflection(self)
