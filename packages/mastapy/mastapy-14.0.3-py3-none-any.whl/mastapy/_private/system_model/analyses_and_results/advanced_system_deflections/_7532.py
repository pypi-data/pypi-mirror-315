...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionAdvancedSystemDeflection._Cast_ShaftHubConnectionAdvancedSystemDeflection",
    )
...
class _Cast_ShaftHubConnectionAdvancedSystemDeflection:
    ...
    __parent__: "ShaftHubConnectionAdvancedSystemDeflection"
...
class ShaftHubConnectionAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _SHAFT_HUB_CONNECTION_ADVANCED_SYSTEM_DEFLECTION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ShaftHubConnectionAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionAdvancedSystemDeflection
        """
        return _Cast_ShaftHubConnectionAdvancedSystemDeflection(self)
