...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalMeshedGearAdvancedSystemDeflection._Cast_CylindricalMeshedGearAdvancedSystemDeflection",
    )
...
class _Cast_CylindricalMeshedGearAdvancedSystemDeflection:
    ...
    __parent__: "CylindricalMeshedGearAdvancedSystemDeflection"
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_MESHED_GEAR_ADVANCED_SYSTEM_DEFLECTION
    ...
    def mean_node_torque_in_meshes(self: "Self") -> "float":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "MeanNodeTorqueInMeshes")
    ...
    def cylindrical_gear_advanced_system_deflection(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "CylindricalGearAdvancedSystemDeflection"
        )
    ...
    def cylindrical_gear_mesh_advanced_system_deflection(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "CylindricalGearMeshAdvancedSystemDeflection"
        )
    ...
    def other_cylindrical_gear_advanced_system_deflection(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "OtherCylindricalGearAdvancedSystemDeflection"
        )
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalMeshedGearAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_CylindricalMeshedGearAdvancedSystemDeflection
        """
        return _Cast_CylindricalMeshedGearAdvancedSystemDeflection(self)
