...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartAdvancedSystemDeflection(_7722.PartStaticLoadAnalysisCase):
    """PartAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self: "Self") -> "_7432.AdvancedSystemDeflection":
    ...
    def create_viewable(self: "Self") -> "_2301.AdvancedSystemDeflectionViewable":
