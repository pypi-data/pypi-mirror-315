...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentCompoundAdvancedSystemDeflection._Cast_MeasurementComponentCompoundAdvancedSystemDeflection",
    )
...
class _Cast_MeasurementComponentCompoundAdvancedSystemDeflection:
    ...
    __parent__: "MeasurementComponentCompoundAdvancedSystemDeflection"
...
class MeasurementComponentCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7510.MeasurementComponentAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_MeasurementComponentCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentCompoundAdvancedSystemDeflection
        """
        return _Cast_MeasurementComponentCompoundAdvancedSystemDeflection(self)
