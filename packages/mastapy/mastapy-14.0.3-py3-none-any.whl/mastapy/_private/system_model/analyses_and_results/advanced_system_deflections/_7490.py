...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyAdvancedSystemDeflection._Cast_FlexiblePinAssemblyAdvancedSystemDeflection",
    )
...
class _Cast_FlexiblePinAssemblyAdvancedSystemDeflection:
    ...
    __parent__: "FlexiblePinAssemblyAdvancedSystemDeflection"
...
class FlexiblePinAssemblyAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _FLEXIBLE_PIN_ASSEMBLY_ADVANCED_SYSTEM_DEFLECTION
    ...
    def assembly_system_deflection_results(
        self: "Self",
    ) -> "List[_2847.FlexiblePinAssemblySystemDeflection]":
    ...
    def load_sharing_factor_reporters(
        self: "Self",
    ) -> "List[_2867.LoadSharingFactorReporter]":
    ...
    def pin_spindle_fit_advanced_analyses(
        self: "Self",
    ) -> "List[_2892.ShaftHubConnectionSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ShaftHubConnectionSystemDeflection]

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "PinSpindleFitAdvancedAnalyses")
    ...
    def spindle_advanced_analyses(
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "SpindleAdvancedAnalyses")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FlexiblePinAssemblyAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyAdvancedSystemDeflection
        """
        return _Cast_FlexiblePinAssemblyAdvancedSystemDeflection(self)
