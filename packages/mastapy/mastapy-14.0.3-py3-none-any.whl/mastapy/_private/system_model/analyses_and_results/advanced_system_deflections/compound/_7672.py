...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfCompoundAdvancedSystemDeflection._Cast_SpringDamperHalfCompoundAdvancedSystemDeflection",
    )
...
class _Cast_SpringDamperHalfCompoundAdvancedSystemDeflection:
    ...
    __parent__: "SpringDamperHalfCompoundAdvancedSystemDeflection"
...
class SpringDamperHalfCompoundAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_COMPOUND_ADVANCED_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7540.SpringDamperHalfAdvancedSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperHalfCompoundAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfCompoundAdvancedSystemDeflection
        """
        return _Cast_SpringDamperHalfCompoundAdvancedSystemDeflection(self)
