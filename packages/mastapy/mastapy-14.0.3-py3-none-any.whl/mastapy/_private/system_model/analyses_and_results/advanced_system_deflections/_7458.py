...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingConnectionAdvancedSystemDeflection._Cast_ConceptCouplingConnectionAdvancedSystemDeflection",
    )
...
class _Cast_ConceptCouplingConnectionAdvancedSystemDeflection:
    ...
    __parent__: "ConceptCouplingConnectionAdvancedSystemDeflection"
...
class ConceptCouplingConnectionAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_CONNECTION_ADVANCED_SYSTEM_DEFLECTION
    ...
    def connection_system_deflection_results(
        self: "Self",
    ) -> "List[_2806.ConceptCouplingConnectionSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingConnectionAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingConnectionAdvancedSystemDeflection
        """
        return _Cast_ConceptCouplingConnectionAdvancedSystemDeflection(self)
