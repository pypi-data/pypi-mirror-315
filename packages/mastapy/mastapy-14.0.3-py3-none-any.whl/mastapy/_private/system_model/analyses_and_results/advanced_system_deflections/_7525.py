...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsAdvancedSystemDeflection._Cast_RingPinsAdvancedSystemDeflection",
    )
...
class _Cast_RingPinsAdvancedSystemDeflection:
    ...
    __parent__: "RingPinsAdvancedSystemDeflection"
...
class RingPinsAdvancedSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_ADVANCED_SYSTEM_DEFLECTION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_RingPinsAdvancedSystemDeflection
        """
        return _Cast_RingPinsAdvancedSystemDeflection(self)
