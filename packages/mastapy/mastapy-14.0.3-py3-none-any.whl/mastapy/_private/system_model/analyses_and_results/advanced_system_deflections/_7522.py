...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PointLoadAdvancedSystemDeflection._Cast_PointLoadAdvancedSystemDeflection",
    )
...
class _Cast_PointLoadAdvancedSystemDeflection:
    ...
    __parent__: "PointLoadAdvancedSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadAdvancedSystemDeflection(_7559.VirtualComponentAdvancedSystemDeflection):
    """PointLoadAdvancedSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POINT_LOAD_ADVANCED_SYSTEM_DEFLECTION
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2882.PointLoadSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PointLoadAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_PointLoadAdvancedSystemDeflection
        """
        return _Cast_PointLoadAdvancedSystemDeflection(self)
