...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelAdvancedSystemDeflection._Cast_ExternalCADModelAdvancedSystemDeflection",
    )
...
class _Cast_ExternalCADModelAdvancedSystemDeflection:
    ...
    __parent__: "ExternalCADModelAdvancedSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExternalCADModelAdvancedSystemDeflection(_7456.ComponentAdvancedSystemDeflection):
    """ExternalCADModelAdvancedSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _EXTERNAL_CAD_MODEL_ADVANCED_SYSTEM_DEFLECTION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ExternalCADModelAdvancedSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelAdvancedSystemDeflection
        """
        return _Cast_ExternalCADModelAdvancedSystemDeflection(self)
