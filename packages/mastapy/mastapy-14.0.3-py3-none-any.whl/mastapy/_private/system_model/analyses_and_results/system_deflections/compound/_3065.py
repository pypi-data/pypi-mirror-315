...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpCompoundSystemDeflection._Cast_TorqueConverterPumpCompoundSystemDeflection",
    )
...
class _Cast_TorqueConverterPumpCompoundSystemDeflection:
    ...
    __parent__: "TorqueConverterPumpCompoundSystemDeflection"
...
class TorqueConverterPumpCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_PUMP_COMPOUND_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2920.TorqueConverterPumpSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterPumpCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpCompoundSystemDeflection
        """
        return _Cast_TorqueConverterPumpCompoundSystemDeflection(self)
