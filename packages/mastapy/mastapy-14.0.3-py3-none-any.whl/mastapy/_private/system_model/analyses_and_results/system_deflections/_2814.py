...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConicalGearSetSystemDeflection(_2849.GearSetSystemDeflection):
    """ConicalGearSetSystemDeflection
    ...
    def gears_system_deflection(
        self: "Self",
    ) -> "List[_2815.ConicalGearSystemDeflection]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4175.ConicalGearSetPowerFlow":
