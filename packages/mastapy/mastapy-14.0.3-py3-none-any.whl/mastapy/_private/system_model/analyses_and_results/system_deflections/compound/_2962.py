...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCompoundSystemDeflection._Cast_BoltedJointCompoundSystemDeflection",
    )
...
class _Cast_BoltedJointCompoundSystemDeflection:
    ...
    __parent__: "BoltedJointCompoundSystemDeflection"
...
class BoltedJointCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_COMPOUND_SYSTEM_DEFLECTION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2798.BoltedJointSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCompoundSystemDeflection
        """
        return _Cast_BoltedJointCompoundSystemDeflection(self)
