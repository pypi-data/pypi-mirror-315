...
class BevelDifferentialGearSetCompoundSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2791.BevelDifferentialGearSetSystemDeflection]":
    ...
    def bevel_differential_gears_compound_system_deflection(
        self: "Self",
    ) -> "List[_2953.BevelDifferentialGearCompoundSystemDeflection]":
    ...
    def bevel_differential_meshes_compound_system_deflection(
        self: "Self",
    ) -> "List[_2954.BevelDifferentialGearMeshCompoundSystemDeflection]":
