...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchSystemDeflection(_2820.CouplingSystemDeflection):
    """ClutchSystemDeflection
    ...
    @property
    def clutch_connection(self: "Self") -> "_2800.ClutchConnectionSystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4164.ClutchPowerFlow":
