...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BearingDynamicElementPropertyWrapper._Cast_BearingDynamicElementPropertyWrapper",
    )
...
class _Cast_BearingDynamicElementPropertyWrapper:
    ...
    __parent__: "BearingDynamicElementPropertyWrapper"
...
class BearingDynamicElementPropertyWrapper(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _BEARING_DYNAMIC_ELEMENT_PROPERTY_WRAPPER
    ...
    def contact_results(
        self: "Self",
    ) -> "List[_2782.BearingDynamicElementContactPropertyWrapper]":
    ...
    def element_results(
        self: "Self",
    ) -> "List[_2785.BearingDynamicResultsPropertyWrapper]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BearingDynamicElementPropertyWrapper":
        """Cast to another type.

        Returns:
            _Cast_BearingDynamicElementPropertyWrapper
        """
        return _Cast_BearingDynamicElementPropertyWrapper(self)
