...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2788
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTBeltConnectionSystemDeflection(_2788.BeltConnectionSystemDeflection):
    """CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4181.CVTBeltConnectionPowerFlow":
