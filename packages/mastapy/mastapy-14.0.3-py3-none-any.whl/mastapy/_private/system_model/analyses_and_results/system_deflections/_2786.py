...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    @property
    def bearing_system_deflection(self: "Self") -> "_2787.BearingSystemDeflection":
    ...
    def element_results(
        self: "Self",
    ) -> "List[_2783.BearingDynamicElementPropertyWrapper]":
    ...
    def post_analysis_results(
        self: "Self",
    ) -> "List[_2784.BearingDynamicPostAnalysisResultWrapper]":
