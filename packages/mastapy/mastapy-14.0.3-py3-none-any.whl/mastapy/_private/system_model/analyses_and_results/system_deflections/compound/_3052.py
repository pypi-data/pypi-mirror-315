...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearMeshCompoundSystemDeflection._Cast_StraightBevelDiffGearMeshCompoundSystemDeflection",
    )
...
class _Cast_StraightBevelDiffGearMeshCompoundSystemDeflection:
    ...
    __parent__: "StraightBevelDiffGearMeshCompoundSystemDeflection"
...
class StraightBevelDiffGearMeshCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_DIFF_GEAR_MESH_COMPOUND_SYSTEM_DEFLECTION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelDiffGearMeshCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearMeshCompoundSystemDeflection
        """
        return _Cast_StraightBevelDiffGearMeshCompoundSystemDeflection(self)
