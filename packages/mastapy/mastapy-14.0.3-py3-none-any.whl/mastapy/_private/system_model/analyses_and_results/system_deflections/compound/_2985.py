...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyCompoundSystemDeflection._Cast_CycloidalAssemblyCompoundSystemDeflection",
    )
...
class _Cast_CycloidalAssemblyCompoundSystemDeflection:
    ...
    __parent__: "CycloidalAssemblyCompoundSystemDeflection"
...
class CycloidalAssemblyCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_COMPOUND_SYSTEM_DEFLECTION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2824.CycloidalAssemblySystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyCompoundSystemDeflection
        """
        return _Cast_CycloidalAssemblyCompoundSystemDeflection(self)
