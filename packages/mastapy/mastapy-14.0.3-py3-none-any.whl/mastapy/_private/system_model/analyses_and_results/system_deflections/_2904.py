...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearMeshSystemDeflection._Cast_StraightBevelDiffGearMeshSystemDeflection",
    )
...
class _Cast_StraightBevelDiffGearMeshSystemDeflection:
    ...
    __parent__: "StraightBevelDiffGearMeshSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearMeshSystemDeflection(_2795.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_DIFF_GEAR_MESH_SYSTEM_DEFLECTION
    ...
    @property
    def power_flow_results(self: "Self") -> "_4253.StraightBevelDiffGearMeshPowerFlow":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelDiffGearMeshSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearMeshSystemDeflection
        """
        return _Cast_StraightBevelDiffGearMeshSystemDeflection(self)
