...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2796
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearSetSystemDeflection._Cast_SpiralBevelGearSetSystemDeflection",
    )
...
class _Cast_SpiralBevelGearSetSystemDeflection:
    ...
    __parent__: "SpiralBevelGearSetSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetSystemDeflection(_2796.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_SET_SYSTEM_DEFLECTION
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7110.SpiralBevelGearSetLoadCase":
    ...
    @property
    def rating(self: "Self") -> "_417.SpiralBevelGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_417.SpiralBevelGearSetRating":
        """mastapy.gears.rating.spiral_bevel.SpiralBevelGearSetRating
    ...
    @property
    def power_flow_results(self: "Self") -> "_4249.SpiralBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_2900.SpiralBevelGearSystemDeflection]":
    ...
    def spiral_bevel_gears_system_deflection(
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "SpiralBevelGearsSystemDeflection")
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2898.SpiralBevelGearMeshSystemDeflection]":
    ...
    def spiral_bevel_meshes_system_deflection(
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "SpiralBevelMeshesSystemDeflection")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpiralBevelGearSetSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearSetSystemDeflection
        """
        return _Cast_SpiralBevelGearSetSystemDeflection(self)
