...
from mastapy._private.system_model.analyses_and_results.system_deflections import _2926
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentSystemDeflection._Cast_MeasurementComponentSystemDeflection",
    )
...
class _Cast_MeasurementComponentSystemDeflection:
    ...
    __parent__: "MeasurementComponentSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeasurementComponentSystemDeflection(_2926.VirtualComponentSystemDeflection):
    """MeasurementComponentSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_SYSTEM_DEFLECTION
    ...
    @property
    def component_load_case(self: "Self") -> "_7075.MeasurementComponentLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4220.MeasurementComponentPowerFlow":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MeasurementComponentSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentSystemDeflection
        """
        return _Cast_MeasurementComponentSystemDeflection(self)
