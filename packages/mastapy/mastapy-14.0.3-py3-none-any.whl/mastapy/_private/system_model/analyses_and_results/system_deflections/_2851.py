...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="GuideDxfModelSystemDeflection._Cast_GuideDxfModelSystemDeflection",
    )
...
class _Cast_GuideDxfModelSystemDeflection:
    ...
    __parent__: "GuideDxfModelSystemDeflection"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GuideDxfModelSystemDeflection(_2804.ComponentSystemDeflection):
    """GuideDxfModelSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _GUIDE_DXF_MODEL_SYSTEM_DEFLECTION
    ...
    @property
    def power_flow_results(self: "Self") -> "_4205.GuideDxfModelPowerFlow":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_GuideDxfModelSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_GuideDxfModelSystemDeflection
        """
        return _Cast_GuideDxfModelSystemDeflection(self)
