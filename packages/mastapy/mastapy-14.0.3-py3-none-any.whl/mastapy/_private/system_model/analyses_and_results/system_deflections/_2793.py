...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialPlanetGearSystemDeflection._Cast_BevelDifferentialPlanetGearSystemDeflection",
    )
...
class _Cast_BevelDifferentialPlanetGearSystemDeflection:
    ...
    __parent__: "BevelDifferentialPlanetGearSystemDeflection"
...
class BevelDifferentialPlanetGearSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _BEVEL_DIFFERENTIAL_PLANET_GEAR_SYSTEM_DEFLECTION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BevelDifferentialPlanetGearSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialPlanetGearSystemDeflection
        """
        return _Cast_BevelDifferentialPlanetGearSystemDeflection(self)
