...
_MICROPHONE_SYSTEM_DEFLECTION = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="MicrophoneSystemDeflection")
    CastSelf = TypeVar(
        "CastSelf", bound="MicrophoneSystemDeflection._Cast_MicrophoneSystemDeflection"
    )


__docformat__ = "restructuredtext en"
__all__ = ("MicrophoneSystemDeflection",)


@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class _Cast_MicrophoneSystemDeflection:
    """Special nested class for casting MicrophoneSystemDeflection to subclasses."""

    __parent__: "MicrophoneSystemDeflection"
    ...
    @property
    def microphone_system_deflection(self: "CastSelf") -> "MicrophoneSystemDeflection":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneSystemDeflection(_2804.ComponentSystemDeflection):
    """MicrophoneSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MICROPHONE_SYSTEM_DEFLECTION
    ...
    @property
    def power_flow_results(self: "Self") -> "_4222.MicrophonePowerFlow":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MicrophoneSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_MicrophoneSystemDeflection
        """
        return _Cast_MicrophoneSystemDeflection(self)
