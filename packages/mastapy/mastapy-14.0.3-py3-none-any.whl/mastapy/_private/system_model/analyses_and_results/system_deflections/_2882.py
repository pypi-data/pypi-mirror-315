...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="PointLoadSystemDeflection._Cast_PointLoadSystemDeflection"
    )
...
class _Cast_PointLoadSystemDeflection:
    ...
    __parent__: "PointLoadSystemDeflection"
    ...
    @property
    def point_load_system_deflection(self: "CastSelf") -> "PointLoadSystemDeflection":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadSystemDeflection(_2926.VirtualComponentSystemDeflection):
    """PointLoadSystemDeflection

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POINT_LOAD_SYSTEM_DEFLECTION
    ...
    @property
    def power_flow_results(self: "Self") -> "_4232.PointLoadPowerFlow":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PointLoadSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_PointLoadSystemDeflection
        """
        return _Cast_PointLoadSystemDeflection(self)
