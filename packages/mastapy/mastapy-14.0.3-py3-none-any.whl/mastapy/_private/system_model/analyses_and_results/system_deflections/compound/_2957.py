...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialSunGearCompoundSystemDeflection._Cast_BevelDifferentialSunGearCompoundSystemDeflection",
    )
...
class _Cast_BevelDifferentialSunGearCompoundSystemDeflection:
    ...
    __parent__: "BevelDifferentialSunGearCompoundSystemDeflection"
...
class BevelDifferentialSunGearCompoundSystemDeflection(
    ...
    TYPE: ClassVar["Type"] = _BEVEL_DIFFERENTIAL_SUN_GEAR_COMPOUND_SYSTEM_DEFLECTION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2794.BevelDifferentialSunGearSystemDeflection]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialSunGearCompoundSystemDeflection":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialSunGearCompoundSystemDeflection
        """
        return _Cast_BevelDifferentialSunGearCompoundSystemDeflection(self)
