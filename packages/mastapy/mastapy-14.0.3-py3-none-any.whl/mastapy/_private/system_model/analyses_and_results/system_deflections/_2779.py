...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMAGleasonConicalGearSetSystemDeflection(_2814.ConicalGearSetSystemDeflection):
    """AGMAGleasonConicalGearSetSystemDeflection
    ...
    def conical_gears_system_deflection(
        self: "Self",
    ) -> "List[_2780.AGMAGleasonConicalGearSystemDeflection]":
    ...
    def conical_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2778.AGMAGleasonConicalGearMeshSystemDeflection]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4147.AGMAGleasonConicalGearSetPowerFlow":
