...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearStabilityAnalysis._Cast_HypoidGearStabilityAnalysis",
    )
...
class _Cast_HypoidGearStabilityAnalysis:
    ...
    __parent__: "HypoidGearStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearStabilityAnalysis(_3874.AGMAGleasonConicalGearStabilityAnalysis):
    """HypoidGearStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _HYPOID_GEAR_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearStabilityAnalysis
        """
        return _Cast_HypoidGearStabilityAnalysis(self)
