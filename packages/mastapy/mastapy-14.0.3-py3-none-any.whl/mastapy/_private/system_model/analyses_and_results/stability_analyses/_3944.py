...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis._Cast_KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis",
    )
...
class _Cast_KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis:
    ...
    __parent__: "KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis"
...
class KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = (
        _KLINGELNBERG_CYCLO_PALLOID_SPIRAL_BEVEL_GEAR_STABILITY_ANALYSIS
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis
        """
        return _Cast_KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis(self)
