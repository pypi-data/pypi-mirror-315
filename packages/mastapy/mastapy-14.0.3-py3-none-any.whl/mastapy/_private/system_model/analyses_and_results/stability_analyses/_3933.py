...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearSetStabilityAnalysis(_3873.AGMAGleasonConicalGearSetStabilityAnalysis):
    """HypoidGearSetStabilityAnalysis
    ...
    def agma_gleason_conical_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3934.HypoidGearStabilityAnalysis]":
    ...
    def agma_gleason_conical_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3932.HypoidGearMeshStabilityAnalysis]":
