...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltDriveCompoundStabilityAnalysis._Cast_BeltDriveCompoundStabilityAnalysis",
    )
...
class _Cast_BeltDriveCompoundStabilityAnalysis:
    ...
    __parent__: "BeltDriveCompoundStabilityAnalysis"
...
class BeltDriveCompoundStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = _BELT_DRIVE_COMPOUND_STABILITY_ANALYSIS
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3878.BeltDriveStabilityAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltDriveCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BeltDriveCompoundStabilityAnalysis
        """
        return _Cast_BeltDriveCompoundStabilityAnalysis(self)
