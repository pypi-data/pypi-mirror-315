...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelStabilityAnalysis._Cast_ExternalCADModelStabilityAnalysis",
    )
...
class _Cast_ExternalCADModelStabilityAnalysis:
    ...
    __parent__: "ExternalCADModelStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExternalCADModelStabilityAnalysis(_3893.ComponentStabilityAnalysis):
    """ExternalCADModelStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _EXTERNAL_CAD_MODEL_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ExternalCADModelStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelStabilityAnalysis
        """
        return _Cast_ExternalCADModelStabilityAnalysis(self)
