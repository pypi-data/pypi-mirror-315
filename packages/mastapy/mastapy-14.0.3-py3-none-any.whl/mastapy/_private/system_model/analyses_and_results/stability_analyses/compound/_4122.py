...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserSleeveCompoundStabilityAnalysis._Cast_SynchroniserSleeveCompoundStabilityAnalysis",
    )
...
class _Cast_SynchroniserSleeveCompoundStabilityAnalysis:
    ...
    __parent__: "SynchroniserSleeveCompoundStabilityAnalysis"
...
class SynchroniserSleeveCompoundStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_SLEEVE_COMPOUND_STABILITY_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3990.SynchroniserSleeveStabilityAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserSleeveCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserSleeveCompoundStabilityAnalysis
        """
        return _Cast_SynchroniserSleeveCompoundStabilityAnalysis(self)
