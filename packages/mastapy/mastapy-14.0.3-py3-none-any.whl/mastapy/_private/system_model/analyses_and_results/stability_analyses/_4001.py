...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMeshStabilityAnalysis._Cast_ZerolBevelGearMeshStabilityAnalysis",
    )
...
class _Cast_ZerolBevelGearMeshStabilityAnalysis:
    ...
    __parent__: "ZerolBevelGearMeshStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearMeshStabilityAnalysis(_3884.BevelGearMeshStabilityAnalysis):
    """ZerolBevelGearMeshStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_MESH_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ZerolBevelGearMeshStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMeshStabilityAnalysis
        """
        return _Cast_ZerolBevelGearMeshStabilityAnalysis(self)
