...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyStabilityAnalysis._Cast_FlexiblePinAssemblyStabilityAnalysis",
    )
...
class _Cast_FlexiblePinAssemblyStabilityAnalysis:
    ...
    __parent__: "FlexiblePinAssemblyStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FlexiblePinAssemblyStabilityAnalysis(_3970.SpecialisedAssemblyStabilityAnalysis):
    """FlexiblePinAssemblyStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FLEXIBLE_PIN_ASSEMBLY_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FlexiblePinAssemblyStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyStabilityAnalysis
        """
        return _Cast_FlexiblePinAssemblyStabilityAnalysis(self)
