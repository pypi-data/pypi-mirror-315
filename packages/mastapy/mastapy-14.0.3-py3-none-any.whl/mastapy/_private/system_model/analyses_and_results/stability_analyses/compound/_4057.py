...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearCompoundStabilityAnalysis._Cast_FaceGearCompoundStabilityAnalysis",
    )
...
class _Cast_FaceGearCompoundStabilityAnalysis:
    ...
    __parent__: "FaceGearCompoundStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearCompoundStabilityAnalysis(_4062.GearCompoundStabilityAnalysis):
    """FaceGearCompoundStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FACE_GEAR_COMPOUND_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FaceGearCompoundStabilityAnalysis
        """
        return _Cast_FaceGearCompoundStabilityAnalysis(self)
