...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="BoltStabilityAnalysis._Cast_BoltStabilityAnalysis"
    )
...
class _Cast_BoltStabilityAnalysis:
    ...
    __parent__: "BoltStabilityAnalysis"
    ...
    @property
    def bolt_stability_analysis(self: "CastSelf") -> "BoltStabilityAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltStabilityAnalysis(_3893.ComponentStabilityAnalysis):
    """BoltStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLT_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BoltStabilityAnalysis
        """
        return _Cast_BoltStabilityAnalysis(self)
