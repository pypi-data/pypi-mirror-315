...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierStabilityAnalysis._Cast_PlanetCarrierStabilityAnalysis",
    )
...
class _Cast_PlanetCarrierStabilityAnalysis:
    ...
    __parent__: "PlanetCarrierStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierStabilityAnalysis(_3949.MountableComponentStabilityAnalysis):
    """PlanetCarrierStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _PLANET_CARRIER_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PlanetCarrierStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierStabilityAnalysis
        """
        return _Cast_PlanetCarrierStabilityAnalysis(self)
