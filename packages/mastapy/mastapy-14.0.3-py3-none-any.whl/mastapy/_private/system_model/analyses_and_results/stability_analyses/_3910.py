...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3960
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="CVTPulleyStabilityAnalysis._Cast_CVTPulleyStabilityAnalysis"
    )
...
class _Cast_CVTPulleyStabilityAnalysis:
    ...
    __parent__: "CVTPulleyStabilityAnalysis"
    ...
    @property
    def cvt_pulley_stability_analysis(self: "CastSelf") -> "CVTPulleyStabilityAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleyStabilityAnalysis(_3960.PulleyStabilityAnalysis):
    """CVTPulleyStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CVT_PULLEY_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CVTPulleyStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CVTPulleyStabilityAnalysis
        """
        return _Cast_CVTPulleyStabilityAnalysis(self)
