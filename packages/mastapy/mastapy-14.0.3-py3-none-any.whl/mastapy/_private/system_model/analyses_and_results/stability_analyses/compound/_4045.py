...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTCompoundStabilityAnalysis(_4014.BeltDriveCompoundStabilityAnalysis):
    """CVTCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3911.CVTStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_3911.CVTStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.CVTStabilityAnalysis]
