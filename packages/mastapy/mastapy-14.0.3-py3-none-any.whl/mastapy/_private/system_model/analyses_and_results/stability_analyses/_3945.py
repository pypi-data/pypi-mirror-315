...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="MassDiscStabilityAnalysis._Cast_MassDiscStabilityAnalysis"
    )
...
class _Cast_MassDiscStabilityAnalysis:
    ...
    __parent__: "MassDiscStabilityAnalysis"
    ...
    @property
    def mass_disc_stability_analysis(self: "CastSelf") -> "MassDiscStabilityAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscStabilityAnalysis(_3997.VirtualComponentStabilityAnalysis):
    """MassDiscStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MASS_DISC_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MassDiscStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MassDiscStabilityAnalysis
        """
        return _Cast_MassDiscStabilityAnalysis(self)
