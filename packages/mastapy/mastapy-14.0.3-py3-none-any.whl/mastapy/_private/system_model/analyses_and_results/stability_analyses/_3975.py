...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfStabilityAnalysis._Cast_SpringDamperHalfStabilityAnalysis",
    )
...
class _Cast_SpringDamperHalfStabilityAnalysis:
    ...
    __parent__: "SpringDamperHalfStabilityAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperHalfStabilityAnalysis(_3906.CouplingHalfStabilityAnalysis):
    """SpringDamperHalfStabilityAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_STABILITY_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHalfStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfStabilityAnalysis
        """
        return _Cast_SpringDamperHalfStabilityAnalysis(self)
