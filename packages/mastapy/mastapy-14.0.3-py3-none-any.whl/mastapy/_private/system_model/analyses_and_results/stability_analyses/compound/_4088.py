...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingHalfCompoundStabilityAnalysis._Cast_PartToPartShearCouplingHalfCompoundStabilityAnalysis",
    )
...
class _Cast_PartToPartShearCouplingHalfCompoundStabilityAnalysis:
    ...
    __parent__: "PartToPartShearCouplingHalfCompoundStabilityAnalysis"
...
class PartToPartShearCouplingHalfCompoundStabilityAnalysis(
    ...
    TYPE: ClassVar["Type"] = (
        _PART_TO_PART_SHEAR_COUPLING_HALF_COMPOUND_STABILITY_ANALYSIS
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3953.PartToPartShearCouplingHalfStabilityAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingHalfCompoundStabilityAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingHalfCompoundStabilityAnalysis
        """
        return _Cast_PartToPartShearCouplingHalfCompoundStabilityAnalysis(self)
