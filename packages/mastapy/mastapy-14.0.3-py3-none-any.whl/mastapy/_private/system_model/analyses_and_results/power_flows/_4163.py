...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ClutchHalfPowerFlow._Cast_ClutchHalfPowerFlow"
    )
...
class _Cast_ClutchHalfPowerFlow:
    ...
    __parent__: "ClutchHalfPowerFlow"
    ...
    @property
    def clutch_half_power_flow(self: "CastSelf") -> "ClutchHalfPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfPowerFlow(_4179.CouplingHalfPowerFlow):
    """ClutchHalfPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_HALF_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfPowerFlow
        """
        return _Cast_ClutchHalfPowerFlow(self)
