...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="SynchroniserPowerFlow._Cast_SynchroniserPowerFlow"
    )
...
class _Cast_SynchroniserPowerFlow:
    ...
    __parent__: "SynchroniserPowerFlow"
    ...
    @property
    def synchroniser_power_flow(self: "CastSelf") -> "SynchroniserPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserPowerFlow(_4246.SpecialisedAssemblyPowerFlow):
    """SynchroniserPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SYNCHRONISER_POWER_FLOW
    ...
    @property
    def cones(self: "Self") -> "List[_4261.SynchroniserHalfPowerFlow]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserPowerFlow
        """
        return _Cast_SynchroniserPowerFlow(self)
