...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="RollingRingPowerFlow._Cast_RollingRingPowerFlow"
    )
...
class _Cast_RollingRingPowerFlow:
    ...
    __parent__: "RollingRingPowerFlow"
    ...
    @property
    def rolling_ring_power_flow(self: "CastSelf") -> "RollingRingPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingPowerFlow(_4179.CouplingHalfPowerFlow):
    """RollingRingPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _ROLLING_RING_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_RollingRingPowerFlow
        """
        return _Cast_RollingRingPowerFlow(self)
