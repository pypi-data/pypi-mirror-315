...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="SpiralBevelGearPowerFlow._Cast_SpiralBevelGearPowerFlow"
    )
...
class _Cast_SpiralBevelGearPowerFlow:
    ...
    __parent__: "SpiralBevelGearPowerFlow"
    ...
    @property
    def spiral_bevel_gear_power_flow(self: "CastSelf") -> "SpiralBevelGearPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearPowerFlow(_4158.BevelGearPowerFlow):
    """SpiralBevelGearPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_POWER_FLOW
    ...
    @property
    def component_detailed_analysis(self: "Self") -> "_416.SpiralBevelGearRating":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpiralBevelGearPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearPowerFlow
        """
        return _Cast_SpiralBevelGearPowerFlow(self)
