...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetPowerFlow(_4204.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4171.ConceptGearPowerFlow]":
    ...
    @property
    def concept_gears_power_flow(self: "Self") -> "List[_4171.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4170.ConceptGearMeshPowerFlow]":
