...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="CycloidalAssemblyPowerFlow._Cast_CycloidalAssemblyPowerFlow"
    )
...
class _Cast_CycloidalAssemblyPowerFlow:
    ...
    __parent__: "CycloidalAssemblyPowerFlow"
    ...
    @property
    def cycloidal_assembly_power_flow(self: "CastSelf") -> "CycloidalAssemblyPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalAssemblyPowerFlow(_4246.SpecialisedAssemblyPowerFlow):
    """CycloidalAssemblyPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyPowerFlow
        """
        return _Cast_CycloidalAssemblyPowerFlow(self)
