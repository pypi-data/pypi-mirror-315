...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearSetPowerFlow._Cast_SpiralBevelGearSetPowerFlow",
    )
...
class _Cast_SpiralBevelGearSetPowerFlow:
    ...
    __parent__: "SpiralBevelGearSetPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpiralBevelGearSetPowerFlow(_4159.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_SET_POWER_FLOW
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4248.SpiralBevelGearPowerFlow]":
    ...
    def spiral_bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4248.SpiralBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpiralBevelGearPowerFlow]

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "SpiralBevelGearsPowerFlow")
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4247.SpiralBevelGearMeshPowerFlow]":
    ...
    def spiral_bevel_meshes_power_flow(
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "SpiralBevelMeshesPowerFlow")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpiralBevelGearSetPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearSetPowerFlow
        """
        return _Cast_SpiralBevelGearSetPowerFlow(self)
