...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="UnbalancedMassPowerFlow._Cast_UnbalancedMassPowerFlow"
    )
...
class _Cast_UnbalancedMassPowerFlow:
    ...
    __parent__: "UnbalancedMassPowerFlow"
    ...
    @property
    def unbalanced_mass_power_flow(self: "CastSelf") -> "UnbalancedMassPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UnbalancedMassPowerFlow(_4271.VirtualComponentPowerFlow):
    """UnbalancedMassPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_UnbalancedMassPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassPowerFlow
        """
        return _Cast_UnbalancedMassPowerFlow(self)
