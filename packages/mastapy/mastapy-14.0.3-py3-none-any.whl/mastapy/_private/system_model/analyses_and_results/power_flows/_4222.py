...
_MICROPHONE_POWER_FLOW = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="MicrophonePowerFlow")
    CastSelf = TypeVar(
        "CastSelf", bound="MicrophonePowerFlow._Cast_MicrophonePowerFlow"
    )


__docformat__ = "restructuredtext en"
__all__ = ("MicrophonePowerFlow",)


@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class _Cast_MicrophonePowerFlow:
    """Special nested class for casting MicrophonePowerFlow to subclasses."""

    __parent__: "MicrophonePowerFlow"
    ...
    @property
    def microphone_power_flow(self: "CastSelf") -> "MicrophonePowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophonePowerFlow(_4166.ComponentPowerFlow):
    """MicrophonePowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MICROPHONE_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MicrophonePowerFlow":
        """Cast to another type.

        Returns:
            _Cast_MicrophonePowerFlow
        """
        return _Cast_MicrophonePowerFlow(self)
