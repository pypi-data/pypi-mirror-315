...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftCompoundPowerFlow(_4279.AbstractShaftCompoundPowerFlow):
    """ShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4244.ShaftPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4244.ShaftPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ShaftPowerFlow]
