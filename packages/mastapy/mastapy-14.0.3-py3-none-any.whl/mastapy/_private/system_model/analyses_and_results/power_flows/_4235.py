...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="PowerLoadPowerFlow._Cast_PowerLoadPowerFlow")
...
class _Cast_PowerLoadPowerFlow:
    ...
    @property
    def power_load_power_flow(self: "CastSelf") -> "PowerLoadPowerFlow":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadPowerFlow(_4271.VirtualComponentPowerFlow):
    """PowerLoadPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POWER_LOAD_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerLoadPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadPowerFlow
        """
        return _Cast_PowerLoadPowerFlow(self)
