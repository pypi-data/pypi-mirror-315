...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetCompoundPowerFlow(_4338.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4172.ConceptGearSetPowerFlow]":
    ...
    def concept_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4307.ConceptGearCompoundPowerFlow]":
    ...
    def concept_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4308.ConceptGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4172.ConceptGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearSetPowerFlow]
