...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetPowerFlow(_4204.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4196.FaceGearPowerFlow]":
    ...
    @property
    def face_gears_power_flow(self: "Self") -> "List[_4196.FaceGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4195.FaceGearMeshPowerFlow]":
    ...
    @property
    def face_meshes_power_flow(self: "Self") -> "List[_4195.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]
