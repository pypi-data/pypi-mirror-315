...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserCompoundPowerFlow._Cast_SynchroniserCompoundPowerFlow",
    )
...
class _Cast_SynchroniserCompoundPowerFlow:
    ...
    __parent__: "SynchroniserCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SynchroniserCompoundPowerFlow(_4378.SpecialisedAssemblyCompoundPowerFlow):
    """SynchroniserCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SYNCHRONISER_COMPOUND_POWER_FLOW
    ...
    @property
    def component_design(self: "Self") -> "_2669.Synchroniser":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4263.SynchroniserPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4263.SynchroniserPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPowerFlow]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserCompoundPowerFlow
        """
        return _Cast_SynchroniserCompoundPowerFlow(self)
