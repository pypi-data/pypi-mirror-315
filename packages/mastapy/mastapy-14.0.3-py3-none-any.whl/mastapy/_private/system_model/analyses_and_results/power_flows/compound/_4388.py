...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearCompoundPowerFlow._Cast_StraightBevelGearCompoundPowerFlow",
    )
...
class _Cast_StraightBevelGearCompoundPowerFlow:
    ...
    __parent__: "StraightBevelGearCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearCompoundPowerFlow(_4294.BevelGearCompoundPowerFlow):
    """StraightBevelGearCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_COMPOUND_POWER_FLOW
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelGearCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearCompoundPowerFlow
        """
        return _Cast_StraightBevelGearCompoundPowerFlow(self)
