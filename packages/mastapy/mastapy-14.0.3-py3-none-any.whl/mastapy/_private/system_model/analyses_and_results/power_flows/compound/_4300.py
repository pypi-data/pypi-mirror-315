...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchConnectionCompoundPowerFlow._Cast_ClutchConnectionCompoundPowerFlow",
    )
...
class _Cast_ClutchConnectionCompoundPowerFlow:
    ...
    __parent__: "ClutchConnectionCompoundPowerFlow"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchConnectionCompoundPowerFlow(_4316.CouplingConnectionCompoundPowerFlow):
    """ClutchConnectionCompoundPowerFlow

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_CONNECTION_COMPOUND_POWER_FLOW
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4162.ClutchConnectionPowerFlow]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchConnectionCompoundPowerFlow":
        """Cast to another type.

        Returns:
            _Cast_ClutchConnectionCompoundPowerFlow
        """
        return _Cast_ClutchConnectionCompoundPowerFlow(self)
