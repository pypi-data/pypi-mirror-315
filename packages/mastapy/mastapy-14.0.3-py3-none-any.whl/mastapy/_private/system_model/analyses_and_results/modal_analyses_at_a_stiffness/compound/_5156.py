...
_CYCLOIDAL_DISC_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="CycloidalDiscCompoundModalAnalysisAtAStiffness")
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalDiscCompoundModalAnalysisAtAStiffness._Cast_CycloidalDiscCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_CycloidalDiscCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "CycloidalDiscCompoundModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CycloidalDiscCompoundModalAnalysisAtAStiffness(
    _5112.AbstractShaftCompoundModalAnalysisAtAStiffness
):
    """CycloidalDiscCompoundModalAnalysisAtAStiffness
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_DISC_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalDiscCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_CycloidalDiscCompoundModalAnalysisAtAStiffness
        """
        return _Cast_CycloidalDiscCompoundModalAnalysisAtAStiffness(self)
