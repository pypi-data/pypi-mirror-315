...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadCompoundModalAnalysisAtAStiffness._Cast_PowerLoadCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_PowerLoadCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "PowerLoadCompoundModalAnalysisAtAStiffness"
...
class PowerLoadCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _POWER_LOAD_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5069.PowerLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerLoadCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadCompoundModalAnalysisAtAStiffness
        """
        return _Cast_PowerLoadCompoundModalAnalysisAtAStiffness(self)
