...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="OilSealModalAnalysisAtAStiffness._Cast_OilSealModalAnalysisAtAStiffness",
    )
...
class _Cast_OilSealModalAnalysisAtAStiffness:
    ...
    __parent__: "OilSealModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class OilSealModalAnalysisAtAStiffness(_5014.ConnectorModalAnalysisAtAStiffness):
    """OilSealModalAnalysisAtAStiffness

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _OIL_SEAL_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_OilSealModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_OilSealModalAnalysisAtAStiffness
        """
        return _Cast_OilSealModalAnalysisAtAStiffness(self)
