...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltModalAnalysisAtAStiffness._Cast_BoltModalAnalysisAtAStiffness",
    )
...
class _Cast_BoltModalAnalysisAtAStiffness:
    ...
    __parent__: "BoltModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltModalAnalysisAtAStiffness(_5003.ComponentModalAnalysisAtAStiffness):
    """BoltModalAnalysisAtAStiffness

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLT_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_BoltModalAnalysisAtAStiffness
        """
        return _Cast_BoltModalAnalysisAtAStiffness(self)
