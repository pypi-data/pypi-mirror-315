...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassModalAnalysisAtAStiffness._Cast_UnbalancedMassModalAnalysisAtAStiffness",
    )
...
class _Cast_UnbalancedMassModalAnalysisAtAStiffness:
    ...
    __parent__: "UnbalancedMassModalAnalysisAtAStiffness"
...
class UnbalancedMassModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_UnbalancedMassModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassModalAnalysisAtAStiffness
        """
        return _Cast_UnbalancedMassModalAnalysisAtAStiffness(self)
