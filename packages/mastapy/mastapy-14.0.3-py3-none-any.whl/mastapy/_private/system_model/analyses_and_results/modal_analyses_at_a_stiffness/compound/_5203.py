...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness._Cast_RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness"
...
class RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _RING_PINS_TO_DISC_CONNECTION_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5072.RingPinsToDiscConnectionModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness
        """
        return _Cast_RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness(self)
