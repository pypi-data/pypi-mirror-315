...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfModalAnalysisAtAStiffness._Cast_SpringDamperHalfModalAnalysisAtAStiffness",
    )
...
class _Cast_SpringDamperHalfModalAnalysisAtAStiffness:
    ...
    __parent__: "SpringDamperHalfModalAnalysisAtAStiffness"
...
class SpringDamperHalfModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHalfModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfModalAnalysisAtAStiffness
        """
        return _Cast_SpringDamperHalfModalAnalysisAtAStiffness(self)
