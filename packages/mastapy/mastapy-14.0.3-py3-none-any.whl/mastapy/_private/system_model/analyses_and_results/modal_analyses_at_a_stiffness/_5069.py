...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadModalAnalysisAtAStiffness._Cast_PowerLoadModalAnalysisAtAStiffness",
    )
...
class _Cast_PowerLoadModalAnalysisAtAStiffness:
    ...
    __parent__: "PowerLoadModalAnalysisAtAStiffness"
...
class PowerLoadModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _POWER_LOAD_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerLoadModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadModalAnalysisAtAStiffness
        """
        return _Cast_PowerLoadModalAnalysisAtAStiffness(self)
