...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="MeasurementComponentCompoundModalAnalysisAtAStiffness"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentCompoundModalAnalysisAtAStiffness._Cast_MeasurementComponentCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_MeasurementComponentCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "MeasurementComponentCompoundModalAnalysisAtAStiffness"
...
class MeasurementComponentCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _MEASUREMENT_COMPONENT_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_MeasurementComponentCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentCompoundModalAnalysisAtAStiffness
        """
        return _Cast_MeasurementComponentCompoundModalAnalysisAtAStiffness(self)
