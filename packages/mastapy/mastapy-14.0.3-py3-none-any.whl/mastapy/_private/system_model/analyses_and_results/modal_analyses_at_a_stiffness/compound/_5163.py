...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelCompoundModalAnalysisAtAStiffness._Cast_ExternalCADModelCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_ExternalCADModelCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "ExternalCADModelCompoundModalAnalysisAtAStiffness"
...
class ExternalCADModelCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _EXTERNAL_CAD_MODEL_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5031.ExternalCADModelModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ExternalCADModelCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelCompoundModalAnalysisAtAStiffness
        """
        return _Cast_ExternalCADModelCompoundModalAnalysisAtAStiffness(self)
