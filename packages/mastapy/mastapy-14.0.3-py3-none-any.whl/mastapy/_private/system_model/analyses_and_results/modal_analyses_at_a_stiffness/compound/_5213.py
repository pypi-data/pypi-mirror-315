...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness._Cast_SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness"
...
class SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _SPIRAL_BEVEL_GEAR_MESH_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5081.SpiralBevelGearMeshModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness
        """
        return _Cast_SpiralBevelGearMeshCompoundModalAnalysisAtAStiffness(self)
