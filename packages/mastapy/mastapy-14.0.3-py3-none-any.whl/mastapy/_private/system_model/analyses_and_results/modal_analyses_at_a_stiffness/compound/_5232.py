...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpCompoundModalAnalysisAtAStiffness._Cast_TorqueConverterPumpCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_TorqueConverterPumpCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "TorqueConverterPumpCompoundModalAnalysisAtAStiffness"
...
class TorqueConverterPumpCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_PUMP_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5101.TorqueConverterPumpModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterPumpCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpCompoundModalAnalysisAtAStiffness
        """
        return _Cast_TorqueConverterPumpCompoundModalAnalysisAtAStiffness(self)
