...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingAssemblyModalAnalysisAtAStiffness._Cast_RollingRingAssemblyModalAnalysisAtAStiffness",
    )
...
class _Cast_RollingRingAssemblyModalAnalysisAtAStiffness:
    ...
    __parent__: "RollingRingAssemblyModalAnalysisAtAStiffness"
...
class RollingRingAssemblyModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_ASSEMBLY_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingAssemblyModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_RollingRingAssemblyModalAnalysisAtAStiffness
        """
        return _Cast_RollingRingAssemblyModalAnalysisAtAStiffness(self)
