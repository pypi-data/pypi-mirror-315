...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchConnectionCompoundModalAnalysisAtAStiffness._Cast_ClutchConnectionCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_ClutchConnectionCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "ClutchConnectionCompoundModalAnalysisAtAStiffness"
...
class ClutchConnectionCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_CONNECTION_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4999.ClutchConnectionModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchConnectionCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_ClutchConnectionCompoundModalAnalysisAtAStiffness
        """
        return _Cast_ClutchConnectionCompoundModalAnalysisAtAStiffness(self)
