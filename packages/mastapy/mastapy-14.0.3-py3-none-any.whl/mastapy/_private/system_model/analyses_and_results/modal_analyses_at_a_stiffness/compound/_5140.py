...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearCompoundModalAnalysisAtAStiffness._Cast_ConceptGearCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_ConceptGearCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "ConceptGearCompoundModalAnalysisAtAStiffness"
...
class ConceptGearCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5008.ConceptGearModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearCompoundModalAnalysisAtAStiffness
        """
        return _Cast_ConceptGearCompoundModalAnalysisAtAStiffness(self)
