...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearModalAnalysisAtAStiffness._Cast_SpiralBevelGearModalAnalysisAtAStiffness",
    )
...
class _Cast_SpiralBevelGearModalAnalysisAtAStiffness:
    ...
    __parent__: "SpiralBevelGearModalAnalysisAtAStiffness"
...
class SpiralBevelGearModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpiralBevelGearModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearModalAnalysisAtAStiffness
        """
        return _Cast_SpiralBevelGearModalAnalysisAtAStiffness(self)
