...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearModalAnalysisAtAStiffness._Cast_WormGearModalAnalysisAtAStiffness",
    )
...
class _Cast_WormGearModalAnalysisAtAStiffness:
    ...
    __parent__: "WormGearModalAnalysisAtAStiffness"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearModalAnalysisAtAStiffness(_5038.GearModalAnalysisAtAStiffness):
    """WormGearModalAnalysisAtAStiffness

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _WORM_GEAR_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_WormGearModalAnalysisAtAStiffness
        """
        return _Cast_WormGearModalAnalysisAtAStiffness(self)
