...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperConnectionModalAnalysisAtAStiffness._Cast_SpringDamperConnectionModalAnalysisAtAStiffness",
    )
...
class _Cast_SpringDamperConnectionModalAnalysisAtAStiffness:
    ...
    __parent__: "SpringDamperConnectionModalAnalysisAtAStiffness"
...
class SpringDamperConnectionModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_CONNECTION_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpringDamperConnectionModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperConnectionModalAnalysisAtAStiffness
        """
        return _Cast_SpringDamperConnectionModalAnalysisAtAStiffness(self)
