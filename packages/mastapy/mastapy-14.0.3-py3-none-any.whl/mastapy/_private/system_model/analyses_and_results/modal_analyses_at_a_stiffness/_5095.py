...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserHalfModalAnalysisAtAStiffness._Cast_SynchroniserHalfModalAnalysisAtAStiffness",
    )
...
class _Cast_SynchroniserHalfModalAnalysisAtAStiffness:
    ...
    __parent__: "SynchroniserHalfModalAnalysisAtAStiffness"
...
class SynchroniserHalfModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_HALF_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserHalfModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserHalfModalAnalysisAtAStiffness
        """
        return _Cast_SynchroniserHalfModalAnalysisAtAStiffness(self)
