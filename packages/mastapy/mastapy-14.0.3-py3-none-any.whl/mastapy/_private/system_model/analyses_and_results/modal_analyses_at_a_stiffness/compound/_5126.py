...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness._Cast_BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness"
...
class BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_SUN_GEAR_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4993.BevelDifferentialSunGearModalAnalysisAtAStiffness]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness
        """
        return _Cast_BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(self)
