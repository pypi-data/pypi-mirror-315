...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CVTPulleyCompoundModalAnalysisAtAStiffness._Cast_CVTPulleyCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_CVTPulleyCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "CVTPulleyCompoundModalAnalysisAtAStiffness"
...
class CVTPulleyCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = _CVT_PULLEY_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5020.CVTPulleyModalAnalysisAtAStiffness]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CVTPulleyCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_CVTPulleyCompoundModalAnalysisAtAStiffness
        """
        return _Cast_CVTPulleyCompoundModalAnalysisAtAStiffness(self)
