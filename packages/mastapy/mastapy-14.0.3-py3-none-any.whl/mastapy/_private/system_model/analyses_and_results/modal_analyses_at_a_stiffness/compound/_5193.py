...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="PartToPartShearCouplingCompoundModalAnalysisAtAStiffness"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingCompoundModalAnalysisAtAStiffness._Cast_PartToPartShearCouplingCompoundModalAnalysisAtAStiffness",
    )
...
class _Cast_PartToPartShearCouplingCompoundModalAnalysisAtAStiffness:
    ...
    __parent__: "PartToPartShearCouplingCompoundModalAnalysisAtAStiffness"
...
class PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(
    ...
    TYPE: ClassVar["Type"] = (
        _PART_TO_PART_SHEAR_COUPLING_COMPOUND_MODAL_ANALYSIS_AT_A_STIFFNESS
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingCompoundModalAnalysisAtAStiffness":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingCompoundModalAnalysisAtAStiffness
        """
        return _Cast_PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(self)
