...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed._Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_GEAR_MESH_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        ...
        "_Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed"
    ):
        ...
        Returns:
            _Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponseAtASpeed(
            self
        )
