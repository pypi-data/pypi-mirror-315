...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed._Cast_SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed"
...
class SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _SPIRAL_BEVEL_GEAR_SET_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3707.SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spiral_bevel_gears_compound_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3838.SpiralBevelGearCompoundSteadyStateSynchronousResponseAtASpeed]":
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "SpiralBevelGearsCompoundSteadyStateSynchronousResponseAtASpeed",
        )
    ...
    def spiral_bevel_meshes_compound_steady_state_synchronous_response_at_a_speed(
        ...
        "List[_3839.SpiralBevelGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
        ...
        temp = pythonnet_property_get(
            self.wrapped,
            "SpiralBevelMeshesCompoundSteadyStateSynchronousResponseAtASpeed",
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
            self
        )
