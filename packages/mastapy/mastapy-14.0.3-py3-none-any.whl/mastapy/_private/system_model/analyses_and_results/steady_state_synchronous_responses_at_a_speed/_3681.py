...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentSteadyStateSynchronousResponseAtASpeed._Cast_MeasurementComponentSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_MeasurementComponentSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "MeasurementComponentSteadyStateSynchronousResponseAtASpeed"
...
class MeasurementComponentSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _MEASUREMENT_COMPONENT_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_MeasurementComponentSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_MeasurementComponentSteadyStateSynchronousResponseAtASpeed(self)
