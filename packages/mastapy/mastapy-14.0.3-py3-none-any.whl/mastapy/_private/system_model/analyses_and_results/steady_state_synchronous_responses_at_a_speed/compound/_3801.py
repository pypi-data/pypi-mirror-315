...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed._Cast_HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed"
...
class HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _HYPOID_GEAR_SET_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3668.HypoidGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def hypoid_gears_compound_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3799.HypoidGearCompoundSteadyStateSynchronousResponseAtASpeed]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "HypoidGearsCompoundSteadyStateSynchronousResponseAtASpeed"
        )
    ...
    def hypoid_meshes_compound_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3800.HypoidGearMeshCompoundSteadyStateSynchronousResponseAtASpeed]":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "HypoidMeshesCompoundSteadyStateSynchronousResponseAtASpeed"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed(self)
