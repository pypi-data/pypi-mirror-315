...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="TorqueConverterSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterSteadyStateSynchronousResponseAtASpeed._Cast_TorqueConverterSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_TorqueConverterSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "TorqueConverterSteadyStateSynchronousResponseAtASpeed"
...
class TorqueConverterSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_TorqueConverterSteadyStateSynchronousResponseAtASpeed(self)
