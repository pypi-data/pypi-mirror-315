...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="BearingCompoundSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="BearingCompoundSteadyStateSynchronousResponseAtASpeed._Cast_BearingCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_BearingCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "BearingCompoundSteadyStateSynchronousResponseAtASpeed"
...
class BearingCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _BEARING_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3613.BearingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BearingCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_BearingCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_BearingCompoundSteadyStateSynchronousResponseAtASpeed(self)
