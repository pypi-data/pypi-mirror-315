...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearSetSteadyStateSynchronousResponseAtASpeed._Cast_FaceGearSetSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_FaceGearSetSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "FaceGearSetSteadyStateSynchronousResponseAtASpeed"
...
class FaceGearSetSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_SET_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def gears_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3660.FaceGearSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_gears_steady_state_synchronous_response_at_a_speed(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "FaceGearsSteadyStateSynchronousResponseAtASpeed"
        )
    ...
    def meshes_steady_state_synchronous_response_at_a_speed(
        self: "Self",
    ) -> "List[_3658.FaceGearMeshSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_meshes_steady_state_synchronous_response_at_a_speed(
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "FaceMeshesSteadyStateSynchronousResponseAtASpeed"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FaceGearSetSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_FaceGearSetSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_FaceGearSetSteadyStateSynchronousResponseAtASpeed(self)
