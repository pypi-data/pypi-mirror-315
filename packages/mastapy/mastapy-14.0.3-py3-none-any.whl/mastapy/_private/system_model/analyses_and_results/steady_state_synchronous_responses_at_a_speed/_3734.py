...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.static_loads import _7141
    from mastapy._private.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import (
        _3609,
        _3637,
        _3640,
    ...
    Self = TypeVar(
        "Self", bound="ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed"
...
class ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _ZEROL_BEVEL_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    @property
    def connection_load_case(self: "Self") -> "_7141.ZerolBevelGearMeshLoadCase":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ZerolBevelGearMeshSteadyStateSynchronousResponseAtASpeed(self)
