...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshSteadyStateSynchronousResponseAtASpeed._Cast_FaceGearMeshSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_FaceGearMeshSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "FaceGearMeshSteadyStateSynchronousResponseAtASpeed"
...
class FaceGearMeshSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _FACE_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FaceGearMeshSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_FaceGearMeshSteadyStateSynchronousResponseAtASpeed(self)
