...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed._Cast_CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed"
...
class CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CYLINDRICAL_PLANET_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed(self)
