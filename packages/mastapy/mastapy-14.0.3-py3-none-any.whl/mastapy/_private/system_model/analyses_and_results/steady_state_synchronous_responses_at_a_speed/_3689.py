...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed._Cast_PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed"
...
class PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _PART_TO_PART_SHEAR_COUPLING_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed(self)
