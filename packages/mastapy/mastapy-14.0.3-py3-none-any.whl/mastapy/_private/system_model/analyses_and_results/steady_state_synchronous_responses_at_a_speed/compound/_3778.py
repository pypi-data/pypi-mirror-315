...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CVTCompoundSteadyStateSynchronousResponseAtASpeed._Cast_CVTCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_CVTCompoundSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "CVTCompoundSteadyStateSynchronousResponseAtASpeed"
...
class CVTCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _CVT_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3647.CVTSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CVTCompoundSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_CVTCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_CVTCompoundSteadyStateSynchronousResponseAtASpeed(self)
