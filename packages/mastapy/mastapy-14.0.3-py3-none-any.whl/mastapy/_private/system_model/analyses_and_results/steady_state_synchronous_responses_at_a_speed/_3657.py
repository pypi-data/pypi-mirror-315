...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ExternalCADModelSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelSteadyStateSynchronousResponseAtASpeed._Cast_ExternalCADModelSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ExternalCADModelSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ExternalCADModelSteadyStateSynchronousResponseAtASpeed"
...
class ExternalCADModelSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _EXTERNAL_CAD_MODEL_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ExternalCADModelSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ExternalCADModelSteadyStateSynchronousResponseAtASpeed(self)
