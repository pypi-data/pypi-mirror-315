...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RootAssemblySteadyStateSynchronousResponseAtASpeed._Cast_RootAssemblySteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_RootAssemblySteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "RootAssemblySteadyStateSynchronousResponseAtASpeed"
...
class RootAssemblySteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _ROOT_ASSEMBLY_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def steady_state_synchronous_response_at_a_speed_inputs(
        ...
        temp = pythonnet_property_get(
            self.wrapped, "SteadyStateSynchronousResponseAtASpeedInputs"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RootAssemblySteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_RootAssemblySteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_RootAssemblySteadyStateSynchronousResponseAtASpeed(self)
