...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearSteadyStateSynchronousResponseAtASpeed._Cast_HypoidGearSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_HypoidGearSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "HypoidGearSteadyStateSynchronousResponseAtASpeed"
...
class HypoidGearSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = _HYPOID_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_HypoidGearSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_HypoidGearSteadyStateSynchronousResponseAtASpeed(self)
