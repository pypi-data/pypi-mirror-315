...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ClutchConnectionSteadyStateSynchronousResponseAtASpeed"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchConnectionSteadyStateSynchronousResponseAtASpeed._Cast_ClutchConnectionSteadyStateSynchronousResponseAtASpeed",
    )
...
class _Cast_ClutchConnectionSteadyStateSynchronousResponseAtASpeed:
    ...
    __parent__: "ClutchConnectionSteadyStateSynchronousResponseAtASpeed"
...
class ClutchConnectionSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CLUTCH_CONNECTION_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchConnectionSteadyStateSynchronousResponseAtASpeed":
        """Cast to another type.

        Returns:
            _Cast_ClutchConnectionSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ClutchConnectionSteadyStateSynchronousResponseAtASpeed(self)
