...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed._Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed",
    )
...
class ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_CONNECTION_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_AT_A_SPEED
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3631.ConceptCouplingConnectionSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cast_to(
        ...
        "_Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed"
    ):
        ...
        Returns:
            _Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed
        """
        return _Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseAtASpeed(
            self
        )
