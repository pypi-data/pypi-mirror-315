...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MassDiscCriticalSpeedAnalysis._Cast_MassDiscCriticalSpeedAnalysis",
    )
...
class _Cast_MassDiscCriticalSpeedAnalysis:
    ...
    __parent__: "MassDiscCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscCriticalSpeedAnalysis(_6818.VirtualComponentCriticalSpeedAnalysis):
    """MassDiscCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MASS_DISC_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MassDiscCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MassDiscCriticalSpeedAnalysis
        """
        return _Cast_MassDiscCriticalSpeedAnalysis(self)
