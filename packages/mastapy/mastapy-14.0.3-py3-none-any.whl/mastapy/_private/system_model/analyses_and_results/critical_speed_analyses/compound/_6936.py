...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearMeshCompoundCriticalSpeedAnalysis._Cast_StraightBevelGearMeshCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_StraightBevelGearMeshCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "StraightBevelGearMeshCompoundCriticalSpeedAnalysis"
...
class StraightBevelGearMeshCompoundCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_MESH_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6805.StraightBevelGearMeshCriticalSpeedAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearMeshCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearMeshCompoundCriticalSpeedAnalysis
        """
        return _Cast_StraightBevelGearMeshCompoundCriticalSpeedAnalysis(self)
