...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearMeshCriticalSpeedAnalysis._Cast_ConceptGearMeshCriticalSpeedAnalysis",
    )
...
class _Cast_ConceptGearMeshCriticalSpeedAnalysis:
    ...
    __parent__: "ConceptGearMeshCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearMeshCriticalSpeedAnalysis(_6753.GearMeshCriticalSpeedAnalysis):
    """ConceptGearMeshCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_MESH_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearMeshCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearMeshCriticalSpeedAnalysis
        """
        return _Cast_ConceptGearMeshCriticalSpeedAnalysis(self)
