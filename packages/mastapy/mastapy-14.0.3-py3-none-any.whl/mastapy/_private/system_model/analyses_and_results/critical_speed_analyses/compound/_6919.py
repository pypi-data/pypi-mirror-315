...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingCompoundCriticalSpeedAnalysis._Cast_RollingRingCompoundCriticalSpeedAnalysis",
    )
...
class _Cast_RollingRingCompoundCriticalSpeedAnalysis:
    ...
    __parent__: "RollingRingCompoundCriticalSpeedAnalysis"
...
class RollingRingCompoundCriticalSpeedAnalysis(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_COMPOUND_CRITICAL_SPEED_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6789.RollingRingCriticalSpeedAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingCompoundCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_RollingRingCompoundCriticalSpeedAnalysis
        """
        return _Cast_RollingRingCompoundCriticalSpeedAnalysis(self)
