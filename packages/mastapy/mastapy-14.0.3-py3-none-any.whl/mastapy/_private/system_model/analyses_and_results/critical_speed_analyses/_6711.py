...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCriticalSpeedAnalysis._Cast_BoltedJointCriticalSpeedAnalysis",
    )
...
class _Cast_BoltedJointCriticalSpeedAnalysis:
    ...
    __parent__: "BoltedJointCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointCriticalSpeedAnalysis(_6794.SpecialisedAssemblyCriticalSpeedAnalysis):
    """BoltedJointCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLTED_JOINT_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCriticalSpeedAnalysis
        """
        return _Cast_BoltedJointCriticalSpeedAnalysis(self)
