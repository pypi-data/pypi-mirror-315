...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCriticalSpeedAnalysis._Cast_ClutchHalfCriticalSpeedAnalysis",
    )
...
class _Cast_ClutchHalfCriticalSpeedAnalysis:
    ...
    __parent__: "ClutchHalfCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfCriticalSpeedAnalysis(_6730.CouplingHalfCriticalSpeedAnalysis):
    """ClutchHalfCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_HALF_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCriticalSpeedAnalysis
        """
        return _Cast_ClutchHalfCriticalSpeedAnalysis(self)
