...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearCriticalSpeedAnalysis._Cast_FaceGearCriticalSpeedAnalysis",
    )
...
class _Cast_FaceGearCriticalSpeedAnalysis:
    ...
    __parent__: "FaceGearCriticalSpeedAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearCriticalSpeedAnalysis(_6752.GearCriticalSpeedAnalysis):
    """FaceGearCriticalSpeedAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FACE_GEAR_CRITICAL_SPEED_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearCriticalSpeedAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FaceGearCriticalSpeedAnalysis
        """
        return _Cast_FaceGearCriticalSpeedAnalysis(self)
