...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1657.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1657.MeasurementBase")
...
class _Cast_ShaftComplexShape:
    ...
    @property
    def shaft_forced_complex_shape(self: "CastSelf") -> "_4137.ShaftForcedComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4137,
        )

        return self.__parent__._cast(_4137.ShaftForcedComplexShape)

    @property
    def shaft_modal_complex_shape(self: "CastSelf") -> "_4138.ShaftModalComplexShape":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4138,
        )

        return self.__parent__._cast(_4138.ShaftModalComplexShape)

    @property
    def shaft_modal_complex_shape_at_speeds(
        self: "CastSelf",
    ) -> "_4139.ShaftModalComplexShapeAtSpeeds":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4139,
        )

        return self.__parent__._cast(_4139.ShaftModalComplexShapeAtSpeeds)

    @property
    def shaft_modal_complex_shape_at_stiffness(
        self: "CastSelf",
    ) -> "_4140.ShaftModalComplexShapeAtStiffness":
        from mastapy._private.system_model.analyses_and_results.rotor_dynamics import (
            _4140,
        )

        return self.__parent__._cast(_4140.ShaftModalComplexShapeAtStiffness)
