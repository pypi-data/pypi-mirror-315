...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearCompoundMultibodyDynamicsAnalysis._Cast_StraightBevelGearCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_StraightBevelGearCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "StraightBevelGearCompoundMultibodyDynamicsAnalysis"
...
class StraightBevelGearCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5633.StraightBevelGearMultibodyDynamicsAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_StraightBevelGearCompoundMultibodyDynamicsAnalysis(self)
