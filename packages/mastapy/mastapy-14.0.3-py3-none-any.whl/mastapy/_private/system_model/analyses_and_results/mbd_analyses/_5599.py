...
from mastapy._private.system_model.analyses_and_results.analysis_cases import _7723
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PartMultibodyDynamicsAnalysis(_7723.PartTimeSeriesLoadAnalysisCase):
    """PartMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis(self: "Self") -> "_5597.MultibodyDynamicsAnalysis":
    ...
    @property
    def data_logger(self: "Self") -> "_1626.DataLogger":
    ...
    def create_viewable(self: "Self") -> "_2307.MBDAnalysisViewable":
