...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.mbd_analyses import _5609
    from mastapy._private.system_model.analyses_and_results.mbd_analyses.compound import (
        _5688,
        _5744,
    )
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsCompoundMultibodyDynamicsAnalysis._Cast_RingPinsCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_RingPinsCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "RingPinsCompoundMultibodyDynamicsAnalysis"
...
class RingPinsCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5609.RingPinsMultibodyDynamicsAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_RingPinsCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_RingPinsCompoundMultibodyDynamicsAnalysis(self)
