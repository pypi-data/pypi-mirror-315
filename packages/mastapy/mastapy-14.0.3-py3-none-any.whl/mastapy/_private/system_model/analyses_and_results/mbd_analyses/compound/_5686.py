...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchHalfCompoundMultibodyDynamicsAnalysis._Cast_ClutchHalfCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_ClutchHalfCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "ClutchHalfCompoundMultibodyDynamicsAnalysis"
...
class ClutchHalfCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_HALF_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5530.ClutchHalfMultibodyDynamicsAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_ClutchHalfCompoundMultibodyDynamicsAnalysis(self)
