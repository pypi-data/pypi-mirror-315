...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperCompoundMultibodyDynamicsAnalysis._Cast_SpringDamperCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_SpringDamperCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "SpringDamperCompoundMultibodyDynamicsAnalysis"
...
class SpringDamperCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_SpringDamperCompoundMultibodyDynamicsAnalysis(self)
