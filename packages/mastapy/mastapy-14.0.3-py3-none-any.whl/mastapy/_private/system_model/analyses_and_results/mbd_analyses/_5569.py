...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMultibodyDynamicsAnalysis(_5596.MountableComponentMultibodyDynamicsAnalysis):
    """GearMultibodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self: "Self") -> "List[_5659.DynamicTorqueResultAtTime]":
