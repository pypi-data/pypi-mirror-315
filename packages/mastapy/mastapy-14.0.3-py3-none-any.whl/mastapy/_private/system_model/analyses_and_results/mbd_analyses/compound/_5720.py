...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis._Cast_FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis"
...
class FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _FLEXIBLE_PIN_ASSEMBLY_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis(self)
