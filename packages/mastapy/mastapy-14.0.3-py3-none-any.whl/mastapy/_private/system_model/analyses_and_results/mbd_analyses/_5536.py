...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfMultibodyDynamicsAnalysis._Cast_ConceptCouplingHalfMultibodyDynamicsAnalysis",
    )
...
class _Cast_ConceptCouplingHalfMultibodyDynamicsAnalysis:
    ...
    __parent__: "ConceptCouplingHalfMultibodyDynamicsAnalysis"
...
class ConceptCouplingHalfMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_HALF_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptCouplingHalfMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfMultibodyDynamicsAnalysis
        """
        return _Cast_ConceptCouplingHalfMultibodyDynamicsAnalysis(self)
