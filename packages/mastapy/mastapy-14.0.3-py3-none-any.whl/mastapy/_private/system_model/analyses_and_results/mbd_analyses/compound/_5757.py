...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingCompoundMultibodyDynamicsAnalysis._Cast_RollingRingCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_RollingRingCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "RollingRingCompoundMultibodyDynamicsAnalysis"
...
class RollingRingCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _ROLLING_RING_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5613.RollingRingMultibodyDynamicsAnalysis]":
    ...
    def planetaries(
        self: "Self",
    ) -> "List[RollingRingCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RollingRingCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_RollingRingCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_RollingRingCompoundMultibodyDynamicsAnalysis(self)
