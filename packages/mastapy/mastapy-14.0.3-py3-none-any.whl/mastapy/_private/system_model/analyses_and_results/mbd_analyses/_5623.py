...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearMultibodyDynamicsAnalysis._Cast_SpiralBevelGearMultibodyDynamicsAnalysis",
    )
...
class _Cast_SpiralBevelGearMultibodyDynamicsAnalysis:
    ...
    __parent__: "SpiralBevelGearMultibodyDynamicsAnalysis"
...
class SpiralBevelGearMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SPIRAL_BEVEL_GEAR_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpiralBevelGearMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearMultibodyDynamicsAnalysis
        """
        return _Cast_SpiralBevelGearMultibodyDynamicsAnalysis(self)
