...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltConnectionCompoundMultibodyDynamicsAnalysis._Cast_BeltConnectionCompoundMultibodyDynamicsAnalysis",
    )
...
class _Cast_BeltConnectionCompoundMultibodyDynamicsAnalysis:
    ...
    __parent__: "BeltConnectionCompoundMultibodyDynamicsAnalysis"
...
class BeltConnectionCompoundMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _BELT_CONNECTION_COMPOUND_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5517.BeltConnectionMultibodyDynamicsAnalysis]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BeltConnectionCompoundMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_BeltConnectionCompoundMultibodyDynamicsAnalysis
        """
        return _Cast_BeltConnectionCompoundMultibodyDynamicsAnalysis(self)
