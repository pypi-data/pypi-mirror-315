...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyMultibodyDynamicsAnalysis._Cast_CycloidalAssemblyMultibodyDynamicsAnalysis",
    )
...
class _Cast_CycloidalAssemblyMultibodyDynamicsAnalysis:
    ...
    __parent__: "CycloidalAssemblyMultibodyDynamicsAnalysis"
...
class CycloidalAssemblyMultibodyDynamicsAnalysis(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_MULTIBODY_DYNAMICS_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyMultibodyDynamicsAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyMultibodyDynamicsAnalysis
        """
        return _Cast_CycloidalAssemblyMultibodyDynamicsAnalysis(self)
