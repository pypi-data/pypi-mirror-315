...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsSteadyStateSynchronousResponseOnAShaft._Cast_RingPinsSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_RingPinsSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "RingPinsSteadyStateSynchronousResponseOnAShaft"
...
class RingPinsSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _RING_PINS_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_RingPinsSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_RingPinsSteadyStateSynchronousResponseOnAShaft(self)
