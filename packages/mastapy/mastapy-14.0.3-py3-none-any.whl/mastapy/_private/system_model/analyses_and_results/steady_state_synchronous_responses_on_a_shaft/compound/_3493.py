...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltCompoundSteadyStateSynchronousResponseOnAShaft._Cast_BoltCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_BoltCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "BoltCompoundSteadyStateSynchronousResponseOnAShaft"
...
class BoltCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _BOLT_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3362.BoltSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BoltCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_BoltCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_BoltCompoundSteadyStateSynchronousResponseOnAShaft(self)
