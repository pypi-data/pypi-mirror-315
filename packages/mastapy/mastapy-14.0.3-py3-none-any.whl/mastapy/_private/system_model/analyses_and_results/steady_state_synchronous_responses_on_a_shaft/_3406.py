...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearSteadyStateSynchronousResponseOnAShaft._Cast_HypoidGearSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_HypoidGearSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "HypoidGearSteadyStateSynchronousResponseOnAShaft"
...
class HypoidGearSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _HYPOID_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_HypoidGearSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_HypoidGearSteadyStateSynchronousResponseOnAShaft(self)
