...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft"
...
class ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _CLUTCH_CONNECTION_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    @property
    def component_design(self: "Self") -> "_2399.ClutchConnection":
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3363.ClutchConnectionSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft(
            self
        )
