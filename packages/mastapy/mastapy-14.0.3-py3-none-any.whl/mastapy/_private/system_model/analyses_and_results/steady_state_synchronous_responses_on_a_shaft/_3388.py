...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalDiscSteadyStateSynchronousResponseOnAShaft._Cast_CycloidalDiscSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_CycloidalDiscSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "CycloidalDiscSteadyStateSynchronousResponseOnAShaft"
...
class CycloidalDiscSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _CYCLOIDAL_DISC_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CycloidalDiscSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_CycloidalDiscSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_CycloidalDiscSteadyStateSynchronousResponseOnAShaft(self)
