...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="TorqueConverterSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterSteadyStateSynchronousResponseOnAShaft._Cast_TorqueConverterSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_TorqueConverterSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "TorqueConverterSteadyStateSynchronousResponseOnAShaft"
...
class TorqueConverterSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _TORQUE_CONVERTER_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_TorqueConverterSteadyStateSynchronousResponseOnAShaft(self)
