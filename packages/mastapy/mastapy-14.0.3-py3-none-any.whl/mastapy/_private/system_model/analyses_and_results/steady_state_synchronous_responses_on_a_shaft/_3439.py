...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft._Cast_ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft"
...
class ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _SHAFT_HUB_CONNECTION_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft(self)
