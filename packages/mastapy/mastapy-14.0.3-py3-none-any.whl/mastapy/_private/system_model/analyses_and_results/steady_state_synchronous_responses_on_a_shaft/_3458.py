...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="SynchroniserHalfSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserHalfSteadyStateSynchronousResponseOnAShaft._Cast_SynchroniserHalfSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_SynchroniserHalfSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "SynchroniserHalfSteadyStateSynchronousResponseOnAShaft"
...
class SynchroniserHalfSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _SYNCHRONISER_HALF_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SynchroniserHalfSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserHalfSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_SynchroniserHalfSteadyStateSynchronousResponseOnAShaft(self)
