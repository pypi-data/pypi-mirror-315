...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_HypoidGearMeshSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_HypoidGearMeshSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "HypoidGearMeshSteadyStateSynchronousResponseOnAShaft"
...
class HypoidGearMeshSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _HYPOID_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_HypoidGearMeshSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearMeshSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_HypoidGearMeshSteadyStateSynchronousResponseOnAShaft(self)
