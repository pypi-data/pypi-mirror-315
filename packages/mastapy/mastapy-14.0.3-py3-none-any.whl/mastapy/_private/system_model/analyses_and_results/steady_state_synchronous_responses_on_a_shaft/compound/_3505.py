...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft"
...
class ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_GEAR_SET_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3372.ConceptGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_gears_compound_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3503.ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "ConceptGearsCompoundSteadyStateSynchronousResponseOnAShaft"
        )
    ...
    def concept_meshes_compound_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3504.ConceptGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "ConceptMeshesCompoundSteadyStateSynchronousResponseOnAShaft"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft(self)
