...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="DatumSteadyStateSynchronousResponseOnAShaft._Cast_DatumSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_DatumSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "DatumSteadyStateSynchronousResponseOnAShaft"
...
class DatumSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _DATUM_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_DatumSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_DatumSteadyStateSynchronousResponseOnAShaft(self)
