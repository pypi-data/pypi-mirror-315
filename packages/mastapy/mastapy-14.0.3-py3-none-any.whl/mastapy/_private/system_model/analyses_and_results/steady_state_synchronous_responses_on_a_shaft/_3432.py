...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PulleySteadyStateSynchronousResponseOnAShaft._Cast_PulleySteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_PulleySteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "PulleySteadyStateSynchronousResponseOnAShaft"
...
class PulleySteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _PULLEY_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PulleySteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_PulleySteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_PulleySteadyStateSynchronousResponseOnAShaft(self)
