...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltSteadyStateSynchronousResponseOnAShaft._Cast_BoltSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_BoltSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "BoltSteadyStateSynchronousResponseOnAShaft"
...
class BoltSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _BOLT_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_BoltSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_BoltSteadyStateSynchronousResponseOnAShaft(self)
