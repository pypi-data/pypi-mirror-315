...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft._Cast_BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft"
...
class BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _BEVEL_DIFFERENTIAL_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft(self)
