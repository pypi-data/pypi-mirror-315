...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BearingSteadyStateSynchronousResponseOnAShaft._Cast_BearingSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_BearingSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "BearingSteadyStateSynchronousResponseOnAShaft"
...
class BearingSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _BEARING_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BearingSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_BearingSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_BearingSteadyStateSynchronousResponseOnAShaft(self)
