...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft"
...
class StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_DIFF_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_StraightBevelDiffGearMeshSteadyStateSynchronousResponseOnAShaft(
            self
        )
