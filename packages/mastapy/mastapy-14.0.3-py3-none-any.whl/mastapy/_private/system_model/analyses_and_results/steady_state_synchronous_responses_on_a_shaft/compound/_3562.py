...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="PointLoadCompoundSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PointLoadCompoundSteadyStateSynchronousResponseOnAShaft._Cast_PointLoadCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_PointLoadCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "PointLoadCompoundSteadyStateSynchronousResponseOnAShaft"
...
class PointLoadCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _POINT_LOAD_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3430.PointLoadSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PointLoadCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_PointLoadCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_PointLoadCompoundSteadyStateSynchronousResponseOnAShaft(self)
