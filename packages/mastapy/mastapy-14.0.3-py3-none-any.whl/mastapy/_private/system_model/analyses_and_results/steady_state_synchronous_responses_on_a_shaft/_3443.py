...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft._Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft"
...
class SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _SPIRAL_BEVEL_GEAR_MESH_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_SpiralBevelGearMeshSteadyStateSynchronousResponseOnAShaft(self)
