...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="StraightBevelGearSteadyStateSynchronousResponseOnAShaft"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearSteadyStateSynchronousResponseOnAShaft._Cast_StraightBevelGearSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_StraightBevelGearSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "StraightBevelGearSteadyStateSynchronousResponseOnAShaft"
...
class StraightBevelGearSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_StraightBevelGearSteadyStateSynchronousResponseOnAShaft(self)
