...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearSteadyStateSynchronousResponseOnAShaft._Cast_WormGearSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_WormGearSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "WormGearSteadyStateSynchronousResponseOnAShaft"
...
class WormGearSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = _WORM_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_WormGearSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_WormGearSteadyStateSynchronousResponseOnAShaft(self)
