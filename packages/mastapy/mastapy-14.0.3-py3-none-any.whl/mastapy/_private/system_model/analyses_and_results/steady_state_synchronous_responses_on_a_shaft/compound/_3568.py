...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingCompoundSteadyStateSynchronousResponseOnAShaft._Cast_RollingRingCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_RollingRingCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "RollingRingCompoundSteadyStateSynchronousResponseOnAShaft"
...
class RollingRingCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _ROLLING_RING_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3437.RollingRingSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RollingRingCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_RollingRingCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_RollingRingCompoundSteadyStateSynchronousResponseOnAShaft(self)
