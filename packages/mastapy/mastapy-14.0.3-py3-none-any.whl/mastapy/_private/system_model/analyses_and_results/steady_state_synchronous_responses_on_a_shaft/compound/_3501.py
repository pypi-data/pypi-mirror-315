...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft._Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_CONNECTION_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3368.ConceptCouplingConnectionSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cast_to(
        ...
        "_Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft"
    ):
        ...
        Returns:
            _Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_ConceptCouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft(
            self
        )
