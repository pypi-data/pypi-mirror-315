...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft._Cast_WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft",
    )
...
class _Cast_WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft:
    ...
    __parent__: "WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft"
...
class WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    TYPE: ClassVar["Type"] = (
        _WORM_GEAR_SET_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3469.WormGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def worm_gears_compound_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3599.WormGearCompoundSteadyStateSynchronousResponseOnAShaft]":
        ...
        temp = pythonnet_property_get(
            self.wrapped, "WormGearsCompoundSteadyStateSynchronousResponseOnAShaft"
        )
    ...
    def worm_meshes_compound_steady_state_synchronous_response_on_a_shaft(
        self: "Self",
    ) -> "List[_3600.WormGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]":
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "WormMeshesCompoundSteadyStateSynchronousResponseOnAShaft"
        )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft":
        """Cast to another type.

        Returns:
            _Cast_WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft
        """
        return _Cast_WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft(self)
