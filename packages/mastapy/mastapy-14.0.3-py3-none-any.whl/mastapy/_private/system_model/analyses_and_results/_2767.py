...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CompoundSteadyStateSynchronousResponseAnalysis._Cast_CompoundSteadyStateSynchronousResponseAnalysis",
    )
...
class _Cast_CompoundSteadyStateSynchronousResponseAnalysis:
    ...
    __parent__: "CompoundSteadyStateSynchronousResponseAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CompoundSteadyStateSynchronousResponseAnalysis(_2708.CompoundAnalysis):
    """CompoundSteadyStateSynchronousResponseAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CompoundSteadyStateSynchronousResponseAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CompoundSteadyStateSynchronousResponseAnalysis
        """
        return _Cast_CompoundSteadyStateSynchronousResponseAnalysis(self)
