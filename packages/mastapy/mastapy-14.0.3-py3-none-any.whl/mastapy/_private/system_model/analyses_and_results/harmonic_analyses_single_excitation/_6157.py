...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltConnectionHarmonicAnalysisOfSingleExcitation._Cast_BeltConnectionHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_BeltConnectionHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "BeltConnectionHarmonicAnalysisOfSingleExcitation"
...
class BeltConnectionHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _BELT_CONNECTION_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BeltConnectionHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_BeltConnectionHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_BeltConnectionHarmonicAnalysisOfSingleExcitation(self)
