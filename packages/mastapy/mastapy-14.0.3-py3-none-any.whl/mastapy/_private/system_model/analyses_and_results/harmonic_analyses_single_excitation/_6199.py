...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="DatumHarmonicAnalysisOfSingleExcitation._Cast_DatumHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_DatumHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "DatumHarmonicAnalysisOfSingleExcitation"
...
class DatumHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _DATUM_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_DatumHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_DatumHarmonicAnalysisOfSingleExcitation(self)
