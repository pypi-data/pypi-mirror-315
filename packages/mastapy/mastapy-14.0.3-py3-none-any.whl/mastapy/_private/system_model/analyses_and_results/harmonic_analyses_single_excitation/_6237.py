...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierHarmonicAnalysisOfSingleExcitation._Cast_PlanetCarrierHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_PlanetCarrierHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "PlanetCarrierHarmonicAnalysisOfSingleExcitation"
...
class PlanetCarrierHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _PLANET_CARRIER_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PlanetCarrierHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_PlanetCarrierHarmonicAnalysisOfSingleExcitation(self)
