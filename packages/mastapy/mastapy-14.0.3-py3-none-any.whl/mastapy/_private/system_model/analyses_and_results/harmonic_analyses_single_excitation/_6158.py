...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltDriveHarmonicAnalysisOfSingleExcitation._Cast_BeltDriveHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_BeltDriveHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "BeltDriveHarmonicAnalysisOfSingleExcitation"
...
class BeltDriveHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _BELT_DRIVE_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltDriveHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_BeltDriveHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_BeltDriveHarmonicAnalysisOfSingleExcitation(self)
