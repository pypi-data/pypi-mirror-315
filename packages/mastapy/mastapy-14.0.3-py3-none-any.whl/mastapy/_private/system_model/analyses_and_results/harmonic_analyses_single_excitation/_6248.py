...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ShaftHubConnectionHarmonicAnalysisOfSingleExcitation._Cast_ShaftHubConnectionHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ShaftHubConnectionHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ShaftHubConnectionHarmonicAnalysisOfSingleExcitation"
...
class ShaftHubConnectionHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _SHAFT_HUB_CONNECTION_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ShaftHubConnectionHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ShaftHubConnectionHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ShaftHubConnectionHarmonicAnalysisOfSingleExcitation(self)
