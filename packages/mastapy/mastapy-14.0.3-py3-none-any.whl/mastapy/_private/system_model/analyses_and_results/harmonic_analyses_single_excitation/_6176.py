...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHarmonicAnalysisOfSingleExcitation._Cast_ConceptCouplingHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ConceptCouplingHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ConceptCouplingHarmonicAnalysisOfSingleExcitation"
...
class ConceptCouplingHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ConceptCouplingHarmonicAnalysisOfSingleExcitation(self)
