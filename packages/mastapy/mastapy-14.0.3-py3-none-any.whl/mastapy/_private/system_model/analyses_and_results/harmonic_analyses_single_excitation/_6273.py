...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassHarmonicAnalysisOfSingleExcitation._Cast_UnbalancedMassHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_UnbalancedMassHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "UnbalancedMassHarmonicAnalysisOfSingleExcitation"
...
class UnbalancedMassHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_UnbalancedMassHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_UnbalancedMassHarmonicAnalysisOfSingleExcitation(self)
