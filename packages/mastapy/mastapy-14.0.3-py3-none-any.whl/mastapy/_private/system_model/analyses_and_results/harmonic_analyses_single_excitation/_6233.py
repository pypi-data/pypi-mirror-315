...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation._Cast_PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation"
...
class PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation(
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation(self)
