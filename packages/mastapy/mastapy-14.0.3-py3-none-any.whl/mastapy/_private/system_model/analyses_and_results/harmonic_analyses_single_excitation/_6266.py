...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserHarmonicAnalysisOfSingleExcitation._Cast_SynchroniserHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_SynchroniserHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "SynchroniserHarmonicAnalysisOfSingleExcitation"
...
class SynchroniserHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_SynchroniserHarmonicAnalysisOfSingleExcitation(self)
