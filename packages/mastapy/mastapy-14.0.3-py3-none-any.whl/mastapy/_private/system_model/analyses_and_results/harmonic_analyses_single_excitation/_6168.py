...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltHarmonicAnalysisOfSingleExcitation._Cast_BoltHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_BoltHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "BoltHarmonicAnalysisOfSingleExcitation"
...
class BoltHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _BOLT_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_BoltHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_BoltHarmonicAnalysisOfSingleExcitation(self)
