...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation._Cast_FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation"
...
class FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _FLEXIBLE_PIN_ASSEMBLY_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation(self)
