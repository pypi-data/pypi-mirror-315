...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearHarmonicAnalysisOfSingleExcitation._Cast_StraightBevelGearHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_StraightBevelGearHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "StraightBevelGearHarmonicAnalysisOfSingleExcitation"
...
class StraightBevelGearHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_StraightBevelGearHarmonicAnalysisOfSingleExcitation(self)
