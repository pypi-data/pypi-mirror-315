...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self",
        bound="PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation",
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation._Cast_PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation"
...
class PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _PART_TO_PART_SHEAR_COUPLING_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6234.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation(
            self
        )
