...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ClutchCompoundHarmonicAnalysisOfSingleExcitation._Cast_ClutchCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_ClutchCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "ClutchCompoundHarmonicAnalysisOfSingleExcitation"
...
class ClutchCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _CLUTCH_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6171.ClutchHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ClutchCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_ClutchCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_ClutchCompoundHarmonicAnalysisOfSingleExcitation(self)
