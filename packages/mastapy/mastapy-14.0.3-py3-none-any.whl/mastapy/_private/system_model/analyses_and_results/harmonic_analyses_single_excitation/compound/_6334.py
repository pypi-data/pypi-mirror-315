...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearCompoundHarmonicAnalysisOfSingleExcitation._Cast_FaceGearCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_FaceGearCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "FaceGearCompoundHarmonicAnalysisOfSingleExcitation"
...
class FaceGearCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _FACE_GEAR_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6201.FaceGearHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_FaceGearCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_FaceGearCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_FaceGearCompoundHarmonicAnalysisOfSingleExcitation(self)
