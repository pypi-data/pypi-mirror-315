...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHarmonicAnalysisOfSingleExcitation._Cast_SpringDamperHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_SpringDamperHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "SpringDamperHarmonicAnalysisOfSingleExcitation"
...
class SpringDamperHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_SpringDamperHarmonicAnalysisOfSingleExcitation(self)
