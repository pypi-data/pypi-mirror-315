...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation._Cast_RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation",
    )
...
class _Cast_RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation:
    ...
    __parent__: "RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation"
...
class RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    TYPE: ClassVar["Type"] = (
        _ROLLING_RING_ASSEMBLY_COMPOUND_HARMONIC_ANALYSIS_OF_SINGLE_EXCITATION
    )
    ...
    @property
    def component_design(self: "Self") -> "_2661.RollingRingAssembly":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6243.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation":
        """Cast to another type.

        Returns:
            _Cast_RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation
        """
        return _Cast_RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation(self)
