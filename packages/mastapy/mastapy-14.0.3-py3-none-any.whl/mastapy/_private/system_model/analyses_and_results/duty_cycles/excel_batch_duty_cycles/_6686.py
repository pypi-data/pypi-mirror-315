...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1650
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: "Self") -> "_6687.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: "Self") -> "_6690.MASTAFileDetails":
    ...
    @property
    def working_folder(self: "Self") -> "_1650.SelectableFolder":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6689.ExcelSheetDesignStateSelector]":
