...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearSteadyStateSynchronousResponse._Cast_CylindricalGearSteadyStateSynchronousResponse",
    )
...
class _Cast_CylindricalGearSteadyStateSynchronousResponse:
    ...
    __parent__: "CylindricalGearSteadyStateSynchronousResponse"
...
class CylindricalGearSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearSteadyStateSynchronousResponse
        """
        return _Cast_CylindricalGearSteadyStateSynchronousResponse(self)
