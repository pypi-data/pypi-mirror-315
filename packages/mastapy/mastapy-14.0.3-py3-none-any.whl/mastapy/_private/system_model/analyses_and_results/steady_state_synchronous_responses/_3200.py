...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpSteadyStateSynchronousResponse._Cast_TorqueConverterPumpSteadyStateSynchronousResponse",
    )
...
class _Cast_TorqueConverterPumpSteadyStateSynchronousResponse:
    ...
    __parent__: "TorqueConverterPumpSteadyStateSynchronousResponse"
...
class TorqueConverterPumpSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_PUMP_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_TorqueConverterPumpSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpSteadyStateSynchronousResponse
        """
        return _Cast_TorqueConverterPumpSteadyStateSynchronousResponse(self)
