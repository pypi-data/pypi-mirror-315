...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierSteadyStateSynchronousResponse._Cast_PlanetCarrierSteadyStateSynchronousResponse",
    )
...
class _Cast_PlanetCarrierSteadyStateSynchronousResponse:
    ...
    __parent__: "PlanetCarrierSteadyStateSynchronousResponse"
...
class PlanetCarrierSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _PLANET_CARRIER_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PlanetCarrierSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierSteadyStateSynchronousResponse
        """
        return _Cast_PlanetCarrierSteadyStateSynchronousResponse(self)
