...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterSteadyStateSynchronousResponse._Cast_TorqueConverterSteadyStateSynchronousResponse",
    )
...
class _Cast_TorqueConverterSteadyStateSynchronousResponse:
    ...
    __parent__: "TorqueConverterSteadyStateSynchronousResponse"
...
class TorqueConverterSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterSteadyStateSynchronousResponse
        """
        return _Cast_TorqueConverterSteadyStateSynchronousResponse(self)
