...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointCompoundSteadyStateSynchronousResponse._Cast_BoltedJointCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_BoltedJointCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "BoltedJointCompoundSteadyStateSynchronousResponse"
...
class BoltedJointCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_BoltedJointCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointCompoundSteadyStateSynchronousResponse
        """
        return _Cast_BoltedJointCompoundSteadyStateSynchronousResponse(self)
