...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ExternalCADModelSteadyStateSynchronousResponse._Cast_ExternalCADModelSteadyStateSynchronousResponse",
    )
...
class _Cast_ExternalCADModelSteadyStateSynchronousResponse:
    ...
    __parent__: "ExternalCADModelSteadyStateSynchronousResponse"
...
class ExternalCADModelSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _EXTERNAL_CAD_MODEL_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ExternalCADModelSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_ExternalCADModelSteadyStateSynchronousResponse
        """
        return _Cast_ExternalCADModelSteadyStateSynchronousResponse(self)
