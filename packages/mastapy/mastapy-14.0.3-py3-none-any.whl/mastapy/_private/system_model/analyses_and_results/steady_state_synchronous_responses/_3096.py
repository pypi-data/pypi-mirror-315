...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltSteadyStateSynchronousResponse._Cast_BoltSteadyStateSynchronousResponse",
    )
...
class _Cast_BoltSteadyStateSynchronousResponse:
    ...
    __parent__: "BoltSteadyStateSynchronousResponse"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltSteadyStateSynchronousResponse(_3101.ComponentSteadyStateSynchronousResponse):
    """BoltSteadyStateSynchronousResponse

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _BOLT_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_BoltSteadyStateSynchronousResponse
        """
        return _Cast_BoltSteadyStateSynchronousResponse(self)
