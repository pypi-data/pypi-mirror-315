...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ZerolBevelGearSteadyStateSynchronousResponse._Cast_ZerolBevelGearSteadyStateSynchronousResponse",
    )
...
class _Cast_ZerolBevelGearSteadyStateSynchronousResponse:
    ...
    __parent__: "ZerolBevelGearSteadyStateSynchronousResponse"
...
class ZerolBevelGearSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _ZEROL_BEVEL_GEAR_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ZerolBevelGearSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_ZerolBevelGearSteadyStateSynchronousResponse
        """
        return _Cast_ZerolBevelGearSteadyStateSynchronousResponse(self)
