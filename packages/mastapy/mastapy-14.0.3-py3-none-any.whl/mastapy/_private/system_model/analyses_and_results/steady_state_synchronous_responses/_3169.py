...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="RingPinsToDiscConnectionSteadyStateSynchronousResponse"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsToDiscConnectionSteadyStateSynchronousResponse._Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponse",
    )
...
class _Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponse:
    ...
    __parent__: "RingPinsToDiscConnectionSteadyStateSynchronousResponse"
...
class RingPinsToDiscConnectionSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _RING_PINS_TO_DISC_CONNECTION_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponse
        """
        return _Cast_RingPinsToDiscConnectionSteadyStateSynchronousResponse(self)
