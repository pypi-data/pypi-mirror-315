...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="StraightBevelGearCompoundSteadyStateSynchronousResponse"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearCompoundSteadyStateSynchronousResponse._Cast_StraightBevelGearCompoundSteadyStateSynchronousResponse",
    )
...
class _Cast_StraightBevelGearCompoundSteadyStateSynchronousResponse:
    ...
    __parent__: "StraightBevelGearCompoundSteadyStateSynchronousResponse"
...
class StraightBevelGearCompoundSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _STRAIGHT_BEVEL_GEAR_COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3192.StraightBevelGearSteadyStateSynchronousResponse]":
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_StraightBevelGearCompoundSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearCompoundSteadyStateSynchronousResponse
        """
        return _Cast_StraightBevelGearCompoundSteadyStateSynchronousResponse(self)
