...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="ConceptCouplingConnectionSteadyStateSynchronousResponse"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingConnectionSteadyStateSynchronousResponse._Cast_ConceptCouplingConnectionSteadyStateSynchronousResponse",
    )
...
class _Cast_ConceptCouplingConnectionSteadyStateSynchronousResponse:
    ...
    __parent__: "ConceptCouplingConnectionSteadyStateSynchronousResponse"
...
class ConceptCouplingConnectionSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = (
        _CONCEPT_COUPLING_CONNECTION_STEADY_STATE_SYNCHRONOUS_RESPONSE
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ConceptCouplingConnectionSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingConnectionSteadyStateSynchronousResponse
        """
        return _Cast_ConceptCouplingConnectionSteadyStateSynchronousResponse(self)
