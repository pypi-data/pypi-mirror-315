...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BoltedJointSteadyStateSynchronousResponse._Cast_BoltedJointSteadyStateSynchronousResponse",
    )
...
class _Cast_BoltedJointSteadyStateSynchronousResponse:
    ...
    __parent__: "BoltedJointSteadyStateSynchronousResponse"
...
class BoltedJointSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _BOLTED_JOINT_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BoltedJointSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_BoltedJointSteadyStateSynchronousResponse
        """
        return _Cast_BoltedJointSteadyStateSynchronousResponse(self)
