...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentSteadyStateSynchronousResponse._Cast_MeasurementComponentSteadyStateSynchronousResponse",
    )
...
class _Cast_MeasurementComponentSteadyStateSynchronousResponse:
    ...
    __parent__: "MeasurementComponentSteadyStateSynchronousResponse"
...
class MeasurementComponentSteadyStateSynchronousResponse(
    ...
    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_STEADY_STATE_SYNCHRONOUS_RESPONSE
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_MeasurementComponentSteadyStateSynchronousResponse":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentSteadyStateSynchronousResponse
        """
        return _Cast_MeasurementComponentSteadyStateSynchronousResponse(self)
