...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="PowerFlowAnalysis._Cast_PowerFlowAnalysis")
...
class _Cast_PowerFlowAnalysis:
    ...
    @property
    def power_flow_analysis(self: "CastSelf") -> "PowerFlowAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerFlowAnalysis(_2709.SingleAnalysis):
    """PowerFlowAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POWER_FLOW_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerFlowAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PowerFlowAnalysis
        """
        return _Cast_PowerFlowAnalysis(self)
