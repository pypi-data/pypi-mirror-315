...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="SystemDeflectionAnalysis._Cast_SystemDeflectionAnalysis"
    )
...
class _Cast_SystemDeflectionAnalysis:
    ...
    __parent__: "SystemDeflectionAnalysis"
    ...
    @property
    def system_deflection_analysis(self: "CastSelf") -> "SystemDeflectionAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SystemDeflectionAnalysis(_2709.SingleAnalysis):
    """SystemDeflectionAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SYSTEM_DEFLECTION_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SystemDeflectionAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SystemDeflectionAnalysis
        """
        return _Cast_SystemDeflectionAnalysis(self)
