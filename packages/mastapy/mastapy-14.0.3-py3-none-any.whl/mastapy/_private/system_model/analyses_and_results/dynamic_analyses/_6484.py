...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="GuideDxfModelDynamicAnalysis._Cast_GuideDxfModelDynamicAnalysis",
    )
...
class _Cast_GuideDxfModelDynamicAnalysis:
    ...
    __parent__: "GuideDxfModelDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GuideDxfModelDynamicAnalysis(_6446.ComponentDynamicAnalysis):
    """GuideDxfModelDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _GUIDE_DXF_MODEL_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_GuideDxfModelDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_GuideDxfModelDynamicAnalysis
        """
        return _Cast_GuideDxfModelDynamicAnalysis(self)
