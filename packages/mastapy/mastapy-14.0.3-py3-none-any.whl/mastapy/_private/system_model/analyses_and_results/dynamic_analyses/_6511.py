...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="PointLoadDynamicAnalysis._Cast_PointLoadDynamicAnalysis"
    )
...
class _Cast_PointLoadDynamicAnalysis:
    ...
    __parent__: "PointLoadDynamicAnalysis"
    ...
    @property
    def point_load_dynamic_analysis(self: "CastSelf") -> "PointLoadDynamicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadDynamicAnalysis(_6547.VirtualComponentDynamicAnalysis):
    """PointLoadDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POINT_LOAD_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PointLoadDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PointLoadDynamicAnalysis
        """
        return _Cast_PointLoadDynamicAnalysis(self)
