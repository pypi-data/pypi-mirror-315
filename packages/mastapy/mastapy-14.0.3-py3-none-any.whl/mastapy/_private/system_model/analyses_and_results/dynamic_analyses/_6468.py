...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearDynamicAnalysis._Cast_CylindricalGearDynamicAnalysis",
    )
...
class _Cast_CylindricalGearDynamicAnalysis:
    ...
    __parent__: "CylindricalGearDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearDynamicAnalysis(_6481.GearDynamicAnalysis):
    """CylindricalGearDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearDynamicAnalysis
        """
        return _Cast_CylindricalGearDynamicAnalysis(self)
