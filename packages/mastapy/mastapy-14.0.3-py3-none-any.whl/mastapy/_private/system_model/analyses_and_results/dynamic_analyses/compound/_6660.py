...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfCompoundDynamicAnalysis._Cast_SpringDamperHalfCompoundDynamicAnalysis",
    )
...
class _Cast_SpringDamperHalfCompoundDynamicAnalysis:
    ...
    __parent__: "SpringDamperHalfCompoundDynamicAnalysis"
...
class SpringDamperHalfCompoundDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6529.SpringDamperHalfDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHalfCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfCompoundDynamicAnalysis
        """
        return _Cast_SpringDamperHalfCompoundDynamicAnalysis(self)
