...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassDynamicAnalysis._Cast_UnbalancedMassDynamicAnalysis",
    )
...
class _Cast_UnbalancedMassDynamicAnalysis:
    ...
    __parent__: "UnbalancedMassDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UnbalancedMassDynamicAnalysis(_6547.VirtualComponentDynamicAnalysis):
    """UnbalancedMassDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_UnbalancedMassDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassDynamicAnalysis
        """
        return _Cast_UnbalancedMassDynamicAnalysis(self)
