...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearMeshCompoundDynamicAnalysis._Cast_CylindricalGearMeshCompoundDynamicAnalysis",
    )
...
class _Cast_CylindricalGearMeshCompoundDynamicAnalysis:
    ...
    __parent__: "CylindricalGearMeshCompoundDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshCompoundDynamicAnalysis(_6613.GearMeshCompoundDynamicAnalysis):
    """CylindricalGearMeshCompoundDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_MESH_COMPOUND_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearMeshCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearMeshCompoundDynamicAnalysis
        """
        return _Cast_CylindricalGearMeshCompoundDynamicAnalysis(self)
