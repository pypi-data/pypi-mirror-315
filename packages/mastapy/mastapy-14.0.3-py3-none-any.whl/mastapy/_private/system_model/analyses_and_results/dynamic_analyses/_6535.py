...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="StraightBevelGearSetDynamicAnalysis._Cast_StraightBevelGearSetDynamicAnalysis",
    )
...
class _Cast_StraightBevelGearSetDynamicAnalysis:
    ...
    __parent__: "StraightBevelGearSetDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSetDynamicAnalysis(_6439.BevelGearSetDynamicAnalysis):
    """StraightBevelGearSetDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _STRAIGHT_BEVEL_GEAR_SET_DYNAMIC_ANALYSIS
    ...
    def bevel_gears_dynamic_analysis(
        self: "Self",
    ) -> "List[_6533.StraightBevelGearDynamicAnalysis]":
    ...
    def straight_bevel_gears_dynamic_analysis(
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "StraightBevelGearsDynamicAnalysis")
    ...
    def bevel_meshes_dynamic_analysis(
        self: "Self",
    ) -> "List[_6534.StraightBevelGearMeshDynamicAnalysis]":
    ...
    def straight_bevel_meshes_dynamic_analysis(
        ...
        temp = pythonnet_property_get(
            self.wrapped, "StraightBevelMeshesDynamicAnalysis"
        )
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_StraightBevelGearSetDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_StraightBevelGearSetDynamicAnalysis
        """
        return _Cast_StraightBevelGearSetDynamicAnalysis(self)
