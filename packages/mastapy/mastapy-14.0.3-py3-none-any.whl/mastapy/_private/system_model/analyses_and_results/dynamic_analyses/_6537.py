...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6530
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelSunGearDynamicAnalysis(_6530.StraightBevelDiffGearDynamicAnalysis):
    """StraightBevelSunGearDynamicAnalysis
