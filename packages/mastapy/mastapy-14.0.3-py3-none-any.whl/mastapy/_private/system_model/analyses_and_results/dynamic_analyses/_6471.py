...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalPlanetGearDynamicAnalysis._Cast_CylindricalPlanetGearDynamicAnalysis",
    )
...
class _Cast_CylindricalPlanetGearDynamicAnalysis:
    ...
    __parent__: "CylindricalPlanetGearDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalPlanetGearDynamicAnalysis(_6468.CylindricalGearDynamicAnalysis):
    """CylindricalPlanetGearDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYLINDRICAL_PLANET_GEAR_DYNAMIC_ANALYSIS
    ...
    @property
    def component_design(self: "Self") -> "_2588.CylindricalPlanetGear":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalPlanetGearDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CylindricalPlanetGearDynamicAnalysis
        """
        return _Cast_CylindricalPlanetGearDynamicAnalysis(self)
