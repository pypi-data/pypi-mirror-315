...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentCompoundDynamicAnalysis._Cast_MeasurementComponentCompoundDynamicAnalysis",
    )
...
class _Cast_MeasurementComponentCompoundDynamicAnalysis:
    ...
    __parent__: "MeasurementComponentCompoundDynamicAnalysis"
...
class MeasurementComponentCompoundDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6499.MeasurementComponentDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MeasurementComponentCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentCompoundDynamicAnalysis
        """
        return _Cast_MeasurementComponentCompoundDynamicAnalysis(self)
