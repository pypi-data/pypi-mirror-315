...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ClutchDynamicAnalysis._Cast_ClutchDynamicAnalysis"
    )
...
class _Cast_ClutchDynamicAnalysis:
    ...
    __parent__: "ClutchDynamicAnalysis"
    ...
    @property
    def clutch_dynamic_analysis(self: "CastSelf") -> "ClutchDynamicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchDynamicAnalysis(_6459.CouplingDynamicAnalysis):
    """ClutchDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_DYNAMIC_ANALYSIS
    ...
    @property
    def assembly_load_case(self: "Self") -> "_6987.ClutchLoadCase":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ClutchDynamicAnalysis
        """
        return _Cast_ClutchDynamicAnalysis(self)
