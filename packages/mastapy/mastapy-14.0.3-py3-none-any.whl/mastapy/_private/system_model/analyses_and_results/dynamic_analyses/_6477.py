...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshDynamicAnalysis._Cast_FaceGearMeshDynamicAnalysis",
    )
...
class _Cast_FaceGearMeshDynamicAnalysis:
    ...
    __parent__: "FaceGearMeshDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMeshDynamicAnalysis(_6482.GearMeshDynamicAnalysis):
    """FaceGearMeshDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FACE_GEAR_MESH_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearMeshDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshDynamicAnalysis
        """
        return _Cast_FaceGearMeshDynamicAnalysis(self)
