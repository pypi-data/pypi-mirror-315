...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6428
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyDynamicAnalysis(_6428.AssemblyDynamicAnalysis):
    """RootAssemblyDynamicAnalysis
    ...
    @property
    def dynamic_analysis_inputs(self: "Self") -> "_6473.DynamicAnalysis":
