...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6459
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterDynamicAnalysis._Cast_TorqueConverterDynamicAnalysis",
    )
...
class _Cast_TorqueConverterDynamicAnalysis:
    ...
    __parent__: "TorqueConverterDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterDynamicAnalysis(_6459.CouplingDynamicAnalysis):
    """TorqueConverterDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterDynamicAnalysis
        """
        return _Cast_TorqueConverterDynamicAnalysis(self)
