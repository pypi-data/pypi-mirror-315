...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserSleeveCompoundDynamicAnalysis._Cast_SynchroniserSleeveCompoundDynamicAnalysis",
    )
...
class _Cast_SynchroniserSleeveCompoundDynamicAnalysis:
    ...
    __parent__: "SynchroniserSleeveCompoundDynamicAnalysis"
...
class SynchroniserSleeveCompoundDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_SLEEVE_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6541.SynchroniserSleeveDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserSleeveCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserSleeveCompoundDynamicAnalysis
        """
        return _Cast_SynchroniserSleeveCompoundDynamicAnalysis(self)
