...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ConceptGearDynamicAnalysis._Cast_ConceptGearDynamicAnalysis"
    )
...
class _Cast_ConceptGearDynamicAnalysis:
    ...
    __parent__: "ConceptGearDynamicAnalysis"
    ...
    @property
    def concept_gear_dynamic_analysis(self: "CastSelf") -> "ConceptGearDynamicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearDynamicAnalysis(_6481.GearDynamicAnalysis):
    """ConceptGearDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CONCEPT_GEAR_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptGearDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ConceptGearDynamicAnalysis
        """
        return _Cast_ConceptGearDynamicAnalysis(self)
