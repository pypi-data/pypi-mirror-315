...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterPumpCompoundDynamicAnalysis._Cast_TorqueConverterPumpCompoundDynamicAnalysis",
    )
...
class _Cast_TorqueConverterPumpCompoundDynamicAnalysis:
    ...
    __parent__: "TorqueConverterPumpCompoundDynamicAnalysis"
...
class TorqueConverterPumpCompoundDynamicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_PUMP_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6544.TorqueConverterPumpDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterPumpCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterPumpCompoundDynamicAnalysis
        """
        return _Cast_TorqueConverterPumpCompoundDynamicAnalysis(self)
