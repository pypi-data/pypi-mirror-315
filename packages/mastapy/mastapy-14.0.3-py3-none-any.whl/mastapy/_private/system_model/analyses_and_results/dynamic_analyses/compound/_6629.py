...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MassDiscCompoundDynamicAnalysis._Cast_MassDiscCompoundDynamicAnalysis",
    )
...
class _Cast_MassDiscCompoundDynamicAnalysis:
    ...
    __parent__: "MassDiscCompoundDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscCompoundDynamicAnalysis(_6678.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MASS_DISC_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6498.MassDiscDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_6498.MassDiscDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.MassDiscDynamicAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MassDiscCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MassDiscCompoundDynamicAnalysis
        """
        return _Cast_MassDiscCompoundDynamicAnalysis(self)
