...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="MassDiscDynamicAnalysis._Cast_MassDiscDynamicAnalysis"
    )
...
class _Cast_MassDiscDynamicAnalysis:
    ...
    __parent__: "MassDiscDynamicAnalysis"
    ...
    @property
    def mass_disc_dynamic_analysis(self: "CastSelf") -> "MassDiscDynamicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscDynamicAnalysis(_6547.VirtualComponentDynamicAnalysis):
    """MassDiscDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MASS_DISC_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MassDiscDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MassDiscDynamicAnalysis
        """
        return _Cast_MassDiscDynamicAnalysis(self)
