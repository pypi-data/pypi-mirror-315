...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearMeshCompoundDynamicAnalysis._Cast_WormGearMeshCompoundDynamicAnalysis",
    )
...
class _Cast_WormGearMeshCompoundDynamicAnalysis:
    ...
    __parent__: "WormGearMeshCompoundDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearMeshCompoundDynamicAnalysis(_6613.GearMeshCompoundDynamicAnalysis):
    """WormGearMeshCompoundDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _WORM_GEAR_MESH_COMPOUND_DYNAMIC_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6549.WormGearMeshDynamicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearMeshCompoundDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_WormGearMeshCompoundDynamicAnalysis
        """
        return _Cast_WormGearMeshCompoundDynamicAnalysis(self)
