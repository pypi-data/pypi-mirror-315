...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperDynamicAnalysis._Cast_SpringDamperDynamicAnalysis",
    )
...
class _Cast_SpringDamperDynamicAnalysis:
    ...
    __parent__: "SpringDamperDynamicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperDynamicAnalysis(_6459.CouplingDynamicAnalysis):
    """SpringDamperDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperDynamicAnalysis
        """
        return _Cast_SpringDamperDynamicAnalysis(self)
