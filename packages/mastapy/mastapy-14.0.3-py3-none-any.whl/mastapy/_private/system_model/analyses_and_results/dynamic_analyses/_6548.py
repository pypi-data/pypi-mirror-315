...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="WormGearDynamicAnalysis._Cast_WormGearDynamicAnalysis"
    )
...
class _Cast_WormGearDynamicAnalysis:
    ...
    __parent__: "WormGearDynamicAnalysis"
    ...
    @property
    def worm_gear_dynamic_analysis(self: "CastSelf") -> "WormGearDynamicAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearDynamicAnalysis(_6481.GearDynamicAnalysis):
    """WormGearDynamicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _WORM_GEAR_DYNAMIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearDynamicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_WormGearDynamicAnalysis
        """
        return _Cast_WormGearDynamicAnalysis(self)
