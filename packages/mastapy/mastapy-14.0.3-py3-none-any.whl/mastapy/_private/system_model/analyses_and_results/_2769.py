...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="CompoundSteadyStateSynchronousResponseOnAShaftAnalysis"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="CompoundSteadyStateSynchronousResponseOnAShaftAnalysis._Cast_CompoundSteadyStateSynchronousResponseOnAShaftAnalysis",
    )
...
class _Cast_CompoundSteadyStateSynchronousResponseOnAShaftAnalysis:
    ...
    __parent__: "CompoundSteadyStateSynchronousResponseOnAShaftAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CompoundSteadyStateSynchronousResponseOnAShaftAnalysis(_2708.CompoundAnalysis):
    """CompoundSteadyStateSynchronousResponseOnAShaftAnalysis
    ...
    TYPE: ClassVar["Type"] = (
        _COMPOUND_STEADY_STATE_SYNCHRONOUS_RESPONSE_ON_A_SHAFT_ANALYSIS
    )
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CompoundSteadyStateSynchronousResponseOnAShaftAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CompoundSteadyStateSynchronousResponseOnAShaftAnalysis
        """
        return _Cast_CompoundSteadyStateSynchronousResponseOnAShaftAnalysis(self)
