...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MassDiscCompoundModalAnalysis(_4971.VirtualComponentCompoundModalAnalysis):
    """MassDiscCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4769.MassDiscModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4769.MassDiscModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.MassDiscModalAnalysis]
