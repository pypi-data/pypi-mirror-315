...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="RingPinsModalAnalysis._Cast_RingPinsModalAnalysis"
    )
...
class _Cast_RingPinsModalAnalysis:
    ...
    __parent__: "RingPinsModalAnalysis"
    ...
    @property
    def ring_pins_modal_analysis(self: "CastSelf") -> "RingPinsModalAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPinsModalAnalysis(_4777.MountableComponentModalAnalysis):
    """RingPinsModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _RING_PINS_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_RingPinsModalAnalysis
        """
        return _Cast_RingPinsModalAnalysis(self)
