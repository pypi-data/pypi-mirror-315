...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SynchroniserSleeveCompoundModalAnalysis._Cast_SynchroniserSleeveCompoundModalAnalysis",
    )
...
class _Cast_SynchroniserSleeveCompoundModalAnalysis:
    ...
    __parent__: "SynchroniserSleeveCompoundModalAnalysis"
...
class SynchroniserSleeveCompoundModalAnalysis(
    ...
    TYPE: ClassVar["Type"] = _SYNCHRONISER_SLEEVE_COMPOUND_MODAL_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4819.SynchroniserSleeveModalAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SynchroniserSleeveCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_SynchroniserSleeveCompoundModalAnalysis
        """
        return _Cast_SynchroniserSleeveCompoundModalAnalysis(self)
