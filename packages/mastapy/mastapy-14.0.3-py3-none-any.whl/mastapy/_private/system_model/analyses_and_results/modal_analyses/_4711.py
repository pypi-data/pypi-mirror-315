...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="ClutchHalfModalAnalysis._Cast_ClutchHalfModalAnalysis"
    )
...
class _Cast_ClutchHalfModalAnalysis:
    ...
    __parent__: "ClutchHalfModalAnalysis"
    ...
    @property
    def clutch_half_modal_analysis(self: "CastSelf") -> "ClutchHalfModalAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ClutchHalfModalAnalysis(_4728.CouplingHalfModalAnalysis):
    """ClutchHalfModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CLUTCH_HALF_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ClutchHalfModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_ClutchHalfModalAnalysis
        """
        return _Cast_ClutchHalfModalAnalysis(self)
