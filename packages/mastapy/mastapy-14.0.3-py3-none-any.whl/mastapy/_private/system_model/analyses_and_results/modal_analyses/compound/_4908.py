...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4755
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _4928,
    )
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GuideDxfModelCompoundModalAnalysis(_4872.ComponentCompoundModalAnalysis):
    """GuideDxfModelCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4755.GuideDxfModelModalAnalysis]":
