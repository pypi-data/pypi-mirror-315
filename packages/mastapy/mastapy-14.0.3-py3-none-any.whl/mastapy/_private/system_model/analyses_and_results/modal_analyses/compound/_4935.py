...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PointLoadCompoundModalAnalysis._Cast_PointLoadCompoundModalAnalysis",
    )
...
class _Cast_PointLoadCompoundModalAnalysis:
    ...
    __parent__: "PointLoadCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PointLoadCompoundModalAnalysis(_4971.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POINT_LOAD_COMPOUND_MODAL_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4788.PointLoadModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4788.PointLoadModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PointLoadModalAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PointLoadCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PointLoadCompoundModalAnalysis
        """
        return _Cast_PointLoadCompoundModalAnalysis(self)
