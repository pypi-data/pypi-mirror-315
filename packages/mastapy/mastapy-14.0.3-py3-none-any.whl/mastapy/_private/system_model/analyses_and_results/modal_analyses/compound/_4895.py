...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearMeshCompoundModalAnalysis._Cast_CylindricalGearMeshCompoundModalAnalysis",
    )
...
class _Cast_CylindricalGearMeshCompoundModalAnalysis:
    ...
    __parent__: "CylindricalGearMeshCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshCompoundModalAnalysis(_4906.GearMeshCompoundModalAnalysis):
    """CylindricalGearMeshCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_MESH_COMPOUND_MODAL_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4737.CylindricalGearMeshModalAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearMeshCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearMeshCompoundModalAnalysis
        """
        return _Cast_CylindricalGearMeshCompoundModalAnalysis(self)
