...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="FaceGearMeshCompoundModalAnalysis._Cast_FaceGearMeshCompoundModalAnalysis",
    )
...
class _Cast_FaceGearMeshCompoundModalAnalysis:
    ...
    __parent__: "FaceGearMeshCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMeshCompoundModalAnalysis(_4906.GearMeshCompoundModalAnalysis):
    """FaceGearMeshCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _FACE_GEAR_MESH_COMPOUND_MODAL_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4746.FaceGearMeshModalAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_FaceGearMeshCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_FaceGearMeshCompoundModalAnalysis
        """
        return _Cast_FaceGearMeshCompoundModalAnalysis(self)
