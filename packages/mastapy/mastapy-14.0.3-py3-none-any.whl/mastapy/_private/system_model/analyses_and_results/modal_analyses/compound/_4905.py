...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearCompoundModalAnalysis(_4926.MountableComponentCompoundModalAnalysis):
    """GearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4753.GearModalAnalysis]":
    ...
    @property
    def component_analysis_cases_ready(self: "Self") -> "List[_4753.GearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.GearModalAnalysis]
