...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CalculateFullFEResultsForMode._Cast_CalculateFullFEResultsForMode",
    )
...
class _Cast_CalculateFullFEResultsForMode:
    ...
    __parent__: "CalculateFullFEResultsForMode"
...
class CalculateFullFEResultsForMode(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _CALCULATE_FULL_FE_RESULTS_FOR_MODE
    ...
    @property
    def fe_results(self: "Self") -> "List[_4839.ModalCMSResultsForModeAndFE]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.reporting.ModalCMSResultsForModeAndFE]

        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "FEResults")
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CalculateFullFEResultsForMode":
        """Cast to another type.

        Returns:
            _Cast_CalculateFullFEResultsForMode
        """
        return _Cast_CalculateFullFEResultsForMode(self)
