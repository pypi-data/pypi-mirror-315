...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar("CastSelf", bound="CVTModalAnalysis._Cast_CVTModalAnalysis")
...
class _Cast_CVTModalAnalysis:
    ...
    @property
    def cvt_modal_analysis(self: "CastSelf") -> "CVTModalAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTModalAnalysis(_4699.BeltDriveModalAnalysis):
    """CVTModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CVT_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CVTModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CVTModalAnalysis
        """
        return _Cast_CVTModalAnalysis(self)
