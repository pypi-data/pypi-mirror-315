...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    def analysis_type(self: "Self") -> "_52.BarModelAnalysisType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis._52", "BarModelAnalysisType"
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: "Self", value: "_52.BarModelAnalysisType") -> None:
    ...
    @enforce_parameter_types
    def coordinate_system(self: "Self", value: "_2511.FEPart") -> None:
        wrapper_type = (
    ...
    @fe_package.setter
    @enforce_parameter_types
    def fe_package(self: "Self", value: "_174.FEExportFormat") -> None:
    ...
    @fe_part.setter
    @enforce_parameter_types
    def fe_part(self: "Self", value: "_2511.FEPart") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_FEPart.wrapper_type()
        )
        enclosed_type = (
    ...
    @length_unit.setter
    @enforce_parameter_types
    def length_unit(self: "Self", value: "_1662.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @enforce_parameter_types
    def shaft_export_type(self: "Self", value: "_53.BarModelExportType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def mode_options(self: "Self") -> "_191.EigenvalueOptions":
