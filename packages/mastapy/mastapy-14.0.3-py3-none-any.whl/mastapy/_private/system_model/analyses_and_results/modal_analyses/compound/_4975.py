...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.modal_analyses import _4833
    from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
        _4851,
        _4872,
        _4879,
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearCompoundModalAnalysis(_4863.BevelGearCompoundModalAnalysis):
    """ZerolBevelGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4833.ZerolBevelGearModalAnalysis]":
