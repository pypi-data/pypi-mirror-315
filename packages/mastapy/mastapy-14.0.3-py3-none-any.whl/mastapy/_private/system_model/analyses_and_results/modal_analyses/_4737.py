...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearMeshModalAnalysis._Cast_CylindricalGearMeshModalAnalysis",
    )
...
class _Cast_CylindricalGearMeshModalAnalysis:
    ...
    __parent__: "CylindricalGearMeshModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearMeshModalAnalysis(_4752.GearMeshModalAnalysis):
    """CylindricalGearMeshModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_MESH_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearMeshModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearMeshModalAnalysis
        """
        return _Cast_CylindricalGearMeshModalAnalysis(self)
