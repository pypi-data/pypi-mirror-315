...
class WormGearSetModalAnalysis(_4754.GearSetModalAnalysis):
    ...
    @property
    def gears_modal_analysis(self: "Self") -> "List[_4830.WormGearModalAnalysis]":
    ...
    @property
    def worm_gears_modal_analysis(self: "Self") -> "List[_4830.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: "Self") -> "List[_4829.WormGearMeshModalAnalysis]":
    ...
    def worm_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4829.WormGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearMeshModalAnalysis]
