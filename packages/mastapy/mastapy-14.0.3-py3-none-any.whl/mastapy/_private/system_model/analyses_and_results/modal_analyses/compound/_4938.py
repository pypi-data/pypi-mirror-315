...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="RingPinsCompoundModalAnalysis._Cast_RingPinsCompoundModalAnalysis",
    )
...
class _Cast_RingPinsCompoundModalAnalysis:
    ...
    __parent__: "RingPinsCompoundModalAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPinsCompoundModalAnalysis(_4926.MountableComponentCompoundModalAnalysis):
    """RingPinsCompoundModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _RING_PINS_COMPOUND_MODAL_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4791.RingPinsModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4791.RingPinsModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.RingPinsModalAnalysis]
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_RingPinsCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_RingPinsCompoundModalAnalysis
        """
        return _Cast_RingPinsCompoundModalAnalysis(self)
