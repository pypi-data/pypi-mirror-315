...
class _Cast_ShaftPerModeResult:
    ...
    @property
    def component_per_mode_result(self: "CastSelf") -> "_4837.ComponentPerModeResult":
        return self.__parent__._cast(_4837.ComponentPerModeResult)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftPerModeResult(_4837.ComponentPerModeResult):
    """ShaftPerModeResult
