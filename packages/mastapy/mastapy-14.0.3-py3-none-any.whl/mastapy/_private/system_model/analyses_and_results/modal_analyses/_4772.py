...
_MICROPHONE_MODAL_ANALYSIS = python_net_import(
...
if TYPE_CHECKING:
    ...
    Self = TypeVar("Self", bound="MicrophoneModalAnalysis")
    CastSelf = TypeVar(
        "CastSelf", bound="MicrophoneModalAnalysis._Cast_MicrophoneModalAnalysis"
    )


__docformat__ = "restructuredtext en"
__all__ = ("MicrophoneModalAnalysis",)


@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class _Cast_MicrophoneModalAnalysis:
    """Special nested class for casting MicrophoneModalAnalysis to subclasses."""

    __parent__: "MicrophoneModalAnalysis"
    ...
    @property
    def microphone_modal_analysis(self: "CastSelf") -> "MicrophoneModalAnalysis":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneModalAnalysis(_4714.ComponentModalAnalysis):
    """MicrophoneModalAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _MICROPHONE_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MicrophoneModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_MicrophoneModalAnalysis
        """
        return _Cast_MicrophoneModalAnalysis(self)
