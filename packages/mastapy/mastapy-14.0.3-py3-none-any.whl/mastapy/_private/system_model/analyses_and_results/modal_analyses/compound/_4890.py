...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CycloidalAssemblyCompoundModalAnalysis._Cast_CycloidalAssemblyCompoundModalAnalysis",
    )
...
class _Cast_CycloidalAssemblyCompoundModalAnalysis:
    ...
    __parent__: "CycloidalAssemblyCompoundModalAnalysis"
...
class CycloidalAssemblyCompoundModalAnalysis(
    ...
    TYPE: ClassVar["Type"] = _CYCLOIDAL_ASSEMBLY_COMPOUND_MODAL_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CycloidalAssemblyCompoundModalAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CycloidalAssemblyCompoundModalAnalysis
        """
        return _Cast_CycloidalAssemblyCompoundModalAnalysis(self)
