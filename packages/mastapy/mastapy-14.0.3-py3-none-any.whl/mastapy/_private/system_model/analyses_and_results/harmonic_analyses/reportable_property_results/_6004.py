...
class _Cast_ResultsForMultipleOrders:
    ...
    def results_for_multiple_orders_for_fe_surface(
        self: "CastSelf",
    ) -> "_6005.ResultsForMultipleOrdersForFESurface":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6005,
        )

        return self.__parent__._cast(_6005.ResultsForMultipleOrdersForFESurface)

    @property
    def results_for_multiple_orders_for_groups(
        self: "CastSelf",
    ) -> "_6006.ResultsForMultipleOrdersForGroups":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import (
            _6006,
        )

        return self.__parent__._cast(_6006.ResultsForMultipleOrdersForGroups)
