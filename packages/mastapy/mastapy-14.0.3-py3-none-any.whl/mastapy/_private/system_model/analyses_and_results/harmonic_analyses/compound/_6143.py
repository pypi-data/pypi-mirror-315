...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearMeshCompoundHarmonicAnalysis._Cast_WormGearMeshCompoundHarmonicAnalysis",
    )
...
class _Cast_WormGearMeshCompoundHarmonicAnalysis:
    ...
    __parent__: "WormGearMeshCompoundHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearMeshCompoundHarmonicAnalysis(_6076.GearMeshCompoundHarmonicAnalysis):
    """WormGearMeshCompoundHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _WORM_GEAR_MESH_COMPOUND_HARMONIC_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5977.WormGearMeshHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearMeshCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_WormGearMeshCompoundHarmonicAnalysis
        """
        return _Cast_WormGearMeshCompoundHarmonicAnalysis(self)
