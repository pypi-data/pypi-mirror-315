...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CylindricalGearHarmonicAnalysis._Cast_CylindricalGearHarmonicAnalysis",
    )
...
class _Cast_CylindricalGearHarmonicAnalysis:
    ...
    __parent__: "CylindricalGearHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearHarmonicAnalysis(_5889.GearHarmonicAnalysis):
    """CylindricalGearHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CYLINDRICAL_GEAR_HARMONIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CylindricalGearHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CylindricalGearHarmonicAnalysis
        """
        return _Cast_CylindricalGearHarmonicAnalysis(self)
