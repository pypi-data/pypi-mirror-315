...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="TorqueConverterCompoundHarmonicAnalysis._Cast_TorqueConverterCompoundHarmonicAnalysis",
    )
...
class _Cast_TorqueConverterCompoundHarmonicAnalysis:
    ...
    __parent__: "TorqueConverterCompoundHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterCompoundHarmonicAnalysis(_6054.CouplingCompoundHarmonicAnalysis):
    """TorqueConverterCompoundHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _TORQUE_CONVERTER_COMPOUND_HARMONIC_ANALYSIS
    ...
    @property
    def component_design(self: "Self") -> "_2674.TorqueConverter":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_TorqueConverterCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_TorqueConverterCompoundHarmonicAnalysis
        """
        return _Cast_TorqueConverterCompoundHarmonicAnalysis(self)
