...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PlanetCarrierHarmonicAnalysis._Cast_PlanetCarrierHarmonicAnalysis",
    )
...
class _Cast_PlanetCarrierHarmonicAnalysis:
    ...
    __parent__: "PlanetCarrierHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierHarmonicAnalysis(_5924.MountableComponentHarmonicAnalysis):
    """PlanetCarrierHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _PLANET_CARRIER_HARMONIC_ANALYSIS
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PlanetCarrierHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_PlanetCarrierHarmonicAnalysis
        """
        return _Cast_PlanetCarrierHarmonicAnalysis(self)
