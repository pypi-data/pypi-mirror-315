...
class ShaftHarmonicAnalysis(
    _5816.AbstractShaftHarmonicAnalysis, _2745.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4798.ShaftModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_5904.HarmonicAnalysisShaftExportOptions":
