...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def combined_orders(self: "Self") -> "_6006.ResultsForMultipleOrdersForGroups":
    ...
    def excitations(
        self: "Self",
    ) -> "List[_6015.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: "Self",
    ) -> "List[_6008.ResultsForOrderIncludingGroups]":
