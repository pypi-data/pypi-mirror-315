...
if TYPE_CHECKING:
    ...
    Self = TypeVar(
        "Self", bound="HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic"
    )
    CastSelf = TypeVar(
        "CastSelf",
        bound="HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic._Cast_HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic",
    )
...
class _Cast_HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic:
    ...
    __parent__: "HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic"
...
class HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = (
        _HARMONIC_ANALYSIS_RESULTS_BROKEN_DOWN_BY_GROUPS_WITHIN_A_HARMONIC
    )
    ...
    def locations_global_coordinate_system(
        self: "Self",
    ) -> "List[_6000.HarmonicAnalysisResultsBrokenDownByLocationWithinAHarmonic]":
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "LocationsGlobalCoordinateSystem")
    ...
    def locations_local_coordinate_system(
        ...
        Note:
            This property is readonly.
        """
        temp = pythonnet_property_get(self.wrapped, "LocationsLocalCoordinateSystem")
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic":
        """Cast to another type.

        Returns:
            _Cast_HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic
        """
        return _Cast_HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic(self)
