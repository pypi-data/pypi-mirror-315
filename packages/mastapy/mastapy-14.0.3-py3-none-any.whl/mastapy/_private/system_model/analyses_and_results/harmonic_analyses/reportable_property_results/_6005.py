...
class _Cast_ResultsForMultipleOrdersForFESurface:
    ...
    def results_for_multiple_orders(
        self: "CastSelf",
    ) -> "_6004.ResultsForMultipleOrders":
        return self.__parent__._cast(_6004.ResultsForMultipleOrders)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultsForMultipleOrdersForFESurface(_6004.ResultsForMultipleOrders):
    """ResultsForMultipleOrdersForFESurface
