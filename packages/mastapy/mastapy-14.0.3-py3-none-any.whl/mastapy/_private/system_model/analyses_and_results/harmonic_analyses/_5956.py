...
class StiffnessOptionsForHarmonicAnalysis(
    _7710.AbstractAnalysisOptions[_6957.StaticLoadCase]
):
    """StiffnessOptionsForHarmonicAnalysis
    ...
    @property
    def curve_with_stiffness_steps(self: "Self") -> "_1922.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def torque_input_type(
        self: "Self", value: "_5905.HarmonicAnalysisTorqueInputType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def torque_speed_curve(self: "Self") -> "_1585.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def torque_speed_curve(self: "Self", value: "_1585.Vector2DListAccessor") -> None:
