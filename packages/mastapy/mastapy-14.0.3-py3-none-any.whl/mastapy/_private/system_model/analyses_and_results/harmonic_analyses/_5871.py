...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ElectricMachineRotorXMomentPeriodicExcitationDetail._Cast_ElectricMachineRotorXMomentPeriodicExcitationDetail",
    )
...
class _Cast_ElectricMachineRotorXMomentPeriodicExcitationDetail:
    ...
    __parent__: "ElectricMachineRotorXMomentPeriodicExcitationDetail"
...
class ElectricMachineRotorXMomentPeriodicExcitationDetail(
    ...
    TYPE: ClassVar["Type"] = _ELECTRIC_MACHINE_ROTOR_X_MOMENT_PERIODIC_EXCITATION_DETAIL
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ElectricMachineRotorXMomentPeriodicExcitationDetail":
        """Cast to another type.

        Returns:
            _Cast_ElectricMachineRotorXMomentPeriodicExcitationDetail
        """
        return _Cast_ElectricMachineRotorXMomentPeriodicExcitationDetail(self)
