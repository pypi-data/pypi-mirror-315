...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5822
...
class RootAssemblyHarmonicAnalysis(
    _5822.AssemblyHarmonicAnalysis, _2744.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self: "Self") -> "_5903.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: "Self") -> "_5897.HarmonicAnalysis":
    ...
    def results(
        self: "Self",
    ) -> "_6014.RootAssemblyHarmonicAnalysisResultsPropertyAccessor":
