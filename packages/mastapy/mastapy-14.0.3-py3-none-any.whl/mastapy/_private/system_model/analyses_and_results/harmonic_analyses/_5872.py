...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ElectricMachineRotorYForcePeriodicExcitationDetail._Cast_ElectricMachineRotorYForcePeriodicExcitationDetail",
    )
...
class _Cast_ElectricMachineRotorYForcePeriodicExcitationDetail:
    ...
    __parent__: "ElectricMachineRotorYForcePeriodicExcitationDetail"
...
class ElectricMachineRotorYForcePeriodicExcitationDetail(
    ...
    TYPE: ClassVar["Type"] = _ELECTRIC_MACHINE_ROTOR_Y_FORCE_PERIODIC_EXCITATION_DETAIL
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_ElectricMachineRotorYForcePeriodicExcitationDetail":
        """Cast to another type.

        Returns:
            _Cast_ElectricMachineRotorYForcePeriodicExcitationDetail
        """
        return _Cast_ElectricMachineRotorYForcePeriodicExcitationDetail(self)
