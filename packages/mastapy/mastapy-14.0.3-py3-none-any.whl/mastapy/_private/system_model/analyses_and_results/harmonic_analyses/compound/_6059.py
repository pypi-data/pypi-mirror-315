...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CVTPulleyCompoundHarmonicAnalysis._Cast_CVTPulleyCompoundHarmonicAnalysis",
    )
...
class _Cast_CVTPulleyCompoundHarmonicAnalysis:
    ...
    __parent__: "CVTPulleyCompoundHarmonicAnalysis"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CVTPulleyCompoundHarmonicAnalysis(_6107.PulleyCompoundHarmonicAnalysis):
    """CVTPulleyCompoundHarmonicAnalysis

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _CVT_PULLEY_COMPOUND_HARMONIC_ANALYSIS
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5858.CVTPulleyHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_CVTPulleyCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CVTPulleyCompoundHarmonicAnalysis
        """
        return _Cast_CVTPulleyCompoundHarmonicAnalysis(self)
