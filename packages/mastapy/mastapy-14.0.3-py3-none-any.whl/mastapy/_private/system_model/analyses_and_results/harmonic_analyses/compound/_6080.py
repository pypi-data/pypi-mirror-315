...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearMeshCompoundHarmonicAnalysis._Cast_HypoidGearMeshCompoundHarmonicAnalysis",
    )
...
class _Cast_HypoidGearMeshCompoundHarmonicAnalysis:
    ...
    __parent__: "HypoidGearMeshCompoundHarmonicAnalysis"
...
class HypoidGearMeshCompoundHarmonicAnalysis(
    ...
    TYPE: ClassVar["Type"] = _HYPOID_GEAR_MESH_COMPOUND_HARMONIC_ANALYSIS
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5908.HypoidGearMeshHarmonicAnalysis]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearMeshCompoundHarmonicAnalysis":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearMeshCompoundHarmonicAnalysis
        """
        return _Cast_HypoidGearMeshCompoundHarmonicAnalysis(self)
