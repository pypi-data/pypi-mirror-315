...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    def results_for_all_gear_sets(
        self: "Self",
    ) -> "_4464.DutyCycleResultsForAllGearSets":
    ...
    def results_for_root_assembly(
        self: "Self",
    ) -> "_4465.DutyCycleResultsForRootAssembly":
    ...
    def results_for_all_bearings(
        self: "Self",
    ) -> "List[_4466.DutyCycleResultsForSingleBearing]":
    ...
    def results_for_all_shafts(
        self: "Self",
    ) -> "List[_4467.DutyCycleResultsForSingleShaft]":
