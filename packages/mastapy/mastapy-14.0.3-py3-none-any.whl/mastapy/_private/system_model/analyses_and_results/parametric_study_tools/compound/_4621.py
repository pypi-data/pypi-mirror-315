...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearMeshCompoundParametricStudyTool._Cast_HypoidGearMeshCompoundParametricStudyTool",
    )
...
class _Cast_HypoidGearMeshCompoundParametricStudyTool:
    ...
    __parent__: "HypoidGearMeshCompoundParametricStudyTool"
...
class HypoidGearMeshCompoundParametricStudyTool(
    ...
    TYPE: ClassVar["Type"] = _HYPOID_GEAR_MESH_COMPOUND_PARAMETRIC_STUDY_TOOL
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearMeshCompoundParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearMeshCompoundParametricStudyTool
        """
        return _Cast_HypoidGearMeshCompoundParametricStudyTool(self)
