...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="PowerLoadParametricStudyTool._Cast_PowerLoadParametricStudyTool",
    )
...
class _Cast_PowerLoadParametricStudyTool:
    ...
    __parent__: "PowerLoadParametricStudyTool"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadParametricStudyTool(_4551.VirtualComponentParametricStudyTool):
    """PowerLoadParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _POWER_LOAD_PARAMETRIC_STUDY_TOOL
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2883.PowerLoadSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PowerLoadParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_PowerLoadParametricStudyTool
        """
        return _Cast_PowerLoadParametricStudyTool(self)
