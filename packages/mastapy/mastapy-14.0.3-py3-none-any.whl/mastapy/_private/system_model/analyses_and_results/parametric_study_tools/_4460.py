...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="DatumParametricStudyTool._Cast_DatumParametricStudyTool"
    )
...
class _Cast_DatumParametricStudyTool:
    ...
    __parent__: "DatumParametricStudyTool"
    ...
    @property
    def datum_parametric_study_tool(self: "CastSelf") -> "DatumParametricStudyTool":
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumParametricStudyTool(_4434.ComponentParametricStudyTool):
    """DatumParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _DATUM_PARAMETRIC_STUDY_TOOL
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2840.DatumSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_DatumParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_DatumParametricStudyTool
        """
        return _Cast_DatumParametricStudyTool(self)
