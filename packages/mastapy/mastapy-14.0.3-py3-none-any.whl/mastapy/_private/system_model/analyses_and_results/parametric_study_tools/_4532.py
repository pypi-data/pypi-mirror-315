...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="SpringDamperHalfParametricStudyTool._Cast_SpringDamperHalfParametricStudyTool",
    )
...
class _Cast_SpringDamperHalfParametricStudyTool:
    ...
    __parent__: "SpringDamperHalfParametricStudyTool"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperHalfParametricStudyTool(_4447.CouplingHalfParametricStudyTool):
    """SpringDamperHalfParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _SPRING_DAMPER_HALF_PARAMETRIC_STUDY_TOOL
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2902.SpringDamperHalfSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_SpringDamperHalfParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_SpringDamperHalfParametricStudyTool
        """
        return _Cast_SpringDamperHalfParametricStudyTool(self)
