...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="HypoidGearParametricStudyTool._Cast_HypoidGearParametricStudyTool",
    )
...
class _Cast_HypoidGearParametricStudyTool:
    ...
    __parent__: "HypoidGearParametricStudyTool"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HypoidGearParametricStudyTool(_4414.AGMAGleasonConicalGearParametricStudyTool):
    """HypoidGearParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _HYPOID_GEAR_PARAMETRIC_STUDY_TOOL
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2854.HypoidGearSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_HypoidGearParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_HypoidGearParametricStudyTool
        """
        return _Cast_HypoidGearParametricStudyTool(self)
