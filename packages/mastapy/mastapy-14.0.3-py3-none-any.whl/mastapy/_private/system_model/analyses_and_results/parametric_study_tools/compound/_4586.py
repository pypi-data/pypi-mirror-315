...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="ConceptCouplingHalfCompoundParametricStudyTool._Cast_ConceptCouplingHalfCompoundParametricStudyTool",
    )
...
class _Cast_ConceptCouplingHalfCompoundParametricStudyTool:
    ...
    __parent__: "ConceptCouplingHalfCompoundParametricStudyTool"
...
class ConceptCouplingHalfCompoundParametricStudyTool(
    ...
    TYPE: ClassVar["Type"] = _CONCEPT_COUPLING_HALF_COMPOUND_PARAMETRIC_STUDY_TOOL
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4436.ConceptCouplingHalfParametricStudyTool]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_ConceptCouplingHalfCompoundParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_ConceptCouplingHalfCompoundParametricStudyTool
        """
        return _Cast_ConceptCouplingHalfCompoundParametricStudyTool(self)
