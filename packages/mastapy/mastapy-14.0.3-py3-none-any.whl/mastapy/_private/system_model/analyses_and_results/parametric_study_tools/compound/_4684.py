...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="WormGearMeshCompoundParametricStudyTool._Cast_WormGearMeshCompoundParametricStudyTool",
    )
...
class _Cast_WormGearMeshCompoundParametricStudyTool:
    ...
    __parent__: "WormGearMeshCompoundParametricStudyTool"
...
class WormGearMeshCompoundParametricStudyTool(
    ...
    TYPE: ClassVar["Type"] = _WORM_GEAR_MESH_COMPOUND_PARAMETRIC_STUDY_TOOL
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_WormGearMeshCompoundParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_WormGearMeshCompoundParametricStudyTool
        """
        return _Cast_WormGearMeshCompoundParametricStudyTool(self)
