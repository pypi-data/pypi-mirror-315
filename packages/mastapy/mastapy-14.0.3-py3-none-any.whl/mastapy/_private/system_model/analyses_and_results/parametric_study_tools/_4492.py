...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="MeasurementComponentParametricStudyTool._Cast_MeasurementComponentParametricStudyTool",
    )
...
class _Cast_MeasurementComponentParametricStudyTool:
    ...
    __parent__: "MeasurementComponentParametricStudyTool"
...
class MeasurementComponentParametricStudyTool(
    ...
    TYPE: ClassVar["Type"] = _MEASUREMENT_COMPONENT_PARAMETRIC_STUDY_TOOL
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2869.MeasurementComponentSystemDeflection]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_MeasurementComponentParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_MeasurementComponentParametricStudyTool
        """
        return _Cast_MeasurementComponentParametricStudyTool(self)
