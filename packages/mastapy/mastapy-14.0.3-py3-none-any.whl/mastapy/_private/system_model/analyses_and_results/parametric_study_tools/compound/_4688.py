...
class ZerolBevelGearSetCompoundParametricStudyTool(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4557.ZerolBevelGearSetParametricStudyTool]":
    ...
    def zerol_bevel_gears_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4686.ZerolBevelGearCompoundParametricStudyTool]":
    ...
    def zerol_bevel_meshes_compound_parametric_study_tool(
        self: "Self",
    ) -> "List[_4687.ZerolBevelGearMeshCompoundParametricStudyTool]":
