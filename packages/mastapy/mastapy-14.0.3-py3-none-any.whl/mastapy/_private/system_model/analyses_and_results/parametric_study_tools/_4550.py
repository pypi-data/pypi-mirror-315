...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="UnbalancedMassParametricStudyTool._Cast_UnbalancedMassParametricStudyTool",
    )
...
class _Cast_UnbalancedMassParametricStudyTool:
    ...
    __parent__: "UnbalancedMassParametricStudyTool"
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UnbalancedMassParametricStudyTool(_4551.VirtualComponentParametricStudyTool):
    """UnbalancedMassParametricStudyTool

    This is a mastapy class.
    """

    TYPE: ClassVar["Type"] = _UNBALANCED_MASS_PARAMETRIC_STUDY_TOOL
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_UnbalancedMassParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_UnbalancedMassParametricStudyTool
        """
        return _Cast_UnbalancedMassParametricStudyTool(self)
