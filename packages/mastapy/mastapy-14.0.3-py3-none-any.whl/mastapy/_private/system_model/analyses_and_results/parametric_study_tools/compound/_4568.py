...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="BeltDriveCompoundParametricStudyTool._Cast_BeltDriveCompoundParametricStudyTool",
    )
...
class _Cast_BeltDriveCompoundParametricStudyTool:
    ...
    __parent__: "BeltDriveCompoundParametricStudyTool"
...
class BeltDriveCompoundParametricStudyTool(
    ...
    TYPE: ClassVar["Type"] = _BELT_DRIVE_COMPOUND_PARAMETRIC_STUDY_TOOL
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_6974.BeltDriveLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4419.BeltDriveParametricStudyTool]":
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_BeltDriveCompoundParametricStudyTool":
        """Cast to another type.

        Returns:
            _Cast_BeltDriveCompoundParametricStudyTool
        """
        return _Cast_BeltDriveCompoundParametricStudyTool(self)
