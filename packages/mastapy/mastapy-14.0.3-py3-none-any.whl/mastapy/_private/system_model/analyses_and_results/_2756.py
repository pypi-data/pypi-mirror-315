...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf",
        bound="CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis._Cast_CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis",
    )
...
class _Cast_CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis:
    ...
    __parent__: "CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis"
...
class CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis(
    ...
    def cast_to(
        self: "Self",
    ) -> "_Cast_CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis":
        """Cast to another type.

        Returns:
            _Cast_CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis
        """
        return _Cast_CompoundDynamicModelForSteadyStateSynchronousResponseAnalysis(self)
