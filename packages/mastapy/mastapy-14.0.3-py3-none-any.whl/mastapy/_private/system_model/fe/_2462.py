...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="PerLinkExportOptions._Cast_PerLinkExportOptions"
    )
...
class _Cast_PerLinkExportOptions:
    ...
    __parent__: "PerLinkExportOptions"

    @property
    def per_link_export_options(self: "CastSelf") -> "PerLinkExportOptions":
...
class PerLinkExportOptions(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _PER_LINK_EXPORT_OPTIONS
    ...
    def type_of_coupling_to_export(
        ...
        temp = pythonnet_property_get(self.wrapped, "TypeOfCouplingToExport")
    ...
    def type_of_coupling_to_export(
        ...
        pythonnet_property_set(self.wrapped, "TypeOfCouplingToExport", value)
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PerLinkExportOptions":
        """Cast to another type.

        Returns:
            _Cast_PerLinkExportOptions
        """
        return _Cast_PerLinkExportOptions(self)
