...
from mastapy._private.system_model.fe import _2428
...
class _Cast_DegreeOfFreedomBoundaryConditionAngular:
    ...
    def degree_of_freedom_boundary_condition(
        self: "CastSelf",
    ) -> "_2428.DegreeOfFreedomBoundaryCondition":
        return self.__parent__._cast(_2428.DegreeOfFreedomBoundaryCondition)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DegreeOfFreedomBoundaryConditionAngular(_2428.DegreeOfFreedomBoundaryCondition):
    """DegreeOfFreedomBoundaryConditionAngular
