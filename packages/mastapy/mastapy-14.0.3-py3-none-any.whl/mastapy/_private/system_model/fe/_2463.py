...
from mastapy._private.nodal_analysis.fe_export_utility import _173
...
if TYPE_CHECKING:
    ...
    CastSelf = TypeVar(
        "CastSelf", bound="PerNodeExportOptions._Cast_PerNodeExportOptions"
    )
...
class _Cast_PerNodeExportOptions:
    ...
    __parent__: "PerNodeExportOptions"

    @property
    def per_node_export_options(self: "CastSelf") -> "PerNodeExportOptions":
...
class PerNodeExportOptions(_0.APIBase):
    ...
    TYPE: ClassVar["Type"] = _PER_NODE_EXPORT_OPTIONS
    ...
    @property
    def external_id(self: "Self") -> "overridable.Overridable_int":
        """Overridable[int]"""
    ...
    def external_id(self: "Self", value: "Union[int, Tuple[int, bool]]") -> None:
        ...
        pythonnet_property_set(self.wrapped, "ExternalID", value)
    ...
    def type_of_result_to_export(
        self: "Self",
        value: "Union[_173.BoundaryConditionType, Tuple[_173.BoundaryConditionType, bool]]",
    ) -> None:
    ...
    @property
    def cast_to(self: "Self") -> "_Cast_PerNodeExportOptions":
        """Cast to another type.

        Returns:
            _Cast_PerNodeExportOptions
        """
        return _Cast_PerNodeExportOptions(self)
