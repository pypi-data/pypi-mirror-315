...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearMesh(_2370.GearMesh):
    """WormGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_984.WormGearMeshDesign":
    ...
    @property
    def worm_gear_mesh_design(self: "Self") -> "_984.WormGearMeshDesign":
        """mastapy.gears.gear_designs.worm.WormGearMeshDesign
