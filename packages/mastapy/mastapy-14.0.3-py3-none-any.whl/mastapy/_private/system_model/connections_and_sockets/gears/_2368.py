...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearMesh(_2370.GearMesh):
    """FaceGearMesh
    ...
    @property
    def active_gear_mesh_design(self: "Self") -> "_1017.FaceGearMeshDesign":
    ...
    @property
    def face_gear_mesh_design(self: "Self") -> "_1017.FaceGearMeshDesign":
        """mastapy.gears.gear_designs.face.FaceGearMeshDesign
