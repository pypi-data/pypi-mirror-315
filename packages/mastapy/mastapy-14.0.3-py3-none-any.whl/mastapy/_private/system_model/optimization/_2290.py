...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2284, _2287, _2289
...
class _Cast_OptimizationStep:
    ...
    def conical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2284.ConicalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2284

        return self.__parent__._cast(_2284.ConicalGearOptimizationStep)

    @property
    def cylindrical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2287.CylindricalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2287

        return self.__parent__._cast(_2287.CylindricalGearOptimizationStep)
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self: "Self") -> "_2289.MicroGeometryOptimisationTarget":
    ...
    def optimisation_target(
        self: "Self", value: "_2289.MicroGeometryOptimisationTarget"
    ) -> None:
