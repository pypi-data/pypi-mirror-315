...
class _Cast_RollingBearingElementLoadCase:
    ...
    @property
    def rolling_bearing_element(self: "CastSelf") -> "_2222.RollingBearingElement":
        return self.__parent__._cast(_2222.RollingBearingElement)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingBearingElementLoadCase(_2222.RollingBearingElement):
    """RollingBearingElementLoadCase
