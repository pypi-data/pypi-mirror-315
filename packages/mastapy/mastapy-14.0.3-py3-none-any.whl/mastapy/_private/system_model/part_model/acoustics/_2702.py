...
from mastapy._private.system_model.part_model.acoustics import _2705
...
class _Cast_ResultPlaneOptions:
    ...
    @property
    def result_surface_options(self: "CastSelf") -> "_2705.ResultSurfaceOptions":
        return self.__parent__._cast(_2705.ResultSurfaceOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultPlaneOptions(_2705.ResultSurfaceOptions):
    """ResultPlaneOptions
    ...
    @property
    def axis_for_plane_normal(self: "Self") -> "_1542.Axis":
    ...
    def axis_for_plane_normal(self: "Self", value: "_1542.Axis") -> None:
