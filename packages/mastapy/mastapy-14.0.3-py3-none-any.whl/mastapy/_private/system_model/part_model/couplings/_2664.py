...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.stiffness_calculators import _1587
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self: "Self") -> "_1587.IndividualContactPosition":
    ...
    @property
    def microgeometry_clearance_chart(self: "Self") -> "_1922.TwoDChartDefinition":
    ...
    @property
    def crowning(self: "Self") -> "_2648.CrowningSpecification":
