...
from mastapy._private.gears import _334
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2586, _2603
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSet(_2593.GearSet):
    """CylindricalGearSet
    ...
    def axial_contact_ratio_requirement(
        self: "Self",
        value: "Union[_334.ContactRatioRequirements, Tuple[_334.ContactRatioRequirements, bool]]",
    ) -> None:
    ...
    @property
    def active_gear_set_design(self: "Self") -> "_1060.CylindricalGearSetDesign":
    ...
    @property
    def cylindrical_gear_set_design(self: "Self") -> "_1060.CylindricalGearSetDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign
    ...
    @property
    def supercharger_rotor_set(self: "Self") -> "_2624.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_gears(self: "Self") -> "List[_2586.CylindricalGear]":
    ...
    @property
    def cylindrical_meshes(self: "Self") -> "List[_2366.CylindricalGearMesh]":
    ...
    @property
    def gear_set_designs(self: "Self") -> "List[_1060.CylindricalGearSetDesign]":
    ...
    def add_gear(self: "Self") -> "_2586.CylindricalGear":
