...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelGearSet(_2581.BevelGearSet):
    """StraightBevelGearSet
    ...
    @property
    def conical_gear_set_design(self: "Self") -> "_989.StraightBevelGearSetDesign":
    ...
    @property
    def straight_bevel_gears(self: "Self") -> "List[_2608.StraightBevelGear]":
    ...
    @property
    def straight_bevel_meshes(self: "Self") -> "List[_2384.StraightBevelGearMesh]":
