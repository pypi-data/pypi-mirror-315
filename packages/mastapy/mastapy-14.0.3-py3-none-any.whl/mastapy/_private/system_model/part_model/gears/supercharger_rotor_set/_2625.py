...
from mastapy._private.system_model.part_model.gears.supercharger_rotor_set import _2624
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SuperchargerRotorSetDatabase(_1883.NamedDatabase[_2624.SuperchargerRotorSet]):
    """SuperchargerRotorSetDatabase
