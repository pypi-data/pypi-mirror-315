...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.configurations import _2685
...
class _Cast_ActiveCylindricalGearSetDesignSelection:
    ...
    @property
    def part_detail_selection(self: "CastSelf") -> "_2685.PartDetailSelection":
        pass

        from mastapy._private.system_model.part_model.configurations import _2685

        return self.__parent__._cast(_2685.PartDetailSelection)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ActiveCylindricalGearSetDesignSelection(_2572.ActiveGearSetDesignSelection):
    """ActiveCylindricalGearSetDesignSelection
