...
from mastapy._private.system_model.part_model import _2493, _2513
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class Shaft(_2493.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: "Self", value: "_2513.GuideDxfModel") -> None:
        wrapper_type = (
    ...
    @property
    def guide_image(self: "Self") -> "_2514.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: "Self") -> "_2441.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: "Self", component: "_2524.MountableComponent", offset: "float"
    ) -> None:
        """Method does not return.
