...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1512, _1513
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RingPins(_2524.MountableComponent):
    """RingPins
    ...
    @property
    def ring_pins_design(self: "Self") -> "_1512.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: "Self") -> "_1513.RingPinsMaterial":
