...
if __tc:
    ...
    from mastapy._private.shafts._31 import ShaftProfilePoint
    from mastapy._private.shafts._32 import ShaftProfilePointCopy
    from mastapy._private.shafts._33 import ShaftRadialHole
    from mastapy._private.shafts._34 import ShaftRatingMethod
    from mastapy._private.shafts._35 import ShaftSafetyFactorSettings
    from mastapy._private.shafts._36 import ShaftSectionDamageResults
    from mastapy._private.shafts._37 import ShaftSectionEndDamageResults
    from mastapy._private.shafts._38 import ShaftSettings
    from mastapy._private.shafts._39 import ShaftSettingsDatabase
    from mastapy._private.shafts._40 import ShaftSettingsItem
    from mastapy._private.shafts._41 import ShaftSurfaceFinishSection
    from mastapy._private.shafts._42 import ShaftSurfaceRoughness
    from mastapy._private.shafts._43 import SimpleShaftDefinition
    from mastapy._private.shafts._44 import (
        StressMeasurementShaftAxialBendingTorsionalComponentValues,
    )
    from mastapy._private.shafts._45 import SurfaceFinishes
else:
    import sys as __sys
    ...
    __import_structure = {
        ...
        "_private.shafts._31": ["ShaftProfilePoint"],
        "_private.shafts._32": ["ShaftProfilePointCopy"],
        "_private.shafts._33": ["ShaftRadialHole"],
        "_private.shafts._34": ["ShaftRatingMethod"],
        "_private.shafts._35": ["ShaftSafetyFactorSettings"],
        "_private.shafts._36": ["ShaftSectionDamageResults"],
        "_private.shafts._37": ["ShaftSectionEndDamageResults"],
        "_private.shafts._38": ["ShaftSettings"],
        "_private.shafts._39": ["ShaftSettingsDatabase"],
        "_private.shafts._40": ["ShaftSettingsItem"],
        "_private.shafts._41": ["ShaftSurfaceFinishSection"],
        "_private.shafts._42": ["ShaftSurfaceRoughness"],
        "_private.shafts._43": ["SimpleShaftDefinition"],
        "_private.shafts._44": [
            "StressMeasurementShaftAxialBendingTorsionalComponentValues"
        ],
        "_private.shafts._45": ["SurfaceFinishes"],
    }
