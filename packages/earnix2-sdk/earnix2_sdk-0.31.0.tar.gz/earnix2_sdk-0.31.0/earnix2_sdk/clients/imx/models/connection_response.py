...
if TYPE_CHECKING:
    from earnix2_sdk.clients.imx.models.s3_connection_response import (
    ...
    def from_dict(
        ...
        if object_type == "S3ConnectionResponse":
            return import_module(
                "earnix2_sdk.clients.imx.models.s3_connection_response"
            ).S3ConnectionResponse.from_dict(obj)
        if object_type == "SnowflakeConnectionResponse":
            return import_module(
                "earnix2_sdk.clients.imx.models.snowflake_connection_response"
