...
class ConnectionServiceApi:
    ...
    def browse_bucket_data_source(
        ...
        _param = self._browse_bucket_data_source_serialize(
            connection_id=connection_id,
            browse_bucket_data_source_request=browse_bucket_data_source_request,
    ...
    def browse_bucket_data_source_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BrowseBucketDataSourceResponse]:
        """browse_bucket_data_source
    ...
    @validate_call
    def browse_bucket_data_source_without_preload_content(
        self,
        connection_id: Annotated[StrictInt, Field(description="The connection id.")],
        browse_bucket_data_source_request: Annotated[
            BrowseBucketDataSourceRequest,
    ...
    def _browse_bucket_data_source_serialize(
        self,
        connection_id,
        ...
        if browse_bucket_data_source_request is not None:
            _body_params = browse_bucket_data_source_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/connections/{connection-id}/browse-bucket-data-source",
    ...
    def test_connection_by_id(
        ...
        _param = self._test_connection_by_id_serialize(
            connection_id=connection_id,
            test_updated_connection_request=test_updated_connection_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    def _test_connection_by_id_serialize(
        self,
        connection_id,
        test_updated_connection_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if test_updated_connection_request is not None:
            _body_params = test_updated_connection_request
    ...
    def test_rdbms_data_source(
        ...
        _param = self._test_rdbms_data_source_serialize(
            connection_id=connection_id,
            test_rdbms_data_source_request=test_rdbms_data_source_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def test_rdbms_data_source_without_preload_content(
        self,
        connection_id: Annotated[StrictInt, Field(description="The connection id.")],
        test_rdbms_data_source_request: Annotated[
            TestRDBMSDataSourceRequest,
    ...
    def _test_rdbms_data_source_serialize(
        self,
        connection_id,
        test_rdbms_data_source_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if test_rdbms_data_source_request is not None:
            _body_params = test_rdbms_data_source_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/connections/{connection-id}/test-rdbms-data-source",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
