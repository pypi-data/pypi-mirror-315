/*! `macaulay2` grammar compiled for Highlight.js 11.10.0 */
...
keywords:{
keyword:["SPACE","TEST","and","break","catch","continue","do","elapsedTime","elapsedTiming","else","for","from","global","if","in","list","local","new","not","of","or","return","shield","step","symbol","then","threadLocal","threadVariable","throw","time","timing","to","try","when","while","xor"],
