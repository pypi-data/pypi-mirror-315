        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=255, verbose_name="Supplier name"
                    ),
                ),
                (
                    "short_name",
                    models.CharField(
                        max_length=255, verbose_name="Short name"
                    ),
                ),
                (
                    "code",
                ...
                (
                    "currency",
                    exchange.models.CurrencyField(
                        choices=[(980, "UAH"), (840, "USD"), (978, "EUR")],
                ...
                (
                    ...
                    ckeditor.fields.RichTextField(
                        blank=True, verbose_name="Delivery info"
                    ),
                ),
                (
                    "email",
                ...
                (
                    "markup",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Mark-up, %"
                    ),
                ),
                (
                    "price_updated",
                    models.DateTimeField(
                        ...
                        editable=False,
                        null=True,
                        verbose_name="Price updated date",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        verbose_name="Is visible for unregistered users",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=255, verbose_name="Warehouse name"
                    ),
                ),
                (
                    "short_name",
