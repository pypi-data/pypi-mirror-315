...
import questionary
from .utils import ask_for_quit_confirmation, get_short_git_commit_hash
import click
...
class Chat:
    ...
    async def process_chat_subscription(
        self, extra_vars: dict[str, Any], reset_pending_event: bool = True
    ) -> None:
        vars = {
