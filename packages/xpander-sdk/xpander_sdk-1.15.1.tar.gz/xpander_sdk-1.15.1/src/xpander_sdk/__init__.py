...
class Agent(Base, metaclass=jsii.JSIIMeta, jsii_type="xpander-sdk.Agent"):
    ...
    def __init__(
        ...
        jsii.create(self.__class__, self, [configuration, id, organization_id, status, name, source_nodes, pg_switch_allowed, tools, graphs, pg_oas, auto_load, pg_schemas, pg_node_description_override])
