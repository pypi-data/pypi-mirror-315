...
def _create_orm_execution_environment():
    ...
    if gpu_count:
        try:
            gpu_type = pynvml.nvmlDeviceGetName(pynvml.nvmlDeviceGetHandleByIndex(0)).decode("utf8")
        except AttributeError:
            gpu_type = pynvml.nvmlDeviceGetName(pynvml.nvmlDeviceGetHandleByIndex(0))
...
def create_local_experiment(message: str = None, hyperparameters: dict = None, **kwargs):
