...
class ResponseMyUser(object):
    ...
    def __init__(self, created_dt=None, default_organization=None, display_name=None, email=None, git_ssh_key_name=None, has_password=None, id=None, is_email_verified=None, is_pending=None, is_superuser=None, last_login=None, marketing_consent_dt=None, notification_config=None, organizations=None, updated_dt=None, username=None, local_vars_configuration=None):  # noqa: E501
