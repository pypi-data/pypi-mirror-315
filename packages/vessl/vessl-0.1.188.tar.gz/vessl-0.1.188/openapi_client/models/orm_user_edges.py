...
class OrmUserEdges(object):
    ...
    def __init__(self, access_tokens=None, cluster_quotas=None, coupon_redemptions=None, created_volume_v2s=None, credit_earn_histories=None, default_organization=None, experiments=None, judged_pipeline_step_executions=None, llm_api_keys=None, llm_documents=None, llm_knowledge=None, llm_knowledge_jobs=None, llm_model_connections=None, llm_model_parameter_definitions=None, llm_model_parameter_presets=None, llm_user_groups=None, llm_vectordb_connections=None, llm_workflow_revisions=None, llm_workflows=None, model_service_revisions=None, model_service_rollouts=None, model_services=None, models=None, owned_organizations=None, persistent_artifacts=None, pipelines=None, policies=None, project_dashboards=None, reset_password_tokens=None, run_executions=None, run_tracking_dashboards=None, starred_dashboards=None, subjects=None, triggered_pipeline_executions=None, user_groups=None, user_history_as_transferer=None, user_organization=None, user_starred_projects=None, withdraw_history_organizations=None, withdraw_history_workloads=None, workspaces=None, local_vars_configuration=None):  # noqa: E501
