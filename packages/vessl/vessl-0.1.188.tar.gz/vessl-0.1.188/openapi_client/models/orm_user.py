...
class OrmUser(object):
    ...
    def __init__(self, created_dt=None, default_organization_id=None, display_name=None, edges=None, email=None, encrypted_git_ssh_key=None, first_time_credit_given=None, git_ssh_key_name=None, id=None, immutable_slug=None, is_email_verified=None, is_pending=None, last_login=None, marketing_consent_dt=None, notification_config=None, status=None, updated_dt=None, username=None, local_vars_configuration=None):  # noqa: E501
