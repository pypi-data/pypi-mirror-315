...
class OrmOrganizationEdges(object):
    ...
    def __init__(self, artifacts=None, cluster_quotas=None, coupon_redemptions=None, credit_earn_histories=None, default_storage=None, default_volume=None, groups=None, kernel_clusters=None, llm_api_keys=None, llm_documents=None, llm_knowledge=None, llm_model_connections=None, llm_user_groups=None, llm_vectordb_connections=None, llm_workflows=None, model_services=None, organization_credential_provider=None, organization_credentials=None, organization_kernel_clusters=None, organization_policies=None, periodic_credit_events=None, pipeline_step_types=None, pipelines=None, price_overrides=None, pricing_plan=None, primary_owner=None, root_organization_policies=None, run_executions=None, run_specs=None, stripe_billing_history=None, subscriptions=None, unresolved_credits=None, user_organization=None, users_with_this_as_default_organization=None, wallets=None, withdraw_history_kernel_clusters=None, withdraw_history_organizations=None, workloads=None, workspaces=None, local_vars_configuration=None):  # noqa: E501
