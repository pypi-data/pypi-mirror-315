...
class OrmUserOrganization(object):
    ...
    def __init__(self, created_dt=None, edges=None, id=None, immutable_slug=None, joined_dt=None, permission=None, updated_dt=None, user_organization_organization=None, user_organization_user=None, local_vars_configuration=None):  # noqa: E501
