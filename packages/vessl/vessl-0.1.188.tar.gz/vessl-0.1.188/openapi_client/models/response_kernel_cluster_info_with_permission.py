...
class ResponseKernelClusterInfoWithPermission(object):
    ...
    def __init__(self, available_gpus=None, created_dt=None, current_system_metrics=None, docs_link=None, id=None, is_cluster_admin=None, is_custom_resource_spec_allowed=None, is_registered=None, is_savvihub_managed=None, is_vessl_managed=None, issues=None, kubernetes_namespace=None, kubernetes_service_type=None, latest_cluster_metrics=None, message=None, metric_source=None, name=None, nodes_summary=None, provider=None, region=None, status=None, updated_dt=None, workloads_summary=None, local_vars_configuration=None):  # noqa: E501
