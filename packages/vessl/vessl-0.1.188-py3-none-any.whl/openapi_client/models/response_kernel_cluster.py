...
class ResponseKernelCluster(object):
    ...
    def __init__(self, created_dt=None, id=None, is_custom_resource_spec_allowed=None, is_savvihub_managed=None, is_vessl_managed=None, kubernetes_service_type=None, metric_source=None, name=None, provider=None, region=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
