...
class OrmModelServiceGateway(object):
    ...
    def __init__(self, created_dt=None, edges=None, enabled=None, endpoint=None, generated_hostname=None, id=None, immutable_slug=None, ingress_config=None, last_error=None, model_service_id=None, status=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
