...
class ResponsePipelineStepRun(object):
    ...
    def __init__(self, form=None, produced_output_volumes=None, run_spec=None, variable_injects=None, volume_injects=None, local_vars_configuration=None):  # noqa: E501
