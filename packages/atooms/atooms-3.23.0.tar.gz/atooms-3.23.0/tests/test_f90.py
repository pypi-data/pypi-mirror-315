...
"""
    ...
    def test_cutoff(self):
        ...
        for cut in ["cut", "cut_shift", "cut_shift_linear",
                    ...
                    "cut_shift_quadratic", "cubic_spline"]:
    ...
    def test_potential_derivatives(self):
        ...
        self.assertTrue(_check('gaussian', [1.0, 1.0], 1.0))
        self.assertTrue(_check('harmonic', [1.0, 1.0], 1.0))
        self.assertTrue(_check('yukawa', [1.0, 1.0, 0.0], 1.0))
        self.assertTrue(_check('lennard_jones', [1.0, 1.0], 1.0))
        self.assertTrue(_check('inverse_power', [12, 1.0, 1.0], 1.0))
        self.assertTrue(_check('sum_inverse_power', [[12], [1.0], [1.0]], 1.0))
