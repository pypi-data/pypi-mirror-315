"""
:mod:"valve_setup" -- Quick setup script for Chemputer Valves
===================================

.. module:: valve_setup
   :platform: Windows
   :synopsis: Quick setup script for Chemputer Valves
.. moduleauthor:: Sebastian Steiner <s.steiner.1@research.gla.ac.uk>

This script is called once after programming a valve device. It will send the required network config via serial, then
send the default valve config via network and finally execute an auto configuration, followed by a move to position 3
and back to home to exercise the device and make sure everything is ok.
"""
...
from modules.pv_api.Chemputer_Device_API import initialise_udp_keepalive, ChemputerValve
...
network_cfg = construct_network_config(
    mac_address="01:{0}:B0:0B:5A:55".format(ip_ending),
...
v.write_default_valve_configuration()
