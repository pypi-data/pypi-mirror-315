...
from hein_analytical_control.ChemputerSoftware.platform_server.modules.pv_api.Chemputer_Device_API import \
    ChemputerDevice
from . import SpinsolveNMR,  HPLCController
...
class ChemputerIDEX(ChemputerDevice):
