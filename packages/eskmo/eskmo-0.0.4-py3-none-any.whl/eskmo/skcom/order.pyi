...
class OrderEventHandler(APIEventHandler):
    ...
    def afterCancelBySeqNo(self, data, ret) -> None: ...
    ...
    def afterSendOrderCall(self, startTime, fromPid, orderDict: dict, isSuccessCalled, status, callbackId, proxy: bool = False): ...
    ...
    @staticmethod
    def isIntraDayOrderSuccess(nCode, bstrMessage): ...
    @staticmethod
