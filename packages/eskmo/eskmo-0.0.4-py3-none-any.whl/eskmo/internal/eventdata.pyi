...
class MITOrderPlaceFailResult(ErrorsResult, PlaceResult): ...
class MITOrderPlaceSuccessResult(PlaceResult): ...
...
class OrderChangedResult(DictableResult):
    count: int
    order: OrderStatus

class MITOrderChangedResult(DictableResult):
    count: int
    order: MITOrderStatus
