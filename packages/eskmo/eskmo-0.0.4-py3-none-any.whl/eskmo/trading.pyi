...
from eskmo.symbol.oddlots import HANDLER_ODD_LOTS_INFO as HANDLER_ODD_LOTS_INFO, OddLotsInfoHandler as OddLotsInfoHandler
...
class TradingAPI(APIBase):
    ...
    def request(self, pid, api, account, tag, *args, **kwargs) -> None: ...
