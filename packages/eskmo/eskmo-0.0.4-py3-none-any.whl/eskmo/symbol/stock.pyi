...
from eskmo.base.types import EVENT_HANDLER_ORDER as EVENT_HANDLER_ORDER
from eskmo.const import event as event
...
from eskmo.utils.misc import getDictFromSKCOMStream as getDictFromSKCOMStream, threadStart as threadStart, toDollar as toDollar
from eskmo.utils.tick import BaseTickCategoryRule as BaseTickCategoryRule, TickType as TickType

HANDLER_STOCK_INFO: str
RUNNER_TAG_STOCK: int
QUOTE_ZERO_VERFIED_TIMES: int
MAX_QUOTE_RESUBSCRIBE_TIMES: int
E_PNL_NOTIFY_MAPS: Incomplete

class StockInfoHandler(Extension):
    symbolInfoClass: Incomplete
    stockDict: Incomplete
    pendingStockDict: Incomplete
    stockIdxDict: Incomplete
    subscribeDict: Incomplete
    stockList: Incomplete
    page: Incomplete
    trigger: Incomplete
    subscribeLock: Incomplete
    createEmptyStockInfoLock: Incomplete
    getPendingStockLock: Incomplete
    tagDict: Incomplete
    suffixSymbol: str
    ...
    def requestCurrentSymbols(self, pid, apiName, account, tag, data, *args, **kwargs) -> None: ...
    def addSymbolIdx(self, nStockIdx, bstrMarketNo, symbolCode) -> None: ...
    def getPendingSymbolInfo(self, symbolCode): ...
    def requestSymbols(self): ...
    def onNewReply(self, reply) -> None: ...
    def onNewStrategyReply(self, reply) -> None: ...
    def onNewMITReply(self, reply) -> None: ...
    def onNewOCOReply(self, reply) -> None: ...
    def onNewFastOCOReply(self, reply) -> None: ...
    def initAvgCostSuccess(self, bstrList) -> None: ...

class StockInfo(SubscribableInfo):
    api: Incomplete
    handler: Incomplete
    ...
    def updatePnL(self, pnl: dict, pnlType: int, formatType: int): ...
    def triggerPnLUpdated(self, pnl: dict, pnlType: int, formatType: int): ...
    def publishToWaitingList(self, waitingList, event, data) -> None: ...
    def getIndexedData(self): ...
    def getStockInfo(self) -> None: ...
    ...
    def addAndPublishFirst(self, tag, pid) -> None: ...
    ...
    def addNewAvgCost(self, data) -> None: ...
