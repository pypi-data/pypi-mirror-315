...
class APIHandler(ABC, metaclass=abc.ABCMeta):
    ...
    def multiLogin(self, pid, account, password, connectionNum: int = 2, runnerNames=[]) -> None: ...
    def loginCall(self, account, password, runnerTag: Incomplete | None = None, runnerName: Incomplete | None = None) -> None: ...
