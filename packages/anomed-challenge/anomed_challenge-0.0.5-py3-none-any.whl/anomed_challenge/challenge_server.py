...
class UtilityResource:
    ...
    def __init__(
        ...
        request_validator: Callable[[falcon.Request], None] | None = None,
    ) -> None:
        """
        Parameters
        ----------
        ...
        submitter : Callable[falcon.Request, [dict[str, float]], None]
            ...
            expected that the this callable raises an exception, if the
            submission fails.
        request_validator : Callable[[falcon.Request], None] | None
            A callable that validates the request and raises exceptions when it
            does not meet its expectation. Otherwise, return nothing. By
            default, a no-op.
        """
        ...
        if request_validator is None:
            self._request_validator = lambda _: None
        else:
    ...
    def on_post(self, req: falcon.Request, resp: falcon.Response) -> None:
        ...
        try:
            ...
            error_msg = "Unable to submit the evaluation results."
    ...
    * [POST] `/utility/deanonymizer`
    ...
    app.add_route(
        ...
        UtilityResource(
            ...
            submitter=lambda req, _eval: None,
        ),
    )
    app.add_route(
