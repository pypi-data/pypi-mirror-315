...
class BuiltinsClass:
    def __init__(self) -> None:
        ...
        self.ExportReturnDistinct = Type("ExportReturn", parents=[self.ExportReturn, self.Distinct], properties=[Property(f"v{i}", self.Any) for i in range(20)])
        ...
        self.BoolFilter = Type("pyrel_bool_filter", parents=[self.Relation, self.NonFiltering], properties=[
        ...
        self.Default = Type("pyrel_default", parents=[self.Relation, self.NonFiltering], properties=[
            Property("relation", self.Relation, True),
