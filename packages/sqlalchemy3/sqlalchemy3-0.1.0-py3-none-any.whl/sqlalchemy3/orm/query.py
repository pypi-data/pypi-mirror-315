...
class Query(
    ...
    @util.preload_module("sqlalchemy3.orm.relationships")
    def with_parent(
        self,
        instance: object,
    ...
    def with_session(self, session: Session) -> Self:
        ...
        object associated with a target session using this method::
            ...
            from sqlalchemy3.orm import Query
    ...
    def exists(self) -> Exists:
        ...
        as a WHERE, use :func:`.literal`::
            ...
            from sqlalchemy3 import literal
    ...
    def count(self) -> int:
        ...
        expressions in conjunction with :meth:`~.Session.query`, i.e.::
            ...
            from sqlalchemy3 import distinct
