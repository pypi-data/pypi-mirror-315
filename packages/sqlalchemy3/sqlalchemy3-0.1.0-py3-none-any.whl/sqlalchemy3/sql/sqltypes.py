    ...
    def __init__(
        ...
        :param collation: Optional, a column-level collation for
          ...
          .. sourcecode:: pycon+sql
            ...
            >>> from sqlalchemy3 import cast, select, String
        ...
        :param precision: the numeric precision for use in DDL ``CREATE
           ...
           .. note:: For the Oracle Database backend, the
              ...
              :meth:`_types.TypeEngine.with_variant` as follows::
                    ...
                    from sqlalchemy3 import Column
                    from sqlalchemy3 import Float
                    from sqlalchemy3.dialects import oracle
...
class Enum(String, SchemaType, Emulated, TypeEngine[Union[str, enum.Enum]]):
    ...
    @util.preload_module("sqlalchemy3.sql.schema")
    def _set_table(self, column, table):
...
class JSON(Indexable, TypeEngine[Any]):
    ...
    * :meth:`.JSON.Comparator.as_integer` - return the element as an integer
    ...
    .. note::
        ...
        this looked like::
           ...
           from sqlalchemy3 import cast, type_coerce
           from sqlalchemy3 import String, JSON
    ...
    **Customizing the JSON Serializer**
    ...
    which always resolves to SQL NULL.  E.g.::
        ...
        from sqlalchemy3 import null
        from sqlalchemy3.dialects.postgresql import JSON
...
class ARRAY(
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    .. container:: topic
        ...
        **Detecting Changes in ARRAY columns when using the ORM**
        ...
        the :class:`.MutableList` class::
            ...
            from sqlalchemy3 import ARRAY
            from sqlalchemy3.ext.mutable import MutableList
    ...
    class Comparator(
        ...
        @util.preload_module("sqlalchemy3.sql.elements")
        def any(self, other, operator=None):
            ...
            is as follows::
                ...
                from sqlalchemy3.sql import operators
...
class Uuid(Emulated, TypeEngine[_UUID_RETURN]):
    ...
    **Python uuid objects**, from the Python
    ...
    module::
        ...
        from sqlalchemy3 import Uuid
        from sqlalchemy3 import Table, Column, MetaData, String
