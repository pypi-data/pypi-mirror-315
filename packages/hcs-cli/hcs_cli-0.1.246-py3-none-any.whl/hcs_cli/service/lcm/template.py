...
from hcs_core.sglib.client_util import hdc_service_client, default_crud
...
def wait(
    ...
    while True:
        ...
        print(f"Waiting for template {id}. Expected={expected_status}, current={status}, counter={t.counter} ...")
        ever_printed = True
...
def ensure_capacity(id: str, org_id: str, target_spare: int, protection_time: str):
    url = f"/v1/capacity/{id}?org_id={org_id}"
    payload = {"targetSpare": target_spare, "shrinkProtectionTime": protection_time}
