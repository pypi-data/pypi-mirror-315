...
import click
from hcs_cli.service.clouddriver import task as task_service
...
def list(provider: str, **kwargs):
    """List provider tasks"""
    return task_service.list_all(provider)
...
def get(provider: str, task: str, **kwargs):
    """Get a task"""
    return task_service.get(provider, task)
...
def delete(provider: str, task: str, **kwargs):
    """Delete a task"""
    return task_service.delete(provider, task)
