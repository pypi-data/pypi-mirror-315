...
class Client():
    ...
    def get_document(self, id_or_security_code_or_your_number):
        '''
        ...
        :param id_or_security_code: Identificador do documento. Pode ser o ID em
            si, o código de segurança ou o "yourNumber" do documento.
        ...
        json = parse_or_raise(
            self.session.get(self.base_url + u'/documents/' +
                             str(id_or_security_code_or_your_number)),
            raise_for_404=False)
