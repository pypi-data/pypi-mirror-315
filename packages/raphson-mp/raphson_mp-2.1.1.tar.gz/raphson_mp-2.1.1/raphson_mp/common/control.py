...
async def send(sockets: ClientWebSocketResponse | web.WebSocketResponse | Iterable[web.WebSocketResponse] | Iterable[ClientWebSocketResponse], commands: Command | Iterable[Command]):
