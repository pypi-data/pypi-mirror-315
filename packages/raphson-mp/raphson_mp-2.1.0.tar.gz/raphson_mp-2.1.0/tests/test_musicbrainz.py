...
async def test_correct_release():
    ...
    rg_id = await musicbrainz._search_release_group("Red Hot Chili Peppers", "Californication")  # pyright: ignore[reportPrivateUsage]
    ...
    rg_id = await musicbrainz._search_release_group("The Midnight", "Nocturnal")  # pyright: ignore[reportPrivateUsage]
