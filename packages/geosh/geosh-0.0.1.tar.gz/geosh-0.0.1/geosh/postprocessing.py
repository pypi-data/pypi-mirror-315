...
# Modified by [Umberto Grechi] in 2024
#
...
#
# This file has been modified from its original version. The changes include:
# - [Variazione grafica, editing funzioni ns-ew-z]
#
# If you have questions about the modifications, contact [Umberto Grechi] at [umberto.grechi@sofhare.com].
...
def plot_single_panel_hvsr_curves(hvsr,
    ...
    ax.set_xlim(0.1, 64)  # Example: x-axis limits from 0.1 Hz to 100 Hz
    ax.set_ylim(0, 8)
