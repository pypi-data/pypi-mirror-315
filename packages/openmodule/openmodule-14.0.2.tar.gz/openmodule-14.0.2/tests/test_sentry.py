...
class SentryTestCase(SentryTestMixin):
    ...
    def assert_spans(self, span_recorder: _SpanRecorder, expected: List[Optional[str]]):
    ...
    def test_trace_decorator_without_param(self):
        ...
        span_recorder: Optional[_SpanRecorder] = None
...
class SentryTransportTestCase(TestCase):
    ...
    def test_parse_stored_envelope(self):
        ...
        sent_envelope: Optional[sentry_sdk.envelope.Envelope] = None
