...
const std::string& LoadgenVersion() {
  static const std::string str = "5.0.1";
  return str;
}

const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2024-12-13T04:39:17.647026";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2024-12-13T04:39:17.647050";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "fa274563d7";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2024-12-12T22:38:37-06:00";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(fa274563d74b555f0fb8cd6fe5d11a24e83684ce Fix llama3-405B docker workflow and performance sample count (#1978))LGVG_RSLD";
  return str;
}
...
1a920a7d60138a8b98106112e1a38de9ac1697fc /VERSION.txt
...
42b50c087c6fea1005abbba369c22cb09d6a364a /loadgen.cc
...
b6693382da131e91f1c3a30ba66f242d29ccd19f /mlperf.conf
6a1823661a7d404eebf0453e4e973d83e9559579 /mlperf_conf.h
...
8827ef7d70e6c9a43dd25b4f42a6d2a9cecda428 /test_settings_internal.cc
