...
try:
    from clusterondemandoci._version import version as __version__
except ImportError:
    from setuptools_scm import get_version
    __version__ = get_version(
        root="..",
        relative_to="__file__",
        write_to="cluster-on-demand-oci/clusterondemandoci/_version.py"
    )
...
setup(
    ...
    version=__version__,
    description="Bright Cluster on Demand Utility OCI",
    author="Cloudteam",
    ...
    entry_points={
        "console_scripts": [
            "cm-cod-oci = clusterondemandoci.cli:cli_main"
        ]
    },
    python_requires=">=3.9",
