...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-cloud9)](https://pypistats.org/packages/mypy-boto3-cloud9)
...
`mypy-boto3-cloud9` dependency in production. However, there is an issue in
