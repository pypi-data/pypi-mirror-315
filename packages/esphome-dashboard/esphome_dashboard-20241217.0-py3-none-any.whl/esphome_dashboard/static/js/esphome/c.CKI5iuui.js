import{e as t,T as e,K as o,r as i,b as s,c as r,n as a,s as n,x as l,d as c,L as p,N as d,O as h,P as u,H as m,I as _,k as v,Q as g,C as w,S as y}from"./index-D-cxILmb.js";import{c as f}from"./c.PrM8NUDE.js";import{g as b}from"./c.CV6cyzYS.js";import"./c.CyiVjy7U.js";import{o as $,c as S}from"./c.Ezi_ChDx.js";import{m as P,s as x,b as k}from"./c.CBPI5kTQ.js";import{o as C}from"./c.BHD4IP9p.js";class j{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class E{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.Z=t)))}resume(){var t;null===(t=this.Z)||void 0===t||t.call(this),this.Y=this.Z=void 0}}const H=t=>!o(t)&&"function"==typeof t.then,W=1073741823;const I=t(class extends f{constructor(){super(...arguments),this._$C_t=W,this._$Cwt=[],this._$Cq=new j(this),this._$CK=new E}render(...t){var o;return null!==(o=t.find((t=>!H(t))))&&void 0!==o?o:e}update(t,o){const i=this._$Cwt;let s=i.length;this._$Cwt=o;const r=this._$Cq,a=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<o.length&&!(t>this._$C_t);t++){const e=o[t];if(!H(e))return this._$C_t=t,e;t<s&&e===i[t]||(this._$C_t=W,s=0,Promise.resolve(e).then((async t=>{for(;a.get();)await a.get();const o=r.deref();if(void 0!==o){const i=o._$Cwt.indexOf(e);i>-1&&i<o._$C_t&&(o._$C_t=i,o.setValue(t))}})))}return e}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}}),D=(t,e)=>{import("./c.BDKoPu4O.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)},T=async(t,e)=>{import("./c.COQgv3CN.js");let o=t.port;if(o)await o.close();else try{o=await navigator.serial.requestPort()}catch(o){return void("NotFoundError"===o.name?$((()=>T(t,e))):alert(`Unable to connect: ${o.message}`))}const i=S(o);e&&e();const s=document.createElement("esphome-install-web-dialog");s.params=t,s.esploader=i,document.body.append(s)},A={info:p,warning:d,error:h,success:u};let q=class extends n{constructor(){super(...arguments),this.title="",this.alertType="info",this.rtl=!1}render(){return l`
      <div
  ...
  `,s([r()],q.prototype,"title",void 0),s([r({attribute:"alert-type"})],q.prototype,"alertType",void 0),s([r({type:Boolean})],q.prototype,"rtl",void 0),q=s([a("esphome-alert")],q);const B=(t,e)=>{import("./c.oBWCqTHn.js");const o=document.createElement("esphome-download-type-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)};let U=class extends n{constructor(){super(...arguments),this._ethernet=!1,this._isPico=!1,this._shouldDownloadFactory=!1,this._state="pick_option"}get _platformSupportsWebSerial(){return!this._isPico}render(){let t,e;if("pick_option"===this._state)t=`How do you want to install ${this.configuration} on your device?`,e=l`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
    ...
    `}firstUpdated(t){super.firstUpdated(t),this._updateSerialPorts(),g(this.configuration).then((t=>{this._ethernet=t.loaded_integrations.includes("ethernet"),this._isPico="RP2040"===t.esp_platform,this._shouldDownloadFactory="ESP32"===t.esp_platform}))}async _updateSerialPorts(){this._ports=await b()}willUpdate(t){super.willUpdate(t),t.has("_state")&&"download_instructions"===this._state&&!this._compileConfiguration&&(this._abortCompilation=new AbortController,this._compileConfiguration=w(this.configuration).then((()=>this._shouldDownloadFactory?l`<a
                ...
                >`:l`<button
                  class="link"
                  @click=${()=>{B(this.configuration,this._platformSupportsWebSerial)}}
                  >Download project</a
                >`),(()=>l`
    ...
    `],s([r()],U.prototype,"configuration",void 0),s([v()],U.prototype,"_ethernet",void 0),s([v()],U.prototype,"_isPico",void 0),s([v()],U.prototype,"_shouldDownloadFactory",void 0),s([v()],U.prototype,"_ports",void 0),s([v()],U.prototype,"_state",void 0),s([v()],U.prototype,"_error",void 0),U=s([a("esphome-install-choose-dialog")],U);var O=Object.freeze({__proto__:null});export{D as a,T as b,O as i,B as o};
//# sourceMappingURL=c.CKI5iuui.js.map
