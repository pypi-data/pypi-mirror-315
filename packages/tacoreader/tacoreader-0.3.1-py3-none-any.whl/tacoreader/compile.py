...
def compile(
    ...
    data_format: str = dataframe["internal:file_format"].iloc[0]
    ...
    if mode == "local":
        compile_local(dataframe, output, chunk_size_iter, nworkers, data_format, quiet)
    elif mode == "online":
        compile_online(dataframe, output, chunk_size_iter, data_format, quiet)
    else:
