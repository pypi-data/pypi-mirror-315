...
class GraphOperation(BaseModel):
    ...
    entity_examples: typing.List[EntityExample] = Field(
        default_factory=list,
        description="Examples of entities to be sent to the model as few-shot learning",
    )
    relation_examples: typing.List[RelationExample] = Field(
        default_factory=list,
        description="Examples of relations to be sent to the model as few-shot learning",
    )
