...
import ourskyai_platform_api.models
from ourskyai_platform_api import rest
from ourskyai_platform_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ourskyai_platform_api.models, klass)
