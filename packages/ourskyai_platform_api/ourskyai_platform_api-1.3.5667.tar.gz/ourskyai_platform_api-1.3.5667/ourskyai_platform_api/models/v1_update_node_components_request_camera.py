...
class V1UpdateNodeComponentsRequestCamera(BaseModel):
    """
    ...
    __properties = ["model", "pixelSizeMicrons", "fullWellCapacity", "pixelsX", "pixelsY", "megapixels", "chilled", "shutterType", "gpsTimestamps", "sensorXmm", "sensorYmm", "unityGain", "optimalNighttimeGain", "optimalNighttimeGainOffset", "optimalNighttimeGainMode", "supportsVideoMode", "adcBitDepth", "quantumEfficiency", "gainCurves", "setupActions", "isColor"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateNodeComponentsRequestCamera:
        """Create an instance of V1UpdateNodeComponentsRequestCamera from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateNodeComponentsRequestCamera:
        """Create an instance of V1UpdateNodeComponentsRequestCamera from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateNodeComponentsRequestCamera.parse_obj(obj)

        _obj = V1UpdateNodeComponentsRequestCamera.parse_obj({
            "model": obj.get("model"),
