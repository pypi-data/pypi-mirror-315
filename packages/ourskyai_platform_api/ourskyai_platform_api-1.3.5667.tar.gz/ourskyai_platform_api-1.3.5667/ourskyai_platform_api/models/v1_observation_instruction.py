...
class V1ObservationInstruction(BaseModel):
    ...
    __properties = ["id", "noradId", "orbitType", "imageSetId", "targetId", "trackingType", "exposureDuration", "binning", "gain", "gainMode", "gainOffset", "ra", "dec", "captureStart", "captureEnd", "preCaptureWait", "startSlewAt", "cameraMode", "tleName", "tleLine1", "tleLine2", "tleOffsetDec", "tleOffsetRa", "plateSolveParameters", "uploadPriority", "satellitePassEphemeris", "ascomAxisRates"]
