...
class V1Node(BaseModel):
    ...
    __properties = ["name", "observatoryId", "organizationId", "cameraId", "opticalTubeId", "mountId", "filterWheelId", "minAltitude", "elevationMask", "slewTiming", "createdAt", "updatedAt", "state", "id", "location"]
