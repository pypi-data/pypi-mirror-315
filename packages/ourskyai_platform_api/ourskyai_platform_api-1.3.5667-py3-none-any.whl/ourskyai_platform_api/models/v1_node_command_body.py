...
V1NODECOMMANDBODY_ONE_OF_SCHEMAS = ["V1Halt", "V1RebootSystem", "V1RestartAdb", "V1StartPerpetualInstructionLoop", "V1StopPerpetualInstructionLoop"]
...
class V1NodeCommandBody(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[V1Halt, V1RebootSystem, V1RestartAdb, V1StartPerpetualInstructionLoop, V1StopPerpetualInstructionLoop]
    else:
        actual_instance: Any
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in V1NodeCommandBody with oneOf schemas: V1Halt, V1RebootSystem, V1RestartAdb, V1StartPerpetualInstructionLoop, V1StopPerpetualInstructionLoop. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in V1NodeCommandBody with oneOf schemas: V1Halt, V1RebootSystem, V1RestartAdb, V1StartPerpetualInstructionLoop, V1StopPerpetualInstructionLoop. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> V1NodeCommandBody:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into V1NodeCommandBody with oneOf schemas: V1Halt, V1RebootSystem, V1RestartAdb, V1StartPerpetualInstructionLoop, V1StopPerpetualInstructionLoop. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into V1NodeCommandBody with oneOf schemas: V1Halt, V1RebootSystem, V1RestartAdb, V1StartPerpetualInstructionLoop, V1StopPerpetualInstructionLoop. Details: " + ", ".join(error_messages))
        else:
            return instance
