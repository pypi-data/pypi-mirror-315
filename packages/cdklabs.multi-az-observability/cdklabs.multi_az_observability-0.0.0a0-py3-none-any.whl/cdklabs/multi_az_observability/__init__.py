...
class BasicServiceMultiAZObservabilityProps:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Properties for creating a basic service.

        :param create_dashboard: (experimental) Whether to create a dashboard displaying the metrics and alarms.
        ...
        :param period: (experimental) The period to evaluate metrics.
        :param service_name: (experimental) The service's name.
        :param application_load_balancers: (experimental) The application load balancers being used by the service. Default: - No alarms for ALBs will be created
        ...
        :param fault_count_percentage_threshold: (experimental) The percentage of faults for a single ALB to consider an AZ to be unhealthy, this should align with your availability goal. For example 1% or 5%. Default: - 5 (as in 5%)
        :param interval: (experimental) Dashboard interval. Default: - 1 hour
        :param nat_gateways: (experimental) (Optional) A map of Availability Zone name to the NAT Gateways in that AZ. Default: - No alarms for NAT Gateways will be created
        ...
        :param packet_loss_impact_percentage_threshold: (experimental) The amount of packet loss in a NAT GW to determine if an AZ is actually impacted, recommendation is 0.01%. Default: - 0.01 (as in 0.01%)
    ...
    def fault_count_percentage_threshold(self) -> typing.Optional[jsii.Number]:
        '''(experimental) The percentage of faults for a single ALB to consider an AZ to be unhealthy, this should align with your availability goal.
    ...
    def nat_gateways(
        ...
        '''(experimental) (Optional) A map of Availability Zone name to the NAT Gateways in that AZ.
    ...
    def packet_loss_impact_percentage_threshold(self) -> typing.Optional[jsii.Number]:
        '''(experimental) The amount of packet loss in a NAT GW to determine if an AZ is actually impacted, recommendation is 0.01%.
