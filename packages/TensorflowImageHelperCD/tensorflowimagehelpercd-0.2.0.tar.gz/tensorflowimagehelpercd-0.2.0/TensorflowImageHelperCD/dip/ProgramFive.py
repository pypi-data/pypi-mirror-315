def programFive():
    """
    Read an image, first apply erosion to the image and then subtract the result from the original. Demonstrate the difference in the edge image
you use dilation instead of erosion.
    """
    import numpy as np
    ...
    if image is None:
        raise FileNotFoundError("The image file 'scem.jpg' was not found.")
