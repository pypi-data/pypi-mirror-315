...
from caerp_base.models.base import default_table_args, DBBASE, DBSESSION
...
from .services.business_status import (
...
class Business(BusinessMetricsMixin, Node):
    ...
    @classmethod
    def create(cls, name, project, business_type_id) -> "Business":
        visible = project.project_type.with_business
        result = cls(
            name=name,
            project=project,
    ...
    def amount_foreseen_to_invoice(self):
        return self._caerp_service.amount_foreseen_to_invoice(self)
    ...
    def get_deposit_deadlines(self, waiting=True):
        ...
        """
        return self._caerp_service.get_deposit_deadlines(self, waiting)
    ...
    def set_progress_invoicing_mode(self):
        ...
        self._caerp_service.populate_progress_invoicing_status(self)
    ...
    def unset_progress_invoicing_mode(self):
        ...
        self._caerp_service.clear_progress_invoicing_status(self)

    def populate_progress_invoicing_status(self, exclude_estimation=None):
        """
        Populate the progress invoicing statuses

        :param obj exclude_estimation: Estimation to be excluded from treatment
        """
        self._caerp_service.populate_progress_invoicing_status(exclude_estimation)
    ...
    def on_estimation_signed_status_change(self):
        ...
        """
        self._caerp_service.on_estimation_signed_status_change(self)
