...
def query_list_with_pagination(
    endpoint: str, rel_key: str, block_height: int = 0, max_pages: int = 50, params: dict | list[tuple[str, str]] = {}
) -> list[dict]: ...
...
def get_deposit_records(
    chain_id: str, status: types.DepositRecordStatus | None = None, block_height: int = 0
) -> list[dict[str, Any]]: ...
def get_unbonding_records(
    chain_id: str, status: types.UnbondingRecordStatus | None = None, block_height: int = 0
) -> list[dict[str, Any]]: ...
def get_unbonding_queue_records(chain_id: str, block_height: int = 0) -> list[dict[str, Any]]: ...
def get_unbonded_records(
    chain_id: str, block_height: int = 0, filter_unbonded_last_epoch: bool = False
) -> list[dict[str, Any]]: ...
...
def get_multisig_redemption_records(
    module: str, address: str | None = None, unbonding_record_id: int | None = None
) -> list[dict]: ...
...
def get_balances(
    address: str, block_height: int = 0, api_endpoint: str = ..., cache_response: bool = False
) -> dict[str, int]: ...
def get_balance(
    address: str, denom: str, block_height: int = 0, api_endpoint: str = ..., cache_response: bool = False
) -> int: ...
...
def get_block_height_in_past(
    ...
    target_time_offset: datetime.timedelta | None = None,
    error_tolerance: datetime.timedelta = ...,
