...
def request(url: str, headers: dict[str, str] = {}, params: dict | list[tuple[str, str]] = {}, data: str | None = None, block_height: int = 0, cache_response: bool = False, _cache: dict[str, Any] = {}): ...
