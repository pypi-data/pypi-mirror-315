...
#   timestamp: 2024-11-22T14:30:43+00:00
...
class IcebergStats(BaseModel):
    ...
    branches: Optional[List[Dict[str, Dict[str, Any]]]] = None
    properties: Optional[Dict[str, str]] = None
...
class Snowflake(Resolution):
    url: Optional[str] = None
    table: Optional[str] = None
    schema_: Optional[str] = Field(None, alias='schema')


class Wasbs(Resolution):
...
class Abfss(Resolution):
    wasbsUrl: Optional[str] = None
    relativePath: Optional[str] = None
    abfssUrl: Optional[str] = None


class Bigquery(Resolution):
    dataset: Optional[str] = None
    table: Optional[str] = None


class ElasticSearch(Resolution):
    index: Optional[str] = None
    type: Optional[str] = None


class Eventhub(Resolution):
...
class Gcs(Resolution):
    gcsUrl: Optional[str] = None
    relativePath: Optional[str] = None


class Jdbc(Resolution):
    url: Optional[str] = None
    table: Optional[str] = None
    database: Optional[str] = None
    schema_: Optional[str] = Field(None, alias='schema')
...
class Kafka(Resolution):
    topic: Optional[str] = None


class MongoDb(Resolution):
    url: Optional[str] = None
    database: Optional[str] = None
    table: Optional[str] = None


class OpenSearch(Resolution):
    index: Optional[str] = None


class Oracle(Resolution):
    url: Optional[str] = None
    table: Optional[str] = None
    schema_: Optional[str] = Field(None, alias='schema')


class Presto(Resolution):
    url: Optional[str] = None


class Pulsar(Resolution):
    topic: Optional[str] = None
    isPersistent: Optional[bool] = None


class Redis(Resolution):
    pass


class Redshift(Resolution):
    url: Optional[str] = None
    table: Optional[str] = None
    schema_: Optional[str] = Field(None, alias='schema')
