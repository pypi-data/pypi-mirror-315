...
class MortalSQL(MortalSQLMain):
    ...
    def read_sql(self, table_sql, coerce_float=False, **kwargs):
        return self._read_sql(table_sql, coerce_float, **kwargs)
    ...
    def data_sync(self, name, path):
        self._data_sync(name, path)
