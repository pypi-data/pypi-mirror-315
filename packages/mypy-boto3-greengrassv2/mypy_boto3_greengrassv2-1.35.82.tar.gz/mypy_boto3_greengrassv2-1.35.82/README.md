...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-greengrassv2)](https://pypistats.org/packages/mypy-boto3-greengrassv2)
...
`mypy-boto3-greengrassv2` dependency in production. However, there is an issue
