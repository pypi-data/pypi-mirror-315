...
from msb_parent_api.msb_api_client import StudentResponse,Schools,MealPaymentsAcceptedPaymentMethods
...
class Student(DataModel):
    ...
    @property
    def schools(self) -> Optional[list[Schools]]:
        """Property Definition."""
    ...
    @property
    def mealPaymentsAcceptedPaytmentMethods(self) -> Optional[MealPaymentsAcceptedPaymentMethods]:
        """Property Definition."""
