...
setup(
    ...
    description=('A Python library for checking server availability and managing '
                'server configurations via SSH, with support for parallel '
