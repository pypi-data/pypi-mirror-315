...
class DeformableModel(PhysicalModel):
    def __init__(self, *args, **kwargs) -> None: ...
    def AddFixedConstraint(self, body_A_id: DeformableBodyId, body_B: pydrake.multibody.tree.RigidBody, X_BA: pydrake.math.RigidTransform, shape: pydrake.geometry.Shape, X_BG: pydrake.math.RigidTransform) -> pydrake.multibody.tree.MultibodyConstraintId: ...
    def GetBodyId(self, geometry_id: pydrake.geometry.GeometryId) -> DeformableBodyId: ...
    def GetDiscreteStateIndex(self, id: DeformableBodyId) -> pydrake.systems.framework.DiscreteStateIndex: ...
    def GetGeometryId(self, id: DeformableBodyId) -> pydrake.geometry.GeometryId: ...
    def GetReferencePositions(self, id: DeformableBodyId) -> numpy.ndarray[numpy.float64[m, 1]]: ...
    def RegisterDeformableBody(self, geometry_instance: pydrake.geometry.GeometryInstance, config: pydrake.multibody.fem.DeformableBodyConfig, resolution_hint: float) -> DeformableBodyId: ...
    def SetWallBoundaryCondition(self, id: DeformableBodyId, p_WQ: numpy.ndarray[numpy.float64[3, 1]], n_W: numpy.ndarray[numpy.float64[3, 1]]) -> None: ...
...
class MultibodyPlant(pydrake.systems.framework.LeafSystem):
    ...
    def SetFreeBodyPose(self, context: pydrake.systems.framework.Context, body: pydrake.multibody.tree.RigidBody, X_PB: pydrake.math.RigidTransform) -> None: ...
    def SetFreeBodySpatialVelocity(self, body: pydrake.multibody.tree.RigidBody, V_PB: pydrake.multibody.math.SpatialVelocity, context: pydrake.systems.framework.Context) -> None: ...
    @overload
...
class MultibodyPlant_𝓣AutoDiffXd𝓤(pydrake.systems.framework.LeafSystem_TAutoDiffXdU):
    ...
    def SetFreeBodyPose(self, context: pydrake.systems.framework.Context_TAutoDiffXdU, body: pydrake.multibody.tree.RigidBody_TAutoDiffXdU, X_PB: pydrake.math.RigidTransform_TAutoDiffXdU) -> None: ...
    def SetFreeBodySpatialVelocity(self, body: pydrake.multibody.tree.RigidBody_TAutoDiffXdU, V_PB: pydrake.multibody.math.SpatialVelocity_TAutoDiffXdU, context: pydrake.systems.framework.Context_TAutoDiffXdU) -> None: ...
    @overload
...
class MultibodyPlant_𝓣Expression𝓤(pydrake.systems.framework.LeafSystem_TExpressionU):
    ...
    def SetFreeBodyPose(self, context: pydrake.systems.framework.Context_TExpressionU, body: pydrake.multibody.tree.RigidBody_TExpressionU, X_PB: pydrake.math.RigidTransform_TExpressionU) -> None: ...
    def SetFreeBodySpatialVelocity(self, body: pydrake.multibody.tree.RigidBody_TExpressionU, V_PB: pydrake.multibody.math.SpatialVelocity_TExpressionU, context: pydrake.systems.framework.Context_TExpressionU) -> None: ...
    @overload
