...
class Attention(nn.Module):
    ...
    def _finalize_kv(self,
        ...
        if self.attention_type == AttentionType.KVCachedSelfAttention:
            ...
            key_cache = key_cache + current_key * kv_cache_update_mask
            value_cache = value_cache + current_value * kv_cache_update_mask
...
class StatefulKVCachedAttention(Attention):
    ...
    def forward(self,
        ...
        outputs, key_cache_updates, value_cache_updates = super().forward(
            input_embeds,
            key_padding_mask,
            self.key_cache,
            self.value_cache,
