...
def putRequestFunction(status: EnumStatus, enumProcesso: EnumProcesso, enumBanco: EnumBanco):
    ...
    if enumProcesso == EnumProcesso.INTEGRACAO:
        PORTA = 8443
...
if __name__=="__main__":
    # putRequestFunction(EnumStatus.LIGADO, EnumProcesso.RESET, EnumBanco.DIGIO)
    #putRequestFunction(EnumStatus.LIGADO, EnumProcesso.CRIACAO, EnumBanco.BMG)
    putRequestFunction(EnumStatus.LIGADO, EnumProcesso.RESET, EnumBanco.BMG)
    # postSolicitacao(None, EnumProcesso.CRIACAO, 123345, EnumBanco.BANRISUL)
    # putRequestFunction(EnumStatus.LIGADO, EnumProcesso.IMPORTACAO, EnumBanco.MEU_CASH_CARD)
    # putRequestFunction(EnumStatus.LIGADO, EnumProcesso.RESET, EnumBanco.BANRISUL)
