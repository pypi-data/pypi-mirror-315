...
async def account_info(self, account, representative=None, weight=None, pending=None, include_confirmed=None):
    return await self.rpc.account_info(account, representative=representative, weight=weight, pending=pending, include_confirmed=include_confirmed)
...
async def accounts_balances(self, accounts):
    return await self.rpc.accounts_balances(accounts)
...
async def blocks_info(self, hashes, json_block=None, pending=None, source=None, include_not_found=None):
    return await self.rpc.blocks_info(hashes, json_block=json_block, pending=pending, source=source, include_not_found=include_not_found)
...
async def ledger(self, account, count, representative=None, weight=None, pending=None, modified_since=None, sorting=None, threshold=None):
    return await self.rpc.ledger(account, count, representative=representative, weight=weight, pending=pending, modified_since=modified_since, sorting=sorting, threshold=threshold)
...
async def wallet_ledger(self, wallet, representative=None, weight=None, pending=None):
    return await self.rpc.wallet_ledger(wallet, representative=representative, weight=weight, pending=pending)
