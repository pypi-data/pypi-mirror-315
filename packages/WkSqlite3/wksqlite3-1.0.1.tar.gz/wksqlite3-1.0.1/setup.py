...
# Package meta-data.
NAME = "WkSqlite3"
DESCRIPTION = "WkSqlite3 是一个用于简化 SQLite 数据库操作的 Python 封装类。它提供线程安全的连接管理及创建表、插入和查询数据等功能，帮助开发者高效地进行数据库操作。"
URL = "https://gitee.com/purify_wang/wk-sqlite3.git"  # Github
