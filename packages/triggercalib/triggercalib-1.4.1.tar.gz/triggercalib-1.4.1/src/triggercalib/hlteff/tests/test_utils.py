...
def test_bins_io_json(example_file):
    import json
...
def test_bins_io_yaml(example_file):
    import yaml
    from triggercalib import HltEff
...
def test_conversion_to_th1(example_file):
    from triggercalib import HltEff
    from triggercalib.utils import tgraph_to_np, th_to_np
    ...
    xvals, yvals, xerrs, yerrs = th_to_np(hist_th)


def test_conversion_to_th2(example_file):
    from triggercalib import HltEff
