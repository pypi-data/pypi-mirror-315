...
"""
        ...
        source = f2py_jit.inline_source(source, ignore='extra')
        self.assertTrue('! inline: addone' in source)
        f2py_jit.compile_module(source, name='jit_test_new', verbose=False)
