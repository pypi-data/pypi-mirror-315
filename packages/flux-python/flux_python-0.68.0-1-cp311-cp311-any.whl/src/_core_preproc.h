# 0 "/__w/flux-python/flux-python/src/_core_clean.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/__w/flux-python/flux-python/src/_core_clean.h"
# 48 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 104 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_match_asprintf (struct flux_match *m,
                         ...
                         ...);
# 178 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 285 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 386 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 460 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 517 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 561 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 595 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 619 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 657 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 712 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 815 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 854 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 931 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 994 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1015 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_msglist_pollevents (struct flux_msglist *l);
int flux_msglist_pollfd (struct flux_msglist *l);
# 1051 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_msg_t *flux_request_encode_raw (const char *topic,
                                     const void *data, int len);
# 1117 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_response_decode (const flux_msg_t *msg,
                          const char **topic,
                          const char **s);
# 1129 "/__w/flux-python/flux-python/src/_core_clean.h"
...
void flux_llog (void *arg,
                ...
                const char *fmt,
                va_list ap);
# 1352 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1430 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_future_fulfill_next (flux_future_t *prev,
                              void *result,
                              flux_free_f free_fn);
# 1472 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1550 "/__w/flux-python/flux-python/src/_core_clean.h"
enum event_flags {
...
# 1661 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 1734 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1786 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 1824 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_conf_unpack (const flux_conf_t *conf,
                      flux_error_t *error,
                      const char *fmt, ...);
# 1908 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_barrier (flux_t *h, const char *name, int nprocs);
# 1951 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_register (flux_t *h, const char *name);
# 1963 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_service_unregister (flux_t *h, const char *name);
# 2015 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2053 "/__w/flux-python/flux-python/src/_core_clean.h"
enum {
...
# 2140 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_plugin_arg_vunpack (flux_plugin_arg_t *args, int flags,
                             const char *fmt, va_list ap);
# 2209 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_call (flux_plugin_t *p, const char *name,
                      flux_plugin_arg_t *args);
# 2219 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_plugin_load_dso (flux_plugin_t *p, const char *path);
# 2252 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_sync_create (flux_t *h, double minimum);
# 2284 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_msglist_cancel (flux_t *h,
                         ...
                         const flux_msg_t *msg);
# 2353 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2436 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct flux_kvsdir flux_kvsdir_t;
typedef struct flux_kvsitr flux_kvsitr_t;
# 2451 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2526 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2580 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_getroot (flux_t *h, const char *ns, int flags);
# 2589 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2621 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2720 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2781 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_copy (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2798 "/__w/flux-python/flux-python/src/_core_clean.h"
flux_future_t *flux_kvs_move (flux_t *h,
                              ...
                              const char *dstkey,
                              int commit_flags);
# 2821 "/__w/flux-python/flux-python/src/_core_clean.h"
enum kvs_op {
    FLUX_KVS_READDIR = 1,
    FLUX_KVS_READLINK = 2,
    FLUX_KVS_WATCH = 4,
...
# 2842 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2893 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 2979 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_id_encode (flux_jobid_t id, const char *type,
                        char *buf, size_t bufsz);
# 2990 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_job_result_get (flux_future_t *f,
                         const char **json_str);
# 3121 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_result_get_unpack (flux_future_t *f, const char *fmt, ...);
# 3135 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_job_timeleft (flux_t *h, flux_error_t *errp, double *timeleft);
# 3151 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3186 "/__w/flux-python/flux-python/src/_core_clean.h"
...
flux_jobspec1_t *flux_jobspec1_decode (const char *s,
                                       flux_jobspec1_error_t *error);
# 3297 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3353 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3552 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3580 "/__w/flux-python/flux-python/src/_core_clean.h"
typedef struct {
    ...
    flux_subprocess_credit_f on_credit;
...
typedef void (*subprocess_log_f)(void *arg,
                                 ...
                                 const char *fmt,
                                 va_list args);
# 3636 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3680 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3708 "/__w/flux-python/flux-python/src/_core_clean.h"
int flux_subprocess_read (flux_subprocess_t *p,
                          const char *stream,
                          const char **bufp);
# 3734 "/__w/flux-python/flux-python/src/_core_clean.h"
...
int flux_subprocess_read_trimmed_line (flux_subprocess_t *p,
                                       const char *stream,
                                       const char **bufp);
# 3753 "/__w/flux-python/flux-python/src/_core_clean.h"
bool flux_subprocess_read_stream_closed (flux_subprocess_t *p,
                                         const char *stream);
# 3771 "/__w/flux-python/flux-python/src/_core_clean.h"
...
# 3879 "/__w/flux-python/flux-python/src/_core_clean.h"
