...
pub struct CreateModerationRequest {
    ...
    /// [moderation guide](https://platform.TupleleapAI.com/docs/guides/moderation), and learn about
    /// available models [here](https://platform.TupleleapAI.com/docs/models/moderation).
