...
pub struct CreateTranscriptionRequest {
    ...
    /// An optional text to guide the model's style or continue a previous audio segment. The [prompt](https://platform.TupleleapAI.com/docs/guides/speech-to-text/prompting) should match the audio language.
...
pub struct CreateSpeechRequest {
    ...
    /// One of the available [TTS models](https://platform.TupleleapAI.com/docs/models/tts): `tts-1` or `tts-1-hd`
    pub model: SpeechModel,

    /// The voice to use when generating the audio. Supported voices are `alloy`, `echo`, `fable`, `onyx`, `nova`, and `shimmer`. Previews of the voices are available in the [Text to speech guide](https://platform.TupleleapAI.com/docs/guides/text-to-speech/voice-options).
    pub voice: Voice,
...
pub struct CreateTranslationRequest {
    ...
    /// An optional text to guide the model's style or continue a previous audio segment. The [prompt](https://platform.TupleleapAI.com/docs/guides/speech-to-text/prompting) should be in English.
    pub prompt: Option<String>,
