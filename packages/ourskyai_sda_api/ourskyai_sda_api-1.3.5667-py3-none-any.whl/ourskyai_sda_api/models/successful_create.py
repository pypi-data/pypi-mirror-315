...
class SuccessfulCreate(BaseModel):
    """
    SuccessfulCreate
    """
    id: StrictStr = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SuccessfulCreate:
        """Create an instance of SuccessfulCreate from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SuccessfulCreate:
        """Create an instance of SuccessfulCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SuccessfulCreate.parse_obj(obj)

        _obj = SuccessfulCreate.parse_obj({
            "id": obj.get("id")
        })
        return _obj
