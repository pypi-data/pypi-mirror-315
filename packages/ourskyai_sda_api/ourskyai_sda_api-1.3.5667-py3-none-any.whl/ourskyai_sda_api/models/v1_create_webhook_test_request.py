...
class V1CreateWebhookTestRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateWebhookTestRequest:
        """Create an instance of V1CreateWebhookTestRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateWebhookTestRequest:
        """Create an instance of V1CreateWebhookTestRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateWebhookTestRequest.parse_obj(obj)

        _obj = V1CreateWebhookTestRequest.parse_obj({
