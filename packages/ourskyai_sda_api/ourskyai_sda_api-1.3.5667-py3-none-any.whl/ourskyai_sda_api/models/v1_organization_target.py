...
class V1OrganizationTarget(BaseModel):
    """
    V1OrganizationTarget
    """
    id: StrictStr = Field(...)
    satellite_target: V1SatelliteTarget = Field(..., alias="satelliteTarget")
    created_by: StrictStr = Field(..., alias="createdBy")
    created_at: datetime = Field(..., alias="createdAt")
    __properties = ["id", "satelliteTarget", "createdBy", "createdAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1OrganizationTarget:
        """Create an instance of V1OrganizationTarget from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of satellite_target
        if self.satellite_target:
            _dict['satelliteTarget'] = self.satellite_target.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> V1OrganizationTarget:
        """Create an instance of V1OrganizationTarget from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1OrganizationTarget.parse_obj(obj)

        _obj = V1OrganizationTarget.parse_obj({
            "id": obj.get("id"),
            "satellite_target": V1SatelliteTarget.from_dict(obj.get("satelliteTarget")) if obj.get("satelliteTarget") is not None else None,
