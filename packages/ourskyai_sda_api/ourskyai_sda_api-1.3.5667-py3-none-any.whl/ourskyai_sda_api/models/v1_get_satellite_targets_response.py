...
class V1GetSatelliteTargetsResponse(BaseModel):
    """
    V1GetSatelliteTargetsResponse
    """
    targets: conlist(V1SatelliteTarget) = Field(...)
    __properties = ["targets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1GetSatelliteTargetsResponse:
        """Create an instance of V1GetSatelliteTargetsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1GetSatelliteTargetsResponse:
        """Create an instance of V1GetSatelliteTargetsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1GetSatelliteTargetsResponse.parse_obj(obj)

        _obj = V1GetSatelliteTargetsResponse.parse_obj({
            "targets": [V1SatelliteTarget.from_dict(_item) for _item in obj.get("targets")] if obj.get("targets") is not None else None
        })
        return _obj
