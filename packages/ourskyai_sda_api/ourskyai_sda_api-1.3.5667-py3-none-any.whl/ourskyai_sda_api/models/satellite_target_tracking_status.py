...
class SatelliteTargetTrackingStatus(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SatelliteTargetTrackingStatus:
        """Create an instance of SatelliteTargetTrackingStatus from a JSON string"""
        return SatelliteTargetTrackingStatus(json.loads(json_str))
