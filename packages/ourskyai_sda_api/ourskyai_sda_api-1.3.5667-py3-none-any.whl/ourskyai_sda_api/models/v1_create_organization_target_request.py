...
class V1CreateOrganizationTargetRequest(BaseModel):
    """
    V1CreateOrganizationTargetRequest
    """
    satellite_target_id: StrictStr = Field(..., alias="satelliteTargetId")
    ...
    __properties = ["satelliteTargetId", "revisitRateMinutes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateOrganizationTargetRequest:
        """Create an instance of V1CreateOrganizationTargetRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateOrganizationTargetRequest:
        """Create an instance of V1CreateOrganizationTargetRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateOrganizationTargetRequest.parse_obj(obj)

        _obj = V1CreateOrganizationTargetRequest.parse_obj({
