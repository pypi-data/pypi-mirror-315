...
class V1SurveyInstruction(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1SurveyInstruction:
        """Create an instance of V1SurveyInstruction from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1SurveyInstruction:
        """Create an instance of V1SurveyInstruction from a dict"""
        if obj is None:
            return None
