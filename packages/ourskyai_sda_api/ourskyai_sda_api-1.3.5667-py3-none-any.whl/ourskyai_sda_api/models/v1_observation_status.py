...
class V1ObservationStatus(BaseModel):
    ...
    observation_time: datetime = Field(..., alias="observationTime")
    tle_line1: StrictStr = Field(..., alias="tleLine1", description="TLE line 1 of when the observation was tasked")
    tle_line2: StrictStr = Field(..., alias="tleLine2", description="TLE line 2 of when the observation was tasked")
    tle_epoch: datetime = Field(..., alias="tleEpoch")
    ...
    __properties = ["id", "targetId", "trackingType", "ra", "dec", "observationTime", "tleLine1", "tleLine2", "tleEpoch", "imageSetId", "observationSequenceResultId", "searchInstructionId", "surveyInstructionId", "completedAt", "state"]
