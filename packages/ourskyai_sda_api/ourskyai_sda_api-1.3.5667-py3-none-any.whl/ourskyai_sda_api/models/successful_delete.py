...
class SuccessfulDelete(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SuccessfulDelete:
        """Create an instance of SuccessfulDelete from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SuccessfulDelete:
        """Create an instance of SuccessfulDelete from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SuccessfulDelete.parse_obj(obj)

        _obj = SuccessfulDelete.parse_obj({
            "id": obj.get("id")
        })
        return _obj
