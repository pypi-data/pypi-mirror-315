...
class V1UpdateWebhookConfigurationRequest(BaseModel):
    """
    V1UpdateWebhookConfigurationRequest
    """
    id: StrictStr = Field(...)
    enabled: StrictBool = Field(...)
    __properties = ["id", "enabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateWebhookConfigurationRequest:
        """Create an instance of V1UpdateWebhookConfigurationRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateWebhookConfigurationRequest:
        """Create an instance of V1UpdateWebhookConfigurationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateWebhookConfigurationRequest.parse_obj(obj)

        _obj = V1UpdateWebhookConfigurationRequest.parse_obj({
            "id": obj.get("id"),
