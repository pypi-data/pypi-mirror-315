...
class V1CreateWebhookConfigurationRequest(BaseModel):
    """
    ...
    auth_type: Optional[WebhookAuthType] = Field(None, alias="authType")
    authorization: Optional[StrictStr] = None
    __properties = ["url", "secret", "events", "authType", "authorization"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateWebhookConfigurationRequest:
        """Create an instance of V1CreateWebhookConfigurationRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateWebhookConfigurationRequest:
        """Create an instance of V1CreateWebhookConfigurationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateWebhookConfigurationRequest.parse_obj(obj)

        _obj = V1CreateWebhookConfigurationRequest.parse_obj({
            "url": obj.get("url"),
