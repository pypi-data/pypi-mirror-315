...
import ourskyai_sda_api.models
from ourskyai_sda_api import rest
from ourskyai_sda_api.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/1.3.5667/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ourskyai_sda_api.models, klass)
