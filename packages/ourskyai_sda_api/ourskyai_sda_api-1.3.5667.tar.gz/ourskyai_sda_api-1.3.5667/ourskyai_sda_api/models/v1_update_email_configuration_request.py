...
class V1UpdateEmailConfigurationRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1UpdateEmailConfigurationRequest:
        """Create an instance of V1UpdateEmailConfigurationRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1UpdateEmailConfigurationRequest:
        """Create an instance of V1UpdateEmailConfigurationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1UpdateEmailConfigurationRequest.parse_obj(obj)

        _obj = V1UpdateEmailConfigurationRequest.parse_obj({
