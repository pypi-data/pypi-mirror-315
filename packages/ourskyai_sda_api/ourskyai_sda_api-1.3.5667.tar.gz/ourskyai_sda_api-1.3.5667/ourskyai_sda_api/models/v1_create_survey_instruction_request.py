...
class V1CreateSurveyInstructionRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateSurveyInstructionRequest:
        """Create an instance of V1CreateSurveyInstructionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateSurveyInstructionRequest:
        """Create an instance of V1CreateSurveyInstructionRequest from a dict"""
        if obj is None:
            return None
