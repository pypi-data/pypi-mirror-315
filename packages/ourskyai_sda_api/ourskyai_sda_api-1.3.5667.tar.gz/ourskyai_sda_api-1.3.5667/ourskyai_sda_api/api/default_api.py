...
class DefaultApi:
    ...
    @validate_arguments
    def v1_get_observation_statuses(self, target_id : Optional[StrictStr] = None, before : Optional[datetime] = None, search_instruction_id : Optional[StrictStr] = None, survey_instruction_id : Optional[StrictStr] = None, image_id : Optional[StrictStr] = None, **kwargs) -> List[V1ObservationStatus]:  # noqa: E501
        ...
        >>> thread = api.v1_get_observation_statuses(target_id, before, search_instruction_id, survey_instruction_id, image_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.v1_get_observation_statuses_with_http_info(target_id, before, search_instruction_id, survey_instruction_id, image_id, **kwargs)  # noqa: E501

    @validate_arguments
    def v1_get_observation_statuses_with_http_info(self, target_id : Optional[StrictStr] = None, before : Optional[datetime] = None, search_instruction_id : Optional[StrictStr] = None, survey_instruction_id : Optional[StrictStr] = None, image_id : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """v1_get_observation_statuses  # noqa: E501
        ...
        >>> thread = api.v1_get_observation_statuses_with_http_info(target_id, before, search_instruction_id, survey_instruction_id, image_id, async_req=True)
        >>> result = thread.get()
