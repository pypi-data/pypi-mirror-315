"""
KColorConverter: A library for converting colors between multiple formats.
...
- Customizable output formats:
  - Use format strings like 'III' for integer output or 'IIIF' for mixed integer-float output
    (e.g., (255, 0, 0, 0.5)).
...
__all__ = ["KColorFormat", "KColorConverter"]
