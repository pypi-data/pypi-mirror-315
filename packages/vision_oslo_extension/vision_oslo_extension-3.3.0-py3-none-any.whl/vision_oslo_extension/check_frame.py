...
class C03(BasePage):
    def __init__(self, parent, controller):
        ...
        explain = tk.Message(master=self.headframe, text = 'This will create a plot (A3 Picture format) of the OSLO network.',aspect = 1200, font = controller.text_font)
        explain.pack()

        explain1 = tk.Label(master=self.headframe, text = 'NOTE: Random Position Plot. Different plots for each run.', font = controller.text_font)
        explain1.pack()
