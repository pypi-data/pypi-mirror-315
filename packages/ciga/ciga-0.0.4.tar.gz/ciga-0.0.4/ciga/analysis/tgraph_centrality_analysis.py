...
def tgraph_degree(tgraph: TGraph, *,
    ...
    return sequential_analysis(tgraph, analysis_func=graph_degree, start=start, end=end, weighted=weighted,
                               w_normalized=w_normalized, normalized=normalized)
...
def tgraph_betweenness(tgraph: TGraph, *,
    ...
    return sequential_analysis(tgraph, analysis_func=graph_betweenness, start=start, end=end, weighted=weighted,
                               w_normalized=w_normalized, normalized=normalized, cutoff=cutoff, sources=sources,
                               targets=targets)
...
def tgraph_closeness(tgraph: TGraph, *,
    ...
    return sequential_analysis(tgraph, analysis_func=graph_closeness, start=start, end=end, weighted=weighted,
                               w_normalized=w_normalized, normalized=normalized, cutoff=cutoff)
...
def tgraph_eigenvector_centrality(tgraph: TGraph, *,
    ...
    return sequential_analysis(tgraph, analysis_func=graph_eigenvector_centrality, start=start, end=end,
                               weighted=weighted, scale=scale, return_eigenvalue=return_eigenvalue)
