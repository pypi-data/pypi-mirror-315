...
BCE_IP = b"x-bce-client-ip"

BCE_COOKIES = b"x-bce-client-cookies"
...
BOS_SERVER_SIDE_ENCRYPTION_CUSTOMER_KEY_MD5 = (
    b"x-bce-server-side-encryption-customer-key-md5"
)
...
# IAM HTTP Headers
X_AUTH_TOKEN = b"x-auth-token"
X_SUBJECT_TOKEN = b"x-subject-token"
