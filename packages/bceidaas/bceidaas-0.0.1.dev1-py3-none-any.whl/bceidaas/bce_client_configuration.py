...
import bceidaas.region
import bceidaas.protocol
from bceidaas import compat
from bceidaas.retry.retry_policy import BackOffRetryPolicy
...
DEFAULT_PROTOCOL = bceidaas.protocol.HTTP
DEFAULT_REGION = bceidaas.region.BEIJING
