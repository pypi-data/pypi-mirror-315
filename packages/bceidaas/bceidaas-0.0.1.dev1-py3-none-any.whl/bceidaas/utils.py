...
def convert_to_standard_string(input_string):
    ...
    #    return input_string.encode(bceidaas.DEFAULT_ENCODING)
...
def parse_host_port(endpoint, default_protocol):
    ...
    :type: bceidaas.protocol.HTTP or bceidaas.protocol.HTTPS
    ...
    if parse_result.scheme == compat.convert_to_bytes(bceidaas.protocol.HTTP.name):
        protocol = bceidaas.protocol.HTTP
        port = bceidaas.protocol.HTTP.default_port
    elif parse_result.scheme == compat.convert_to_bytes(bceidaas.protocol.HTTPS.name):
        protocol = bceidaas.protocol.HTTPS
        port = bceidaas.protocol.HTTPS.default_port
    else:
