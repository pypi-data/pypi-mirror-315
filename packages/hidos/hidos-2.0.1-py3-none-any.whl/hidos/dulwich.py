...
from sshsig0.allowed_signers import load_for_git_allowed_signers_file
from sshsig0.sshsig import do_verify
...
class _DulwichRepoFacade:
    def __init__(self, repo: dulwich.repo.Repo):
        self._repo = repo
...
class DulwichRevisionRecord(RevisionRecord):
    ...
    def _valid_child(self, parent_rev: DulwichRevisionRecord) -> bool:
        ...
        err = do_verify(crypto_msg, c.gpgsig, parent_rev.allowed_keys)
        return not isinstance(err, Exception)
