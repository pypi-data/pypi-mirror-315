...
class PagedResourceListOfProcessUpdateResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfProcessUpdateResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfProcessUpdateResult:
        """Create an instance of PagedResourceListOfProcessUpdateResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfProcessUpdateResult.parse_obj(obj)

        _obj = PagedResourceListOfProcessUpdateResult.parse_obj({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [ProcessUpdateResult.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
