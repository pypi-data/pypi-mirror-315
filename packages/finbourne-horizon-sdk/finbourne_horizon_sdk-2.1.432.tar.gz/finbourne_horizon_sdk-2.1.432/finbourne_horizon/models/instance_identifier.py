...
class InstanceIdentifier(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstanceIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstanceIdentifier:
        """Create an instance of InstanceIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstanceIdentifier.parse_obj(obj)

        _obj = InstanceIdentifier.parse_obj({
            "id": obj.get("id")
        })
        return _obj
