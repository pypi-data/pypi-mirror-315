...
class PagedResourceListOfVendorProduct(BaseModel):
    ...
    values: conlist(VendorProduct) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfVendorProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfVendorProduct:
        """Create an instance of PagedResourceListOfVendorProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfVendorProduct.parse_obj(obj)

        _obj = PagedResourceListOfVendorProduct.parse_obj({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [VendorProduct.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
