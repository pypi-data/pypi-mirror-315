...
class PagedResourceListOfProcessInformation(BaseModel):
    ...
    values: conlist(ProcessInformation) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfProcessInformation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfProcessInformation:
        """Create an instance of PagedResourceListOfProcessInformation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfProcessInformation.parse_obj(obj)

        _obj = PagedResourceListOfProcessInformation.parse_obj({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [ProcessInformation.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
