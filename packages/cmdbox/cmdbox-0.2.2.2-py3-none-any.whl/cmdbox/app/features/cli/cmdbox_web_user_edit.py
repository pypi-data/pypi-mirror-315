    ...
    def get_option(self):
        ...
        return dict(
            ...
            choise=[
                ...
                dict(opt="user_pass", type="str", default=None, required=False, multi=False, hide=False, choise=None,
                     discription_ja="ユーザーパスワードを指定します。",
                     discription_en="Specify the user password."),
                dict(opt="user_pass_hash", type="str", default='sha1', required=False, multi=False, hide=False, choise=['plain', 'md5', 'sha1', 'sha256'],
                     discription_ja="ユーザーパスワードのハッシュアルゴリズムを指定します。",
                     discription_en="Specifies the hash algorithm for user passwords."),
                dict(opt="user_group", type="str", default=None, required=True, multi=True, hide=False, choise=None,
