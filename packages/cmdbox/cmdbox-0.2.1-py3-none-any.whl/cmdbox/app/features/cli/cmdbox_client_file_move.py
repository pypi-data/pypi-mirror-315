...
class ClientFileMove(Feature):
    ...
    def get_option(self):
        ...
        return dict(
            ...
            discription_ja="サーバー側のデータフォルダ配下のファイルを移動します。",
            discription_en="Move the files under the data folder on the server side.",
            choise=[
                ...
                dict(opt="from_path", type="str", default=None, required=True, multi=False, hide=False, choise=None,
                        discription_ja="サーバーのデータフォルダ以下の移動元パスを指定します。",
                        discription_en="Specify the move source path under the data folder of the inference server.",
                ...
                dict(opt="to_path", type="str", default=None, required=True, multi=False, hide=False, choise=None,
                        discription_ja="サーバーのデータフォルダ以下の移動先パスを指定します。",
                        discription_en="Specify the path to move under the data folder of the inference server.",
    ...
    def file_move(self, reskey:str, from_path:str, to_path:str,
        ...
        try:
            ...
            redis_cli.rpush(reskey, {"warn": f"Failed to move file: {e}"})
