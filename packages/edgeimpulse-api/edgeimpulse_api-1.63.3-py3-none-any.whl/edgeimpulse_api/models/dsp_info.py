...
class DSPInfo(BaseModel):
    ...
    __properties = ["id", "name", "windowLength", "type", "classes", "features", "expectedWindowCount", "inputAxes", "performance", "canCalculateFeatureImportance", "calculateFeatureImportance", "hasAutoTune", "minimumVersionForAutotune", "hasAutotunerResults", "usesState"]
