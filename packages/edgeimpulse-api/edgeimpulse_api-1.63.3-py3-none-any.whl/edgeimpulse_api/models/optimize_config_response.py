...
class OptimizeConfigResponse(BaseModel):
    ...
    optimization_objectives: Optional[List[StrictStr]] = Field(None, alias="optimizationObjectives", description="Hyperparameter optimization objectives ordered by priority")
    ...
    def from_dict(cls, obj: dict) -> OptimizeConfigResponse:
        ...
        _obj = OptimizeConfigResponse.construct(**{
            ...
            "optimization_objectives": obj.get("optimizationObjectives"),
