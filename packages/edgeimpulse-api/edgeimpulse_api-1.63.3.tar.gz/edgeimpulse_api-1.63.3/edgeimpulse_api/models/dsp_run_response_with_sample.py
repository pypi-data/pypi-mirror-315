...
class DspRunResponseWithSample(BaseModel):
    ...
    __properties = ["success", "error", "features", "graphs", "labels", "state_string", "labelAtEndOfWindow", "sample", "performance", "canProfilePerformance"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DspRunResponseWithSample:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DspRunResponseWithSample:
        """Create an instance of DspRunResponseWithSample from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DspRunResponseWithSample.construct(**obj)

        _obj = DspRunResponseWithSample.construct(**{
