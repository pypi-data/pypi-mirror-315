...
from odoo.addons.somconnexio.otrs_factories.base_data_from_crm_lead_line import (
    BaseDataFromCRMLeadLine,
)
...
class SwitchboardDataFromCRMLeadLine(BaseDataFromCRMLeadLine):
    ...
    def build(self):
        ...
        sb_data.update(
            {
                ...
                "landline_2": self.isp_info.phone_number_2,
        ...
        return SwitchboardData(**sb_data)
