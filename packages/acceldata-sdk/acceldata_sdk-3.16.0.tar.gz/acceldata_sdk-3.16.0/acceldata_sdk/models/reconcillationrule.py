...
class ReconciliationRule:
    def __init__(self, name=None, description=None, type=None, enabled=None, schedule=None, scheduled=None,
                 notificationChannels=None, leftBackingAsset=None,
                 rightBackingAsset=None, timeSecondsOffset=None, createdAt=None, updatedAt=None, thresholdLevel=None,
                 archived=None, archivalReason=None,
                 tenantId=None, createdBy=None, lastUpdatedBy=None, tags=None, version=None, executorConfig=None,
                 labels=None, isProtectedResource=None,
                 policyGroups=None, id=None, sparkResourceConfig=None, *args, **kwargs):
        self.id = id
        self.name = name
        ...
        if isinstance(sparkResourceConfig, dict):
            self.sparkResourceConfig = SparkResourceConfig(**executorConfig)
        else:
