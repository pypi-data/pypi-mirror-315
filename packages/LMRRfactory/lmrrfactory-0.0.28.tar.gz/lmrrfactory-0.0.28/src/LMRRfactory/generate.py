        ...
        for mech_rxn in data['mech']['reactions']:
            ...
            # rxn is specifically covered either in defaults or user input
                ...
                for col in data['defaults']['generic-colliders']:
                    if col['name'] in speciesList and col['name'] not in extras_keys:
                ...
                extras_keys = {col['name'] for col in extras}
                filtered_colliders = [col for col in colliders if col['name'] not in extras_keys]
                newRxn['colliders'] = [colliderM] + filtered_colliders + extras
                newData['reactions'].append(newRxn)
