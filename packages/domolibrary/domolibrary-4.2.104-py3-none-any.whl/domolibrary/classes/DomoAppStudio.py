...
# %% ../../nbs/classes/50_DomoAppStudio.ipynb 9
@dataclass
...
# %% ../../nbs/classes/50_DomoAppStudio.ipynb 13
@patch_to(DomoAppStudio, cls_method=True)
async def _from_content_stacks_v3(cls: DomoAppStudio, page_obj, auth: dmda.DomoAuth = None):
...
async def get_by_id(
    ...
    res = await appstudio_routes.get_apstudio_by_id(
        auth=auth, appstudio_id=appstudio_id, debug_api=debug_api
    )
    ...
    aps = await cls._from_content_stacks_v3(page_obj=res.response, auth=auth)
...
# %% ../../nbs/classes/50_DomoAppStudio.ipynb 23
@patch_to(DomoAppStudio, cls_method=True)
