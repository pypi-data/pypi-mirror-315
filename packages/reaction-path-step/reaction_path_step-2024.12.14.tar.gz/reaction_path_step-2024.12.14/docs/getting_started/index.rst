...
Installation
============
The Reaction Path step is probably already installed in your SEAMM
...
check for `reaction-path-step`. If it is not installed, or
...
The non-graphical installer is also straightforward::
  ...
  seamm-installer install --update reaction-path-step
