...
class ReactionPathStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Reaction Path step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return reaction_path_step.ReactionPath(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return reaction_path_step.TkReactionPath(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return ReactionPathStep.my_description
