...
class UserDetails(ModelNormal):
    ...
    validations = {
        ...
        ('preferred_username',): {
            'max_length': 50,
            'regex': {
                'pattern': r'^[A-Za-z0-9]{3,50}$',  # noqa: E501
            },
        },
        ('phone',): {
            'max_length': 30,
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, password, email, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, password, email, *args, **kwargs):  # noqa: E501
        """UserDetails - a model defined in OpenAPI
