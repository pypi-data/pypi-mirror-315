...
# XXX: The following "ruff" directive silences the warnings because the imports
# are not at the beginning of the file, because we are changing the warning
# level first.
...
PROGRAM = sys.argv[0]
min_version = packaging.version.parse('62.1.0')
if packaging.version.parse(setuptools.__version__) >= min_version:
