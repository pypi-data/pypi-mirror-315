...
class DeviceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ShutDownAndRestartDevice = channel.unary_unary(
                '/t2iapi.device.DeviceService/ShutDownAndRestartDevice',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
                )
...
class DeviceServiceServicer(object):
    ...
    def ShutDownAndRestartDevice(self, request, context):
        """
...
def add_DeviceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ShutDownAndRestartDevice': grpc.unary_unary_rpc_method_handler(
                    servicer.ShutDownAndRestartDevice,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=t2iapi_dot_basic__responses__pb2.BasicResponse.SerializeToString,
            ),
    }
...
class DeviceService(object):
    ...
    @staticmethod
    def ShutDownAndRestartDevice(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/t2iapi.device.DeviceService/ShutDownAndRestartDevice',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            t2iapi_dot_basic__responses__pb2.BasicResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
