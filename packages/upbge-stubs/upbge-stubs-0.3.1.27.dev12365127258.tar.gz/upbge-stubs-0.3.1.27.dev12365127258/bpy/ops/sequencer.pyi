...
def effect_strip_add(*args, type: str = 'CROSS', frame_start: int = 0, frame_end: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, color: mathutils.Color = (0.0, 0.0, 0.0)) -> None:
...
def mask_strip_add(*args, frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, mask: str = '') -> None:
...
def movieclip_strip_add(*args, frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, clip: str = '') -> None:
...
def paste(*args, keep_offset: bool = False) -> None:
...
def scene_strip_add(*args, frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, scene: str = '') -> None:
...
def scene_strip_add_new(*args, frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, type: str = 'NEW') -> None:
...
def select(*args, wait_to_deselect_others: bool = False, mouse_x: int = 0, mouse_y: int = 0, extend: bool = False, deselect: bool = False, toggle: bool = False, deselect_all: bool = False, select_passthrough: bool = False, center: bool = False, linked_handle: bool = False, linked_time: bool = False, side_of_frame: bool = False, ignore_connections: bool = False) -> None:
...
def select_handle(*args, wait_to_deselect_others: bool = False, mouse_x: int = 0, mouse_y: int = 0, ignore_connections: bool = False) -> None:
...
def slip(*args, offset: float = 0.0) -> None:
...
def split(*args, frame: int = 0, channel: int = 0, type: str = 'SOFT', use_cursor_position: bool = False, side: str = 'MOUSE', ignore_selection: bool = False) -> None:
