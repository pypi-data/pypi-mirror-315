...
class TrainMethylationInteract(object):
    """
    ...
    def train(self):
        ...
        with torch.autograd.set_detect_anomaly(True):
            ...
            inputs = torch.Tensor(inputs).int()
            ...
            reg_pred = self.model(inputs)
            reg_loss = self.criterion(reg_pred, targets)
    ...
    def validate(self):
        ...
        if validation_loss < self._min_loss:
            ...
            self._save_checkpoint({
                ...
                "min_loss": self._min_loss,
                "optimizer": self.optimizer.state_dict(),
                "scheduler": self.scheduler.state_dict()}, True)
