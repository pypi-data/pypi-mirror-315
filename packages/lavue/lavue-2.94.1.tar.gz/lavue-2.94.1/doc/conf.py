...
html_context = {
    "docs_versions" : [
        "v2.94.1", "v2.94.0", "v2.93.1", "v2.93.0",
        "v2.92.2", "v2.92.1", "v2.92.0", "v2.91.1",
...
latex_documents = [
  ('index', 'lavuelib.tex', u'lavuelib Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    ('index', 'lavuelib', u'lavuelib Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
  ('index', 'lavuelib', u'lavuelib Documentation',
   u'Author', 'lavuelib', 'One line description of project.',
   'Miscellaneous'),
]
