...
def collect(mode, start_date=None, end_date=None, url=None, title=None, output_path=None,
    ...
    if mode not in ['date_range', 'date', 'title', 'url', 'existing', 'editor_extraction']:
        raise ValueError("Invalid mode. Choose from ['date_range', 'date', 'title', 'url', 'existing', 'editor_extraction']")
