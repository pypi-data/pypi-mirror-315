...
from utils.collect_editor_stats import collect_editor_info
import pandas as pd
...
def collect(mode, start_date=None, end_date=None, url=None, title=None, output_path=None,
    ...
    if mode not in ['date_range', 'date', 'title', 'url', 'existing']:
        raise ValueError("Invalid mode. Choose from ['date_range', 'date', 'title', 'url', 'existing']")
