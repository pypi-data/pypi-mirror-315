...
setuptools.setup(
    name="certora-cli-alpha-rahav-support_external_build_rahav",
    version="20241216.17.42.449636",
    author="Certora",
    author_email="support@certora.com",
    description="Runner for the Certora Prover",
    long_description="Commit b29dcd2.                    Build and Run scripts for executing the Certora Prover on Solidity smart contracts.",
    long_description_content_type="text/markdown",
    url="https://pypi.org/project/certora-cli-alpha-rahav-support_external_build_rahav",
