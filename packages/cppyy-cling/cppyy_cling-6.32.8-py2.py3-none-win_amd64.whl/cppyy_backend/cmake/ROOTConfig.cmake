...
#
set(ROOT_DEFINITIONS "-D_WINDOWS;-DWIN32;-D_AMD64_;-D_WIN32;-D_XKEYCHECK_H;-D_LIBCPP_HAS_NO_PRAGMA_SYSTEM_HEADER;-DNOMINMAX;-D_CRT_SECURE_NO_WARNINGS")
set(ROOT_CXX_FLAGS "-nologo -IC:/Users/Code/cppyy-backend/cling/src/build/win -FIw32pragma.h -FIsehmap.h -MD -D_WINDOWS -DWIN32 -D_AMD64_ -EHsc- -wd4141 -wd4291 -wd4244 -wd4049 -wd4146 -D_WIN32  -D_XKEYCHECK_H -D_LIBCPP_HAS_NO_PRAGMA_SYSTEM_HEADER -DNOMINMAX -D_CRT_SECURE_NO_WARNINGS ")
set(ROOT_C_FLAGS "-nologo -IC:/Users/Code/cppyy-backend/cling/src/build/win -FIw32pragma.h -FIsehmap.h -MD -D_WINDOWS -DWIN32 -D_AMD64_ -EHsc- -D_LIBCPP_HAS_NO_PRAGMA_SYSTEM_HEADER -DNOMINMAX ")
set(ROOT_fortran_FLAGS "")
set(ROOT_EXE_LINKER_FLAGS "/machine:x64")
...
# ROOT configured for the install with relative paths, so use these
get_filename_component(ROOT_BINDIR "${_thisdir}/../bin" ABSOLUTE)
...
set(_root_enabled_options  builtin_clang builtin_llvm builtin_zlib shared)
set(_root_all_options  builtin_clang builtin_llvm builtin_zlib cuda cudnn cxxmodules exceptions gnuinstall libcxx rpath runtime_cxxmodules shadowpw shared soversion winrtdebug)
...
foreach(CoreLegacy RIOLegacy ThreadLegacy ${ROOT_FIND_COMPONENTS})
