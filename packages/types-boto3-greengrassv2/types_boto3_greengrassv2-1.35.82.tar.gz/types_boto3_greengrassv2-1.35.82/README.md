<a id="types-boto3-greengrassv2"></a>

# types-boto3-greengrassv2

[![PyPI - types-boto3-greengrassv2](https://img.shields.io/pypi/v/types-boto3-greengrassv2.svg?color=blue)](https://pypi.org/project/types-boto3-greengrassv2/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-greengrassv2.svg?color=blue)](https://pypi.org/project/types-boto3-greengrassv2/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-greengrassv2)](https://pypistats.org/packages/types-boto3-greengrassv2)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 GreengrassV2 1.35.82](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-greengrassv2 docs](https://youtype.github.io/types_boto3_docs/types_boto3_greengrassv2/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-greengrassv2](#types-boto3-greengrassv2)
...
- Install `types-boto3[greengrassv2]` in your environment:
...
- Install `types-boto3[greengrassv2]` with services you use in your
  environment:
...
`types-boto3-greengrassv2` dependency in production. However, there is an issue
...
`types_boto3_greengrassv2.paginator` module contains type annotations for all
paginators.
...
from types_boto3_greengrassv2 import GreengrassV2Client
from types_boto3_greengrassv2.paginator import (
...
`types_boto3_greengrassv2.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `GreengrassV2` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_greengrassv2/literals/).
...
`types_boto3_greengrassv2.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `GreengrassV2` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_greengrassv2/type_defs/).
...
`types-boto3-greengrassv2` version is the same as related `boto3` version and
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_greengrassv2/)
