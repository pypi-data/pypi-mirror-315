...
class S3Manager:
    def __init__(self, aws_access_key_id, aws_secret_access_key, bucket_name, s3_path, file_name, region_name="ap-northeast-2", log_level='INFO',custom_version_id=None):
        """
        S3Manager 객체 초기화
