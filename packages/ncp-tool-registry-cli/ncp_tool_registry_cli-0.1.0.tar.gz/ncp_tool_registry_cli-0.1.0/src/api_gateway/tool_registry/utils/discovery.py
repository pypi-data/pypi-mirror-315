...
def get_endpoint_schemas_and_components(path: str, methods: List[str], base_url=None, spec=None):
    ...
    for method in methods:
        if method in path_details:
            method_schema = path_details[method]
            response_schemas[method] = method_schema.pop("responses", None)
            ...
            used_components = get_used_components(method_schema, spec["components"])
            components.update(used_components)
