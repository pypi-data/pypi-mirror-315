...
EVR assigns persistent identifiers (PIDs) to make referencing venues FAIR.
This is similar to how ORCID assigns PIDs to researchers and ROR assigns PIDs to research organizations.
...
[PyPI](https://pypi.org/project/evr/) with:
...
to https://zenodo.org/account/settings/github/repository/cthoyt/evr
...
1. Uses [bump-my-version](https://github.com/callowayproject/bump-my-version) to switch the version number in
   the `pyproject.toml`, `CITATION.cff`, `src/evr/version.py`,
...
1. Navigate
   to https://github.com/cthoyt/evr/releases/new
