...
OTEL_TRACES_EXPORTER: Literal["otlp", "console", "file"] | None = os.environ.get(
    "OTEL_TRACES_EXPORTER"
)
OTEL_EXPORTER_OTLP_PROTOCOL: Literal["grpc", "http/protobuf"] | None = os.environ.get(
...
OTEL_SERVICE_NAME: str | None = os.getenv("OTEL_SERVICE_NAME", "unknown-service")
