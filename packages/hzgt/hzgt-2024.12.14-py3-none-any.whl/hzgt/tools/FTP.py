...
class Ftpserver:
    ...
    def set_log(self, logfilename: str = "ftp.log", level=logging.INFO, encoding="utf-8"):
        """
        + level
            * logging.CRITICAL
            * logging.FATAL
        ...
        :return:
        """
        logfilename = logfilename if logfilename else "ftp.log"
    ...
    def start(self, host_res: str = "127.0.0.1", port: int = 2121,
        ...
        server = FTPServer((host_res, port), self.__handler)
