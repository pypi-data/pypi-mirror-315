...
def _parse_response(*, client: Client, response: httpx.Response) -> EventTypeExampleOut:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[EventTypeExampleOut]:
    return Response(
