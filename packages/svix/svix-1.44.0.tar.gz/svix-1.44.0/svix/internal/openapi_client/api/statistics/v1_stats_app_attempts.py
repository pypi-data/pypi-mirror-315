...
def request_sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        start_date (Union[Unset, None, datetime.datetime]): Filter the range to data starting from
            this date
        end_date (Union[Unset, None, datetime.datetime]): Filter the range to data ending by this
            date
