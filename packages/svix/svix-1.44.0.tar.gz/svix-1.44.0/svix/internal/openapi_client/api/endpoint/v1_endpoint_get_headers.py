...
def _parse_response(*, client: Client, response: httpx.Response) -> EndpointHeadersOut:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[EndpointHeadersOut]:
    return Response(
