...
from ...models.rotated_url_out import RotatedUrlOut
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/app/{app_id}/inbound/rotate-url".format(client.base_url, app_id=app_id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> RotatedUrlOut:
    if response.status_code == HTTPStatus.OK:
        response_200 = RotatedUrlOut.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[RotatedUrlOut]:
    return Response(
