...
from ...models.o_auth_payload_out import OAuthPayloadOut
...
def _get_kwargs(
    *,
    ...
    url = "{}/api/v1/transformation-template/oauth/hubspot".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> OAuthPayloadOut:
    if response.status_code == HTTPStatus.OK:
        response_200 = OAuthPayloadOut.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[OAuthPayloadOut]:
    return Response(
