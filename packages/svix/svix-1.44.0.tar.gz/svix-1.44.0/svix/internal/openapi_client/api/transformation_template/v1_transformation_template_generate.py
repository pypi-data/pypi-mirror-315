...
from ...models.generate_out import GenerateOut
...
def _get_kwargs(
    *,
    ...
    json_body: GenerateIn,
    idempotency_key: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/api/v1/transformation-template/generate".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> GenerateOut:
    if response.status_code == HTTPStatus.OK:
        response_200 = GenerateOut.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[GenerateOut]:
    return Response(
