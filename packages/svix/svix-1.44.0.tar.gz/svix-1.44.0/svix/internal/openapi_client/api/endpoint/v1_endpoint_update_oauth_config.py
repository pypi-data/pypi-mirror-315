...
from ...models.endpoint_oauth_config_in import EndpointOauthConfigIn
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: EndpointOauthConfigIn,
) -> Dict[str, Any]:
    url = "{}/api/v1/app/{app_id}/endpoint/{endpoint_id}/oauth".format(
