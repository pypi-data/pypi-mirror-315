...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/v1/app/{app_id}/events/{sink_id}".format(client.base_url, app_id=app_id, sink_id=sink_id)
...
def request_sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sink_id (str): The ep's ID Example: ep_1srOrx2ZWZBpBUvZwXKQmoEYga2.
        ...
        event_type (Union[Unset, None, str]): Filters messages sent with this event type
            (optional). Example: user.signup.
        channel (Union[Unset, None, str]): Filters messages sent with this channel (optional).
