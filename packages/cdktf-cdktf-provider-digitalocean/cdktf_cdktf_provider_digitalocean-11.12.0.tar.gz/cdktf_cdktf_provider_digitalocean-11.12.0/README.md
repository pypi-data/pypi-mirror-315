# CDKTF prebuilt bindings for digitalocean/digitalocean provider version 2.46.0

This repo builds and publishes the [Terraform digitalocean provider](https://registry.terraform.io/providers/digitalocean/digitalocean/2.46.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform digitalocean provider](https://registry.terraform.io/providers/digitalocean/digitalocean/2.46.0)
