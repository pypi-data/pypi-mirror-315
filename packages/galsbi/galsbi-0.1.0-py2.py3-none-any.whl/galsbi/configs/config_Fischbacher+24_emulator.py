...
plugins = [
    ...
    Loop(
        [
            ...
            "ufig.plugins.write_catalog_for_emu",
        ],
        stop=FiltersStopCriteria(),
    ),
    "ufig.plugins.run_emulator",
...
# emulator
path2emu = data_path("emulator_fischbacher24")
clf, nflow = load_emulator(
    path2emu,
    bands=None,
)
emu_conf = file_utils.read_yaml(os.path.join(path2emu, "config_emu.yaml"))
emu_mini = True
