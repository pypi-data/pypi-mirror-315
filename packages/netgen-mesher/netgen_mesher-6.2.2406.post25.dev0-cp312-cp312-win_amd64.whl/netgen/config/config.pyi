...
NETGEN_VERSION: str = '6.2.2406-25-g0bb738b2'
NETGEN_VERSION_GIT: str = 'v6.2.2406-25-g0bb738b2'
NETGEN_VERSION_HASH: str = 'g0bb738b2'
NETGEN_VERSION_MAJOR: str = '6'
NETGEN_VERSION_MINOR: str = '2'
NETGEN_VERSION_PATCH: str = '2406'
NETGEN_VERSION_PYTHON: str = '6.2.2406.post25.dev0'
NETGEN_VERSION_TWEAK: str = '25'
...
ngcore_compile_definitions: str = 'NETGEN_PYTHON;NG_PYTHON;PYBIND11_SIMPLE_GIL_MANAGEMENT;_WIN32_WINNT=0x1000;WNT;WNT_WINDOW;NOMINMAX;MSVC_EXPRESS;_CRT_SECURE_NO_WARNINGS;HAVE_STRUCT_TIMESPEC;WIN32;PARALLEL;NG_MPI_WRAPPER'
ngcore_compile_options: str = '/arch:AVX2;/bigobj;$<BUILD_INTERFACE:/MP;/W1;/wd4068>'
version: str = 'v6.2.2406-25-g0bb738b2'
