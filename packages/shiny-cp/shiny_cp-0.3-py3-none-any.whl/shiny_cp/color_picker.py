...
color_picker_deps = HTMLDependency(
    "shiny_cp",
    "1.0.0",
    source={
        "package": "shiny_cp",
...
# Output component
class render_color_picker(Renderer[str]):
    """
    ...
    def auto_output_ui(self) -> Tag:
        return output_color_picker(self.output_id)

    # # There are no parameters being supplied to the `output_color_picker` rendering function.
...
def output_color_picker(id: str):
    """
    Show a color
    """
    return Tag(
