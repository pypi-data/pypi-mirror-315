...
from globaleaks_ephemeral_fs import EphemeralFile, EphemeralOperations
...
class TestEphemeralOperations(unittest.TestCase):
    ...
    def test_getattr_file(self):
        ...
        # Create a new file
        file_path = '/testfile'
        self.operations.create(file_path, mode=0o660)
        file = self.operations.files[file_path]

        # Retrieve file attributes
        attr = self.operations.getattr(file_path)
