...
from ptools_base.tool import ASSERT_PATH_KEY, EXTRACT_PATH_KEY, ENV_PATH_KEY, write_asserts, copy_2_extra, write_envs
...
os.environ[EXTRACT_PATH_KEY] = EXTRA_DST_PATH
