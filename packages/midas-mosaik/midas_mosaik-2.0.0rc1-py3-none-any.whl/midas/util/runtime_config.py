...
DEFAULT_BASE_CONFIG = {
    ...
    "data": {
        ...
        "simbench": [
            {"name": "1-LV-rural3--0-sw.csv", "load_on_start": True}
        ],
        #     "smart_nord": [
        ...
        "weather": [
            {
                ...
                "pressure_url": (
                    "pressure/historical/stundenwerte_P0_00691_" "19490101_"
                ),
    ...
    "modules": {
        "default_modules": [
            ...
            # ["powergrid", "midas.modules.powergrid.module:PowergridModule"],
            ["sbdata", "midas_sbdata.module:SimbenchDataModule"],
