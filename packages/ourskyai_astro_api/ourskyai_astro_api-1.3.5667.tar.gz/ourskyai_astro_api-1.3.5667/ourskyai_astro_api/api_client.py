...
import ourskyai_astro_api.models
from ourskyai_astro_api import rest
from ourskyai_astro_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ourskyai_astro_api.models, klass)
