...
class V1CreateCalibrationSetRequest(BaseModel):
    """
    V1CreateCalibrationSetRequest
    """
    node_id: StrictStr = Field(..., alias="nodeId")
    calibration_set_type: CalibrationMasterType = Field(..., alias="calibrationSetType")
    ...
    __properties = ["nodeId", "calibrationSetType", "filterType", "binXY", "gain", "readoutMode", "temperature", "exposureTime", "rotatorAngle", "offset", "capturedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CreateCalibrationSetRequest:
        """Create an instance of V1CreateCalibrationSetRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CreateCalibrationSetRequest:
        """Create an instance of V1CreateCalibrationSetRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CreateCalibrationSetRequest.parse_obj(obj)

        _obj = V1CreateCalibrationSetRequest.parse_obj({
            "node_id": obj.get("nodeId"),
            "calibration_set_type": obj.get("calibrationSetType"),
