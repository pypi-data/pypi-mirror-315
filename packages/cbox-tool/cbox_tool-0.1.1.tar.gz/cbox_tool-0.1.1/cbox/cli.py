...
def cli():
    ...
    快速开始:
        $ cbox add workspace1 ~/projects/workspace1  # 添加工作空间
        $ cbox list                                 # 查看工作空间
        $ cbox clone workspace1 <repo-url>          # 克隆仓库
    
    详细文档请访问: https://github.com/yourusername/cbox
    """
    pass
...
def add(name, path):
    ...
    示例:
        $ cbox add dev ~/projects/dev
        $ cbox add work ~/workspace
    """
...
def remove_workspace(workspace):
    ...
    """
    MyBox().remove_workspace(workspace)
...
def remove_repo(workspace, repo_name):
    ...
    """
    MyBox().remove_repo(workspace, repo_name)
