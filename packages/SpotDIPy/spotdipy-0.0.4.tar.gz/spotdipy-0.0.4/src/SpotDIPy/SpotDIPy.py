...
class SpotDIPy:
    ...
    def objective_func(self, x0s, alpha, beta, gamma, delta, lmbd, cpcs):
        ...
        # """"""
        # total_fsc = jnp.sum(fssc * wp)
        # total_fsh = jnp.sum(fssh * wp)
        #
        # aa = 20 * (total_fsc + total_fsh)
        # """"""
    ...
    def grid_search(self, fit_params, opt_params=None, info=True, save=False):
        ...
        def grid_search_run(fpmg):
            ...
            for j, item in enumerate(chisq_grid):
                ...
                elif item == 'rv_amp' and 'line' in self.conf:
                ...
                elif item == 'lc_amp' and 'lc' in self.conf:
