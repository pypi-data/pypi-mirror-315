...
class Services(Elements):
    ...
    def _update_one_managed(self, service_url):
        ...
        list_managed = self.request.get_in_python(
            self.url_manager.managed_services_url()
        )
    ...
    def _build_all(self, service_access=""):
        ...
        """
        node_info_url = self.url_manager.services_children_url(
    ...
    def all(self):
        ...
        self._update()
        return sorted(
            self._elements.values(), key=lambda service: service.access_url.lower()
        )
    ...
    def _create_service(self, service_url):
        ...
        user_filters = []
        if 'userFilters' in service:
            user_filters = service['userFilters']
        ...
        return Service(
            service.get("portalItemId", ""),
            service_url,
            service.get("capabilities", ""),
            is_managed=is_managed,
            is_cadastre_resource=is_cadastre_resource,
