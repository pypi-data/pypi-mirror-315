...
class HelpScreen(ModalScreen[None]):
    ...
    def __init__(self, slurms: list[Slurm], config: Config, *args: Any, **kwargs: Any) -> None:
    ...
    def compose(self) -> ComposeResult:
        with VerticalScroll():
            ...
            yield Static(Markdown('  \n'.join(
                [
                    '# Contact'
                    , ' - Created by [Patrick de Koning](https://www.linkedin.com/in/patrick-de-koning-3b99a22/) and [Prerak Mody](https://www.linkedin.com/in/prerakmody/)'
