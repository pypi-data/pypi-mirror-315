...
from deeporigin_data._utils import PropertyInfo
from deeporigin_data._compat import PYDANTIC_V2, parse_obj, model_dump, model_json
from deeporigin_data._models import BaseModel, construct_type
