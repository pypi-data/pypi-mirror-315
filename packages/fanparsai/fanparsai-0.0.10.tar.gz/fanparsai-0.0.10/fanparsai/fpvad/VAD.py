...
class VAD:
    ...
    def process_audio(self, path_audio: str, save_path: str = None, sr: int = 16000, batch_size: int = 32):
        ...
        save_path = "output/output.flac"  # Adjust the path as needed
...
# Ensure the directory exists
        ...
        try:
            save_path.write(save_path, voiced_chunked_sig, sr)
        except FileNotFoundError:
            print(f"Error: Cannot find or create the file at '{save_path}'")
