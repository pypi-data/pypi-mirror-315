...
class DatabaseWrapper(base.DatabaseWrapper):
    ...
    def get_connection_params(self):
        ...
        # django_informixdb_dev expects USER and PASSWORD, so fake them for now
        ...
        setattr(thread_locals, 'VAULT_USERNAME', username)
        setattr(thread_locals, 'VAULT_PASSWORD', password)
