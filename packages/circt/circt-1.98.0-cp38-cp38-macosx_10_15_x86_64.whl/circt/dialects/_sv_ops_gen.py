...
class AlwaysOp(_ods_ir.OpView):
  ...
  def __init__(self, events, clocks, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_558')) else
      _ods_ir.AttrBuilder.get('anonymous_558')(events, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, module_type, *, per_argument_attrs=None, input_locs=None, result_locs=None, verilogName=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_621')) else
      _ods_ir.AttrBuilder.get('anonymous_621')(module_type, context=_ods_context))
