...
class BagDifferenceOp(_ods_ir.OpView):
  ...
  def __init__(self, original, diff, *, inf=None, loc=None, ip=None):
    ...
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(original))
    operands.append(_get_op_result_or_value(diff))
    _ods_context = _ods_get_default_loc_context(loc)
...
class BagSelectRandomOp(_ods_ir.OpView):
  ...
  def __init__(self, bag, *, loc=None, ip=None):
    ...
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(bag))
    _ods_context = _ods_get_default_loc_context(loc)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
@_ods_cext.register_operation(_Dialect)
class InvokeSequenceOp(_ods_ir.OpView):
  OPERATION_NAME = "rtg.invoke_sequence"
...
def invoke_sequence(sequence, *, loc=None, ip=None) -> _ods_ir.Operation:
  return InvokeSequenceOp(sequence=sequence, loc=loc, ip=ip)

@_ods_cext.register_operation(_Dialect)
class SequenceClosureOp(_ods_ir.OpView):
  OPERATION_NAME = "rtg.sequence_closure"

  _ODS_REGIONS = (0, True)

  def __init__(self, sequence, args, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def sequence_closure(sequence, args, *, loc=None, ip=None) -> _ods_ir.Value:
  return SequenceClosureOp(sequence=sequence, args=args, loc=loc, ip=ip).result
...
def sequence(sym_name, *, loc=None, ip=None) -> _ods_ir.Operation:
  return SequenceOp(sym_name=sym_name, loc=loc, ip=ip)
...
class SetSelectRandomOp(_ods_ir.OpView):
  ...
  def __init__(self, set, *, loc=None, ip=None):
    ...
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(set))
    _ods_context = _ods_get_default_loc_context(loc)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class TargetOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, target, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_392')) else
      _ods_ir.AttrBuilder.get('anonymous_392')(target, context=_ods_context))
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
