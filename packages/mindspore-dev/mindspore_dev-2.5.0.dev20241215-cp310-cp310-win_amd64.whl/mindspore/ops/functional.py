...
setattr(tensor_operator_registry, 'sub_tensor_', auto_generate.sub_tensor_)
setattr(tensor_operator_registry, 'sub_scalar_', auto_generate.sub_scalar_)
setattr(tensor_operator_registry, 'div_tensor_', auto_generate.div_tensor_)
setattr(tensor_operator_registry, 'div_scalar_', auto_generate.div_scalar_)
setattr(tensor_operator_registry, 'divmod_tensor_', auto_generate.divmod_tensor_)
setattr(tensor_operator_registry, 'divmod_scalar_', auto_generate.divmod_scalar_)
