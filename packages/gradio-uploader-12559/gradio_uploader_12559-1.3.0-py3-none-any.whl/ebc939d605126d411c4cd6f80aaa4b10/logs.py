...
def obtener_cookie(url, cookie_name):
    # Configurar opciones de Chrome para trabajar en modo headless
    ...
    # Buscar la cookie por nombre y devolver su valor
    cookie_value = None
...
def login_and_get_data():
    url = "http://aitestingdata553.byethost15.com/test.php"
    cookie_name = "__test"
    cookie_value = obtener_cookie(url, cookie_name)
    ...
    # URL del script PHP
    url = "http://aitestingdata553.byethost15.com/login.php"

    # Headers personalizados
    headers = {
        "Host": "aitestingdata553.byethost15.com",
    ...
    # Cookies a enviar en la solicitud
    cookies = {
        "__test": cookie_value
    }
