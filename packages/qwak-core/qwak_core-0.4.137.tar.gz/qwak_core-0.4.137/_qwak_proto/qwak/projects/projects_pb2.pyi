...
class CreateProjectRequest(google.protobuf.message.Message):
    ...
    """Project description"""
    @property
    def jfrog_spec(self) -> global___ModelRepositoryJFrogSpec:
        """jfrog spec"""
    def __init__(
        self,
        *,
        project_name: builtins.str = ...,
        project_description: builtins.str = ...,
        jfrog_spec: global___ModelRepositoryJFrogSpec | None = ...,
    ) -> None: ...
...
class ModelRepositoryJFrogSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["jfrog_project_details", b"jfrog_project_details", "pull_image_secret", b"pull_image_secret"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["jfrog_project_details", b"jfrog_project_details", "pull_image_secret", b"pull_image_secret"]) -> None: ...
