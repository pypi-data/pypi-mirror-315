...
QwakEnvironment = _reflection.GeneratedProtocolMessageType('QwakEnvironment', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:qwak.administration.environment.QwakEnvironment)
  })
_sym_db.RegisterMessage(QwakEnvironment)

EnvironmentApplicationUserCredentials = _reflection.GeneratedProtocolMessageType('EnvironmentApplicationUserCredentials', (_message.Message,), {
  'DESCRIPTOR' : _ENVIRONMENTAPPLICATIONUSERCREDENTIALS,
  '__module__' : 'qwak.administration.v0.environments.environment_pb2'
  # @@protoc_insertion_point(class_scope:qwak.administration.environment.EnvironmentApplicationUserCredentials)
  })
_sym_db.RegisterMessage(EnvironmentApplicationUserCredentials)
