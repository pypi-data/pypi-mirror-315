...
class FiinSession:
    ...
    def Fetch_Trading_Data(self, realtime: bool, tickers: list, fields: list, adjusted: bool, 
        ...
        callback and wait_for_full_timeFrame only required when realtime = True. Two method start() and stop() are used to start and stop (Only needed when realtime = True).
        
        Args:
            realtime (bool): Real-time data or not.
            tickers (list): List of tickers.
            fields (list): List of fields. Including: 'O', 'H', 'L', 'C', 'V', 'B', 'S', 'FB', 'FS', 'FN'.
            adjusted (bool, optional): Adjusted price or unadjusted price (). Defaults to True (Adjusted).
            period (Union[int, None], optional): Number of most recent candles. Defaults to None.
            by (str, optional): Unit of time. Defaults to '1M'.
            from_date (Union[str, datetime, None], optional): The furthest time of data. Defaults to None.
            to_date (Union[str, datetime, None], optional): Latest time of data. Defaults to None.
            callback (callable, optional): User-defined callback function for manipulating data. Defaults to None.
            wait_for_full_timeFrame (bool, optional): Wait until the candle is over to get data or not. Defaults to False.
        """
