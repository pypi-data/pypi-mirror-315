...
class ShareButton(Component):
    FRONTEND_DIR = resolve_frontend_dir("ShareButton")
...
class ModelScopeShareButton(Component):
    FRONTEND_DIR = resolve_frontend_dir("ShareButton")
...
class ModelScopeChatbotInput(FormComponent):
    """
    ...
    """
    FRONTEND_DIR = resolve_frontend_dir("UploaderInput")
    ...
    def __init__(
        ...
        *,
        ...
        # upload button
        file_count: Literal['multiple', 'single', 'directory'] = 'multiple',
        file_types: list[str] | None = None,
        upload_button_variant: Literal['primary',
        ...
        self.data_postprocess = postprocess
        self.file_count = file_count
        self.file_types = file_types
        self.upload_button_variant = upload_button_variant
        self.file_preview_height = file_preview_height
        super().__init__(
            label=label,
            info=info,
            every=every,
...
class ChatbotInput(FormComponent):
    """
    Creates a textarea for user to enter string input or display string output.
    Preprocessing: passes textarea value as a {str} into the function.
    Postprocessing: expects a {str} returned from function and sets textarea value to it.
