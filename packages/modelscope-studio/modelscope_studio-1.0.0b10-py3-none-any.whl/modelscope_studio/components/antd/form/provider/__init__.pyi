...
class AntdFormProvider(ModelScopeLayoutComponent):
    """
    Ant Design: https://ant.design/components/form
    """
    EVENTS = [
        EventListener("form_change",
                      callback=lambda block: block._internal.update(
                          bind_formChange_event=True)),
        EventListener("form_finish",
                      callback=lambda block: block._internal.update(
                          bind_formFinish_event=True)),
    ]
