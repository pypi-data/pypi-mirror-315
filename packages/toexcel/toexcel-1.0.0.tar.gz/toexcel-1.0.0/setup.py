...
setup(
    ...
    url="https://github.com/gary714/toexecl",
    # 声明项目使用的【许可证】
    ...
    project_urls={
        # 项目主页
        "Homepage": "https://github.com/gary714/toexecl",
        # 标明有额外文档资源可以访问
        "Documentation": "https://github.com/gary714/toexecl",
        # 显示源代码所在位置
        "Source": "https://github.com/gary714/toexecl"
    },
    # 明确列出哪些【平台】适用这个软件包
    # 以便用户和自动化工具知道【兼容性信息】
