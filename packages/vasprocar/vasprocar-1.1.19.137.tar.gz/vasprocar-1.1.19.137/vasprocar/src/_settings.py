...
if (len(inputs) == 0 and DFT == '_VASP/'):
   ...
   if (opcao == 3 or opcao == -3):
      ...
      print("## ======================================================== ##")
      print("## Atomic Orbital Contribution on the states (Table)        ##")
      print("## Penetration Length (Plot)                                ##")
...
if (len(inputs) == 0 and DFT == '_QE/'):
   ...
   print("## [30] Default   --   [-30] Custom                         ##")
   print("## -------------------------------------------------------- ##")
   print("## Note: The 'QE' package projects the states as a function ##")
   print("## of the quantum numbers 'l=s,p,d,f', 'j', 'm_j'.          ##")
   print("## For more information visit:                              ##")
   print("## https://www.quantum-espresso.org/Doc/INPUT_PROJWFC.html  ##")   
   print("## ======================================================== ##")
   print("## DOS, p-DOS e l-DOS (Plot 2D)                             ##")
   print("## [31] Default   --   [-31] Custom                         ##")
   print("## ======================================================== ##")
   ...
   print("## [36] Default   --   [-36] Custom                         ##")
   print("## ======================================================== ##")
   print("## 2D projection of Total Angular Momentum j:               ##")
   print("## |l-S| <= j <= (l+S):  L=0|J={1/2}      L=1|J={1/2,3/2}   ##") 
   print("##                       L=2|J={3/2,5/2}  L=3|J={5/2,7/2}   ##")
   print("## [37] Default   --   [-37] Custom                         ##")
   print("## -------------------------------------------------------- ##")
   print("## Note: Only for calculation with spin-orbit coupling      ##") 
   print("## ======================================================== ##")
   print("## [888] Install/Update Python modules                      ##")
   print("## ======================================================== ##")
   print("## [999] DFT2kp: effective kp models from ab-initio data    ##")
...
if ((opcao == 37 or opcao == -37) and (DFT == '_QE/')):
   execute_python_file(filename = DFT + 'projecao_angular_momentum.py')
