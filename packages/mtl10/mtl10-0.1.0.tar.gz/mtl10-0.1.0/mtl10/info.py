from mtl10 import motley


def info() -> str:
    return f"""
        {motley(text="info", style="bold_italic", color_combo="night")}: 
             {motley(text="main", style="bold_italic")}: {motley(text="Вы можете как выбрать любой цвет и/или стиль, так и ничего не выбирать", style="italic")}
