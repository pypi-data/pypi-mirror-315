...
def motley(text: str,
    ...
    colors = {
        ...
        "pink": Fore.LIGHTMAGENTA_EX, "dark_pink": Fore.LIGHTMAGENTA_EX,
    ...
    try:
        ...
        return ("Вы указали неверный "
                ...
                "Все цвета и стили можно получить, написав ")
        # и тут будет что-то info# и тут будет что-то info# и тут будет что-то info# и тут будет что-то info# и тут будет что-то info
    else:
