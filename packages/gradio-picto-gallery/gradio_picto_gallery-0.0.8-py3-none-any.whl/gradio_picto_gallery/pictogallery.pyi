...
FavoritedCaptionedGalleryImageType = Tuple[GalleryImageType, str, bool]
...
class PictoGallery(Component):
    ...
    EVENTS = [
        ...
        Events.change,
        EventListener(
            "toggle_favorite", doc="Triggered when the user clicks on the favorite icon of an image"
        ),
        EventListener("like", doc="Triggered when the user clicks on the like button of an image"),
        EventListener(
            "dislike", doc="Triggered when the user clicks on the dislike button of an image"
        ),
        EventListener("edit", doc="Triggered when the user clicks on the edit button of an image"),
    ]
    ...
    def __init__(
        ...
        *,
        ...
        show_like_dislike: bool | None = True,
        show_edit_button: bool | None = True,
        hide_close_button: bool | None = False,
        container: bool = True,
        scale: int | None = None,
        min_width: int = 160,
        visible: bool = True,
        ...
        Parameters:
            ...
            preview: If True, downloadGallery will start in preview mode, which shows all of the images as thumbnails and allows the user to click on them to view them in full size. Only works if allow_preview is True.
            selected_index: The index of the image that should be initially selected. If None, no image will be selected at start. If provided, will set downloadGallery to preview mode unless allow_preview is set to False.
            ...
            hide_close_button: If True, will hide the close button in the top right corner of the gallery. Default is False.
            show_like_dislike: If True, will show like and dislike buttons for each image in the gallery. Default is True.
            show_edit_button: If True, will show an edit button for each image in the gallery. Default is True.
        """
        self.format = format
        ...
        self.show_like_dislike = show_like_dislike
    ...
    def preprocess(
        ...
        | List[tuple[np.ndarray, str | None, bool | None]]
        | None
    ):
        """
        Parameters:
        ...
        for gallery_element in payload.root:
            ...
            data.append((image, gallery_element.caption, gallery_element.favorite))
        return data

    def postprocess(
        self,
        value: (
            list[GalleryImageType | CaptionedGalleryImageType | FavoritedCaptionedGalleryImageType]
            | None
        ),
    ) -> GalleryData:
        """
