...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-servicediscovery)](https://pypistats.org/packages/mypy-boto3-servicediscovery)
...
`mypy-boto3-servicediscovery` dependency in production. However, there is an
