...
class BaseArticleModel(BaseModel):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name=_('作者'), blank=True, null=True)
    image = models.ImageField(upload_to='article', blank=True, null=True, verbose_name=_('图片'))
