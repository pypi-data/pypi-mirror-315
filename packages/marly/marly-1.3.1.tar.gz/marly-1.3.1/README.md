...
The Marly Python library provides convenient access to the Marly REST API from any Python 3.8+
...
You can enable logging by setting the environment variable `MARLY_LOG` to `info`.

```shell
$ export MARLY_LOG=info
```
