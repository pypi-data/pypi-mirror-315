...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, base_url=None, pulp_href=None, base_path=None, name=None, pulp_labels=None, content_guard=None, pulp_created=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
