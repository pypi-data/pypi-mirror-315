...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, hidden=False, no_content_change_since=None, base_url=None, prn=None, content_guard=None, pulp_last_updated=None, pulp_labels=None, name=None, base_path=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
