...
class ComponentPricePointErrorException(advancedbilling.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        ...
        """
        super(ComponentPricePointErrorException, self).__init__(reason, response)
