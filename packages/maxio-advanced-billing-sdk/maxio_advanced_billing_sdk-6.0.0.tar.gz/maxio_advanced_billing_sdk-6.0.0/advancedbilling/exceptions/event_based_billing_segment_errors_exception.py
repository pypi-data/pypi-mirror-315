...
class EventBasedBillingSegmentErrorsException(advancedbilling.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        ...
        """
        super(EventBasedBillingSegmentErrorsException, self).__init__(reason, response)
