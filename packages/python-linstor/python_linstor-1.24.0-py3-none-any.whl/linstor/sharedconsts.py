...
# Copyright (C) 2017 - 2024  LINBIT HA-Solutions GmbH
# All Rights Reserved.
...
FAIL_INVLD_DB_EXPORT_FILE = long(242 | MASK_ERROR)
...
# ## Other failures ###
FAIL_SNAPSHOT_ROLLBACK_IN_PROGRESS = long(971 | MASK_ERROR)
FAIL_SP_MIXING_NOT_ALLOWED = long(972 | MASK_ERROR)
...
WARN_STORPOOL_RENAME_NOT_ALLOWED = long(1022 | MASK_WARN)
WARN_NOT_FOUND = long(3000 | MASK_WARN)
WARN_DEPRECATED = long(4000 | MASK_WARN)
...
INFO_ABORTED_FAILED_SNAPSHOT_ROLLBACK = long(10009 | MASK_INFO)
INFO_RECOVERING_FAILED_SNAPSHOT_ROLLBACK = long(10010 | MASK_INFO)
...
API_CRT_SNAPSHOT_MULTI = str('CrtSnapshotMulti')
...
API_MOD_VLM_DFN_PASS = str('ModVlmDfnPassphrase')
...
API_QRY_ALL_SIZE_INFO = str('QryAllSizeInfo')
API_RSCDFN_SYNC_STATUS = str('RscDfnSyncStatus')
API_CHECK_EXT_FILE = str('CheckExtFile')
...
KEY_DRBD_SKIP_DISK = str('SkipDisk')
KEY_DRBD_EXACT_SIZE = str('ExactSize')
...
KEY_BALANCE_RESOURCES_ENABLED = str('BalanceResourcesEnabled')
KEY_BALANCE_RESOURCES_INTERVAL = str('BalanceResourcesInterval')
KEY_BALANCE_RESOURCES_GRACE_PERIOD = str('BalanceResourcesGracePeriod')
...
KEY_MAX_CONCURRENT_BACKUPS_PER_NODE = str('MaxConcurrentBackupsPerNode')
VAL_NODE_UNDECIDED = str('<undecided>')
KEY_ALLOW_FORCE_RESTORE = str('AllowForceRestore')
KEY_RECV_TIMEOUT_IN_MS = str('L2LReceiveStartedTimeout')
...
NAMESPC_ENCRYPTION = str('Encryption')
...
KEY_STOR_POOL_LVCREATE_SNAPSHOT_OPTIONS = str('LvcreateSnapshotOptions')
KEY_STOR_POOL_THIN_POOL = str('ThinPool')
KEY_STOR_POOL_LVM_SIZES_CACHE_TIME = str('SizesCacheTime')
KEY_STOR_POOL_ZPOOL = str('ZPool')
KEY_STOR_POOL_ZPOOLTHIN = str('ZPoolThin')
KEY_STOR_POOL_ZFS_CREATE_OPTIONS = str('ZfscreateOptions')
KEY_STOR_POOL_ZFS_SNAPSHOT_OPTIONS = str('ZfsSnapshotOptions')
...
KEY_STOR_POOL_MAX_OVERSUBSCRIPTION_RATIO = str('MaxOversubscriptionRatio')
KEY_STOR_POOL_MAX_FREE_CAPACITY_OVERSUBSCRIPTION_RATIO = str('MaxFreeCapacityOversubscriptionRatio')
KEY_STOR_POOL_MAX_TOTAL_CAPACITY_OVERSUBSCRIPTION_RATIO = str('MaxTotalCapacityOversubscriptionRatio')
KEY_STOR_POOL_WAIT_TIMEOUT_AFTER_CREATE = str('WaitTimeoutAfterCreate')
KEY_SPEC_STLT_PORT_AUTO_RANGE = str('SpecStltPortAutoRange')
...
KEY_FS_USER = str('User')
KEY_FS_GROUP = str('Group')
...
FLAG_DRBD_DELETE = str('DRBD_DELETE')
...
if __name__ == "__main__":
    MAP_MASK = {
        ...
        'FAIL_INVLD_DB_EXPORT_FILE': FAIL_INVLD_DB_EXPORT_FILE,
        ...
        'FAIL_SNAPSHOT_ROLLBACK_IN_PROGRESS': FAIL_SNAPSHOT_ROLLBACK_IN_PROGRESS,
        'FAIL_SP_MIXING_NOT_ALLOWED': FAIL_SP_MIXING_NOT_ALLOWED,
        ...
        'WARN_STORPOOL_RENAME_NOT_ALLOWED': WARN_STORPOOL_RENAME_NOT_ALLOWED,
        ...
        'INFO_ABORTED_FAILED_SNAPSHOT_ROLLBACK': INFO_ABORTED_FAILED_SNAPSHOT_ROLLBACK,
        'INFO_RECOVERING_FAILED_SNAPSHOT_ROLLBACK': INFO_RECOVERING_FAILED_SNAPSHOT_ROLLBACK,
