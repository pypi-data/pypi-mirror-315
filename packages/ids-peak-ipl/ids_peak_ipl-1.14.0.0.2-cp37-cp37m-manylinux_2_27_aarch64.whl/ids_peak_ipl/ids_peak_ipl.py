...
class Size2D(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    width: "int" = property(_ids_peak_ipl_python_interface.Size2D_width_get, _ids_peak_ipl_python_interface.Size2D_width_set, doc=r""" Width of size""")
    height: "int" = property(_ids_peak_ipl_python_interface.Size2D_height_get, _ids_peak_ipl_python_interface.Size2D_height_set, doc=r""" Height of size""")
...
class Point2D(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    x: "int" = property(_ids_peak_ipl_python_interface.Point2D_x_get, _ids_peak_ipl_python_interface.Point2D_x_set, doc=r""" X position""")
    y: "int" = property(_ids_peak_ipl_python_interface.Point2D_y_get, _ids_peak_ipl_python_interface.Point2D_y_set, doc=r""" Y position""")
...
class ScaleFactor(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    x: "float" = property(_ids_peak_ipl_python_interface.ScaleFactor_x_get, _ids_peak_ipl_python_interface.ScaleFactor_x_set, doc=r""" X factor""")
    y: "float" = property(_ids_peak_ipl_python_interface.ScaleFactor_y_get, _ids_peak_ipl_python_interface.ScaleFactor_y_set, doc=r""" Y factor""")
...
class Image(object):
    ...
    def ConvertTo(self, *args) -> "Image":
        ...
        *Overload 2:*
        ...
        :type outputPixelFormat: :py:class:`PixelFormat`, in
        :param outputPixelFormat:     The output pixel format.
        :type outputImageBuffer: int, out
    ...
    def ConvertToWithFactor(self, *args) -> "Image":
        r"""
        Returns a new created image containing the data of the current image converted to the given pixel format with the factor multiplied to each output pixel.

        :type outputPixelFormat: :py:class:`PixelFormat`, in
        :param outputPixelFormat: The output pixel format.
        :type factor: float, in
        :param factor:            The factor multiplied to each output pixel.
        :type conversionMode: int, in, optional
        :param conversionMode:    The conversion mode.

        :rtype: :py:class:`Image`
        :return: Converted image with the factor applied
