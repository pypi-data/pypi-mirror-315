...
import bceiam.region
import bceiam.protocol
from bceiam import compat
from bceiam.retry.retry_policy import BackOffRetryPolicy
...
class BceClientConfiguration(object):
    ...
    def __init__(
        self,
        bce_credentials=None,
        iam_credentials=None,
        idaas_credentials=None,
        endpoint=None,
        protocol=None,
        region=None,
        ...
        self.bce_credentials = bce_credentials
        self.iam_credentials = iam_credentials
        self.idaas_credentials = idaas_credentials
        self.endpoint = (
...
DEFAULT_PROTOCOL = bceiam.protocol.HTTP
DEFAULT_REGION = bceiam.region.BEIJING
