...
class _Defaults():
    ...
    # then convert to float64. Commonly relevant if calculating 'n' in 'raw' Bifrost units.
    BIFROST_MAX_GUARANTEE_SUPPORT_N_SI = 1e30
...
class _PhysicalDefaults():
    ...
    CONSTANTS_SI = {
        ...
        'mu0'     : 1.25664E-6,   # permeability of free space
