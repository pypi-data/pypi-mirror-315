...
class DimRegion(dict):
    ...
    def assign_to(self, array, *, attrs=None, **kw_xarray_assign):
        '''array.assign_coords(self). Internally, use PlasmaCalcs xarray_assign function.
        Also assign_attrs if attrs is not None.
        ...
        return xarray_assign(array, self, attrs=attrs, **kw_xarray_assign)
