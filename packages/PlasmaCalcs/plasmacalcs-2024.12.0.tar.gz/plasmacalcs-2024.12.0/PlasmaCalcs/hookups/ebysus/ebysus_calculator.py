...
class EbysusCalculator(EbysusBasesLoader, EbysusCollisionsLoader,
    ...
    dirbase = property(lambda self: os.path.basename(self.dirname), doc='''os.path.basename of self.dirname''')
    ...
    def get_init_fluids(self):
        ...
        fluidlist = FluidList.from_infos([electrons] + others)
    ...
    def load_direct(self, var, *args, pre_dimmed=False, **kw):
        ...
        ebysus_var = var if pre_dimmed else self._var_dimmed(var)
