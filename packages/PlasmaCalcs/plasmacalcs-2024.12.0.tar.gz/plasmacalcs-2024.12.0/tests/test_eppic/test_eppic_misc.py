...
def test_eppic_calculator_help():
    ...
    # as classmethod
    pc.EppicCalculator.cls_help()
    pc.EppicCalculator.cls_help('')
    pc.EppicCalculator.cls_help('mod')
    pc.EppicCalculator.cls_help('q')
    pc.EppicCalculator.cls_help('', modules=True)
    pc.EppicCalculator.cls_help('', modules=True, dense=False)
    pc.EppicCalculator.cls_help('1+2')
    pc.EppicCalculator.cls_help('1+(2+3)')
    # as instance method
    ...
    ec.help('mod')
    ec.help('q')
    ec.help('', modules=True)
    ec.help('', modules=True, dense=False)
    ec.help('1+2')
    ec.help('1+(2+3)')
