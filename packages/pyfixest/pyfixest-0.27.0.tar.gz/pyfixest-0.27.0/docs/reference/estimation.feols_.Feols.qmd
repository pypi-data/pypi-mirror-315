...
| solver | str        | "np.linalg.solve", and "scipy.sparse.linalg.lsqr". | _required_ |
...
| Name    | Type       | Description                                                                                 | Default    |
|---------|------------|---------------------------------------------------------------------------------------------|------------|
| X_new   | np.ndarray | Covariates for new data points. Users expected to ensure conformability with existing data. | _required_ |
| y_new   | np.ndarray | Outcome values for new data points                                                          | _required_ |
