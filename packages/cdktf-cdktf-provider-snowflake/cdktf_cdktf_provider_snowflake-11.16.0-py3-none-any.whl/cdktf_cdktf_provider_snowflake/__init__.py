r'''
# CDKTF prebuilt bindings for Snowflake-Labs/snowflake provider version 0.100.0

This repo builds and publishes the [Terraform snowflake provider](https://registry.terraform.io/providers/Snowflake-Labs/snowflake/0.100.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform snowflake provider](https://registry.terraform.io/providers/Snowflake-Labs/snowflake/0.100.0)
...
from . import data_snowflake_roles
