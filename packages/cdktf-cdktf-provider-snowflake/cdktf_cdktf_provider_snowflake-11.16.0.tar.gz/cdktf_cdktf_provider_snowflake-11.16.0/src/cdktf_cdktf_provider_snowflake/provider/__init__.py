...
class SnowflakeProvider(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.100.0/docs#import import section} in the documentation of this resource for the id to use
    ...
    def browser_auth(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "browserAuth", value) # pyright: ignore[reportArgumentType]
    ...
    def oauth_access_token(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "oauthAccessToken", value) # pyright: ignore[reportArgumentType]
    ...
    def oauth_endpoint(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "oauthEndpoint", value) # pyright: ignore[reportArgumentType]
    ...
    def oauth_redirect_url(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "oauthRedirectUrl", value) # pyright: ignore[reportArgumentType]
    ...
    def session_params(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "sessionParams", value) # pyright: ignore[reportArgumentType]
