...
class GenerateResponseBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["result", "request_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerateResponseBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerateResponseBody from a dict"""
        if obj is None:
            return None
