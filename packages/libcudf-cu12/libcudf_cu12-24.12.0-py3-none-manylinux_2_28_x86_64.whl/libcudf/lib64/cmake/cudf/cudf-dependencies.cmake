...
set(CCCL_ROOT "${CMAKE_CURRENT_LIST_DIR}/../../../include/libcudf/lib/rapids/cmake/cccl;${CMAKE_CURRENT_LIST_DIR}/../../rapids/cmake/cccl")
find_dependency(CUDAToolkit)

find_package(nvtx3 3.1.0 QUIET)
find_dependency(nvtx3)

find_package(CCCL 2.5.0 QUIET)
...
set(rapids_global_targets nvtx3-c;nvtx3-cpp;CCCL;CCCL::CCCL;CCCL::CUB;CCCL::libcudacxx;rmm::rmm;fmt::fmt;fmt::fmt-header-only;spdlog::spdlog;spdlog::spdlog_header_only)
