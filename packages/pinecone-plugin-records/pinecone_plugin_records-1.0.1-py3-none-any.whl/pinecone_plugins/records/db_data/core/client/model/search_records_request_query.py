...
class SearchRecordsRequestQuery(ModelNormal):
    ...
    def _from_openapi_data(cls, top_k, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            filter ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): The filter to apply.. [optional]  # noqa: E501
            inputs ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
