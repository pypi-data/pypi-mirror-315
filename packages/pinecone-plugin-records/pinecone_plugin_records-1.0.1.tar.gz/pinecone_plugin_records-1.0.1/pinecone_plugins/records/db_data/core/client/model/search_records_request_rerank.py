...
from pinecone_plugins.records.db_data.core.client.model_utils import (  # noqa: F401
...
class SearchRecordsRequestRerank(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, model, rank_fields, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            parameters ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Additional model-specific parameters. Refer to the [model guide](https://docs.pinecone.io/guides/inference/understanding-inference#reranking-models) for available model parameters.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, model, rank_fields, *args, **kwargs):  # noqa: E501
        """SearchRecordsRequestRerank - a model defined in OpenAPI
