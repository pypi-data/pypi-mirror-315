...
#import string
import json
from adaletCleaningV4 import utils


def convertTRChars(text):

    with open("resources/trCharToReplace.json", "r", encoding="utf-8") as file:
...
def removePunctuations(text):
    ...
    with open("resources/punctuations.txt", "r", encoding="utf-8") as file:
...
def keepCharacters(text, keepNumber):
    ...
    with open("resources/cleaningParams.txt", "r", encoding="utf-8") as file:
...
def removeUnusedWords(text):
    ...
    with open("resources/adaletUnusedWords.txt", "r", encoding="utf-8") as file:
...
def removeCommonWords(text):
    ...
    with open("resources/adaletCommonWords.txt", "r", encoding="utf-8") as file:
...
def replaceAbbreviations(text):
    ...
    with open("resources/abbreviations.json", "r", encoding="utf-8") as file:
...
def allowOnlySpecificCharacters(text, isSpecialCharacters):
    ...
    with open("resources/cleaningParams.txt", "r", encoding="utf-8") as file:
        ...
        specialCharacters = partOfFile[specialCharactersStart:specialCharactersEnd]
        SPECIALCHARACTERS = re.compile(r'[{}]'.format(specialCharacters))
    with open("resources/punctuations.txt", "r") as file:
        PUNCTUATIONS = file.read()
    with open("resources/allowedChars.txt", "r") as file:
