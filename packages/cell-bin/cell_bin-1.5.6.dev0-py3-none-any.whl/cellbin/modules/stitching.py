...
class Stitching(CellBinElement):
    ...
    def set_size(self, rows, cols):
        ...
        try:
            ...
            clog.info("Rows type error(expect int).")

        try:
            cols = int(cols)
        except:
            clog.info("Cols type error(expect int).")
    ...
    def _get_jitter(self, src_fovs, fft_channel=0, process=10):
        ...
        if self.fov_x_jitter is None or self.fov_y_jitter is None:
            ...
            end_time = time.time()
            clog.info("Calculate jitter time -- {}s".format(end_time - start_time))
        else:
            ...
            self.__jitter_diff, self.__jitter_x_diff, self.__jitter_y_diff = \
                jitter_model._offset_eval(self._fov_height, self._fov_width, self._overlap)
            clog.info("Have jitter matrix, skip this mode.")
    ...
    def _get_location(self, ):
        ...
        if self.fov_location is None:
            ...
            end_time = time.time()
            clog.info("Calculate location time -- {}s".format(end_time - start_time))
        else:
    ...
    def template(self, pts, scale_x, scale_y, rotate, chipno, index, correct_points,
                 ...
                 scale_range, rotate_range, rotate_fov_min, method_threshold,
...
if __name__ == "__main__":
    ...
    import cv2 as cv
    image_src = {
        "0001_0001": r"C:\Users\87393\Downloads\xxx\DP81FocusSweep20241029-flu-1.L001.S001.C001R001.P003.C.2024-10-29_16-44-55-893.tif",
        "0001_0002":r"C:\Users\87393\Downloads\xxx\DP81FocusSweep20241029-flu-1.L001.S001.C002R001.P003.C.2024-10-29_16-44-57-542.tif",
        "0002_0001":r"C:\Users\87393\Downloads\xxx\DP81FocusSweep20241029-flu-1.L001.S001.C001R002.P003.C.2024-10-29_16-45-12-506.tif",
        "0002_0002":r"C:\Users\87393\Downloads\xxx\DP81FocusSweep20241029-flu-1.L001.S001.C002R002.P003.C.2024-10-29_16-45-14-376.tif",
    }
    stitch = Stitching()
    stitch.set_overlap(0.2)
    stitch.set_size(3, 3)
    stitch.stitch(image_src, r"C:\Users\87393\Downloads\xxx")
    cv.imwrite(r"C:\Users\87393\Downloads\xxx\test.tif", stitch.get_image())
    print(1)
