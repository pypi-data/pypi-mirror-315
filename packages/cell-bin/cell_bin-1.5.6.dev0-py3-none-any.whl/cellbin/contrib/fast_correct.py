...
class Fast(Mask):
    def __init__(self, mask, distance=15, process=8):
        """
    ...
    def process(self):
        ...
        clog.info(f'Fast Labeling ends at {datetime.datetime.now()}\n')
...
if __name__ == '__main__':
    ...
    m3 = "/media/Data/dzh/data/single_cell/debug_20240511/A03580C4_result/A03580C4_mask.tif"

    m4 = "/media/Data/dzh/data/single_cell/dapi_mif/rseg_result/B02304A2_mask.tif" # normal
    mask = tifffile.imread(m4)
    a = Fast(mask,
             10)
    a.process()
