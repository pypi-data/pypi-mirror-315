...
from cellbin.contrib.tr_scale_search import ScaleSearch
from cellbin.contrib.tr_rotate_search import RotateSearch
...
class TemplateReferenceV2(TemplateReference):
    ...
    def _template_correct(self, qc_pts, n=5):
        ...
        if not self.set_rotate_flag:
            ...
            if tmp_list[0] is None: tmp_rot = tmp_list[1]
            else: tmp_rot = tmp_list[0]
