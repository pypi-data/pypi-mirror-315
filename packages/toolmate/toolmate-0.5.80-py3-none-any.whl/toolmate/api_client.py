...
parser.add_argument('-imh', '--imageheight', action='store', dest='imageheight', type=int, help="image height")
...
parser.add_argument('-imw', '--imagewidth', action='store', dest='imagewidth', type=int, help="image width")
