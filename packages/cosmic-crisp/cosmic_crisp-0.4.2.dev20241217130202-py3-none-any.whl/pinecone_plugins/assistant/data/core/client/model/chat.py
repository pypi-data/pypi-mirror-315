...
class Chat(ModelNormal):
    ...
    def _from_openapi_data(cls, messages, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            filter ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Optionally filter which documents can be used in this query.. [optional]  # noqa: E501
            json_response (bool): If true, the assistant will be instructed to return a JSON response. Cannot be used with streaming. For Claude, JSON formatting relies on prompt engineering techniques and may not guarantee perfect JSON output. For OpenAI models, JSON mode is used to ensure highly reliable output.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
