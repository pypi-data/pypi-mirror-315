    ...
    def __init__(self, api_client=None):
        ...
        def __create_assistant(
            ...
            **kwargs
            ...
            The `create_assistant` endpoint [creates a Pinecone Assistant](https://docs.pinecone.io/guides/assistant/create-assistant). This is where you specify the underlying training model, which cloud provider you would like to deploy with, and more.  # noqa: E501
        ...
        def __delete_assistant(
            ...
            **kwargs
            ...
            The `delete_assistant` endpoint [deletes an existing assistant](https://docs.pinecone.io/guides/assistant/manage-assistants#delete-an-assistant).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __describe_assistant(
            ...
            **kwargs
            ...
            The `describe_assistant` endpoint [gets the status](https://docs.pinecone.io/guides/assistant/manage-assistants#get-the-status-of-an-assistant) of an assistant.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.describe_assistant(assistant_name, async_req=True)
            >>> result = thread.get()
        ...
        self.describe_assistant = _Endpoint(
            settings={
                'response_type': (Assistant,),
                'auth': [
                    'ApiKeyAuth'
                ...
                'endpoint_path': '/assistant/assistants/{assistant_name}',
                'operation_id': 'describe_assistant',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        def __update_assistant(
            ...
            **kwargs
            ...
            The `update_assistant` endpoint [updates an existing assistant](https://docs.pinecone.io/guides/assistant/manage-assistants#update-an-existing-assistant). You can modify the assistant's instructions and metadata.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
