...
class Parser:
    ...
    def xPath(self, path: str, element: Element=None, pos: int=None, data_type: str=None, prop: str=None, explode=None, condition=None, substring=None, transform=None, replace=None, join=None, timeout=None, is_error: bool=True, sleep_before: int=0, sleep_after: int=0) -> any:
        time.sleep(sleep_before)
