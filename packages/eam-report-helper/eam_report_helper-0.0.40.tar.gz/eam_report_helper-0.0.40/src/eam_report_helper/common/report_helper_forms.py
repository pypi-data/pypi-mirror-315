    ...
    def get_sub_forms(self, distributions: list, users: list) -> list:
        ...
        for sub_form in sub_form_ref_list_filtered:
            ...
            sub_form['matched_elements'] = dict({
                ...
                'Corrective Action Asignee': f"{sub_form['matched_elements']['Corrective Action Responsibility']['first']} {sub_form['matched_elements']['Corrective Action Responsibility']['last']}",
