...
class Justement(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous justement client instance.

        This automatically infers the `api_key` argument from the `JUSTEMENT_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("JUSTEMENT_API_KEY")
        if api_key is None:
            raise JustementError(
                "The api_key client option must be set either by passing api_key to the client or by setting the JUSTEMENT_API_KEY environment variable"
            )
...
class AsyncJustement(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async justement client instance.
