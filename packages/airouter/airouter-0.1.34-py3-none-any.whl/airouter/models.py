...
class LLM(str, Enum):
  ...
  ANTROPHIC_CLAUDE_V35_SONNET = "anthropic.claude-3-5-sonnet-20240620-v1:0"
...
class ImageURL(BaseModel):
  url: str
  detail: t.Optional[t.Literal["auto", "low", "high"]] = "auto"
...
class UserChatMessage(BaseModel):
  role: t.Literal["user"]
  content: t.Union[str, t.List[t.Union[ChatCompletionContentPartTextParam, ChatCompletionContentPartImageParam]]]
...
Messages = t.List[t.Union[ChatMessage, UserChatMessage]]
...
if True:
  ...
  map_provider_to_llms = {
    ...
    ProviderName.AWS_BEDROCK_CHAT: [
      ...
      LLM.ANTROPHIC_CLAUDE_V35_SONNET,
    ],
  ...
  map_context_size = {
    ...
    LLM.ANTROPHIC_CLAUDE_V35_SONNET: 200_000,
  ...
  map_output_size = {
    LLM.ANTROPHIC_CLAUDE_V35_SONNET: 8_192
  }
