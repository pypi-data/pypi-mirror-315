...
def record(experiment_name=None,questions=None, contexts=None, generated_prompts=None, answers=None, ground_truths=None, model_temperature=None, top_k=None, prompt_template=None,model_provider=None,API_key=None,maxToken=None,top_p=None,user_prompt=None,llm_endpoint=None,promptName=None,apiVersion=None,modelDeploymentName=None):
    """
    Function Overview:
    ...
    if not prompt_template or not model_provider or not API_key or not promptName or not apiVersion:
