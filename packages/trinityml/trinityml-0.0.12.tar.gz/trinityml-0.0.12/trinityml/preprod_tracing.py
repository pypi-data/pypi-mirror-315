...
def record(experiment_name=None,questions=None, contexts=None, generated_prompts=None, answers=None, ground_truths=None, model_temperature=None, top_k=None,system_prompt= None,model_provider=None,API_key=None,maxToken=None,top_p=None,user_prompt=None,llm_endpoint=None,promptName=None,apiVersion=None,modelDeploymentName=None):
    ...
    if not system_prompt or not model_provider or not API_key or not promptName or not apiVersion:
        print("Model parameters (model_name, system_prompt, temperature, model_provider, API_key ) are required. Please make sure you have provided all the necessary parameters.")
        return
