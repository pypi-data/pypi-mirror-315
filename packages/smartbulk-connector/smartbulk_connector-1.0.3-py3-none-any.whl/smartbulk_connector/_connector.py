...
class SmartbulkConnector(Connector):
    ...
    def __create_project(self,
        ...
        if not self.validate_file_paths(matrix_paths) \
            or not self.validate_file_paths(metadata_paths):
            return
        ...
        for file_path in matrix_paths + metadata_paths:
            try:
        ...
        print('Start creating project, please use check_project_status to check the process')
