...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-dlm)](https://pypistats.org/packages/mypy-boto3-dlm)
...
`mypy-boto3-dlm` dependency in production. However, there is an issue in
