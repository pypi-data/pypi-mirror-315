...
"""
    ...
    def query_tag(self) -> Optional[str]:
        ...
        :getter: Returns the query tag. You can use the query tag to find all queries
            run for this session in the History page of the ClickZetta web interface.
        ...
        :setter: Sets the query tag. If the input is ``None`` or an empty :class:`str`,
            ...
            query to the ClickZetta Database is called. For example, :meth:`DataFrame.collect`,
    ...
    def _get_remote_query_tag(self) -> None:
        ...
        #     raise ValueError(
        #         "Clickzetta server side query tag parameter has unexpected schema."
        #     )
