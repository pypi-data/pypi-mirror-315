...
if TYPE_CHECKING:
    from clickzetta.zettapark._internal.analyzer.query_plan import QueryPlan


def find_duplicate_subtrees(root: "QueryPlan") -> Set["QueryPlan"]:
    """
    ...
    def traverse(node: "QueryPlan") -> None:
    ...
    def is_duplicate_subtree(node: "QueryPlan") -> bool:
...
def create_cte_query(node: "QueryPlan", duplicate_plan_set: Set["QueryPlan"]) -> str:
    plan_to_query_map = {}
    duplicate_plan_to_cte_map = {}
    duplicate_plan_to_table_name_map = {}

    def build_plan_to_query_map_in_post_order(node: "QueryPlan") -> None:
        """
