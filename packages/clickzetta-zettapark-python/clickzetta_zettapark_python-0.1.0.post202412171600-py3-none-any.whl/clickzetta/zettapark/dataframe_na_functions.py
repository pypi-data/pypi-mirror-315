...
from clickzetta.zettapark._internal.telemetry import add_api_call, adjust_api_subcalls
...
from clickzetta.zettapark.functions import iff, lit, when
...
def _is_value_type_matching_for_na_function(
    ...
    # None should be compatible with any Zettapark type.
    return (
        value is None
        or (
...
class DataFrameNaFunctions:
    ...
    def fill(
        ...
        Note:
            ...
            column data type (e.g. a ``float`` for :class:`~clickzetta.zettapark.types.StringType`
            column), this replacement will be skipped in this column. Especially,

                * ``int`` can be filled in a column with
                  :class:`~clickzetta.zettapark.types.FloatType` or
                  :class:`~clickzetta.zettapark.types.DoubleType`, but ``float`` cannot
                  filled in a column with :class:`~clickzetta.zettapark.types.IntegerType`
                  or :class:`~clickzetta.zettapark.types.LongType`.
        ...
        Note:
            ...
            column), this replacement will be skipped in this column. Especially,
                ...
                * ``int`` can replace or be replaced in a column with
                  :class:`~clickzetta.zettapark.types.FloatType` or
                  :class:`~clickzetta.zettapark.types.DoubleType`, but ``float`` cannot
                  replace or be replaced in a column with :class:`~clickzetta.zettapark.types.IntegerType`
                  or :class:`~clickzetta.zettapark.types.LongType`.
