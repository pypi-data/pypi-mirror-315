...
"""User-defined aggregate functions (UDAFs) in Zettapark. Refer to :class:`~clickzetta.zettapark.udaf.UDAFRegistration` for details and sample code."""
...
class UserDefinedAggregateFunction:
    ...
    :func:`~clickzetta.zettapark.functions.udaf`, :meth:`UDAFRegistration.register` or
    ...
    :class:`~clickzetta.zettapark.Column` instance. The input type can be
    a column name as a :class:`str`, or a :class:`~clickzetta.zettapark.Column` object.

    See Also:
        - :class:`UDAFRegistration`
        - :func:`~clickzetta.zettapark.functions.udaf`
    """
    ...
    def _create_udaf_expression(self, exprs: List[Expression]) -> UDF:
...
class UDAFRegistration:
    """
    Provides methods to register lambdas and functions as UDAFs in the ClickZetta database.
    For more information about ClickZetta Python UDAFs, see `Python UDAFs <https://doc.clickzetta.com/>`__.

    :attr:`session.udaf <clickzetta.zettapark.Session.udaf>` returns an object of this class.
    ...
    Registering a UDAF is like registering a scalar UDF, you can use :meth:`register` or :func:`clickzetta.zettapark.functions.udaf`
    ...
    Another way is to use :meth:`register_from_file`. Refer to module :class:`clickzetta.zettapark.udaf.UDAFRegistration` for when to use them.

    To query a registered UDAF is the same as to query other aggregate functions. Refer to :meth:`~clickzetta.zettapark.DataFrame.agg`.
    ...
    Example 1
        Create a temporary UDAF and call it:
            ...
            >>> from clickzetta.zettapark.functions import call_function, col, udaf
            >>> class PythonSumUDAF:
    ...
    Example 2
        Create a UDAF with type hints and ``@udaf`` decorator and query it:
            ...
            >>> from clickzetta.zettapark.functions import udaf
            >>> @udaf
            ... class PythonSumUDAF:
            ...     def __init__(self) -> None:
            ...         self._sum = 0
    ...
    def describe(
        ...
        """
        Returns a :class:`~clickzetta.zettapark.DataFrame` that describes the properties of a UDAF.

        Args:
            udaf_obj: A :class:`UserDefinedAggregateFunction` returned by
                :func:`~clickzetta.zettapark.functions.udaf` or :meth:`register`.
        """
        func_args = [convert_sp_to_cz_type(t) for t in udaf_obj._input_types]
    ...
    def register(
        ...
        **kwargs,
        ...
        """
        Registers a Python function as a ClickZetta Python UDAF and returns the UDAF.
        The usage, input arguments, and return value of this method are the same as
        they are for :func:`~clickzetta.zettapark.functions.udaf`, but :meth:`register`
        cannot be used as a decorator. See examples in
        :class:`~clickzetta.zettapark.udaf.UDAFRegistration` and notes in
        :func:`~clickzetta.zettapark.functions.udaf`.
        ...
        Args:
            ...
            name: A string or list of strings that specify the name or fully-qualified
                ...
                command or via :func:`~clickzetta.zettapark.DataFrame.agg` or
                :func:`~clickzetta.zettapark.DataFrame.group_by`.
    ...
    def register_from_file(
        ...
        *,
        ...
        """
        Registers a Python class as a ClickZetta Python UDAF from a Python or zip file,
