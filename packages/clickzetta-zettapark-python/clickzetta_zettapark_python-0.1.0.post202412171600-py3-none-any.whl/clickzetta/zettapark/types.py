...
"""This package contains all Zettapark logical types."""
...
import clickzetta.zettapark._internal.analyzer.expression as expression
from clickzetta.zettapark._connector import installed_pandas, pandas
...
class DataType:
    """The base class of Zettapark data types."""
...
class BinaryType(_AtomicType):
    """Binary data type. This maps to the BINARY data type in ClickZetta."""

    pass


class BooleanType(_AtomicType):
    """Boolean data type. This maps to the BOOLEAN data type in ClickZetta."""

    pass


class DateType(_AtomicType):
    """Date data type. This maps to the DATE data type in ClickZetta."""

    pass


class StringType(_AtomicType):
    """String data type. This maps to the VARCHAR data type in ClickZetta.
...
class TimestampTimeZone(Enum):
    """
    `Timestamp variations <https://doc.clickzetta.com/>`_.
    """
...
class TimestampType(_AtomicType):
    """Timestamp data type. This maps to the TIMESTAMP data type in ClickZetta."""
...
class TimeType(_AtomicType):
    """Time data type. This maps to the TIME data type in ClickZetta."""
...
class ByteType(_IntegralType):
    """Byte data type. This maps to the TINYINT data type in ClickZetta."""

    pass


class ShortType(_IntegralType):
    """Short integer data type. This maps to the SMALLINT data type in ClickZetta."""

    pass


class IntegerType(_IntegralType):
    """Integer data type. This maps to the INT data type in ClickZetta."""

    pass


class LongType(_IntegralType):
    """Long integer data type. This maps to the BIGINT data type in ClickZetta."""

    pass


class FloatType(_FractionalType):
    """Float data type. This maps to the FLOAT data type in ClickZetta."""

    pass


class DoubleType(_FractionalType):
    """Double data type. This maps to the DOUBLE data type in ClickZetta."""

    pass


class DecimalType(_FractionalType):
    """Decimal data type. This maps to the NUMBER data type in ClickZetta."""
...
class ArrayType(DataType):
    """Array data type. This maps to the ARRAY data type in ClickZetta."""
...
class MapType(DataType):
    """Map data type. This maps to the OBJECT data type in ClickZetta."""
...
class VectorType(DataType):
    """Vector data type. This maps to the VECTOR data type in ClickZetta."""
...
class ColumnIdentifier:
    ...
    def name(self) -> str:
        ...
        return quotes(self.normalized_name)
    ...
    def _strip_unnecessary_quotes(string: str) -> str:
        ...
        Remove quotes if name starts with _a-z and only contains _0-9a-z$.
        """
        remove_quote = re.compile("^`([_a-z]+[_0-9a-z]*)`$")
        result = remove_quote.search(string)
        return string[1:-1] if result else string
...
class VariantType(DataType):
    """Variant data type. This maps to the VARIANT data type in ClickZetta."""
...
class GeographyType(DataType):
    """Geography data type. This maps to the GEOGRAPHY data type in ClickZetta."""

    pass


class GeometryType(DataType):
    """Geometry data type. This maps to the GEOMETRY data type in ClickZetta."""
...
class PandasDataFrameType(_PandasType):
    ...
    def get_database_col_datatypes(self):
