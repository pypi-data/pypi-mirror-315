...
from clickzetta.zettapark import Column
from clickzetta.zettapark._internal.error_message import (
    ZettaparkClientExceptionMessages,
)
from clickzetta.zettapark._internal.telemetry import adjust_api_subcalls
    ...
    def crosstab(
        ...
        *,
        ...
        if row_count > _MAX_COLUMNS_PER_TABLE:
            raise ZettaparkClientExceptionMessages.DF_CROSS_TAB_COUNT_TOO_LARGE(
