...
class StoredProcedureRegistration:
    ...
    Example 6
        Create a stored procedure with stored-procedure-level packages and call it::
            ...
            >>> import math
            >>>
            >>> @sproc(packages=["snowflake-zettapark-python", "numpy"])
    ...
    def describe(
        ...
        """
        func_args = [convert_sp_to_cz_type(t) for t in sproc_obj._input_types]
    ...
    def _do_register_sp(
        ...
        *,
        ...
        # Add in snowflake-zettapark-python if it is not already in the package list.
        major, minor, patch = VERSION
        package_name = "snowflake-zettapark-python"
        ...
        # default to the packages in the current session. If snowflake-zettapark-python is not
