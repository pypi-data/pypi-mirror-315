...
def to_timestamp(e: ColumnOrName, fmt: Optional["Column"] = None) -> Column:
    ...
    <https://docs.snowflake.com/en/sql-reference/functions/to_timestamp#usage-notes>. Currently Zettapark does support
    ...
    *,
    ...
    Args:
        ...
        packages: A list of packages that only apply to this UDTF. These UDTF-level packages
            ...
            in Snowflake, refer to :meth:`~clickzetta.zettapark.Session.custom_package_usage_config`.
...
def sproc(
    ...
    **kwargs,
    ...
    `snowflake-zettapark-python` package (version >= 0.4.0) to your session before trying to create a
    stored procedure.
    ...
    Args:
        ...
        packages: A list of packages that only apply to this stored procedure. These stored-proc-level packages
            ...
            Snowflake, refer to :meth:`~clickzetta.zettapark.Session.custom_package_usage_config`.
    ...
    Example::
        >>> from clickzetta.zettapark.types import IntegerType
        >>> @sproc(return_type=IntegerType(), input_types=[IntegerType(), IntegerType()], packages=["snowflake-zettapark-python"])
