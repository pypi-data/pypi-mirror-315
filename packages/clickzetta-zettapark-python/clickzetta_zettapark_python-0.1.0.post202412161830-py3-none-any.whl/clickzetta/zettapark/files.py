...
"""
SnowflakeFile for UDFs and stored procedures in Zettapark.
...
class SnowflakeFile(RawIOBase):
    ...
    The constructor of this class is not supposed to be called directly. Call :meth:`~clickzetta.zettapark.file.SnowflakeFile.open` to create a SnowflakeFile object.
    ...
    def open(
        ...
        *,
        ...
        """
        Returns a :class:`~clickzetta.zettapark.file.SnowflakeFile`.
