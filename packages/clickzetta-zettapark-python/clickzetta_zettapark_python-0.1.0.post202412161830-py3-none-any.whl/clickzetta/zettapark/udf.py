...
"""User-defined functions (UDFs) in Zettapark. Please see `Python UDFs <https://docs.snowflake.com/en/developer-guide/zettapark/python/creating-udfs>`_ for details.
...
from clickzetta.zettapark._internal.analyzer.expression import Expression, SnowflakeUDF
...
class UDFRegistration:
    ...
    Example 8
        Use cache to read a file once from a stage in a UDF::
            ...
            [Row(COL1='zettapark-snowflake'), Row(COL1='zettapark-python')]
