...
from django33.contrib.sessions.backends.base import CreateError, SessionBase, UpdateError
from django33.core.exceptions import SuspiciousOperation
from django33.db import DatabaseError, IntegrityError, router, transaction
...
class SessionStore(SessionBase):
    ...
    def get_model_class(cls):
        ...
        # django33.contrib.sessions is not in INSTALLED_APPS.
        from django33.contrib.sessions.models import Session
    ...
    def _get_session_from_db(self):
        try:
            ...
            if isinstance(e, SuspiciousOperation):
                logger = logging.getLogger("django33.security.%s" % e.__class__.__name__)
