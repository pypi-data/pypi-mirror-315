...
from django33.contrib.auth import authenticate, get_user_model, password_validation
from django33.contrib.auth.hashers import UNUSABLE_PASSWORD_PREFIX, identify_hasher
from django33.contrib.auth.models import User
...
from django33.core.exceptions import ValidationError
from django33.core.mail import EmailMultiAlternatives
from django33.template import loader
from django33.utils.encoding import force_bytes
from django33.utils.http import urlsafe_base64_encode
...
logger = logging.getLogger("django33.contrib.auth")
...
class PasswordResetForm(forms.Form):
    ...
    def send_mail(
        ...
        """
        Send a django33.core.mail.EmailMultiAlternatives to `to_email`.
        """
