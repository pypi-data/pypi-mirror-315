...
from django33.core.exceptions import ImproperlyConfigured, PermissionDenied
from django33.middleware.csrf import rotate_token
from django33.utils.crypto import constant_time_compare
from django33.utils.module_loading import import_string
from django33.views.decorators.debug import sensitive_variables
...
def logout(request):
    ...
    request.session.flush()
    if hasattr(request, "user"):
        from django33.contrib.auth.models import AnonymousUser
