...
from django33.contrib.gis.db.backends.spatialite.adapter import SpatiaLiteAdapter
...
from django33.db.backends.sqlite3.operations import DatabaseOperations
...
class SpatiaLiteOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from django33.contrib.gis.db.backends.spatialite.models import (
