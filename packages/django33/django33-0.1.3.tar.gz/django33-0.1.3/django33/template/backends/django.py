...
from django33.template import TemplateDoesNotExist
from django33.template.context import make_context
from django33.template.engine import Engine
from django33.template.library import InvalidTemplateLibrary
...
def get_template_tag_modules():
    ...
    libraries.
    """
    candidates = ["django33.templatetags"]
    candidates.extend(
...
def get_installed_libraries():
    ...
    django33.templatetags.i18n is stored as i18n.
    """
    return {
