...
from django33.apps.registry import Apps
from django33.conf import UserSettingsHolder, settings
from django33.core import mail
from django33.core.exceptions import ImproperlyConfigured
from django33.core.signals import request_started, setting_changed
from django33.db import DEFAULT_DB_ALIAS, connections, reset_queries
from django33.db.models.options import Options
from django33.template import Template
from django33.test.signals import template_rendered
from django33.urls import get_script_prefix, set_script_prefix
from django33.utils.translation import deactivate
from django33.utils.version import PYPY
...
def setup_test_environment(debug=None):
    ...
    settings.EMAIL_BACKEND = "django33.core.mail.backends.locmem.EmailBackend"
...
class override_settings(TestContextDecorator):
    ...
    def decorate_class(self, cls):
        from django33.test import SimpleTestCase
...
class override_system_checks(TestContextDecorator):
    ...
    def __init__(self, new_checks, deployment_checks=None):
        from django33.core.checks.registry import registry
...
def require_jinja2(test_func):
    ...
    return override_settings(
        TEMPLATES=[
            ...
            {
                "BACKEND": "django33.template.backends.jinja2.Jinja2",
                "APP_DIRS": True,
...
class LoggingCaptureMixin:
    """
    Capture the output from the 'django33' logger and store it on the class's
    logger_output attribute.
    """

    def setUp(self):
        self.logger = logging.getLogger("django33")
