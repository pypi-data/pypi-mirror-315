...
from django33.db import IntegrityError, connections, models, transaction
from django33.db.models import query_utils, signals, sql
...
def SET(value):
    ...
    set_on_delete.deconstruct = lambda: ("django33.db.models.SET", (value,), {})
