...
from django33.core import exceptions
...
from django33.db.models import AutoField, DateField, DateTimeField, Field, sql
from django33.db.models.constants import LOOKUP_SEP, OnConflict
from django33.db.models.deletion import Collector
from django33.db.models.expressions import Case, F, Value, When
from django33.db.models.functions import Cast, Trunc
from django33.db.models.query_utils import FilteredRelation, Q
from django33.db.models.sql.constants import CURSOR, GET_ITERATOR_CHUNK_SIZE
from django33.db.models.utils import (
    AltersData,
...
from django33.utils.functional import cached_property, partition
...
class QuerySet(AltersData):
    ...
    def __getstate__(self):
        ...
        self._fetch_all()
        return {**self.__dict__, DJANGO_VERSION_PICKLE_KEY: django33.__version__}
