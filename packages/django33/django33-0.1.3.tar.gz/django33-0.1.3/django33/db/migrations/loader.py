...
from django33.db.migrations.graph import MigrationGraph
...
class MigrationLoader:
    ...
    inherit from django33.db.migrations.Migration. See
    django33.db.migrations.migration for what that looks like.
