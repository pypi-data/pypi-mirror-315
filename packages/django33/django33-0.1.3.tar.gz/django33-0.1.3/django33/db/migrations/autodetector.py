...
from django33.db.migrations import operations
from django33.db.migrations.migration import Migration
from django33.db.migrations.operations.models import AlterModelOptions
from django33.db.migrations.optimizer import MigrationOptimizer
from django33.db.migrations.questioner import MigrationQuestioner
from django33.db.migrations.utils import (
    COMPILED_REGEX_TYPE,
    RegexObject,
    resolve_relation,
)
