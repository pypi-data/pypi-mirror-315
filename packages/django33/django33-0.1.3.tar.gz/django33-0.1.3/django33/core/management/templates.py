...
from django33.core.management.base import BaseCommand, CommandError
from django33.core.management.utils import (
    find_formatters,
    handle_extensions,
    run_formatters,
)
from django33.template import Context, Engine
from django33.utils import archive
from django33.utils.http import parse_header_parameters
...
class TemplateCommand(BaseCommand):
    ...
    :param style: A color style object (see django33.core.management.color).
        ...
        context = Context(
            {
                **options,
                ...
                "django_version": django33.__version__,
            },
            autoescape=False,
        )
    ...
    def handle_template(self, template, subdir):
        ...
        Use django33.__path__[0] as the default because the Django install
        directory isn't known.
        """
        if template is None:
            return os.path.join(django33.__path__[0], "conf", subdir)
        else:
    ...
    def download(self, url):
        ...
        opener = build_opener()
        opener.addheaders = [("User-Agent", f"Django/{django33.__version__}")]
        try:
