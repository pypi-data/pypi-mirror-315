...
SECRET_KEY_INSECURE_PREFIX = "django33-insecure-"
...
W001 = Warning(
    "You do not have 'django33.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'django33.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
def _security_middleware():
    return "django33.middleware.security.SecurityMiddleware" in settings.MIDDLEWARE


def _xframe_middleware():
    return (
        "django33.middleware.clickjacking.XFrameOptionsMiddleware" in settings.MIDDLEWARE
    )
