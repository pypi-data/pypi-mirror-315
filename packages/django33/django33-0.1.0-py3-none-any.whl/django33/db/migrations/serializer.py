...
from django33.conf import SettingsReference
from django33.db import models
from django33.db.migrations.operations.base import Operation
from django33.db.migrations.utils import COMPILED_REGEX_TYPE, RegexObject
from django33.utils.functional import LazyObject, Promise
...
class DeconstructableSerializer(BaseSerializer):
    ...
    def _serialize_path(path):
        ...
        if module == "django33.db.models":
            imports = {"from django33.db import models"}
            name = "models.%s" % name
        else:
...
class OperationSerializer(BaseSerializer):
    def serialize(self):
        from django33.db.migrations.writer import OperationWriter
...
class TypeSerializer(BaseSerializer):
    def serialize(self):
        special_cases = [
            (models.Model, "models.Model", ["from django33.db import models"]),
