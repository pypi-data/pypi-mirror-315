...
from django33.apps.registry import apps as global_apps
from django33.conf import settings
from django33.core.exceptions import FieldDoesNotExist
from django33.db import models
from django33.db.migrations.utils import field_is_referenced, get_references
from django33.db.models import NOT_PROVIDED
from django33.db.models.fields.related import RECURSIVE_RELATIONSHIP_CONSTANT
from django33.db.models.options import DEFAULT_NAMES, normalize_together
from django33.db.models.utils import make_model_tuple
from django33.utils.functional import cached_property
from django33.utils.module_loading import import_string
from django33.utils.version import get_docs_version
...
class StateApps(Apps):
    ...
    def __init__(self, real_apps, models, ignore_swappable=False):
        ...
        from django33.core.checks.model_checks import _check_lazy_references
