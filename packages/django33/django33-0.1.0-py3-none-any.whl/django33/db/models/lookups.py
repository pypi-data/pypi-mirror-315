...
from django33.core.exceptions import EmptyResultSet, FullResultSet
from django33.db.backends.base.operations import BaseDatabaseOperations
from django33.db.models.expressions import Case, Expression, Func, Value, When
from django33.db.models.fields import (
    BooleanField,
    CharField,
    DateTimeField,
    Field,
...
from django33.db.models.query_utils import RegisterLookupMixin
from django33.utils.datastructures import OrderedSet
...
class Lookup(Expression):
    ...
    def __init__(self, lhs, rhs):
        ...
        if bilateral_transforms:
            ...
            from django33.db.models.sql.query import Query  # avoid circular import
...
class YearLookup(Lookup):
    def year_lookup_bounds(self, connection, year):
        from django33.db.models.functions import ExtractIsoYear
...
class UUIDTextMixin:
    ...
    def process_rhs(self, qn, connection):
        if not connection.features.has_native_uuid_field:
            from django33.db.models.functions import Replace
