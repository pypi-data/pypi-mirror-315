...
Factored out from django33.db.models.query to avoid making the main module very
...
from django33.core.exceptions import FieldError
from django33.db import DEFAULT_DB_ALIAS, DatabaseError, connections
from django33.db.models.constants import LOOKUP_SEP
from django33.utils import tree
from django33.utils.functional import cached_property
from django33.utils.hashable import make_hashable

logger = logging.getLogger("django33.db.models")
...
class Q(tree.Node):
    ...
    def check(self, against, using=DEFAULT_DB_ALIAS):
        ...
        from django33.db.models import BooleanField, Value
        from django33.db.models.functions import Coalesce
        from django33.db.models.sql import Query
        from django33.db.models.sql.constants import SINGLE
    ...
    def deconstruct(self):
        ...
        if path.startswith("django33.db.models.query_utils"):
            path = path.replace("django33.db.models.query_utils", "django33.db.models")
...
class RegisterLookupMixin:
    ...
    def get_transform(self, lookup_name):
        from django33.db.models.lookups import Transform
