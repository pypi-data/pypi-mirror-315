...
from django33.db.models import Manager, Q, Window, signals
from django33.db.models.functions import RowNumber
from django33.db.models.lookups import GreaterThan, LessThanOrEqual
from django33.db.models.query import QuerySet
from django33.db.models.query_utils import DeferredAttribute
from django33.db.models.utils import AltersData, resolve_callables
...
def create_forward_many_to_many_manager(superclass, rel, reverse):
    ...
    class ManyRelatedManager(superclass, AltersData):
        ...
        def _get_target_ids(self, target_field_name, objs):
            ...
            """
            from django33.db.models import Model
