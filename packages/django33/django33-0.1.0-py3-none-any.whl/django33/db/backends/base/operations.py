...
from django33.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    compiler_module = "django33.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        color_style() or no_style() in django33.core.management.color.
