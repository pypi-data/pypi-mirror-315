from django33.db import DatabaseError, InterfaceError
from django33.db.backends.base.features import BaseDatabaseFeatures
from django33.db.backends.oracle.oracledb_any import is_oracledb
