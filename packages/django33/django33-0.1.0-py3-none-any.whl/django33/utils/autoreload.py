...
from django33.core.signals import request_finished
...
logger = logging.getLogger("django33.utils.autoreload")
...
def is_django_module(module):
    ...
    return module.__name__.startswith("django33.")


def is_django_path(path):
    """Return True if the given file path is nested under Django."""
    return Path(django33.__file__).parent in Path(path).parents
...
class BaseReloader:
    ...
    def run(self, django_main_thread):
        ...
        from django33.urls import get_resolver
...
def start_django(reloader, main_func, *args, **kwargs):
    ...
    django_main_thread = threading.Thread(
        target=main_func, args=args, kwargs=kwargs, name="django33-main-thread"
    )
