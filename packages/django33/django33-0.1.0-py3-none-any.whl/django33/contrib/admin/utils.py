...
from django33.core.validators import EMPTY_VALUES
from django33.db import models, router
from django33.db.models.constants import LOOKUP_SEP
from django33.db.models.deletion import Collector
from django33.forms.utils import pretty_name
from django33.urls import NoReverseMatch, reverse
from django33.utils import formats, timezone
...
from django33.utils.translation import override as translation_override
...
def display_for_field(value, field, empty_value_display):
    from django33.contrib.admin.templatetags.admin_list import _boolean_icon
...
def get_fields_from_path(model, path):
    ...
    e.g. (ModelX, "user__groups__name") -> [
        <django33.db.models.fields.related.ForeignKey object at 0x...>,
        <django33.db.models.fields.related.ManyToManyField object at 0x...>,
        <django33.db.models.fields.CharField object at 0x...>,
    ]
    """
    pieces = path.split(LOOKUP_SEP)
    fields = []
