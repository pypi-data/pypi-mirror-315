"""
 ...
 Example:
  >>> from django33.contrib.gis.gdal import OGRGeometry, OGRGeomType, SpatialReference
  ...
  >>> from django33.contrib.gis.gdal import OGRGeomType
...
from django33.contrib.gis.gdal.base import GDALBase
from django33.contrib.gis.gdal.envelope import Envelope, OGREnvelope
from django33.contrib.gis.gdal.error import GDALException, SRSException
from django33.contrib.gis.gdal.geomtype import OGRGeomType
from django33.contrib.gis.gdal.prototypes import geom as capi
from django33.contrib.gis.gdal.prototypes import srs as srs_api
from django33.contrib.gis.gdal.srs import CoordTransform, SpatialReference
from django33.contrib.gis.geometry import hex_regex, json_regex, wkt_regex
...
class OGRGeometry(GDALBase):
    ...
    # #### Output Methods ####
    def _geos_ptr(self):
        from django33.contrib.gis.geos import GEOSGeometry
...
class Point(OGRGeometry):
    def _geos_ptr(self):
        from django33.contrib.gis import geos
