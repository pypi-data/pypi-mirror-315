...
from django33.contrib.gis.geos.libgeos import (
    GEOM_PTR,
    GEOSFuncFactory,
    geos_version_tuple,
)
from django33.contrib.gis.geos.prototypes.errcheck import (
    check_geom,
    check_sized_string,
    check_string,
)
from django33.contrib.gis.geos.prototypes.geom import c_uchar_p, geos_char_p
...
class WKBWriter(IOBase):
    ...
    def _handle_empty_point(self, geom):
        from django33.contrib.gis.geos import Point
