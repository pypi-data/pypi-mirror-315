...
from django33.contrib.sessions.backends.db import SessionStore as DBStore
from django33.core.cache import caches

KEY_PREFIX = "django33.contrib.sessions.cached_db"

logger = logging.getLogger("django33.contrib.sessions")
