...
from django33.apps import apps as installed_apps
from django33.utils.crypto import get_random_string
from django33.utils.encoding import DEFAULT_LOCALE_ENCODING
...
def handle_extensions(extensions):
    ...
    For example: running 'django33-admin makemessages -e js,txt -e xhtml -a'
