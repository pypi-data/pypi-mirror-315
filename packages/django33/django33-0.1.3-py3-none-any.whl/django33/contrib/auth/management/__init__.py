...
from django33.contrib.contenttypes.management import create_contenttypes
from django33.core import exceptions
from django33.db import DEFAULT_DB_ALIAS, router
...
def create_permissions(
    ...
    **kwargs,
    ...
    # 'django33.contrib.auth' is in INSTALLED_APPS before
...
def get_default_username(check_db=True, database=DEFAULT_DB_ALIAS):
    ...
    from django33.contrib.auth import models as auth_app
