...
from django33.contrib.postgres import lookups
from django33.contrib.postgres.forms import SimpleArrayField
from django33.contrib.postgres.validators import ArrayMaxLengthValidator
from django33.core import checks, exceptions
from django33.db.models import Field, Func, IntegerField, Transform, Value
from django33.db.models.fields.mixins import CheckFieldDefaultMixin
from django33.db.models.lookups import Exact, In
...
class ArrayField(CheckFieldDefaultMixin, Field):
    ...
    def deconstruct(self):
        ...
        if path == "django33.contrib.postgres.fields.array.ArrayField":
            path = "django33.contrib.postgres.fields.ArrayField"
        kwargs.update(
            {
