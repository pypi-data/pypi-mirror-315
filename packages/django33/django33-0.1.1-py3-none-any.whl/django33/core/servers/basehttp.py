...
from django33.core.handlers.wsgi import LimitedStream
from django33.core.wsgi import get_wsgi_application
from django33.db import connections
from django33.utils.module_loading import import_string

__all__ = ("WSGIServer", "WSGIRequestHandler")

logger = logging.getLogger("django33.server")
...
def get_internal_wsgi_application():
    ...
    whatever ``django33.core.wsgi.get_wsgi_application`` returns.
    """
