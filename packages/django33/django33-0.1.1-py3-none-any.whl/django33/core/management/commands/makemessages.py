...
from django33.core.files.temp import NamedTemporaryFile
...
from django33.utils.jslex import prepare_js_for_gettext
from django33.utils.regex_helper import _lazy_re_compile
from django33.utils.text import get_text_list
from django33.utils.translation import templatize
...
class Command(BaseCommand):
    help = (
        ...
        "conf/locale (in the django33 tree) or locale (for projects and applications) "
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            "-d",
            default="django33",
            help='The domain of the message files (default: "django33").',
        )
        parser.add_argument(
            "--all",
            "-a",
    ...
    def handle(self, *args, **options):
        ...
        if self.domain not in ("django33", "djangojs"):
            raise CommandError(
                "currently makemessages only supports domains "
                "'django33' and 'djangojs'"
            )
        if self.domain == "djangojs":
    ...
    def process_locale_dir(self, locale_dir, files):
        ...
        for translatable in files:
            ...
            if self.domain not in ("djangojs", "django33"):
                continue
    ...
    def copy_plural_forms(self, msgs, locale):
        ...
        """
        django_dir = os.path.normpath(os.path.join(os.path.dirname(django33.__file__)))
        if self.domain == "djangojs":
            domains = ("djangojs", "django33")
        else:
            domains = ("django33",)
