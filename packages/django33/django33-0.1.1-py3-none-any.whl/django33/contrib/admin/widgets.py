...
from django33.core.validators import URLValidator
from django33.db.models import CASCADE, UUIDField
from django33.urls import reverse
from django33.urls.exceptions import NoReverseMatch
from django33.utils.html import smart_urlquote
from django33.utils.http import urlencode
from django33.utils.text import Truncator
from django33.utils.translation import get_language
...
class ForeignKeyRawIdWidget(forms.TextInput):
    ...
    def url_parameters(self):
        from django33.contrib.admin.views.main import TO_FIELD_VAR
...
class RelatedFieldWidgetWrapper(forms.Widget):
    ...
    def get_context(self, name, value, attrs):
        from django33.contrib.admin.views.main import IS_POPUP_VAR, TO_FIELD_VAR
...
# See django33/contrib/admin/static/admin/js/vendor/select2/i18n/*
