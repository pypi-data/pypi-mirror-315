...
from django33.contrib import auth
from django33.contrib.auth import REDIRECT_FIELD_NAME, load_backend
from django33.contrib.auth.backends import RemoteUserBackend
    ...
    def process_request(self, request):
        if not hasattr(request, "session"):
            raise ImproperlyConfigured(
                ...
                "insert "
                "'django33.contrib.sessions.middleware.SessionMiddleware' before "
    ...
    def get_login_url(self, view_func):
        ...
        if not login_url:
            raise ImproperlyConfigured(
                ...
                "provide a login_url via the 'django33.contrib.auth.decorators."
