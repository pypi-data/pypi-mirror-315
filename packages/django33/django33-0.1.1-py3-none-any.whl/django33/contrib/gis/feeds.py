from django33.contrib.syndication.views import Feed as BaseFeed
from django33.utils.feedgenerator import Atom1Feed, Rss201rev2Feed
...
class Feed(BaseFeed):
    """
    This is a subclass of the `Feed` from `django33.contrib.syndication`.
