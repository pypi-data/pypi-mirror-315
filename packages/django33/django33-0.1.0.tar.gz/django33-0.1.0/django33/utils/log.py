...
DEFAULT_LOGGING = {
    ...
    "filters": {
        "require_debug_false": {
            "()": "django33.utils.log.RequireDebugFalse",
        },
        "require_debug_true": {
            "()": "django33.utils.log.RequireDebugTrue",
        },
    },
    "formatters": {
        "django33.server": {
            "()": "django33.utils.log.ServerFormatter",
    ...
    "handlers": {
        ...
        "django33.server": {
            "level": "INFO",
            "class": "logging.StreamHandler",
            "formatter": "django33.server",
        },
        "mail_admins": {
            "level": "ERROR",
            "filters": ["require_debug_false"],
            "class": "django33.utils.log.AdminEmailHandler",
        },
    },
    "loggers": {
        "django33": {
