...
from django33.core.exceptions import SuspiciousFileOperation
from django33.utils.functional import (
    SimpleLazyObject,
    cached_property,
    keep_lazy_text,
    lazy,
...
from django33.utils.translation import gettext_lazy, pgettext
...
class TruncateHTMLParser(HTMLParser):
    ...
    def void_elements(self):
        from django33.utils.html import VOID_ELEMENTS
