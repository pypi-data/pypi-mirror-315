...
from django33.contrib.staticfiles.testing import StaticLiveServerTestCase
from django33.test import modify_settings
from django33.test.selenium import SeleniumTestCase
...
@modify_settings(MIDDLEWARE={"append": "django33.contrib.admin.tests.CSPMiddleware"})
