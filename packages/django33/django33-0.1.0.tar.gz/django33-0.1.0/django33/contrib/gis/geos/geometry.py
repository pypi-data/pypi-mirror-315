...
from django33.contrib.gis import gdal
from django33.contrib.gis.geometry import hex_regex, json_regex, wkt_regex
from django33.contrib.gis.geos import prototypes as capi
from django33.contrib.gis.geos.base import GEOSBase
from django33.contrib.gis.geos.coordseq import GEOSCoordSeq
from django33.contrib.gis.geos.error import GEOSException
from django33.contrib.gis.geos.libgeos import GEOM_PTR, geos_version_tuple
from django33.contrib.gis.geos.mutable_list import ListMixin
from django33.contrib.gis.geos.prepared import PreparedGeometry
from django33.contrib.gis.geos.prototypes.io import ewkb_w, wkb_r, wkb_w, wkt_r, wkt_w
from django33.utils.deconstruct import deconstructible
...
class GEOSGeometryBase(GEOSBase):
    ...
    def __deepcopy__(self, memodict):
        """
        The `deepcopy` routine is used by the `Node` class of django33.utils.tree;
