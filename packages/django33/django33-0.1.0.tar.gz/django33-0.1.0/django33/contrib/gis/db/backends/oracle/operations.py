...
from django33.contrib.gis.db import models
from django33.contrib.gis.db.backends.base.operations import BaseSpatialOperations
from django33.contrib.gis.db.backends.oracle.adapter import OracleSpatialAdapter
from django33.contrib.gis.db.backends.utils import SpatialOperator
from django33.contrib.gis.geos.geometry import GEOSGeometry, GEOSGeometryBase
from django33.contrib.gis.geos.prototypes.io import wkb_r
from django33.contrib.gis.measure import Distance
from django33.db.backends.oracle.operations import DatabaseOperations
...
class OracleOperations(BaseSpatialOperations, DatabaseOperations):
    ...
    def geometry_columns(self):
        from django33.contrib.gis.db.backends.oracle.models import OracleGeometryColumns

        return OracleGeometryColumns

    def spatial_ref_sys(self):
        from django33.contrib.gis.db.backends.oracle.models import OracleSpatialRefSys
