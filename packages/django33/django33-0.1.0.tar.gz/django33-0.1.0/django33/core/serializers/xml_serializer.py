...
from django33.core.serializers import base
from django33.db import DEFAULT_DB_ALIAS, models
from django33.utils.xmlutils import SimplerXMLGenerator, UnserializableContentError
...
class Serializer(base.Serializer):
    ...
    def start_serialization(self):
        ...
        self.xml.startElement("django33-objects", {"version": "1.0"})
    ...
    def end_serialization(self):
        ...
        """
        self.indent(0)
        self.xml.endElement("django33-objects")
