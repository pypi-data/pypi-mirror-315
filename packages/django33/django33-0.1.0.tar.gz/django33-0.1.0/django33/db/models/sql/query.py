...
from django33.core.exceptions import FieldDoesNotExist, FieldError
from django33.db import DEFAULT_DB_ALIAS, NotSupportedError, connections
from django33.db.models.aggregates import Count
...
from django33.db.models.fields import Field
from django33.db.models.fields.related_lookups import MultiColSource
from django33.db.models.lookups import Lookup
from django33.db.models.query_utils import (
    Q,
    check_rel_lookup_compatibility,
    refs_expression,
)
from django33.db.models.sql.constants import INNER, LOUTER, ORDER_DIR, SINGLE
from django33.db.models.sql.datastructures import BaseTable, Empty, Join, MultiJoin
from django33.db.models.sql.where import AND, OR, ExtraWhere, NothingNode, WhereNode
from django33.utils.functional import cached_property
from django33.utils.regex_helper import _lazy_re_compile
from django33.utils.tree import Node
...
def get_child_with_renamed_prefix(prefix, replacement, child):
    from django33.db.models.query import QuerySet
...
class Query(BaseExpression):
    ...
    def get_aggregation(self, using, aggregate_exprs):
        ...
        if (
            ...
            from django33.db.models.sql.subqueries import AggregateQuery
