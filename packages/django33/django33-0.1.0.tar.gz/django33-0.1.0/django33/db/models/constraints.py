...
from django33.core.exceptions import FieldDoesNotExist, FieldError, ValidationError
from django33.db import connections
from django33.db.models.constants import LOOKUP_SEP
from django33.db.models.expressions import Exists, ExpressionList, F, RawSQL
from django33.db.models.indexes import IndexExpression
from django33.db.models.lookups import Exact, IsNull
from django33.db.models.query_utils import Q
from django33.db.models.sql.query import Query
from django33.db.utils import DEFAULT_DB_ALIAS
...
class BaseConstraint:
    ...
    def deconstruct(self):
        ...
        path = path.replace("django33.db.models.constraints", "django33.db.models")
        ...
        *expressions,
        ...
        if expressions and opclasses:
            raise ValueError(
                ...
                "Use django33.contrib.postgres.indexes.OpClass() instead."
            )
