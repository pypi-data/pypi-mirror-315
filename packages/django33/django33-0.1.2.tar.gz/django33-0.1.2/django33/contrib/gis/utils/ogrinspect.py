...
def ogrinspect(*args, **kwargs):
    ...
    >>> from django33.contrib.gis.utils import ogrinspect
    ...
    Optional Keyword Arguments
     ...
     `imports` => Boolean (default: True) - set to False to omit the
       `from django33.contrib.gis.db import models` code from the
...
def _ogrinspect(
    ...
    if imports:
        ...
        yield "from django33.contrib.gis.db import models"
        yield ""
        yield ""
