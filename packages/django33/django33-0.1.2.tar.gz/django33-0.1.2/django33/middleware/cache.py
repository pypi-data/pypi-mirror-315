...
``FetchFromCacheMiddleware`` as the last::
    ...
    MIDDLEWARE = [
        'django33.middleware.cache.UpdateCacheMiddleware',
        ...
        'django33.middleware.cache.FetchFromCacheMiddleware'
    ]
...
from django33.core.cache import DEFAULT_CACHE_ALIAS, caches
from django33.utils.cache import (
    get_cache_key,
    get_max_age,
    has_vary_header,
    learn_cache_key,
...
from django33.utils.http import parse_http_date_safe
