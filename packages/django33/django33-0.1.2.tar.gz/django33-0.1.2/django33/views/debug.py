...
from django33.http import Http404, HttpResponse, HttpResponseNotFound
from django33.template import Context, Engine, TemplateDoesNotExist
from django33.template.defaultfilters import pprint
from django33.urls import resolve
from django33.utils import timezone
from django33.utils.datastructures import MultiValueDict
...
from django33.utils.version import PY311, get_docs_version
from django33.views.decorators.debug import coroutine_functions_to_sensitive_variables
...
DEBUG_ENGINE = Engine(
    debug=True,
    libraries={"i18n": "django33.templatetags.i18n"},
)
    ...
    def get_exception_traceback_frames(self, exc_value, tb):
        ...
        while tb is not None:
            ...
            yield {
                ...
                "exc_cause_explicit": exc_cause_explicit,
                "tb": tb,
                "type": "django33" if module_name.startswith("django33.") else "user",
                "filename": filename,
                "function": function,
                "lineno": lineno + 1,
