...
from django33.template.context import BaseContext
from django33.utils.formats import localize
from django33.utils.html import conditional_escape, escape
from django33.utils.regex_helper import _lazy_re_compile
from django33.utils.safestring import SafeData, SafeString, mark_safe
from django33.utils.text import get_text_list, smart_split, unescape_string_literal
from django33.utils.timezone import template_localtime
from django33.utils.translation import gettext_lazy, pgettext_lazy
...
logger = logging.getLogger("django33.template")
...
class Parser:
    def __init__(self, tokens, libraries=None, builtins=None, origin=None):
        ...
        # should use a key to namespace any added data. The 'django33' namespace
