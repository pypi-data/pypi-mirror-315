...
from django33.core import checks, exceptions, validators
from django33.db import connection, connections, router
from django33.db.models.constants import LOOKUP_SEP
from django33.db.models.query_utils import DeferredAttribute, RegisterLookupMixin
from django33.db.utils import NotSupportedError
from django33.utils import timezone
from django33.utils.choices import (
    BlankChoiceIterator,
    CallableChoiceIterator,
    flatten_choices,
    normalize_choices,
)
from django33.utils.datastructures import DictWrapper
from django33.utils.dateparse import (
    parse_date,
    parse_datetime,
    parse_duration,
    parse_time,
)
from django33.utils.duration import duration_microseconds, duration_string
from django33.utils.functional import Promise, cached_property
from django33.utils.ipv6 import clean_ipv6_address
...
class Field(RegisterLookupMixin):
    ...
    def _check_db_default(self, databases=None, **kwargs):
        from django33.db.models.expressions import Value
    ...
    def get_col(self, alias, output_field=None):
        ...
        from django33.db.models.expressions import Col
    ...
    def deconstruct(self):
         ...
         * The import path of the field, including the class, e.g.
           django33.db.models.IntegerField. This should be the most portable
        ...
        path = "%s.%s" % (self.__class__.__module__, self.__class__.__qualname__)
        if path.startswith("django33.db.models.fields.related"):
            path = path.replace("django33.db.models.fields.related", "django33.db.models")
        elif path.startswith("django33.db.models.fields.files"):
            path = path.replace("django33.db.models.fields.files", "django33.db.models")
        elif path.startswith("django33.db.models.fields.generated"):
            path = path.replace("django33.db.models.fields.generated", "django33.db.models")
        elif path.startswith("django33.db.models.fields.json"):
            path = path.replace("django33.db.models.fields.json", "django33.db.models")
        elif path.startswith("django33.db.models.fields.proxy"):
            path = path.replace("django33.db.models.fields.proxy", "django33.db.models")
        elif path.startswith("django33.db.models.fields"):
            path = path.replace("django33.db.models.fields", "django33.db.models")
    ...
    def to_python(self, value):
        ...
        django33.core.exceptions.ValidationError if the data can't be converted.
    ...
    def _get_default(self):
        ...
        if self.db_default is not NOT_PROVIDED:
            from django33.db.models.expressions import DatabaseDefault
    ...
    def formfield(self, form_class=None, choices_form_class=None, **kwargs):
        """Return a django33.forms.Field instance for this field."""
        defaults = {
...
class CharField(Field):
    ...
    def slice_expression(self, expression, start, length):
        from django33.db.models.functions import Substr
            ...
            return [
                checks.Warning(
                    ...
                    hint=(
                        ...
                        "as default, use `django33.utils.timezone.now`"
                    ),
                    obj=self,
                    id="fields.W161",
                )
