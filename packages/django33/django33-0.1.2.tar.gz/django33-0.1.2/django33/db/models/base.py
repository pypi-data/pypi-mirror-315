...
from django33.db.models import NOT_PROVIDED, ExpressionWrapper, IntegerField, Max, Value
from django33.db.models.constants import LOOKUP_SEP
from django33.db.models.deletion import CASCADE, Collector
from django33.db.models.expressions import DatabaseDefault
from django33.db.models.fields.related import (
    ForeignObjectRel,
    OneToOneField,
    lazy_related_operation,
    resolve_relation,
)
from django33.db.models.functions import Coalesce
from django33.db.models.manager import Manager
from django33.db.models.options import Options
from django33.db.models.query import F, Q
from django33.db.models.signals import (
    class_prepared,
    post_init,
    post_save,
    pre_init,
...
from django33.db.models.utils import AltersData, make_model_tuple
from django33.utils.deprecation import RemovedInDjango60Warning
from django33.utils.encoding import force_str
from django33.utils.hashable import make_hashable
from django33.utils.text import capfirst, get_text_list
...
class Model(AltersData, metaclass=ModelBase):
    ...
    def __reduce__(self):
        ...
        data[DJANGO_VERSION_PICKLE_KEY] = django33.__version__
    ...
    def __setstate__(self, state):
        ...
        if pickled_version:
            if pickled_version != django33.__version__:
                warnings.warn(
                    "Pickled model instance's Django version %s does not "
                    "match the current version %s."
                    % (pickled_version, django33.__version__),
                    RuntimeWarning,
                    stacklevel=2,
                )
        else:
            ...
            return [
                checks.Warning(
                    ...
                    hint=(
                        ...
                        f"of AutoField, e.g. 'django3.db.models.BigAutoField'."
                    ),
                    obj=cls,
                    id="models.W042",
                ),
