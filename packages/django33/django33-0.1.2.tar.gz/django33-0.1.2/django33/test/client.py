...
from django33.core.handlers.asgi import ASGIRequest
from django33.core.handlers.base import BaseHandler
from django33.core.handlers.wsgi import LimitedStream, WSGIRequest
from django33.core.serializers.json import DjangoJSONEncoder
from django33.core.signals import got_request_exception, request_finished, request_started
from django33.db import close_old_connections
from django33.http import HttpHeaders, HttpRequest, QueryDict, SimpleCookie
from django33.test import signals
from django33.test.utils import ContextList
from django33.urls import resolve
from django33.utils.encoding import force_bytes
...
class ClientMixin:
    ...
    def login(self, **credentials):
        ...
        are incorrect.
        """
        from django33.contrib.auth import authenticate
    ...
    async def alogin(self, **credentials):
        """See login()."""
        from django33.contrib.auth import aauthenticate
    ...
    def _get_backend(self):
        from django33.contrib.auth import load_backend
    ...
    def _login(self, user, backend=None):
        from django33.contrib.auth import login
    ...
    async def _alogin(self, user, backend=None):
        from django33.contrib.auth import alogin
    ...
    def logout(self):
        ...
        from django33.contrib.auth import get_user, logout
    ...
    async def alogout(self):
        """See logout()."""
        from django33.contrib.auth import aget_user, alogout
