...
variable, and then from django33.conf.global_settings; see the global_settings.py
...
class LazySettings(LazyObject):
    ...
    def _add_script_prefix(value):
        ...
        if value.startswith(("http://", "https://", "/")):
            return value
        from django33.urls import get_script_prefix
    ...
    def _show_deprecation_warning(self, message, category):
        ...
        if not filename.startswith(os.path.dirname(django33.__file__)):
