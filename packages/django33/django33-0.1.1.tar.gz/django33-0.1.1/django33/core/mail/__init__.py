...
# django33/core/mail.py before the introduction of email
# backends and the subsequent reorganization (See #10355)
from django33.core.mail.message import (
...
from django33.core.mail.utils import DNS_NAME, CachedDnsName
