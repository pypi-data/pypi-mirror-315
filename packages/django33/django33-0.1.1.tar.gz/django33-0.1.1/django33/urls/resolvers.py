...
from django33.core.checks import Error, Warning
from django33.core.checks.urls import check_resolver
...
from django33.utils.http import RFC3986_SUBDELIMS, escape_leading_slashes
from django33.utils.regex_helper import _lazy_re_compile, normalize
...
def _route_to_regex(route, is_endpoint):
    ...
    and {'pk': <django33.urls.converters.IntConverter>}.
    """
    parts = ["^"]
        ...
        if "(?P<" in route or route.startswith("^") or route.endswith("$"):
            warnings.append(
                Warning(
                    ...
                    "when migrating to django33.urls.path().".format(self.describe()),
                    id="2_0.W001",
                )
            )
        return warnings
...
class URLPattern:
    ...
    def _check_callback(self):
        from django33.views import View
...
class URLResolver:
    ...
    def resolve_error_handler(self, view_type):
        ...
        if not callback:
            ...
            # django33.conf.urls imports this file.
            from django33.conf import urls
