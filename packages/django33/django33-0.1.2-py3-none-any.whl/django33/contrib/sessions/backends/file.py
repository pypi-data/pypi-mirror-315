...
from django33.contrib.sessions.backends.base import (
    VALID_KEY_CHARS,
    CreateError,
    SessionBase,
    UpdateError,
)
from django33.contrib.sessions.exceptions import InvalidSessionKey
from django33.core.exceptions import ImproperlyConfigured, SuspiciousOperation
                ...
                try:
                    ...
                    if isinstance(e, SuspiciousOperation):
                        logger = logging.getLogger(
                            "django33.security.%s" % e.__class__.__name__
                        )
