...
from django33.utils.html import conditional_escape, escape, format_html
from django33.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from django33.utils.html import strip_spaces_between_tags
...
def load(parser, token):
    ...
    ``django33/templatetags/news/photos.py``::
