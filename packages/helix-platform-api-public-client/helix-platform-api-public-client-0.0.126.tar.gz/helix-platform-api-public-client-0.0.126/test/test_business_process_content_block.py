...
from helix_platform_api_public_client.models.business_process_content_block import BusinessProcessContentBlock  # noqa: E501
    ...
    def make_instance(self, include_optional) -> BusinessProcessContentBlock:
        ...
        if include_optional:
            return BusinessProcessContentBlock(
                ...
                step_type = helix_platform_api_public_client.models.business_process_step_type.BusinessProcessStepType(
                    id = '', 
                    display_name = '', ),
                logic_type = 'INTERNAL_LOGIC',
                data_flow_direction = 'INCOMING',
                interface = helix_platform_api_public_client.models.interface.Interface(
                    id = '', 
                    display_name = '', ),
                ...
                rerunnable = True,
                attempts = [
                    helix_platform_api_public_client.models.business_process_step_attempt.BusinessProcessStepAttempt(
                        status = 'SCHEDULED', 
                        started_at = '2022-01-04T00:00Z', 
                        ended_at = '2022-01-04T00:00Z', 
                        fail_reason = '', )
                    ],
                file = helix_platform_api_public_client.models.attachment.Attachment(
                    id = '8d3787bb-b9ce-4d75-9a75-074ddd5d1e09', 
                    file_name = '', 
                    file_size = 0, 
                    mime_type = '', 
