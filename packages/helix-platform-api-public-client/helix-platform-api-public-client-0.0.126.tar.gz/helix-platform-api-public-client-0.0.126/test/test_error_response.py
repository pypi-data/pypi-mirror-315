...
from helix_platform_api_public_client.models.error_response import ErrorResponse  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ErrorResponse:
        ...
        if include_optional:
            return ErrorResponse(
                ...
                message = '',
                nested_errors = [
                    helix_platform_api_public_client.models.nested_error.NestedError(
                        field_name = '', 
                        code = '', 
                        message = '', )
                    ],
