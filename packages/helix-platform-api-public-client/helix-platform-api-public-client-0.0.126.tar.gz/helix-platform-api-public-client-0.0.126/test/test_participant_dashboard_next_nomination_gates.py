...
from helix_platform_api_public_client.models.participant_dashboard_next_nomination_gates import ParticipantDashboardNextNominationGates  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ParticipantDashboardNextNominationGates:
        ...
        if include_optional:
            return ParticipantDashboardNextNominationGates(
                nomination_gates = [
                    helix_platform_api_public_client.models.dashboard_next_nomination_gate.DashboardNextNominationGate(
                        timescale = 'LONG_TERM', 
                        window = helix_platform_api_public_client.models.dashboard_next_nomination_gate_window.DashboardNextNominationGate_window(
                            opens_at = '2022-01-04T00:00Z', 
                            closes_at = '2022-01-04T00:00Z', ), 
                        delivery_period = helix_platform_api_public_client.models.mtu_period.MtuPeriod(
