...
from helix_platform_api_public_client.models.user import User  # noqa: E501
    ...
    def make_instance(self, include_optional) -> User:
        ...
        if include_optional:
            return User(
                ...
                organisation = helix_platform_api_public_client.models.user_organisation.UserOrganisation(
                    id = '8d3787bb-b9ce-4d75-9a75-074ddd5d1e09', 
                    name = '', ),
                name = '',
