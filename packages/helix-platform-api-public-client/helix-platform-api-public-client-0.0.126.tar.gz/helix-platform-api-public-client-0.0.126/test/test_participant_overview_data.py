...
from helix_platform_api_public_client.models.participant_overview_data import ParticipantOverviewData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ParticipantOverviewData:
        ...
        if include_optional:
            return ParticipantOverviewData(
                ...
                type = 'ICO',
                status = 'ACTIVE',
                organisation_members = helix_platform_api_public_client.models.participant_overview_data_organisation_members.ParticipantOverviewData_organisationMembers(
                    registered_count = 0, 
                    invited_count = 0, ),
                contact_information = helix_platform_api_public_client.models.participant_overview_data_contact_information.ParticipantOverviewData_contactInformation(
