...
from helix_platform_api_public_client.models.timescale_nominations import TimescaleNominations  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TimescaleNominations:
        ...
        if include_optional:
            return TimescaleNominations(
                ...
                mtus = [
                    helix_platform_api_public_client.models.timescale_nominations_mtus.TimescaleNominations_mtus(
                        mtu = '2022-01-04T10:00Z', 
                        mtu_status = 'EDITABLE', 
                        total_trs = 56, 
                        current_nomination = helix_platform_api_public_client.models.timescale_nominations_mtus_current_nomination.TimescaleNominations_mtus_currentNomination(
                            status = 'PRE', 
                            value = 56, ), 
