...
class InvitedOrganisationUser(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvitedOrganisationUser:
        """Create an instance of InvitedOrganisationUser from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvitedOrganisationUser:
        """Create an instance of InvitedOrganisationUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvitedOrganisationUser.parse_obj(obj)

        _obj = InvitedOrganisationUser.parse_obj({
            "id": obj.get("id")
        })
        return _obj
