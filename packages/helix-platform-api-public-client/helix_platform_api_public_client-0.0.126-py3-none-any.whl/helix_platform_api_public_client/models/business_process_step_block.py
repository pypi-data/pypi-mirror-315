...
class BusinessProcessStepBlock(BaseModel):
    ...
    data_flow_direction: Optional[DataFlowDirection] = Field(None, alias="dataFlowDirection")
    ...
    __properties = ["blockType", "stepType", "logicType", "dataFlowDirection", "interface", "id", "resolvable", "rerunnable", "attempts", "file"]
    ...
    def from_dict(cls, obj: dict) -> BusinessProcessStepBlock:
        ...
        _obj = BusinessProcessStepBlock.parse_obj({
            ...
            "file": Attachment.from_dict(obj.get("file")) if obj.get("file") is not None else None
        })
        return _obj
