...
class OrganisationMarketSettingsGbNominationSettings(BaseModel):
    ...
    bmu_demand_code: Optional[constr(strict=True, max_length=30, min_length=1)] = Field(None, alias="bmuDemandCode")
    bmu_generation_code: Optional[constr(strict=True, max_length=30, min_length=1)] = Field(None, alias="bmuGenerationCode")
