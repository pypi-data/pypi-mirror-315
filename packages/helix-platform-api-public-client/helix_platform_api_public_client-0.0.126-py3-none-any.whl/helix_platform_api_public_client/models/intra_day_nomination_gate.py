...
class IntraDayNominationGate(BaseModel):
    ...
    """
    id: constr(strict=True) = Field(..., description="Virtual ID of a \"Workflow\" in the following format `{recurringWorkflowId}:{executionDay}`  Example: `684df173-4110-4e0d-b364-d2364388afe3:2024-06-01` ")
    ...
    __properties = ["id", "productType", "name", "deliveryDay", "mtu", "status", "nextActionAt"]
