...
class AuditLogApi:
    ...
    def get_audit_logs(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], sort_by : AuditLogSortBy, offset : Annotated[Optional[conint(strict=True, ge=0)], Field(description="Offset in the list of records to return")] = None, id_offset : Annotated[Optional[StrictStr], Field(description="Offset by ID in the list of records to return")] = None, domains : Optional[conlist(AuditLogDomain)] = None, x_organisation_id : Annotated[Optional[StrictStr], Field(description="Internal ID of an Organisation (optional)")] = None, creation_period_start : Optional[datetime] = None, creation_period_end : Optional[datetime] = None, query : Optional[StrictStr] = None, status : Optional[conlist(AuditLogStatus)] = None, **kwargs) -> AuditLogBatch:  # noqa: E501
        ...
        >>> thread = api.get_audit_logs(limit, sort_by, offset, id_offset, domains, x_organisation_id, creation_period_start, creation_period_end, query, status, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_audit_logs_with_http_info(limit, sort_by, offset, id_offset, domains, x_organisation_id, creation_period_start, creation_period_end, query, status, **kwargs)  # noqa: E501
    ...
    def get_audit_logs_with_http_info(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], sort_by : AuditLogSortBy, offset : Annotated[Optional[conint(strict=True, ge=0)], Field(description="Offset in the list of records to return")] = None, id_offset : Annotated[Optional[StrictStr], Field(description="Offset by ID in the list of records to return")] = None, domains : Optional[conlist(AuditLogDomain)] = None, x_organisation_id : Annotated[Optional[StrictStr], Field(description="Internal ID of an Organisation (optional)")] = None, creation_period_start : Optional[datetime] = None, creation_period_end : Optional[datetime] = None, query : Optional[StrictStr] = None, status : Optional[conlist(AuditLogStatus)] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_audit_logs_with_http_info(limit, sort_by, offset, id_offset, domains, x_organisation_id, creation_period_start, creation_period_end, query, status, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('creation_period_start') is not None:  # noqa: E501
            if isinstance(_params['creation_period_start'], datetime):
                _query_params.append(('creationPeriodStart', _params['creation_period_start'].isoformat()))
            else:
                _query_params.append(('creationPeriodStart', _params['creation_period_start']))

        if _params.get('creation_period_end') is not None:  # noqa: E501
            if isinstance(_params['creation_period_end'], datetime):
                _query_params.append(('creationPeriodEnd', _params['creation_period_end'].isoformat()))
            else:
                _query_params.append(('creationPeriodEnd', _params['creation_period_end']))
