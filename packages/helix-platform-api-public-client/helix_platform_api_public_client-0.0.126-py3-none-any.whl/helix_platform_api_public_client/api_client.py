...
import helix_platform_api_public_client.models
from helix_platform_api_public_client import rest
from helix_platform_api_public_client.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/0.0.126/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(helix_platform_api_public_client.models, klass)
