...
class Transformation:
    ...
    def __init__(self, at: str, to: str, transformation_mtx: np.array):
        ...
        self.at = at
        self.to = to
        self.transformation_mtx = transformation_mtx  # Setter extrahiert translation und rotation automatisch
    ...
    @property
    def transformation_mtx(self) -> np.array:
        """Get or set the 4x4 transformation matrix."""
        return self._transformation_mtx

    @transformation_mtx.setter
    def transformation_mtx(self, value):
        if value.shape != (4, 4):
    ...
    def combine_transformation(self, transformation_to):
        ...
        """
        new_transformation_mtx = np.dot(transformation_to.transformation_mtx, self.transformation_mtx)
    ...
    def invert_transformation(self):
        ...
        """
        inverse_mtx = np.linalg.inv(self.transformation_mtx)
