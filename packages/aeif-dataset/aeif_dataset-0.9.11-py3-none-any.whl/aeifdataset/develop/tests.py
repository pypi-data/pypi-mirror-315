...
if __name__ == '__main__':
    ...
    frame = DataRecord('/mnt/hot_data/temp/seq_1/id00999_2024-09-27_10-35-41.4mse')[18]

    trans = ad.Transformation.from_xyz_and_rpy('a1', 'a2', frame.vehicle.cameras.BACK_LEFT.info.extrinsic.xyz,
                                               frame.vehicle.cameras.BACK_LEFT.info.extrinsic.rpy)
