...
ACCESS_RIGHTS = {
    ...
    "global_create_company": {
        ...
        "global_permissions": [
            ...
            PERMISSIONS["global.view_company"],
            PERMISSIONS["global.access_ea"],
        ],
    ...
    "global_company_supervisor": {
        "label": "Consulter les enseignes",
        "description": "Consulter les enseignes et toutes leurs données",
    ...
    "global_record_payment_invoice": {
        ...
        "description": "Saisir des encaissements",
    ...
    "global_supervisor_salary": {
        ...
        "description": (
            "Lister les bulletins de paie déposés dans le logiciel."
    ...
    "es_validate_estimation": {
        ...
        "description": (
            ...
            "NB : Un montant maximum peut être spécifié"
        ),
    ...
    "es_record_payment_invoice": {
        ...
        "description": (
            "L'entrepreneur peut saisir/modifier/supprimer "
