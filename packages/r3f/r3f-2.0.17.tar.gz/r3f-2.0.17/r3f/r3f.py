...
def axis_angle_to_vector(
        ax: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        ang: Union[float, Sequence[float], np.ndarray],
        degs: bool = False
    ) -> np.ndarray:
    """
...
def vector_to_axis_angle(
        vec: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        degs: bool = False
...
def rpy_to_vector(
        rpy: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        degs: bool = False
    ) -> np.ndarray:
    """
...
def dcm_to_vector(
        C: Union[Sequence[Sequence[float]],
...
def quat_to_vector(
        q: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray]
    ) -> np.ndarray:
    """
...
def rot(
        ang: Union[float, int, Sequence[Union[float, int]], np.ndarray],
        ax: Optional[Union[str, int, float, Sequence[Union[str, int, float]],
                np.ndarray]] = None,
        degs: bool = False
    ) -> np.ndarray:
    """
...
def rotate(
        C: np.ndarray,
        vec: Union[Sequence[Sequence[float]], np.ndarray]
    ) -> np.ndarray:
    """
...
def dcm_ecef_to_navigation(
        lat: Union[float, Sequence[float], np.ndarray],
        lon: Union[float, Sequence[float], np.ndarray],
        ned: bool = True,
        degs: bool = False,
    ) -> np.ndarray:
    """
    ...
    if ned:
        ...
        c21 = -slon;        c22 = clon;         c23 = 0*lat
        c31 = -clat*clon;   c32 = -clat*slon;   c33 = -slat
    else:
        c11 = -slon;        c12 = clon;         c13 = 0*lat
        c21 = -slat*clon;   c22 = -slat*slon;   c23 = clat
        c31 = clat*clon;    c32 = clat*slon;    c33 = slat

    # Assemble the rotation matrix.
    if np.ndim(lat) == 0: # scalar
        C = np.array([
            [c11, c12, c13],
            [c21, c22, c23],
            [c31, c32, c33]])
...
def geodetic_to_ecef(
        llh: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        degs: bool = False,
    ) -> np.ndarray:
    """
...
def ecef_to_geodetic(
        pe: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        degs: bool = False
    ) -> np.ndarray:
    """
...
def tangent_to_ecef(
        pt: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        pe0: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        ned: bool = True
    ) -> np.ndarray:
    """
...
def ecef_to_tangent(
        pe: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        pe0: Union[Sequence[float], Sequence[Sequence[float]],
            np.ndarray] = None,
        ned: bool = True
    ) -> np.ndarray:
    """
...
def curvilinear_to_ecef(
        pc: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        pe0: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        ned: bool = True
    ) -> np.ndarray:
    """
...
def tangent_to_geodetic(
        pt: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        llh0: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        ned: bool = True,
        degs: bool = False
    ) -> np.ndarray:
    """
...
def geodetic_to_tangent(
        llh: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        llh0: Union[Sequence[float], Sequence[Sequence[float]],
            np.ndarray] = None,
        ned: bool = True,
        degs: bool = False
    ) -> np.ndarray:
...
def is_ortho(
        A: Union[Sequence[Sequence[float]],
            Sequence[Sequence[Sequence[float]]], np.ndarray]
    ) -> bool:
    """
...
def orthonormalize_dcm(
        Cin: Union[Sequence[Sequence[float]],
            Sequence[Sequence[Sequence[float]]], np.ndarray]
    ) -> np.ndarray:
    """
...
def rodrigues_rotation(
        theta: Union[Sequence[float], Sequence[Sequence[float]], np.ndarray],
        degs: bool = False
    ) -> np.ndarray:
    """
    ...
    if theta.ndim == 1:
        ...
        s = 1.0 if nm < 0.04e-6 else math.sin(nm)/nm
        c = 0.5 if nm < 0.2e-3 else (1 - math.cos(nm))/nm2
...
def inverse_rodrigues_rotation(
        Delta: Union[Sequence[Sequence[float]],
            Sequence[Sequence[Sequence[float]]], np.ndarray],
        degs: bool = False
    ) -> np.ndarray:
    """
    ...
    if Delta.ndim == 2:
        ...
        q = np.minimum(np.maximum(d11 + d22 + d33, q_min), 3.0)
