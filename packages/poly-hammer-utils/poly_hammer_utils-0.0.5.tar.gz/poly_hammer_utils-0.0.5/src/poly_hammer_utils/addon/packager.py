...
def install_requirements(addon_folder_path: Path):
    """
    ...
    Args:
        addon_folder_path (Path): The path to the addon folder.
    """
    requirements_file_path = RESOURCES_FOLDER / 'addon-requirements' / 'requirements.txt'
...
def zip_addon(
    ...
    if add_requirements:
        install_requirements(addon_folder_path)
