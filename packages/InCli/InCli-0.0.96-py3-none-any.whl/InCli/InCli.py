...
def option_logs(args):
 ...
 """
    ...
    if check_modifiers('-logs',args,["-last","-tail","-store","-deletelogs","-limit","-limitinfo","-auto","-folder","-level","-loguser","-where","-inputfile","-fileOutput","-error","-parseSmallFiles","-allLimits","-debuglevel","-var","-downloadOnly","-all","-sqol"],help) == False: return
