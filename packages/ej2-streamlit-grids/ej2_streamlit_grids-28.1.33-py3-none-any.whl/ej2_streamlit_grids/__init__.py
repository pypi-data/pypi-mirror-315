...
class GridProps:
    ...
    def __init__(self, data: pd.DataFrame=None):
        ...
        self.rowCount = None
        self.sortSettings = None
        self.pageSettings = None
        self.filterSettings = None
        self.groupSettings = None
        self.searchSettings = None
        self.selectionSettings = None
        self.infiniteScrollSettings = None
        self.textWrapSettings = None
        self.height = '300'
        self.width = 'auto'
        self.rowHeight = None
        ...
        self.theme = 'https://cdn.syncfusion.com/ej2/28.1.33/material.css'
