...
class TriggerActionParam(object):
    def __init__(self, eventDisplayId=None, eventId=None, eventName=None, eventDescription=None, eventStatus=None, eventTargetId=None,
                 ...
                 additionContents=None, additionFile=None, raw=None, **kwargs):
        self.eventDisplayId = eventDisplayId
        self.eventId = eventId
        self.eventName = eventName
        self.eventDescription = eventDescription
        self.eventStatus = eventStatus
        self.eventTargetId = eventTargetId
        ...
        self.raw = raw
        self.additionFile = {}
        if additionFile is not None:
            self.additionFile = additionFile
