r'''
# CDKTF prebuilt bindings for opentelekomcloud/opentelekomcloud provider version 1.36.27

This repo builds and publishes the [Terraform opentelekomcloud provider](https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.27/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform opentelekomcloud provider](https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.27)
