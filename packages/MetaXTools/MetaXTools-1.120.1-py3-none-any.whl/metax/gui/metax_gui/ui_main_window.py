...
class Ui_metaX_main(object):
    def setupUi(self, metaX_main):
        ...
        self.groupBox_basic_plot.setMaximumSize(QtCore.QSize(16777215, 420))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 885, 239))
        ...
        self.gridLayout_34.addLayout(self.horizontalLayout_105, 5, 2, 1, 1)
        ...
        self.gridLayout_34.addLayout(self.horizontalLayout_108, 6, 1, 1, 1)
        ...
        self.gridLayout_34.addWidget(self.checkBox_box_violinplot, 6, 2, 1, 1)
        ...
        self.groupBox_cross_heatmap_settings.setMaximumSize(QtCore.QSize(16777215, 300))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 889, 128))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 865, 95))
        ...
        self.lineEdit_annotator_exclude_protein_contains = QtWidgets.QLineEdit(self.groupBox_peptide_annotator_settings)
        self.lineEdit_annotator_exclude_protein_contains.setObjectName("lineEdit_annotator_exclude_protein_contains")
        self.gridLayout_35.addWidget(self.lineEdit_annotator_exclude_protein_contains, 3, 3, 1, 1)
    ...
    def retranslateUi(self, metaX_main):
        ...
        self.comboBox_outlier_handling_method1.setItemText(7, _translate("metaX_main", "FillZero"))
...
""))
        ...
        self.label_197.setText(_translate("metaX_main", "Filter By"))
        ...
        self.label_204.setText(_translate("metaX_main", "Filter Genome with Distinct peptide Number"))
        self.checkBox_annotator_genome_mode.setText(_translate("metaX_main", "Staring LCA  level from Genome"))
        self.label_205.setText(_translate("metaX_main", "Exclude Protein with"))
        self.lineEdit_annotator_exclude_protein_contains.setToolTip(_translate("metaX_main", "Remove the peptides which annoate to exclude proteins"))
        self.lineEdit_annotator_exclude_protein_contains.setText(_translate("metaX_main", "REV_"))
