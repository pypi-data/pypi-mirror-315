...
from .llm import set_verbosity, OpenaiModels, OpenrouterModels, AnthropicModels, OllamaModels, GroqModels, TogetheraiModels
from .tools import (
    FileTools,
    EmbeddingsTools,
    WebTools,
...
def __getattr__(name):
    ...
    if name in package_map:
        ...
        try:
            ...
            print(f"\033[95mError: The required packages ({missing_packages}) are not installed. "
