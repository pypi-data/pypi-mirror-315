...
fn aes128_cfb8_encrypt(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes128_cfb8_decrypt(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes256_cfb8_encrypt(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes256_cfb8_decrypt(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes128_cfb128_encrypt(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes128_cfb128_decrypt(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes256_cfb128_encrypt(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes256_cfb128_decrypt(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes128_ctr128(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
...
#[pyfunction]
#[pyo3(signature = (data, key, nonce))]
fn aes256_ctr128(py: Python, data: Cow<[u8]>, key: &[u8], nonce: &[u8]) -> PyObject {
