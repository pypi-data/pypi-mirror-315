...
#from py_tidy_adapter.adapter import Adapter
...
def anomaly_detection(series: 'list' = [], query: 'string' = None, endpoint: 'string' = None,
                      idSession: 'string' = None, contamination=0.1, max_value=2,
                      min_scores=0.5) :
...
def isolation_forest_anomaly_detection(series: 'list' = [], n_estimators=100, max_samples='auto', contamination=0.1,
...
def abod_anomaly_detection(series: 'list' = [], contamination=0.1, n_neighbors=5, method='fast') -> 'DataFrame':
...
def kde_anomaly_detection(series: 'list' = [], contamination=0.1, bandwidth=1.0, algorithm='auto', leaf_size=30,
...
def cof_anomaly_detection(series: 'list' = [], contamination=0.1, n_neighbors=20, method='fast') -> 'DataFrame':
...
def knn_anomaly_detection(series: 'list' = [], contamination=0.1, n_neighbors=5, method='largest', radius=1.0,
...
def inne_anomaly_detection(series: 'list' = [], n_estimators=200, max_samples='auto', contamination=0.1,
...
def qmcd_anomaly_detection(series: 'list' = [], contamination=0.1) -> 'DataFrame':
...
def sampling_anomaly_detection(series: 'list' = [], contamination=0.1, subset_size=20, metric='minkowski',
...
def gmm_anomaly_detection(series: 'list' = [], n_components=1, covariance_type='full', tol=0.001, reg_covar=1e-06,
...
def pca_anomaly_detection(series: 'list' = [], n_components=None, n_selected_components=None, contamination=0.1,
