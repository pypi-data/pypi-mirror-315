...
CREATE TABLE "TNC_Trip" (
  ...
  "init_status" INTEGER NOT NULL DEFAULT 0,  --@ TNC status denoting what operation was being done when trip started. Allowable values are: Pickup (-1), Dropoff (-2), Charging (-3), and Repositioning (-4)
  "final_status" INTEGER NOT NULL DEFAULT 0, --@ TNC status denoting what operation was actually done when trip ended because of mid-trip detours. Allowable values are: Pickup (-1), Dropoff (-2), Charging (-3), and Repositioning (-4)
