...
def mount_ephemeral_fs(mount_point, storage_directory=None, **fuse_args):
    """
    Mounts the filesystem at the given mount point with an optional storage directory.
    ...
    Args:
        ...
        **kwargs: Additional arguments to pass to the FUSE constructor.
    """
    ...
    FUSE(EphemeralFS(storage_directory), mount_point, **fuse_args)
