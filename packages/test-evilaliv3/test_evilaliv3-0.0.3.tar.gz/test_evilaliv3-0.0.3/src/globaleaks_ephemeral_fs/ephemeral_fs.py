...
class EphemeralFSOperations(Operations):
...
class EphemeralFSManager(FUSE):
    ...
    def __init__(self, mount_point, storage_directory=None, **fuse_args):
        ...
        super().__init__(EphemeralFSOperations(self.storage_directory), self.mount_point, **fuse_args)
