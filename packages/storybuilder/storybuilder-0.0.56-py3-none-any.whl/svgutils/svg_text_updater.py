...
class SVGTextProcessor:
    ...
    def clean_svg(self, svg_path, output_path=None):
...
def main():
    ...
    # clean command
    clean_parser = subparsers.add_parser('clean', help='Clean SVG file')
    ...
    if args.command == 'merge':
        ...
        process_files(processor, 'clean_svg', args.files, args.recursive,
                     output_path=args.output)
