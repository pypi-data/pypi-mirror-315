...
from ..Domain.Enums.type_logging_level import TypeLoggingLevel
from ..Utilites.global_setting_service import GlobalSettingService
    ...
    def _inject_(func: _C)->_C:
        ...
        def __sync(*args, **kwargs)->_C:
            ...
            if 'is_inject' not in kwargs:
                ...
                len_sign = len(fn_signature)

                if len(kwargs) > 0 and len(kwargs) == len_sign:
