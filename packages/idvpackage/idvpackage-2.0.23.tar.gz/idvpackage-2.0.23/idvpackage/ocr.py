...
class IdentityVerification:
    ...
    def extract_document_info(self, image, side, document_type, country, nationality):
        st = time.time()
        document_data = {}
        ...
        if document_type == 'passport' and (side == 'first' or side == 'page1' or side == ''):
            document_data = self.exract_passport_info(image, country, nationality)
    ...
    def extract_front_id_info(self, front_id, country, nationality):
        ...
        if country == 'IRQ':
            ...
            from idvpackage.ocr_utils import  detect_photo_on_screen, detect_screenshot, document_on_printed_paper
            from idvpackage.iraq_id_extraction import iraq_front_id_extraction, extract_mother_surname, extract_mother_name, extract_paternal_grandfather_name
            ...
            try:
                ...
                dict_mother_surname['mother_last_name_en'] = GoogleTranslator('ar', 'en').translate(dict_mother_surname['mother_last_name']).upper()
            except Exception as e:
            ...
            try:
                ...
                dict_third_name['third_name_en'] = GoogleTranslator('ar', 'en').translate(dict_third_name['third_name']).upper()
            except Exception as e:
            ...
            try:
                ...
                dict_mother_name['mother_first_name_en'] = GoogleTranslator('ar', 'en').translate(dict_mother_name['mother_first_name']).upper()
            except Exception as e:
        ...
        if country == 'QAT':
            ...
            try:
                ...
                front_data_fields = qatar_front_id_extraction(self.client, compressed_image_data, front_id_text, front_id_text_desc, self.api_key)
        ...
        if country == 'SDN':
                ...
                try:
                    ...
                    st = time.time()
                    front_data_fields = sdn_front_id_extraction(self.client, front_id_text_desc, compressed_image_data, front_id_text)
                    logging.info(f'----------------Time taken for data formatting and final extraction front: {time.time() - st} seconds\n')
                    ...
                    required_keys = ["front_face_locations", "front_face_encodings", "full_name", "dob"]
                    empty_string_keys = [key for key, value in front_data.items() if key in required_keys and value == '']
                ...
                try:
                    ...
                    if len(filtered_names) ==4:
                        ...
                        front_data['middle_name_ar'] = filtered_names[1] + ' ' + filtered_names[2]+ ' ' + filtered_names[3]+ ' ' + filtered_names[4]
                    elif len(filtered_names) ==7:
                        front_data['first_name_ar'] = filtered_names[0]
                        front_data['last_name_ar'] = filtered_names[6]
                        front_data['middle_name_ar'] = filtered_names[1] + ' ' + filtered_names[2]+ ' ' + filtered_names[3]+ ' ' + filtered_names[4]+ ' ' + filtered_names[5]
                    else:
                        front_data['first_name_ar'] = ''
                        front_data['last_name_ar'] = ''
                        front_data['middle_name_ar'] = ''
    ...
    def extract_back_id_info(self, back_id, country, nationality):
        ...
        if country == 'IRQ':
            ...
            from idvpackage.ocr_utils import  detect_photo_on_screen, detect_screenshot, document_on_printed_paper
            from idvpackage.iraq_id_extraction import iraq_back_id_extraction, update_family_number_cases, extract_family_number
    ...
    def exract_passport_info(self, passport, country, nationality):
        ...
        if (nationality and nationality == 'IRQ') or (not nationality and country == 'IRQ'):
                ...
                try:
                    ...
                    from deep_translator import GoogleTranslator
                    new_dict['mother_first_name'] = GoogleTranslator('en', 'ar').translate(new_dict.get('mother_first_name', ''))
                    new_dict['mother_last_name'] = GoogleTranslator('en', 'ar').translate(new_dict.get('mother_last_name', ''))
        ...
        if (nationality and nationality == 'SDN') or (not nationality and country == 'SDN'):
                ...
                try:
                    ...
                    pattern4 = r'(Republic of Sudan|Republic of the Sudan|PCSDN)'
                    k= re.search(pattern4, passport_text, re.IGNORECASE)
                ...
                try:
                    list_1 = passport_data['name_ar'].split(" ")
                    filtered_names = [name for name in list_1 if len(name) > 1]
                    if len(filtered_names) ==4:
                        passport_data['first_name_ar'] = filtered_names[0]
                        passport_data['last_name_ar'] = filtered_names[3]
                        passport_data['middle_name_ar'] = filtered_names[1] + ' ' + filtered_names[2]
                    elif len(filtered_names) ==5:
                        passport_data['first_name_ar'] = filtered_names[0]
                        passport_data['last_name_ar'] = filtered_names[4]
                        passport_data['middle_name_ar'] = filtered_names[1] + ' ' + filtered_names[2]+ ' ' + filtered_names[3]
                    elif len(filtered_names) ==6:
                        passport_data['first_name_ar'] = filtered_names[0]
                        passport_data['last_name_ar'] = filtered_names[5]
                        passport_data['middle_name_ar'] = filtered_names[1] + ' ' + filtered_names[2]+ ' ' + filtered_names[3]+ ' ' + filtered_names[4]
                    elif len(filtered_names) ==7:
                        passport_data['first_name_ar'] = filtered_names[0]
                        passport_data['last_name_ar'] = filtered_names[6]
                        passport_data['middle_name_ar'] = filtered_names[1] + ' ' + filtered_names[2]+ ' ' + filtered_names[3]+ ' ' + filtered_names[4]+ ' ' + filtered_names[5]
                    else:
                        passport_data['first_name_ar'] = ''
                        passport_data['last_name_ar'] = ''
                        passport_data['middle_name_ar'] = ''
        ...
        if (nationality and nationality == 'PSE') or (not nationality and country == 'PSE'):
            ...
            try:
                ...
                pattern4 = r'(PALESTINIAN AUTHORITY|PALESTINE)'#PASSPORT
                k= re.search(pattern4, passport_text, re.IGNORECASE)
        ...
        try:
            ...
            if 'document' in report_names:
                if nationality:
                    ...
                    document_report = form_final_data_document_report(data, front_id_text, back_id_text, nationality, colour_picture, selfie, similarity, blurred, glare, missing_fields, face_match_threshold, back_img)
                else:
            ...
            if 'facial_similarity_video' in report_names:
                ...
                if nationality:
                    ...
                    facial_report = form_final_facial_similarity_report(data, selfie, similarity, liveness_result, face_match_threshold, nationality)
                else:
                    print(f"\nNationality not present, pikcing country: {country} for generating Document Report")
