...
def data_comparison_check(data, country):
    ...
    if user_data and country not in ['IRQ', 'LBN', 'SDN', 'SYR', 'JOR', 'PSE']:
        ...
        if country in ['IRQ', 'LBN', 'QAT', 'SDN', 'SYR', 'JOR', 'PSE']:
            if country == 'IRQ':
                ...
                if data.get('doc_type') == 'passport':
                    ...
                    keys = ['full_name', 'id_number', 'mrz', 'issue_date', 'mother_first_name', 'mother_first_name_en', 'mother_last_name', 'mother_last_name_en']
                else:
            ...
            if country == 'SDN':
                ...
                if data.get('doc_type') == 'passport':
                    keys = ['full_name_generic', 'first_name', 'middle_name', 'last_name', 'name_ar','first_name_ar','last_name_ar','middle_name_ar', 'gender', 'place_of_birth', 'place_of_issue', 'passport_number_mrz', 'national_number', 'issue_date', 'mrz', 'nationality', 'issuing_country']
                else:
                    # keys = ['father_name', 'last_name', 'name_en', 'first_name_en', 'fathers_name_en', 'last_name_en', 'gender_ar', 'place_of_birth', 'issue_date', 'issue_date_ar', 'card_number_ar', 'id_number_ar']
                    keys = ['name', 'name_ar', 'nationality', 'gender', 'place_of_birth', 'place_of_birth_en', 'id_number', 'first_name_ar','last_name_ar','middle_name_ar','occupation', 'occupation_en', 'occupation_ar','issue_date', 'first_name', 'middle_name', 'last_name', 'issuing_country']
                    keys_to_remove = ['issuing_place', 'family_sponsor', 'employer', 'first_name', 'last_name', 'father_name', 'mother_name', 'place_of_issue']

            if country == 'SYR':
                main_prop_data = {}
                keys_to_remove = ['name', 'issuing_place', 'occupation', 'employer', 'mrz_line3', 'family_sponsor', 'issuing_country', 'first_name', 'last_name', 'father_name', 'mother_name']
                if data.get('doc_type') == 'passport':
                    keys = ['full_name', 'first_name', 'last_name', 'father_name', 'mother_name', 'place_of_birth', 'dob', 'nationality', 'gender', 'passport_number', 'issue_number', 'issuing_date', 'national_number', 'mrz1', 'mrz2', 'mrz']

            if country == 'JOR':
                main_prop_data = {}
                keys_to_remove = ['name', 'issuing_place', 'occupation', 'employer', 'mrz_line3', 'family_sponsor', 'issuing_country', 'first_name', 'last_name', 'father_name', 'mother_name']
                if data.get('doc_type') == 'passport':
                    keys = ['full_name', 'first_name', 'last_name', 'father_name', 'mother_name', 'place_of_birth', 'dob', 'issuing_date', 'nationality', 'gender', 'issuing_place', 'passport_number', 'mrz1', 'mrz2', 'mrz']

            if country == 'PSE':
                main_prop_data = {}
                keys_to_remove = ['name', 'issuing_place', 'occupation', 'employer', 'mrz_line3', 'family_sponsor', 'issuing_country', 'first_name', 'last_name', 'father_name', 'mother_name']
                if data.get('doc_type') == 'passport':
                    keys = ['full_name', 'first_name', 'last_name', 'mother_name', 'place_of_birth', 'dob', 'issuing_date', 'nationality', 'gender', 'issuing_place', 'passport_number', 'id_number', 'mrz1', 'mrz2', 'mrz']
