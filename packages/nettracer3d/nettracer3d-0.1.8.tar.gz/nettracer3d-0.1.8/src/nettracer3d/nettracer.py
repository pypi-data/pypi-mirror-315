...
def hash_inners(search_region, inner_edges, GPU = True):
    ...
    blurred_search = smart_dilate.gaussian(search_region) #For now I am using CPU for this, but it can be passed GPU = True for GPU, I just don't think it's really faster at all.
...
def watershed(image, directory = None, proportion = 0.1, GPU = True, smallest_rad = None, predownsample = None, predownsample2 = None):
    ...
    labels = smart_dilate.smart_label(old_mask, labels, predownsample = predownsample2)
