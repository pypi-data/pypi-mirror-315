...
setup(
    ...
    entry_points = {
        'console_scripts': [
            'pygbag-builder_main_flow=pygbag_builder.main_flow:main',
            'pygbag-builder_make_repo=pygbag_builder.make_repo:main',
            'pygbag-builder_set_page=pygbagbuilder.set_page:_main'
        ],
    },
