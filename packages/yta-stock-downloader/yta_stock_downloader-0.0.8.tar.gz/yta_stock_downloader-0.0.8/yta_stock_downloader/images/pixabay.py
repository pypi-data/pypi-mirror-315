...
def search_pixabay_images(query: str, ignore_ids: list[str] = []):
    """
    ...
    if response['total'] == 0:
        # TODO: Return empty array or raise Exception (?)
        return []
    
    # TODO: Apply the 'ignore_ids' filter
    
    # TODO: How is the response['hits']? Map it (!)
    return response['hits']

def get_first_pixabay_image(query: str, ignore_ids: list[str]):
    """
