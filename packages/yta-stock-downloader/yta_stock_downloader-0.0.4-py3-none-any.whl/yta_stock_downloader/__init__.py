from yta_stock_downloader.images.pexels import get_first_pexels_image, download_first_pexels_image, PexelsLocale
...
class Pexels:
    ...
    """
    @staticmethod
    def get_first_image(query: str, locale: Union[PexelsLocale, str] = PexelsLocale.ES_ES, ignore_ids: list[str] = []):
        """
    ...
    @staticmethod
    def download_first_image(query: str, locale: Union[PexelsLocale, str] = PexelsLocale.ES_ES, ignore_ids: list[str] = [], output_filename: Union[str, None] = None):
        """
    ...
    @staticmethod
    def get_first_video(query: str, locale: Union[PexelsLocale, str] = PexelsLocale.ES_ES, ignore_ids: list[str] = [], output_filename: Union[str, None] = None):
        """
        ...
        avialable or if the download is not possible.
        """
        return get_first_pexels_video(query, locale, ignore_ids)

    @staticmethod
    def download_first_video(query: str, locale: Union[PexelsLocale, str] = PexelsLocale.ES_ES, ignore_ids: list[str] = [], output_filename: Union[str, None] = None):
        """
        Download the first available video from the Pexels
...
class Pixabay:
    ...
    def get_first_image(query: str):
        ...
        available.
        """
        return get_first_pixabay_image(query)
    
    @staticmethod
    def download_first_image(query: str, output_filename: Union[str, None] = None):
        """
        Download the first available image from the Pexels
        provider for the given 'query' (if available).
        ...
        available or if the download is not possible.
        """
        return download_first_pixabay_image(query, output_filename)
