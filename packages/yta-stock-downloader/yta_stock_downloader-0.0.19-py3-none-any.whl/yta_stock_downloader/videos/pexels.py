...
def get_random_pexels_video(query: str, locale: PexelsLocale = PexelsLocale.ES_ES, ignore_ids = []) -> PexelsVideo:
    """
...
def download_random_pexels_video(query: str, locale: PexelsLocale = PexelsLocale.ES_ES, ignore_ids = [], output_filename: Union[str, None] = None):
...
# TODO: Remove this below when completely refactored
