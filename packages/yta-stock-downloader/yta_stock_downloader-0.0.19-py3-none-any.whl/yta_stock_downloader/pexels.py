...
from yta_stock_downloader.videos.pexels import get_first_pexels_video, download_first_pexels_video, download_random_pexels_video
...
class Pexels:
    ...
    @staticmethod
    def download_random_video(query: str, locale: Union[PexelsLocale, str] = PexelsLocale.ES_ES, ignore_ids: list[int] = [], output_filename: Union[str, None] = None):
        """
        Download a random video from the Pexels provided
        and the given 'query' and locale' (if existing)
        ...
        not possible.
        """
        return download_random_pexels_video(query, locale, ignore_ids, output_filename)