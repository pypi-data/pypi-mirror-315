...
from src.kiss_ai_stack.core.models.enums.tool_kind import ToolKind
...
class StackValidator:
    ...
    def validate(data: dict) -> AgentProperties:
        ...
        if 'decision_maker' not in agent_data:
            ...
            if agent_data['decision_maker']['kind'] != ToolKind.PROMPT:
                raise ValueError(f'StackValidator :: \'decision_maker\' :: only supports {ToolKind.PROMPT}.')
