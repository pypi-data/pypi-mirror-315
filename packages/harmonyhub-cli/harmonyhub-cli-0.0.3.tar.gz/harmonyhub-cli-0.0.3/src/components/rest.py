...
# Execute test case
def execute_test_case(testCase, total_variables, logging):
...
def run_rest_flow(step, global_headers, global_variables, logging):
    output_variables = {}
    ...
    try:
        ...
        if not isinstance(test_cases, list):
            ...
            for test_case in test_cases:
                execute_test_case(test_case,total_variables, logging)
