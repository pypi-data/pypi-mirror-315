...
class Workflow:
    ...
    # Constructor
    def __init__(self, yaml_file: str, debug_mode: bool = False):
        ...
        try:
            ...
            match step.get('type'):
                case 'restapi':
                    ...
                    rest_output_variables = run_rest_flow(step, self.global_headers, self.global_variables, logging)
                                ...
                                for catch_step in catch_steps:
                                    ...
                                    if e.status_code == catch_step.get('condition'):
                                        ...
                                        for catch_sub_step in catch_step.get('steps', []):
                                            ...
                                            self.execute_step(catch_sub_step)  
                                        break
                ...
                case 'harmonyhub-integration':
                    ...
                    self.execute_workflow_steps(step.get('steps', []))
    ...
    def execute_workflow_steps(self, steps):
        try:
