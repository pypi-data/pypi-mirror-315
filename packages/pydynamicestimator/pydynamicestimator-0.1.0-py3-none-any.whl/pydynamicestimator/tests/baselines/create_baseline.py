# Filename: tests/baselines/create_baseline.py
# Created: 2024-12-01
...
# Run the function to generate baseline result
baseline_result_est, baseline_result_sim = run(config)


with open("baseline_result_est.pkl", "wb") as file:
    pickle.dump(baseline_result_est, file)

with open("baseline_result_sim.pkl", "wb") as file:
    pickle.dump(baseline_result_sim, file)
