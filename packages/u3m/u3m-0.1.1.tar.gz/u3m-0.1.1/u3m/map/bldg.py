...
def generate_bldg_map(outdir, usfeet, target_epsg, kernel_size=5, resol_ = 0.5, height_threshold=1.5, 
...
if __name__ == '__main__': 
    ...
    args = get_args()
    generate_bldg_map(args.fn, args.outdir, args.usfeet, args.SRC)