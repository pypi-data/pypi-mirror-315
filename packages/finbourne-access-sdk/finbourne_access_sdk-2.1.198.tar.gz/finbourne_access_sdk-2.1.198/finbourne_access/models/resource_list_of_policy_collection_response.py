...
class ResourceListOfPolicyCollectionResponse(BaseModel):
    ...
    """
    values: conlist(PolicyCollectionResponse) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfPolicyCollectionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfPolicyCollectionResponse:
        """Create an instance of ResourceListOfPolicyCollectionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfPolicyCollectionResponse.parse_obj(obj)

        _obj = ResourceListOfPolicyCollectionResponse.parse_obj({
            "values": [PolicyCollectionResponse.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
