...
class UserRoleUpdateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserRoleUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserRoleUpdateRequest:
        """Create an instance of UserRoleUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserRoleUpdateRequest.parse_obj(obj)

        _obj = UserRoleUpdateRequest.parse_obj({
