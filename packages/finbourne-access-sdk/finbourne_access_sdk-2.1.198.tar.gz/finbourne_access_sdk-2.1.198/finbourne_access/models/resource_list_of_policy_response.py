...
class ResourceListOfPolicyResponse(BaseModel):
    ...
    """
    values: conlist(PolicyResponse) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfPolicyResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfPolicyResponse:
        """Create an instance of ResourceListOfPolicyResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfPolicyResponse.parse_obj(obj)

        _obj = ResourceListOfPolicyResponse.parse_obj({
            "values": [PolicyResponse.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
