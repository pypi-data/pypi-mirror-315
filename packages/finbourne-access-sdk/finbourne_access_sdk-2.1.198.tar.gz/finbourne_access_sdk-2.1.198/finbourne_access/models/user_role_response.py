...
class UserRoleResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserRoleResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserRoleResponse:
        """Create an instance of UserRoleResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserRoleResponse.parse_obj(obj)

        _obj = UserRoleResponse.parse_obj({
