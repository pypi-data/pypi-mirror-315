...
class RemoveFromPolicyCollectionRequest(BaseModel):
    ...
    """
    policies: Optional[conlist(PolicyId)] = Field(None, description="The identifiers of the Policies to be removed from the collection.")
    policy_collections: Optional[conlist(PolicyCollectionId)] = Field(None, alias="policyCollections", description="The identifiers of the PolicyCollections to be removed from the collection.")
