...
class MatchAllSelectorDefinition(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatchAllSelectorDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatchAllSelectorDefinition:
        """Create an instance of MatchAllSelectorDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatchAllSelectorDefinition.parse_obj(obj)

        _obj = MatchAllSelectorDefinition.parse_obj({
