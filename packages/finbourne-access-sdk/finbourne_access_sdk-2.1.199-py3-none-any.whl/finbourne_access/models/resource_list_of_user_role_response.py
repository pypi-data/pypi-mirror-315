...
class ResourceListOfUserRoleResponse(BaseModel):
    ...
    """
    values: conlist(UserRoleResponse) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfUserRoleResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfUserRoleResponse:
        """Create an instance of ResourceListOfUserRoleResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfUserRoleResponse.parse_obj(obj)

        _obj = ResourceListOfUserRoleResponse.parse_obj({
            "values": [UserRoleResponse.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
