...
class PolicyCreationRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyCreationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolicyCreationRequest:
        """Create an instance of PolicyCreationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyCreationRequest.parse_obj(obj)

        _obj = PolicyCreationRequest.parse_obj({
            "code": obj.get("code"),
