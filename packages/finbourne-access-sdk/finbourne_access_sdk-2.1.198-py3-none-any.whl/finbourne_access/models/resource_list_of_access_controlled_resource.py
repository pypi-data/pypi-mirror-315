...
class ResourceListOfAccessControlledResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfAccessControlledResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfAccessControlledResource:
        """Create an instance of ResourceListOfAccessControlledResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfAccessControlledResource.parse_obj(obj)

        _obj = ResourceListOfAccessControlledResource.parse_obj({
            "values": [AccessControlledResource.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
