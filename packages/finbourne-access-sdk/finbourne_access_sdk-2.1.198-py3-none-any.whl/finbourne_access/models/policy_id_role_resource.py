...
class PolicyIdRoleResource(BaseModel):
    ...
    policy_collections: Optional[conlist(PolicyCollectionId)] = Field(None, alias="policyCollections")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyIdRoleResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolicyIdRoleResource:
        """Create an instance of PolicyIdRoleResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyIdRoleResource.parse_obj(obj)

        _obj = PolicyIdRoleResource.parse_obj({
