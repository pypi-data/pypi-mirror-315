...
class EntitlementMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntitlementMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntitlementMetadata:
        """Create an instance of EntitlementMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntitlementMetadata.parse_obj(obj)

        _obj = EntitlementMetadata.parse_obj({
