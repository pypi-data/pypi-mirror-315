...
class PolicyCollectionId(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyCollectionId:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolicyCollectionId:
        """Create an instance of PolicyCollectionId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyCollectionId.parse_obj(obj)

        _obj = PolicyCollectionId.parse_obj({
            "scope": obj.get("scope"),
            "code": obj.get("code")
        })
        return _obj
