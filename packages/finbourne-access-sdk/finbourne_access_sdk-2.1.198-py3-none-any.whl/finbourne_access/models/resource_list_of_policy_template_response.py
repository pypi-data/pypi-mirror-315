...
class ResourceListOfPolicyTemplateResponse(BaseModel):
    ...
    """
    values: conlist(PolicyTemplateResponse) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfPolicyTemplateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfPolicyTemplateResponse:
        """Create an instance of ResourceListOfPolicyTemplateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfPolicyTemplateResponse.parse_obj(obj)

        _obj = ResourceListOfPolicyTemplateResponse.parse_obj({
            "values": [PolicyTemplateResponse.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
