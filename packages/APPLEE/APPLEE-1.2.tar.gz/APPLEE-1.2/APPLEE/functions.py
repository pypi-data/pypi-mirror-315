...
def run_wavelet(sig, fs=int, L_FREQ=4, H_FREQ=50):
    """
    ...
    signal_wavelet = signal_filtering(raw.get_data(), highpass, lowpass, raw.ch_names, raw.info['sfreq'], HP=False)
    # Return the filtered signal
    return signal_wavelet