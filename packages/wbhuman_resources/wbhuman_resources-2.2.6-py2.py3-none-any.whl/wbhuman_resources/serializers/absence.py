...
class AbsenceRequestTypeModelSerializer(wb_serializers.ModelSerializer):
    ...
    def crossborder_countries_additional_resources(self, instance, request, user, **kwargsy):
        return {
...
class AbsenceRequestModelSerializer(wb_serializers.ModelSerializer):
    ...
    def additional_resources(self, instance, request, user):
        ...
        if instance and not instance.type.is_vacation and instance.status == AbsenceRequest.Status.APPROVED.name:
