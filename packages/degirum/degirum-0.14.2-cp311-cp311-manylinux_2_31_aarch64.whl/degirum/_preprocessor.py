...
class _TensorPreprocessor(_CommonPreprocessor):
    ...
    def forward(self, data):
        ...
        if (
            ...
            if self._model_params.InputN_defined(self._model_input) and self._model_params.InputN[self._model_input] > 0:
                shape_list.append(self._model_params.InputN[self._model_input])
            if self._model_params.InputH_defined(self._model_input) and self._model_params.InputH[self._model_input] > 0:
                shape_list.append(self._model_params.InputH[self._model_input])
            if self._model_params.InputW_defined(self._model_input) and self._model_params.InputW[self._model_input] > 0:
                shape_list.append(self._model_params.InputW[self._model_input])
            if self._model_params.InputC_defined(self._model_input) and self._model_params.InputC[self._model_input] > 0:
