...
def bench_older_semchunk(text: str) -> None:
    older_semchunk.chunk(text, chunk_size=chunk_size, token_counter=test_semchunk.tiktoken_token_counter)

def bench_newer_semchunk(text: str) -> None:
    newer_semchunk.chunk(text, chunk_size=chunk_size, token_counter=test_semchunk.tiktoken_token_counter)
