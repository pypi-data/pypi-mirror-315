...
def test_chunk() -> None:
    ...
    for chunk_size in {1, 2, 512}:
        ...
        for fileid in {'austen-emma.txt', 'carroll-alice.txt', 'shakespeare-macbeth.txt'}:
            ...
            chunker = semchunk.chunkify(tiktoken_tokenizer, chunk_size)
    ...
    chunker = semchunk.chunkify(tiktoken_token_counter, 4)
