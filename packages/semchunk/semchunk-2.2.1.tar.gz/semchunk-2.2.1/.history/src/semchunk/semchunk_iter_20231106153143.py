        ...
        for split_i, (split, length) in enumerate(zip(splits, lengths)):
            ...
            if length <= chunk_size:
                ...
                for next_split_i, next_split in enumerate(splits[split_i+1:], start=split_i+1):
                    ...
                    if length + splitter_length + lengths[next_split_i] <= chunk_size or token_counter(splitter.join(new_chunk_splits+[next_split])) <= chunk_size:
                        ...
                        length += splitter_length + lengths[next_split_i]
