...
def chunkerify(
    ...
    Returns:
        ...
        The resulting chunker can also be passed a `processes` argument that specifies the number of processes to be used when chunking multiple texts.
        ...
        Technically, the chunker is an instance of the `Chunker` class in order to assist with type hinting, however, it can be called like any other function."""
