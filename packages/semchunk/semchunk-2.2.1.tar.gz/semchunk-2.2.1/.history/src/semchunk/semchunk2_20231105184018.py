   ...
   Args:
    ...
    for i, split in enumerate(splits):
        ...
        if (token_counter(split+splitter) if not splitter_is_whitespace and not is_last_split else token_counter(split)) > chunk_size:
            ...
            print(not splitter_is_whitespace and not is_last_split)
            while not splitter_is_whitespace and not is_last_split and token_counter(new_chunks[-1]+splitter) > chunk_size:
