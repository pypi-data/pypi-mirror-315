...
# NOTE NOTE NOTE NOTE NOTE IMPORTANT TODO TODO TODO: FIGURE OUT why it is that this script is much slower than the newer semchunk as well as the original semchunk.