...
from ..chain import Chain, EthereumChain, constants as chain_constants
...
class MachClient:
    ...
    async def request_quote(
        ...
        assert NativeCoin not in (type(src_token), type(dest_token)), "Native coins not supported"
    ...
    async def place_trade[SrcChain: Chain, DestChain: Chain](
        ...
        *,
        ...
        try:
            order_response = await self.submit_order(result, referral_code)
        except Exception as e:
