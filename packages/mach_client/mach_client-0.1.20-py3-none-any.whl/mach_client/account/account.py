...
class AccountID[ChainType: Chain](AccountBase[ChainType]):
    ...
    @staticmethod
    def from_hdwallet(hdwallet: HDWallet) -> AccountID:
        chain = Chain.from_str(hdwallet.cryptocurrency())
    ...
    @staticmethod
    def from_id_str(id: str) -> AccountID:
        namespace, reference, address = id.split(":")
        return AccountID.from_id(namespace, reference, address)
...
class Account[ChainType: Chain](AccountBase[ChainType]):
    ...
    @staticmethod
    def from_hdwallet(hdwallet: HDWallet) -> Account:
        chain = Chain.from_str(hdwallet.cryptocurrency())
    ...
    @staticmethod
    def from_id_str(id: str) -> Account:
        namespace, reference, private_key = id.split(":")
        return Account.from_id(namespace, reference, private_key)
