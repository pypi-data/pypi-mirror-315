    ...
    for f in media_files:
        ...
        try:
            ...
            if datetime_original:
                # parse datetime_original as ISO datetime format, in case
                # of failure exception is raised and file is not imported
                ...
                dst_file_path = (
                    ...
                    / dst_dir
                    / Path(
                        datetime_original.strftime(iso_datetime_fmt)
                        + "_"
                        + f["FileName"]
                    )
                )
