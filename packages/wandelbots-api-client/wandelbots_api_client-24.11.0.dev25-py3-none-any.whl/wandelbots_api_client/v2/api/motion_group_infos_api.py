...
from typing_extensions import Annotated
from wandelbots_api_client.v2.models.info_service_capabilities import InfoServiceCapabilities
from wandelbots_api_client.v2.models.list_payloads_response import ListPayloadsResponse
from wandelbots_api_client.v2.models.list_tcps_response import ListTcpsResponse
from wandelbots_api_client.v2.models.motion_group_specification import MotionGroupSpecification
from wandelbots_api_client.v2.models.motion_group_state import MotionGroupState
from wandelbots_api_client.v2.models.mounting import Mounting
from wandelbots_api_client.v2.models.optimizer_setup import OptimizerSetup
...
from wandelbots_api_client.v2.models.safety_setup import SafetySetup
...
class MotionGroupInfosApi:
    ...
    async def get_active_tcp(
        ...
        use_controller_orientation: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param use_controller_orientation:
        :type use_controller_orientation: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_active_tcp_serialize(
            ...
            use_controller_orientation=use_controller_orientation,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _get_active_tcp_serialize(
        ...
        if use_controller_orientation is not None:
            
            _query_params.append(('use_controller_orientation', use_controller_orientation))
