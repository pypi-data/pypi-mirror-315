...
class MotionGroupInstance(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["motion_group", "controller", "name_from_controller", "model_from_controller"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MotionGroupInstance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MotionGroupInstance from a dict"""
        if obj is None:
            return None
