...
class MotionApi:
    ...
    async def execute_to_trajectory(self, cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. ")], trajectory: Annotated[StrictStr, Field(description="This represents the unique identifier of a trajectory. Every executable or partially executable trajectory is cached and an unique identifier is returned. Indicate the unique identifier to execute the trajectory or retrieve information on the trajectory. ")], location_on_trajectory: Union[StrictFloat, StrictInt], limit_override_joint_velocity_limits_joints: Annotated[Optional[List[Union[StrictFloat, StrictInt]]], Field(description="The joint velocity limits for the p2p movement to a previously added trajectory.")] = None, limit_override_joint_acceleration_limits_joints: Annotated[Optional[List[Union[StrictFloat, StrictInt]]], Field(description="The joint acceleration limits for the p2p movement to a previously added trajectory.")] = None, limit_override_tcp_velocity_limit: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Maximum allowed TCP velocity in [mm/s].")] = None, limit_override_tcp_acceleration_limit: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Maximum allowed TCP acceleration in [mm/s^2].")] = None, limit_override_tcp_orientation_velocity_limit: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Maximum allowed TCP rotation velocity in [rad/s].")] = None, limit_override_tcp_orientation_acceleration_limit: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Maximum allowed TCP rotation acceleration in [rad/s^2].")] = None, responses_coordinate_system: Optional[StrictStr] = None) -> AsyncGenerator[MoveToTrajectoryViaJointPTPResponse, None]:  # noqa: E501
        ...
        path = format_path_parameters("/cells/{cell}/trajectories/{trajectory}/executetotrajectory")
    ...
    async def execute_trajectory(self, cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. ")], client_request_generator: Callable[[AsyncGenerator[ExecuteTrajectoryResponse, None]], AsyncGenerator[ExecuteTrajectoryRequest, None]]) -> None:  # noqa: E501
        ...
        path = format_path_parameters("/cells/{cell}/trajectories/execute")
