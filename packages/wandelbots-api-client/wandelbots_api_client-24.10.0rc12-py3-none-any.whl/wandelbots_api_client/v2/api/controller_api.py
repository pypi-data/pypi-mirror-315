...
from wandelbots_api_client.v2.models.controller_instance_list import ControllerInstanceList
...
class ControllerApi:
    ...
    async def add_robot_controller(
        ...
        Add a robot controller to the cell.  **Warning**: Using it in conjunction with the settings app may lead to unpredictable behavior. 
    ...
    async def clear_robot_controllers(
        ...
        Delete all robot controllers from the cell.  To replace all robot controllers in a cell, use this endpoint in combination with the 'Add Robot Controller' endpoint.  **Warning**: Using it in conjunction with the settings app may lead to unpredictable behavior. 
    ...
    async def delete_robot_controller(
        ...
        Delete a robot controller from the cell.  **Warning**: Using it in conjunction with the settings app may lead to unpredictable behavior. 
    ...
    @validate_call
    async def stream_free_drive(self, cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. ")], controller: Annotated[StrictStr, Field(description="Unique identifier to address a controller in the cell.")], response_rate: Optional[StrictInt] = None) -> AsyncGenerator[RobotControllerState, None]:  # noqa: E501
    ...
    @validate_call
    async def stream_mode_change(self, cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. ")], controller: Annotated[StrictStr, Field(description="Unique identifier to address a controller in the cell.")]) -> AsyncGenerator[ModeChangeResponse, None]:  # noqa: E501
    ...
    @validate_call
    async def stream_robot_controller_state(self, cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. ")], controller: Annotated[StrictStr, Field(description="Unique identifier to address a controller in the cell.")], response_rate: Optional[StrictInt] = None) -> AsyncGenerator[RobotControllerState, None]:  # noqa: E501
    ...
    async def update_robot_controller(
        ...
        Update the configuration of a robot controller.  Reconfigure certain options of a robot controller, or deploy a specific container image of a robot controller.  **Warning**: Using it in conjunction with the settings app may lead to unpredictable behavior. 
