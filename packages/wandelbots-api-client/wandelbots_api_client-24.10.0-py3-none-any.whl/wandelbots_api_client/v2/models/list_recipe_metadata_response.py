...
class ListRecipeMetadataResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListRecipeMetadataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListRecipeMetadataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "recipes": [
                ...
                RecipeMetadata.from_dict(_item) if hasattr(RecipeMetadata, 'from_dict') else _item
                # <<< End modification
                for _item in obj["recipes"]
            ] if obj.get("recipes") is not None else None
        })
        return _obj
