...
from wandelbots_api_client.v2.models.movement_state_type import MovementStateType
...
class JoggingResponse(BaseModel):
    ...
    state: Optional[RobotControllerState] = None
    movement_state: Optional[MovementStateType] = None
