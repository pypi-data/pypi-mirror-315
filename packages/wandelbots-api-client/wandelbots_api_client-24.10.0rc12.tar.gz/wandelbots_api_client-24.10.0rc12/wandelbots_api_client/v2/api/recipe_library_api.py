...
class RecipeLibraryApi:
    ...
    async def create_recipe(
        ...
        # EXPERIMENTAL  > **Note:** This endpoint is experimental and might experience functional changes in the future.  Creates a new recipe. The corresponding metadata is created as well. 
    ...
    async def delete_recipe_list(
        ...
        # EXPERIMENTAL  > **Note:** This endpoint is experimental and might experience functional changes in the future.  Deletes the provided list of recipes. This action is irreversible. 
    ...
    async def get_recipe(
        ...
        # EXPERIMENTAL  > **Note:** This endpoint is experimental and might experience functional changes in the future.  Returns the content of a recipe. The identifier of the recipe is recieved on creation or from the metadata list of all the recipes. 
    ...
    async def update_recipe(
        ...
        # EXPERIMENTAL  > **Note:** This endpoint is experimental and might experience functional changes in the future.  Updates an existing recipe. The update is partial, only the set fields get updated. 
