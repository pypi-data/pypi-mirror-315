...
class ProgramApi:
    ...
    async def get_program_runner(
        ...
        Returns information about a program currently executed. When a program is finished: Program response, result, collected Wandelscript logs, .. When a program is running: Running status, current executed line, ...  ## Parameters - **runner_id**: The id of the program runner
    ...
    async def stop_program_runner(
        ...
        Stop a specific program runner. Note: A 204 will also be thrown if the runner is not running.  ## Parameters - **runner_id**: The id of the program runner
