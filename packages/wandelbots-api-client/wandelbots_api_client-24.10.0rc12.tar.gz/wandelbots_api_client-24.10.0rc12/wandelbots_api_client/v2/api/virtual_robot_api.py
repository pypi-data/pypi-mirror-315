...
class VirtualRobotApi:
    ...
    async def list_ios(
        ...
        prefix: Annotated[Optional[StrictStr], Field(description="Return only I/Os with the specified prefix of unique identifier. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Lists the I/Os of the virtual controller. Every I/O contains the description and the value.  Each I/O has a unique identifier. If no identifiers are specified in the request, the full list of available I/Os is retrieved by this endpoint. As a virtual robot can have up to thousand I/Os, be ready to handle a large response. Use [List Descriptions](List Descriptions) to get a detailed description of an I/O. 
        ...
        :param prefix: Return only I/Os with the specified prefix of unique identifier. 
        :type prefix: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    async def set_io_values(
        ...
        Sets a list of values of a virtual controller I/O. 
