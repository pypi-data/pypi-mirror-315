...
from wandelbots_api_client.v2.models.google_protobuf_any import GoogleProtobufAny
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": [
                ...
                GoogleProtobufAny.from_dict(_item) if hasattr(GoogleProtobufAny, 'from_dict') else _item
                # <<< End modification
