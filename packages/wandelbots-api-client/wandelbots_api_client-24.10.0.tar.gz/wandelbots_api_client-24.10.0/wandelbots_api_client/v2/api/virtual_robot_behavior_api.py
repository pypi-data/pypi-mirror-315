...
class VirtualRobotBehaviorApi:
    ...
    @validate_call
    async def external_joints_stream(self, cell: Annotated[str, Field(strict=True, description="Unique identifier addressing a cell in all API calls. ")], controller: Annotated[StrictStr, Field(description="Unique identifier to address a controller in the cell.")], client_request_generator: Callable[[AsyncGenerator[MotionGroupJoints, None]], AsyncGenerator[ExternalJointStreamDatapoint, None]]) -> None:  # noqa: E501
