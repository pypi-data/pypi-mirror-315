...
def new_allowlist_ip_command(
    ...
    *,
    ...
    Args:
        ...
        env_name (typing.Annotated[typing.Optional[str], Option]): The name of the environment.
            Defaults to the current environment from configuration.
        ip_address (Annotated[Optional[str], typer.Option]): The IP address, range, or combination of both to add
            to the allowlist. Will add your IP if not provided.
