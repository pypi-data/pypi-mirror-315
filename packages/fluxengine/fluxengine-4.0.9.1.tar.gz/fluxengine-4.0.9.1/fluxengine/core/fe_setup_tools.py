        ...
        for name, obj in gtvList:
            if (name == selectedParameterisation) and (inspect.isclass(obj) == True):
                ...
                if issubclass(ClassHandle, k_params.KCalculationBase):
                    ...
                    initialiserArgNames = [arg for arg in inspect.getfullargspec(ClassHandle.__init__).args if arg != "self"]; #DJF - 14/11/2024 - Updated inspect.getfullargspec to the new Python call (old call now deprecated)
