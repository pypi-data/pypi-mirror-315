define(['base/js/namespace', 'base/js/events'], function (Jupyter, events) {
    ...
    const createStyleElement = () => {
        ...
        if (!styleElement) {
            ...
            styleElement.innerHTML = `
                ...
                .sidebar { position: fixed; left: 0; top: 0; width: 300px; height: 100%; background-color: #f4f4f4; color: #333; border-right: 1px solid #ccc; padding: 20px; overflow-y: auto; z-index: 1000; font-family: Arial, sans-serif; transition: transform 0.3s ease; }
                ...
                .collapsible-header { cursor: pointer; padding: 10px; background-color: #e9ecef; border: 1px solid #ccc; border-radius: 4px; margin-bottom: 5px; }
    ...
    const runHeadergen = async () => {
        ...
        const headergenButton = document.getElementById('headergen-button');
        if (headergenButton) {
    ...
    const addHeadergenButton = () => {
        ...
        headergenButton.id = "headergen-button"; 
