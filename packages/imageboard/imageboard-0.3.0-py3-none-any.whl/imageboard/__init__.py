...
class ImageBoard:
    ...
    def to_image(
        ...
        if x and y:
            ...
            label_2d = [[f"{record[0][x]}" for record in row] for row in filtered_data]
        else:
            label_2d = [[f"{record[0][y]}" for record in row] for row in filtered_data]
