...
const (
	...
	Moriarty_StartAutoPilot_FullMethodName  = "/com.appknox.bakerstreet.Moriarty/StartAutoPilot"
...
func (c *moriartyClient) StartAutoPilot(ctx context.Context, in *AutoPilotConfig, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, Moriarty_StartAutoPilot_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Moriarty_StartAutoPilot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Moriarty_StartAutoPilot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
