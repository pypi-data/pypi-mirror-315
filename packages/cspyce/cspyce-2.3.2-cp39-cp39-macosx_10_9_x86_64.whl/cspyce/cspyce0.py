...
def bltfrm(frmcls, ids):
    r"""bltfrm(SpiceInt frmcls, SpiceCell * ids)"""
    return _cspyce0.bltfrm(frmcls, ids)
...
def ckcov(ck, idcode, needav, level, tol, timsys, cover):
    r"""ckcov(ConstSpiceChar * ck, SpiceInt idcode, SpiceBoolean needav, ConstSpiceChar * level, SpiceDouble tol, ConstSpiceChar * timsys, SpiceCell * cover)"""
    return _cspyce0.ckcov(ck, idcode, needav, level, tol, timsys, cover)
...
def ckobj(ck, bodids):
    r"""ckobj(ConstSpiceChar * ck, SpiceCell * bodids)"""
    return _cspyce0.ckobj(ck, bodids)
...
def dafus(sum, nd, ni):
    r"""dafus(ConstSpiceDouble [] sum, SpiceInt nd, SpiceInt ni)"""
...
def el2cgv(ellipse):
    r"""el2cgv(ConstSpiceEllipse * ellipse)"""
...
def fovray(inst, raydir, rframe, abcorr, obsrvr, et):
    r"""fovray(ConstSpiceChar * inst, ConstSpiceDouble [3] raydir, ConstSpiceChar * rframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble et)"""
    return _cspyce0.fovray(inst, raydir, rframe, abcorr, obsrvr, et)
...
def fovtrg(inst, target, tshape, tframe, abcorr, obsrvr, et):
    r"""fovtrg(ConstSpiceChar * inst, ConstSpiceChar * target, ConstSpiceChar * tshape, ConstSpiceChar * tframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble et)"""
    return _cspyce0.fovtrg(inst, target, tshape, tframe, abcorr, obsrvr, et)
...
def furnsh(CONST_FILENAME):
    r"""furnsh(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.furnsh(CONST_FILENAME)
...
def inedpl(a, b, c, plane):
    r"""inedpl(SpiceDouble a, SpiceDouble b, SpiceDouble c, ConstSpicePlane * plane)"""
...
def inelpl(ellips, plane):
    r"""inelpl(ConstSpiceEllipse * ellips, ConstSpicePlane * plane)"""
...
def inrypl(vertex, dir, plane):
    r"""inrypl(ConstSpiceDouble [3] vertex, ConstSpiceDouble [3] dir, ConstSpicePlane * plane)"""
...
def kplfrm(frmcls, ids):
    r"""kplfrm(SpiceInt frmcls, SpiceCell * ids)"""
    return _cspyce0.kplfrm(frmcls, ids)
...
def latsrf(method, target, et, fixref, npts):
    r"""latsrf(ConstSpiceChar * method, ConstSpiceChar * target, SpiceDouble et, ConstSpiceChar * fixref, SpiceInt npts)"""
    return _cspyce0.latsrf(method, target, et, fixref, npts)
...
def ldpool(CONST_FILENAME):
    r"""ldpool(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.ldpool(CONST_FILENAME)
...
def npelpt(point, ellips):
    r"""npelpt(ConstSpiceDouble [3] point, ConstSpiceEllipse * ellips)"""
...
def pckcov(pck, idcode, cover):
    r"""pckcov(ConstSpiceChar * pck, SpiceInt idcode, SpiceCell * cover)"""
    return _cspyce0.pckcov(pck, idcode, cover)

def pckfrm(pck, ids):
    r"""pckfrm(ConstSpiceChar * pck, SpiceCell * ids)"""
    return _cspyce0.pckfrm(pck, ids)
...
def pjelpl(elin, plane):
    r"""pjelpl(ConstSpiceEllipse * elin, ConstSpicePlane * plane)"""
...
def pl2nvc(plane):
    r"""pl2nvc(ConstSpicePlane * plane)"""
...
def pl2nvp(plane):
    r"""pl2nvp(ConstSpicePlane * plane)"""
...
def pl2psv(plane):
    r"""pl2psv(ConstSpicePlane * plane)"""
...
def spkcov(spk, idcode, cover):
    r"""spkcov(ConstSpiceChar * spk, SpiceInt idcode, SpiceCell * cover)"""
    return _cspyce0.spkcov(spk, idcode, cover)
...
def spkobj(spk, ids):
    r"""spkobj(ConstSpiceChar * spk, SpiceCell * ids)"""
    return _cspyce0.spkobj(spk, ids)
...
def unload(CONST_FILENAME):
    r"""unload(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.unload(CONST_FILENAME)
...
def vprjp(v1, plane):
    r"""vprjp(ConstSpiceDouble [3] v1, ConstSpicePlane * plane)"""
...
def vprjpi(v1, projpl, invpl):
    r"""vprjpi(ConstSpiceDouble [3] v1, ConstSpicePlane * projpl, ConstSpicePlane * invpl)"""
...
def ckfrot_vector(k1, in11):
    r"""ckfrot_vector(SpiceInt k1, ConstSpiceDouble * in11)"""
    return _cspyce0.ckfrot_vector(k1, in11)

def ckfxfm(inst, et):
    r"""ckfxfm(SpiceInt inst, SpiceDouble et)"""
    return _cspyce0.ckfxfm(inst, et)

def ckfxfm_vector(k1, in11):
    r"""ckfxfm_vector(SpiceInt k1, ConstSpiceDouble * in11)"""
    return _cspyce0.ckfxfm_vector(k1, in11)
...
def cklpf(CONST_FILENAME):
    r"""cklpf(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.cklpf(CONST_FILENAME)
...
def ckopn(CONST_FILENAME, CONST_STRING, ncomch):
    r"""ckopn(ConstSpiceChar * CONST_FILENAME, ConstSpiceChar * CONST_STRING, SpiceInt ncomch)"""
    return _cspyce0.ckopn(CONST_FILENAME, CONST_STRING, ncomch)
...
def cmprss(delim, n, input):
    r"""cmprss(SpiceChar delim, SpiceInt n, ConstSpiceChar * input)"""
    return _cspyce0.cmprss(delim, n, input)
...
def dafps(nd, ni):
    r"""dafps(SpiceInt nd, SpiceInt ni)"""
    return _cspyce0.dafps(nd, ni)
...
def dasonw(CONST_FILENAME, arg2, arg3, ncomr):
    r"""dasonw(ConstSpiceChar * CONST_FILENAME, ConstSpiceChar * arg2, ConstSpiceChar * arg3, SpiceInt ncomr)"""
    return _cspyce0.dasonw(CONST_FILENAME, arg2, arg3, ncomr)

def dasopr(CONST_FILENAME):
    r"""dasopr(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.dasopr(CONST_FILENAME)

def dasops():
    r"""dasops()"""
    return _cspyce0.dasops()

def dasopw(CONST_FILENAME):
    r"""dasopw(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.dasopw(CONST_FILENAME)

def dasrdc(handle, first, last, bpos, epos, datlen, data):
    r"""dasrdc(SpiceInt handle, SpiceInt first, SpiceInt last, SpiceInt bpos, SpiceInt epos, SpiceInt datlen, SpiceChar * data)"""
...
def dasudd(handle, first, last, n):
    r"""dasudd(SpiceInt handle, SpiceInt first, SpiceInt last, SpiceInt n)"""
    return _cspyce0.dasudd(handle, first, last, n)

def dasudi(handle, first, last, n):
    r"""dasudi(SpiceInt handle, SpiceInt first, SpiceInt last, SpiceInt n)"""
    return _cspyce0.dasudi(handle, first, last, n)
...
def dlafns(handle, dladsc):
    r"""dlafns(SpiceInt handle, ConstSpiceDLADescr * dladsc)"""
    return _cspyce0.dlafns(handle, dladsc)

def dlafps(handle, dladsc):
    r"""dlafps(SpiceInt handle, ConstSpiceDLADescr * dladsc)"""
    return _cspyce0.dlafps(handle, dladsc)

def dlaopn(CONST_FILENAME, arg2, arg3, ncomch):
    r"""dlaopn(ConstSpiceChar * CONST_FILENAME, ConstSpiceChar * arg2, ConstSpiceChar * arg3, SpiceInt ncomch)"""
    return _cspyce0.dlaopn(CONST_FILENAME, arg2, arg3, ncomch)
...
def dp2hx(number):
    r"""dp2hx(SpiceDouble number)"""
    return _cspyce0.dp2hx(number)
...
def dskb02(handle, dladsc):
    r"""dskb02(SpiceInt handle, ConstSpiceDLADescr * dladsc)"""
...
def dskd02(handle, dladsc, item, start):
    r"""dskd02(SpiceInt handle, ConstSpiceDLADescr * dladsc, SpiceInt item, SpiceInt start)"""
    return _cspyce0.dskd02(handle, dladsc, item, start)

def dskgd(handle, dladsc):
    r"""dskgd(SpiceInt handle, ConstSpiceDLADescr * dladsc)"""
...
def dski02(handle, dladsc, item, start, room):
    r"""dski02(SpiceInt handle, ConstSpiceDLADescr * dladsc, SpiceInt item, SpiceInt start, SpiceInt room)"""
    return _cspyce0.dski02(handle, dladsc, item, start, room)

def dskmi2(nv, np, finscl, corscl, worksz, voxpsz, voxlsz, makvtl, spxisz):
    r"""dskmi2(SpiceInt nv, SpiceInt np, SpiceDouble finscl, SpiceInt corscl, SpiceInt worksz, SpiceInt voxpsz, SpiceInt voxlsz, SpiceBoolean makvtl, SpiceInt spxisz)"""
    return _cspyce0.dskmi2(nv, np, finscl, corscl, worksz, voxpsz, voxlsz, makvtl, spxisz)

def dskn02(handle, dladsc, plid):
    r"""dskn02(SpiceInt handle, ConstSpiceDLADescr * dladsc, SpiceInt plid)"""
    return _cspyce0.dskn02(handle, dladsc, plid)

def dskobj(dskfnm, bodids):
    r"""dskobj(ConstSpiceChar * dskfnm, SpiceCell * bodids)"""
    return _cspyce0.dskobj(dskfnm, bodids)

def dskopn(CONST_FILENAME, CONST_STRING, ncomch):
    r"""dskopn(ConstSpiceChar * CONST_FILENAME, ConstSpiceChar * CONST_STRING, SpiceInt ncomch)"""
    return _cspyce0.dskopn(CONST_FILENAME, CONST_STRING, ncomch)

def dskp02(handle, dladsc, start, room):
    r"""dskp02(SpiceInt handle, ConstSpiceDLADescr * dladsc, SpiceInt start, SpiceInt room)"""
    return _cspyce0.dskp02(handle, dladsc, start, room)
...
def dsksrf(dskfnm, bodyid, srfids):
    r"""dsksrf(ConstSpiceChar * dskfnm, SpiceInt bodyid, SpiceCell * srfids)"""
    return _cspyce0.dsksrf(dskfnm, bodyid, srfids)
...
def dskv02(handle, dladsc, start, room):
    r"""dskv02(SpiceInt handle, ConstSpiceDLADescr * dladsc, SpiceInt start, SpiceInt room)"""
    return _cspyce0.dskv02(handle, dladsc, start, room)
...
def dskx02(handle, dladsc, vertex, raydir):
    r"""dskx02(SpiceInt handle, ConstSpiceDLADescr * dladsc, ConstSpiceDouble [3] vertex, ConstSpiceDouble [3] raydir)"""
    return _cspyce0.dskx02(handle, dladsc, vertex, raydir)

def dskxsi(pri, target, nsurf, et, fixref, vertex, raydir):
    r"""dskxsi(SpiceBoolean pri, ConstSpiceChar * target, SpiceInt nsurf, SpiceDouble et, ConstSpiceChar * fixref, ConstSpiceDouble [3] vertex, ConstSpiceDouble [3] raydir)"""
    return _cspyce0.dskxsi(pri, target, nsurf, et, fixref, vertex, raydir)

def dskxv(pri, target, nsurf, et, fixref, nrays, n2):
    r"""dskxv(SpiceBoolean pri, ConstSpiceChar * target, SpiceInt nsurf, SpiceDouble et, ConstSpiceChar * fixref, SpiceInt nrays, SpiceInt n2)"""
    return _cspyce0.dskxv(pri, target, nsurf, et, fixref, nrays, n2)

def dskz02(handle, dladsc):
    r"""dskz02(SpiceInt handle, ConstSpiceDLADescr * dladsc)"""
...
def ekaced(handle, segno, recno, CONST_STRING, nvals, isnull):
    r"""ekaced(SpiceInt handle, SpiceInt segno, SpiceInt recno, ConstSpiceChar * CONST_STRING, SpiceInt nvals, SpiceBoolean isnull)"""
    return _cspyce0.ekaced(handle, segno, recno, CONST_STRING, nvals, isnull)

def ekacei(handle, segno, recno, CONST_STRING, nvals, isnull):
    r"""ekacei(SpiceInt handle, SpiceInt segno, SpiceInt recno, ConstSpiceChar * CONST_STRING, SpiceInt nvals, SpiceBoolean isnull)"""
    return _cspyce0.ekacei(handle, segno, recno, CONST_STRING, nvals, isnull)

def ekaclc(handle, segno, column, ignore, entszs, nlflgs, rcptrs):
    r"""ekaclc(SpiceInt handle, SpiceInt segno, ConstSpiceChar * column, SpiceInt ignore, ConstSpiceInt [] entszs, ConstSpiceBoolean [] nlflgs, ConstSpiceInt [] rcptrs)"""
    return _cspyce0.ekaclc(handle, segno, column, ignore, entszs, nlflgs, rcptrs)
...
def ekbseg(handle, tabnam, ncols, ignore):
    r"""ekbseg(SpiceInt handle, ConstSpiceChar * tabnam, SpiceInt ncols, SpiceInt ignore)"""
    return _cspyce0.ekbseg(handle, tabnam, ncols, ignore)
...
def ekifld(handle, tabnam, nrows, ncols, ignore):
    r"""ekifld(SpiceInt handle, ConstSpiceChar * tabnam, SpiceInt nrows, SpiceInt ncols, SpiceInt ignore)"""
    return _cspyce0.ekifld(handle, tabnam, nrows, ncols, ignore)
...
def eklef(CONST_FILENAME):
    r"""eklef(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.eklef(CONST_FILENAME)
...
def ekopn(CONST_FILENAME, CONST_STRING, ncomch):
    r"""ekopn(ConstSpiceChar * CONST_FILENAME, ConstSpiceChar * CONST_STRING, SpiceInt ncomch)"""
    return _cspyce0.ekopn(CONST_FILENAME, CONST_STRING, ncomch)

def ekopr(CONST_FILENAME):
    r"""ekopr(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.ekopr(CONST_FILENAME)

def ekops():
    r"""ekops()"""
    return _cspyce0.ekops()

def ekopw(CONST_FILENAME):
    r"""ekopw(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.ekopw(CONST_FILENAME)

def ekpsel(query):
    r"""ekpsel(ConstSpiceChar * query)"""
    return _cspyce0.ekpsel(query)

def ekrcec(handle, segno, recno, CONST_STRING):
    r"""ekrcec(SpiceInt handle, SpiceInt segno, SpiceInt recno, ConstSpiceChar * CONST_STRING)"""
    return _cspyce0.ekrcec(handle, segno, recno, CONST_STRING)
...
def ekssum(handle, segno):
    r"""ekssum(SpiceInt handle, SpiceInt segno)"""
    return _cspyce0.ekssum(handle, segno)
...
def ekuced(handle, segno, recno, CONST_STRING, nvals, isnull):
    r"""ekuced(SpiceInt handle, SpiceInt segno, SpiceInt recno, ConstSpiceChar * CONST_STRING, SpiceInt nvals, SpiceBoolean isnull)"""
    return _cspyce0.ekuced(handle, segno, recno, CONST_STRING, nvals, isnull)

def ekucei(handle, segno, recno, CONST_STRING, nvals, isnull):
    r"""ekucei(SpiceInt handle, SpiceInt segno, SpiceInt recno, ConstSpiceChar * CONST_STRING, SpiceInt nvals, SpiceBoolean isnull)"""
    return _cspyce0.ekucei(handle, segno, recno, CONST_STRING, nvals, isnull)
...
def gfdist(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine, result):
    r"""gfdist(ConstSpiceChar * target, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfdist(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine, result)

def gfevnt(step, gquant, qpnams_ct, qcpars_ct, qdpars, qipars, qlpars, op, refval, tol, adjust, rpt, nintvls, cnfine, result):
    r"""gfevnt(SpiceDouble step, ConstSpiceChar * gquant, SpiceInt qpnams_ct, SpiceInt qcpars_ct, ConstSpiceDouble * qdpars, ConstSpiceInt * qipars, ConstSpiceBoolean * qlpars, ConstSpiceChar * op, SpiceDouble refval, SpiceDouble tol, SpiceDouble adjust, SpiceBoolean rpt, SpiceInt nintvls, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfevnt(step, gquant, qpnams_ct, qcpars_ct, qdpars, qipars, qlpars, op, refval, tol, adjust, rpt, nintvls, cnfine, result)

def gffove(inst, tshape, raydir, target, tframe, abcorr, obsrvr, tol, step, rpt, cnfine, result):
    r"""gffove(ConstSpiceChar * inst, ConstSpiceChar * tshape, ConstSpiceDouble [3] raydir, ConstSpiceChar * target, ConstSpiceChar * tframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble tol, SpiceDouble step, SpiceBoolean rpt, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gffove(inst, tshape, raydir, target, tframe, abcorr, obsrvr, tol, step, rpt, cnfine, result)

def gfilum(method, angtyp, target, illmn, fixref, abcorr, obsrvr, spoint, relate, refval, adjust, step, nintvls, cnfine, result):
    r"""gfilum(ConstSpiceChar * method, ConstSpiceChar * angtyp, ConstSpiceChar * target, ConstSpiceChar * illmn, ConstSpiceChar * fixref, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceDouble [3] spoint, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfilum(method, angtyp, target, illmn, fixref, abcorr, obsrvr, spoint, relate, refval, adjust, step, nintvls, cnfine, result)

def gfocce(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, tol, step, rpt, cnfine, result):
    r"""gfocce(ConstSpiceChar * occtyp, ConstSpiceChar * front, ConstSpiceChar * fshape, ConstSpiceChar * fframe, ConstSpiceChar * back, ConstSpiceChar * bshape, ConstSpiceChar * bframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble tol, SpiceDouble step, SpiceBoolean rpt, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfocce(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, tol, step, rpt, cnfine, result)

def gfoclt(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, step, cnfine, result):
    r"""gfoclt(ConstSpiceChar * occtyp, ConstSpiceChar * front, ConstSpiceChar * fshape, ConstSpiceChar * fframe, ConstSpiceChar * back, ConstSpiceChar * bshape, ConstSpiceChar * bframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble step, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfoclt(occtyp, front, fshape, fframe, back, bshape, bframe, abcorr, obsrvr, step, cnfine, result)

def gfpa(target, illmn, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine, result):
    r"""gfpa(ConstSpiceChar * target, ConstSpiceChar * illmn, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfpa(target, illmn, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine, result)

def gfposc(target, frame, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine, result):
    r"""gfposc(ConstSpiceChar * target, ConstSpiceChar * frame, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * crdsys, ConstSpiceChar * coord, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfposc(target, frame, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine, result)

def gfrfov(inst, raydir, rframe, abcorr, obsrvr, step, cnfine, result):
    r"""gfrfov(ConstSpiceChar * inst, ConstSpiceDouble [3] raydir, ConstSpiceChar * rframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble step, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfrfov(inst, raydir, rframe, abcorr, obsrvr, step, cnfine, result)

def gfrr(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine, result):
    r"""gfrr(ConstSpiceChar * target, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfrr(target, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine, result)

def gfsep(targ1, shape1, frame1, targ2, shape2, frame2, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine, result):
    r"""gfsep(ConstSpiceChar * targ1, ConstSpiceChar * shape1, ConstSpiceChar * frame1, ConstSpiceChar * targ2, ConstSpiceChar * shape2, ConstSpiceChar * frame2, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfsep(targ1, shape1, frame1, targ2, shape2, frame2, abcorr, obsrvr, relate, refval, adjust, step, nintvls, cnfine, result)

def gfsntc(target, fixref, method, abcorr, obsrvr, dref, dvec, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine, result):
    ...
    return _cspyce0.gfsntc(target, fixref, method, abcorr, obsrvr, dref, dvec, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine, result)

def gfstol(value):
    r"""gfstol(SpiceDouble value)"""
    return _cspyce0.gfstol(value)

def gfsubc(target, fixref, method, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine, result):
    r"""gfsubc(ConstSpiceChar * target, ConstSpiceChar * fixref, ConstSpiceChar * method, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, ConstSpiceChar * crdsys, ConstSpiceChar * coord, ConstSpiceChar * relate, SpiceDouble refval, SpiceDouble adjust, SpiceDouble step, SpiceInt nintvls, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gfsubc(target, fixref, method, abcorr, obsrvr, crdsys, coord, relate, refval, adjust, step, nintvls, cnfine, result)

def gftfov(inst, target, tshape, tframe, abcorr, obsrvr, step, cnfine, result):
    r"""gftfov(ConstSpiceChar * inst, ConstSpiceChar * target, ConstSpiceChar * tshape, ConstSpiceChar * tframe, ConstSpiceChar * abcorr, ConstSpiceChar * obsrvr, SpiceDouble step, SpiceCell * cnfine, SpiceCell * result)"""
    return _cspyce0.gftfov(inst, target, tshape, tframe, abcorr, obsrvr, step, cnfine, result)
...
def isordv(array):
    r"""isordv(ConstSpiceInt [] array) -> SpiceBoolean"""
    return _cspyce0.isordv(array)
...
def matchi(arg1, arg2, arg3, arg4):
    r"""matchi(ConstSpiceChar * arg1, SpiceChar * arg2, SpiceChar arg3, SpiceChar arg4) -> SpiceBoolean"""
    return _cspyce0.matchi(arg1, arg2, arg3, arg4)

def matchw(arg1, arg2, arg3, arg4):
    r"""matchw(ConstSpiceChar * arg1, ConstSpiceChar * arg2, SpiceChar arg3, SpiceChar arg4) -> SpiceBoolean"""
...
def orderc(ndim):
    r"""orderc(SpiceInt ndim)"""
    return _cspyce0.orderc(ndim)

def orderd(array):
    r"""orderd(ConstSpiceDouble * array)"""
    return _cspyce0.orderd(array)

def orderi(array):
    r"""orderi(ConstSpiceInt * array)"""
    return _cspyce0.orderi(array)

def pckcls(handle):
    r"""pckcls(SpiceInt handle)"""
    return _cspyce0.pckcls(handle)

def pcklof(CONST_FILENAME):
    r"""pcklof(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.pcklof(CONST_FILENAME)

def pckopn(CONST_FILENAME, CONST_STRING, ncomch):
    r"""pckopn(ConstSpiceChar * CONST_FILENAME, ConstSpiceChar * CONST_STRING, SpiceInt ncomch)"""
    return _cspyce0.pckopn(CONST_FILENAME, CONST_STRING, ncomch)
...
def qderiv(ndim, ndim1, delta):
    r"""qderiv(SpiceInt ndim, SpiceInt ndim1, SpiceDouble delta)"""
    return _cspyce0.qderiv(ndim, ndim1, delta)
...
def reordd(iorder, ndim):
    r"""reordd(ConstSpiceInt * iorder, SpiceInt ndim)"""
    return _cspyce0.reordd(iorder, ndim)

def reordi(iorder, ndim):
    r"""reordi(ConstSpiceInt * iorder, SpiceInt ndim)"""
    return _cspyce0.reordi(iorder, ndim)

def reordl(iorder, ndim):
    r"""reordl(ConstSpiceInt * iorder, SpiceInt ndim)"""
    return _cspyce0.reordl(iorder, ndim)

def repml(arg1, arg2, value, IN_STRING):
    r"""repml(ConstSpiceChar * arg1, ConstSpiceChar * arg2, SpiceBoolean value, SpiceChar IN_STRING)"""
...
def shelld(ndim):
    r"""shelld(SpiceInt ndim)"""
    return _cspyce0.shelld(ndim)

def shelli(ndim):
    r"""shelli(SpiceInt ndim)"""
    return _cspyce0.shelli(ndim)
...
def spklef(CONST_FILENAME):
    r"""spklef(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.spklef(CONST_FILENAME)

def spkopa(CONST_FILENAME):
    r"""spkopa(ConstSpiceChar * CONST_FILENAME)"""
    return _cspyce0.spkopa(CONST_FILENAME)

def spkopn(CONST_FILENAME, CONST_STRING, ncomch):
    r"""spkopn(ConstSpiceChar * CONST_FILENAME, ConstSpiceChar * CONST_STRING, SpiceInt ncomch)"""
    return _cspyce0.spkopn(CONST_FILENAME, CONST_STRING, ncomch)
...
def spksfs(body, et):
    r"""spksfs(SpiceInt body, SpiceDouble et)"""
    return _cspyce0.spksfs(body, et)
...
def wncomd(left, right, window, result):
    r"""wncomd(SpiceDouble left, SpiceDouble right, SpiceCell * window, SpiceCell * result)"""
    return _cspyce0.wncomd(left, right, window, result)

def wncond(left, right, window):
    r"""wncond(SpiceDouble left, SpiceDouble right, SpiceCell * window)"""
    return _cspyce0.wncond(left, right, window)

def wndifd(a, b, c):
    r"""wndifd(SpiceCell * a, SpiceCell * b, SpiceCell * c)"""
    return _cspyce0.wndifd(a, b, c)

def wnelmd(point, window):
    r"""wnelmd(SpiceDouble point, SpiceCell * window) -> SpiceBoolean"""
    return _cspyce0.wnelmd(point, window)

def wnexpd(left, right, window):
    r"""wnexpd(SpiceDouble left, SpiceDouble right, SpiceCell * window)"""
    return _cspyce0.wnexpd(left, right, window)

def wnextd(side, window):
    r"""wnextd(SpiceChar side, SpiceCell * window)"""
    return _cspyce0.wnextd(side, window)

def wnfild(smlgap, window):
    r"""wnfild(SpiceDouble smlgap, SpiceCell * window)"""
    return _cspyce0.wnfild(smlgap, window)

def wnfltd(smlint, window):
    r"""wnfltd(SpiceDouble smlint, SpiceCell * window)"""
    return _cspyce0.wnfltd(smlint, window)

def wnincd(left, right, window):
    r"""wnincd(SpiceDouble left, SpiceDouble right, SpiceCell * window) -> SpiceBoolean"""
    return _cspyce0.wnincd(left, right, window)

def wninsd(left, right, window):
    r"""wninsd(SpiceDouble left, SpiceDouble right, SpiceCellDouble * window)"""
    return _cspyce0.wninsd(left, right, window)

def wnintd(a, b, c):
    r"""wnintd(SpiceCell * a, SpiceCell * b, SpiceCell * c)"""
    return _cspyce0.wnintd(a, b, c)

def wnreld(a, op, b):
    r"""wnreld(SpiceCell * a, ConstSpiceChar * op, SpiceCell * b) -> SpiceBoolean"""
    return _cspyce0.wnreld(a, op, b)

def wnsumd(window):
    r"""wnsumd(SpiceCell * window)"""
    return _cspyce0.wnsumd(window)

def wnunid(a, b, c):
    r"""wnunid(SpiceCell * a, SpiceCell * b, SpiceCell * c)"""
    return _cspyce0.wnunid(a, b, c)
