...
def inout_string_10(dim):
    return _typemap_samples.inout_string_10(dim)

def inout_string_ptr(dim):
    return _typemap_samples.inout_string_ptr(dim)
...
def outvar_set_from_var_int(INPUT):
    return _typemap_samples.outvar_set_from_var_int(INPUT)

def outvar_set_from_var_double(INPUT):
    return _typemap_samples.outvar_set_from_var_double(INPUT)

def outvar_set_from_var_char(INPUT):
    return _typemap_samples.outvar_set_from_var_char(INPUT)

def outvar_set_from_var_bool(INPUT):
    return _typemap_samples.outvar_set_from_var_bool(INPUT)

def DLADescr_in(arg):
    return _typemap_samples.DLADescr_in(arg)

def DLADescr_out():
    return _typemap_samples.DLADescr_out()

def ellipse_in(arg):
    return _typemap_samples.ellipse_in(arg)

def ellipse_out():
    return _typemap_samples.ellipse_out()

def SpiceCell_in(arg):
    return _typemap_samples.SpiceCell_in(arg)

def SpiceCell_append(arg, value):
    return _typemap_samples.SpiceCell_append(arg, value)

def decode_filename(filename):
    return _typemap_samples.decode_filename(filename)
