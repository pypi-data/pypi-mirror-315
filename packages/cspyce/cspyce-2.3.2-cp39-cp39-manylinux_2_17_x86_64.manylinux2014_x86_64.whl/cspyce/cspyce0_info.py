...
#########################################
CSPYCE_ARGNAMES["dasadc"] = ["handle", "n", "bpos", "epos", "datlen", "data"]
...
'data'  : ("byte_array[*,*]", "Sequence of strings providing the set of substrings to be added to the character data in the DAS file."),
}
...
#########################################
CSPYCE_ARGNAMES["dasrdc"] = ["handle", "first", "last", "bpos", "epos", "datlen", "data"]
...
'datlen': ("int", "Common length of the character arrays in `data'."),
'data'  : ("byte_array[*,*]", "Sequence of strings to be updated by the character data in the DAS file."),
}
...
'last'  : ("int", "End of range of DAS floating-point logical addresses."),
...
'last'  : ("int", "End of range of DAS integer logical addresses."),
...
#########################################
CSPYCE_ARGNAMES["dasudc"] = ["handle", "first", "last", "bpos", "epos", "datlen", "data"]
...
'epos'  : ("int", "End position of substrings in byte array."),
'datlen': ("int", "Common length of the character arrays in `data'."),
'data'  : ("byte_array[*,*]", "Sequence of strings providing the set of substrings to be updated in the character data in the DAS file."),
}
...
'dladsc': ("SpiceDLADescr", "Descriptor of last segment in DLA file."),
...
'handle': ("int", "Handle of open DLA file."),
'dladsc': ("SpiceDLADescr", "Descriptor of first segment in DLA file."),
'found' : ("bool", "Flag indicating whether a segment was found."),
}
...
'handle': ("int", "Handle of open DLA file."),
'dladsc': ("ConstSpiceDLADescr[*]", "Descriptor of a DLA segment."),
'nxtdsc': ("SpiceDLADescr", "Descriptor of next segment in DLA file."),
'found' : ("bool", "Flag indicating whether a segment was found."),
}
...
'handle': ("int", "Handle of open DLA file."),
'dladsc': ("ConstSpiceDLADescr[*]", "Descriptor of a segment in DLA file."),
'prvdsc': ("SpiceDLADescr", "Descriptor of previous segment in DLA file."),
'found' : ("bool", "Flag indicating whether a segment was found."),
}
...
'dladsc': ("ConstSpiceDLADescr[*]", "DLA descriptor."),
...
'dladsc': ("ConstSpiceDLADescr[*]", "DLA segment descriptor."),
'dskdsc': ("SpiceDSKDescr", "DSK segment descriptor."),
}
...
#########################################
CSPYCE_ARGNAMES["dskmi2"] = ["vrtces", "plates", "finscl", "corscl", "worksz", "voxpsz", "voxlsz", "makvtl", "spxisz"]
...
#########################################
CSPYCE_ARGNAMES["dskobj"] = ["dskfnm", "bodids"]
...
#########################################
CSPYCE_ARGNAMES["dskp02"] = ["handle", "dladsc", "start", "room"]
...
#########################################
CSPYCE_ARGNAMES["dsksrf"] = ["dskfnm", "bodyid", "srfids"]
...
#########################################
CSPYCE_ARGNAMES["dskv02"] = ["handle", "dladsc", "start", "room"]
...
'dladsc': ("ConstSpiceDLADescr[*]", "DLA descriptor of plate model segment."),
...
'dladsc': ("SpiceDLADescr", "DLA descriptor of segment."),
'dskdsc': ("SpiceDSKDescr", "DSK descriptor of segment."),
...
#########################################
CSPYCE_ARGNAMES["ekopn"] = ["fname", "ifname", "ncomch"]
...
CSPYCE_RETNAMES["ekssum"] = ["tabnam", "nrows", "ncols", "cnames", "cclass", "dtype", "strln", "size", "indexd", "nullok"]
...
'nrows' : ("int", "The number of rows in the segment."),
...
#########################################
CSPYCE_ARGNAMES["gfdist"] = ["target", "abcorr", "obsrvr", "relate", "refval", "adjust", "step", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfdist"] = ["result"]
...
CSPYCE_DEFAULTS["gfdist"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfevnt"] = ["step", "gquant", "qpnams", "qcpars", "qdpars", "qipars", "qlpars", "op", "refval", "tol", "adjust", "rpt", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfevnt"] = ["result"]
...
CSPYCE_DEFAULTS["gfevnt"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gffove"] = ["inst", "tshape", "raydir", "target", "tframe", "abcorr", "obsrvr", "tol", "step", "rpt", "cnfine", "result"]
CSPYCE_RETNAMES["gffove"] = ["result"]
...
CSPYCE_DEFAULTS["gffove"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfilum"] = ["method", "angtyp", "target", "illmn", "fixref", "abcorr", "obsrvr", "spoint", "relate", "refval", "adjust", "step", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfilum"] = ["result"]
...
CSPYCE_DEFAULTS["gfilum"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfocce"] = ["occtyp", "front", "fshape", "fframe", "back", "bshape", "bframe", "abcorr", "obsrvr", "tol", "step", "rpt", "cnfine", "result"]
CSPYCE_RETNAMES["gfocce"] = ["result"]
...
CSPYCE_DEFAULTS["gfocce"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfoclt"] = ["occtyp", "front", "fshape", "fframe", "back", "bshape", "bframe", "abcorr", "obsrvr", "step", "cnfine", "result"]
CSPYCE_RETNAMES["gfoclt"] = ["result"]
...
CSPYCE_DEFAULTS["gfoclt"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfpa"] = ["target", "illmn", "abcorr", "obsrvr", "relate", "refval", "adjust", "step", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfpa"] = ["result"]
...
CSPYCE_DEFAULTS["gfpa"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfposc"] = ["target", "frame", "abcorr", "obsrvr", "crdsys", "coord", "relate", "refval", "adjust", "step", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfposc"] = ["result"]
...
CSPYCE_DEFAULTS["gfposc"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfrfov"] = ["inst", "raydir", "rframe", "abcorr", "obsrvr", "step", "cnfine", "result"]
CSPYCE_RETNAMES["gfrfov"] = ["result"]
...
CSPYCE_DEFAULTS["gfrfov"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfrr"] = ["target", "abcorr", "obsrvr", "relate", "refval", "adjust", "step", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfrr"] = ["result"]
...
CSPYCE_DEFAULTS["gfrr"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfsep"] = ["targ1", "shape1", "frame1", "targ2", "shape2", "frame2", "abcorr", "obsrvr", "relate", "refval", "adjust", "step", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfsep"] = ["result"]
...
CSPYCE_DEFAULTS["gfsep"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gfsntc"] = ["target", "fixref", "method", "abcorr", "obsrvr", "dref", "dvec", "crdsys", "coord", "relate", "refval", "adjust", "step", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfsntc"] = ["result"]
...
#########################################
CSPYCE_ARGNAMES["gfsubc"] = ["target", "fixref", "method", "abcorr", "obsrvr", "crdsys", "coord", "relate", "refval", "adjust", "step", "nintvls", "cnfine", "result"]
CSPYCE_RETNAMES["gfsubc"] = ["result"]
...
CSPYCE_DEFAULTS["gfsubc"] = (2000,)
#########################################
CSPYCE_ARGNAMES["gftfov"] = ["inst", "target", "tshape", "tframe", "abcorr", "obsrvr", "step", "cnfine", "result"]
CSPYCE_RETNAMES["gftfov"] = ["result"]
...
#########################################
CSPYCE_ARGNAMES["wncomd"] = ["left", "right", "window", "result"]
...
'b'     : ("SpiceCell[*]", "Second input windows."),
'c'     : ("SpiceCell", "Difference of `a' and `b'."),
}
CSPYCE_URL["wndifd"] = "https://naif.jpl.nasa.gov/pub/naif/toolkit_docs/C/cspice/wndifd_c.html"
CSPYCE_DEFAULTS["wndifd"] = (2000,)
#########################################
...
#########################################
CSPYCE_ARGNAMES["bltfrm"] = ["frmcls", "ids"]
...
'ellipse': ("SpiceEllipse", "The CSPICE ellipse defined by the input vectors."),
}
...
#########################################
CSPYCE_ARGNAMES["ckcov"] = ["ck", "idcode", "needav", "level", "tol", "timsys", "cover"]
...
'cover' : ("SpiceCell", "Array giving start/stop time pairs for the intervals covered."),
}
CSPYCE_URL["ckcov"] = "https://naif.jpl.nasa.gov/pub/naif/toolkit_docs/C/cspice/ckcov_c.html"
CSPYCE_DEFAULTS["ckcov"] = (20000,)
#########################################
...
#########################################
CSPYCE_ARGNAMES["ckobj"] = ["ck", "bodids"]
...
'limb'  : ("SpiceEllipse", "Limb of ellipsoid as seen from viewing point."),
}
...
'ellipse': ("ConstSpiceEllipse[*]", "A CSPICE ellipse."),
...
'b'     : ("float", "Length of ellipsoid semi-axis lying on the y-axis."),
'c'     : ("float", "Length of ellipsoid semi-axis lying on the z-axis."),
'plane' : ("ConstSpicePlane[*]", "Plane that intersects ellipsoid."),
'ellipse': ("SpiceEllipse", "Intersection ellipse, when found is True."),
...
'ellips': ("ConstSpiceEllipse[*]", "A CSPICE ellipse."),
'plane' : ("ConstSpicePlane[*]", "A CSPICE plane."),
...
#########################################
CSPYCE_ARGNAMES["kplfrm"] = ["frmcls", "ids"]
...
'plane' : ("SpicePlane", "A CSPICE plane structure representing the plane."),
}
...
#########################################
CSPYCE_ARGNAMES["pckcov"] = ["pck", "idcode", "cover"]
...
CSPYCE_DEFAULTS["pckcov"] = (2000,)
#########################################
CSPYCE_ARGNAMES["pckfrm"] = ["pck", "ids"]
...
'pck'   : ("string", "Name of PCK file."),
'ids'   : ("SpiceCell", "Array of frame class ID codes for frames in PCK file."),
}
CSPYCE_URL["pckfrm"] = "https://naif.jpl.nasa.gov/pub/naif/toolkit_docs/C/cspice/pckfrm_c.html"
CSPYCE_DEFAULTS["pckfrm"] = (2000,)
#########################################
...
'elin'  : ("ConstSpiceEllipse[*]", "A CSPICE ellipse to be projected."),
'plane' : ("ConstSpicePlane[*]", "A plane onto which elin is to be projected."),
'elout' : ("SpiceEllipse", "A CSPICE ellipse resulting from the projection."),
}
...
'plane' : ("SpicePlane", "A CSPICE plane representing the plane."),
}
...
#########################################
CSPYCE_ARGNAMES["spkcov"] = ["spk", "idcode", "cover"]
...
#########################################
CSPYCE_ARGNAMES["spkobj"] = ["spk", "ids"]
...
'plane' : ("ConstSpicePlane[*]", "A CSPICE plane onto which vin is projected."),
...
'projpl': ("ConstSpicePlane[*]", "Plane containing v1."),
'invpl' : ("ConstSpicePlane[*]", "Plane containing inverse image of v1."),
