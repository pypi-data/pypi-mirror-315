...
from thalesians.adiutor.conditions import precondition, postcondition
...
class TestConditions(unittest.TestCase):
    ...
    def test_unary_function_precondition_level_too_low(self):
        ...
        # thailib_settings.THAILIB_MIN_PRECONDITION_LEVEL, so it is not checked:
    ...
    def test_function_postcondition_level_too_low(self):
        ...
        # thailib_settings.THAILIB_MIN_POSTCONDITION_LEVEL, so it is not checked:
