    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appsecret', models.CharField(blank=True, max_length=64, null=True, verbose_name='AppSecret')),
                ('type', models.PositiveSmallIntegerField(choices=[(4, 'MINIPROGRAM'), (0, 'OTHER'), (256, 'PAYPARTNER'), (1, 'SERVICEAPP'), (2, 'SUBSCRIBEAPP')], default=1, verbose_name='type')),
                ...
                ('ext_info', models.JSONField(db_column='ext_info', default=dict, encoder=DjangoJSONEncoder)),
                ('configurations', models.JSONField(db_column='configurations', default=dict, encoder=DjangoJSONEncoder)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_content', models.JSONField(db_column='content', default=dict, encoder=DjangoJSONEncoder)),
                ('weight', models.IntegerField(default=0, verbose_name='weight')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created_at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated_at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('all', 'ALL'), ('contain', 'CONTAIN'), ('custom', 'CUSTOM'), ('equal', 'EQUAL'), ('event', 'EVENT'), ('eventkey', 'EVENTKEY'), ('msg_type', 'MSGTYPE'), ('regex', 'REGEX')], max_length=16, verbose_name='type')),
                ('_content', models.JSONField(blank=True, db_column='content', default=dict, encoder=DjangoJSONEncoder)),
                ('weight', models.IntegerField(default=0, verbose_name='weight')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created_at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated_at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.JSONField(default=dict, blank=True, encoder=DjangoJSONEncoder)),
                ('weight', models.IntegerField(default=0, verbose_name='weight')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_button', to='wechat_django.menu')),
                ('app', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menus', to='wechat_django.wechatapp')),
            ],
            options={
                'verbose_name': 'menu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.CharField(blank=True, help_text='素材别名,用于程序快速查询素材,单app下唯一', max_length=16, null=True, verbose_name='alias')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('app', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='materials', to='wechat_django.wechatapp')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.CharField(blank=True, help_text='用户别名,用于程序快速查询用户,单app下唯一', max_length=16, null=True, verbose_name='alias')),
                ...
                ('subscribe', models.BooleanField(null=True, verbose_name='is subscribed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('app', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='user_tags', to='wechat_django.wechatapp')),
                ('users', models.ManyToManyField(related_name='tags', to='wechat_django.wechatuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth', models.JSONField(default=dict, encoder=DjangoJSONEncoder, blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.JSONField(verbose_name='content', default=dict, encoder=DjangoJSONEncoder, blank=True)),
                ('direct', models.BooleanField(default=False, verbose_name='direct')),
                ('raw', models.TextField(blank=True, default=None, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('app', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wechat_django.wechatapp')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wechat_django.wechatuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('need_open_comment', models.BooleanField(default=None, null=True, verbose_name='need open comment')),
                ('only_fans_can_comment', models.BooleanField(default=None, null=True, verbose_name='only fans can comment')),
                ...
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='wechat_django.material')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.CharField(blank=True, help_text='模板别名,用于程序快速查询模板,单app下唯一', max_length=16, null=True, verbose_name='alias')),
            ...
            options={
                ...
                'unique_together': {('app', 'alias'), ('app', 'template_id')},
            },
        ),
        migrations.AddIndex(
            model_name='messagehandler',
            index=models.Index(fields=['app', 'weight', 'created_at'], name='wechat_djan_app_id_9f5dcd_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='material',
            unique_together={('app', 'alias'), ('app', 'media_id')},
        ),
        migrations.AlterUniqueTogether(
            name='wechatuser',
            unique_together={('app', 'alias'), ('app', 'openid'), ('unionid', 'app')},
        ),
        migrations.AddIndex(
            model_name='usertag',
            index=models.Index(fields=['app', 'name'], name='wechat_djan_app_id_29d5d6_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='usertag',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['app', 'created_at'], name='wechat_djan_app_id_396706_idx'),
        ),
    ]
