...
from sqlalchemy3 import Enum as sa_Enum
from sqlalchemy3.orm import (
    Mapped,
...
from sqlalchemy3.orm.attributes import set_attribute
from sqlalchemy3.orm.decl_api import DeclarativeMeta
from sqlalchemy3.orm.instrumentation import is_instrumented
from sqlalchemy3.sql.schema import MetaData
from sqlalchemy3.sql.sqltypes import LargeBinary, Time, Uuid
...
class SQLModel(BaseModel, metaclass=SQLModelMetaclass, registry=default_registry):
    ...
    __allow_unmapped__ = True  # https://docs.sqlalchemy3.org/en/20/changelog/migration_20.html#migration-20-step-six
    ...
    def __new__(cls, *args: Any, **kwargs: Any) -> Any:
        ...
        # Ref: https://docs.sqlalchemy3.org/en/14/orm/constructors.html
    ...
    def __init__(__pydantic_self__, **data: Any) -> None:
        ...
        # sqlalchemy3.orm.instrumentation._generate_init()
