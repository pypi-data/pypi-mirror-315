...
class ModelsApi(object):
    ...
    def generate_column_model(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.generate_column_model(body=body_value, callback=callback_function)
    ...
    def generate_column_model_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.generate_column_model_with_http_info(body=body_value, callback=callback_function)
