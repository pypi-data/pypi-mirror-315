...
[Open documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/)
...
class EndpointDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/#endpointdeletedwaiter)
    """
    def wait(self, **kwargs: Unpack[DescribeEndpointsMessageEndpointDeletedWaitTypeDef]) -> None:
        """
...
class ReplicationInstanceAvailableWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/#replicationinstanceavailablewaiter)
    """
    def wait(
        self,
        **kwargs: Unpack[
...
class ReplicationInstanceDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/#replicationinstancedeletedwaiter)
    """
    def wait(
        self,
        **kwargs: Unpack[DescribeReplicationInstancesMessageReplicationInstanceDeletedWaitTypeDef],
    ) -> None:
        """
...
class ReplicationTaskDeletedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/#replicationtaskdeletedwaiter)
    """
    def wait(
        self, **kwargs: Unpack[DescribeReplicationTasksMessageReplicationTaskDeletedWaitTypeDef]
    ) -> None:
        """
...
class ReplicationTaskReadyWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/#replicationtaskreadywaiter)
    """
    def wait(
        self, **kwargs: Unpack[DescribeReplicationTasksMessageReplicationTaskReadyWaitTypeDef]
    ) -> None:
        """
...
class ReplicationTaskRunningWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/#replicationtaskrunningwaiter)
    """
    def wait(
        self, **kwargs: Unpack[DescribeReplicationTasksMessageReplicationTaskRunningWaitTypeDef]
    ) -> None:
        """
...
class ReplicationTaskStoppedWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/#replicationtaskstoppedwaiter)
    """
    def wait(
        self, **kwargs: Unpack[DescribeReplicationTasksMessageReplicationTaskStoppedWaitTypeDef]
    ) -> None:
        """
...
class TestConnectionSucceedsWaiter(Waiter):
    ...
    [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dms/waiters/#testconnectionsucceedswaiter)
    """
    def wait(
        self, **kwargs: Unpack[DescribeConnectionsMessageTestConnectionSucceedsWaitTypeDef]
    ) -> None:
        """
