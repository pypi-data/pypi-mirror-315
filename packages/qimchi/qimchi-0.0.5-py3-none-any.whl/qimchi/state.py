...
LINE_COLOR_OPTS = MARKER_COLOR_OPTS = GRID_COLOR_OPTS = TICK_COLOR_OPTS = [
    # Some random colors # TODO: Sort this out @s.anupam
    "red",
    "blue",
    "green",
    "purple",
...
DEFAULT_MARKER_SYMBOL = "diamond-tall-open"
MARKER_SYMBOL_OPTS = [
