...
def pipeline(accelerator: str = "T4",
    ...
    """
    Pipeline for change ocrnet training eval transform transform-eval package inference.
    """
    ...
    transform = Transform(transform_skip=transform_skip,
                          ...
                          category=Category.CategoryImageChangeDetectionSemanticSegmentation.value,
    ...
    def __call__(self,
        ...
        train = ContainerStep(name=Train.name(),
                              ...
                              command=f'cd /root && '
                                      ...
                                      f'python3 -m gaea_operator.nodes.train.change_ocrnet '
...
if __name__ == "__main__":
    pipeline_client = pipeline(
        ...
        eval_model_name="workspaces/internal/modelstores/ms-6TDGY7Hv/models/change_ocrnet/versions/latest",
        transform_input_model_name="workspaces/internal/modelstores/ms-6TDGY7Hv/models/change_ocrnet/versions/latest",
