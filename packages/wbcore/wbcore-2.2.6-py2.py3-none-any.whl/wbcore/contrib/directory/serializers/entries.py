...
class BankRepresentationSerializer(CompanyRepresentationSerializer):
    endpoint = "wbcore:directory:bankrepresentation-list"
    _detail = wb_serializers.HyperlinkField(reverse_name="wbcore:directory:bank-detail")
...
class EntryModelSerializer(wb_serializers.ModelSerializer):
    ...
    addresses_repr = wb_serializers.CharField(read_only=True)
