...
class WBCore:
    ...
    WBCORE_TINYMCE_CDN_URL = values.Value(
    ...
    WBCORE_DEFAULT_AUTH_CONFIG = values.Value("wbcore.auth.jwt_auth", environ_prefix=None)
    WBCORE_DEFAULT_USER_NAME = values.Value("wbcore.auth.get_user_name", environ_prefix=None)
    ...
    MESSAGE_STORAGE = "wbcore.messages.InMemoryMessageStorage"
    ...
    def FRONTEND_CONTEXT(self):
        ...
        return {
            ...
            "CDN_URLS": [self.WBCORE_PLOTLY_CDN_URL, self.WBCORE_TINYMCE_CDN_URL, *self.WBCORE_EXTRA_CDN_URLS],
