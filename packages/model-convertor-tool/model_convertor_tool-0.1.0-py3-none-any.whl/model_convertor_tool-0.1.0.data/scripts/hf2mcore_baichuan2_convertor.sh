...
# template_json="./hf_baichuan2_moe/config_TEMPLATE.json"
# config_json="./hf_baichuan2_moe/config.json"
...
torchrun ${DISTRIBUTED_ARGS} $PACKAGE_PATH/ckpt/megatron-core/toolkits/model_checkpoints_convertor/baichuan2_core/hf2mcore.py \
...
python $PACKAGE_PATH/ckpt/megatron-core/toolkits/model_checkpoints_convertor/baichuan2_core/hf2mcore.py \
  --load ${HG_CKPT_PATH} \
  --megatron-path ${MEGATRON_PATH} \
  --load_path ${SOURCE_CKPT_PATH} \
  --save_path ${TARGET_CKPT_PATH} \
