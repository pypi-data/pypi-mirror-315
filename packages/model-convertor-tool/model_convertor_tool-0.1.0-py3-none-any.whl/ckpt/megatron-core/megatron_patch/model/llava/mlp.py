...
class MLP(MegatronModule):
    ...
    def __init__(
        ...
        #TODO 待确认
        self._linear_fc1_key = "linear_fc1"
        self._linear_fc2_key = "linear_fc2"
    ...
    def state_dict_for_save_checkpoint(self, prefix='', keep_vars=False):
        state_dict_ = {}
        state_dict_[self._linear_fc1_key] = self.linear_fc1.state_dict(prefix=prefix, keep_vars=keep_vars)
        state_dict_[self._linear_fc2_key] = self.linear_fc2.state_dict(prefix=prefix, keep_vars=keep_vars)
        return state_dict_
    
    #TODO 待确认
    def load_state_dict(self, state_dict, strict=True):
        self.linear_fc1.load_state_dict(state_dict[self._linear_fc1_key], strict=strict)
        self.linear_fc2.load_state_dict(state_dict[self._linear_fc2_key], strict=strict)
