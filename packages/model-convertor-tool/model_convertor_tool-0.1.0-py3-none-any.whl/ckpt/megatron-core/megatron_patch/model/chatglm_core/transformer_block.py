...
from .transformer_layer import BaseTransformerLayer, TransformerLayer
...
class TransformerBlock(MegatronModule):
    ...
    def __init__(
        ...
        # self.gmask_token_id = tokenizer.gmask_token_id
        # print("**********************position_encoding_2d:", self.position_encoding_2d)
    ...
    def get_masks(self, input_ids, device):
        ...
        context_lengths = [
            seq.tolist().index(self.bos_token_id) for seq in input_ids
        ]
    ...
    def forward(
        ...
        # print("TransformerBlock before:", position_ids.shape)
        # #TODO 2d encoder
        # # position_ids = None
        ...
        #     print("TransformerBlock after:", position_ids.shape)
