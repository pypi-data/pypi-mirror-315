...
class GPTModel(LanguageModule):
    ...
    def __init__(
        ...
        self.position_encoding_2d = self.config.position_encoding_2d #TODO 2d encoder
    ...
    def forward(
        ...
        attention_mask = None
        position_ids = None
        # print("GPTModel before:", position_ids.shape)
        ...
        if position_ids is None:
            ...
            # print("GPTModel after:",position_ids.shape)
