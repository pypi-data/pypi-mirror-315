...
from megatron_patch.model.llama2_core.layer_specs import get_gpt_layer_with_transformer_engine_spec
from megatron_patch.model.llama2_core.model import GPTModel
from megatron_patch.model.llama2_core.transformer_config import LLama2TransformerConfig
...
def model_provider(pre_process=True, post_process=True) -> Union[GPTModel, megatron.legacy.model.GPTModel]:
    ...
    print_rank_0('building Llama2 model ...')
    # Experimental loading arguments from yaml
    config = core_transformer_config_from_args(args, LLama2TransformerConfig)
...
def forward_step(data_iterator, model: GPTModel):
    ...
    nvtx.range_push("Forward training step by model")
