...
from megatron_patch.model.llama3_core.layer_specs import get_gpt_layer_with_transformer_engine_spec
from megatron_patch.model.llama3_core.model import GPTModel
from megatron_patch.model.llama3_core.transformer_config import LLama3TransformerConfig
...
def model_provider(pre_process=True, post_process=True) -> Union[GPTModel, megatron.legacy.model.GPTModel]:
    ...
    print_rank_0('building Llama3 model ...')
