...
from megatron_patch.model.qwen_core.layer_specs import get_gpt_layer_with_transformer_engine_spec
from megatron_patch.model.qwen_core.model import GPTModel
from megatron_patch.model.qwen_core.transformer_config import QwenTransformerConfig
