...
def getFPM(args):
	...
	try:
		...
		logger.message("File for customized precision formats is lacking: " + __file__)
...
def parseOptions(options):
	...
	return method, path, files, run, (nbDigitsGen, nbDigitsPerVar), compileLines, output, options.get('--custom', None), alias
